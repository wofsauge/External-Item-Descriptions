...
if MCMLoaded then
	...
	MCM.AddSpace("EID", "Info")
	MCM.AddText("EID", "Info", function() return "Version "..EID.Config.ModVersion .." ("..EID.GameVersion..")" end)
	MCM.AddSpace("EID", "Info")
	...
	---------------------------------General-----------------------------------
	-- Language
	local displayLanguage = {"English", "English (detailed)", "French (AB+)", "Portuguese (AB+)", "Portugues (Brasil)", "Russian", "Spanish", "Italian", "Bulgarian (WIP) (AB+)", "Polish (WIP)", "German (WIP) (AB+)", "Turkish"}
	MCM.AddSetting(
		"EID",
		"General",
		{
