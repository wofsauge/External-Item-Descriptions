...
local repCollectibles={
	...
	[83] = {"83", "钉子", "{{BlackHeart}} +半黑心#{{Timer}} 当前房间获得：#↑ {{Damage}} +2.0伤害#↓ {{Speed}} -0.18移速#造成每秒1次40点接触伤害#粉碎经过的岩石"}, -- The Nail
	...
	[107] = {"107", "锯齿剪", "{{Timer}} 当前房间获得：#飞行#角色身体会攻击敌人，每秒造成23.5点接触伤害"},
	...
	[123] = {"123", "怪物手册", "{Timer}} 本层生成1个随机跟班"}, -- Monster Manual
	...
	[158] = {"158", "水晶球", "{{Timer}} 揭示本层地图（除了 {{SuperSecretRoom}} 超级隐藏房）#生成随机卡牌，魂心或符文#持有时：#{{PlanetariumChance}} +15%星象房几率#{{PlanetariumChance}} 如果跳过{{TreasureRoom}}道具房则为100%"}, -- Crystal Ball
	...
	[192] = {"192", "心灵感应傻瓜式教程", "{{Timer}} 当前房间获得：#跟踪眼泪#↑ +3.0射程"}, -- Telepathy for Dummies
	...
	[214] = {"214", "贫血", "↑ {{Range}} +1.5射程#{{Timer}} 受伤时当前房间能留下能造成伤害的血迹#血迹造成每秒6点伤害"}, -- Anemic
	...
	[263] = {"263", "透明符文", "{{Rune}} 触发持有符文或魂石的效果#{{Rune}} 拾取后生成1随机符文"}, -- Clear Rune   (REPENTANCE ITEM)
	...
	[287] = {"287", "秘密之书", "高亮当前房间的夹层石头与标记石头#{{Timer}} 在本层获得以下道具的效果之一：#{{Blank}} {{Collectible54}} 藏宝图#{{Blank}} {{Collectible21}} 指南针 #{{Blank}} {{Collectible246}} 蓝地图#只产生未拥有的效果#如果三者都已拥有，施加{{Collectible76}}X光透视效果"}, -- Book of Secrets
	...
	[293] = {"293", "坎卜斯的头", "在四个方向上发射硫磺火激光#每道硫磺火造成200点伤害"},
	...
	[297] = {"297", "潘多拉魔盒", "根据所在层生成以下物品：#1章1:2{{SoulHeart}}; 1章2:2{{Key}}+2 {{Bomb}}#2章1:1{{BossRoom}}道具; 2章2:1章1+2章1#3章1:4{{SoulHeart}}; 3章2:20{{Coin}}#4章1:2{{BossRoom}}道具; 4章2:{{Collectible33}}圣经#???/虚空：无#地狱:1{{DevilRoom}}道具+1{{BlackHeart}}; 大教堂:1{{AngelRoom}}道具+1{{EternalHeart}}#暗室:解锁{{Collectible523}}搬家盒; 宝箱:1{{Coin}}#家:{{Collectible580}}红钥匙#若有迷宫诅咒则为章节1层"}, -- Pandora's Box
	...
	[577] = {"577", "达摩克里斯之剑", "在头顶生成悬浮的剑，所有底座道具额外生成1个#不会影响商店，箱子和恶魔房的道具生成#头顶有剑时受伤，在随机时间后，角色会自动死亡"}, --  Damocles
	...
	[622] = {"622", "创世纪", "移除持有的全部道具和掉落物#传送到特殊的卧室，内有掉落物，箱子和暗门#每移除1个道具，就显示1组3个道具供你选择"}, --  Genesis
	...
	[628] = {"628", "死亡证明", "传送至含有所有游戏道具的房间#捡起1个道具后回到之前的房间"}, --  Death Certificate
	...
	[636] = {"636", "R键", "将角色带到新一局开始层#保留道具和掉落物"}, --  R Key
...
local repCards={
	...
	[12] = {"12", "XI-力量", "{{Timer}} 当前房间获得：#↑ +1心之容器#↑ {{Damage}} +0.3伤害#↑ {{Damage}} +50%伤害倍率#↑ {{Range}} +2.5射程#↑ {{Speed}} +0.3移速"}, -- XI - Strength
	...
	[52] = {"52", "变巨术", "{{Timer}} 当前房间获得：↑ {{Damage}} +7.0额外伤害#↑ {{Range}} +3.0射程#粉碎经过的岩石#体型变大"}, -- Huge Growth
