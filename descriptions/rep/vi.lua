...
local repTrinkets={
	...
	[162] = {"162", "Azazel's Stump", "{{Player7}} Dọn phòng có 33% cơ hội biến người chơi thành Azazel#{{Timer}} Hiệu ứng kéo dài đến khi dọn và rời một phòng khác"}, -- Azazel's Stump
...
local repCards={
	...
	[71] = {"71", "XV - The Devil?", "{{Timer}} Nhận trong 30 giây:#{{Collectible33}} Kích hoạt The Bible (bay)#{{Collectible390}} bạn đồng hành Seraphim#{{MomsHeart}} Giết ngay lập tức Chân của Mom và Trái tim của Mom#{{Warning}} Giết Isaac khi dùng với Satan"}, -- XV - The Devil?
