...
local repCollectibles={
	...
	[577] = {"577", "Damocle", "Evoca una spada sopra la tua testa, che raddoppia tutti i piedistalli e oggetti trovati da mendicanti#0.15% probabilita' che la spada cada e ti uccida ogni secondo"}, --  Damocles
	...
	[622] = {"622", "Genesi", "Rimuove tutti gli oggetti e consumabili di Isaac#Ti teletrasporta in una camera da letto con consumabili, casse ed una botola#Per ogni oggetto perso, Stanze del Tesoro {{TreasureRoom}} mostrano un set di 3 oggetti tra cui scegliere"}, --  Genesis
	...
	[628] = {"628", "Certificato di Morte", "Ti teletrasporta in un piano contenente TUTTI gli oggetti del gioco#Dopo aver preso un oggetto, ti riporta nella stanza in cui hai attivato l'oggetto"}, --  Death Certificate
	...
	[636] = {"636", "Tasto R", "Ti teletrasporta alla stanza d'inizio del primo piano di una partita nuova#Oggetti, consumabili, Ninnoli, Vita e Statistiche restano intatte"}, --  R Key
...
local repTrinkets={
	...
	[173] = {"173", "La Tua Anima", "Puo' essere usato per prendere un patto del Diavolo gratuitamente"}, --  Your Soul
