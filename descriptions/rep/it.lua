...
local repCollectibles={
	...
	[285] = {"285", "D10", "Regredisce utti i nemici nella stanza#Ad esempio, tutte le Mosche Rosse diventano Mosche Nere"}, -- D10
	...
	[386] = {"386", "D12", "Rilancia gli ostacoli in altri ostacoli casuali (ad es. cacca, vasi, TNT, cacca rossa, blocchi di pietra etc.)#Piccola chance di rilanciare gli ostacoli in pulsanti, interruttori di vita, cunicoli o botole"}, -- D12
	...
	[489] = {"489", "D Infinito", "Può operare come qualsiasi dado (escluso {{Collectible723}} \"Dado Decrementale\") con il tasto di rilascio ({{ButtonRT}})#I tempi di carica dipendono dall'ultimo dado usato e si aggiorna ad ogni uso"}, -- D Infinity
	...
	[500] = {"500", "Sacco di Sacchi", "Genera in sacco ogni 7-8 stanze"}, -- Sack of Sacks
...
EID.descriptions[languageCode].bookOfBelialBuffs = {
	...
	[147] = "Il piccone ha una robustezza e spinta maggiore, può venire usato più rapidamente, {{Burning}} mette a fuoco i nemici e quando distrugge cacche e ostacoli butta a terra più consumabili", -- Notched Axe
...
EID.descriptions[languageCode].abyssSynergies = {
	...
	[257] = "Locusta arancione e fiammeggiante che mette a fuoco i nemici", -- Fire Mind
	[305] = "Locusta verde che avvelena i nemici", -- Scorpio
	[374] = "Locusta celeste e lucente che può generare raggi di luce che infliggono x3 dei danni di Isaac", -- Holy Light
...
EID.descriptions[languageCode].birthright ={
	...
	{"Il Dimenticato Corrotto", "", "{{Collectible714}} L'Anima Corrotta ottiene l'abilità \"Richiamo\" per recuperare da lontano Il Dimenticato Corrotto#Mentre Il Dimenticato ritorna L'Anima è invincibile"},
	...
	{"Giacobbe Corrotto 2", "", ""},
	{"L'Anima Corrotta", "", "{{Collectible714}} L'Anima Corrotta ottiene l'abilità \"Richiamo\" per recuperare da lontano Il Dimenticato Corrotto#Mentre Il Dimenticato ritorna L'Anima è invincibile"},
}
...
EID.descriptions[languageCode].GlowingHourglassTransformed = "Nel prossimo ritornerà ad essere \"Clessidra Luminosa\""
...
local repConditions = {
	...
	["5.100.566"] = {"{{HalfSoulHeart}} All'ingresso in un nuovo piano +1 mezzo Cuore Celeste#!!! Nella Modalità Avido gli incubi nelle transizioni tra i livellimostrano gli oggetti sbagliati"}, -- Dream Catcher (Greed)
