...
local repCollectibles={
	...
	[45] = {"45", "Cuore Gustoso", "Cura di 1 cuore#Cura altri giocatori di mezzo cuore"}, -- Yum Heart
	[46] = {"46", "Piede Fortunato", "↑ +1.0 Fortuna#Probabilità di vittoria aumentate in giochi d'azzardo#Probabilità di trovare consumabili a fine stanza aumentata#Trasforma alcune pillole negative in pillole positive"}, -- Lucky Foot
	...
	[55] = {"55", "Occhio di Mamma", "Probabilità di sparare una lacrima dietro di te"}, -- Mom's Eye
	[62] = {"62", "Fascino del Vampiro", "↑ +0.3 Danni#Cura di mezzo cuore ogni 13 nemici uccisi"}, -- Charm of the Vampire
	[64] = {"64", "Saldi di Steam", "50% sconto per oggetti in negozio#Copie multiple dell'oggetto riducono il prezzo ulteriormente"}, -- Steam Sale
	[67] = {"67", "Sorella Maggy", "Famiglio normale#Infligge 6 danni per lacrima"}, -- Sister Maggy
	[70] = {"70", "Ormoni Della Crescita", "↑ +1.0 Danni#↑ +0.2 Velocità"}, -- Growth Hormones
	[71] = {"71", "Mini Fungo", "↑ +0.3 Velocità#↑ +1.5 Gittata#↑ Dimensione ridotta"}, -- Mini Mush
	[72] = {"72", "Rosario", "+3 Cuori Spirito#↑ +0.5 Lacrime#La Bibbia è più comune"}, -- Rosary
	[77] = {"77", "Il mio Piccolo Unicorno", "Invincibilità#20 danni da contatto"}, -- My Little Unicorn
	[79] = {"79", "Il Marchio", "↑ +1.0 Danni#↑ +0.2 Velocità#+1 Cuore Nero"}, -- The Mark
	[80] = {"80", "Il Patto", "↑ +0.5 Danni#↑ +0.7 Lacrime#+2 Cuori Neri"}, -- The Pact
	[83] = {"83", "Il Chiodo", "+ Mezzo Cuore Nero#↑ +2.0 Danni#↓ -0.18 Velocità#Danni da contatto#Squarcia rocce"}, -- The Nail
	[98] = {"98", "La Reliquia", "Evoca un Cuore Spirito ogni 7-8 stanze"}, -- The Relic
	[101] = {"101", "L'Aureola", "↑ +1 Vita#↑ +0.3 Danni#↑ +0.2 Lacrime#↑ +0.38 Gittata#↑ +0.3 Velocità#↑ +0.5 Altezza lacrime"}, -- The Halo
	[106] = {"106", "Sig. Mega", "↑ Danni bombe x1.85#+5 Bombe"}, -- Mr. Mega
	[110] = {"110", "Lentine di Mamma", "Possibilità di sparare lacrime pietrificanti#↑ +0.38 Gittata#↑ +0.5 Altezza lacrime"}, -- Mom's Contacts
	[121] = {"121", "Buffungo (Grande)", "↑ +1 Contenitore vita (vuoto)#↑ +1.0 Danni#↑ +0.38 Gittata#↓ -0.2 Velocità#↑ +0.5 Altezza lacrime"}, -- Odd Mushroom (Large)
	[123] = {"123", "Manuale dei Mostri", "Evoca un famiglio casuale#Scompare al prossimo piano"}, -- Monster Manual
	[129] = {"129", "Secchio di Lardo", "↑ +2 Vita#↓ -0.2 Velocità#Cura mezzo cuore"}, -- Bucket of Lard
