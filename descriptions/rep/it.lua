...
EID.descriptions[languageCode].bookOfVirtuesWisps = {
	...
	[609] = "Fiammella dell'anello mediano {{MiddleWisp}}#50% di chance di generare una fiammella invincibile#50% di chance che se usato tutte le fiammelle di \"D6 Eterno\" vengano distrutte", -- Eternal D6
