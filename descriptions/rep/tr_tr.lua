...
local repCollectibles={
	...
	[297] = {"297", "Pandora'nın Kutusu", "!!! TEK KULLANIM !#!!! Bulunan kata gore farklı şeyler düşürür:#B1: 2 Ruh Kalbi#B2: 2 anahtar ve bomba#C1: 1 Boss itemi#C2: B1+C1#D1: 4 Ruh Kalbi#D2: 20 Altın#W1: 2 Boss itemi#W2: İncil#Sheol: 1 Şeytan itemi + Siyah kalp#Cat: 1 Melek itemi + Ruh kalbi#Chest: 1 Altın#Home: Kırmızı anahtar"}, -- Pandora's box
	...
	[577] = {"577", "Demokles", "{{Warning}} TEK KULLANIM {{Warning}}#Kafanın üstünde bir kılıç oluşturur, İtem ve dilenci ödüllerini iki katına çıkartır#Hasar alınan rastgele bir zamanda seni öldürür"}, --  Damocles
	...
	[622] = {"622", "Yaratılış", "{{Warning}} TEK KULLANIM {{Warning}}#Isaacin bütün itemlerini ve pickuplarını siler#Seni pickupların, kasaların ve alt kapının olduğu bir yatak odasına ışınlar#Kaybedilen her item için, Hazine Odası {{TreasureRoom}} seçmek üzere 3 item sunar"}, --  Genesis
	...
	[628] = {"628", "Ölüm Sertifikası", "{{Warning}} TEK KULLANIM {{Warning}}#Oyundaki her itemin olduğu bir kata ışınlar#1 İtem aldıktan sonra geldiğin odaya ışınlar"}, --  Death Certificate
	...
	[636] = {"636", "R Tuşu", "{{Warning}} TEK KULLANIM {{Warning}}#Yeni bir oyunun ilk katına ışınlar#İtemler ve pickuplar üzerinde kalır"}, --  R Key
	...
	[669] = {"669", "Sosis", "↑ +1 HP#↑ +1.33 Hasar#↑ +0.2 Hız#↑ +1.2 Gözyaşı hızı#↑ +0.16 Menzil#↑ +1 Şans"}, --  Sausage
	...
	[720] = {"720", "Her Şey Kavanozu", "Şarj durumuna göre farklı pickuplar çıkartır#Şarj full ise, daha güçlü bir rastgele efekti olur#Şarj ödülleri: 1:Bok 2:{{Coin}} 3:{{Bomb}} 4:{{Key}} 5:{{Heart}} 6:{{Pill}} 7:{{Card}} 8:{{RuhHeart}} 9:{{GoldenHeart}} 10:{{GoldenKey}} 11:{{GoldenBomb}}"}, --  Everything Jar
...
local repTrinkets={
	...
	[26] = {"26", "Çengel Solucan", "Gözyaşları açısal hareketlerle ilerler#↑ +10 Menzil#Hayalet gözyaşları verir"}, -- Hook Worm
...
local repCards={
	...
	[79] = {"79", "Kupa Kızı", "1-12 kırmızı kalp çıkartır"}, -- Queen of Hearts
