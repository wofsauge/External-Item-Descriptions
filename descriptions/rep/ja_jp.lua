...
local repCollectibles={
    ...
    [107] = {"107", "ピンキング シアー", "頭と体を分離し、浮遊状態 になった頭部を操作する#体が敵を自動的に追いかけ、 毎秒23.6の接触ダメージを 与える"}, -- The Pinking Shears
    ...
    [585] = {"585", "アラバスタ ボックス", "{{Warning}} 使い切りアイテム {{Warning}}#天使部屋アイテムを2個、 青ハートを3個スポーン#悪魔取引済みの場合、 スポーン量が各1個減#チャージが空の状態で 始まり、通常の方法で チャージされない#青／黒ハートを取得時、 体力には追加されず、 代わりに、チャージが 2追加される"}, -- Alabaster Box
    ...
    [605] = {"605", "ザ スクーパー", "部屋を飛び回る目玉を 召喚する#目玉は接触ダメージを 与え、弾をブロックし、 ダメージ性の血痕を残す#↑ 右目の攻撃力 +35%"}, -- The Scooper
    ...
    [655] = {"655", "スピン トゥ ウィン", "コマがアイザックを周回し、 敵に接触ダメージを与え、 弾をブロックする#毎秒26の接触ダメージ#使用すると、コマと他の 使い魔が高速で周回し、 接触ダメージが強化され、 移動速度が0.5アップする"}, -- Spin to Win
