...
local repCollectibles={
    ...
    [135] = {"135", "静脈注射", "いつでも売血#1ダメージ = 1～2コイン"}, -- IV Bag
    ...
    [161] = {"161", "アンク", "{{Player4}} 死ぬと、一つ前の部屋に ？？？として復活する"},
    ...
    [311] = {"311", "ユダの影", "{{Player12}} 死ぬと、一つ前の部屋に ダークユダとして復活#復活後、実績上はユダ として扱われる"}, --Judas' Shadow
    ...
    [332] = {"332", "ラザラスのぼろきれ", "{{Player11}} 死ぬと、その部屋で ラザラスとして復活する"},
...
local repTrinkets={
    [1] = {"1", "飲み込んだペニー", "ダメージを受けた時 コインを1枚スポーン"}, -- Swallowed Penny
...
local repConditions={
	["5.100.161"] = "{{Player25}} 汚染？？？プレイ時は 汚染？？？のまま復活", -- Ankh
	["5.350.28"] = "{{Player25}} 汚染？？？プレイ時は 汚染？？？のまま復活", -- Broken Ankh
	["5.100.311"] = "{{Player24}} 汚染ユダプレイ時は 汚染ユダのまま復活", -- Judas's Shadow
	["5.100.332"] = "{{Player29}} 汚染ラザラスプレイ時は 汚染ラザラスのまま復活", -- Lazarus's Rags
	["5.350.23 (Tainted Lost)"] = "{{Player31}} 汚染ロストプレイ時は 汚染ロストのまま復活", -- Missing Poster
	["5.100.676"] = "赤ハートを持てない キャラクターの場合、 効果なし", -- Empty Heart
	["5.300.15 (Tarot)"] = "{{DemonBeggar}} 悪魔乞食を{{ColorShinyPurple}}2体{{CR}}スポーン", -- Temperance (Greed Mode + Tarot Cloth effect)
	["5.350.1"] = "{{Player14}} キーパー使用時は0～1枚", -- Swallowed Penny
