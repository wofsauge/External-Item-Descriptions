...
local repCollectibles={
    ...
    [29] = {"29", "ママの下着", "↑ 射程 +2.5#取得時、3～8匹の 青ハエがスポーン"}, -- Mom's Underwear
    ...
    [42] = {"42", "ボブの腐った頭", "手投げ式の毒爆弾#185ダメージと毒を与える#着弾地点に毒雲を生成"}, -- Bob's Rotten Head
    [45] = {"45", "ヤム ハート", "体力を1回復#協力プレイ中の場合、 他プレイヤーの体力も 半赤ハート回復させる"}, -- Yum Heart
    ...
    [135] = {"135", "静脈注射", "いつでも売血#1ダメージ = 1～2コイン#ハードモードでは1枚固定#キーパー使用時は0～1枚"}, -- IV Bag
    [138] = {"138", "聖痕", "↑ 最大体力 +1#↑ 攻撃力　 +0.3#体力を1回復"}, -- Stigmata
    [139] = {"139", "ママのカバン", "トリンケットを2個まで 保持可能になる#取得時、トリンケットを ランダムに1個スポーン"}, -- Mom's Purse
    [140] = {"140", "ボブの呪い", "爆弾に毒効果を付与する#爆弾 +5#爆破地点に毒雲が生成 されるようになる"}, -- Bob's Curse
    ...
    [155] = {"155", "ノゾキ魔", "目玉が部屋を飛び回り、 敵の弾をブロックし、 接触した敵に毎秒17の ダメージを与える#↑ 左目の攻撃力 +34%"}, -- The Peeper
    ...
    [161] = {"161", "アンク", "{{Player4}} 死ぬと、一つ前の部屋に ？？？として復活する#{{Player25}} 汚染？？？使用時は、 汚染？？？のまま復活"},
    ...
    [223] = {"223", "放火魔", "爆風を浴びると 体力が0.5回復する#爆弾 +5"}, -- Pyromaniac
    [224] = {"224", "クリケットの体", "衝突した涙が四つに分裂する#分裂した涙はダメージ量が 半減する#↑ 連射速度 +0.5 ※上限を突破できる#↓ 射程　　 -20%"}, -- Cricket's Body
    [225] = {"225", "ギンピー", "ダメージを受けた時、 一定確率で青ハートが スポーンする#確率：運0=8%、46=100%#死んだ敵が一定確率で 半赤ハートを落とす"},
    [226] = {"226", "ブラックロータス", "↑ 最大体力 +1#青ハート +1#黒ハート +1#体力を1回復"}, -- Black Lotus
    [228] = {"228", "ママの香水", "一定確率で涙に 恐怖効果を付与#確率：運0=12%、85=100%#↑ 連射速度 +0.5 ※上限を突破できる"}, -- Mom's Perfume
    [229] = {"229", "モンストロの肺", "涙をチャージ式に置き換え、 一度に14発の涙を同時発射 できるようになる#↓ 連射速度 -77%"}, --Monstro's Lung
    [230] = {"230", "アバドン", "↑ 攻撃力　 +1.5#↑ 移動速度 +0.2#一定確率で涙に 恐怖効果を付与#赤ハートを同数の 黒ハートに置き換える#黒ハート +2"}, -- Abaddon
    ...
    [241] = {"241", "闇からの契約", "部屋のクリア報酬が2倍に なるが、1/3の確率でゼロ 報酬になる"}, -- Contract from Below
    ...
    [297] = {"297", "パンドラの箱", "{{Warning}} 使い切りアイテム#使用フロアで効果が変化：#B1:青ハート 2個#B2:爆弾と鍵 各2個#C1:ボスアイテム 1個#C2:B1+C1#D1:青ハート 4個#D2:コイン 20枚#W1:ボスアイテム 2個#W2:{{Collectible33}} 聖書#???/Void:なし#Sheol:悪魔部屋アイテム1個 　　　黒ハート 1個#Cat:天使部屋アイテム 1個 　　白ハート 1個#DarkRoom:{{Collectible523}}お引越し用の箱 　　　　　 をアンロック#Chest:コイン 1枚#Home:{{Collectible580}}レッドキー"}, -- Pandora's Box
    ...
    [311] = {"311", "ユダの影", "{{Player12}} 死ぬと、一つ前の部屋に ダークユダとして復活#復活後、実績上はユダ として扱われる#{{Player24}} 汚染ユダ使用時は、 汚染ユダのまま復活"}, --Judas' Shadow
    [314] = {"314", "ムッチムチなもも！", "↑ 最大体力 +1#↓ 移動速度 -0.4#体力を1回復#障害物破壊能力を付与"}, -- Thunder Thighs
    [315] = {"315", "謎の引力", "涙が磁気を帯び、着地点に 敵やピックアップ等が引き 寄せられるようになる"}, -- Strange Attractor
    [319] = {"319", "ケインの予備眼", "目玉がアイザックを追従し、 アイザックと同じ涙を ランダムな方向に放つ#ダメージ量は攻撃力の75%"}, -- Cain's Other Eye
    [320] = {"320", "？？？唯一の友", "攻撃方向に連動して移動し、 毎秒14の接触ダメージを 与える使い魔"}, -- ???'s Only Friend
    ...
    [332] = {"332", "ラザラスのぼろきれ", "{{Player11}} 死ぬと、その部屋で ラザラスとして復活する#{{Player29}} 汚染ラザラス使用時は、 汚染ラザラスのまま復活"},
    [336] = {"336", "枯れタマネギ", "涙に貫通と透過効果を付与#↓ 射程　　 -1.5#↓ 弾速　　 -0.4#↑ 涙サイズ +50%"}, -- Dead Onion
    ...
    [350] = {"350", "有毒ショック", "バトル開始時、部屋の 全ての敵を毒状態にする#死んだ敵が緑色の液体を 残し、触れた敵に毎秒30 ダメージを与える"}, -- Toxic Shock
    ...
    [360] = {"360", "インキュバス", "アイザックの涙をコピー して攻撃する使い魔#リリス以外のキャラで 使う場合、ダメージが 25%減少する"}, -- Incubus
    [365] = {"365", "ロスト フライ", "壁や障害物に沿って 移動する使い魔#毎秒56の接触ダメージ#近くの敵を引き付け、 アイザックの代わりに 攻撃対象となる"}, -- Lost Fly
    ...
    [374] = {"374", "聖なる光", "一定確率で聖なる涙が 発射され、衝突すると 近くの敵に光線が降り注ぐ#光線は攻撃力ｘ3の ダメージを与える#確率：運0=9%、9=50%"}, -- Holy Light
    ...
    [393] = {"393", "サーペントのくちづけ", "一定確率で涙に毒効果が 付与される#接触した敵に毒を与える#接触で毒を受けた敵が 死んだ時、20%の確率で 黒ハートを落とす"}, -- Serpent's Kiss
    ...
    [401] = {"401", "エクスプロシボ", "一定確率で涙が敵に くっ付き、数秒後に 爆発する"}, -- Explosivo
    [404] = {"404", "ファーティング ベイビー", "敵の弾をブロックする 使い魔　　#ブロックすると10%の 確率でおならを出し、 毒・ノックバック・ チャームのいずれかの 効果を敵に与える#おならは5～6ダメージを 与える"}, -- Farting Baby
    ...
    [408] = {"408", "儀式の刃", "倒された敵が一定確率で ブリムストーンリングを 放ち、それに触れた他の 敵にダメージを与える"}, -- Athame
    ...
    [493] = {"493", "アドレナリン", "↑ 空の赤ハートの量に 応じて攻撃力がアップ#{{EmptyHeart}} 1個：+0.3#{{EmptyHeart}} 2個：+0.92#{{EmptyHeart}} 3個：+1.76#{{EmptyHeart}} 4個：+2.79#{{EmptyHeart}} 5個：+3.98"}, -- Adrenaline
    ...
    [543] = {"543", "神聖なる土", "ダメージを受けると 白いうんちがスポーン#うんちオーラの範囲内：#↑ 攻撃力　 +20%#↑ 連射速度 +150%#涙にホーミング効果を付与#一定確率でダメージ無効化"}, -- Hallowed Ground
    ...
    [575] = {"575", "侵入者", "クモが頭に寄生し、スロー 効果付き涙で敵を攻撃する#ダメージを受けた時、 一定確率で頭から飛び出す"}, -- The Intruder
    [576] = {"576", "ダーティ マインド", "敵のうんちが味方になる#うんちを壊すと1～4匹の うんち使い魔がスポーン#特殊なうんちは特殊な うんち使い魔をスポーン#一定確率で岩がうんちに 置き換わる"}, -- Dirty Mind
    [577] = {"577", "ダモクレス", "{{Warning}} 使い切りアイテム {{Warning}}#使うと、アイザックの 頭上に剣が吊るされ、 以降、アイテムが倍に なってスポーンする#お店、宝箱、悪魔取引の アイテムは倍にならない#{{Warning}} ダメージを受けた後、 剣が一定確率で落下し、 アイザックが即死する#即死効果は無敵状態で 回避できる#落下確率は15分で50%"}, -- Damocles
    [578] = {"578", "タダのレモネード", "床にレモネードが広がり、 敵に毎秒24のダメージを 与える"}, -- Free Lemonade
    [579] = {"579", "スピリット ソード", "涙を剣による近接攻撃に 置き換える#剣は攻撃力x3のダメージを 与え、総体力が十分な時、 ビームを放つ#フルチャージするとスピン アタックとビームを放つ"}, -- Spirit Sword
    ...
    [584] = {"584", "美徳の書", "ウィスプがスポーンし、 アイザックを周回する#ウィスプは透過効果付きの 涙を放ち、弾をブロックし、 敵に接触ダメージを与える#一定量のブロック・接触で 燃え尽きる#別のアクティブアイテムを 上に積み重ねると、特殊な ウィスプがスポーン#最初に現れる悪魔部屋を 天使部屋に置き換える#悪魔取引済みでも天使 部屋が生成可能になり、 その出現率を12.5%増やす"}, -- Book of Virtues
    [585] = {"585", "アラバスタ ボックス", "{{Warning}} 使い切りアイテム {{Warning}}#天使部屋アイテムを2個、 青ハートを3個スポーン#悪魔取引済みの場合、 スポーン量が各一個減#チャージが空の状態で 始まり、通常の方法で チャージされない#青／黒ハートを取得時、 体力には追加されず、 代わりに、チャージと して追加される"}, -- Alabaster Box
    ...
    [588] = {"588", "ソル", "ボス部屋の位置がマップに 表示される#ボスを倒した時：#{{Card20}} 太陽カードの効果が発動#アクティブアイテムを フルチャージ#フロアの呪いを除去#↑ 攻撃力 +3#↑ 運　　 +1"}, -- Sol
    ...
    [594] = {"594", "ユピテル", "体力を半ハート回復#↑ 最大体力 +2##↓ 移動速度 -0.3#静止中、一時的に移動 速度が上昇し、毒ガス がチャージされる#移動すると一時上昇した 移動速度が減少を始め、 同時に毒ガスを放出する"}, -- Jupiter
    ...
    [601] = {"601", "痛悔の祈り", "↑ 連射速度 +0.7#白ハート +1#悪魔取引済みでも天使 部屋が生成可能になる#赤ハートにダメージを 受けた時のペナルティ (悪魔部屋の出現率減) が軽減される"}, -- Act of Contrition
    ...
    [605] = {"605", "ザ スクーパー", "部屋を飛び回る目玉を 召喚する#目玉は接触ダメージを 与え、弾をブロックし、 ダメージ性の血痕を残す#↑ 右目の攻撃力 +34%"}, -- The Scooper
    [606] = {"606", "オキュラー リフト", "5%の確率で涙の着地点に 裂け目が生成され、敵と 弾、ピックアップが吸い 込まれる#裂け目に吸引された敵に 攻撃力x3のダメージを 毎秒与える"}, -- Ocular Rift
    [607] = {"607", "ボイルド ベイビー", "涙をまき散らして攻撃する 使い魔#涙は3.5か5.3のダメージを 与える"}, -- Boiled Baby
    ...
    [615] = {"615", "リトル ダンピー", "敵の弾がアイザックに 接近した時、おならを 出してそれを跳ね返す#一度おならを出すと、 アイザックが再接触 するまで停止する"}, -- Lil Dumpy
    ...
    [618] = {"618", "ロッテン トマト", "一定確率で涙に標的化 効果を付与する#標的化した敵は、他の 敵から攻撃される#確率：運0=17%、5=100%"}, -- Rotten Tomato
    ...
    [622] = {"622", "ジェネシス", "{{Warning}} 使い切りアイテム {{Warning}}#アイザックを初期状態に リセットし、特殊な部屋 にテレポートさせる#リセットで失った全ての アイテムを、3つの選択肢 からそれぞれ選び直す#部屋から離れると、次の フロアに直行する"}, -- Genesis
    ...
    [627] = {"627", "ナイフピース２", "ナイフピース1と合成 すると、ナイフが現れる#涙の発射方向に連動して ナイフが発射され、敵に ダメージを与える#マウソレウム／ゲヘナで 肉のドアを開くと消滅"}, -- Knife Piece 2
    [628] = {"628", "死亡届", "{{Warning}} 使い切りアイテム {{Warning}}#ゲーム内に存在する、ほぼ 全てのアイテムが置かれた 特殊フロアにテレポート#アイテムを一つ取ると元に 居た場所へ戻る"}, -- Death Certificate
    [629] = {"629", "ボット フライ", "アイザックを周回し、 シールド付きの涙で 敵の弾をブロックする 使い魔　　#毎秒3の接触ダメージ"}, -- Bot Fly
    [630] = {"630", "", "<Item does not exist>"},
    [631] = {"631", "ブッチャーナイフ", "敵を二分割し、体力の 少ないミニバージョン にする　　"}, -- Meat Cleaver
    ...
    [635] = {"635", "スティッチ", "保持中、攻撃方向に連動 して移動する人形が現れる#使用すると、アイザックと 人形の位置が入れ替わり、 一時的に無敵状態になる#敵の位置にテレポートした 場合、敵に接触ダメージを 与える#人形は接触した敵に毎秒3 ダメージを与える"}, -- Stitches
    [636] = {"636", "Ｒキー", "{{Warning}} 使い切りアイテム {{Warning}}#アイザックを現在の状態の まま最初のフロアに戻す （強くてニューゲーム）"}, -- R Key
    [637] = {"637", "眠り薬", "一定確率で涙が拳に置き 換わり、敵を強くノック バックさせ、混乱状態に する　　#この効果で壁や障害物に 衝突した敵はダメージを 受ける　#確率：運0=10%、9=100%"}, -- Knockout Drops
    ...
    [642] = {"642", "マジックスキン", "その部屋のアイテムプール から、アイテムを一つ生成#最大体力1か骨ハート1個、 または青／黒ハート2個を、 壊れたハート1個に変換#消費優先順位は赤＞骨＞青#使用後にこれを手放すと、 スポーンするアイテムが 一定確率でこれに置き換え られるようになる#確率は1回の使用で33%、 2回で50%、3回以上で100%#現フロアのどこかにこの アイテムが存在する場合、 置き換え確率が低下する#{{Warning}} ロスト使用時は使い切り、 置き換え効果なし"}, -- Magic Skin
    ...
    [647] = {"647", "４.５ボルト", "アクティブアイテムが 通常の方法でチャージ されなくなる代わりに、 敵にダメージを与える ことでチャージされる ようになる#フルチャージに必要な ダメージは一階で40で、 以降、20ずつ増加"}, -- 4.5 Volt
    [648] = {"648", "", "<Item does not exist>"},
    [649] = {"649", "フルーティ プラム", "部屋を斜めに飛び回り ながら涙を連射する、 ミニ・ベビープラムの 使い魔　　"}, -- Fruity Plum
    ...
    [652] = {"652", "キューブ ベイビー", "接触した敵にダメージと スロー効果を与え、敵を 倒した場合は凍結させる 使い魔　　#自ら動けず、アイザック との接触や、敵の弾の ブロックでスライドする"}, -- Cube Baby
    ...
    [655] = {"655", "スピン トゥ ウィン", "コマがアイザックを周回 し、敵に接触ダメージを 与え、弾をブロックする#毎秒10.5の接触ダメージ#使用すると、コマと他の 使い魔が高速で周回し、 接触ダメージが強化され、 移動速度が0.5アップする"}, -- Spin to Win
    ...
    [672] = {"672", "１ポンドの肉", "悪魔部屋と闇市の取引 コストがコインになる#お店のアイテム価格が コインではなくハート になる　　#お店のピックアップは 無料で取得できるが、 トゲでダメージを受ける"}, -- A Pound of Flesh
    ...
    [675] = {"675", "ひび割れたオーブ", "ダメージを受けた時：#隠し部屋の入り口を含む、 部屋の全てのドアの開放#クロールスペースの岩と、 ｘ岩を破壊する#離れ隠し部屋を含む、 ランダムな部屋一つを マッピング "}, -- Cracked Orb
    [676] = {"676", "エンプティ ハート", "赤ハートが1以下の状態で フロアを移動した時：#↑ 最大体力 +1#赤ハートを持てない キャラには効果なし"}, -- Empty Heart
    [677] = {"677", "アストラル プロジェクション", "ダメージを受けると 幽体離脱し、時間が 2秒間止まる#幽体離脱中は飛行能力と 透過の涙が付与され、 次に受けるダメージを 無効にする#部屋のクリアか、再度 ダメージを受けると、 幽体離脱が解除される"}, -- Astral Projection
    [678] = {"678", "帝王切開", "涙が胎児に置き換わる#胎児はホーミングと 貫通・透過効果を持ち、 攻撃力ｘ2.8のダメージを 毎秒与える"}, -- C Section
    [679] = {"679", "リトル アバドン", "ブリムストーンリングで 攻撃する使い魔"}, -- Lil Abaddon
    ...
    [682] = {"682", "ワーム フレンド", "敵に絡みつき、ダメージと スロー効果を与え、動きを 4秒間止める使い魔"}, -- Worm Friend
    [683] = {"683", "ボーン スパーズ", "倒された敵が、1～2個の 骨をスポーンする#骨はその場に浮遊し、接触 した敵にダメージを与え、 弾をブロックする#2回の接触／ブロックで 骨は消滅する"}, -- Bone Spurs
    [684] = {"684", "ハングリー ソウル", "倒された敵が33%の確率で 幽霊をスポーンする#幽霊は敵を追いかけ攻撃し、 7秒後に爆発する#アイザックは幽霊の爆発で ダメージを受けない"}, -- Hungry Soul
    ...
    [687] = {"687", "フレンド ファインダー", "アイザックの移動と攻撃を 模倣する、チャーム状態の ランダムな敵をスポーン"}, -- Friend Finder
    ...
    [695] = {"695", "血まみれの突風", "ダメージを受けるたびに 移動速度と連射速度が アップする#上限値（6ヒット後）：#{{Blank}} 移動速度 +1.02#{{Blank}} 連射速度 +3#効果は次のフロアに移動 するまで有効"}, -- Bloody Gust
    [696] = {"696", "救済", "アイザックを光輪が囲む#光輪に触れた敵を中心に 十字形のビームが発生し、 最大152ダメージを与える#アイザックがダメージを 受けるたびに光輪が拡大 し、最大10倍になる#フロア移動時にサイズが リセットされる"}, -- Salvation
    ...
    [726] = {"726", "ヘモプタスィス", "攻撃ボタンをダブルタップ すると吐血し、正面の敵に 攻撃力x1.5のダメージと ノックバック与える#吐血を浴びた敵は呪われ、 ブリムストーンタイプの 攻撃で追加のダメージを 受ける#クールダウンは1秒"}, -- Hemoptysis
    [727] = {"727", "ゴースト ボム", "爆弾 +5#爆弾から幽霊がスポーンし、 敵を追いかけて攻撃する#幽霊は10秒後に爆発する"}, -- Ghost Bombs
    [728] = {"728", "ゲロー", "アイザックの涙をコピーし、 近くの敵を自動で攻撃する 使い魔を召喚#使用した部屋でのみ有効"}, -- Gello
...
local repTrinkets={
    [1] = {"1", "飲み込んだペニー", "ダメージを受けた時 コインを1枚スポーン#キーパーでは0～1枚"}, -- Swallowed Penny
    ...
    [23] = {"23", "尋ね人ポスター", "保持中に生贄部屋で死ぬと ザ・ロストをアンロック#{{Player10}} アンロック済みの場合： 死ぬと、その部屋で ザ・ロストとして復活#{{Player31}} 汚染ロスト使用時は、 汚染ロストのまま復活"}, -- Missing Poster
    ...
    [33] = {"33", "へそのお", "残り体力が半赤ハート 以下の時、{{Collectible100}}リトル スティーブンを付与#ダメージを受けた時、高い 確率で　{{Collectible318}}ふたご座の使い 魔がスポーンする#ふたご座の使い魔は複数体 スポーン可能で、その部屋 でのみ有効"}, -- Umbilical Cord
    [39] = {"39", "癌", "↑ 連射速度 +1"},
    [48] = {"48", "失くしたページ", "ネクロノミコン効果 （黒ハートなど）の ダメージ量を2倍にする#ダメージを受けた時、 ネクロノミコン効果が 一定確率で発動する （全ての敵に80ダメージ）"}, -- A Missing Page
    ...
    [128] = {"128", "指のホネ", "ダメージを受けた時、5%の 確率で骨ハートを付与"}, -- Finger Bone
    ...
    [142] = {"142", "ベタニアの信念", "フロア開始時、4つの ウィスプをスポーンする#ウィスプは{{Collectible584}} 美徳の書 からスポーンするものと 同一　　　　"}, -- Beth's Faith
    [143] = {"143", "オールド キャパシタ", "アクティブアイテムが 部屋クリア時にチャージ されなくなる代わりに、 20%の確率で報酬に電池が 追加される#確率は運5で33%"}, -- Old Capacitor
    ...
    [147] = {"147", "充電済みのペニー", "コイン取得時、一定確率 でアクティブアイテムが 1チャージされる#高額コインほど高確率"}, -- Charged Penny
    ...
    [173] = {"173", "ユア ソウル", "悪魔取引を一度だけ 無料にする#!!! この効果は悪魔取引 として扱われ、天使 部屋の出現率に影響 する　　　　　"}, -- Your Soul
    ...
    [184] = {"184", "養子縁組届書", "お店のアイテムが 使い魔アイテムに 置き換わる#所持中は販売価格が 10コインになる"}, -- Adoption Papers
    ...
    [187] = {"187", "壊れたメガネ", "トレジャールームに 50%の確率でブラインド アイテムが追加される#代替ルートの追加の ブラインドアイテムが、 50%の確率で公開状態に なる"}, -- Broken Glasses
