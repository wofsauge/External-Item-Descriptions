...
local repCollectibles={
	...
	[222] =	{"222", "Anti-Gravitație", "↑ {{Tears}} +1 Viteză#Dacă butonul de tragere este ținut apăsat, lacrimile vor fi suspenadate in aer#Eliberarea butoului face ca lacrimile să fie aruncate în direcția inițială"}, -- Anti-Gravity
