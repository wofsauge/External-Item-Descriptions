...
local repCollectibles={
	...
	[569] = {"569", "Jurământul de Sânge", "{{Warning}} Când intrii într-un etaj nouEntering a new floor drains all of Isaac's Red Hearts, but grants speed and damage bonuses for each heart lost#Each half heart lost counts as an individual hit for on-hit effects"}, -- Blood Oath
