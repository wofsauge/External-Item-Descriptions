...
local repCollectibles={
	...
	[18] = {"18", "Un Dolar", "{{Coin}} +100 Bănuți"}, -- Un Dolar
	...
	[52] = {"52", "Dl. Fetus", "↓ {{Tears}} x0.4 Viteză de Atac#{{Bomb}} Isaac împușcă cu bombe înloc de lacrimi#{{Damage}} Aceste bombe cauzează 10x daunele lui Isaac#Dacă asta rezultă in daune de peste 60, ele vor cauza 5x + 30"}, -- Dr. Fetus
	[53] = {"53", "Magnet", "Obiectele sunt atrase de Isaac#Deschide cuferele de la distanță(2 patrate), ignoră daunele provocate de cuferele capcană"}, -- Magneto
	...
	[180] = {"180", "Fasolea Neagră", "Isaac se beșește de mai multe ori cand este vătămat#{{Poison}} Beșinile lasă nori otravitori care deviază proiectilele"}, -- The Black Bean
	...
	[272] = {"272", "BBF", "Muscă prietenoasă care explodează #Explozia cauzeaza 100 de daune#{{Warning}} Explozia poate să îl răcească pe Isaac"}, -- BBF
	...
	[549] =	{"549", "Oase Fragile", "{{Em tyBoneHeart}} Înlocuiește toate Inimile lui Isaac cu 6 Inimi Os#Dacă pierzi o Inimă Os:#↑ {{Tears}} +0.4 Viteza de atac(permanentă)#Trage cu 9 oase in toate direcțile"}, -- Brittle Bones
	...
	[553] = {"553", "Mucormicoza", "25% ș nsă sa arunci cu o lacrimă lipicioasă cu spori#{{Luck}} Șansa nu este afectată de noroc#{{Poison}} După 2.5 secunde sporii explodează, otravesc inamicii din jur și se răspândesc"}, -- Mucormycosis
	...
	[594] = {"594", "Jupiter", "↑ {{EmptyHeart}} +2 Vieți goale#↓ {{Speed}} -0.3 Viteză#{{HealingRed}} Vindecă jumătate de Inimă#{{Speed}} Viteza lacrimilor crește până la +0.5 cât timp stai pe loc#{{Poison}} Deplasarea cauzează nori otravitori#{{Poison}} Imunitate la otravă"}, -- Jupiter
	...
	[601] = {"601", "Contriție", "↑ {{Tears}} +0.7 Lacrimi#{{EternalHeart}} +1 Inimă Eternă#{{AngelChance}} Perimite Camerelor Înger să apară  după un pact cu Diavolul#Dacă Isaac este vătămat șansa de Camere Înger/Diavol nu este scăzută atât de mult"}, -- Act of Contrition
	...
	[626] = {"626", "Bucata de Cuțit 1", "Se transformă într-un cuțit aruncabil care provoacă 25 de pagube când e combinat cu {{Collectible627}} Bucata de Cuțit 2#Cuțitul poate deschide o ușă de carne"}, -- Knife Piece 1
	[627] = {"627", "Knife Piece 2", "Se transformă într-un cuțit aruncabil care provoacă 25 de pagube când e combinat cu {{Collectible626}} Bucata de Cuțit 1#Cuțitul poate deschide o ușă de carne"}, -- Knife Piece 2
...
[661] = {"661", "Cvadrupleți", "Când ucizi un inamic în locul lui apare un familiar staționar#Maxim 5 familiari"}, -- Quints
	...
	[669] = {"669", "Cârnaț", "↑ {{Heart}} +1 Viață#↑ {{Speed}} +0.2 Viteză#↑ {{Tears}} +0.5 Lacrimi#↑ {{Damage}} +0.5 Daune#↑ {{Range}} +2.5 Rază de atac#↑ {{Shotspeed}} +0.16 Viteza lacrimilor#↑ {{Luck}} +1 Noroc#{{HealingRed}} Vindecă inimile#↑ {{AngelDevilChance}} +6.9% Șansă la Camerele Înger/Diavol#↑ {{PlanetariumChance}} +6.9% Șansă la Planetariu"}, -- Sausage
...
EID.descriptions[languageCode].abyssSynergies = {
	...
	[3] = "Locustă mov balistică", -- Spoon Bender
	[4] = "Locustă roșie mare care provoacă daune triple", -- Cricket's Head
	[6] = "Locustă galbenă rapidă de distanță mică care atacă mai rapid", -- Number One
	[7] = "Locustă roșie care provoacă daune duble", -- Blood of the Martyr
	[10] = "2 locuste gri care provoacă daune înjumătăție", -- Halo of Flies
	[13] = "Locustă verde care otrăvește inamicii", -- The Virus
	[103] = "Locustă verde care otrăvește inamicii", -- The Common Cold
	[118] = "Locustă gri mare care e altfel normală", -- Brimstone
	[149] = "Locustă verde mare și înceată care provoacă 1.5x daune și otrăvește inamicii", -- Ipecac
	[153] = "4 locuste normale", -- Mutant Spider
	[257] = "Locustă portocalie ce arde și incendiază inamicii", -- Fire Mind
	[305] = "Locustă verde care otrăvește inamicii", -- Scorpio
	[374] = "Locustă albastră strălucitoare care aduce o rază de lumină ce provoacă 3x daune", -- Holy Light
	[494] = "Locustă albastru deschid ce curentează inamicii și provoacă 0.1 daune pe scânteie", -- Jacob's Ladder
	[559] = "Locustă albastru deschid ce curentează inamicii și provoacă 0.1 daune pe scânteie", -- 120 Volt
}
...
local repCarBattery = {
	...
	[296] = {1, 2, " Inimă", " {{CR}}Inimi", 1, 2, "Spatiu de inimă", "{{CR}}Spații de inimi"}, -- Converter
	...
	[639] = {1, 2, " Inimă", " {{CR}}Inimi"}, -- Yuck Heart
...
local repTrinkets={
	...
	[51] = {"51", "Flat Penny", "{{Key}} 25% șansă să primesti o cheie dacă colectezi bănuți#Șansă mai mare de la banuții mai valoroși"}, -- Flat Penny
