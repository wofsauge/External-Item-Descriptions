...
local repCollectibles={
	...
	[118] = {"118", "Brimstone", "↓ {{Tears}} x0.33 Viteză de atac(lacrimi)#{{Chargeable}} Lacrimile lui Isac sunt înlocuite cu rază laser mare de sânge{{Damage}} Cauzează 9x din dauna lui Isac pe durata a 0.63 secunde "}, -- Brimstone
	...
	[149] = {"149", "Ipecac", "↑ {{Damage}} +40 Daune#↓ {{Tears}} x0.33 Rată de atac#↓ {{Range}} x0.8 Rază de atac#↓ {{Shotspeed}} -0.2 Viteza lacrimilor#Lacrimile sunt aruncate arcuit{{Poison}} lacrimile explodează și otrăvesc inamicii in locul in care aterizează"}, -- Ipecac
	[152] = {"152", "Tehnologia 2", "↓ {{Tears}} x0.67 Rată de atac#Înlocuiește lacrimile din ochiul drept cu un laser continu#{{Damage}} Laserul provoacă 2x daune pe secunda"}, -- Technology 2
	[153] = {"153", "Păianjen Mutant", "↓ {{Tears}} x0.42 Rată de atac#Isac aruncă de 4 ori o dată"}, -- Mutant Spider
	...
	[169] =	{"169", "Polifem", "↑ {{Damage}} +4 Daune#↑ {{Damage}} x2 Daune#↓ {{Tears}} x0.42 Rată de atac#Lacrimile străpung inamicii uciși dacă există daune rămase pe lacrimă"}, -- Polyphemus
	...
	[182] = {"182", "Inimă Sacră", "↑ {{Heart}} +1 Inimă#↑ {{Damage}} x2.3 Daune#↑ {{Damage}} +1 Daună↓ {{Tears}} -0.4 Lacrimi#↓ {{Shotspeed}} -0.25 Viteza lacrimilor#{{HealingRed}} Umple toate inimile#Lacrimile urmăresc inamicii"}, -- Sacred Heart
	...
	[189] = {"189", "SMB Super Fan", "↑ {{Heart}} +1 Inimă↑ {{Speed}} +0.2 Viteză↑ {{Tears}} +0.2 Lacrimi#↑ {{Damage}} +0.3 Daune#↑ {{Range}} +2.5 Raza de atac#{{HealingRed}} Umple toate inimile roșii"}, -- SMB Super Fan
	...
	[222] =	{"222", "Anti-Gravitație", "↑ {{Tears}} +1 Rată de atac#Dacă butonul de tragere este ținut apăsat, lacrimile vor fi suspenadate in aer#Eliberarea butoului face ca lacrimile să fie aruncate în direcția inițială"}, -- Anti-Gravity
	...
	[226] = {"226", "Lotusul Negru", "↑ {{Heart}} +1 Inimă}} Vindecă o inimă{{SoulHeart}} +1 Inimă Suflet{{BlackHeart}} +1 Inimă Neagră"}, -- Black Lotus
	[228] = {"228", "Parfumul Mamei", "↑ {{Tears}} +0.5 Lacrimi#{{Fear}} Șansă de 15% să tragi cu lacrimi provocatoare de frică"}, -- Mom's Perfume
	[229] =	{"229", "Plămânii lui Monstro", "↓ {{Tears}} x0.23 Rată de atac#{{Chargeable}} Lacrimile sunt încărcate și eliberate într-un efect de shotgun"}, -- Monstro's Lung
	...
	[256] = {"256", "Bombe Fierbinți", "{{Bomb}} +5 Bombe}} Bombele lui Isac provoacă daune de contact#{{Burning}} După explozie bombele lasă un foc#{{Burning}} Imunitate la foc (cu excepția proiectilelor)"}, -- Hot Bombs
	...
	[307] = {"307", "Capricorn", "↑ {{Heart}} +1 Inimă↑ {{Speed}} +0.1 Viteză#↑ {{Tears}} +0.5 Lacrimi#↑ {{Damage}} +0.5 Daune#↑ {{Range}} +0.75 Rază de atac {{Coin}} Moneda, {{Bomb}} bomba și {{Key}} cheia#{{HealingRed}} Vindecă o inimă"}, -- Capricorn
	...
	[314] = {"314", "Coapse Grase", "↑ {{Heart}} +1 Inimă#↓ {{Speed}} -0.4 Viteză#{{HealingRed}} Vindecă 1 inimă#Isac poate sa sparga pietrele daca trece prin ele"}, -- Thunder Thighs
	...
	[319] = {"319", "Celalat Ochi a lui Cain", "Aruncă lacrimi in direcții aleatorii cu același efect a le lui Isac#{{Damage}} Provoacă 75% din daunele lui Isac"}, -- Cain's Other Eye
	...
	[354] = {"354", "Crack Jacks", "↑ {{Heart}} +1 inimă}} Vindecă o inimă#{{Trinket}} Oferă un trinket"}, -- Crack Jacks
	...
	[376] = {"376", "Reprovizionare", "Dacă cumperi un item de la magazin el va fi înoit#Itemele reprovizionate vor fi mai scumpe"}, -- Restock
	...
	[397] = {"397", "Tractor Range", "↑ {{Tears}} +1 Attack Rate#↑ {{Range}} +2.5 Attack Range#↑ {{Shotspeed}} +0.16 Attack Speed #Issac's tears always travel along a ray of light before him"}, -- Tractor Beam
	[399] = {"399", "Mouth of the Abyss", "{{Chargeable}} Firing tears for 2.35 seconds and releasing the button creates a black ring of Brimstone around Isac#Deals 30x of Isac's damage and lasts 1.97 seconds"}, -- Maw of the Void
	[401] = {"401", "Explosive", "25% chance to throw a sticky tear#The sticky tears grow and explode after a few seconds, dealing +60 damage to Isac"}, -- Explosivo
	[404] = {"404", "Babe Baby", "Blocks projectiles#10% chance to babble and {{Charm}} cast, {{Poison}} poison or push enemies#Battle inflicts between 5- 6 damage"}, -- Farting Baby
	[405] = {"405", "GB Bug", "{{Throwable}} Throwable (double tap the fire button)#Changes enemies and pickups it comes into contact with"}, -- GB Bug
	[407] = {"407", "Purity", "↑ Boosts one of Isac's stats based on aura color#On damage the effect is removed and a new one is given in the next room#{{ColorYellow}}Yellow{{ CR}} = ↑ {{Speed}} +0.5 Speed}} = ↑ {{Tears}} +2 Attack Rate#{{ColorRed}}Red{{CR}} = ↑ {{Damage}} +4 Damage# {{ColorOrange}}Orange{{CR}} = ↑ {{Range}} +3 Attack Range"}, -- Purity
	[408] = {"408", "Athame", "25% chance for a black brimstone ring to appear in the jururl of eliminated enemies#Deals 30x Isac's damage over 2 seconds#{{Luck}} +2.5 % chance per luck"}, -- Athame
	[415] = {"415", "Crown of Light", "{{SoulHeart}} +2 Soul Hearts#If Isac has no life containers affected:#↑ {{Damage}} x2 Damage multiplicate#↓ {{Shotspeed}} -0.3 Viteza lacrimilor#Dacă ești rănit, efectele o să fie eliminate pe durata camerei"}, -- Crown Of Light
	[416] = {"416", "Buzunare Adânci", "{{Coin}} Daca o cameră nu oferă recompensă, vei primi 1-3 bănuți#{{Coin}} Mărește limita de bănuți la 999"}, -- Deep Pockets
	[417] = {"417", "Sucub", "Zboară prin cameră izbindu-se de pereți și este înconjurat de o aură care provoacă 7.5-10 daune pe secundă.#↑ {{Damage}} x1.5 Daune multiplicate când stai în aură"} , -- Succubus
	[419] = {"419", "Teleport 2.0", "Îl teleportează pe Isac într-o cameră care nu a fost curățată încă #Ierarhie: {{Room}}>{{BossRoom}}>{{SuperSecretRoom}}>{{Shop }}>{{TreasureRoom}}>{{SacrificeRoom}}> {{DiceRoom}}>{{Library}}>{{CursedRoom}}>{{MiniBoss}}>{{ChallengeRoom}}{{BossRushRoom}}> {{IsaacsRoom}}{{BarrenRoom}}> {{ArcadeRoom}}>{{ChestRoom}}>{{Planetarium}}>{{SecretRoom}}>{{DevilRoom}}{{AngelRoom}}>{{ErrorRoom} }"}, -- Teleport 2.0
 	[421] = {"421", "Fasole", "{{Charm}} Vrăjește inamicii din imediata apropiere"}, -- Kidney Bean
	[422] = {"422", "Clepsidra strălucitoare", "Isac este dus în camera anterioară și inversează toate acțiunile facute în cameră#Acest efect poate fi folosit de 3 ori pe etaj#{{Collectible66}} Acționează ca o clepsidră după cele 3 folosiri și încetinește inamicii pentru 8 secunde"}, -- Glowing Hourglass
	[426] = {"426", "Fan Obsedat", "Imită mișcarea lui Isac cu o întârziere de 0,66 secunde#Provoacă 30 de daune pe secundă "}, -- Obsessed Fan
	[430] = {"430", "Tata Muscă", "Imită mișcarea lui Isac cu o întârziere de 0,66 secunde#{{Damage}} Aruncă lacrimi în inamicii din apropiere și provoacă daunele lui Isac"}, -- Papa Fly
	[431] = {"431", "Bebeluș Multidimensional", "Imită mișcarea lui Isaac cu o întârziere de 0,66 secunde#Lacrimile care trec prin el sunt dublate și raza de atac + viteza lacrimilor este marită"}, -- Multidimensional Baby
	[432] = {"432", "Bombe cu Sclipici", "{{Bomb}} +5 Bombe#{{Charm}} Bombele au o șansă de 63% să ofere un pick-up aleatoriu și o șansă de 15% de a fermeca inamicii atunci când explodează#Șansa de a primi un pickup scade cu 1% de fiecare dată când primești unul pe durata etajului."}, -- Glitter Bombs
	[433] = {"433", "Umbra Mea", "Isac este urmarit de o umbra mică#{{Timer}} Când un inamic atinge umbra un charger prietenos apare în cameră#Chargerul provoacă 8.7 daune pe hit"}, -- My Shadow
	[437] = {"437", "D7", "Reîncepe camera și învie inamicii#Poate fi folosit pentru a obține mai multe recompense la finalizarea camerei"}, -- D7
	[440] = {"440", "Pietre la Rinichi", "Isaac occasionally stops firing and charges an attack that releases a burst of tears and a kidney stone"}, -- Kidney Stone
