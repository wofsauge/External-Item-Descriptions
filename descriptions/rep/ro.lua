...
local repCollectibles={
	...
	[186] = {"186", "Drepturile de Sânge", "Provoacă 40 de daune tuturor inamicilor din cameră#{{Warning}} Isac este vătămat o inimă#După prima folosite isac va fi vătămat jumătate de inimă#{{Heart}} Inimile roșii sunt eliminate prima dată"}, -- Blood Rights
	...
	[292] = {"292", "Biblie Satanică", "{{BlackHeart}} +1 Inimă Neagră#{{DevilRoom}} Folosirea cărții înainte de lupta cu bossul face ca recompensa să fie un pact cu diavolul#Cumpărarea ofertelor are aceiași consecință cu cele din Devil Room#Nu are efect asupra piedestaelor din Abis(The Void)"}, -- Satanic Bible
	...
	[397] = {"397", "Rază Tractoare", "↑ {{Tears}} +1 Rată de atac#↑ {{Range}} +2.5 Rază de atac#↑ {{Shotspeed}} +0.16 Viteza de atac#Lacrimile lui Isac călătoresc mereu de-a lungul unei raze de lumină din fața lui"}, -- Tractor Beam
