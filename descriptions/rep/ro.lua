...
local repCollectibles={
	...
	[462] = {"462", "Ochiul lui Belial", "↑ {{Range}} +1.5 Rază de atac#Lacrimi străpung inamicii#Lacrimile care trec prin inamici devin lacrimi care urmăresc inamicii și au pagube duble"}, -- Eye of Belial
	...
	[468] = {"468", "Umbra", "Copiază mișcările lui Isac cu o întârziere de 0.66 secunde#Provoacă 75 de daune de contact pe secundă#După ce provoacă 666 de pagube va fi absorbit de Isaac și îi crește daunele de contact"}, -- Shade
	...
	[487] = {"487", "Curățăor de Cartofi", "{{EmptyHeart}} Elimină o viață, dar oferă: #↑ {{Damage}} +0.2 Pagube#{{Collectible73}} Un Cub de Carne#{{Timer}} Pe durata camerei:#↑ {{Range}} +1.5 Rază de atac#{{Collectible214}} Lasă o baltă de sânge"}, -- Potato Peeler
	...
	[493] = {"493", "Adrenalină", "↑ {{Damage}} Pagube pentru fiecare inimă roșie lipsă#Cu cât mai multe inimi lipsă, cu atât mai multe pagube primite"}, -- Adrenaline
	[494] = {"494", "Scara lui Iacob", "Lacrimile provoacă o scânteie de electricitate la impact#Scânteia provoacă jumătate din pagubele lui Isaac#Scânteia poate traversa până la 4 inamici"}, -- Jacob's Ladder
	[495] = {"495", "Ardei Fantomă", "8% șansă sa arunci cu un foc albastru care blochează proiectilele și cauzează pagube inamicilor#{{Luck}} 50% șansă la 10 noroc#Focul se micește și dispare după 2 secunde"}, -- Ghost Pepper
	...
	[497] = {"497", "Chioți de Camunflat", "{{Confusion}} La intrarea într-o cameră Isaac este camunflat până trage cu o lacrimă#↑ {{Speed}} +0.5 viteză cand este camunflat#După tragerea unei Lacrimi Isaac provoacă daune în jurul lui si viteza lacrimilor și pagubele sunt crescute temporar"}, -- Camo Undies
	...
	[503] = {"503", "Corn Micuț", "5% șansă să arunci cu o lacrimă care aduce mâna lui Big Horn#{{Luck}} 20% șansă la 15 noroc#Mâna omoară inamicii instant și provoacă 36 de pagube șefilor#Isaac provoacă 7 daune de contact pe secundă"}, -- Little Horn
	[504] = {"504", "Pepită Maro", "Oferă o muscă care trage în inamici#Fiecare glonț provoacă 3.5 pagube"}, -- Brown Nugget
	[506] = {"506", "Înjunghie în Spate", "{{BleedingOut}} Dacă lovești un inamic în spate acesta primește pagube duble și sângerează cauzândule pagube dacă merg"}, -- Backstabber
	[507] = {"507", "Pai Ascuțit", "{{Damage}} Provoacă pagubele lui Isaac + 10% din viața inamicului cu cea mai mare viața tuturor inamicilor#{{HalfHeart}} 15% șansă să primești o jumătate de inimă dacă provoci pagube cu paiul"}, -- Sharp Straw
	[508] = {"508", "Briciul Mamei", "{{BleedingOut}} Orbital care provoacă sângerare#Sângerarea provoacă pagube inamicilor care se mișcă#{{Damage}} Provoacă 1.5x din pagubele lui Isaac pe secundă"}, -- Mom's Razor
	[509] = {"509", "Ochi Însângerat", "Orbital care trage la fiecare 0.33 secunde către inamici din apropiere#Pagube de 3.5 pe lacrimă#20 de pagube de contact pe secundă"}, -- Bloodshot Eye
	...
	[549] =	{"549", "Oase Fragile", "{{EmptyBoneHeart}} Ănlocuiește toate Inimile lui Isaac cu 6 Inimi Os#Dacă pierzi o Inimă Os:#↑ {{Tears}} +0.4 Viteza lacrimilor#Trage cu 9 oase in toate direcțile"}, -- Brittle Bones
	[552] = {"552", "Lopata Mamei", "Deschide o trapa către următorul nivel#{{LadderRoom}} Deschide un bechi daca este folosită pe o decoratiune (iarbă, pietre micuțe, hârtie, gemuri, etc.)(beciul are o scară și nu te duce la urmatorul etaj)#{{Warning}} Folosește lopata in pamântul din  \"Dark Room\""}, -- Mom's Shovel
