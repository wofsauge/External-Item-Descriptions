...
local repCollectibles={
	...
	[354] = {"354", "Popcprn Caramelizat", "↑ {{Heart}} +1 Inimă}} Vindecă o inimă#{{Trinket}} Oferă un trinket"}, -- Crack Jacks
	...
	[397] = {"397", "Rază Tractoare", "↑ {{Tears}} +1 Viteză de atac#↑ {{Range}} +2.5 Rază de atac#↑ {{Shotspeed}} +0.16 Viteza de atac#Lacrimile lui Isac călătoresc mereu de-a lungul unei raze de lumină din fața lui"}, -- Tractor Beam
	...
	[421] = {"421", "Fasole Roșie", "{{Charm}} Îndrăgostește toți inamicii din jur"}, -- Kidney Bean
	[422] = {"422", "Clepsidră Strălucitoare", "Îl aduce pe Isac in camera anterioară și retrage acțiuniile făcute în camera în care a fost folosită#Poate fi folosit de 3 ori pe etaj#{{Collectible66}} După cele 3 folosiri se transformă în Clepsidra, care încetinește inamicii pentru 8 secunde#La etajul urmator vei primii cele 3 folosiri înapoi"}, -- Glowing Hourglass
