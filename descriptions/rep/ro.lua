...
local repCollectibles={
	...
	[468] = {"468", "Umbra", "Copiază mișcările lui Isac cu o întârziere de 0.66 secunde#Provoacă 75 de daune de contact pe secundă#După ce provoacă 666 de daune va fi absorbit de Isaac și îi crește daunele de contact"}, -- Shade
	...
	[543] = {"543", "Rahat Binecuvântat", "Vătămarea oferă un rahat alb#Dacă stai în aura rahatului:#↑ {{Tears}} x2.5 Viteza lacrimilor#↑ {{Damage}} x1.2 Daune#Lacrimi orientate(urmaresc inamicii)#Șansă sa nu fi vătămat"}, -- Hallowed Ground
...
local repCarBattery = {
	...
	[283] = {1, 2, "pickupuri", "{{CR}}pickupuri"}, -- D100
	...
	[605] = {" un ", " 2 ", "familiari", "{{CR}}familiari"}, -- The Scooper
