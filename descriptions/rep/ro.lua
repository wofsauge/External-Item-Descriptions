...
local repCollectibles={
	...
	[107] = {"107", "Foarfece Zig-Zag", "{{Timer}} Pe durata camerei:#Abilitatea de a zbura#Corpul lui Isac este separat de cap si atacă inamicii cu 23.5 daune de contact pe secundă"}, -- The Pinking Shears
	[110] = {"110", "Lentilele Mamei", "↑ {{Range}} +1.5 Rază de atac#Sansă de 20% ca lacrimile sa pietrifice inamicii#{{Luck}} Șansă de 50% la 20 noroc"}, -- Mom's Contacts
	[114] = {"114", "Cuțitul Mamei", "Lacrimile lui Isaac sunt înlocuite cu un cuțit care poate fi aruncat#{{Damage}} Cuțitul cauzează 2x daunele lui Isac daca este ținut și maxim 6x daune daca este incarcat la 1/3(o treime)#Daca este încărcat mai mult de 1/3 numai raza de atac va fi marită#Damage reduces to 2x when returning to Isaac"}, -- Mom's Knife
