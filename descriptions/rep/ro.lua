...
local repCollectibles={
	...
	[115] = {"115", "Tablă Ouija", "↑ {{Tears}} +0.5 Lacrimi#Lacrimi Spectrale(lacrimile pot trece prin obstacole,dar nu si prin inamici"}, -- Ouija Board
	...
	[123] = {"123", "Manualul Monstru", "{{Timer}} Spawns a random familiar for the floor"}, -- Monster Manual
