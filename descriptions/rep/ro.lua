...
local repCollectibles={
	...
	[440] = {"440", "Piatră la Rinichi", "Ocazional Isaac se oprește din tras și încarcă un atac care eliberează o furună de lacrimi si o piatră la rinichi#↑ {{Damage}} Piatra la rinchi provoacă 10x din daunele lui Isaac și range dublu#↑ {{Tears}} Furtuna de lacrimi oferă 6x viteza lacrimilor"}, -- Kidney Stone
