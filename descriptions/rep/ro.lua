...
local repCollectibles={
	...
	[553] = {"553", "Mucormicoza", "25% șansă sa arunci cu o lacrimă lipicioasă cu spori#{{Luck}} Șansa nu este afectată de noroc#{{Poison}} După 2.5 secunde sporii explodează, otravesc inamicii din jur și se răspândesc"}, -- Mucormycosis
	[554] = {"554", "DeSpaimă", "{{Fear}} Provoacă frică tutuor inamicilor din jurul lui Isaac"}, -- 2Spooky
	[555] = {"555", "Brici de Aur", "{{Coin}} +5 Bănuți#{{Timer}} Plătește 5 {{Coin}} bănuți și primești pe durata camerei:#↑ {{Damage}} +1.2 Daune"}, -- Golden Razor
	...
	[614] = {"614", "Bombe Sânge", "↑ {{Heart}} +1 Viață#{{HealingRed}} Vindecă 4 Inimi Roșii#{{HalfHeart}} Dacă Isaac nu are bombe, o bombă poate fi pusă, dar costă o jumătate de inimă#Bombele lui Isaac lasă o baltă roșie#"}, -- Blood Bombs
	[615] = {"615", "Micul Dumpy", "Deflects an enemy or projectile right before Isaac would take damage from it#Chance to deflect projectiles near it#Needs to be touched after deflecting to be reactivated"}, -- Lil Dumpy
	...
	[647] = {"647", "4.5 Volți", "Clearing rooms no longer charges active items#Dealing damage to enemies slowly fills up the charge bar#Damage needed per charge increases each floor"}, -- 4.5 Volt
