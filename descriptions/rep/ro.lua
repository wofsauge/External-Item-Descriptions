...
local repCollectibles={
	...
	[276] = {"276", "Inima lui Isac", "Isac devine invincibil#Oferă un familiar inimă care îl urmărește pe Isac#Inima se încarcă când Isaac trage și eliberează o explozie de lacrimi când se oprește#{{Warning}} If the heart familiar gets hit, Isaac takes damage"}, -- Isaac's Heart
