...
{"252","","Spawns a random pill. #Allows the player to hold two pills. #Replaces all cards with pills. #By default, the key to cycle between pills is Control (PC), R2 (PlayStation) or RT (XBox). #Cracked Key counts as a card and will be converted. #Blowing up the skull marked with an X guarantees a telepills drop."},
