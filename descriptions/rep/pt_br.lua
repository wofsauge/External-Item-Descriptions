...
local repCollectibles={
	...
	[230] = {"230", "", "↑ {{Damage}} +1.5 Dano#↑ {{Speed}} +0.2 Velocidade#{{Fear}} Lágrimas que amedrontam inimigos#Converte todos os espaços de {{Heart}} Coração Vermelho em {{BlackHeart}} Corações Negro#{{BlackHeart}} +2 Corações negro"}, -- Abaddon
...
EID.descriptions[languageCode].bookOfVirtuesWisps = {
	...
	[35] = "3.5% de chance de disparar lágrimas que amedrontam inimigos#Efeito do Necronomicon quando destruído", -- The Necronomicon
