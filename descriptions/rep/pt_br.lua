...
-- Last Sync with en_us: 30.08.2021
...
local repCollectibles={
	...
	[101] = {"101", "", "↑ +1 Saúde#↑ +0.3 Dano#↑ +0.2 Lágrimas#↑ +0.38 Alcance#↑ +0.3 Velocidade#↑ +0.5 Altura da lágrima#Cura um coração"}, -- The Halo
	...
	[129] = {"129", "", "↑ +2 Espaço de coração cheio#↓ -0.2 Velocidade#Cura metade de um coração"}, -- Bucket of Lard
	...
	[182] = {"182", "", "Lágrimas teleguiadas#↑ +1 Saúde#↑ 230% + 1 Dano#↓ -0.4 Lágrimas#↓ -0.25 Velocidade de disparo#↑ +0.5 Alcance#Vida Cheia"}, -- Sacred Heart
	...
	[350] = {"350", "", "No começo de cada sala, todo inimigo fica envenenado#Inimigos mortos deixam uma poça#Concede imunidade a nuvens tóxicas"}, -- Toxic Shock
	...
	[354] = {"354", "", "↑ +1 Saúde#Gera um trinket aleatório no chão#Cura um coração"}, -- Crack Jacks
	...
	[566] = {"566", "", "+1 Meio Coração de alma quando entrar em um novo andar#Exibe o próximo item da Sala do Tesouro {{TreasureRoom}} e Chefe {{BossRoom}} na transição de andar"}, --  Dream Catcher
	...
	[585] = {"585", "", "Gera três corações de alma e dois itens da sala do anjo#Pode ser carregado pegando corações de alma#Gera apenas 2 Corações de alma e 1 item do Anjo se um acordo com o Diabo foi selado anteriormente"}, --  Alabaster Box
	...
	[591] = {"591", "", "+1 Espaço de Coração vermelho#Cura um coração#Inimigos próximos ficam encantados"}, --  Venus
	...
	[621] = {"621", "", "Vida cheia#↑ +21.6 Dano#O dano desaparece pelos próximos 3 minutos#O tempo é estendido enquanto matar inimigos enquanto o efeito está ativo"}, --  Red Stew
	...
	[647] = {"647", "", "Os itens ativadores não carregam ao limpar as salas#Eles carregam causando dano aos inimigos#Fórmula: 40 + 20 * estágio"}, --  4.5 Volt
	...
	[651] = {"651", "", "Familiar que viaja lentamente em direção à Sala do Chefe {{BossRoom}}#Emite uma aura que concede +20% + 1 Dano, +Lágrimas e lágrimas teleguiadas"}, --  Star of Bethlehem
	...
	[697] = {"697", "", "Familiar que se torna um clone do chefe ao entrar na Sala do Chefe {{BossRoom}}#Derrotá-lo deixa cair um item extra#O clone é mais lento e tem 75% da saúde do chefe original"}, --  Vanishing Twin
...
local repTrinkets={
	...
	[164] = {"164","","Gera uma bomba extra para cada bomba colocada"}, --  Ring Cap
	...
	[171] = {"171","","Chance de usar moedas ao invés de corações em acordos com Diabo"}, --  Keeper's Bargain
	...
	[187] = {"187","","33% de chance de gerar um item cego extra nas salas de itens#Chance de revelar o item cego no caminho alternativo"}, --  Broken Glasses
