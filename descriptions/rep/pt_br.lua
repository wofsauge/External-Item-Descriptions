...
local repCollectibles={
	...
	[297] = {"297", "", "!!! USO ÚNICO !#Gera itens baseados no andar em que for ativado:#B1: 2 {{SoulHeart}}#B2: 2 {{Bomb}} e 2 {{Key}}#C1: 1 {{BossRoom}} item#C2: B1+C1#D1: 4 {{SoulHeart}}#D2: 20 {{Coin}}#W1: 2 {{BossRoom}} itens#W2: {{Collectible33}} The Bible#???: Nada#Void: Nada#Sheol: 1 {{DevilRoom}} item + 1 {{BlackHeart}}#Catch: 1 {{AngelRoom}} item +  1 {{EternalHeart}}#Dark Room: {{Collectible523}} Destranca Moving Box#Chest: 1 {{Coin}}#Home: {{Collectible580}} Red Key"}, -- Pandora's box
