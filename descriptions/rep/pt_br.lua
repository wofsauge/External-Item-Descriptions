...
local repCollectibles={
	...
	[573] = {"573", "", "↑ {{Heart}} +1 Espaço de Coração Vermelho#{{Heart}} Saúde cheia#↑ {{Damage}} +20% Dano#20% de chance de disparar lágrimas espectrais orbitais adicionais"}, --  Immaculate Heart
