...
local repCollectibles={
	...
	[541] = {"541", "", "+1 Coração de osso#Gera 3 corações vermelhos#Chance de gerar um {{Trinket167}} Polished Bone quando um coração de osso acaba"}, -- Marrow
...
EID.descriptions["pt_br"].CraftingResults = "Resultado:#(Rolar: Segurar {{ButtonSelect}} + {{ButtonY}} {{ButtonA}})"
