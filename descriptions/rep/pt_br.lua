...
-- Last Sync with en_us: 27.03.2022
...
local repCollectibles={
	...
	[228] = {"228", "", "{{Fear}} 15% de chance de atirar lágrimas que amedrontam inimigos#{{Luck}} 100% de chance com 85 de Sorte#↑ {{Tears}} +0.5 Lágrimas"}, -- Mom's Perfume
	...
	[230] = {"230", "", "↑ {{Damage}} +1.5 Dano#↑ {{Speed}} +0.2 Velocidade#{{Fear}} Lágrimas que amedrontam inimigos#Converte todos os espaços de {{Heart}} Coração Vermelho em {{BlackHeart}} Corações Negro#{{BlackHeart}} +2 Corações Negros"}, -- Abaddon
	...
	[342] = {"342", "", "↑ {{Heart}} +1 Saúde#↑ {{Tears}} +0.7 Lágrimas#↓ {{Shotspeed}} -16% Velocidade de disparo#Cura 1 Corações Cermelhos"}, -- Blue Cap
	...
	[393] = {"393", "", "{{Poison}} 15% de chance de atirar lágrimas que envenenam#{{Luck}} Não é afetado pela sorte#{{Poison}} Envenena os inimigos ao contato#{{BlackHeart}} Inimigos mortos por contato tem 20% de chance de soltar um Coração Negro"}, -- Serpent`s Kiss
	...
	[415] = {"415", "", "{{SoulHeart}} +2 Corações de Alma#Se você não tem nenhum Espaço de Coração Vermelho danificado:#↑ {{Damage}} +100% Dano#↑ {{Range}} +1.5 Alcance#↓ {{Shotspeed}} -0.3 Velocidade de disparo#Desativa para a sala atual quando receber dano"}, -- Crown Of Light
	...
	[501] = {"501", "", "Dá a você um Espaço de Coração para cada 25 moedas que você tem#{{Player14}} / {{Player33}}O Keeper ganhará Corações de Moeda adicionais#{{Collectible416}} Recebe 1 Espaço de Coração para cada 100 moedas que você tem (caso ultrapasse 99)"}, -- Greed's Gullet
	...
	[543] = {"543", "", "Gera cocôs brancos ao receber dano#Enquanto dentro da área do cocô: #↑ {{Damage}} +25% de Dano#↑ {{Tears}} +250% Taxa de disparo#Lágrimas teleguiadas#Chance de bloquear danos"}, -- Hallowed Ground
	...
	[553] = {"553", "", "25% de chance de atirar esporos pegajosos#{{Luck}} Não é afetado pela sorte#Esporos explodem depois de 2.5 segundos, causando dano e envenenamento a inimigos próximos e soltando mais esporos"}, --  Mucormycosis
	...
	[585] = {"585", "", "Ao usar gera: #{{SoulHeart}} 3 Corações de Alma#{{AngelRoom}} 2 itens da Sala do Anjo#{{SoulHeart}} Deve ser carregado pegando Corações de Alma#{{DevilRoom}} Gera somente 2 Corações de Alma e 1 item do Anjo se um Acordo com o Diabo foi feito anteriormente"}, --  Alabaster Box
	...
	[612] = {"612", "", "Familiar de alma que morre com um golpe, ressurgindo no início do próximo andar#Se sobreviver a um andar inteiro, gerará 3 Corações de Alma, 2 Corações Eternos ou itens"}, --  Lost Soul
	...
	[652] = {"652", "", "Familiar que desliza pela sala#Ele diminui e causa dano ao contato, congelando monstros que mata"}, --  Cube Baby
	...
	[654] = {"654", "", "{{Pill}} Identifica todas as pílulas#{{BlackHeart}} +1 Coração Negro#Converte pílulas boas em ruins#↑ {{Damage}} Pílulas antiestáticas concedem +Dano#{{BlackHeart}} Outras pílulas deixam cair Corações Negros ao serem usadas"}, --  False PHD
...
local repTrinkets={
	...
	[101] = {"101", "", "!!! Enquanto segurar um item ativável completamente descarregado:#↑ {{Damage}} +1.5 Dano#↑ {{Speed}} +0.5 Velocidade#↑ {{Range}} +1.5 Alcance#↑ {{Tears}} +0.5 Lágrima#↑ {{Shotspeed}} +0.3 Velocidade de disparo#↑ {{Luck}} +2 Sorte"}, -- Dim Bulb
...
EID.descriptions[languageCode].horsepills={
	...
	{"21", "", "Drena todos os seus espaços de Corações exceto um#{{PHeart}} Gera 1-4 Corações Vermelhos"}, -- Hematemesis
