...
local repCollectibles={
	...
	[84] = {"84", "", "Gera um alçapão para o próximo andar#Gera um {{LadderRoom}}crawlspace se usado em um piso decorativo (grama, pedras pequenas, papéis, pedras preciosas, etc.)"}, -- We Need To Go Deeper!
...
local repCards={
	...
	[77] = {"77", "", "{{LadderRoom}} Gera um alçapão para o crawl space"},
