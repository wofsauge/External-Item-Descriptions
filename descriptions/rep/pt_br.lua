...
-- Last Sync with en_us: 07.05.2022
...
local repCollectibles={
	...
	[395] = {"395", "", "{{Chargeable}} Ganha a habilidade de atirar um anel de lazer que atravessa a sala#Dano baseado no progresso de carga#100% de dano na carga completa"}, -- Tech X
	...
	[543] = {"543", "", "Gera cocôs brancos ao receber dano#Enquanto dentro da área do cocô: #↑ {{Damage}} +25% de Dano#↑ {{Tears}} +150% Taxa de Disparo#Lágrimas teleguiadas#Chance de bloquear danos"}, -- Hallowed Ground
	[549] =	{"549", "", "{{EmptyBoneHeart}} Troca todos os seus espaços de Corações Vermelhos por 6 Corações de Osso#Quando perder um Coração de Osso:#Atire 8 lágrimas de osso em todas as direções#↑ {{Tears}} +0.4 Taxa de Disparo permanente"}, -- Brittle Bones
	...
	[614] = {"614", "", "↑ {{Heart}} +1 Espaço de Coração Vermelho#{{Heart}} Cura 5 Corações#{{HalfHeart}} Se o jogador não tiver bombas, uma pode ser colocada ao custo de Meio Coração#Bombas colocadas deixam uma poça vermelha"}, --  Blood Bombs
	...
	[617] = {"617", "", "{{Magnetize}} 17% de chance de atirar lágrimas que magnetizam os inimigos#{{Luck}} 100% com 5 de Sorte#Irá atrair pickups, projéteis e inimigos"}, --  Lodestone
	...
	[628] = {"628", "", "{{Warning}} USO ÚNICO {{Warning}}#Leva você a um andar contendo todos os itens do jogo#Depois de pegar um item, volte para a sala de onde veio"}, --  Death Certificate
	...
	[658] = {"658", "", "Gera Minisaacs quando você recebe dano#Eles perseguem e atiram em inimigos próximos"}, --  Giant Cell
	...
	[676] = {"676", "", "{{EmptyHeart}} Quando estiver com um Coração Vermelho ou menos no início de um novo andar, concede um Espaço de Coração Vazio#Nenhum efeito para personagens que não tem Corações Vermelhos"}, --  Empty Heart
	...
	[704] = {"704", "", "Ao usar entra no modo furioso por 5 segundos:#↑ {{Speed}} +0.4 Velocidade#↑ {{Tears}} Lágrimas#↑ {{Damage}} +3.0 Dano#Restringe os ataques a uma arma branca"}, --  Berserk!
...
local repTrinkets={
	...
	[156] = {"156","","{{Heart}} Ganhe um Espaço de Coração enquanto segurar#{{Player14}} Também funciona para o Keeper"}, --  Mother's Kiss
	...
	[173] = {"173","","{{DevilRoom}} Permite que você pegue um item da Sala do Diabo de graça#Comprar um item da Sala do Diabo destrói este trinket"}, --  Your Soul
