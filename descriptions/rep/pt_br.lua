...
local repCollectibles={
	...
	[29] = {"29", "", "↑ +5.25 Alcance#↑ +0.5 Altura da lágrima#Gera 3-6 moscas azuis"}, -- Moms Underwear
	[30] = {"30", "", "↑ +5.25 Alcance#↑ +0.5 Altura da lágrima#Tocar o inimigo causa 12 de dano"}, -- Mom's Heels
	[31] = {"31", "", "↑ +5.25 Alcance#↑ +0.5 Altura da lágrima#Gera 1 coração aleatório"}, -- Mom's Lipstick
	...
	[294] = {"294", "", "Recua inimigos e projéteis próximos#Inimigos empurrados contra obstáculos recebem 10 de dano#10% de chance de tornar o \"Wait What?\" mais forte ao trocá-lo por um item ativador diferente e pegá-lo novamente"}, -- Butter Bean
	...
	[416] = {"416", "", "Permite carregar duas cartas/pílulas/runas#Gera 1-3 moedas se a sala não rendeu recompensas#Aumenta o limite da moeda para 999"}, -- Deep Pockets
	...
	[564] = {"564", "", "↑ +0.57 Lágrimas#↑ +0.2 Velocidade de tiro"}, --  A Bar of Soap
