...
local repCollectibles={
	...
	[297] = {"297", "", "!!! USO ÚNICO !#!!! Solta coisas baseado no andar em que for ativado:#B1: 2 Corações de Alma#B2: 2 Chaves e bombas#C1: 1 Item de chefe#C2: B1+C1#D1: 4 Corações de alma#D2: 30 Moedas#W1: 2 Itens de chefe#W2: Bible#Sheol: 1 Item do Demônio + Coração negro#Cat: 1 Item do anjo + Coração de alma#Chest: 1 Moeda#Home: Red Key"}, -- Pandora's box
	...
	[342] = {"342", "", "↑ +1 Saúde#↑ +0.7 Lágrimas#↓ -16% Velocidade de disparo#Cura 2 Corações vermelhos"}, -- Blue Cap
	...
	[440] = {"440", "", "Ao parar de disparar, há chance de soltar uma explosão de lágrimas e uma pedra#↓ -17 Alcance#↑ +2.0 Altura da lágrima"},
	[448] = {"448", "", "Quando receber dano, chance de ganhar ↑ +5 Alcance#Concede lágrimas vermelhas#Deixe um rastro de sangue ou gera um coração vermelho"}, -- Shard of Glass
