...
local repCollectibles={
	...
	[375] = {"375", "Host hat", "Grants explosion immunity#20% chance to block tears"}, -- Host hat
...
EID.descriptions["en_us"].bookOfVirtuesWisps = {
	...
	[58] = {"Wisp is immune to projectiles"}, -- Book of Shadows
...
local repCards={
	...
	[57] = {"57", "I - The Magician?", "Grants an aura that repels enemis and projectiles for 1 minute"}, -- I - The Magician?
