...
local repCards={
	...
	[60] = {"60", "IV - The Emperor?", "Teleports you to an extra Boss room with extra loot#The boss is chosen from two floors depeer than the current one"}, -- IV - The Emperor?
