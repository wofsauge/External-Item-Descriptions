...
local repCollectibles={
	...
	[22] = {"22", "Lunch", "↑ +1 Health up#Heals one Red Heart"}, -- Lunch
	[23] = {"23", "Dinner", "↑ +1 Health up#Heals one Red Heart"}, -- Dinner
	[24] = {"24", "Dessert", "↑ +1 Health up#Heals one Red Heart"}, -- Dessert
	[25] = {"25", "Breakfast", "↑ +1 Health up#Heals one Red Heart"}, -- Breakfast
	[26] = {"26", "Rotten Meat", "↑ +1 Health up#Heals one Red Heart"}, -- Rotten Meat
	[29] = {"29", "Mom's Underwear", "↑ +1.5 Range up#↑ +0.5 Tear Height#Spawns 3-6 Blue Flies"}, -- Mom's Underwear
	...
	[101] = {"101", "The Halo", "↑ +1 Health up#↑ +0.3 Damage up#↑ +0.2 Tears up#↑ +0.38 Range up#↑ +0.3 Speed up#↑ +0.5 Tear Height#Heals one Red Heart"}, -- The Halo
	...
	[336] = {"336", "Dead Onion", "Piercing and spectral tears#↓ -1.5 Range down#↓ -0.4 Shot Speed down#↓ -0.5 Tear Height down#↑ +50% Tear size"}, -- Dead Onion
	...
	[344] = {"344", "Match Book", "+1 Black Heart#Spawns 2-3 Bomb pickups and the {{Trinket41}}Match Stick"}, -- Match Book
	...
	[354] = {"354", "Crack Jacks", "↑ +1 Health up#Spawns random trinket on the floor#Heals one Red Heart"}, -- Crack Jacks
	...
	[369] = {"369", "Continuum", "↑ +3 Range up#↑ +1.5 Tear Height up#Tears travel through walls and appear out of the opposite wall"}, -- Continuum
	[370] = {"370", "Mr. Dolly", "↑ +0.7 Tears up#↑ +1.5 Range up#↑ +0.5 Tear Height up#Spawns 3 random hearts when picked up"}, -- Mr. Dolly
	...
	[453] = {"453", "Compound Fracture", "Bone tears#Tears shatter into 1-3 smaller bone shards upon hitting anything#↑ +0.38 Range up#↑ +1 Tear Height"}, -- Compound Fracture
	...
	[549] =	{"549", "Brittle Bones", "Replaces all your Red Heart containers with 6 Bone Hearts#When losing a Bone Heart:#Fires 8 bone tears in all directions#↑ +0.4 Fire Rate up permanently"}, -- Brittle Bones
	...
	[577] = {"577", "Damocles", "{{Warning}} ONE TIME USAGE {{Warning}}#Spawns a sword above your head, which doubles all item pedestals#Does not double Shop, Chest, or Devil deal items#!!! Kills you at a random time after taking damage from an enemy"}, -- Damocles
	...
	[591] = {"591", "Venus", "+1 Health up#Heals one Red Heart#Close enemies become charmed"}, -- Venus
	...
	[622] = {"622", "Genesis", "{{Warning}} ONE TIME USAGE {{Warning}}#Removes all of Isaac's items and pickups#Teleports you to a unique bedroom with pickups, chests and a trapdoor#For every item lost, it shows a set of 3 items to choose from"}, -- Genesis
	...
	[636] = {"636", "R Key", "{{Warning}} ONE TIME USAGE {{Warning}}#Brings you back to the first floor of a new run#Items, stat boosts and pickups stay intact"}, -- R Key
	...
	[707] = {"707", "Supper", "↑ +1 Health up#Heals one Red Heart"}, -- Supper
...
local repTrinkets={
	...
	[142] = {"142", "Beth's Faith", "At the beginning of each floor, spawns 4 {{Collectible584}}Book of Virtues wisps"}, -- Beth's Faith
	...
	[152] = {"152", "Telescope Lens", "Increases the default chance for a Planetarium to spawn to 15%#Adds another 10% chance#More than one Planetarium can spawn#Planetariums can now spawn in the Womb and Corpse"}, -- Telescope Lens	
	...
	[165] = {"165", "Nuh Uh!", "On Womb and beyond, replaces all coin and key spawns with a random pickup or fly#Possible results: Bomb, Heart, Pill, Card, Trinket, Battery"}, -- Nuh Uh!
	...
	[186] = {"186", "Apollyon's Best Friend", "{{Throwable}} {{ColorOrange}}Throwable{{CR}} (double-tap shoot)#Grants 1 Familiar attack fly which you can aim and fire with"}, -- Apollyon's Best Friend
...
EID.descriptions["en_us"].bookOfVirtuesWisps = {
	...
	[44] = {"10% chance for tears to teleport enemies#Wisp flickers every 5 seconds"}, -- Teleport!
	...
	[97] = {"Spawns 1 of 7 wisps#Explosive effects are likely"}, -- The Book of Sin
	[102] = {"Spawns a pill when destroyed#6 possible effects, assigned to a color of wisp each run#Chance for Poison, Petrify, Confusion, Burn, or Troll Bomb tears, or spawning an enemy spider when destroyed"}, -- Mom's Bottle of Pills
	...
	[130] = {"Wisps charge in the direction you fire"}, -- A Pony
	...
	[160] = {"Summons beams of light when contacted"}, -- Crack the Sky
	...
	[283] = {"Rerolls your wisps, plus 1 random wisp#Does not reroll Book of Virtues"}, -- D100
	[284] = {"Removes all wisps, and gives a random wisp per 2 items owned#Does not reroll Book of Virtues"}, -- D4
	...
	[292] = {"+10% Devil/Angel Room chance per Satanic Bible wisp"}, -- Satanic Bible
	...
	[323] = {"Summons 6 wisps#3 second lifetime"}, -- Isaac's Tears
	...
	[383] = {"Wisp's tears can be detonated, turning into 6 of Isaac's tears#Isaac's tears burst when destroyed#Persists between rooms"}, -- Tear Detonator
