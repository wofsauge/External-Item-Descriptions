...
local repCollectibles={
	...
	[514] = {"514", "Broken Modem", "Causes some enemies and projectiles to briefly freeze at random intervals#Frozen projectiles disappear#25% chance to double room clear rewards#(Doesn't double chest, card or pill rewards)"},
	...
	[643] = {"643", "Revelation", "{{SoulHeart}} +2 Soul Hearts#Flight#{{Chargeable}} Chargeable high damage holy laser#Does not replace Isaac's tears"}, -- Revelation
	...
	[731] = {"731", "Stye", "↑ {{Damage}} x1.28 Damage multiplier for the right eye#↑ {{Range}} +7 Range for the right eye#↓ {{Shotspeed}} -0.3 Shot speed for the right eye"}, -- Stye
...
EID.descriptions[languageCode].bookOfVirtuesWisps = {
	...
	[130] = "Cannot shoot tears#Wisps charge in the direction Isaac shoots", -- A Pony
	...
	[290] = "Creates a wisp per heart instead#Chance to spawn a half Red Heart when destroyed", -- The Jar
