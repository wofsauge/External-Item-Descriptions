...
local repCollectibles={
	...
	[121] = {"121", "Odd Mushroom (Large)", "↑ +1 heart container#↑ +1.0 Damage up#↑ +0.38 Range up#↓ -0.2 Speed down"}, -- Odd Mushroom (Large)
	...
	[642] = {"642", "Magic Skin", "Consumes 1 heart container or 2 soul hearts to spawn an item of the current item pool#Also grants a broken heart container that can never be filled#{{Warning}} Single Use item for The Lost#The more times the item is used, the higher the change it replaces future item spawns"}, --  Magic Skin
...
local repTrinkets={
	...
	[174] = {"174", "Number Magnet", "+10% Devil deal chance#Prevents Krampus from appearing in Devil Deal#Devil Deals will be turned into special Devil deal rooms with enemies, items and 1-3 black hearts"}, --  Number Magnet
	...
	[187] = {"187", "Broken Glasses", "33% chance of adding an extra blind item in item rooms#Chance to reveal the blind item in alt path"}, --  Broken Glasses
...
local repCards={
	...
	[75] = {"75", "XIX - The Sun?", "Gain Spirit of the Night {{Collectible159}}#↑ +1.5 Damage up# For the current floor#Turns red hearts into bone hearts, but reverts once the effect ends#Applies Curse of Darkness"}, -- XIX - The Sun?
