...
local repTrinkets={
	...
	[58] = {"58", "Samson's Lock", "{{Damage}} 1/15 chance for +0.5 Damage up when killing an enemy#{{Luck}} 100% chance at 10 Luck#Effect lasts for current room"},
...
local repCards={
	...
	[62] = {"62", "VI - The Lovers?", "Spawns 1 item from current room's item pool#{{BrokenHeart}} Turns 1 Red Heart Container or 2 Soul Hearts into a broken heart"}, -- VI - The Lovers?
