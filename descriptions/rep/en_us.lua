...
local repTrinkets={
	...
	[152] = {"152", "Telescope Lens", "{{PlanetariumChance}} +9% Planetarium chance#Additional +15% Planetarium chance if one hasn't been entered yet#Planetariums can spawn in the Womb and Corpse"}, -- Telescope Lens
