...
local repTrinkets={
	...
	[158] = {"158", "Torn Pocket", "Upon hit, Isaac drops 2 of his Pickups#These pickups are subjected to standard drop rules, meaning the effect will usually result in a net positive#(Exception: Hearts, Cards, Pills, Runes)"}, --  Torn Pocket
