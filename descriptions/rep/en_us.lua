...
local repCollectibles={
	...
	[71] = {"71", "Mini Mush", "↑ +0.3 Speed up#↓ -1.5 Range down#↑ Size down"}, -- Mini Mush
	...
	[297] = {"297", "Pandora's Box", "!!! SINGLE USE !#!!! Drops things based on floor its activated on:#B1: 2 Soul Hearts#B2: 2 keys and bombs#C1: 1 Boss item#C2: B1+C1#D1: 4 Soul hearts#D2: 30 Coins#W1: 2 Boss items#W2: Bible#Sheol: 1 Devil item + Black heart#Cat: 1 Angel item + Soul heart#Chest: 1 Coin#Home: Red Key"}, -- Pandora's box
