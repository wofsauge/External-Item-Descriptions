...
local repCollectibles={
	...
	[307] = {"307", "Capricorn", "↑ {{Heart}} +1 Health#↑ {{Speed}} +0.1 Speed#↑ {{Tears}} +0.5 Fire rate#↑ {{Damage}} +0.5 Damage#↑ {{Range}} +0.75 Range#+1 {{Coin}} coin, {{Bomb}} bomb and {{Key}} key#{{Heart}} Heals 1 heart"}, -- Capricorn
...
EID.descriptions[languageCode].bookOfVirtuesWisps = {
	...
	[604] = "Counts as Middle ring wisp {{MiddleWisp}}#Single room wisp#Spawns 3 wisps where something lands#10% chance for {{Confusion}} confusion tears", -- Mom's Bracelet
	...
	[623] = "Middle ring wisp {{MiddleWisp}}sNo special effect", -- Sharp Key
