...
local repCollectibles={
	...
	[5] = {"5", "My Reflection", "Gives tears a boomerang effect#↑ {{Range}} +1.5 Range up#↑ {{Range}} +60% additional Range up#↑ {{Shotspeed}} +60% Shot Speed up"}, -- My Reflection
	...
	[13] = {"13", "The Virus", "{{Poison}} Poison touch#↑ {{Speed}} +0.2 Speed up"}, -- The Virus
	...
	[30] = {"30", "Mom's Heels", "↑ {{Range}} +1.5 Range up#Deal 12 contact damage to enemies"}, -- Mom's Heels
	...
	[69] = {"69", "Chocolate Milk", "{{Chargeable}} Chargeable tears#↑ {{Damage}} Up to 400% Damage"}, --Chocolate Milk
	...
	[77] = {"77", "My Little Unicorn", "Invincibility and +0.28 Speed up for 6 seconds#Deal 20 contact damage twice per second while invincible"}, -- My Little Unicorn
	[78] = {"78", "Book of Revelations", "{{SoulHeart}} +1 Soul Heart#A Horseman replaces the current floor's boss if used#{{AngelDevilChance}} +17.5% Devil or Angel Room chance while held"}, -- Book of Revelations
	...
	[83] = {"83", "The Nail", "{{HalfBlackHeart}} + Half Black Heart#↑ {{Damage}} +2 Damage up#↓ {{Speed}} -0.18 Speed down#Deal 40 contact damage per second#Destroy rocks when walking over them"}, -- The Nail
	...
	[91] = {"91", "Spelunker Hat", "Reveals the room type of up to 2 adjacent rooms#{{SecretRoom}} Can also reveal Secret and Super Secret Rooms#Blocks projectiles falling from above"}, -- Spelunker Hat
	...
	[135] = {"135", "IV Bag", "Portable blood bank#Half a heart = 1-2 coins#{{HardMode}} 1 coin on Hard Mode#{{Player14}} 0-1 coin as Keeper"}, -- IV Bag
	[138] = {"138", "Stigmata", "↑ {{Heart}} +1 Health up#{{Heart}} Heals 1 Red Heart#↑ {{Damage}} +0.3 Damage up#"}, -- Stigmata
	[139] = {"139", "Mom's Purse", "{{Trinket}} You can now hold 2 trinkets#{{Trinket}} Spawns 1 random trinket"}, -- Mom's Purse
	[140] = {"140", "Bob's Curse", "{{Poison}} Poison bombs#Bombs leave a poison cloud#Makes you immune to poison damage#{{Bomb}} +5 bombs"}, -- Bob's Curse
	[142] = {"142", "Scapular", "{{SoulHeart}} Once per room, when damaged down to half a heart, you gain 1 Soul Heart#!!! Doesn't trigger from donation effects"}, --Scapular
	...
	[149] = {"149", "Ipecac", "{{Poison}} Explosive poison tears#↑ {{Damage}} +40 Damage up#↓ {{Shotspeed}} -0.2 Shot Speed down#↓ {{Tears}} -67% Fire Rate down#↓ {{Range}} -20% Range down"}, -- Ipecac
	[152] = {"152", "Technology 2", "Replaces your right eye with a continuous laser#{{Damage}} Laser deals 13% of your damage#↓ {{Tears}} -33% Fire Rate down"}, -- Technology 2
	[153] = {"153", "Mutant Spider", "Quad shot!#↓ {{Tears}} -58% Fire Rate down"}, -- Mutant Spider
	...
	[158] = {"158", "Crystal Ball", "Reveals the full map#Drops a: #{{SoulHeart}} Soul Heart#{{Card}} Random Card#{{Rune}} Random Rune#While held:#{{PlanetariumChance}} +15% Planetarium chance#100% if a {{TreasureRoom}} Treasure Room was skipped"}, -- Crystal Ball
	[161] = {"161", "Ankh", "{{Player4}} Respawn as ??? (Blue Baby) on death#{{Player25}} Tainted ??? will revive himself"},
	[169] =	{"169", "Polyphemus", "↑ {{Damage}} +100% Damage up#↑ {{Damage}} +4 additional Damage up#↓ {{Tears}} -58% Fire Rate down#Tears travel on after killing an enemy with any leftover damage"}, --Polyphemus
	[171] = {"171", "Spider Butt", "{{Slow}} Slows down enemies for 4 seconds#10 damage to all enemies#Enemies killed with it spawn blue spiders"}, -- Spider Butt
	...
	[188] = {"188", "Abel", "Mirrors your movement#Shoots towards the player#Deals 3.5 damage per shot#{{Player2}} Deals 7.5 damage as Cain"}, -- Abel
	...
	[192] = {"192", "Telepathy for Dummies", "Grants for the current room: #↑ {{Range}} +3 Range up#Homing tears"}, -- Telepathy for Dummies
	...
	[203] = {"203", "Humbleing Bundle", "50% chance to spawn the double version of pickups"}, -- Humbling Bundle
	[205] = {"205", "Sharp Plug", "{{Battery}} On use, fully recharges your active item at the cost of half a heart per charge#Prioritizes Red Hearts"}, -- Sharp Plug
	[206] = {"206", "Guillotine", "↑ {{Damage}} +1 Damage up#↑ {{Tears}} +0.5 Fire Rate up#Your head is now an orbital which doesn't take damage and deals 105 contact damage#You will still shoot from the head"}, -- Guillotine
	...
	[222] =	{"222", "Anti-Gravity", "Holding the fire buttons causes tears to hover in midair#When released, they will all shoot in the direction they were fired#↑ {{Tears}} +1 Fire Rate up"}, -- Anti-Gravity
	...
	[254] = {"254", "Blood Clot", "!!! Applies only for the left eye#↑ {{Damage}} +1 Damage up#↑ {{Range}} +1.5 Range up"}, -- Blood Clot
	[256] = {"256", "Hot Bombs", "{{Burning}} Burning bombs#You can no longer take fire damage#Bombs deal contact damage#{{Bomb}} +5 Bombs"}, -- Hot Bombs
	[261] = {"261", "Proptosis", "↑ {{Damage}} +0.5 Damage up#↓ Tears deal less Damage the longer they're airborne#300% Damage at point blank range"}, -- Proptosis
	[262] = {"262", "Missing Page 2", "{{BlackHeart}} +1 Black Heart#When down to 1 Heart, damages all enemies in the room#{{Collectible35}} Black Hearts and Necronomicon effects deal double damage"}, -- Missing Page 2
	[263] = {"263", "Clear Rune", "{{Rune}} Copies the effects of held rune or soul stone#Drops 1 random rune on pickup"}, -- Clear Rune (REPENTANCE ITEM)
	...
	[274] = {"274", "Best Bud", "When you get hit, gain one midrange orbital for the room#Orbital deals 150 damage per second"}, -- Best Bud
	[275] = {"275", "Lil Brimstone", "{{Collectible118}} Familiar that charges to shoot a brimstone laser#Shot deals 2 damage per tick, for a total of 20 damage"}, -- Lil Brimstone
	...
	[278] = {"278", "Dark Bum", "{{Heart}} Collects Red Hearts from the floor#Every 1.5 hearts, spawns a Black Heart, card, pill, rune, or spider"}, -- Dark Bum
	[280] = {"280", "Sissy Longlegs", "Randomly spawns blue spiders when in a hostile room#{{Charm}} Charms enemies it comes in contact with"}, -- Sissy Longlegs
	...
	[287] = {"287", "Book of Secrets", "On use, highlights tinted and crawlspace rocks#Gain one of these effects for the floor: #{{Collectible54}} Treasure Map#{{Collectible21}} Compass #{{Collectible246}} Blue Map#Only grants effects you don't have already#{{Collectible76}} If all effects are active, grants X-Ray Vision"}, -- Book of Secrets
	...
	[292] = {"292", "Satanic Bible", "{{BlackHeart}} +1 Black Heart#{{DevilRoom}} When used before a boss fight, the Boss Room item will be a Devil deal#!!! Taking that item locks you into Devil deals for the rest of the run"}, -- Satanic Bible
	[294] = {"294", "Butter Bean", "Knocks back nearby enemies and projectiles#Enemies pushed into obstacles take 10 damage"}, -- Butter Bean
	[295] = {"295", "Magic Fingers", "Damages the whole room with 2x the player damage + 10#{{Coin}} Price: 1 coin"}, -- Magic Fingers
	...
	[332] = {"332", "Lazarus' Rags", "{{Player11}} When dead, revive as Lazarus (Risen)#{{Player29}} Tainted Lazarus will revive himself"},
	...
	[350] = {"350", "Toxic Shock", "{{Poison}} At the start of every room every enemy gets a poison effect#Grants immunity for toxic clouds#Killed enemies leave puddle of creep"}, -- Toxic Shock
	[352] = {"352", "Glass Cannon", "Fires one large piercing spectral tear ((DMG x 10) + 10)#!!! When you take damage:#↓ You will lose an extra 2 hearts of health#↑ {{Range}} +1.5 Range up and leave blood creep for the room#The extra damage can't kill you#Self-damage does not count"}, -- Glass Cannon
	[354] = {"354", "Crack Jacks", "↑ {{Heart}} +1 Health up#{{Heart}} Heals 1 Red Heart#{{Trinket}} Spawns random trinket on the floor"}, -- Crack Jacks
	[355] = {"355", "Mom's Pearls", "↑ {{Range}} +0.38 Range up#↑ {{Luck}} +1 Luck up#{{SoulHeart}} +1 Soul Heart"}, -- Mom's Pearls
	[360] = {"360", "Incubus", "Gain a demonic familiar that shoots the same tears as Isaac#{{Damage}} Deals 75% of your damage#{{Player13}} 100% while playing as Lilith"}, -- Incubus
	[365] = {"365", "Lost Fly", "Moves along walls/obstacles in the room#Deals 56 contact damage per second#Nearby enemies will target the Fly"},
	[366] = {"366", "Scatter Bombs", "{{Bomb}} +5 bombs#Causes your bombs to explode into 4-5 tiny bombs"}, -- Scatter Bombs
	[368] =	{"368", "Epiphora", "↑ {{Tears}} Shooting in one direction gradually increases your fire rate by up to 200%"}, -- Epiphora
	[369] = {"369", "Continuum", "↑ {{Range}} +3 Range up#Spectral tears#Tears travel through walls and appear out of the opposite wall"}, -- Continuum
	[370] = {"370", "Mr. Dolly", "↑ {{Tears}} +0.7 Tears up#↑ {{Range}} +1.5 Range up#{{Heart}} Spawns 3 random hearts when picked up"}, -- Mr. Dolly
	[374] = {"374", "Holy Light", "10% chance to shoot Holy tears, which will spawn a beam of light on hit#{{Luck}} 50% chance at 9 Luck#{{Damage}} The beam deals 3x your damage"}, -- Holy Light
	[375] = {"375", "Host Hat", "Grants explosion immunity#20% chance to block tears#Blocks projectiles falling from above"}, -- Host Hat
	[376] = {"376", "Restock", "Shops instantly restock their items when you buy them#Restocked items increase in price each time"}, -- Restock
	[380] = {"380", "Pay To Play", "{{Coin}} +5 coins#You now open locked doors and chests with coins instead of keys"},
	...
	[384] = {"384", "Lil Gurdy", "{{Chargeable}} Will launch and slide around the room with speed based on charge amount#Deals 5-25 contact damage per hit depending on speed"}, -- Lil Gurdy
	[389] = {"389", "Rune Bag", "{{Rune}} Drops a random rune or Soul Stone every 7-8 rooms"}, -- Rune Bag
	[393] = {"393", "Serpent's Kiss", "{{Poison}} 15% chance to shoot poison tears#{{Luck}} Not affected by Luck#{{Poison}} Poison enemies on contact#{{BlackHeart}} Enemies killed with contact poison have a 20% chance to drop a Black Heart"}, -- Serpent's Kiss
	[394] = {"394", "Marked", "Fire tears automatically directed at a red target on the ground which is controlled by the player#↑ {{Tears}} +0.7 Tears up#↑ {{Range}} +3 Range up#Familiars shoot towards the target"}, -- Marked
	[395] = {"395", "Tech X", "{{Chargeable}} Change your tears to a chargeable laser ring that travels across the room#Higher damage and larger ring size with longer charge#100% damage on full charge"}, -- Tech X
	[397] = {"397", "Tractor Beam", "Your tears now travel directly in front of where you're facing, even as you move or turn#↑ {{Tears}} +1 Fire Rate up#↑ {{Range}} +1.5 Range up#↑ {{Shotspeed}} +0.16 Shot Speed up"},
	[399] = {"399", "Maw of the Void", "{{Chargeable}} After firing tears for 3 seconds, a red cross appears on Isaac's head. Upon releasing the fire button, creates a black brimstone ring"}, -- Maw of the Void
	[401] = {"401", "Explosivo", "25% chance to fire sticky bomb tears#{{Luck}} Not affected by Luck#They explode after a few seconds and deal your damage + 60"}, -- Explosivo
	[404] = {"404", "Farting Baby", "Familiar that blocks projectiles#When hit, 10% chance to fart, which will charm, poison or knockback enemies#The farts deal 5-6 damage"}, -- Farting Baby
	...
	[407] = {"407", "Purity", "↑ Boost one of your stats depending on the color of the aura around you#When you take damage, you lose the aura for the room, and will get a new aura next room#{{ColorRed}}Red{{CR}} = {{Damage}} +4 Damage up#{{ColorBlue}}Blue{{CR}} = {{Tears}} +2 Fire Rate up#{{ColorYellow}}Yellow{{CR}} = {{Speed}} +0.5 Speed up#{{ColorOrange}}Orange{{CR}} = {{Range}} +3 Range up"},
	...
	[448] = {"448", "Shard of Glass", "Upon taking damage:#{{Heart}} 25% chance to drop a Red Heart#You start bleeding, spewing tears in the direction you're shooting#The bleeding does a half Red Heart of damage every 20 seconds#You stop bleeding if you heal Red Heart damage, have no Red Hearts, or are about to die"}, -- Shard of Glass
	[450] = {"450", "Eye of Greed", "Every 20 tears, shoot a coin tear that deals 1.5x damage + 10#Hit enemies drop a coin and temporarily turn to gold#Gold enemies drop 1-3 coins if killed#!!! The coin tear costs 1 coin"}, -- Eye of Greed
	[451] = {"451", "Tarot Cloth", "{{Card}} Drops a random card on pickup#{{Card}} Some cards gain an extra or doubled effect"}, -- Tarot Cloth
	[453] = {"453", "Compound Fracture", "↑ {{Range}} +0.38 Range up#Bone tears#Tears shatter into 1-3 smaller bone shards upon hitting anything"}, -- Compound Fracture
	...
	[459] = {"459", "Sinus Infection", "{{Poison}} 20% chance to shoot sticky poison tears#{{Luck}} Not affected by Luck#Deals your damage each second#Sticks for 10 seconds"}, -- Sinus Infection
	[462] = {"462", "Eye of Belial", "↑ {{Range}} +1.5 Range up#Grants piercing tears#After hitting the first enemy, the tear deals double damage and gains a homing effect"}, -- Eye of Belial
	[464] = {"464", "Glyph of Balance", "{{SoulHeart}} +2 Soul Hearts#Drops from champion enemies and room clears will be modified to be whatever pickup you need the most"}, -- Glyph of Balance
	[472] = {"472", "King Baby", "Other familiars follow it and shoot automatically at enemies#Stops moving when you are shooting#Will move back to you when you stop shooting"}, -- King Baby
	...
	[494] = {"494", "Jacob's Ladder", "Tears spawn a spark of electricity on impact#Sparks deal half your damage#Sparks can jump between enemies"}, -- Jacob's Ladder
	[495] = {"495", "Ghost Pepper", "8% chance to shoot a blue fire that blocks enemy shots and deals contact damage#{{Luck}} 50% chance at 10 Luck#The flame disappears after 2 seconds"}, -- Ghost Pepper
	[496] = {"496", "Euthanasia", "3.33% chance to shoot needles#{{Luck}} 25% chance at 15 Luck#Needles kill normal enemies instantly, bursting them into 10 tears#Needles deal 3x damage against bosses"}, -- Euthanasia
	[497] = {"497", "Camo Undies", "When you enter a room, camouflage yourself and confuse all enemies until you start shooting#↑ {{Speed}} +0.5 Speed up while cloaked#Upon uncloak, deal damage around you and gain a very brief Fire Rate and Damage up"},
	[501] = {"501", "Greed's Gullet", "Gain 1 Heart Container for every 25 coins you have#{{Player14}} Keeper can gain additional Coin Hearts#{{Collectible416}} Gain 1 Heart Container for every 100 coins you have past 99"}, -- Greed's Gullet
	[503] = {"503", "Little Horn", "5% chance to shoot tears that summon a Big Horn hand#{{Luck}} 20% chance at 15 Luck#The hand kills enemies instantly and deals damage to bosses#Running into enemies deals 3.5 damage to them"}, -- Little Horn
	[504] = {"504", "Brown Nugget", "Spawns a fly turret that shoots at enemies#Each shot deals 3.5 damage"}, -- Brown Nugget
	[506] = {"506", "Backstabber", "If tears hit an enemy in the back, they do double damage and cause bleeding, which makes enemies leave creep and take damage when they move"},
	[507] = {"507", "Sharp Straw", "{{Damage}} Deals your damage + 10% of the enemy's max health#Affects all enemies in the room#{{HalfHeart}} Chance to drop half hearts when it deals damage"},
	[508] = {"508", "Mom's Razor", "Orbital that causes bleeding, which makes enemies leave creep and take damage when they move#Deals 20% your damage on contact per tick"},
	[509] = {"509", "Bloodshot Eye", "Orbital that shoots a tear every 0.33 seconds when an enemy is nearby#Deals 3.5 damage per tear#Deals 30 contact damage per second"}, -- Bloodshot Eye
	[514] = {"514", "Broken Modem", "Causes random enemies to 'lag' at random intervals, causing them to shortly freeze#Chance to freeze and remove enemy bullets#25% chance to double room clear drops"},
	[517] = {"517", "Fast Bombs", "{{Bomb}} +7 Bombs#Allows you to rapidly place bombs on the ground#Bombs don't knockback each other"}, -- Fast Bombs
	...
	[531] = {"531", "Haemolacria", "Tears fly in an arc and burst into smaller tears on impact#↑ {{Damage}} +1 Damage up#↑ {{Damage}} +50% Damage Multiplier#↓ {{Tears}} -67% Fire Rate down#↓ {{Range}} -20% Range down"}, -- Haemolacria
	[535] = {"535", "Blanket", "{{SoulHeart}} +1 Soul Heart#{{Heart}} Heals 1 Red Heart#{{HolyMantle}} Grants a shield when entering a boss room"},
	[543] = {"543", "Hallowed Ground", "Spawn white poop when you get hit#While inside the poop's aura:#↑ {{Damage}} +20% Damage up#↑ {{Tears}} +150% Fire Rate up#Homing tears#Chance to block damage"}, -- Hallowed Ground
	[549] =	{"549", "Brittle Bones", "{{EmptyBoneHeart}} Replaces all your Red Heart containers with 6 empty Bone Hearts#When a Bone Heart is lost:#Fires 8 bone tears in all directions#↑ {{Tears}} +0.4 Fire Rate up permanently"}, -- Brittle Bones
	...
	[553] = {"553", "Mucormycosis", "25% chance to shoot sticky spore tears#{{Luck}} Not affected by Luck#Spores blow up after 2.5 seconds, dealing damage, poisoning nearby enemies and releasing more spores"}, -- Mucormycosis
	[554] = {"554", "2Spooky", "{{Fear}} Fears enemies in a small radius around you"}, -- 2Spooky
	[555] = {"555", "Golden Razor", "{{Coin}} Converts 5 coins into {{Damage}} +1.2 Damage up for the current room#{{Coin}} +5 coins"}, -- Golden Razor
	[556] = {"556", "Sulfur", "{{Collectible118}} Grants Brimstone for the current room"}, -- Sulfur
	[557] = {"557", "Fortune Cookie", "Gives Isaac one thing of the following list: #A fortune#{{SoulHeart}} Soul Heart#{{Card}} Tarot card#{{Rune}} Rune or Soul Stone#{{Trinket}} Trinket"}, -- Fortune Cookie
	[558] = {"558", "Eye Sore", "Chance to shoot 1-3 extra tears in random directions#{{Luck}} Not affected by Luck"}, -- Eye Sore
	[559] = {"559", "120 Volt", "Repeatedly zaps close enemies#{{Damage}} Electricity deals 75% of your damage"}, -- 120 Volt
	[560] = {"560", "It Hurts", "Release a ring of 10 tears which deal 10 damage and get tears up for the room when hit#↑ {{Tears}} +1.2 Fire Rate up for first hit#↑ {{Tears}} +0.4 for each additional hit"}, -- It Hurts
	[561] = {"561", "Almond Milk", "↑ {{Tears}} 4x Fire Rate up#↓ {{Damage}} -70% Damage down#Tears gain random worm trinket effects and some item effects"}, -- Almond Milk
	[562] = {"562", "Rock Bottom", "↑ Prevents stats from being lowered for the rest of the run"}, -- Rock Bottom
	[563] = {"563", "Nancy Bombs", "{{Bomb}} +5 bombs#Bombs explode with a random bomb effect"}, -- Nancy Bombs
	...
	[573] = {"573", "Immaculate Heart", "↑ {{Heart}} +1 Health up#{{Heart}} Full health#↑ {{Damage}} +20% Damage up#20% chance to shoot additional orbiting spectral tears"}, -- Immaculate Heart
	...
	[594] = {"594", "Jupiter", "↑ {{Heart}} +2 Health up#{{HalfHeart}} Heals half a Red Heart#↓ {{Speed}} -0.3 Speed down#↑ {{Speed}} Build up to +0.5 Speed while standing still#{{Poison}} Makes you immune to poison damage#{{Poison}} Moving releases poison fart clouds behind you"}, -- Jupiter
	...
	[596] = {"596", "Uranus", "{{Freezing}} Shoot ice tears, which slow enemies and freeze monsters they kill#Touching frozen enemies slide away and explode into 6 ice shards"}, -- Uranus
	[597] = {"597", "Neptunus", "{{Chargeable}} Chargeable (automatic)#Builds a massive tears bonus over 3 seconds while not firing#Shooting again will release stored tears#The tear bonus falls off as you fire"}, -- Neptunus
	...
	[599] = {"599", "Voodoo Head", "{{CursedRoom}} Spawns an additional Curse Room each floor#Improves Curse Room layouts and rewards"}, -- Voodoo Head
	[600] = {"600", "Eye Drops", "↑ {{Tears}} +30% Fire Rate up for the left eye only#↑ {{Tears}} +20% Fire Rate up for non-tear attacks#First shot in a while is always a double shot#"}, -- Eye Drops
	[601] = {"601", "Act of Contrition", "↑ {{Tears}} +0.7 Tears up#{{EternalHeart}} +1 Eternal Heart#{{AngelChance}} Allows Angel Rooms to spawn even if you've taken a Devil deal#Taking Red Heart damage doesn't reduce Devil/Angel Room chance as much"}, -- Act of Contrition
	[602] = {"602", "Member Card", "{{Shop}} Adds a trapdoor to every shop that leads to a second shop with a unique stock"}, -- Member Card
	[603] = {"603", "Battery Pack", "{{Battery}} Spawns 2-4 batteries#Fully recharges your active item"}, -- Battery Pack
	...
	[605] = {"605", "The Scooper", "Upon use:#Summons a Peeper familiar for the current room, which leaves a trail of red creep#↑ {{Damage}} +34% Damage Multiplier for your right eye only"}, -- The Scooper
	...
	[612] = {"612", "Lost Soul", "Soul familiar that dies in one hit, respawning at the start of the next floor#If it survives an entire floor, it spawns {{SoulHeart}} 3 Soul Hearts, {{EternalHeart}} 2 Eternal Hearts, or a {{TreasureRoom}} Treasure Room or {{AngelRoom}} Angel Room item"}, -- Lost Soul
	[613] = {"613", "", "<Item does not exist>"}, -- Salt Shaker
	[614] = {"614", "Blood Bombs", "↑ {{Heart}} +1 Health up#{{Heart}} Heals 5 hearts#{{HalfHeart}} If the player has no bombs, one can be placed at the cost of half a heart#Placed bombs leave red creep#"}, -- Blood Bombs
	[615] = {"615", "Lil Dumpy", "Dumpy familiar#Right before Isaac would collide with an enemy or projectile, Dumpy farts to deflect them away#After farting, you need to get close to Dumpy to regain him"}, -- Lil Dumpy
	[616] = {"616", "Bird's Eye", "8% chance to shoot red fires that block enemy shots and deal contact damage#{{Luck}} 50% chance at 10 Luck#Fires can block up to 4 shots and/or deal damage 4 times before being destroyed, and last up to 10 seconds"}, -- Bird's Eye
	[617] = {"617", "Lodestone", "{{Magnetize}} 17% chance to shoot tears that magnetize enemies#{{Luck}} 100% chance at 5 Luck#Magnetized enemies attract nearby pickups, projectiles and enemies"}, -- Lodestone
	...
	[625] = {"625", "Mega Mush", "Gigantifies you for 30 seconds, which persists between rooms#While Giant, you have:#↑ {{Damage}} +300% Damage Multiplier#↑ {{Range}} +7 Range up#↓ {{Tears}} -60% Fire Rate down#Ability to crush enemies and obstacles#Complete invincibility"}, -- Mega Mush
	...
	[629] = {"629", "Bot Fly", "Orbital that fires shielded tears at enemy projectiles"}, -- Bot Fly
	[630] = {"630", "", "<Item does not exist>"},
	[631] = {"631", "Meat Cleaver", "Splits each enemy in the room into 2 smaller versions of itself with much less health"}, -- Meat Cleaver
	[632] = {"632", "Evil Charm", "↑ {{Luck}} +2 Luck up#Makes you immune to burn, confusion, fear, poison, and toxic gas"}, -- Evil Charm
	[633] = {"633", "Dogma", "Grants flight and one-time {{Collectible313}} Holy Mantle effect#↑ {{Damage}} +2 Damage up#↑ {{Speed}} +0.1 Speed up#If player has fewer than 6 hearts, heals him with combination of Red and Soul Hearts"}, -- Dogma
	...
	[637] = {"637", "Knockout Drops", "10% chance to shoot a fist with extreme knockback and confusion effect#{{Luck}} 100% chance at 9 Luck"}, -- Knockout Drops
	...
	[639] = {"639", "Yuck Heart", "{{RottenHeart}} Grants a Rotten Heart upon use"}, -- Yuck Heart
	...
	[642] = {"642", "Magic Skin", "{{BrokenHeart}} Turns 1 Heart Container or 2 Soul Hearts into a Broken Heart#Spawns an item from the current room's item pool#!!! Replaces future items if Isaac isn't holding it#33% after 1 use, 50% after 2, 100% after 3#Lower chance if Magic Skin is on a pedestal on the current floor#{{Player10}} Single use for The Lost"}, -- Magic Skin
	[643] = {"643", "Revelation", "{{Chargeable}} Chargeable Holy Laser#Grants flight and {{SoulHeart}} 2 Soul Hearts"}, -- Revelation
	[644] = {"644", "Consolation Prize", "↑ Increases your lowest stat#Drops either {{Coin}} 3 coins, {{Bomb}} 1 bomb, or {{Key}} 1 key depending on what you have the least of"}, -- Consolation Prize
	...
	[646] = {"646", "Brimstone Bombs", "{{Bomb}} +5 bombs#{{Collectible118}} Bombs release 4 Brimstone lasers in the cardinal directions"}, -- Brimstone Bombs
	[647] = {"647", "4.5 Volt", "Active items don't charge when clearing rooms#They charge by dealing damage to enemies#Damage needed per charge increases each floor#Formula: 40 + 20 * floor"}, -- 4.5 Volt
	...
	[651] = {"651", "Star of Bethlehem", "Familiar that emits an aura and slowly travels towards the {{BossRoom}} Boss Room#While standing in the aura, grants:#↑ {{Damage}} +1 Damage up#↑ {{Damage}} +20% Damage Multiplier#↑ {{Tears}} +150% Tears Multiplier#Homing tears"}, -- Star of Bethlehem
	[652] = {"652", "Cube Baby", "Familiar that slides around when walked into#{{Freezing}} It slows and deals contact damage, freezing monsters it kills"}, -- Cube Baby
	...
	[654] = {"654", "False PHD", "{{Heart}} +1 Black Heart#{{Pill}} Identifies all pills#{{Pill}} Converts good pills into bad pills#↑ {{Damage}} Stat down pills also grant Damage up#{{BlackHeart}} Other pills drop Black Hearts on use"}, -- False PHD
	...
	[664] = {"664", "Binge Eater", "↑ {{Heart}} +1 Health up#{{Heart}} Full health#Food items heal 3 Red Hearts#Item pedestals periodically switch between food items and the item they would hold otherwise#Picking up a food item grants: #↑ {{Damage}} temporary +3.6 damage boost#↑ 2 small permanent stat ups#↓ {{Speed}} -0.03 speed down"}, -- Binge Eater
	[665] = {"665", "Guppy's Eye", "Shows the contents of {{Chest}} Chests, {{GrabBag}} Sacks, Shopkeepers, and Fire Places before they're opened"}, -- Guppy's Eye
	[666] = {"666", "", "<Item does not exist>"},
	[667] = {"667", "Strawman", "{{Bomb}} +1 Bomb#{{Player14}} Spawns Keeper as a second character#When he dies, spawns blue spiders and completely removes this item#{{DevilRoom}} Devil Room items cost coins while he's alive#!!! He can pick up items, including Story items, removing them permanently on death"}, -- Strawman
	...
	[671] = {"671", "Candy Heart", "Gives random permanent stat boost when healing with Red Heart pickups#{{Heart}} Spawns 1 Red Heart"}, -- Candy Heart
	[672] = {"672", "A Pound of Flesh", "{{DevilRoom}} Devil Room items now cost coins#{{Shop}} Shop items now cost health#Consumables in shops are free, but surrounded by spikes"}, -- A Pound of Flesh
	[673] = {"673", "Redemption", "{{DevilRoom}} After entering a Devil Room and not taking any item/pickup, grant:#{{SoulHeart}} +1 Soul Heart#↑ {{Damage}} +1 Damage up"}, -- Redemption
	...
	[676] = {"676", "Empty Heart", "When down to 1 Red Heart or less at the start of a new floor, grants an {{EmptyHeart}} Empty Heart Container#No effect for characters that can't have Red Hearts"}, -- Empty Heart
	...
	[678] = {"678", "C Section", "{{Chargeable}} Gain a short delay charge attack that fires homing, spectral fetus tears"}, -- C Section
	[679] = {"679", "Lil Abaddon", "{{Collectible399}} Familiar which shoots a mini Maw of the Void attack"}, -- Lil Abaddon
	[680] = {"680", "Montezuma's Revenge", "{{Chargeable}} While firing, charge up a short-ranged Brimstone#Shoots behind you"}, -- Montezuma's Revenge
	...
	[686] = {"686", "Soul Locket", "{{SoulHeart}} Grants a permanent stat boost whenever you pick up a Soul Heart#{{SoulHeart}} Spawns a Soul Heart on pickup"}, -- Soul Locket
	...
	[699] = {"699", "Azazel's Rage", "Build rage every time a room is cleared#After 4 rooms, fires a large {{Collectible118}} Brimstone laser when entering the next room"}, -- Azazel's Rage
	...
	[708] = {"708", "Stapler", "↑ {{Damage}} +1 Damage up#Prevents Isaac from firing tears from one eye"}, -- Stapler
	[709] = {"709", "Suplex!", "Allows you to dash into and pick up enemies or bosses, then slam them into the ground#Slam location can be controlled#Slam deals 50 damage and spawns rock waves#Scales in damage and area of effect with the player's size"}, -- Suplex!
	...
	[719] = {"719", "Keeper's Box", "{{Shop}} Spawns a random shop item/pickup for purchase"}, -- Keeper's Box
	...
	[724] = {"724", "Hypercoagulation", "{{Heart}} Upon taking enemy damage, drop a half or full Red Heart#Spawned hearts launch out and despawn after 1.5 seconds"}, -- Hypercoagulation
	[725] = {"725", "IBS", "After dealing enough damage, stop attacking to trigger a random {{Player25}}Tainted ??? effect:#Throw a random poop#Create buffing creep#Poison fart cloud#Drop 5 live bombs"}, -- IBS
	[726] = {"726", "Hemoptysis", "Double-tap a fire button to sneeze blood#Deals 150% your damage to enemies in front of you#1 second cooldown#{{BrimstoneCurse}} Affected enemies take extra damage from Brimstone beams"}, -- Hemoptysis
	[727] = {"727", "Ghost Bombs", "{{Bomb}} +5 bombs#Bombs spawn ghosts that deal contact damage and explode after 10 seconds"}, -- Ghost Bombs
	...
	[731] = {"731", "Stye", "!!! Applies only for the right eye#↑ {{Damage}} +28% Damage up#↑ {{Range}} +7 Range up#↓ {{Shotspeed}} -0.3 Shot Speed down"}, -- Stye
	[732] = {"732", "Mom's Ring", "↑ {{Damage}} +1 Damage up#{{Rune}} Spawns a random rune or soul stone on pickup"}, -- Mom's Ring
...
EID.descriptions[languageCode].birthright ={
	...
	{"Magdalene", "", "↑ {{Heart}} +1 Health up#{{Heart}} Maximum heart limit is raised to 18"},
	{"Cain", "", "↑ {{Luck}} +1 Luck up#{{Arcade}} All floors will contain an upgraded Arcade Room except for Dark Room and Chest#{{Collectible46}} Greatly increases Lucky Foot's chances of winning effect"},
	...
	{"Apollyon", "", "{{Collectible477}} Using Void has a chance to spawn an item that was previously voided#Stat bonuses are kept#The more items voided, the higher the chance for an item to spawn upon use"},
	...
	{"Tainted Magdalene", "", "{{Heart}} Adds 1 more Red Heart that doesn't drain"},
	...
	{"Tainted ???", "", "{{PoopPickup}} Increases the maximum number of carried poops to 29"},
	...
	{"Tainted Jacob 2", "", "Dark Esau splits into two, creating a shadowy clone of itself#Both Esaus will always charge at the same time#{{Collectible722}} Using Anima Sola chains them both"},
	{"Tainted Forgotten Soul", "", "{{Collectible714}} Tainted Soul gains the Recall ability, to retrieve the Tainted Forgotten from a distance"},
}
...
local repTrinkets={
	[1] = {"1", "Swallowed Penny", "{{Coin}} Spawns 1 coin when you get hit#{{Player14}} 0-1 as Keeper"}, -- Swallowed Penny
	...
	[33] = {"33", "Umbilical Cord", "At half a Red Heart or less, you gain#{{Collectible100}} Little Steven#{{Collectible318}} High chance to spawn Gemini familiars for the room when taking damage"}, -- Umbilical Cord
	[39] = {"39", "Cancer", "↑ {{Tears}} +1 Fire Rate up"},
	[48] = {"48", "A Missing Page", "When hit, 5% chance to deal 80 damage to all enemies in the room#{{Collectible35}} Black Hearts and Necronomicon-like effects deal 2x damage"}, -- A Missing Page
	[49] = {"49", "Bloody Penny", "{{HalfHeart}} 25% chance to drop half a heart when picking up coins"}, -- Bloody Penny
	[50] = {"50", "Burnt Penny", "{{Bomb}} 25% chance to drop a bomb when picking up coins"}, -- Burnt Penny
	[51] = {"51", "Flat Penny", "{{Key}} 25% chance to drop a key when picking up coins"}, -- Flat Penny
	...
	[96] = {"96", "Ouroboros Worm", "Tears move quickly in a spiral pattern#↑ +0.4 Tears up#↑ {{Range}} +1.5 Range up#Grants spectral tears#Chance for homing tears"}, -- Ouroboros Worm
	[98] = {"98", "Nose Goblin", "{{Poison}} 5% chance to shoot homing sticky poison tears#Deals your damage each second#Sticks for 10 seconds"},
	[101] = {"101", "Dim Bulb", "!!! While holding a completely uncharged active item:#↑ {{Damage}} +1.5 Damage#↑ {{Speed}} +0.5 Speed#↑ {{Range}} +1.5 Range#↑ {{Tears}} +0.5 Tears#↑ {{Shotspeed}} +0.3 Shot Speed#↑ {{Luck}} +2 Luck"},
	[107] = {"107", "Crow Heart", "Damage taken will ignore Soul/Black Hearts, causing your Red Heart containers to be depleted first#!!! The Red Heart damage can lower your Devil/Angel Room chance"}, -- Crow Heart
	...
	[125] = {"125", "Extension Cord", "Connects your familiars with beams of electricity#Deals 6 damage per beam#Also arcs between co-op players (including Jacob & Esau)"}, -- Extension Cord
	[128] = {"128", "Finger Bone", "{{EmptyBoneHeart}} 4% chance to gain a Bone Heart when taking damage"}, -- Finger Bone
	...
	[131] = {"131", "Blessed Penny", "{{SoulHeart}} 17% chance to drop Half Soul Hearts when picking up coins"}, -- Blessed Penny
	...
	[135] = {"135", "A Lighter", "{{Burning}} 20% chance to apply burn effect to enemies upon entering a room"}, -- A Lighter
	...
	[142] = {"142", "Beth's Faith", "{{Collectible584}} When entering a new floor, spawns 4 Book of Virtues wisps"}, -- Beth's Faith
	[143] = {"143", "Old Capacitor", "Prevents active item from charging#{{Battery}} 20% chance to spawn a battery after clearing a room#{{Luck}} 33% chance at 5 Luck"}, -- Old Capacitor
	[144] = {"144", "Brain Worm", "Tears turn 90 degrees to target enemies that they may have missed"}, -- Brain Worm
	[145] = {"145", "Perfection", "↑ {{Luck}} +10 Luck up#Destroys itself when you take damage"}, -- Perfection
	[146] = {"146", "Devil's Crown", "{{RedTreasureRoom}} Treasure Rooms now contain Devil deals instead of a free item"}, -- Devil's Crown
	...
	[152] = {"152", "Telescope Lens", "{{PlanetariumChance}} +24% Planetarium chance if none have spawned#+9% if a Planetarium has already spawned#Planetariums can now spawn in the Womb and Corpse"}, -- Telescope Lens
	...
	[156] = {"156", "Mother's Kiss", "{{Heart}} +1 heart container while held#{{Player14}} Works for Keeper, too"}, -- Mother's Kiss
	...
	[159] = {"159", "Gilded Key", "{{Key}} +1 key when first picked up#{{GoldenChest}} Replaces all chests (except Old/Mega) with Golden Chests#{{GoldenChest}} Golden Chests can contain extra cards, pills or trinkets"}, -- Gilded Key
	[160] = {"160", "Lucky Sack", "{{GrabBag}} When entering a new floor, spawns 1 Sack"}, -- Lucky Sack
	[161] = {"161", "Wicked Crown", "Spawns a {{TreasureRoom}} Treasure Room and {{Shop}} Shop in Sheol"}, -- Wicked Crown
	[162] = {"162", "Azazel's Stump", "{{Player7}} 50% chance to turn into Azazel after clearing a room#Effect lasts until clearing and leaving another room"}, -- Azazel's Stump
	...
	[165] = {"165", "Nuh Uh!", "{{Coin}} On Womb and beyond, replaces all coin and key spawns with a bomb, heart, pill, card, trinket, battery, or enemy fly"}, -- Nuh Uh!
	...
	[168] = {"168", "Hollow Heart", "{{EmptyBoneHeart}} +1 Bone Heart upon entering a new floor"}, -- Hollow Heart
	[169] = {"169", "Kid's Drawing", "{{Guppy}} While held, counts as 1 item towards the Guppy transformation"}, -- Kid's Drawing
	[170] = {"170", "Crystal Key", "{{Collectible580}} 33% chance to create Red Key rooms each time you clear a room#Lower chance to occur when in a red room"}, -- Crystal Key
	[171] = {"171", "Keeper's Bargain", "{{DevilRoom}} 50% chance for Devil deals to cost coins instead of hearts"}, -- Keeper's Bargain
	[172] = {"172", "Cursed Penny", "{{Coin}} Teleport to a random room upon picking up a penny#Can teleport to secret rooms"}, -- Cursed Penny
	[173] = {"173", "Your Soul", "{{DevilRoom}} Allows you to get 1 Devil Room item for free#Buying a Devil Room item destroys this trinket#!!! The free Devil deal still affects Angel Room chance"}, -- Your Soul
	...
	[177] = {"177", "Temporary Tattoo", "Spawns a {{Chest}} chest after clearing a {{ChallengeRoom}} Challenge Room, or a collectible after clearing a {{BossRushRoom}} Boss Challenge Room"}, -- Temporary Tattoo
	...
	[187] = {"187", "Broken Glasses", "{{TreasureRoom}} 50% chance of adding an extra blind item in Treasure Rooms#50% chance to reveal the blind item in the alt path"}, -- Broken Glasses
	[188] = {"188", "Ice Cube", "20% chance to petrify enemies when entering a room#{{Freezing}} Killing a petrified enemy freezes it"}, -- Ice Cube
...
local repCards={
	...
	[62] = {"62", "VI - The Lovers?", "{{BrokenHeart}} Turns 1 Heart Container or 2 Soul Hearts into a Broken Heart#Spawns an item from the current room's item pool"}, -- VI - The Lovers?
	[63] = {"63", "VII - The Chariot?", "Turn into invincible immobile statue for 10 seconds#↑ {{Tears}} Extreme fire rate for duration"}, -- VII - The Chariot?
	[64] = {"64", "VIII - Justice?", "Spawns 2-4 Golden Chests"}, -- VIII - Justice?
	[65] = {"65", "IX - The Hermit?", "Turns pickups and items in the room into coins#{{Shop}} Coin values are equal to their shop value"}, -- IX - The Hermit?
	[66] = {"66", "X - Wheel of Fortune?", "Random dice room effect"}, -- X - Wheel of Fortune?
	[67] = {"67", "XI - Strength?", "{{Weakness}} Enemies in current room are weakened, slowed and take double damage#Lasts 1 minute"}, -- XI - Strength?
	[68] = {"68", "XII - The Hanged Man?", "{{Player14}} Turns player into the Keeper for 30 seconds#Grants triple shot and speed down#Killed enemies drop random coins"}, -- XII - The Hanged Man?
	[69] = {"69", "XIII - Death?", "{{Collectible545}} Invokes Book of the Dead effect#Spawns Bone entities for each enemy killed in room"}, -- XIII - Death?
	[70] = {"70", "XIV - Temperance?", "Eat 5 random pills"}, -- XIV - Temperance?
	[71] = {"71", "XV - The Devil?", "{{Collectible33}} Invokes The Bible effect#{{Collectible390}} Grants Seraphim and flight for 30 seconds"}, -- XV - The Devil?
	...
	[74] = {"74", "XVIII - The Moon?", "{{UltraSecretRoom}} Teleports you to the Ultra Secret Room#Pathway back will be made of red rooms"}, -- XVIII - The Moon?
	[75] = {"75", "XIX - The Sun?", "For the current floor:#↑ Gain flight and spectral tears#↑ {{Damage}} +1.5 Damage up#{{BoneHeart}} Turns your Red Hearts into Bone Hearts#Applies Curse of Darkness"}, -- XIX - The Sun?
	[76] = {"76", "XX - Judgement?", "{{RestockMachine}} Spawns a Restock Machine"}, -- XX - Judgement?
	[77] = {"77", "XXI - The World?", "Spawns a trap door to a {{LadderRoom}}crawlspace"}, -- XXI - The World?
	[78] = {"78", "Cracked Key", "{{Collectible580}} One time use Red Key"}, -- Cracked Key
	...
	[91] = {"91", "Soul of the Lost", "{{Player10}} Die and turn into The Lost for current room#You can take one {{DevilRoom}}Devil Room item for free, the rest will disappear#You can enter the Mausoleum or Gehenna door for free"}, -- Soul of the Lost
	...
	[95] = {"95", "Soul of the Forgotten", "{{Player16}} Spawns The Forgotten as a temporary secondary character for current room"}, -- Soul of the Forgotten
	[96] = {"96", "Soul of Bethany", "{{Collectible584}} Spawns 6 Book of Virtues wisps with random properties"}, -- Soul of Bethany
	[97] = {"97", "Soul of Jacob and Esau", "{{Player20}} Spawns Esau as a temporary secondary character for current room#He spawns with random passive items equal to how many you have"}, -- Soul of Jacob and Esau
}
...
EID.descriptions[languageCode].tarotClothBuffs = {
	...
	[56] = "Drops your most recent 6 items alongside the pickups", -- 0 - The Fool?
	[59] = "↑ {{Heart}} +3 Health up", -- III - The Empress?
	[61] = "{{EmptyBoneHeart}} Spawns 3 Bone Hearts", -- V - The Hierophant?
	[62] = "{{BrokenHeart}} Adds 2 Broken Hearts and spawns 2 items", -- VI - The Lovers?
	...
	[70] = "{{Pill}} Eat 10 random pills", -- XIV - Temperance?
...
local repPills={
	...
	[38] = {"37", "Retro Vision", "Pixelates all sprites for 30 seconds"},
