...
local repCollectibles={
	...
	[14] = {"14", "Roid Rage", "↑ +0.3 Speed up#↑ +5.25 Range up#↑ +0.5 Shot Height"}, -- Roid Rage
	...
	[42] = {"42", "Bob's Rotten Head", "Throwable poison bomb#Deals 185 + you damage#Creates poison cloud"}, -- Bob's Rotten Head
	...
	[67] = {"67", "Sister Maggy", "Normal tear familiar#Deals 5 Damage per tear"}, -- Sister Maggy
	...
	[83] = {"83", "The Nail", "+ Half Black heart#↑ +0.7 Damage up#↓ -0.18 Speed down#Deal contact Damage#Crush rocks"}, -- The Nail
	[106] = {"106", "Mr. Mega", "↑ Bomb damage x1.85#+5 Bombs"}, -- Mr. Mega
	[121] = {"121", "Odd Mushroom (Large)", "↑ +1 Empty heart container#↑ +1.0 Damage up#↑ +0.25 Range up#↓ -0.2 Speed down#↑ +0.5 Tear Height"}, -- Odd Mushroom (Large)
	...
	[287] = {"287", "Book of Secrets", "Reveals parts of the map#Only grants mapping effects you don't have already"}, -- Book of Secrets
	[288] = {"288", "Box of Spiders", "Spawn 4-8 blue spiders"}, -- Box of Spiders
	[289] = {"289", "Red Candle", "Throw red fire#The flame persists until it has dealt damage 5 times or after 10 seconds"}, -- Red Candle
	...
	[336] = {"336", "Dead Onion", "Piercing + spectral tears↓ -1.5 Range up#↓ -0.4 Shot Speed down"}, -- Dead Onion
	[344] = {"344", "Match Book", "+1 Black Heart#Spawns 2-3 Bomb pickups#Spawns the Match Stick {{Trinket41}} Trinket"}, -- Match Book
	[346] = {"346", "A Snack", "↑ +1 Health up#Heals 2 hearts"}, -- A Snack
	[352] = {"352", "Glass Canon", "Fires one large piercing spectral tear ((DMG+1) X 10)#When you take damage, all damage to the player is increased by 2 hearts"}, -- Glass Canon
	[355] = {"355", "Mom's Pearl", "↑ +1.25 Range up#↑ +1 Luck up#+1 Soul Heart#↑ +0.5 Tear Height"}, -- Mom's Pearl
...
local repTrinkets={
	...
	[33] = {"33", "Umbilical Cord", "When down to half a heart, you get little Steven#High Chance to spawn a Gemini familar when taking damage"}, -- Umbilical Cord
...
local repCards={
	...
	[83] = {"83", "Soul of Cain", "Creates red rooms with Red Key {{Collectible580}} for every possible exit"}, -- Soul of Cain
...
local repPills={
	...
	[13] = {"12", "Range Up", "↑ +0.45 Range up"}, -- Range Up
