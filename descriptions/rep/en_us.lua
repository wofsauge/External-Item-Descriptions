...
local repCollectibles={
	...
	[77] = {"77", "My Little Unicorn", "{{Timer}} Receive for 6 seconds:#↑ {{Speed}} +0.28 Speed#Invincibiliy#Isaac can't shoot but deals 40 contact damage per second"}, -- My Little Unicorn
	...
	[158] = {"158", "Crystal Ball", "Spawns a {{SoulHeart}} Soul Heart, {{Rune}} rune or {{Card}} card#{{Timer}} Full mapping effect for the floor (except {{SuperSecretRoom}} Super Secret Room)#{{Blank}} While held:#{{PlanetariumChance}} +15% Planetarium chance#{{PlanetariumChance}} +100% if a {{TreasureRoom}} Treasure Room was skipped"}, -- Crystal Ball
	...
	[180] = {"180", "The Black Bean", "Isaac farts multiple times when touched#{{Poison}} The farts leave poison clouds"}, -- The Black Bean
	...
	[222] =	{"222", "Anti-Gravity", "↑ {{Tears}} +1 Fire rate#Holding the fire buttons causes tears to hover in midair#Releasing the fire buttons shoots them in the direction they were fired"}, -- Anti-Gravity
	...
	[230] = {"230", "Abaddon", "↑ {{Speed}} +0.2 Speed#↑ {{Damage}} +1.5 Damage#Converts all {{EmptyHeart}} heart containers into {{BlackHeart}} Black Hearts#{{BlackHeart}} +2 Black Hearts#{{Fear}} 15% chance to shoot fear tears#{{Luck}} 100% chance at 85 luck"}, -- Abaddon
	...
	[273] = {"273", "Bob's Brain", "Dashes in the direction Isaac is shooting#Explodes when it hits an enemy#{{Poison}} The explosion deals 100 damage, ignores boss armor and poisons enemies#!!! The explosion can hurt Isaac"}, -- Bob's Brain
	[274] = {"274", "Best Bud", "Taking damage spawns one midrange orbital for the room#The orbital deals 150 damage per second"}, -- Best Bud
	[275] = {"275", "Lil Brimstone", "{{Collectible118}} Familiar that charges and shoots a Brimstone beam#Deals 3 damage per tick, for a total of 24 damage"}, -- Lil Brimstone
	[276] = {"276", "Isaac's Heart", "Isaac becomes invincible#Spawns a heart familiar that follows Isaac#The heart charges up when Isaac fires and releases a burst of tears when he stops#!!! If the heart familiar gets hit, Isaac takes damage"}, -- Isaac's Heart
	[278] = {"278", "Dark Bum", "{{Heart}} Picks up Red Hearts from the floor#Spawns a Black Heart, rune, card, pill, or spider for every 1.5 hearts picked up"}, -- Dark Bum
	...
	[316] = {"316", "Cursed Eye", "Charged wave of 5 tears#!!! Taking damage while partially charged teleports Isaac to a random room#{{Collectible260}} Black Candle removes the teleportation effect"}, -- Cursed Eye
	...
	[326] = {"326", "Breath of Life", "Holding down the USE button empties the charge bar#Isaac is temporarily invincible when the charge bar is empty#Isaac summons light beams on contact with enemies when invincible#If blocked with perfect timing, shoot 4 holy beams in the cardinal directions and gain a brief shield#!!! Holding it for too long deals damage to Isaac"}, -- Breath of Life
	...
	[350] = {"350", "Toxic Shock", "{{Poison}} Entering a room poisons all enemies#Enemies killed leave a puddle of creep#The creep deals 30 damage per second"}, -- Toxic Shock
	[352] = {"352", "Glass Cannon", "{{Damage}} Shoots a large piercing spectral tear that does 10x damage#!!! While held, taking damage:#↓ Removes an extra 2 hearts of health#↓ Breaks the cannon for a few rooms#↑ {{Range}} +1.5 Range and leaves a blood trail for the room#The extra damage can't kill Isaac#Self-damage does not trigger the effect"}, -- Glass Cannon
	...
	[394] = {"394", "Marked", "↑ {{Tears}} +0.7 Tears#↑ {{Range}} +3 Range#Isaac automatically shoots tears at a movable red target on the ground#Familiars shoot towards the target"}, -- Marked
	...
	[442] = {"442", "Dark Prince's Crown", "{{Blank}} While at 1 full Red Heart:#↑ {{Tears}} +2 Fire rate#↑ {{Range}} +1.5 Range#↑ {{Shotspeed}} +0.2 Shot speed#Does not work on characters without Red Hearts"}, -- Dark Prince's Crown
	...
	[450] = {"450", "Eye of Greed", "{{Damage}} Every 20 tears, Isaac shoots a coin tear that deals x1.5 +10 damage#Enemies hit with the coin turn into gold#{{Coin}} Killing a gold enemy drops 1-3 coins#!!! Firing a coin tear costs 1 coin"}, -- Eye of Greed
	...
	[495] = {"495", "Ghost Pepper", "8.33% chance to shoot a blue flame that blocks enemy shots and deals contact damage#The flame shrinks and disappears after 2 seconds#{{Luck}} 50% chance at 10 luck#"}, -- Ghost Pepper
	...
	[569] = {"569", "Blood Oath", "!!! Entering a new floor drains all of Isaac's Red Hearts, but grants speed and damage bonuses for each heart lost#Each half heart lost counts as an individual hit for on-hit effects"}, -- Blood Oath
	...
	[577] = {"577", "Damocles", "!!! SINGLE USE !!!#Hangs a sword above Isaac's head, which doubles all pedestal items#Does not double shop, chest, or devil deal items#!!! After taking any damage, the sword has an extremely low chance to instantly kill Isaac every 0.133 seconds"}, -- Damocles
	[578] = {"578", "Free Lemonade", "Creates a large pool of yellow creep#The creep deals 24 damage per second"}, -- Free Lemonade
	[579] = {"579", "Spirit Sword", "Instead of shooting tears, Isaac swings a sword#{{Damage}} The sword deals 3x Isaac's damage +3.5 and swings as fast as the fire butten is tapped#{{Chargeable}} Charging does a spin attack + projectile shot#Shoots projectiles with normal swings at full health#{{Tears}} Tears effect the charge time and how often a projectile is shot at full health"}, -- Spirit Sword
	...
	[600] = {"600", "Eye Drops", "↑ {{Tears}} x1.3 Fire rate multiplier for the left eye"}, -- Eye Drops
	...
	[628] = {"628", "Death Certificate", "!!! SINGLE USE !!!#Teleports Isaac to a floor that contains every item in the game#Choosing an item from this floor teleports Isaac back to the room he came from"}, -- Death Certificate
	...
	[644] = {"644", "Consolation Prize", "↑ Increases Isaac's lowest stat out of Speed, Fire rate, Damage, and Range#Spawns either {{Coin}} 3 coins, {{Bomb}} 1 bomb, or {{Key}} 1 key depending on what Isaac has the least of"}, -- Consolation Prize
	...
	[646] = {"646", "Brimstone Bombs", "{{Bomb}} +5 Bombs#{{Collectible118}} Isaac's bombs release 4 Brimstone beams in the cardinal directions#The lasers don't hurt Isaac"}, -- Brimstone Bombs
	...
	[667] = {"667", "Strawman", "{{Bomb}} +1 Bomb#{{Player14}} Spawns Keeper as a second character#When he dies, spawns blue spiders and permanently removes Strawman and any item that he has picked up from the inventory#{{DevilRoom}} Devil Room items cost coins while Strawman is alive#!!! Strawman can pick up story items"}, -- Strawman
	...
	[680] = {"680", "Montezuma's Revenge", "{{Chargeable}} Firing charges up a short-ranged high damage backwards laser#Does not replace Isaac's tears"}, -- Montezuma's Revenge
	...
	[699] = {"699", "Azazel's Rage", "Clearing 4 rooms fires a large {{Collectible118}} Brimstone beam upon entering the next room"}, -- Azazel's Rage
	...
	[711] = {"711", "Flip", "Entering a room with item pedestals displays a ghostly second item on the pedestals#Using the item flips the real and ghostly item#Using Flip after taking the first item allows Isaac to pick up the other item#!!! Ghostly items alone on pedestals disappear after leaving the room"}, -- Flip
	...
	[716] = {"716", "Keeper's Sack", "Spawns {{Coin}} 3 coins and {{Key}} 1 key#{{Shop}} Spending 3 coins grants either:#↑ {{Speed}} +0.03 Speed#↑ {{Damage}} +0.5 Damage#↑ {{Range}} +0.25 Range"}, -- Keeper's Sack
...
EID.descriptions[languageCode].birthright ={
	...
	{"Tainted Magdalene", "", "{{Heart}} Adds 1 Red Heart container that doesn't drain"},
	...
	{"Tainted Lazarus", "", "The non-active form of Tainted Lazarus appears as a ghostly second character#He is invulnerable and deals 25% damage#Both forms receive the Birthright item"},
	...
	{"Dead Tainted Lazarus", "", "The non-active form of Tainted Lazarus appears as a ghostly second character#He is invulnerable and deals 25% damage#Both forms receive the Birthright item"},
...
EID.descriptions[languageCode].bookOfVirtuesWisps = {
	[33] = "Inner ring wisps#Homing tears", -- The Bible
	[34] = "Middle ring wisps#Double damage tears", -- The Book of Belial
	[35] = "Inner ring wisps#3.5% chance for {{Fear}} fear tears#{{Collectible35}} Necronomicon effect when destroyed", -- The Necronomicon
	[36] = "Outer ring wisps#2.5% chance for {{Collectible236}} E. Coli tears", -- The Poop
	[37] = "Middle ring wisps#Drop scatter homing bombs when destroyed", -- Mr. Boom
	[38] = "Outer ring wisps#Rapid, inaccurate tears", -- Tammy's Head
	[39] = "Middle ring wisps#5% chance for petrifying tears", -- Mom's Bra
	[40] = "Middle ring wisps#Explosive tears#Explodes when destroyed", -- Kamikaze!
	[41] = "Middle ring wisps#7.5% chance for {{Fear}} fear tears", -- Mom's Pad
	[42] = "Middle ring wisps#7.5% chance for {{Collectible149}} Ipecac tears", -- Bob's Rotten Head
	[44] = "Middle ring wisps#10% chance for tears to teleport enemies#Wisps flicker every 5 seconds", -- Teleport!
	[45] = "Middle ring wisps#20% chance for enemies to drop {{Heart}} 1 Red Heart on kill", -- Yum Heart
	[47] = "Middle ring wisps#Shoot 3 explosive tears towards the crosshair on use", -- Doctor's Remote
	[49] = "Outer ring wisps#Cannot shoot tears#Fires a laser on use", -- Shoop da Whoop!
	[56] = "Middle ring wisps#Rapid, low range tears#Wisp drips yellow creep", -- Lemon Mishap
	[58] = "Middle ring wisps#Low HP but immune to projectiles#Immune to damage during {{Collectible58}} effect", -- Book of Shadows
	[65] = "Middle ring wisps#Drop a Troll Bomb when destroyed", -- Anarchist Cookbook
	[66] = "Middle ring wisps#{{Slow}} Slows enemies for 3 seconds when destroyed", -- The Hourglass
	[77] = "Middle ring wisps#Extra contact damage", -- My Little Unicorn
	[78] = "Inner ring wisps#Cannot shoot tears#Spawns a Locust for the room when destroyed", -- Book of Revelations
	[83] = "Inner ring wisps#Double damage and knockback tears", -- The Nail
	[84] = "Middle ring wisps#No special effect", -- We Need to Go Deeper!
	[85] = "Inner ring wisps#Drop a {{Card}} card when destroyed", -- Deck of Cards
	[86] = "Middle ring wisps#Tooth tears", -- Monstro's Tooth
	[93] = "Inner ring wisps#Anti-gravity tears#Chance for {{Fear}} fear tears", -- The Gamekid
	[97] = "Spawns 1 of 8 wisps:#{{Collectible65}}{{Collectible42}}{{Collectible85}}{{Collectible102}}{{Collectible37}}{{Collectible177}}{{Collectible49}}{{Collectible45}}", -- The Book of Sin
	[102] = "Inner ring wisps#Spawns 1 of 6 wisps:#normal tears that spawns an enemy spider when destroyed or chance for poison, petrify, confusion, burn, Troll Bomb tears#All 6 spawn a {{Pill}} pill when destroyed", -- Mom's Bottle of Pills
	[105] = "Middle ring wisps#+1 Wisp per item rerolled", -- The D6
	[107] = "Inner ring wisps#Piercing tears", -- The Pinking Shears
	[111] = "Outer ring wisps#{{Poison}} Poison fart when destroyed", -- The Bean
	[123] = "Inner ring wisps#Random tears", -- Monster Manual
	[124] = "Spawns the wisp of what item it mimics", -- Dead Sea Scrolls
	[126] = "Middle ring wisps#High HP wisps", -- Razor Blade
	[127] = "Middle ring wisps#Infinite HP wisp for the new floor", -- Forget Me Now
	[130] = "Middle ring wisps#Cannot shoot tears#Wisps charge in the direction Isaac shoots", -- A Pony
	[133] = "Middle ring wisps#Spawns 3 high HP wisps", -- Guppy's Paw
	[135] = "Outer ring wisps#Low HP wisp", -- IV Bag
	[136] = "Middle ring wisps#7.5% chance for {{Bait}} mark tears#Marked enemies are attacked by other enemies", -- Best Friend
	[137] = "Inner ring wisps#+1 Wisp per bomb detonated#Wisp's tears can also be remote detonated", -- Remote Detonator
	[145] = "Outer ring wisps#Wisps are spawned instead of flies#Spawns a blue fly when destroyed", -- Guppy's Head
	[146] = "Inner ring wisps#Homing tears", -- Prayer Card
	...
	[158] = "Middle ring wisps#High HP wisp that shoots at nearby enemies", -- Crystal Ball
	[160] = "Middle ring wisps#Summon a beam of light on contact", -- Crack the Sky
	[164] = "Middle ring wisps#Single room wisp", -- The Candle
	[166] = "Middle ring wisps#Destroys all pickups in the room, with a chance to spawn a random wisp for each", -- D20
	[171] = "Middle ring wisps#7.5% chance for {{Slow}} slow tears", -- Spider Butt
	[175] = "Middle ring wisps#Wisps open locked chests/doors on touch, including the Mega Satan, Ascent, and Corpse doors#Wisps donate themselves to {{KeyBeggar}} Key Bums", -- Dad's Key
	[177] = "Spawns a wisp based on the reward won", -- Portable Slot
	[181] = "Middle ring wisps#10% chance for {{Collectible374}} Holy Light tears", -- White Pony
	[186] = "Middle ring wisps#High HP wisp", -- Blood Rights
	[192] = "Middle ring wisps#Homing tears", -- Telepathy for Dummies
	[263] = "Middle ring wisps#15% chance for enemies to drop a {{Rune}} rune on kill#Drops a {{Rune}} rune when destroyed", -- Clear Rune
	...
	[285] = "Middle ring wisps#10% chance for D10 effect tears", -- D10
	[286] = "Middle ring wisps#15% chance for enemies to drop a {{Card}} card on kill#Spawns a {{Card}} card when destroyed", -- Blank Card
	[287] = "Middle ring wisps#{{Collectible675}} Cracked Orb effect when destroyed", -- Book of Secrets
	[288] = "Outer ring wisps#Wisps are spawned instead of spiders#Spawns a blue spider when destroyed", -- Box of Spiders
	[289] = "Middle ring wisps#Single room wisp#Red flame tears", -- Red Candle
	[290] = "Middle ring wisps#Creates a wisp per heart instead of dropping them as pickups#Chance to spawn a {{HalfHeart}} half Red Heart when destroyed", -- The Jar
	[291] = "Middle ring wisps#Spawns an extra wisp per flushed enemy", -- Flush!
	[292] = "Middle ring wisps#+10% {{AngelDevilChance}} Devil/Angel Room chance per Satanic Bible wisp", -- Satanic Bible
	[293] = "Middle ring wisps#Fires 4-way laser when destroyed", -- Head of Krampus
	[294] = "Inner ring wisps#Low HP single room wisp#Cannot shoot tears#Butter Bean effect when destroyed", -- Butter Bean
	[295] = "Inner ring wisps#Chance to drop a {{Coin}} coin when destroyed", -- Magic Fingers
	[296] = "Middle ring wisps#Higher HP wisp that can be healed with {{Heart}} Red Hearts", -- Converter
	[297] = "Middle ring wisps#Spawns 0-8 wisps depending on the floor", -- Pandora's Box
	[298] = "Middle ring wisps#Cannot shoot tears#Doesn't deal contact damage unless Unicorn Stump or a similar effect is active", -- Unicorn Stump
	[323] = "Middle ring wisps#Spawns 6 wisps#3 Second lifetime", -- Isaac's Tears
	[324] = "Middle ring wisps#{{Collectible570}} Playdough Cookie tears", -- Undefined
	[325] = "Middle ring wisps#Arcing cluster tears", -- Scissors
	[326] = "Inner ring wisps#Spawns 4 wisps on a perfect block", -- Breath of Life
	[338] = "Middle ring wisps#Single room wisp#Boomerang tears", -- The Boomerang
	[347] = "Middle ring wisps#Hihg HP wisps with {{Collectible245}} 20/20 tears#Duplicate all other wisps", -- Diplopia
	[348] = "Middle ring wisps#Spawns a {{Pill}} pill when destroyed", -- Placebo
	[349] = "Middle ring wisps#50% chance to drop a {{Coin}} coin when destroyed", -- Wooden Nickel
	[351] = "Middle ring wisps#Send a rock wave out on use#Petrify + {{Poison}} poison fart when destroyed", -- Mega Bean
	[352] = "Middle ring wisps#Low HP wisp that persists between rooms#All Glass Cannon wisps are destroyed when one is destroyed", -- Glass Cannon
	[357] = "Middle ring wisps#No special effect#Duplicate all wisps for the current room", -- Box of Friends
	[382] = "Middle ring wisps#Friendly enemies spawn 1 of 4 wisps on death, depending on their attacks, with normal, homing, explosive, or Brimstone tears", -- Friendly Ball
	[383] = "Middle ring wisps#Wisp's tears can be detonated, turning into 6 of Isaac's tears#Persists between rooms#Burst into Isaac's tears when destroyed", -- Tear Detonator
	[386] = "Middle ring wisps#5% chance for tears to reroll rocks, urns, skulls or mushrooms", -- D12
	[396] = "Cannot shoot tears#Each portal has 1 wisp", -- Ventricle Razor
	[406] = "Middle ring wisps#Random damage and fire rate", -- D8
	[419] = "Middle ring wisps#20% chance for tears to teleport enemies#Wisps flicker every 5 seconds", -- Teleport 2.0
	[421] = "Middle ring wisps#{{Charm}} Charm fart when destroyed", -- Kidney Bean
	[422] = "Middle ring wisps#30% chance for petrifying tears#Respawns all wisps that got destroyed in the previous room", -- Glowing Hourglass
	[427] = "Bounces around the room, exploding when shot by Isaac#Cannot shoot tears or deal contact damage", -- Mine Crafter
	[434] = "Middle ring wisps#Wisps are spawned instead of flies#Up to 5 flies makes 1 wisp with increased health and damage", -- Jar of Flies
	[437] = "Middle ring wisps#D7 effect when hit for the first time", -- D7
	[439] = "Middle ring wisps#No special effect", -- Mom's Box
	[441] = "Middle ring wisps#Brimstone tears (requires releasing the fire button)#Shoot continuously during a Mega Blast", -- Mega Blast
	[475] = "Middle ring wisps#Spawns 8 high damage wisps that stay after death", -- Plan C
	[476] = "Middle ring wisps#Spawns a second wisp if no pickup was duplicated", -- D1
	[477] = "Spawns the wisps of all absorbed active items#Doesn't spawn a wisp itself", -- Void
	[478] = "Middle ring wisps#Pauses all enemies and shots for 3 seconds when destroyed", -- Pause
	[479] = "Middle ring wisps#Chance to spawn a {{Trinket}} trinket when destroyed", -- Smelter
	...
	[486] = "Cannot shoot tears#Chance to negate Isaac taking damage", -- Dull Razor
	...
	[527] = "Cannot shoot tears#On room clear, wisps open chests/doors", -- Mr. ME!
	...
	[585] = "Middle ring wisps#Spawns 8 wisps", -- Alabaster Box
...
local repTrinkets={
	...
	[23] = {"23", "Missing Poster", "{{Player10}} Respawn as The Lost on death#{{Player31}} Tainted Lost simply revives#!!! Dying in a {{SacrificeRoom}} Sacrifice Room while holding this trinket unlocks The Lost"}, -- Missing Poster
	...
	[129] = {"129", "Jawbreaker", "10% chance to shoot teeth#{{Damage}} Teeth deal 3.2x Isaac's damage#{{Luck}} 100% chance at 9 luck"}, -- Jawbreaker
...
EID.descriptions[languageCode].tarotClothBuffs = {
	...
	[15] = "Spawns 2 {{BloodDonationMachine}} Blood Donation Machines", -- XIV - Temperance
	...
	[70] = "Forces Isaac to eat 10 random {{Pill}} pills", -- XIV - Temperance?
	[72] = "Spawns 14 rock clusters", -- XVI - The Tower?
	[73] = "Removes 2 items and spawns 4", -- XVII - The Stars?
	[76] = "Spawns 2 {{RestockMachine}} Restock Machines", -- XX - Judgement?
}
