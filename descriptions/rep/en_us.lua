...
local repCollectibles={
	...
	[401] = {"401", "Explosivo", "Chance to fire sticky bomb tears#Sticky tears deal your damage periodically#Upon explosion, they deal your damage + 60"}, -- Explosivo
	...
	[495] = {"495", "Ghost Pepper", "Chance to shoot a blue fire that blocks enemy shots and deals contact damage#50% chance at 10 Luck#The flame disappears after 2 seconds"}, -- Ghost Pepper
	[496] = {"496", "Euthanasia", "Chance to shoot needles#50% chance at 15 Luck#Needles kill normal enemies instantly, bursting them into 10 tears#Needles deal 3x damage against bosses"}, -- Euthanasia
	[503] = {"503", "Little Horn", "Chance to shoot tears that summon a Big Horn hand#The hand kills enemies instantly and deals damage to bosses#Running into enemies deals 3.5 damage to them"}, -- Little Horn
	...
	[531] = {"531", "Haemolacria", "↑ +1 Damage up#↑ +50% Damage Multiplier#↓ Tears down#↓ -20% Range down#Tears fly in an arc and burst into smaller tears on impact"}, -- Haemolacria
	...
	[594] = {"594", "Jupiter", "↑ +2 Health up#Heals half a Red Heart#↓ -0.3 Speed down#Build up to +0.5 Speed while standing still#Moving releases poison fart clouds behind you"}, -- Jupiter
	...
	[606] = {"606", "Ocular Rift", "Chance to shoot tears that create rifts where they land#Rifts pull in nearby enemies, pickups, and projectiles"}, -- Ocular Rift
	...
	[616] = {"616", "Bird's Eye", "Chance to shoot red fires that block enemy shots and deal contact damage#50% chance at 10 Luck#Fires can block up to 4 shots and/or deal damage 4 times before being destroyed, and last up to 10 seconds"}, -- Bird's Eye
	[617] = {"617", "Lodestone", "Chance to shoot tears that magnetize enemies#100% chance at 5 Luck#Magnetized enemies attract nearby pickups, projectiles and enemies"}, -- Lodestone
	[618] = {"618", "Rotten Tomato", "Chance to shoot tears that mark enemies#100% chance at 5 Luck#Marked enemies are attacked by other enemies"}, -- Rotten Tomato
	...
	[637] = {"637", "Knockout Drops", "Chance to shoot a fist with extreme knockback and confusion effect#100% chance at 9 Luck"}, -- Knockout Drops
	...
	[642] = {"642", "Magic Skin", "Consumes 1 Heart Container or 2 Soul Hearts and replaces them with a Broken Heart#Spawns an item from the current room's item pool#The more times it's used, the higher the chance it replaces future items if Isaac isn't holding it#Lower chance if Magic Skin is on a pedestal on the current floor#{{Warning}} Single use item for The Lost, doesn't replace future items"}, -- Magic Skin
	...
	[667] = {"667", "Strawman", "Spawns Keeper as a second character#If he dies, he spawns blue spiders#Item gets removed afterwards#Devil deals cost coins while he's alive#!!! He can pick up items, including Story items, removing them permanently on death"}, -- Strawman
