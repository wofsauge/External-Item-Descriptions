...
local repCollectibles={
	...
	[52] = {"52", "Dr. Fetus", "{{Bomb}} Bomb tears#{{Damage}} Each bomb deals 10x your damage#If that results in over 60 damage, it instead deals 5x your damage + 30#↓ {{Tears}} Fire Rate x 0.4"}, --Dr. Fetus
	...
	[106] = {"106", "Mr. Mega", "↑ Bomb damage x1.85#{{Bomb}} +5 Bombs"}, -- Mr. Mega
