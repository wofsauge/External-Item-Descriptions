...
local repCollectibles={
	...
	[594] = {"594", "Jupiter", "+2 red empty Heart containers#↓ -0.3 Speed down#Heals half a heart#Build up Speed while standing still for up to +0.5 Speed#Release a poisoning gas cloud when moving again"}, --  Jupiter
	...
	[660] = {"660", "Card Reading", "Spawns two portals at the beginning of each floor#Portals disappear when leaving the room#{{ColorRed}}Red: {{CR}}{{BossRoom}}Boss Room#{{ColorYellow}}Yellow: {{CR}}{{TreasureRoom}}Item Room#{{ColorBlue}}Blue: {{CR}}{{SecretRoom}}Secret Room"}, --  Card Reading
...
local repTrinkets={
	...
	[101] = {"101", "Dim Bulb", "!!! While holding an completely uncharged active item:#↑ +1.5 Damage#↑ +0.5 Speed#↑ +1.5 Range#↑ +0.5 Tears#↑ +0.3 Shot Speed#↑ +2 Luck"},
