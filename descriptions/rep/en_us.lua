...
local repCollectibles={
	...
	[52] = {"52", "Dr. Fetus", "↓ {{Tears}} x0.4 Fire rate multiplier#{{Bomb}} Isaac shoots bombs instead of tears#Those bombs deal 10x Isaac's tear damage#If that results in over 60 damage, they instead deal 5x damage +30"}, --Dr. Fetus
	...
	[118] = {"118", "Brimstone", "↓ {{Tears}} x0.33 Fire rate multiplier#{{Chargeable}} Isaac's tears are replaced by a chargeable blood laser"}, -- Brimstone
	...
	[140] = {"140", "Bob's Curse", "{{Bomb}} +5 bombs#{{Poison}} Isaac's bombs create a cloud of poison#Grants poison immunity"}, -- Bob's Curse
	...
	[152] = {"152", "Technology 2", "↓ {{Tears}} x0.67 Fire rate multiplier#Replaces Isaac's right eye tears with a continuous laser#The laser deals 13% of Isaac's damage per tick"}, -- Technology 2
	...
	[218] = {"218", "Placenta", "↑ {{Heart}} +1 Health#{{Heart}} Heals 1 heart#{{HalfHeart}} Chance to heal half a heart every minute"}, -- Placenta
	...
	[292] = {"292", "Satanic Bible", "{{BlackHeart}} +1 Black Heart#{{DevilRoom}} Using the item before a boss fight makes the boss reward a devil deal#Purchasing these devil deals has the same consequences as those in Devil Rooms#Does not affect pedestals in The Void floor"}, -- Satanic Bible
	...
	[300] = {"300", "Aries", "↑ {{Speed}} +0.25 Speed#Touching enemies deals contact damage#Moving above 0.85 Speed makes Isaac immune to contact damage"}, -- Aries
	...
	[326] = {"326", "Breath of Life", "Holding down the USE button empties the charge bar#Isaac is temporarily invincible when the charge bar is empty#Isaac summons light beams on contact with enemies when invincible#If you block damage with perfect timing, shoot Holy Brimstone and gain a brief shield#!!! Holding it for too long deals damage to Isaac"}, -- Breath of Life
	...
	[331] = {"331", "Godhead", "↑ {{Speed}} +0.5 Damage#↓ {{Tears}} -0.3 Tears#↓ {{Shotspeed}} -0.3 Shot speed#Homing tears#Tears gain an aura that deals 60 damage per second"}, -- Godhead
	...
	[394] = {"394", "Marked", "↑ {{Tears}} +0.7 Tears#↑ {{Range}} +3 Range#Isaac automatically fires tears at a movable red target on the ground#Familiars shoot towards the target"}, -- Marked
	...
	[430] = {"430", "Papa Fly", "Mimics Isaac's movement on a 0.66 second delay#Shoots tears at nearby enemies that deal Isaac's damage"}, -- Papa Fly
	...
	[448] = {"448", "Shard of Glass", "Upon taking damage:#{{Heart}} 25% chance to drop a Red Heart#{{BleedingOut}} Isaac bleeds, spewing tears in the direction he is shooting#The bleeding does a half Red Heart of damage every 20 seconds#The bleeding stops if a Red Heart is healed, all Red Hearts are empty, or the next damage would kill Isaac"}, -- Shard of Glass
	[450] = {"450", "Eye of Greed", "Every 20 tears, Isaac shoots a coin tear that deals x1.5 +10 damage#Enemies hit with the coin turn into gold#{{Coin}} Killing a gold enemy drops 1-3 coins#!!! Firing a coin tear costs 1 coin"}, -- Eye of Greed
	...
	[496] = {"496", "Euthanasia", "3.33% chance to shoot a needle#{{Luck}} 25% chance at 13 luck#Needles kill normal enemies instantly, bursting them into 10 tears#Needles deal 3x damage against bosses"}, -- Euthanasia
	[497] = {"497", "Camo Undies", "Entering a room camouflages Isaac and confuses all enemies until a tear is shot#↑ {{Speed}} +0.5 Speed while cloaked#Uncloaking deals damage around Isaac and grants a very brief fire rate and damage up"},
	...
	[508] = {"508", "Mom's Razor", "{{BleedingOut}} Orbital that causes bleeding, which makes enemies take damage when they move#Deals 150% of Isaac's damage per second"},
	...
	[514] = {"514", "Broken Modem", "Causes some enemies and projectiles to briefly freeze at random intervals#Frozen projectiles disappear#25% chance to double room clear drops"},
	...
	[524] = {"524", "Technology Zero", "Isaac's tears are connected with beams of electricity#Electricity deals 450% of Isaac's damage per second"}, -- Technology Zero
	...
	[555] = {"555", "Golden Razor", "{{Damage}} Grants +1.2 Damage up for the current room#!!! Costs 5 coins to use#{{Coin}} +5 coins on pickup"}, -- Golden Razor
	...
	[569] = {"569", "Blood Oath", "!!! Entering a new floor drains all of Isaac's Red Hearts, and grants damage and speed bonuses for each heart lost#Each half-heart lost counts as an individual hit for on-hit effects"}, -- Blood Oath
	...
	[577] = {"577", "Damocles", "!!! SINGLE USE !!!#Hangs a sword above Isaac's head, which doubles all pedestal items#Does not double Shop, Chest, or Devil deal items#!!! After taking any damage, the sword has a chance to instantly kill Isaac every frame"}, -- Damocles
	...
	[625] = {"625", "Mega Mush", "Gigantifies Isaac and grants:#↑ {{Damage}} +300% Damage multiplier#↑ {{Range}} +2 Range up#↓ {{Tears}} -60% Fire rate down#Ability to crush enemies and obstacles#Complete invincibility#{{Timer}} The effect lasts for 30 seconds and persists between rooms and floors"}, -- Mega Mush
	...
	[644] = {"644", "Consolation Prize", "↑ Increases Isaac's lowest stat out of Speed, Fire rate, Damage, and Range#Drops either {{Coin}} 3 coins, {{Bomb}} 1 bomb, or {{Key}} 1 key depending on what Isaac has the least of"}, -- Consolation Prize
	...
	[651] = {"651", "Star of Bethlehem", "Slowly travels from the first room of the floor to the {{BossRoom}} Boss Room#Moves faster if you're ahead of it, and slower if you're behind it#Standing in its aura grants:#↑ {{Damage}} +1 Damage up#↑ {{Damage}} +20% Damage multiplier#↑ {{Tears}} +150% Tears Multiplier#Homing tears"}, -- Star of Bethlehem
	...
	[656] = {"656", "Damocles", "Hangs a sword above Isaac's head, which doubles all pedestal items#Does not double Shop, Chest, or Devil deal items#!!! After taking any damage, the sword has a chance to instantly kill Isaac every frame"}, -- Damocles (hidden collectible version)
	...
	[659] = {"659", "Tropicamide", "↑ {{Range}} +2.5 Range up#↑ {{Tearsize}} Tear Size up"}, -- Tropicamide
	...
	[669] = {"669", "Sausage", "↑ {{Heart}} +1 Health up#{{Heart}} Full health#↑ {{Damage}} +0.5 Damage up#↑ {{Tears}} +0.5 Tears up#↑ {{Range}} +2.5 Range up#↑ {{Speed}} +0.2 Speed up#↑ {{Shotspeed}} +0.16 Shot speed up#↑ {{Luck}} +1 Luck up#↑ {{AngelDevilChance}} +6.9% Devil or Angel Room chance#↑ {{PlanetariumChance}} +6.9% Planetarium chance"}, -- Sausage
	...
	[724] = {"724", "Hypercoagulation", "{{Heart}} Taking enemy damage drops a half Red Heart#The hearts launch out and despawn after 1.5 seconds"}, -- Hypercoagulation
...
EID.descriptions[languageCode].bingeEaterBuffs = {
	[22] = "↑ {{Tears}} +0.5 Tears up#↑ {{Range}} +2.5 Range up#↓ {{Speed}} -0.03 Speed down", -- Lunch
	...
	[25] = "↑ {{Shotspeed}} +0.2 Shot speed up#↑ {{Range}} +2.5 Range up#↓ {{Speed}} -0.03 Speed down", -- Breakfast
	[26] = "↑ {{Damage}} +1 Damage up#↑ {{Range}} +2.5 Range up#↓ {{Speed}} -0.03 Speed down", -- Rotten Meat
...
EID.descriptions[languageCode].bookOfBelialBuffs = {
	...
	[326] = "Instead of spawning light, you have a fiery aura while invincible#Temporary Damage Up and invokes the effect of {{Collectible35}}Necronomicon on a perfect block", -- Breath of Life
...
local repTrinkets={
	...
	[98] = {"98", "Nose Goblin", "5% chance to shoot homing sticky tears#Boogers deal Isaac's damage once per second#Boogers stick for 10 seconds"},
...
local repCards={
	...
	[16] = {"16", "XV - The Devil", "{{Timer}} Receive for the current room:#↑ {{Damage}} +2 Damage up"},
