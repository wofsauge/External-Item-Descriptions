...
local repCollectibles={
	...
	[292] = {"292", "Satanic Bible", "{{BlackHeart}} +1 Black Heart#{{DevilRoom}} Using the item before a boss fight makes the Boss reward a Devil deal#Taking these Devil Deals has the same consequences as taking those in devil rooms#Does not affect pedestals in The Void floor"}, -- Satanic Bible
