...
local repCollectibles={
	...
	[188] = {"188", "Abel", "Mirrors your movement#Shoots towards the player#Deals 3.5 damage per shot#7.5 damage as Cain"}, -- Abel
	...
	[675] = {"675", "Cracked Orb", "When you take damage:#Unlocks locked doors#Reveals a random room#Destroys all tinted and crawlspace rocks#Can open story doors#Can reveal the {{UltraSecretRoom}}Ultra Secret Room"}, -- Cracked Orb
...
local repTrinkets={
	...
	[152] = {"152", "Telescope Lens", "Increases the default chance for a {{Planetarium}}Planetarium to spawn to 15%#Adds another 10% chance#More than one Planetarium can spawn#Planetariums can now spawn in the Womb and Corpse"}, -- Telescope Lens	
