...
local repCollectibles={
	...
	[53] = {"53", "Magneto", "Pickups are attracted to Isaac#Opens chests for 2 tiles away, ignoring damage of spike chests"}, -- Magneto
	...
	[77] = {"77", "My Little Unicorn", "Makes Isaac invincible and grants +0.28 Speed up#Isaac deals 20 contact damage per second while invincible{{Blank}}#{{Timer}} Effects last 6 seconds"}, -- My Little Unicorn
	...
	[158] = {"158", "Crystal Ball", "Reveals the map#Drops a {{SoulHeart}} Soul Heart, {{Card}} card, or {{Rune}} rune#{{Blank}}#{{Blank}} While held:#{{PlanetariumChance}} +15% Planetarium chance#{{PlanetariumChance}} +100% if a {{TreasureRoom}} Treasure Room was skipped"}, -- Crystal Ball
	...
	[192] = {"192", "Telepathy for Dummies", "↑ {{Range}} +3 Range up#Homing tears#{{Blank}}#{{Timer}} Lasts for one room"}, -- Telepathy for Dummies
	...
	[245] = {"245", "20/20", "Isaac fires 2 tears at once#↓ {{Damage}} -25% Damage down#{{Blank}}#Removes the tear rate penalty of {{Collectible153}} Mutant Spider, {{Collectible2}} The Inner Eye and {{Collectible169}} Polyphemus"}, -- 20/20
	...
	[275] = {"275", "Lil Brimstone", "Familiar that charges to shoot a {{Collectible118}} brimstone laser#Deals 2 damage per tick, for a total of 20 damage"}, -- Lil Brimstone
	...
	[285] = {"285", "D10", "Rerolls all enemies in the room#Tries to reroll them into enemies with similar max HP"}, -- D10
	...
	[295] = {"295", "Magic Fingers", "Deals 2x Isaac's damage + 10 to all enemies in the room#{{Coin}} Removes 1 coin"}, -- Magic Fingers
	...
	[326] = {"326", "Breath of Life", "Holding down the USE button empties the charge bar#Isaac is temporarily invincible when the charge bar is empty#Isaac summons light beams on contact with enemies when invincible{{Warning}} Holding it for too long deals damage to Isaac"}, -- Breath of Life
	...
	[352] = {"352", "Glass Cannon", "Fires a large piercing spectral tear ((DMG x 10) + 10)#{{Blank}}#{{Warning}} Taking damage:#↓ Removes an extra 2 hearts of health#↑ {{Range}} Grants +1.5 Range up and leaves a blood trail for the room#The extra damage can't kill Isaac#Self-damage does not trigger the effect"}, -- Glass Cannon
	...
	[382] = {"382", "Friendly Ball", "Can be thrown at enemies to capture them#Using the item after capturing an enemy spawns the capture as a friendly companionWalking over the ball after a capture instantly recharges the item"}, -- Friendly Ball
	...
	[407] = {"407", "Purity", "↑ Boosts one of Isaac's stats depending on the color of the aura#Taking damage removes the effect, and grants a new effect in the next room#{{Blank}}#{{ColorRed}}Red{{CR}} = {{Damage}} +4 Damage up#{{ColorBlue}}Blue{{CR}} = {{Tears}} +2 Fire Rate up#{{ColorYellow}}Yellow{{CR}} = {{Speed}} +0.5 Speed up#{{ColorOrange}}Orange{{CR}} = {{Range}} +3 Range up"},
	[408] = {"408", "Athame", "Taking damage creates a black brimstone ring around Isaac"}, -- Athame
	[415] = {"415", "Crown Of Light", "{{SoulHeart}} +2 Soul Hearts#{{Blank}}#{{Blank}} If Isaac has no damaged Red Heart containers:#↑ {{Damage}} +100% Damage up#↑ {{Range}} +1.5 Range up#↓ {{Shotspeed}} -0.3 Shot Speed down#Deactivates for the current room when damaged at all"}, -- Crown Of Light
	...
	[437] = {"437", "D7", "Restarts a room and respawns all enemies#Can be used to get multiple rewards from a single room"}, -- D7
	...
	[450] = {"450", "Eye of Greed", "Every 20 tears, Isaac shoots a coin tear that deals x1.5 +10 damage#Enemies hit with the coin turn into gold#Killing a gold enemy drops 1-3 coins#Firing a coin tear removes 1 coin"}, -- Eye of Greed
	...
	[477] = {"477", "Void", "{{Warning}} Consumes all pedestal items in the room#Active items: Their effects activate with every future use of Void#↑ Passive items:Grant two random stats up"},
	...
	[506] = {"506", "Backstabber", "Hitting an enemy in the back deals double damage and causes bleeding, which makes enemies bleed and take damage when they move"},
	...
	[549] =	{"549", "Brittle Bones", "{{EmptyBoneHeart}} RReplaces all of Isaac's Red Heart containers with 6 empty Bone Hearts#Upon losing a Bone Heart:#Fires 8 bone tears in all directions#↑ {{Tears}} +0.4 permanent Fire Rate up"}, -- Brittle Bones
	...
	[555] = {"555", "Golden Razor", "{{Coin}} Removes 5 coins#{{Damage}} Grants +1.2 Damage up for the current room#{{Coin}} +5 coins"}, -- Golden Razor
	...
	[567] = {"567", "Paschal Candle", "↑ {{Tears}} Clearing a room without taking damage grants +0.4 Fire Rate#{{Tears}} Caps at +2 Fire Rate {{ColorSilver}}(5 rooms)"}, -- Paschal Candle
	...
	[569] = {"569", "Blood Oath", "{{Warning}} Entering a new floor drains all of Isaac's Red Hearts, and grants damage and speed bonuses for each heart lost#Each half-heart lost counts as an individual hit"}, -- Blood Oath
	...
	[582] = {"582", "Wavy Cap", "↑ {{Tears}} +0.75 Fire Rate up#↓ {{Speed}} -0.03 Speed down#Distorts the screen#The effects can be stacked"}, -- Wavy Cap
	[583] = {"583", "Rocket in a Jar", "{{Bomb}} +5 bombs#Placing a bomb while shooting fires a rocket in that direction"}, -- Rocket in a Jar
	[584] = {"584", "Book of Virtues", "Spawns an orbital wisp familiar that fires spectral tears but can be destroyed#Can be combined with a second active item to create special wisps#{{DevilRoom}} Turns the first Devil Room into an {{AngelRoom}} Angel Room#{{AngelChance}} 12.5% higher Angel Room chance#{{AngelChance}} Allows Angel Rooms to spawn after taking a Devil deal"}, -- Book of Virtues
	[585] = {"585", "Alabaster Box", "Must be charged by picking up Soul Hearts, then spawns:#{{SoulHeart}} Three Soul Hearts#{{AngelRoom}} Two Angel Room items#{{Blank}}#{{DevilRoom}} Only spawns 2 Soul Hearts and 1 Angel item if a Devil deal was taken previously"}, -- Alabaster Box
	...
	[588] = {"588", "Sol", "{{BossRoom}} Reveals the location of the Boss Room#Defeating the floor Boss:#↑ {{Damage}} Grants +3 Damage#↑ {{Luck}} Grants +1 Luck#{{Card20}} Activates The Sun#{{Battery}} Fully recharges the active item#{{CurseBlind}} Removes any Curses#{{Blank}}#{{Timer}} Effects last for one floor"}, -- Sol
	...
	[594] = {"594", "Jupiter", "↑ {{Heart}} +2 Health up#{{HalfHeart}} Heals half a Red Heart#↓ {{Speed}} -0.3 Speed down#↑ {{Speed}} Speed builds up to +0.5 while standing still#{{Poison}} Grants poison immunity#{{Poison}} Moving releases poison clouds"}, -- Jupiter
	[595] = {"595", "Saturnus", "Entering a room causes 7 tears to orbit Isaac#Enemy projectiles have a chance to orbit Isaac"}, -- Saturnus
	[596] = {"596", "Uranus", "{{Freezing}} Isaac shoots ice tears that freeze enemies killed#Touching a frozen enemiy makes it slide away and explode into 6 ice shards"}, -- Uranus
	...
	[615] = {"615", "Lil Dumpy", "Deflects an enemy or projectile right before Isaac would take damage from it#Needs to be touched after farting to be reactivated"}, -- Lil Dumpy
	...
	[617] = {"617", "Lodestone", "{{Magnetize}} 17% chance to magnetizing tears#{{Luck}} 100% chance at 5 Luck#Magnetized enemies attract nearby pickups, projectiles and enemies"}, -- Lodestone
	...
	[623] = {"623", "Sharp Key", "{{Key}} +5 keys#Throws one of Isaac's keys in the direction he shoots#Thrown keys deal damage, destroy obstacles, and open doors#Enemies killed with keys have can spawn the contents of a chest, including items"}, -- Sharp Key
	[624] = {"624", "Booster Pack", "{{Card}} Spawns 5 random cards"}, -- Booster Pack
	[625] = {"625", "Mega Mush", "Gigantifies Isaac and grants:#↑ {{Damage}} +300% Damage Multiplier#↑ {{Range}} +7 Range up#↓ {{Tears}} -60% Fire Rate down#Ability to crush enemies and obstacles#Complete invincibility#{{Blank}}#{{Timer}} The effect lasts for 30 seconds and persists between rooms and floors"}, -- Mega Mush
	...
	[653] = {"653", "Vade Retro", "Holding the item causes non-ghost enemies to spawn small red ghosts on death#Using the item causes the ghosts to explode#Kills all ghost enemies and bosses that have less than 50% HP left"}, -- Vade Retro
	...
	[656] = {"656", "Damocles", "Hangs a sword above Isaac's head, which doubles all pedestal items#Does not double Shop, Chest, or Devil deal items#{{Warning}} After taking any damage, the sword has a chance to instantly kill Isaac every frame"}, -- Damocles
	...
	[660] = {"660", "Card Reading", "Spawns two portals in the first room of each floor#Leaving the room despawns the portals#{{Blank}}#{{Blank}} {{ColorRed}}Red: {{CR}}{{BossRoom}} Boss Room#{{Blank}} {{ColorYellow}}Yellow: {{CR}}{{TreasureRoom}} Item Room#{{Blank}} {{ColorBlue}}Blue: {{CR}}{{SecretRoom}} Secret Room"}, -- Card Reading
	...
	[672] = {"672", "A Pound of Flesh", "{{DevilRoom}} Devil Room items cost coins#{{Shop}} Shop items cost heart#Consumables in shops are surrounded by spikes"}, -- A Pound of Flesh
	...
	[676] = {"676", "Empty Heart", "Grants a {{EmptyHeart}} Heart Container when at 1 Red Heart or less at the start of a new floor#No effect for characters that can't have Red Hearts"}, -- Empty Heart
	...
	[678] = {"678", "C Section", "{{Chargeable}} Replaces Isaac's tears with charge attack that fires homing, spectral fetus tears"}, -- C Section
	[679] = {"679", "Lil Abaddon", "{{Collectible399}} Shoots a mini Maw of the Void brimstone circle"}, -- Lil Abaddon
	...
	[691] = {"691", "Sacred Orb", "Prevents Quality {{Quality0}}/{{Quality1}} items from spawning#Quality {{Quality2}}, {{Quality3}}, and {{Quality4}} items have a 33% chance to rerolled"}, -- Sacred Orb
	[692] = {"692", "Sanguine Bond", "Spawns a set of spikes in the {{DevilRoom}}Devil Room#{{Blank}}#{{Blank}} Taking damage on the spikes grants:#Nothing {{ColorSilver}}(35%)#↑ {{Damage}} +0.5 Damage up {{ColorSilver}}(33%)#{{Coin}} 6 pennies {{ColorSilver}}(15%)#{{BlackHeart}} 2 Black Hearts {{ColorSilver}}(10%)#{{DevilRoom}} Devil item {{ColorSilver}}(5%) #Leviathan transformation {{ColorSilver}}(2%)"}, -- Sanguine Bond
	...
	[698] = {"698", "Twisted Pair", "Stand on each side of Isaac#Copy isaac's tear stats and effects at 37.5% of their damage"}, -- Twisted Pair
	...
	[704] = {"704", "Berserk!", "Charges with damage dealt#{{Blank}}#{{Blank}} Using the item grants:#↑ {{Speed}} +0.4 Speed up#↑ {{Damage}} +3 Damage up#Restricts attacks to a melee weapon#{{Blank}}#{{Timer}} Effect lasts for 10 seconds#{{Blank}} Each kill increases the duration by 1 second"}, -- Berserk!
	[705] = {"705", "Dark Arts", "↑ +1 Speed up#Turns Isaac into a shadow that can pass through enemies to paralyze them#After 1 second, damages all paralysed enemies and creates a blast at Isaac's location#The attacks and blast are more powerful the more enemies have been hit"}, -- Dark Arts
	...
	[709] = {"709", "Suplex!", "Isaac dashes in the direction he moves#Dashing into an enemy or boss picks it up and slams it into the ground#Slam deals damage and spawns rock waves based on Isaac's size"}, -- Suplex!
...
EID.descriptions[languageCode].bookOfBelialBuffs = {
	...
	[555] = "Damages all enemies in the room and applies the {{Collectible202}}Midas' Touch effect to them", -- Golden Razor
	[577] = "Grants a permanent damage up", -- Damocles
	[582] = "Grants a permanent damage up beased on the highest number of times the effects of the item have been stacked", -- Wavy Cap
...
local repTrinkets={
	...
	[98] = {"98", "Nose Goblin", "{{Poison}} 5% chance to shoot homing sticky tears#Boogers deal Isaac's damage once per second#Boogers stick for 60 seconds"},
	...
	[107] = {"107", "Crow Heart", "Taking damage depletes red hearts before soul/black hearts"}, -- Crow Heart
	...
	[136] = {"136", "Broken Padlock", "Doors, key blocks and golden chests can be opened with explosions#Explosions can also open the Home door"}, -- Broken Padlock
	...
	[159] = {"159", "Gilded Key", "{{Key}} +1 key#{{GoldenChest}} Replaces all chests (except Old/Mega) with Golden Chests#{{GoldenChest}} Golden Chests can contain extra cards, pills or trinkets"}, -- Gilded Key
	...
	[173] = {"173", "Your Soul", "{{DevilRoom}} Allows Isaac to take 1 Devil Room item for free#Using this trinket to get an item destroys it#{{Warning}} The free Devil deal still affects Angel Room chance"}, -- Your Soul
	...
	[177] = {"177", "Temporary Tattoo", "Clearing a {{ChallengeRoom}} Challenge Room spawns a {{Chest}} chest#Clearing a {{BossRushRoom}} Boss Challenge Room spawns an item"}, -- Temporary Tattoo
...
local repCards={
	[2] = {"2", "I - The Magician", "#Homing tears#↑ {{Range}} +3 Range#{{Blank}}#{{Timer}} Lasts for one room"}, -- I - The Magician
	[12] = {"12", "XI - Strength", "↑ {{Heart}} +1 Health up#↑ {{Damage}} +0.3 Damage up#↑ {{Damage}} +50% Damage#↑ {{Range}} +5.25 Range up#↑ {{Speed}} +0.3 Speed up#{{Blank}}#{{Timer}} Lasts for one room"}, -- XI - Strength
	[16] = {"16", "XV - The Devil", "↑ {{Damage}} +2 Damage up#{{Blank}}#{{Timer}} Lasts for one room"},
	...
	[59] = {"59", "III - The Empress?", "#↑ {{Heart}} +2 Health up#↑ {{Tears}} +1.35 Tears up#{{Blank}}#{{Timer}} Effect lasts for 60 seconds"}, -- III - The Empress?
	...
	[63] = {"63", "VII - The Chariot?", "Turns Isaac into an invincible immobile statue#↑ {{Tears}} Extreme fire rate#{{Blank}}#{{Timer}} Effects last for 10 seconds"}, -- VII - The Chariot?
	...
	[67] = {"67", "XI - Strength?", "{{Weakness}} Enemies in current room are weakened, slowed and take double damage#{{Blank}}#{{Timer}} Effect lasts 1 minute"}, -- XI - Strength?
	[68] = {"68", "XII - The Hanged Man?", "{{Player14}} Turns the player into the Keeper#Grants triple shot and speed down#Killed enemies drop random coins#{{Blank}}#{{Timer}} Effect lasts for 60 seconds"}, -- XII - The Hanged Man?
	...
	[71] = {"71", "XV - The Devil?", "{{Collectible33}} Activates The Bible#{{Collectible390}} Grants Seraphim#Grants flight#{{Blank}}#{{Timer}} Effect lasts for 30 seconds"}, -- XV - The Devil?
	...
	[75] = {"75", "XIX - The Sun?", "↑ Gain flight and spectral tears#↑ {{Damage}} +1.5 Damage up#{{BoneHeart}} Turns all Red Hearts into Bone Hearts#Applies Curse of Darkness#{{Blank}}#{{Timer}} Lasts for one floor"}, -- XIX - The Sun?
	...
	[82] = {"82", "Soul of Magdalene", "{{HalfHeart}} Enemies killed drop red half hearts that disappear after 2 seconds#{{Blank}}#{{Timer}} Effect lasts one room"}, -- Soul of Magdalene
	[83] = {"83", "Soul of Cain", "Opens all doors in the room, including {{Collectible580}} red doors"}, -- Soul of Cain
	...
	[86] = {"86", "Soul of Eve", "14 Dead Bird familiars fly in and attack enemies#{{Blank}}#{{Timer}} Effect lasts for one room or until all enemies are dead"}, -- Soul of Eve
	[87] = {"87", "Soul of Samson", "↑ {{Speed}} +0.4 Speed up#↑ {{Damage}} +3 Damage up#Restricts attacks to a melee weapon#{{Blank}}#{{Timer}} Effect lasts for 10 seconds#{{Blank}} Each kill increases the duration by 1 second"}, -- Soul of Samson
	[88] = {"88", "Soul of Azazel", "{{Collectible441}} Isaac vomits a Mega Blast laser for 7.5 seconds"}, -- Soul of Azazel
	[89] = {"89", "Soul of Lazarus", "Isaac dies and immediately revives at half a heart with some invincibility time#Is automatically used upon taking fatal damage (acts as an extra life)"}, -- Soul of Lazarus
	...
	[91] = {"91", "Soul of the Lost", "{{Player10}} Turns the player into The Lost#Allows taking one {{DevilRoom}}Devil Room item for free#Allows entering the Mausoleum or Gehenna door for free#{{Blank}}#{{Timer}} Effect lasts for one room"}, -- Soul of the Lost
...
EID.descriptions[languageCode].tarotClothBuffs = {
	...
	[9] = "Spawns two of each pickups", -- VIII - Justice
	...
	[12] = "Doubles the stat increases, except the multiplier", -- XI - Strength
...
local repPills={
	...
	[43] = {"42", "I'm Excited{{Warning}}", "Speeds up Isaac and all enemies in the room#Triggers again after 30 and 60 seconds"}, -- I'm Excited{{Warning}}
...
EID.descriptions[languageCode].horsepills={
	...
	{"42", "I'm Excited{{Warning}}", "Speeds up Isaac and all enemies in the room"}, --I'm Excited{{Warning}}
	...
	{"45", "Makes Isaac briefly invincible#{{Fear}} Fears all enemies in the room#Feared enemies take 40 contact damage per second#{{HalfHeart}} Eating 2 enemies replenishes half a heart"}, -- Feels like I'm walking on sunshine!
...
EID.descriptions[languageCode].GlitchedItemText = {
	...
	chain = "Then:{{CR}} ",
	active = "On use:#",
	pickup_collected = "Collecting a pickup:#",
	...
	room_clear = "Clearing a room:#",

	-- Attribute effects
	area_damage = "Deals {1} damage in an area around Isaac",
	add_temporary_effect = "Grants {1} for the room",
	convert_entities = "Converts all {1} in the room to {2}",
	use_active_item = "Uses {1}",
	spawn_entity = "Spawns a {1}",
	fart = "Farts with size {1}",
