...
local repCollectibles={
	...
	[64] = {"64", "Steam Sale", "{{Shop}} -50% discount on {{Shop}} Shop items#Getting this item multiple times reduces the price further"}, -- Steam Sale
	...
	[77] = {"77", "My Little Unicorn", "Grants invincibility and {{Speed}} +0.28 Speed up for 6 seconds#20 contact damage"}, -- My Little Unicorn
	...
	[84] = {"84", "We Need To Go Deeper!", "Spawns a trapdoor to the next floor#Spawns a {{LadderRoom}}crawlspace if used on a decorative floor tile (grass, small rocks, papers, gems, etc.)"},
	...
	[110] = {"110", "Mom's Contacts", "20% chance to shoot Freezing tears#{{Luck}} 50% chance at 20 Luck#↑ {{Range}} +0.38 Range up"}, -- Mom's Contacts
	...
	[203] = {"203", "Humbling Bundle", "50% chance to spawn the double version of pickups"}, -- Humbling Bundle
	...
	[228] = {"228", "Mom's Perfume", "{{Fear}} 15% chance to shoot Fear tears#{{Luck}} 100% chance at 85 Luck#↑ {{Tears}} +0.5 Fire Rate up"}, -- Mom's Perfume
	[229] =	{"229", "Monstro's Lung", "Tears can now be charged and released in a shotgun style attack#↓ {{Tears}} 4.3x Tear Delay up"},
	...
	[419] = {"419", "Teleport 2.0", "Teleports you to another random room that has not been entered yet#Hierarchy: {{Room}}>{{BossRoom}}>{{SuperSecretRoom}}>{{Shop}}>{{TreasureRoom}}>{{SacrificeRoom}}> {{DiceRoom}}>{{Library}}>{{CursedRoom}}>{{MiniBoss}}>{{ChallengeRoom}}>{{IsaacsRoom}}> {{ArcadeRoom}}>{{ChestRoom}}>{{Planetarium}}>{{SecretRoom}}>{{DevilRoom}}{{AngelRoom}}> Error-Room"}, -- Teleport 2.0
	...
	[612] = {"612", "Lost Soul", "Soul familiar that dies in one hit, respawning at the start of the next floor#If it survives an entire floor, it spawns 3 Soul Hearts, 2 Eternal Hearts, or a {{TreasureRoom}}Treasure Room or {{AngelRoom}}Angel Room item"}, -- Lost Soul
	...
	[672] = {"672", "A Pound of Flesh", "{{DevilRoom}} Devil Room items now cost coins#Shop items now cost health#Consumables in shops are free, but surrounded by spikes"}, -- A Pound of Flesh
	...
	[716] = {"716", "Keeper's Sack", "{{Shop}} Gives {{Range}} range, {{Speed}} speed, or {{Damage}} damage up when buying items or consumables from shops#Spawns 3 coins and 1 key on pickup"}, -- Keeper's Sack
