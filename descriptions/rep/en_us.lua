...
local additionalCollectibleInformations = {
	...
	[C_ID .. 487] = "{{EmptyHeart}} Removes 1 heart container for: #↑ {{Damage}} +0.2 Damage#{{Collectible73}} A Cube of Meat#{VAR:ROOMEFFECT}#{{Collectible214}} Leave a trail of blood creep", -- Potato Peeler
	...
	[C_ID .. 503] = "{VAR:LUCKCHANCE}% chance to shoot a tear that summons a Big Horn hand#The hand instantly kills enemies and deals 36 damage to bosses#Isaac deals 7 contact damage per second", -- Little Horn
...
local additionalPillInformations = {
    ...
    [Pill_ID .. (HorseID + 10)] = "Eating 3 grants the Adult transformation:#↑ {{Heart}} +1 Health", -- Puberty
    ...
    [Pill_ID .. (HorseID + 37)] = "{VAR:ROOMEFFECT}#{VAR:TIMEDEFFECT}#Isaac can't shoot but deals 40 contact damage per second#{{HealingRed}} Eating 2 enemies heals half a heart#{{Fear}} Fears all enemies in the room", -- Power Pill!
    ...
    [Pill_ID .. (HorseID + 46)] = "{VAR:TIMEDEFFECT}#Isaac can't shoot but deals 40 contact damage per second#{{HealingRed}} Eating 2 enemies heals half a heart#{{Fear}} Fears all enemies in the room", -- Feels like I'm walking on sunshine!
