...
local repCollectibles={
	...
	[352] = {"352", "Glass Cannon", "Fires one large piercing spectral tear ((DMG x 10) + 10)#!!! When you take damage (self-damage doesn't count):#↓You will lose an extra 2 hearts of health#↑ + 1.5 Range"}, -- Glass Cannon
...
local repCards={
	...
	[91] = {"91", "Soul of the Lost", "Die and turn into The Lost for current room#You can take one {{DevilRoom}}Devil Room item for free, the rest will disappear"}, -- Soul of the Lost
