...
local repCollectibles={
	...
	[69] = {"69", "Chocolate Milk", "{{Chargeable}} Chargeable tears#↑ {{Damage}} Up to 400% Damage"},
	...
	[84] = {"84", "We Need To Go Deeper!", "Spawns a trapdoor to the next floor#{{LadderRoom}} Spawns a crawlspace if used on a decorative floor tile (grass, small rocks, papers, gems, etc.)"},
	...
	[142] = {"142", "Scapular", "{{SoulHeart}} Once per room, when damaged down to half a heart, you gain 1 Soul Heart#!!! Doesn't trigger from donation effects"},
	...
	[169] =	{"169", "Polyphemus", "↑ {{Damage}} +100% Damage up#↑ {{Damage}} +4 additional Damage up#↓ {{Tears}} -58% Fire Rate down#Tears travel on after killing an enemy with any leftover damage"},
	...
	[229] =	{"229", "Monstro's Lung", "{{Chargeable}} Tears are charged and released in a shotgun style attack#↓ {{Tears}} -77% Fire Rate down"},
	...
	[309] =	{"309", "Pisces", "↑ {{Tears}} +0.5 Fire Rate up#Increases tear knockback"},
