...
local repCollectibles={
	...
	[311] = {"311", "Judas' Shadow", "{{Player12}} When dead, respawn as Dark Judas#{{Damage}} He has a 2x Damage Multiplier#{{Player24}} Tainted ??? will revive himself"} --Judas' Shadow
	...
	[552] = {"552", "Mom's Shovel", "Spawns a trapdoor to the next floor#Spawns a {{LadderRoom}}crawlspace if used on a decorative floor tile (grass, small rocks, papers, gems, etc.)"},
