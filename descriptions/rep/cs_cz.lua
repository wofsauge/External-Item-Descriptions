...
local repCharacterInfo = {
	...
	[22] = {"Poskvrněná Magdaléna", "Zdraví nad 2 červená srdce se pomalu vyčerpává#Při kontaktu uděláš švih na blízko pro 6násobné poškození#{{HalfHeart}} Šance pro nepřátele vytvoření půlek červených srdcí, která zmizí do 2 sekund#Drop je zaručen při zabití zblízka#{{Collectible45}} Uzdravíš se dvakrát tolik z jiných zdrojů#{{AngelDevilChance}} Poškození způsobené během vyčerpávání srdcí neovlivní Ďábelskou šanci "},
...
local repTrinkets={
	...
	[162] = {"162", "Azazelův Pahýl", "{{Player7}} 33% šance, že se po vyklizení místnosti proměníš v Azazela#Účinek trvá do vyklizení a opuštění jiné místnosti"}, -- Azazel's Stump
...
EID.descriptions[languageCode].BookOfVirtuesWispTexts = {
	...
	Damage = "{1}% Poškození", 					-- {1} will be replaced with the damage changes in %
