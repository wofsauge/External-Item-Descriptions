...
local repCollectibles={
	...
	[5] = {"5", "Mon Reflet", "↑ Portée {{ColorLime}}x1.6 +1.5#↑ Vitesse des tirs {{ColorLime}}+0.6#Les larmes d'Isaac reviennent vers lui comme un boomerang"}, -- My Reflection
	...
	[67] = {"67", "Sœurette Maggy", "Suit Isaac et tire dans la même direction que lui#{{Blank}}#{{DamageSmall}} 6 par larme"}, -- Sister Maggy
    ...
    [155] = {"155", "Œil Baladeur", "Rebondit contre les murs de la salle#↑ Dégâts {{ColorLime}}+34%{{ColorWhite}} pour les larmes tirées de l'œil gauche#{{Blank}}#{{DamageSmall}} 17.1 par seconde au contact"},
	...
	[172] = {"172", "Dague Sacrificielle", "Orbite autour d'Isaac#Bloque les tirs ennemis#{{Blank}}#{{DamageSmall}} 112 par seconde au contact"},
    [176] = {"176", "Cellules Souches", "{{Heart}} +1 réceptacle de cœur#↑ Vitesse des tirs {{ColorLime}}+0.16#Soigne un cœur rouge"}, -- Stem Cells
	[178] = {"178", "Eau Bénite", "Se projette dans la direction où tire Isaac#Répand une flaque paralysante en se brisant#{{Blank}}#{{DamageSmall}} 7 à l'ennemi touché#{{Blank}} 24 par seconde pour la flaque"}, -- Holy Water
	...
	[188] = {"188", "Abel", "Réfléchit les mouvements d'Isaac#Tire en direction d'Isaac#{{Blank}}#{{DamageSmall}} 3.5 par larme#{{Blank}} 7.5 par larme si ramassé avec {{ColorLightOrange}}Caïn"}, -- Abel
	...
	[206] = {"206", "Guillotine", "↑ Dégâts {{ColorLime}}+1.0#↑ Débit {{ColorLime}}+1.0#La tête d'Isaac se sépare de son corps et l'orbite#Les larmes sont tirées depuis la tête#{{Blank}}#{{DamageSmall}} 56 par seconde au contact"}, -- Guillotine
	...
	[214] = {"214", "Anémie", "↑ Portée {{ColorLime}}+1.5#Subir un dégât répand une traînée de sang corrosive derrière Isaac pour la durée d'une salle#{{Blank}}#{{DamageSmall}} 6 par seconde pour la flaque"}, -- Anemic
	...
	[238] = {"238", "1er Fragment de Clé", "Combiner ce fragment de clé avec l'autre {{Collectible239}} permet d'ouvrir la grande porte dorée dans le {{ColorTransform}}Coffre{{ColorWhite}} et la {{ColorTransform}}Chambre Noire #{{AngelChanceSmall}} Augmente les chances d'Offrandes des Anges {{AngelRoom}}"},
	[239] = {"239", "2è Fragment de Clé", "Combiner ce fragment de clé avec l'autre {{Collectible238}} permet d'ouvrir la grande porte dorée dans le {{ColorTransform}}Coffre{{ColorWhite}} et la {{ColorTransform}}Chambre Noire #{{AngelChanceSmall}} Augmente les chances d'Offrandes des Anges {{AngelRoom}}"},
	[240] = {"240", "Traitement Expérimental", "↑ Augmente 4 stats aléatoires#↓ Diminue 2 stats aléatoires"}, -- Experimental Treatment
	[245] = {"245", "20/20", "↓ Dégâts {{ColorError}}-25%#Duplique les larmes tirées par Isaac#Annule la réduction de débit de {{ColorYellow}}Polyphème{{ColorWhite}} {{Collectible169}}, du {{ColorYellow}}Troisième Œil{{ColorWhite}} {{Collectible2}} et d'{{ColorYellow}}Araignée Mutante{{ColorWhite}} {{Collectible153}}"}, -- 20/20
	...
	[273] = {"273", "Cerveau de Bob", "Peut être projeté en ligne droite avec les boutons de tir#Explose au contact d'un ennemi#{{Blank}}#{{Warning}} L'explosion peut infliger des dégâts à Isaac#{{Blank}}#{{DamageSmall}} 100 par explosion"}, -- Bob's Brain
	[274] = {"274", "Meilleure Pote", "Fait apparaître une mouche qui orbite autour d'Isaac pour la durée d'une salle quand il subit des dégâts#{{Blank}}#{{DamageSmall}} 150 par seconde au contact"}, -- Best Bud
	[275] = {"275", "P'tit Soufre", "Tire un laser de sang#{{Blank}}#{{DamageSmall}} 20 sur la durée d'un laser"}, -- Lil Brimstone	
...
--	[297] = {"297", "Boîte de Pandore", "{{Warning}} USAGE UNIQUE#{{Blank}} Donne selon l'étage :#{{ColorTransform}}SS1{{ColorWhite}} : 2 cœurs d'âme#{{ColorTransform}}SS2{{ColorWhite}} : 2 clés, 2 bombes#{{ColorTransform}}G1{{ColorWhite}} : 1 Objet de boss#{{ColorTransform}}G2{{ColorWhite}} : SS1 + G1#{{ColorTransform}}P1{{ColorWhite}} : 4 cœurs d'âme#{{ColorTransform}}P2{{ColorWhite}} : 30 pièces#{{ColorTransform}}U1{{ColorWhite}} : 2 Objets de boss#{{ColorTransform}}U2{{ColorWhite}} : La {{ColorYellow}}Bible{{ColorWhite}} {{Collectible33}}#{{ColorTransform}}Shéol{{ColorWhite}} : 1 Objet du Diable, 1 cœur noir#{{ColorTransform}}Cathédrale{{ColorWhite}} : 1 Objet d'Ange + 1 cœur d'âme#{{ColorTransform}}Coffre{{ColorWhite}} : 1 Pièce#{{ColorTransform}}Chambre Noire{{ColorWhite}} : Débloque {{ColorYellow}}Carton de Déménagement{{ColorWhite}} {{Collectible523}}#{{ColorTransform}}Maison{{ColorWhite}} : La {{ColorYellow}}Clé Rouge{{ColorWhite}} {{Collectible580}}"}, -- Pandora's box
	...
	[320] = {"320", "La Seule Amie de ???", "Familier contrôlable avec les boutons de tir#{{Blank}}#{{DamageSmall}} 105 par seconde"}, -- ???'s Only Friend
	...
	[326] = {"326", "Souffle de Vie", "Maintenir le bouton d'utilisation vide progressivement la barre de charge#Quand elle est vide, Isaac devient invulnérable pour une seconde#Des rayons de lumière frappent les ennemis qui entrent en contact avec Isaac pendant cette période#{{Warning}} Rester appuyé plus d'une seconde après que la barre a été vidée inflige des dégâts à Isaac"}, -- Breath of Life
	...
	[350] = {"350", "Choc Toxique", "Empoisonne tous les ennemis en entrant dans une salle#Les ennemis répandent une flaque toxique à leur mort#Rend Isaac invulnérable aux nuages de poison#{{Blank}}#{{DamageSmall}} L'empoisonnement inflige {{ColorLime}}dégâts x2"}, -- Toxic Shock
	...
	[360] = {"360", "Incube", "Imite les stats et effets des larmes d'Isaac#{{Blank}}#{{DamageSmall}} 75% des dégâts d'Isaac#{{Blank}} 100% des dégâts de {{ColorLightOrange}}Lilith"}, -- Incubus
	...
	[365] = {"365", "Mouche Égarée", "Longe les murs et les obstacles#Les ennemis à proximité d'elle la prennent pour cible#{{Blank}}#{{DamageSmall}} 56 par seconde au contact"},
	...
	[384] = {"384", "P'tit Boris", "Charge quand Isaac tire, puis se propulse à travers la salle et rebondit contre les murs quand les boutons de tirs sont relâchés#{{Blank}}#{{DamageSmall}} 5-20 au contact selon la durée de la charge"}, -- Lil Gurdy
	...
	[404] = {"404", "Bébé Péteur", "Bloque les projectiles ennemis#S'il est touché par un projectile ennemi, le familier pète et envoûte, empoisonne ou repousse les ennemis#{{Blank}}#{{DamageSmall}} 5-6 par pet"}, -- Farting Baby
	...
	[408] = {"408", "Athamé", "Quand Isaac subit des dégâts, un anneau noir apparaît autour de lui et inflige des dégâts aux ennemis"}, -- Athame
	[414] = {"414", "Plus d'Options", "Permet à Isaac de choisir entre deux objets dans les Salles du Trésor {{TreasureRoom}}"},
	[415] = {"415", "Couronne de Lumière", "{{SoulHeart}} +2 Cœurs d'âme#↑ Dégâts {{ColorLime}}x2#↑ Portée {{ColorLime}}+1.5#↓ Vitesse des tirs {{ColorError}}-0.3#Subir un dégât désactive ces effets pour la durée d'une salle#Les effets restent désactivés tant que tous les réceptacles de cœurs d'Isaac ne sont pas remplis"},
	...
	[417] = {"417", "Succube", "Rebondit contre les murs entourée d'une aura#↑ Dégâts {{ColorLime}}+50%{{ColorWhite}} tant qu'Isaac reste dans l'aura#{{Blank}}#{{DamageSmall}} 7.5-10 par seconde aux ennemis dans l'aura"}, -- Succubus
	...
	[426] = {"426", "Admiratrice Obsessionnelle", "Imite les mouvements d'Isaac avec 0.66 secondes de délai##{{Blank}}#{{DamageSmall}} 30 par seconde au contact"}, -- Obsessed Fan
	[430] = {"430", "Papa Mouche", "Imite les mouvements d'Isaac avec 0.6 secondes de délai#Tire des larmes sur les ennemis à proximité##{{Blank}}#{{DamageSmall}} Identiques à ceux d'Isaac"}, -- papa Fly
	...
	[504] = {"504", "Bout de Crotte", "Fait apparaître une mouche sentinelle qui tire sur les ennemis à proximité#{{Blank}}#{{DamageSmall}} 3.5 par larme"}, -- Brown Nugget
	[506] = {"506", "Traîtrise", "Toucher un ennmi dans le dos avec une larme inflige le double de dégâts et le fait saigner#Le saignement inflige des dégâts à l'ennemi selon sa vitesse de déplacement"},
	...
	[508] = {"508", "Rasoir de Maman", "Orbite autour d'Isaac#Bloque les projectiles#Fait saigner les ennemis qui entrent en contact avec lui#Le saignement inflige des dégâts à l'ennemi selon sa vitesse#Les ennemis qui saignent répandent du sang corrosif derrière eux{{Blank}}#{{DamageSmall}} 2x les dégâts d'Isaac par seconde au contact"},
	[509] = {"509", "Nœnœil", "Orbite autour d'Isaac et tire sur les ennemis à proximité#{{Blank}}#{{DamageSmall}} 3.5 par larme#{{Blank}} 30 par seconde au contact"}, -- Bloodshot Eye
	...
	[565] = {"565", "Chiot de Sang", "Pourchasse et inflige des dégâts aux ennemis#Après avoir tué suffisamment d'ennemis, il gagne en puissance mais pourchasse aussi Isaac#Le chiot peut être calmé si Isaac lui inflige assez de dégâts ou le fait exploser#{{Blank}}#{{DamageSmall}} 4-7.5-15 par seconde selon son niveau d'énervement"}, --  Blood Puppy
	...
	[581] = {"581", "Mouche Oracle", "Pourchasse et détruit les projectiles ennemis#{{Blank}}#{{DamageSmall}} 15 par seconde au contact"}, --  Psy Fly
	...
	[599] = {"599", "Tête Réduite", "Fait apparaître une Salle Maudite {{CursedRoom}} supplémentaire à chaque étage#Les Salles Maudites {{CursedRoom}} sont de meilleure qualité"}, --  Voodoo Head
	...
	[607] = {"607", "Bébé Furoncle", "Tire une gerbe de larmes dans toutes les directions#{{Blank}}#{{DamageSmall}} 3.5 ou 5.3 par larme"}, --  Boiled Baby
	[608] = {"608", "Bébé Congelé", "Tire des larmes de glace#Gèle les ennemis qu'il tue#Entrer en contact avec un ennemi gelé le fait glisser et exploser en 6 fragments de glace#{{Blank}}#{{DamageSmall}} 3.5 par larme"}, --  Freezer Baby
	[609] = {"609", "D6 Éternel", "Rejoue tous les objets de la salle#Les objets ont 30% de chances de disparaître"}, --  Eternal D6
	[610] = {"610", "Gros Piaf", "Plonge sur l'ennemi responsable du premier dégât infligé à Isaac dans la salle et crée une vague de rochers#Pourchasse ensuite les ennemis#{{Blank}}#{{DamageSmall}} 45 à l'ennemi écrasé#{{Blank}} 9 par seconde au contact"}, --  Bird Cage
	...
	[615] = {"615", "P'tit Prout", "Suit Isaac#Pète et repousse un ennemi ou projectile ennemi sur le point de toucher Isaac#Après avoir pété, ne pète plus jusqu'à ce qu'Isaac entre en contact avec lui"}, --  Lil Dumpy
	...
	[627] = {"627", "2è Morceau de Couteau", "Combiné avec le {{ColorYellow}}Premier Morceau{{ColorWhite}} {{Collectible627}}, forme un couteau#Le couteau peut ouvrir une porte faite de chair#{{Blank}}#{{DamageSmall}} 25 {{ColorSilver}}(Couteau entier)"}, --  Knife Piece 2
	...
	[629] = {"629", "Robomouche", "Suit Isaac et tire des larmes sur les projectiles ennemis pour les détruire#{{Blank}}#{{DamageSmall}} 3 par seconde au contact"}, --  Bot Fly
	...
	[641] = {"641", "Haqeldemah", "Pend une traînée de larmes derrière Isaac dans les salles hostiles#{{Blank}}#{{DamageSmall}} 3.5 par larme"}, --  Akeldama
	...
	[645] = {"645", "P'tit Tératome", "Orbite autour d'Isaac et bloque les projectiles#Après avoir reçu 3 coups, se sépare en parties plus petites#Les versions les plus petites se transforment en araignées bleues quand elles meurent#Réapparaît 5 secondes après sa disparition complète#{{Blank}}#{{DamageSmall}} 3.5 par seconde au contact"}, --  Tinytoma
	...
	[649] = {"649", "P'tite Prunelle", "Se propulse en diagonale en tirant des larmes derrière elle#{{Blank}}#{{DamageSmall}} 3 par larme#{{Blank}} 6 par seconde au contact"}, --  Fruity Plum
	...
	[652] = {"652", "Bébé Glaçon", "Glisse quand il est poussé par Isaac#Ralentit les ennemis et leur inflige des dégâts de contact#Gèle les ennemis qu'il tue#Entrer en contact avec un ennemi gelé le fait glisser et exploser en 6 fragments de glace#{{Blank}}#{{DamageSmall}} 1-11 au contact selon sa vitesse"}, --  Cube Baby
	...
	[679] = {"679", "P'tit Abaddon", "Charge l'effet de {{ColorYellow}}Gouffre du Néant{{ColorWhite}} {{Collectible399}} quand Isaac tire et le crache quand les boutons de tir sont relâchés#{{Blank}}#{{DamageSmall}} 52.5 sur la durée d'un anneau"}, --  Lil Abaddon
	...
	[681] = {"681", "P'tit Vortex", "S'élance dans la direction des tirs d'Isaac#Inflige des dégâts de contact et consomme les ressources sur son chemin#Chaque ressource absorbée augmente sa taille, ses dégâts et fait apparaître une mouche bleue#Toutes les 4 ressources consommées, fait apparaître un vortex vers une salle inexplorée#{{Blank}}#{{DamageSmall}} 40-60-80-100 par seconde selon sa taille"}, --  Lil Portal
	[682] = {"682", "Ver de Nerf", "Un tentacule sort parfois du sol pour immobiliser un ennemi et lui infliger des dégâts#{{Blank}}#{{DamageSmall}} 32 sur la durée d'une immobilisation"}, --  Worm Friend
	...
	[698] = {"698", "Jumeaux Malicieux", "Se placent de chaque côté d'Isaac et tirent des larmes identiques aux siennes#{{Blank}}#{{DamageSmall}} 0.375x les dégâts d'Isaac par larme"}, --  Twisted Pair
	...
	[702] = {"702", "Esprit Vengeur", "Subir un dégât invoque un feu follet invulnérable pour la durée de l'étage#Les feux follets ne bloquent pas les projectiles#{{Blank}}#{{DamageSmall}} 7.5x les dégâts d'Isaac par seconde au contact"}, --  Vengeful Spirit
...
local repTrinkets={
	...
	[16] = {"16", "Ongle de Pied de Maman", "Le pied de {{ColorCyan}}Maman{{ColorWhite}} écrase un endroit au hasard dans la salle toutes les 60 secondes"},
	...
	[142] = {"142", "Foi de Béthanie", "Au début de chaque étage, invoque 4 feux follets du {{ColorYellow}}Livre des Vertus{{ColorWhite}} {{Collectible584}}"}, --  Beth's Faith
	...
	[164] = {"164", "Amorces", "Ajoute une bombe supplémentaire à chaque bombe posée"}, --  Ring Cap
	...
	[173] = {"173", "Ton Âme", "{{Warning}} USAGE UNIQUE{{Warning}}#Peut être utilisé pour signer un pacte avec le diable sans perdre de PV"}, --  Your Soul
	...
	[176] = {"176", "P'tit Pâté", "Invoque un pâté amical qui imite les mouvements et les larmes d'Isaac#{{Blank}}#{{DamageSmall}} 35% des dégâts d'Isaac par larme"}, --  Lil Clot
	[177] = {"177", "Tatouage Temporaire", "Fait apparaître un coffre en triomphant d'une Salle de Défi {{ChallengeRoom}}#Fait apparaître un objet en triomphant d'une Salle de Défi Royale {{BossRushRoom}}"}, --  Temporary Tattoo
	...
	[180] = {"180", "Âme Retrouvée", "Suit les mouvements d'Isaac et tire des larmes spectrales#Imite les larmes d'Isaac#Meurt s'il subit un dégât#Revient à l'étage suivant#{{Blank}}#{{DamageSmall}} 50% des dégâts d'Isaac par larme"}, --  Found Soul
...
EID.descriptions["fr"].AchievementWarningText = "Les succès sont désactivés !#Pour pouvoir débloquer des succès, tu dois d'abord tuer {{ColorCyan}}Maman{{ColorSilver}} (Profondeurs II){{ColorWhite}}.#{{Blank}} {{ColorSilver}}(Si tu as déjà battu {{ColorCyan}}Maman{{ColorSilver}}, ce message est un bug et peut être ignoré)#{{Blank}} {{ColorSilver}}(Cette alerte peut être désactivée dans la config)"
