...
local repCollectibles={
	...
	[720] = {"720", "", "Fait apparaître certains collectibles en fonction du nombre de charges de l'objet#En cas de charge complète, l'effet sera bien plus fort#Récompenses de charge :#1: Caca 2:{{Coin}} 3:{{Bomb}} 4:{{Key}} 5:{{Heart}} 6:{{Pill}} 7:{{Card}} 8:{{SoulHeart}} 9:{{GoldenHeart}} 10:{{GoldenKey}} 11:{{GoldenBomb}}"}, --  Everything Jar
...
local repTrinkets={
	...
	[186] = {"186", "", "{{Throwable}} {{ColorOrange}}Peut être lancé{{CR}} (appuyer deux fois sur la touche)#Confère 2 familiers mouches qui peuvent attaquer"}, --  Apollyon's Best Friend
