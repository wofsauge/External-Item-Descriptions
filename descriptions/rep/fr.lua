...
local repCollectibles={
	...
	[46] = {"46", "Pied Chanceux", "↑ Chance {{ColorLime}}+1#Augmente les chances de gagner aux jeux d'argent#Augmente les chances d'obtenir une ressource après avoir terminé une salle#Transforme certaines mauvaises pilules en bonnes pilules"}, -- Lucky Foot
	...
	[83] = {"83", "Clou Pointu", "{{HalfBlackHeart}} +1 Demi-cœur noir#{{Blank}} Pour une salle :#↑ Dégâts {{ColorLime}}+0.7#↓ Vitesse {{ColorError}}-0.18#Permet à Isaac d'infliger des dégâts de contact#Permet à Isaac d'écraser les obstacles"}, -- The Nail
	...
	[135] = {"135", "Perfusion", "Inflige un demi-cœur de dégâts à Isaac et fait apparaître 1-2 pièces#Ne fait apparaître qu'une pièce en mode Difficile#Retire les cœurs rouges en priorité"},
    [136] = {"136", "Meilleur Ami", "Place une peluche en forme d'Isaac#La peluche attire les ennemis et explose après 5 secondes"},
	...
	[149] = {"149", "Ipéca", "↑ Dégâts {{ColorLime}}+40#↓ Vitesse des tirs {{ColorError}}-0.2#↓ Débit {{ColorError}}-67%#Les larmes d'Isaac explosent au contact et empoisonnent les ennemis touchés"}, -- Ipecac
	...
	[158] = {"158", "Boule de Cristal", "Révèle l'étage sur la carte#Fait apparaître une carte ou un cœur d'âme#{{Blank}}#{{Blank}} Quand tenue :#↑ Chance de Planétarium {{ColorLime}}+15%#↑ Chance de Planétarium {{ColorLime}}+100%{{ColorWhite}} si une Salle du Trésor {{TreasureRoom}} a été ignorée"}, -- Crystal Ball
	...
	[181] = {"181", "Poney Blanc", "↑ Vitesse =1.5#Permet à Isaac de voler#Utiliser l'objet déclenche une ruée dans la direction où se déplace Isaac#Des rayons de lumière frappent le sol derrière Isaac#Isaac est invulnérable pendant la ruée"},
    ...
    [192] = {"192", "La Télépathie pour les Nuls", "↑ Portée {{ColorLime}}+3.0{{ColorWhite}} et larmes autoguidées pour la durée d'une salle"}, -- Telepathy for Dummies
	...
	[218] = {"218", "Placenta", "{{Heart}} +1 Réceptacle de cœur#Soigne un cœur rouge#Chance de régénérer un demi-cœur rouge à chaque minute du chronomètre"}, -- Placenta
	...
	[227] = {"227", "Tirelire Cochon", "{{Coin}} +3 Pièces#Subir un dégât fait apparaître 1-2 pièces"},
	...
	[273] = {"273", "Cerveau de Bob", "Peut être projeté en ligne droite avec les boutons de tir#Explose au contact d'un ennemi#{{Warning}} L'explosion peut infliger des dégâts à Isaac"}, -- Bob's Brain
	...
	[291] = {"291", "Chasse d'Eau", "Tue instantanément tous les ennemis et boss cacas#Transforme tous les ennemis de la salle en cacas#Éteint tous les feux et inonde le sol de la salle#Transforme la lave en sol franchissable"}, -- Flush!
	...
	[294] = {"294", "Haricot Blanc", "Repousse les ennemis et les projectiles#Projeter un ennemi contre un mur ou un obstacle lui inflige des dégâts"}, -- Butter Bean
...
--	[297] = {"297", "Boîte de Pandore", "{{Warning}} USAGE UNIQUE#{{Blank}} Donne selon l'étage :#{{ColorTransform}}SS1{{ColorWhite}} : 2 cœurs d'âme#{{ColorTransform}}SS2{{ColorWhite}} : 2 clés, 2 bombes#{{ColorTransform}}G1{{ColorWhite}} : 1 Objet de boss#{{ColorTransform}}G2{{ColorWhite}} : SS1 + G1#{{ColorTransform}}P1{{ColorWhite}} : 4 cœurs d'âme#{{ColorTransform}}P2{{ColorWhite}} : 30 pièces#{{ColorTransform}}U1{{ColorWhite}} : 2 Objets de boss#{{ColorTransform}}U2{{ColorWhite}} : La {{ColorYellow}}Bible{{ColorWhite}} {{Collectible33}}#{{ColorTransform}}Shéol{{ColorWhite}} : 1 Objet du Diable, 1 cœur noir#{{ColorTransform}}Cathédrale{{ColorWhite}} : 1 Objet d'Ange + 1 cœur d'âme#{{ColorTransform}}Coffre{{ColorWhite}} : 1 Pièce#{{ColorTransform}}Chambre Noire{{ColorWhite}} : Débloque {{ColorYellow}}Carton de Déménagement{{ColorWhite}} {{Collectible523}}#{{ColorTransform}}Maison{{ColorWhite}} : La {{ColorYellow}}Clé Rouge{{ColorWhite}} {{Collectible580}}"}, -- Pandora's box
	...
	[350] = {"350", "Choc Toxique", "Entrer dans une salle empoisonne tous les ennemis#Les ennemis répandent une flaque toxique à leur mort"}, -- Toxic Shock
	...
	[365] = {"365", "Mouche Égarée", "Longe les murs et les obstacles et inflige des dégâts de contact#Les ennemis à proximité d'elle la prennent pour cible"},
	[366] = {"366", "Bombes à Fragmentation", "{{Bomb}} +5 Bombes#Les bombes d'Isaac se divisent en 4-5 bombes plus petites en explosant"}, -- Scatter Bombs
	[367] = {"367", "Bombes Arachnides", "{{Bomb}} +5 Bombes#Les bombes d'Isaac répandent une flaque ralentissante et collent aux ennemis#Les ennemis tués par des bombes invoquent 2-4 araignées bleues"},
	...
	[371] = {"371", "Fléau de la Maison Dieu", "Subir un dégât fait apparaître 6 Bombes Troll#Les Bombes Troll imitent les effets des bombes d'Isaac"},
	...
	[374] = {"374", "Saint Éclat", "10% de chances de tirer une larme sacrée qui frappe l'ennemi touché d'un rayon de lumière#{{Blank}}#{{LuckSmall}} Effet affecté par la statistique de chance#{{Blank}} {{ColorSilver}}(50% à 9 Chance)"}, -- Holy Light
	[375] = {"375", "Crâne d'Hôte", "20% de chances de bloquer les projectiles ennemis#Rend Isaac invulnérable aux explosions#Rend Isaac invulnérable aux projectiles qui tombent du plafond "}, -- Host hat
	...
	[380] = {"380", "Fente Magique", "{{Coin}} +5 Pièces#Les portes, coffres et blocs qui doivent être ouverts par des clés se déverrouillent avec une pièce"},
	...
	[394] = {"394", "Ligne de Mire", "↑ Débit {{ColorLime}}+0.7#↑ Portée {{ColorLime}}+3.0#Isaac tire automatiquement vers une cible déplaçable avec les boutons de tir#Affecte également les familiers#Appuyer sur le bouton {{ColorSilver}}[Lâcher]{{ColorWhite}} arrête le tir automatique"}, -- Marked
	...
	[415] = {"415", "Couronne de Lumière", "↑ Dégâts {{ColorLime}}x2#↓ Vitesse des tirs {{ColorError}}-0.3#{{SoulHeart}} +2 Cœurs d'âme#Subir un dégât désactive ces effets pour la durée d'une salle#Les effets restent désactivés tant que tous les réceptacles de cœurs d'Isaac ne sont pas remplis"},
    [416] = {"416", "Poches Profondes", "Augmente la capacité maximale du compteur de pièces à 999#Fait apparaître 1-3 pièces si terminer une salle n'aurait pas donné de récompense"}, -- Deep Pockets
	...
	[433] = {"433", "Mon Ombre", "L'ombre d'Isaac le suit avec un délai#Invoque des sangsues alliées quand un ennemi entre en contact avec l'ombre"},
	...
	[450] = {"450", "Œil d'Avarice", "{{Warning}} Toutes les 20 larmes, Isaac tire une de ses pièces#Toucher un ennemi avec une pièce le transforme en statue d'or et fait apparaître une pièce#Tuer un ennemi doré fait apparaître 1-3 pièces"},
	...
	[459] = {"459", "Sinusite", "20% de chances de tirer une crotte de nez#Les crottes de nez se collent aux ennemis et infligent des dégâts une fois par seconde#Les crottes de nez se décollent si l'ennemi meurt, s'enterre, saute hors de l'écran ou après 10 secondes"}, --Sinus Infection
	...
	[477] = {"477", "Néant", "Absorbe tous les objets sur piédestal présents dans la salle#Objets actifs :#{{Blank}} Les prochaines utilisations de Néant déclencheront l'effet de tous les objets absorbés#Objets passifs :#{{Blank}} Augmente 2 stats aléatoires"},
	...
	[489] = {"489", "Dé Infini", "Imite les effets de dé (sauf {{ColorYellow}}Dé Compteur{{ColorWhite}} {{Collectible723}})#L'effet du dé peut être modifié en appuyant sur la touche [Lâcher] #Le temps de recharge varie selon le dé utilisé"}, -- D Infinity
	...
	[497] = {"497", "Slip Camouflage", "À l'entrée de chaque salle, tous les ennemis sont étourdis et Isaac gagne {{ColorLime}}vitesse +0.5#Quand Isaac tire, l'effet disparait pour le reste de la durée de la salle, les ennemis à proximité d'Isaac subissent des dégâts, et Isaac gagne {{ColorLime}}dégâts +10{{ColorWhite}} et {{ColorLime}} débit +10{{ColorWhite}} pendant 1 seconde"},
	...
	[501] = {"501", "Gosier d'Avarice", "{{Heart}} +1 réceptacle de cœur toutes les 25 pièces au compteur#{{CoinHeart}} Permet au Gardien d'avoir des réceptacles de pièce supplémentaires"},
	[503] = {"503", "P'tite Corne", "5% de chances de tirer une larme qui invoque une main de Grosse Corne#La main tue les ennemis instantanément et inflige des dégâts aux boss#Permet d'infliger des dégâts de contact aux ennemis#{{Blank}}#{{LuckSmall}} Effet affecté par la statistique de chance#{{Blank}} {{ColorSilver}}(20% à 15 Chance)"}, -- Little Horn
	...
	[521] = {"521", "Coupon", "Rend gratuit un objet payant dans la salle#Fonctionne pour les coûts en pièces et en PV#Garantit un objet en solde à la Boutique {{Shop}} tant qu'Isaac porte l'objet"},
	[523] = {"523", "Carton de Déménagement", "Utiliser l'objet absorbe jusqu'à 10 ressources, babioles et objets dans la salle#La prochaine utilisation de l'objet posera les objets absorbés sur le sol"}, -- Moving Box
	...
	[543] = {"543", "Terre Sacrée", "Subir un dégât fait apparaître un caca sacré entouré d'une aura#{{Blank}}#Quand Isaac se tient à l'intérieur de l'aura :#↑ Dégâts {{ColorLime}}+25%#↑ Débit {{ColorLime}}+250%#Larmes autoguidées#Chance de nullifier un dégât subi"}, -- Hallowed Ground
	...
	[555] = {"555", "Lame de Rasoir Dorée", "↑ Dégâts {{ColorLime}}+1.2#↓ {{ColorError}}-5{{ColorWhite}} pièces#{{Coin}} +5 pièces la première fois qu'elle est ramassée"}, --  Golden Razor
	...
	[559] = {"559", "120 Volts", "Électrocute les ennemis qui s'approchent trop près d'Isaac"}, --  120 Volt
	...
	[564] = {"564", "Savonnette", "↑ Débit {{ColorLime}}+0.5#↑ Vitesse des tirs {{ColorLime}}+0.2#{{Warning}} La description de l'objet est erronnée, ce sont bien les dégâts qui augmentent"}, --  A Bar of Soap
	[565] = {"565", "Chiot de Sang", "Pourchasse et inflige des dégâts aux ennemis#Après avoir tué assez d'ennemis, il gagne en puissance mais pourchasse aussi Isaac#Le chiot peut être calmé si Isaac lui inflige assez de dégâts ou le fait exploser"}, --  Blood Puppy
	...
	[575] = {"575", "L'Envahisseur", "Se niche dans la tête d'Isaac et tire 4 larmes ralentissantes toutes les 1.5 secondes#Subir un dégât peut faire sortir l'araignée#Une fois sortie, l'araignée tire deux fois plus vite et bondit sur les ennemis#{{Blank}}#{{LuckSmall}} Effet affecté par la statistique de chance"}, --  The Intruder
	...
	[580] = {"580", "Clé Rouge", "Ouvre une porte vers une salle rouge dans les murs marqués d'un cadre de porte rouge#Les salles rouges peuvent être des salles spéciales#Entrer dans une salle en dehors de la grille de 13x13 téléporte Isaac dans la salle d'erreur"}, --  Red Key
	...
	[585] = {"585", "Boîte d'Albâtre", "Se charge en ramassant des cœurs d'âme#Fait apparaître 2 objets angéliques et 3 cœurs d'âme#Fait apparaître 1 objet angélique et 2 cœurs d'âme si un Pacte avec le Diable a été signé"}, --  Alabaster Box
	...
	[588] = {"588", "Sol", "Révèle l'emplacement de la salle de boss {{BossRoom}}#{{Blank}}#{{Blank}} Après avoir battu un boss:#↑ Dégâts {{ColorLime}}+3.0#↑ Chance {{ColorLime}}+1.0#Recharge entièrement l'objet activable#Retire tous les fléaux#Déclenche {{ColorYellow}}XIX - Le Soleil {{Card20}}"}, --  Sol
	[589] = {"589", "Luna", "Ajoute une deuxième salle secrète {{SecretRoom}} et super secrète {{SuperSecretRoom}} à chaque étage#Révèle la position d'une salle secrète {{SecretRoom}}{{SuperSecretRoom}}#Les salles Secrètes {{SecretRoom}}{{SuperSecretRoom}} contiennent un rayon de lumière qui donne un demi-cœur d'âme et augmente le débit pour la durée de l'étage"}, --  Luna
	...
	[608] = {"608", "Bébé Surgelé", "Tire des larmes de glace#Gèle les ennemis qu'il tue#Entrer en contact avec un ennemi gelé le fait glisser et exploser en 6 fragments de glace"}, --  Freezer Baby
	[609] = {"609", "D6 Éternel", "Rejoue tous les objets de la salle#Les objets ont {{ColorError}}30%{{ColorWhite}} de chances de disparaître"}, --  Eternal D6
	...
	[611] = {"611", "Larynx", "Isaac hurle, inflige des dégâts et repousse les ennemis à proximité##Peut être utilisé même sans être entièrement chargé#Plus l'objet est chargé, plus le hurlement est puissant"}, --  Larynx
	[612] = {"612", "Âme Égarée", "Suit Isaac et meurt si elle subit un dégât#Si elle est encore vivante en entrant dans un nouvel étage, elle peut donner :#{{SoulHeart}} 3 cœurs d'âme#{{EternalHeart}} 2 cœurs éternels#{{AngelRoom}} Un objet angélique#{{TreasureRoom}} Un objet de Salle du Trésor"}, --  Lost Soul
	...
	[615] = {"615", "P'tit Prout", "Suit Isaac#Pète et repousse un ennemi ou projectile ennemi sur le point de toucher Isaac#Après avoir pété, reste inactif jusqu'à ce qu'Isaac vienne le toucher"}, --  Lil Dumpy
	...
	[622] = {"622", "Genèse", "{{Warning}} USAGE UNIQUE#Retire tous les objets et ressources d'Isaac#Téléporte Isaac dans une chambre avec une trappe et des ressources#Permet à Isaac de choisir entre 3 objets pour remplacer chaque objet perdu"}, --  Genesis
	...
	[632] = {"632", "Pendentif Maléfique", "↑ Chance {{ColorLime}}+2.0#{{HalfSoulHeart}} +1 demi-cœur d'âme à chaque nouvel étage#Rend Isaac invulnérable au feu, à la confusion, au poison et au gaz toxique"}, --  Evil Charm
	...
	[637] = {"637", "Gouttes K.O.", "10% de chances de tirer une larme poing#Les poings repoussent fortement les ennemis et les étourdissent#{{Blank}}#{{LuckSmall}} Effet affecté par la statistique de chance"}, --  Knockout Drops
	[638] = {"638", "Gomme", "Utiliser l'objet et tirer dans une direction lance une gomme qui efface instantanément un ennemi#Les ennemis effacés n'apparaissent plus pour le reste de la partie#Utilisable une fois par étage"}, --  Eraser
	...
	[644] = {"644", "Prix de Consolation", "↑ Augmente la stat d'Isaac la plus faible#Fait apparaître 3 pièces, 1 bombe ou 1 clé selon ce qui manque à Isaac"}, --  Consolation Prize
	[645] = {"645", "P'tit Tératome", "Orbite autour d'Isaac et bloque les projectiles#Après avoir subi 3 dégâts, se sépare en parties plus petites puis en araignées bleues quand elles meurent#Réapparaît 5 secondes après sa disparition complète"}, --  Tinytoma
	...
	[654] = {"654", "Doctorat Falsifié", "{{BlackHeart}} +1 cœur noir#Identifie l'effet de toutes les pilules#Convertit les pilules positives en pilules négatives#↑ Les pilules qui diminuent les stats augmentent les dégâts#{{BlackHeart}} Les autres pilules font apparaître un cœur noir une fois avalées"}, --  False PHD
	...
	[664] = {"664", "Goinfrerie", "{{Heart}} +1 Réceptacle de cœur#Les objets sur piédestal alternent avec un objet de nourriture#Choisir la nourriture donne {{ColorLime}}dégâts +3.6{{ColorWhite}} et augmente deux stats#Les dégâts donnés par les objets diminuent jusqu'à revenir à leur valeur de base"}, --  Binge Eater
	...
	[670] = {"670", "Plus d'Options ?", "Deux récompenses apparaissent après avoir terminé une salle#Prendre l'une des deux fait disparaître l'autre"}, --  Options?
	...
	[674] = {"674", "Chaînes de l'Esprit", "Subir un dégât fatal transforme Isaac en fantôme enchaîné#Isaac peut continuer à se battre avec un demi-cœur de vie et revient à la vie après 10 secondes#L'objet se recharge en ramassant un cœur d'âme"}, --  Spirit Shackles
	...
	[677] = {"677", "Projection Astrale", "Subir un dégât arrête le temps pendant 3 secondes#Durant cette période, Isaac devient un fantôme et se sépare de son corps#Sous cette forme, Isaac vole, tire des larmes spectrales et nullifie le prochain dégât subi"}, --  Astral Projection
	[678] = {"678", "Césarienne", "Remplace les larmes d'Isaac par des fœtus qui pourchassent les ennemis et leur infligent des dégâts"}, --  C Section
	...
	[684] = {"684", "Âme Affamée", "Les ennemis tués se transforment parfois en fantômes qui pourchassent les ennemis et infligent des dégâts de contact#Après 5 secondes, les fantômes explosent#Isaac est immunisé à leurs explosions"}, --  Hungry Soul
	...
	[692] = {"692", "Pacte de Sang", "Fait apparaître des piques au centre de l'Antre du Diable {{DevilRoom}}#{{Blank}}#Subir un dégât de ces piques peut donner comme récompense :#{{Coin}} 6 pièces {{ColorSilver}}(35%)#↑ Dégâts {{ColorLime}}+0.5{{ColorWhite}} {{ColorSilver}}(15%)#{{BlackHeart}} 2 cœurs noirs {{ColorSilver}}(5%)#{{RedTreasureRoom}} Objet diabolique {{ColorSilver}}(2%)#{{Blank}} Transformation en Léviathan {{ColorSilver}}(1%)"}, --  Sanguine Bond
	[693] = {"693", "La Nuée", "Entoure Isaac de 9 familiers mouches#Les mouches se transforment en mouches bleues quand elles bloquent un projectile#Une nouvelle mouche apparait à chaque salle terminée"}, --  The Swarm
	[694] = {"694", "Brise-Cœur", "Brise 3 des cœurs d'Isaac#↑ Dégâts {{ColorLime}}+0.25{{ColorWhite}} pour chaque cœur brisé#Chaque coup fatal laisse Isaac en vie mais brise deux cœurs supplémentaires#Isaac meurt s'il possède 12 cœurs brisés"}, --  Heartbreak
	[695] = {"695", "Souffle de Sang", "{{Blank}} Subir un dégât donne :#↑ Débit augmenté#↑ Vitesse augmentée#{{Blank}}#{{Timer}} Persiste pour la durée de l'étage"}, --  Bloody Gust
	...
	[700] = {"700", "Résonance", "Utiliser une carte, pilule ou rune déclenche également l'effet des trois dernières cartes, pilules ou runes utilisées.#Ne fonctionne qu'avec les cartes, pilules et runes utilisées après avoir obtenu l'objet"}, --  Echo Chamber
	[701] = {"701", "Tombeau d'Isaac", "Fait apparaître un Coffre Antique {{DirtyChest}} dans la salle de départ de chaque étage#{{Blank}}#{{Blank}} Les coffres antiques peuvent contenir :#{{SoulHeart}} Cœurs d'âme#{{Trinket}} Babioles#{{Collectible}} Objet angélique#{{Collectible}} Objet de Papa ou Maman"}, --  Isaac's Tomb
	...
	[705] = {"705", "Arts Obscurs", "{{ColorLime}}Vitesse +1.0{{ColorWhite}}#Transforme Isaac en une ombre qui peut traverser les ennemis et projectiles pendant 1 seconde#Paralyse et inflige des dégâts à tous les ennemis traversés"}, --  Dark Arts
	[706] = {"706", "Abysse", "Absorbe tous les objets de la salle et invoque un locuste abyssal pour chaque objet détruit#Les locustes abyssaux sont invulnérables et attaquent dans la direction de tir d'Isaac"}, --  Abyss
	...
	[722] = {"722", "Anima Sola", "Enchaîne l'ennemi le plus proche pendant 5 secondes#Les ennemis enchaînés sont immobilisés et ne peuvent pas attaquer"}, --  Anima Sola
	...
	[727] = {"727", "Bombes Fantômes", "{{Bomb}} +5 Bombes#Les bombes d'Isaac font apparaître des fantômes qui pourchassent les ennemis, infligent des dégâts de contact et explosent au bout de 10 secondes"}, --  Ghost Bombs
...
EID.descriptions["fr"].bookOfBelialBuffs = {
	...
	[352] = "Déclenche le Livre de Bélial quand le canon se brise - le bonus de dégâts persiste jusqu'à ce que le canon soit réparé", -- Glass Cannon
...
EID.descriptions["fr"].bookOfVirtuesWisps = {
	...
	[35] = "Les feux follets ont 3.5% de chances de terrifier un ennemi touché#Les feux follets déclenchent l'effet du Necronomicon quand ils sont détruits", -- The Necronomicon
	...
	[294] = "Les feux follets ne peuvent pas tirer#Les feux follets déclenchent l'effet du Haricot Blanc quand ils sont détruits#Les feux follets disparaissent à la salle suivante", -- Butter Bean
	...
	[326] = "Effectuer un blocage parfait invoque 4 feux follets", -- Breath of Life
	...
	[709] = "3 feux follets sont invoqués à l'atterrissage#Les feux follets disparaissent à la salle suivante", -- Suplex
...
local repTrinkets={
	...
	[8] = {"8", "Cartouche", "Subir un dégât a 5% de chances de déclencher l'effet du {{ColorYellow}}Jeu-Garçon{{Collectible93}}#{{Blank}}#{{LuckSmall}} Effet affecté par la statistique de chance#{{Blank}} {{ColorSilver}}(100% à 38 Chance)"},
	...
	[136] = {"136", "Cadenas Cassé", "Les portes, blocs verrouillés et coffres dorés peuvent être ouverts avec une explosion"}, --  Broken Padlock
	...
	[143] = {"143", "Condensateur", "Empêche les objets activables de se recharger#Terminer une salle a 20% de chances de faire apparaître une micro pile#{{Blank}}#{{LuckSmall}} Effet affecté par la statistique de chance#{{Blank}} {{ColorSilver}}(33% à 5 Chance)"}, --  Old Capacitor
	...
	[150] = {"150", "Clé Bleue", "Les portes qui nécessitent des ressources pour être ouvertes s'ouvrent gratuitement#Isaac devra traverser une salle de l'{{ColorTransform}}Utérus Bleu{{ColorWhite}} pour atteindre la salle de l'autre côté de la porte"}, --  Blue Key
	...
	[160] = {"160", "Bourse Trèfle", "Fait apparaître 1 sachet {{GrabBag}} dans la première salle d'un nouvel étage"}, --  Lucky Sack
	...
	[182] = {"182", "Essence de Béthanie", "Entrer dans le Refuge des Anges {{AngelRoom}} invoque 5 feux follets#Faire un don à un mendiant {{Beggar}} a 25% de chances d'invoquer un feu follet"}, --  Beth's Essence
...
EID.descriptions["fr"].goldenTrinketEffects = {
	...
	[7] = { "Le {{ColorYellow}}Rosaire{{ColorWhite}} {{Collectible72}} est ajouté à toutes les banques d'objets" },
	-- Golden Store Credit: full replace
	...
	[15] = { "Les rochers peuvent faire apparaître 2 pièces", "Les rochers peuvent faire apparaître 2 pièces", "Les rochers peuvent faire apparaître 3 pièces" },
	...
	-- The Twins
	[183] = { "Peut copier/invoquer 2 familiers", "Peut copier/invoquer 2 familiers", "Peut copier/invoquer 3 familiers" },
}
...
local repCards={
	[2] = {"2", "I - Le Bateleur", "↑ Portée {{ColorLime}}+3.0#Larmes autoguidées#{{Blank}}#Persiste pour la durée d'une salle"},
	...
	[59] = {"59", "III - L'Impératrice ?", "↑ Débit {{ColorLime}}+1.35#↓ Vitesse {{ColorError}}-0.1#{{Heart}} +2 Réceptacles de cœur#{{Blank}}#{{Timer}} Persiste pendant 60 secondes"},
	...
	[67] = {"67", "XI - La Force ?", "Les ennemis sont ralentis et subissent deux fois plus de dégâts#{{Blank}}#{{TimerSmall}} Persiste pendant 60 secondes ou jusqu'à ce qu'Isaac quitte la salle"},
	...
	[71] = {"71", "XV - Le Diable ?", "Déclenche l'effet de la {{ColorYellow}}Bible{{ColorWhite}} {{Collectible33}}#Donne {{ColorYellow}}Séraphin{{ColorWhite}} {{Collectible390}}#{{Blank}}#{{Timer}} Persiste pendant 30 secondes"},
	...
	[88] = {"88", "Âme d'Azazel", "Déclenche l'effet de {{ColorYellow}}Souffle du Diable{{ColorWhite}} {{Collectible441}}#{{Blank}}#{{Timer}} Persiste pendant 7.5 secondes"},
...
EID.descriptions["fr"].OldGameVersionWarningText = "Ta version de Repentance n'est pas à jour !#Seule la dernière version du jeu (1.7.9b) est officiellement supportée.#{{Blank}} {{ColorSilver}}(Cette alerte peut être désactivée dans la config)"
