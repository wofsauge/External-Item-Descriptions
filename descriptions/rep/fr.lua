...
local repCollectibles={
	...
	[669] = {"669", "", "↑ +1.33 Dégâts#↑ +0.2 Vitesse#↑ +1.2 Vitesse des larmes#↑ +0.16 Portée#↑ +1 Chance"}, --  Sausage
...
local repTrinkets={
	...
	[65] = {"65", "Tape Worm", "↑ +3 Portée#-50% Hauteur des larmes"}, -- Tape Worm
...
local repCards={
	...
	[79] = {"79", "", "Fait apparaître 1-12 coeurs rouges"},
