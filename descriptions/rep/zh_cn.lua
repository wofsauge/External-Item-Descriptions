...
local repCollectibles={
	...
	[182] = {"182", "圣心", "↑ +1心之容器#满血#↑ {{Damage}} x230%+1伤害修正#↓ {{Tears}} -0.4射速#↓ {{Shotspeed}} -0.25弹速#跟踪眼泪"}, -- Sacred Heart
	[184] = {"184", "圣杯", "飞行#↑ +1心之容器#治疗1红心"}, -- Holy Grail
	[188] = {"188", "亚伯", "与角色移动互为镜像#向角色发射眼泪#每次射击造成3.5伤害#该隐：7.5伤害"}, -- Abel
	[189] = {"189", "超级食肉男孩死忠粉", "↑ +1心之容器#满血#↑ {{Damage}} +0.3伤害#↑ {{Tears}} +0.2射速#↑ {{Range}} +1.5射程#↑ {{Speed}} +0.2移速"}, -- SMB Super Fan
	...
	[355] = {"355", "老妈的珍珠项链", "↑ {{Range}} +0.38射程#↑ +1运气#+1魂心"}, -- Mom's Pearls
	...
	[455] = {"455", "老爸丢失的硬币", "↑ {{Range}} +0.38射程#生成1运气硬币"},
	...
	[573] = {"573", "无瑕圣心", "↑ +1心之容器#满血#↑ {{Damage}} +20%伤害倍率#几率发射环绕自己的幽灵眼泪"}, --  Immaculate Heart
	...
	[588] = {"588", "太阳", "揭示{{BossRoom}}Boss房位置#击败Boss后在所在层获得：#使用{{Card20}}太阳#为主动道具充能#移除诅咒#↑ {[Damage}} +3.0伤害#↑ +1运气"}, --  Sol
	...
	[620] = {"620", "", "<道具不存在>"},
	[621] = {"621", "红豆汤", "↑ {{Damage}} +21.6伤害#增加的伤害会不断衰减，在3分钟后衰减完毕#效果尚存时击杀敌人会延长时间#满血"}, --  Red Stew
	...
	[669] = {"669", "腊肠", "↑ +1心之容器#满血#↑ {{Damage}} +0.5伤害#↑ {{Speed}} +0.2移速#↑ {{Shotspeed}} +1.2弹速#↑ {{Range}} +0.16射程#↑ +1运气#↑ +6.9%{{DevilRoom}}恶魔房/{{AngelRoom}}天使房几率#↑ +6.9%{{Planetarium}}星象房几率"}, --  Sausage
	...
	[730] = {"730", "玻璃眼", "↑ {{Damage}} +0.75伤害#↑ +1运气"}, -- Glass Eye
...
EID.descriptions[languageCode].bingeEaterBuffs = {
	...
	[456] = "↑ {{Damage}} +1.0伤害修正#↑ +1.0运气#↓ {{Speed}} -0.03移速", -- Midnight Snack
	[707] = "↑ {{Tears}} +0.5射速#↑ +1.0运气#↓ {{Speed}} -0.03移速", -- Supper
}
...
local repTrinkets={
	...
	[101] = {"101", "暗灯泡", "!!! 当主动道具无充能时：#↑ {{Damage}} +1.5伤害#↑ {{Speed}} +0.5移速#↑ {{Range}} +1.5射程#↑ {{Tears}} +0.5射速#↑ {{Shotspeed}} +0.3弹速#↑ +2运气"}, -- Dim Bulb
