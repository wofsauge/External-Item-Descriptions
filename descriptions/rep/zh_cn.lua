...
local repCollectibles={
	...
	[408] = {"408", "祭祀之刃", "受伤时在角色周围产生持续1秒的黑色硫磺火圈"}, -- Athame
...
local repTrinkets={
	...
	[49] = {"49", "染血硬币", "{{HalfHeart}} 捡起硬币时有25%几率掉落半红心"}, -- Bloody Penny
	[50] = {"50", "焦灼硬币", "{{Bomb}} 捡起硬币时有25%几率掉落炸弹"}, -- Burnt Penny
	[51] = {"51", "扁平硬币", "{{Key}} 捡起硬币时有25%几率掉落钥匙"}, -- Flat Penny
	...
	[98] = {"98", "鼻涕泡", "{{Poison}} 10%几率发射跟踪粘性有毒眼泪#{{Damage}} 每秒造成角色伤害#能粘住10秒"}, -- Nose Goblin
	...
	[125] = {"125", "扩接电线", "使跟班以电束相连#每束造成6伤害#也会在合作玩家之间产生电束(包括雅各和以扫)"}, -- Stem Cell
	...
	[131] = {"131", "神圣硬币", "{{SoulHeart}} 捡起硬币时有17%几率掉落半魂心"}, --  Blessed Penny
	...
	[158] = {"158", "破损的口袋", "每当角色受伤时，随机掉落2个硬币、炸弹或钥匙#掉落物可能是原有形态的变种，如金钥匙，镍币等"}, --  Torn Pocket
	[159] = {"159", "镀金钥匙", "{{Key}} 首次捡起时+1钥匙#{{GoldenChest}} 以金箱子替换所有新箱子(出了旧箱子和巨型箱子)#{{GoldenChest}} 所有金箱子包含卡牌，胶囊或饰品#对巨型箱子无效"}, --  Gilded Key
	...
	[170] = {"170", "水晶钥匙", "清理房间后有33%几率打开一个与当前房间相连的{{Collectible580}}红房间#红房间中触发几率降低"}, --  Crystal Key
