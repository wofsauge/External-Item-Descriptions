...
local repCollectibles={
	...
	[297] = {"297", "潘多拉魔盒", "{{Warning}} 一次性，根据所在层掉落以下物品：#1章1：2{{SoulHeart}}; 1章2：2{{Key}}+2 {{Bomb}}#2章1：1{{BossRoom}}道具; 2章2：1章1+2章1#3章1：4{{SoulHeart}}; 3章2：20{{Coin}}#4章1：2{{BossRoom}}道具; 4章2：{{Collectible33}}圣经#???/虚空：无#地狱：1{{DevilRoom}}道具+1{{BlackHeart}}; 大教堂：1{{AngelRoom}}道具+1{{EternalHeart}}#暗室：解锁{{Collectible523}}搬家盒; 宝箱：1{{Coin}}#家：{{Collectible580}}红钥匙#若有迷宫诅咒则为章节1层"}, -- Pandora's Box
	...
	[496] = {"496", "安乐死", "3.33%发射针#{{Luck}} 运气15：25%几率#针会立即杀死一般敌人，并爆出10发眼泪#针击中Boss造成3倍伤害"}, -- Euthanasia
	...
	[503] = {"503", "小魔角", "5%几率发射能召唤巨角恶魔的手的眼泪#{{Luck}} 幸运12：20%#手会立即杀死敌人或对Boss造成伤害#冲向敌人造成3次12点接触伤害"}, -- Little Horn
	...
	[669] = {"669", "腊肠", "↑ +1心之容器#{{Heart}} 满血#↑ {{Damage}} +0.5伤害#↑ {{Speed}} +0.2移速#↑ {{Shotspeed}} +1.2弹速#↑ {{Range}} +0.16射程#↑ {{Luck}} +1运气#↑ +6.9%{{DevilRoom}}恶魔房/{{AngelRoom}}天使房几率#↑ +6.9%{{Planetarium}}星象房几率"}, --  Sausage
