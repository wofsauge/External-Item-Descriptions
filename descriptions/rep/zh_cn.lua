...
local repCollectibles={
	...
	[55] = {"55", "老妈的眼睛", "50%几率向后发射眼泪#{{Luck}} 运气5：100%几率"}, -- Mom's Eye
	...
	[253] = {"253", "魔法血痂", "↑ +1心之容器#↑ {{Luck}} +1运气#治疗1红心"}, -- Magic Scab
	...
	[355] = {"355", "老妈的珍珠项链", "↑ {{Range}} +0.38射程#↑ {{Luck}} +1运气#+1魂心"}, -- Mom's Pearls
	...
	[374] = {"374", "圣光", "10%几率发射圣光眼泪，击中时会产生光柱#光柱造成3倍角色伤害#{{Luck}} 运气9：50%几率"}, -- Holy Light
	...
	[495] = {"495", "断魂椒", "8%几率发射蓝火，能阻挡敌人弹幕并造成接触伤害#{{Luck}} 运气10：50%几率#火焰2秒后消失"}, -- Ghost Pepper
	[496] = {"496", "安乐死", "3.33%发射针#{{Luck}} 运气15：50%几率#针会立即杀死一般敌人，并爆出10发眼泪#针击中Boss造成3倍伤害"}, -- Euthanasia
	...
	[588] = {"588", "太阳", "揭示{{BossRoom}}Boss房位置#击败Boss后在所在层获得：#使用{{Card20}}太阳#为主动道具充能#移除诅咒#↑ {{Damage}} +3.0伤害#↑ {{Luck}} +1运气"}, --  Sol
	...
	[616] = {"616", "鸟眼椒", "8%几率发射红火，能阻挡敌人弹幕并造成接触伤害#{{Luck}} 运气10：50%几率#火焰造成或阻挡4次伤害后或10秒后消失"}, --  Bird's Eye
	...
	[669] = {"669", "腊肠", "↑ +1心之容器#满血#↑ {{Damage}} +0.5伤害#↑ {{Speed}} +0.2移速#↑ {{Shotspeed}} +1.2弹速#↑ {{Range}} +0.16射程#↑ {{Luck}} +1运气#↑ +6.9%{{DevilRoom}}恶魔房/{{AngelRoom}}天使房几率#↑ +6.9%{{Planetarium}}星象房几率"}, --  Sausage
...
EID.descriptions[languageCode].bingeEaterBuffs = {
	...
	[456] = "↑ {{Damage}} +1.0伤害修正#↑ {{Luck}} +1运气#↓ {{Speed}} -0.03移速", -- Midnight Snack
...
local repTrinkets={
	...
	[129] = {"129", "崩掉牙", "10%几率发射牙齿眼泪#牙齿造成3.2倍角色伤害#{{Luck}} 运气9：100%几率"}, --  Jawbreaker
	[130] = {"130", "嚼烂的笔", "10%几率发射减速眼泪#{{Luck}} 运气18：100%几率"}, --  Chewed Pen
