...
local repCollectibles={
	...
	[114] = {"114", "老妈的菜刀", "{{Chargeable}} 用可控制的刀攻击#{{Damage}} 菜刀对接触的敌人造成每秒20次伤害#{{Damage}} 菜刀的伤害与蓄力时间成正比：未蓄力(未发射)时造成200%角色伤害，蓄力至约1/3时达到最大的600%角色伤害#进一步蓄力仅增加菜刀射程#{{Damage}} 伤害在回收途中会迅速衰减至200%角色伤害"}, -- Mom's Knife
	[118] = {"118", "硫磺火", "{{Chargeable}} 蓄力发射持续造成伤害的鲜血激光#{{Damage}} 每次发射共造成9次100%角色伤害#↓ {{Tears}} -67%射速修正"}, -- Brimstone
	...
	[365] = {"365", "迷路苍蝇", "沿着房间内的墙/障碍物走#每秒造成56接触伤害#吸引周围敌人以迷路苍蝇为目标"}, 
	...
	[432] = {"432", "闪光炸弹", "{{Bomb}} +5炸弹#{{Charm}} 炸弹爆炸有15%几率魅惑敌人#炸弹爆炸有63%几率掉落随机掉落物#闪光炸弹每生成一个掉落物，在本层中生成掉落物的几率减少1%"}, -- Glitter Bombs
	...
	[503] = {"503", "小魔角", "5%几率发射能召唤巨角恶魔的手的眼泪#{{Luck}} 运气12：20%#手会立即杀死敌人或对Boss造成3次12接触伤害#冲向敌人会造成3.5接触伤害"}, -- Little Horn
