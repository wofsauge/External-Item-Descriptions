...
local repCollectibles={
	...
	[30] = {"30", "妈妈的高跟鞋", "↑ {{Range}} +1.5射程#能对敌人造成12点接触伤害"}, -- Mom's Heels
	...
	[275] = {"275", "硫磺火宝宝", "{{Collectible118}} 发射硫磺火的跟班#每次发射共造成20点伤害"}, -- Lil Brimston
	...
	[328] = {"328", "底片", "↑ {{Damage}} +1.0伤害#受伤后血量不多于半红心对房间内所有敌人造成40点伤害"}, -- The Negative
...
EID.descriptions[languageCode].bingeEaterBuffs = {
	...
	[26] = "↑ {{Damage}} +1.0额外伤害#↑ {{Range}} +1.5射程#↓ {{Speed}} -0.03移速", -- Rotten Meat
...
EID.descriptions[languageCode].horsepills={
	...
	{"45", "感觉像漫步在阳光下！", "触发{{Collectible93}}游戏掌机的效果，在6秒内：#无敌#{{Fear}} 恐惧所有敌人#无法发射眼泪#造成每秒40点接触伤害#{{HalfHeart}} 吃掉两个敌人回复半个红心"}, -- Feels like I'm walking on sunshine!
