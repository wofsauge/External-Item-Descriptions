...
local repCollectibles={
	...
	[5] = {"5", "我的镜像", "眼泪有回旋效果#↑ {{Range}} +1.5射程#↑ {{Range}} +60%额外射程↑ {{Shotspeed}} +0.6弹速"}, -- My Reflection
	...
	[29] = {"29", "老妈的内裤", "↑ {{Range}} +1.5射程#生成3-6只蓝苍蝇"}, -- Moms Underwear
	[30] = {"30", "老妈的高跟鞋", "↑ {{Range}} +1.5射程#能对敌人造成12接触伤害"}, -- Mom's Heels
	[31] = {"31", "老妈的口红", "↑ {{Range}} +2.25射程#生成1随机心"}, -- Mom's Lipstick
	...
	[46] = {"46", "幸运脚", "↑ {{LuckSmall}} +1运气#赌博时赢的几率更高#清理房间后掉落物品的几率更高#将一些坏胶囊变成好胶囊"}, -- Lucky Foot
	[52] = {"52", "胎儿博士", "炸弹眼泪#每个炸弹造成10倍角色伤害#如果结果超过60伤害，以5倍角色伤害+30取代#↓ {{Tears}} -60%射速修正"}, --Dr. Fetus
	[53] = {"53", "万磁王", "吸引掉落物#自动开箱子，忽略刺箱伤害"}, -- Magneto
	[55] = {"55", "老妈的眼睛", "50%几率向后发射眼泪#{{LuckSmall}} 运气5：100%几率"}, -- Mom's Eye
	[59] = {"59", "彼列之书", "<道具无法获得>"}, -- The Book of Belial (Judas's Birthright Version)
	[62] = {"62", "吸血鬼之魅", "↑ {{Damage}} +0.3伤害#每杀死13个敌人治疗半红心"}, -- Charm of the Vampire
	...
	[71] = {"71", "小蘑菇", "↑ {{Speed}} +0.3移速#↑ {{Range}} +1.5射程#↑ 体型缩小"}, -- Mini Mush
	[72] = {"72", "念珠", "+3魂心#↑ {{Tears}} +0.5射速#{{Collectible33}}圣经添加至所有道具池"}, -- Rosary
	...
	[79] = {"79", "咒印", "↑ {{Damage}} +1.0伤害#↑ {{Speed}} +0.2移速#+1黑心"}, -- The Mark
	[80] = {"80", "契约", "↑ {{Damage}} +0.5伤害#↑ {{Tears}} +0.7射速#+2黑心"}, -- The Pact
	[83] = {"83", "钉子", "+半黑心#在当前房间获得：#↑ {{Damage}} +2.0伤害#↓ {{Speed}} -0.18移速#造成接触伤害#粉碎经过的岩石"}, -- The Nail
	[84] = {"84", "我们需要深入挖掘！", "生成1个跳过所在层的活板门#如果在有装饰(草、碎石、宝石、骷颅头等)的地板上使用则改为生成一个暗门"}, -- We Need To Go Deeper!
	[87] = {"87", "洛基的角", "25%几率向4个方向发射眼泪#{{LuckSmall}} 运气15：100%几率"}, -- Loki's Horns
	[91] = {"91", "探窟帽", "揭示相邻房间的类型#也可以揭示隐藏房，超级隐藏房和小Boss房#阻挡上方弹幕的伤害"}, -- Spelunker Hat
	[98] = {"98", "圣遗物", "每7-8个房间生成1魂心"}, -- The Relic
	[101] = {"101", "光环", "↑ +1心之容器#↑ {{Damage}} +0.3伤害#↑ {{Tears}} +0.2射速#↑ {{Range}}} +0.38射程#↑ {{Speed}} +0.3移速#治疗1红心"}, -- The Halo
	[106] = {"106", "大爆弹先生", "↑ 炸弹伤害x1.85#+5炸弹"}, -- Mr. Mega
	[110] = {"110", "老妈的美瞳", "20%几率发射石化眼泪#↑ {{Range}} +0.38射程"}, -- Mom's Contacts
	[118] = {"118", "硫磺火", "蓄力发射持续造成伤害的鲜血激光#↓ {{Tears}} -67%射速修正"},
	[121] = {"121", "怪异蘑菇(大)", "↑ +1心之容器#↑ {{Damage}} +1.0伤害#↑ {{Range}} +0.38射程#↓ {{Speed}} -0.2移速"}, -- Odd Mushroom (Large)
	...
	[138] = {"138", "圣痕", "↑ +1心之容器#↑ {{Damage}} +0.3伤害#治疗1红心"}, -- Stigmata
	...
	[149] = {"149", "吐根酊", "爆炸有毒眼泪#↑ {{Damage}} +40伤害#↓ {{Shotspeed}} -0.2弹速#↓ {{Tears}} -67%射速修正#↓ {{Range}} 射程小幅降低"}, -- Ipecac
	[152] = {"152", "科技II", "右眼以无限射程的持续穿透激光取代#{{Damage}} 激光造成13%角色伤害#↓ {{Tears}} -33%射速修正"}, -- Technology 2
	[153] = {"153", "变异蜘蛛", "四重眼泪!#↓ {{Tears}} -58%射速修正"}, -- Mutant Spider
	[155] = {"155", "窥眼", "在房间内四处漂浮的跟班#每秒造成17.1接触伤害#↑ {{Damage}} 角色左眼伤害+34%"}, -- The Peeper
	[158] = {"158", "水晶球", "揭示全图#掉落随机卡牌或魂心#持有时：#↑ +15%星象房几率#如果跳过道具房则为100%"}, -- Crystal Ball
	[169] =	{"169", "巨人独眼", "↑ {{Damage}} +100%伤害#↑ {{Damage}} +4伤害修正#↓ {{Tears}} -58%射速修正#眼泪杀死敌人后会继续前进"}, -- Polyphemus
	...
	[182] = {"182", "圣心", "↑ +1心之容器#{{Heart}} 满血#↑ {{Damage}} x230%+1伤害修正#↓ {{Tears}} -0.4射速#↓ {{Shotspeed}} -0.25弹速#跟踪眼泪"}, -- Sacred Heart
	[184] = {"184", "圣杯", "飞行#↑ +1心之容器#治疗1红心"}, -- Holy Grail
	[188] = {"188", "亚伯", "与角色移动互为镜像#向角色发射眼泪#每次射击造成3.5伤害#该隐：7.5伤害"}, -- Abel
	[189] = {"189", "超级食肉男孩死忠粉", "↑ +1心之容器#{{Heart}} 满血#↑ {{Damage}} +0.3伤害#↑ {{Tears}} +0.2射速#↑ {{Range}} +1.5射程#↑ {{Speed}} +0.2移速"}, -- SMB Super Fan
	[192] = {"192", "心灵感应傻瓜式教程", "所在房间眼泪有跟踪效果并+3射程"}, -- Telepathy for Dummies
	[193] = {"193", "生肉！", "↑ +1心之容器#↑ {{Damage}} +0.3伤害#治疗1红心"}, -- MEAT!
	[194] = {"194", "魔力八号球", "↑ {{Shotspeed}} +0.16弹速#+1卡牌#+15%星象房几率"}, -- Magic 8 Ball
	[197] = {"197", "耶稣果汁", "↑ {{Damage}} +0.5伤害#↑ {{Range}} +0.38射程"}, -- Jesus Juice
	[203] = {"203", "慈善捆绑包", "掉落物几率成对出现"}, -- Humbling Bundle
	[205] = {"205", "锋利插头", "使用时，以每格充能半心的代价为主动道具完全充能#优先使用红心"}, -- Sharp Plug
	[206] = {"206", "断头台", "↑ {{Damage}} +1.0伤害#↑ {{Tears}} +0.5射速修正#角色的头变成环绕物，不会受伤并造成105接触伤害#角色仍从头发射眼泪"}, -- Guillotine
	...
	[224] = {"224", "柯吉猫的身体", "眼泪击中后会分裂为4个#分裂的眼泪造成一半伤害#↑ {{Tears}} +0.5射速修正#↓ {{Range}} -20%射程"}, -- Cricket's Body
	[228] = {"228", "老妈的香水", "15%几率发射恐惧眼泪#↑ {{Tears}} +0.5射速修正"}, -- Moms Perfume
	[230] = {"230", "亚巴顿", "↑ {{Damage}} +1.5伤害#↑ {{Speed}} +0.2移速#恐惧眼泪#将心之容器变成黑心#+2黑心"}, -- Abaddon
	...
	[245] = {"245", "完美视力", "角色眼泪加倍#↓ {{Damage}} -25%伤害"}, -- 20/20
	[248] = {"248", "虫群之心", "蓝蜘蛛/苍蝇造成双倍伤害#蜘蛛/苍蝇类跟班变得更强"}, -- Hive Mind
	[253] = {"253", "魔法血痂", "↑ +1心之容器#↑ {{LuckSmall}} +1运气#治疗1红心"}, -- Magic Scab
	...
	[309] =	{"309", "双鱼座", "↑ {{Tears}} +0.5射速修正#提高眼泪击退力"},
	...
	[320] = {"320", "???唯一的朋友", "可控制的苍蝇#每秒造成大约15接触伤害"}, -- ???'s Only Friend
	[326] = {"326", "生命之息", "按住空格，充能清空时无敌#无敌时，接触到的敌人会被光束攻击#!!! 不要一直按着！"}, -- Breath of Life
	[328] = {"328", "底片", "↑ {{Damage}} +1.0伤害#受伤后血量不多于半红心对房间内所有敌人造成40伤害"}, -- The Negative
	[330] = {"330", "豆奶", "↑ {{Tears}} x550%射速修正#↓ {{Damage}} -80%伤害#击退大幅降低"}, -- Soy Milk
	[331] = {"331", "神性", "↑ {{Damage}} +0.5伤害#↓ {{Tears}} -0.3射速#↓ {{Shotspeed}} -0.3弹速#眼泪具有伤害光环，每帧造成2伤害#跟踪眼泪"}, -- Godhead
	[336] = {"336", "烂洋葱", "穿透幽灵眼泪#↓ {{Range}} -1.5射程#↓ {{Shotspeed}} -0.4弹速#↑ +50%眼泪大小"}, -- Dead Onion
	[339] = {"339", "安全别针", "↑ {{Range}} +1.5射程#↑ {{Shotspeed}} +0.16弹速#+1黑心"}, -- Safety Pin
	[342] = {"342", "蓝盖蘑菇", "↑ +1心之容器#↑ {{Tears}} +0.7射速#↓ {{Shotspeed}} -0.16弹速#治疗1红心"}, -- Blue Cap
	[344] = {"344", "火柴盒", "+1黑心#生成2-3炸弹和{{Trinket41}}火柴棒"}, -- Match Book
	[345] = {"345", "合成油脂", "↑ {{Damage}} +1.0伤害#↑ {{Range}} +1.5射程"}, -- Synthoil
	...
	[355] = {"355", "老妈的珍珠项链", "↑ {{Range}} +0.38射程#↑ {{LuckSmall}} +1运气#+1魂心"}, -- Mom's Pearls
	[360] = {"360", "淫魔", "获得与角色眼泪效果一致的恶魔跟班#造成75%角色伤害#{{Player13}} 如果是莉莉丝则造成100%角色伤害"}, -- Incubus
	[366] = {"366", "分裂炸弹", "+5炸弹#炸弹会炸成4-5个小炸弹"}, -- Scatter Bombs
	[368] =	{"368", "溢泪症", "向单方向发射会提高射速修正，最多至200%"}, -- Epiphora
	[369] = {"369", "连续统", "↑ {{Range}} +3.0射程#幽灵眼泪#眼泪会穿墙，从另一边回来"}, -- Continuum
	[370] = {"370", "玩偶先生", "↑ {{Tears}} +0.7射速#↑ {{Range}} +1.5射程#捡起时生成3随机心"}, -- Mr. Dolly
	[372] = {"372", "充电宝宝", "几率随机掉落1小电池或石化房间内所有敌人#几率对主动道具充能1格"}, -- Charged Baby
	[374] = {"374", "圣光", "10%几率发射圣光眼泪，击中时会产生光柱#光柱造成3倍角色伤害#{{LuckSmall}} 运气9：50%几率"}, -- Holy Light
	...
	[395] = {"395", "科技X", "能够蓄力并发射穿过整个房间的激光环#蓄力越久伤害越高#{{Damage}} 完全蓄力伤害为100%"}, -- Tech X
	[397] = {"397", "牵引光束", "角色的眼泪现在受光束指引，与角色一起移动#↑ {{Tears}} +0.5射速#↑ {{Range}} +1.5射程#↑ {{Shotspeed}} +0.16弹速"}, -- Tractor Beam
	...
	[407] = {"407", "纯洁", "↑ 根据角色光环颜色对角色属性进行增强#受伤或进入新房间时，获得新的光环：#{{ColorRed}}红色{{CR}} = {{Damage}} +4伤害#{{ColorBlue}}蓝色{{CR}} = {{Tears}} +2射速修正#{{ColorYellow}}黄色{{CR}} = {{Speed}} +0.5移速#{{ColorOrange}}橙色{{CR}} = {{Range}} +3.0射程"},
	[408] = {"408", "祭祀之刃", "受伤时在角色周围产生黑色硫磺火圈"}, -- Athame
	[415] = {"415", "光明之冠", "+2魂心#如果没有不满的心之容器：#↑ {{Damage}} +100%伤害#↑ {{Range}} +1.5射程#↓ {{Shotspeed}} -0.3弹速#受伤后，当前房间无论心之容器是否是满的，效果消失"}, -- Crown Of Light
	[416] = {"416", "深口袋", "如果房间没有奖励，生成1-3硬币#提高硬币上限为999"}, -- Deep Pockets
	[417] = {"417", "魅魔", "在房间内漂浮的跟班，产生伤害光环，每秒造成7-10的伤害#↑ {{Damage}} 站在光环中+50%伤害"}, -- Succubus
	...
	[442] = {"442", "黑王子之冠", "!!! 仅有1红心时：#↑ {{Tears}} +2射速修正#↑ {{Range}} +1.5射程#↑ {{Shotspeed}} +0.2弹速#没有红心的角色无效)"}, -- Dark Princes Crown
	...
	[453] = {"453", "复杂性骨折", "↑ {{Range}} +0.38射程#骨头眼泪#眼泪击中时碎成1-3个小骨头碎片"}, -- Compound Fracture
	[455] = {"455", "老爸丢失的硬币", "↑ {{Range}} +0.38射程#生成1幸运硬币"},
	...
	[495] = {"495", "断魂椒", "8%几率发射蓝火，能阻挡敌人弹幕并造成接触伤害#{{LuckSmall}} 运气10：50%几率#火焰2秒后消失"}, -- Ghost Pepper
	[496] = {"496", "安乐死", "3.33%发射针#{{LuckSmall}} 运气15：25%几率#针会立即杀死一般敌人，并爆出10发眼泪#针击中Boss造成3倍伤害"}, -- Euthanasia
	...
	[503] = {"503", "小魔角", "5%几率发射能召唤巨角恶魔的手的眼泪#{{LuckSmall}} 幸运12：20%#手会立即杀死敌人或对Boss造成伤害#冲向敌人造成3次12点接触伤害"}, -- Little Horn
	[504] = {"504", "棕色粪块", "生成1只苍蝇炮塔，能够向敌人发射眼泪#每次发射造成3.5伤害"}, -- Brown Nugget
	[507] = {"507", "尖头吸管", "造成角色伤害+敌人最大血量10%的伤害#影响房间内所有敌人#{{HalfHeart}} 造成伤害时几率掉落半红心" },
	...
	[531] = {"531", "泪血症", "眼泪弧形前进，击中时眼泪分裂成更小的眼泪#↑ {{Damage}} +1伤害#↑ {{Damage}} +50%伤害倍率#↓ {{Tears}} -67%射速修正#↓ {{Range}} -20%射程"}, -- Haemolacria
	[541] = {"541", "骨髓", "+1骨心#生成3红心"}, -- Marrow
	[543] = {"543", "圣地大便", "受伤时生成白便便#在白便便的光环中：#↑ {{Damage}} +20%伤害倍率#↑ x250%射速修正#跟踪眼泪#几率阻挡伤害"}, -- Hallowed Ground
	[549] =	{"549", "成骨不全症", "以6骨心替换所有心之容器#失去骨心时：#向8个方向发射骨头眼泪#↑ {{Tears}} 永久+0.4射速修正"}, -- Brittle Bones
	[553] = {"553", "毛霉菌病", "25%几率发射粘性孢子眼泪#孢子在命中后2.5秒爆炸，造成伤害，使附近敌人中毒，并释放更多孢子"}, --  Mucormycosis
	[554] = {"554", "恐怖如斯", "使近距离内的敌人恐惧"}, --  2Spooky
	[555] = {"555", "金剃刀片", "{{Damage}} 将5硬币转换成+1.2伤害，所在房间内有效#生成5硬币"}, --  Golden Razor
	...
	[559] = {"559", "220伏", "连续电击近距离的敌人#{{Damage}} 电击伤害为角色伤害的75%"}, --  120 Volt
	[560] = {"560", "好疼", "受伤时向四周发射10颗造成10伤害的眼泪#↑ {{Tears}} 第一次受伤时+1.2射速修正#↑ {{Tears}} 后续受伤+0.4射速"}, --  It Hurts
	...
	[572] = {"572", "邪道之眼", "眼泪飞行中可控制#↑ {{Damage}} +1.0伤害#↑ {{Range}} +2.0射程#↓ {{Shotspeed}} -0.16弹速"}, --  Eye of the Occult
	...
	[579] = {"579", "英灵剑", "攻击方式改为挥剑#{{Damage}} 伤害为角色伤害x3#可蓄力发动旋转攻击，同时发射剑形子弹#红心全满时，挥剑即可发射子弹"}, --  Spirit Sword
	...
	[588] = {"588", "太阳", "揭示{{BossRoom}}Boss房位置#击败Boss后在所在层获得：#使用{{Card20}}太阳#为主动道具充能#移除诅咒#↑ {{Damage}} +3.0伤害#↑ {{LuckSmall}} +1运气"}, --  Sol
	[589] = {"589", "月亮", "为每一层增加1个{{SecretRoom}}隐藏房间和{{SuperSecretRoom}}超级隐藏房间#每层揭示1个{{SecretRoom}}隐藏房#隐藏房间内有光束，接触时获得：#半个魂心# {{Tears}} 当前楼层+0.5射速修正 # {{Tears}} 每层第一次接触月光额外获得+0.5射速修正"}, --  Luna
	...
	[600] = {"600", "眼药水", "↑ {{Tears}} 只对左眼+30%射速修正#一段时间内第一次发射总是双发#{{Tears}} 非眼泪攻击+20%射速修正"}, --  Eye Drops
	[601] = {"601", "痛悔短祷", "↑ {{Tears}} +0.7射速#+1永恒之心#进行过恶魔交易后天使房仍然会出现#减缓受红心伤害减少{{DevilRoom}}恶魔房/{{AngelRoom}}天使房的几率"}, --  Act of Contrition
	...
	[616] = {"616", "鸟眼椒", "8%几率发射红火，能阻挡敌人弹幕并造成接触伤害#{{LuckSmall}} 运气10：50%几率#火焰造成或阻挡4次伤害后或10秒后消失"}, --  Bird's Eye
	[617] = {"617", "磁石", "17%几率发射使敌人磁化的眼泪#{{LuckSmall}} 运气5：100%几率#磁化的敌人吸引掉落物，弹幕和其它敌人"}, --  Lodestone
	[618] = {"618", "烂番茄", "17%几率发射眼泪标记敌人#{{LuckSmall}} 运气5：100%几率#被标记的敌人受其它敌人攻击"}, --  Rotten Tomato
	...
	[632] = {"632", "邪眼护符", "↑ {{LuckSmall}} +2运气#免疫烧伤，混乱，毒气"}, --  Evil Charm
	...
	[637] = {"637", "强力安眠药", "10%几率发射拳头，对敌人造成强力击退和击晕#{{LuckSmall}} 运气9：100%几率"}, --  Knockout Drops
	...
	[651] = {"651", "伯列恒之星", "向Boss房缓缓移动的跟班#四周有光环，在其中时获得：#↑ {{Damage}} +1.0伤害#↑ {{Damage}} +20%伤害倍率#↑ {{Tears}} x150%射速修正#眼泪有跟踪效果"}, --  Star of Bethlehem
	[652] = {"652", "冰块宝宝", "可被推动的跟班#接触敌人时造成伤害，并具有减速效果，击杀的敌人会被冻结"}, --  Cube Baby
	[653] = {"653", "驱魔护符", "非幽灵的敌人在死亡时生成小的红色幽灵#使用时引爆所有红色幽灵"}, --  Vade Retro
	[654] = {"654", "伪造药学博士证", "识别所有胶囊#+1黑心#好的胶囊自动转化为坏的#↑ {{Damage}} 降低属性的胶囊提供+1.0伤害#其它坏胶囊使用时掉落1黑心"}, --  False PHD
	...
	[659] = {"659", "托吡卡胺", "↑ {{Range}} +1.5射程#眼泪变大"}, --  Tropicamide
	...
	[664] = {"664", "大胃王", "↑ +1心之容器#{{Heart}} 满血#所有道具会周期性地切换为食物道具#捡起食物道具时获得：#↑ {{Damage}} 临时+3.6伤害#↑ 永久提升2项属性并永久# {{Speed}} -0.03移速#食物道具治疗3红心"}, --  Binge Eater
	...
	[669] = {"669", "腊肠", "↑ +1心之容器#{{Heart}} 满血#↑ {{Damage}} +0.5伤害#↑ {{Speed}} +0.2移速#↑ {{Shotspeed}} +1.2弹速#↑ {{Range}} +0.16射程#↑ {{LuckSmall}} +1运气#↑ +6.9%{{DevilRoom}}恶魔房/{{AngelRoom}}天使房几率#↑ +6.9%{{Planetarium}}星象房几率"}, --  Sausage
	...
	[673] = {"673", "赎罪", "进入恶魔房间但不捡任何物品时，于下一层获得：#+1魂心#↑  {{Damage}} +1.0伤害"}, --  Redemption
	...
	[692] = {"692", "血色羁绊", "在恶魔房间内生成地刺#在地刺上献祭，可以获得以下奖励：#35%几率为6硬币#{{Damage}} 15%几率为+0.5伤害#5%几率为2黑心#2%几率为随机道具#1%几率变形为利维坦"}, --  Sanguine Bond
	[693] = {"693", "虫群", "获得8只环绕苍蝇，苍蝇被击中时变为蓝色苍蝇#每清理1个房间，生成1只环绕苍蝇"}, --  The Swarm
	[694] = {"694", "心碎", "获得3碎心#{{Damage}} 每个碎心+0.25伤害#受致命伤害时增加2碎心#碎心达到 12个时死亡"}, --  Heartbreak
	[695] = {"695", "血腥怒风", "受伤时，在所在层提升 {{Speed}} 移速和 {{Tears}} 射速#最多+1.02移速，+3射速修正"}, --  Bloody Gust
	...
	[698] = {"698", "作孽双子", "2个与角色并排而行的跟班#攻击方式与角色相同#每个宝宝造成37.5%的角色伤害#{{Player13}} 如果是莉莉丝则改为50%"}, --  Twisted Pair
	...
	[703] = {"703", "小以扫", "使用时在当前角色和小以扫之间切换，小以扫初始拥有3黑心，{{Damage}} +2.0 伤害和飞行#2个角色不共享生命值和道具#第一次使用时获得与角色等量的随机被动道具#{{Warning}} 任意角色死亡，游戏结束"}, --  Esau Jr.
	[704] = {"704", "狂怒！", "使用时进入狂暴状态5秒：#↑ {{Speed}} +0.4移速#↑ {{Tears}} x50%+2.0射速修正#↑ {{Damage}} +3.0伤害#只能使用特定近战武器#狂怒状态下击杀敌人可延长1秒此状态持续时间"}, --  Berserk!
	...
	[726] = {"726", "咯血症", "双击发射键咯血#对前方的敌人造成1.5倍角色伤害#1秒冷却时间#{{BrimstoneCurse}} 被击中的敌人会受到硫磺火束的额外伤害"}, --  Hemoptysis
	...
	[730] = {"730", "玻璃眼", "↑ {{Damage}} +0.75伤害#↑ {{LuckSmall}} +1运气"}, -- Glass Eye
	[731] = {"731", "麦粒肿", "!!! 只对右眼有效#↑ {{Damage}} +1.0伤害#↑ {{Range}} +7.0射程#↓ {{Shotspeed}} -0.3弹速"}, --  Stye
	[732] = {"732", "老妈的戒指", "↑ {{Damage}} +1.0伤害#生成1随机符文或魂石"}, --  Mom's Ring
...
EID.descriptions[languageCode].birthright ={
	{"以撒", "", "所有道具在2个选择间切换"},
	{"抹大拉", "", "↑ +1心之容器#心上限提高到18"},
	{"该隐", "", "↑ {{LuckSmall}} +1运气#除暗室和宝箱层外，所有层都含有一个升级的赌博房#极大增强{{Collectible46}}幸运脚的获胜几率提高的效果"},
...
EID.descriptions[languageCode].bingeEaterBuffs = {
	[22] = "↑ {{Tears}} +0.5射速#↑ {{Range}} +1.5射程#↓ {{Speed}} -0.03移速", -- Lunch
	[23] = "↑ {{Tears}} +0.5射速#↑ {{Shotspeed}} +0.2弹速#↓ {{Speed}} -0.03移速", -- Dinner
	[24] = "↑ {{Damage}} +1.0伤害修正#↑ {{Shotspeed}} +0.2弹速#↓ {{Speed}} -0.03移速", -- Dessert
	[25] = "↑ {{Shotspeed}} +0.2弹速#↑ {{Range}} +1.5射程#↓ {{Speed}} -0.03移速", -- Breakfast
	[26] = "↑ {{Damage}} +1.0伤害修正#↑ {{Range}} +1.5射程#↓ {{Speed}} -0.03移速", -- Rotten Meat
	[346] = "↑ {{Shotspeed}} +0.2弹速#↑ {{LuckSmall}} +1运气#↓ {{Speed}} -0.03移速", -- A Snack
	[456] = "↑ {{Damage}} +1.0伤害修正#↑ {{LuckSmall}} +1运气#↓ {{Speed}} -0.03移速", -- Midnight Snack
	[707] = "↑ {{Tears}} +0.5射速#↑ {{LuckSmall}} +1运气#↓ {{Speed}} -0.03移速", -- Supper
}
...
local repTrinkets={
	...
	[80] = {"80", "黑色羽毛", "↑ {{Damage}} 每持有1个恶魔道具+0.5伤害"}, -- Black Feather
	...
	[101] = {"101", "暗灯泡", "!!! 当主动道具无充能时：#↑ {{Damage}} +1.5伤害#↑ {{Speed}} +0.5移速#↑ {{Range}} +1.5射程#↑ {{Tears}} +0.5射速#↑ {{Shotspeed}} +0.3弹速#↑ {{LuckSmall}} +2运气"}, -- Dim Bulb
	...
	[129] = {"129", "崩掉牙", "10%几率发射牙齿眼泪#牙齿造成3.2倍角色伤害#{{LuckSmall}} 运气9：100%几率"}, --  Jawbreaker
	[130] = {"130", "嚼烂的笔", "10%几率发射减速眼泪#{{LuckSmall}} 运气18：100%几率"}, --  Chewed Pen
	...
	[139] = {"139", "泪滴护符", "{{LuckSmall}} 对基于运气的眼泪效果+3运气"}, --  Teardrop Charm
	...
	[145] = {"145", "满分考卷", "↑ {{LuckSmall}} +10运气#持有时受到怪物，尖刺等非主动伤害时摧毁"}, -- Perfection
...
EID.descriptions[languageCode].horsepills={
	...
	{"36", "大力丸！", "短时间无敌#↑ {{Damage}} +7.0伤害#↑ {{Range}} +3.0射程#所在房间持续"}, -- Power Pill!
