...
local repCollectibles={
	...
	[55] = {"55", "老妈的眼睛", "50%几率向后发射眼泪#运气5：100%几率"}, -- Mom's Eye
	...
	[87] = {"87", "洛基的角", "25%几率向4个方向发射眼泪#运气15：100%几率"}, -- Loki's Horns
	...
	[110] = {"110", "老妈的美瞳", "20%几率发射石化眼泪#↑ +0.38射程"}, -- Mom's Contacts
	...
	[228] = {"228", "老妈的香水", "15%几率发射恐惧眼泪#↑ +0.5射速"}, -- Moms Perfume
	...
	[374] = {"374", "圣光", "10%几率发射圣光眼泪，击中时会产生光柱#光柱造成3倍角色伤害#运气9：50%几率"}, -- Holy Light
	...
	[393] = {"393", "蛇蝎之吻", "15%几率发射有毒眼泪#会使接触的敌人中毒#接触中毒的敌人被杀死时有20%几率掉落1黑心"}, -- Serpent`s Kiss
	...
	[401] = {"401", "爆炸物", "25%几率发射粘性炸弹眼泪#眼泪命中时造成常规眼泪的伤害"}, -- Explosivo
	...
	[459] = {"459", "鼻窦炎", "20%几率发射粘性有毒眼泪#每秒造成角色伤害#能粘住10秒"}, -- Sinus Infection
	...
	[495] = {"495", "断魂椒", "8%几率发射蓝火，能阻挡敌人弹幕并造成接触伤害#运气10：50%几率#火焰2秒后消失"}, -- Ghost Pepper
	[496] = {"496", "安乐死", "3.33%发射针#运气15：50%几率#针会立即杀死一般敌人，并爆出10发眼泪#针击中Boss造成3倍伤害"}, -- Euthanasia
	[503] = {"503", "小魔角", "5%几率发射能召唤巨角恶魔的手的眼泪#手会立即杀死敌人或对Boss造成伤害#冲向敌人会造成3.5接触伤害"}, -- Little Horn
	...
	[553] = {"553", "毛霉菌病", "25%几率发射粘性孢子眼泪#孢子在命中后2.5秒爆炸，造成伤害，使附近敌人中毒，并释放更多孢子"}, --  Mucormycosis
	...
	[558] = {"558", "眼瘤", "几率向随机方向发射1-3颗额外眼泪"}, --  Eye Sore
	...
	[606] = {"606", "邪眼裂口", "5%几率发射在落地时生成裂隙的眼泪#裂隙吸引周围的敌人，掉落物，弹幕"}, --  Ocular Rift
	...
	[616] = {"616", "鸟眼椒", "8%几率发射红火，能阻挡敌人弹幕并造成接触伤害#运气10：50%几率#火焰造成或阻挡4次伤害后或10秒后消失"}, --  Bird's Eye
	[617] = {"617", "磁石", "1/6几率发射使敌人磁化的眼泪#运气5：100%几率#磁化的敌人吸引掉落物，弹幕和其它敌人"}, --  Lodestone
	[618] = {"618", "烂番茄", "1/6几率发射眼泪标记敌人#运气5：100%几率#被标记的敌人受其它敌人攻击"}, --  Rotten Tomato
	...
	[637] = {"637", "强力安眠药", "10%几率发射拳形眼泪，对敌人造成强力击退和击晕#运气9：100%几率"}, --  Knockout Drops
	...
	[642] = {"642", "玄奇驴皮", "消耗1心之容器或2魂心，并将其替换为碎心#从当前房间道具池中生成1个道具#使用次数越多，若不再持有，则后续生成的道具被玄奇驴皮替换的几率越大#使用1次为33%，2次50%，3次100%#如果当前层的底座道具有玄奇驴皮则降低该几率#{{Warning}}游魂：一次性，不影响后续道具#{{Warning}}"}, --  Magic Skin
	...
	[648] = {"648", "", "<道具不存在>"},
	[649] = {"649", "果味甜蝇宝", "迷你甜蝇宝宝跟班#在房间内斜着前进，并发射眼泪"}, --  Fruity Plum
	[650] = {"650", "甜蝇溜溜笛", "使用时，在所在房间召唤甜蝇宝宝，持续10秒"}, --  Plum Flute
...
local repTrinkets={
	...
	[24] = {"24", "屁股硬币", "便便产生硬币的几率+20%#捡起硬币时放屁#屁会使敌人中毒并击退敌人和弹幕"}, -- Butt Penny
	...
	[98] = {"98", "鼻涕泡", "10%几率发射跟踪粘性有毒眼泪#每秒造成角色伤害#能粘住10秒"}, -- Nose Goblin
	...
	[129] = {"129", "崩掉牙", "10%几率发射牙齿眼泪#牙齿造成3.2倍角色伤害#运气9：100%几率"}, --  Jawbreaker
	[130] = {"130", "嚼烂的笔", "10%几率发射减速眼泪#运气18：100%几率"}, --  Chewed Pen
	[131] = {"131", "神圣硬币", "捡起硬币时有1/6几率掉落半魂心"}, --  Blessed Penny
	[132] = {"132", "损坏的注射器", "25%几率在所在房间内获得随机药剂效果"}, --  Broken Syringe
	[133] = {"133", "短引线", "角色放置的炸弹爆炸更快"}, --  Short Fuse
	[134] = {"134", "巨豆", "增加屁的大小"}, --  Gigante Bean
	[135] = {"135", "打火机", "进入房间时有20%几率对敌人施加燃烧效果"}, --  A Lighter
	...
	[139] = {"139", "泪滴护符", "对基于运气的眼泪效果+3运气"}, --  Teardrop Charm
	...
	[143] = {"143", "老旧电容", "阻止主动道具充能#清理房间后有20%几率生成电池"}, --  Old Capacitor
	...
	[147] = {"147", "充能硬币", "捡起硬币时有1/6几率对主动道具充能1格"}, --  Charged Penny
	...
	[153] = {"153", "老妈的发髻", "每个房间有25%几率获得随机老妈道具的效果"}, --  Mom's Lock
	...
	[159] = {"159", "镀金钥匙", "首次捡起时+1钥匙#以金箱子替换所有新箱子#所有金箱子包含卡牌，胶囊或饰品#对巨型箱子无效"}, --  Gilded Key
	[160] = {"160", "幸运袋", "到下一层时生成1福袋"}, --  Lucky Sack
	[161] = {"161", "邪恶王冠", "在地狱生成{{TreasureRoom}}道具房和商店{{Shop}}"}, --  Wicked Crown
	[162] = {"162", "阿撒泻勒的残角", "清理房间后有50%几率变为阿撒泻勒#效果持续到清理或离开另一个房间"}, --  Azazel's Stump
	...
	[169] = {"169", "儿童涂鸦", "持有时当做1个嗝屁猫套装道具"}, --  Kid's Drawing
	[170] = {"170", "水晶钥匙", "清理房间后有33%几率自动创造 {{Collectible580}} 红钥匙房间#红房间中几率降低"}, --  Crystal Key
	...
	[182] = {"182", "伯大尼的精华", "进入天使房时生成5魂火#当给乞丐钱时有25%几率生成1魂火"}, --  Beth's Essence
	[183] = {"183", "双胞胎", "每个房间有50%几率复制1个跟班#没有跟班则以 {{Collectible8}} 弟弟波比或 {{Collectible67}} 妹妹玛姬代替"}, --  The Twins
	[184] = {"184", "领养协议书", "{{Shop}}商店的跟班卖10硬币"}, --  Adoption Papers
	[185] = {"185", "蟋蟀腿", "杀死敌人时有1/6几率生成1只随机蝗虫"}, --  Cricket Leg
	[186] = {"186", "亚玻伦的挚友", "生成1只天启蝗虫"}, --  Apollyon's Best Friend
	[187] = {"187", "碎掉的眼镜", "50%几率在道具房添加1个额外的问号道具#50%几率揭示分支路线的问号道具"}, --  Broken Glasses
	[188] = {"188", "冰块", "进入房间时有20%几率石化1个敌人#击杀石化的敌人可将其冻结"}, --  Ice Cube
...
EID.descriptions[languageCode].horsepills={
	...
	{"20", "48小时能量！", "对主动道具充能#生成更多电池"}, -- 48 Hour Energy!
	{"21", "呕血", "清空红心但保留1红心#生成更多红心"}, -- Hematemesis
