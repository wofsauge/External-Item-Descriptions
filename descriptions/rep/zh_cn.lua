...
local repCollectibles={
	...
	[448] = {"448", "玻璃碎片", "受减红心的伤时，喷出红色眼泪#攻击时控制喷出眼泪的方向#生效后，每20秒受到半心伤害#直到捡到红心或无红心为止#不致死"}, -- Shard of Glass -- TODO: Lines 172 and 176 define the same item, but are different. One of them needs to be removed.
	[448] = {"448", "玻璃碎片", "当受伤时喷出红色眼泪并留下血迹#攻击时控制喷出眼泪的方向#一段时间后红心受伤，有较大几率生成1红心#角色会持续受伤，直到捡到红心或无红心为止"}, -- Shard of Glass -- TODO: Lines 172 and 176 define the same item, but are different. One of them needs to be removed.
