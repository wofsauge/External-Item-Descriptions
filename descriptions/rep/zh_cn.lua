...
local repCollectibles={
	...
	[5] = {"5", "我的镜像", "眼泪有回旋效果#↑ +1.5射程#↑ +60%额外射程↑ {{Shotspeed}} +0.6弹速"}, -- My Reflection
	[6] = {"6", "小号", "↑ +1.5射速#↓ -1.5射程#↓ -20%额外射程"}, -- Number One
	[12] = {"12", "魔法蘑菇", "↑ +1心之容器#满心#↑ +0.3伤害#↑ +50%伤害倍数#↑ +1.5射程#↑ {{Speed}} +0.3移速#体型变大"}, -- Magic Mushroom
	[13] = {"13", "病毒", "接触敌人使其中毒#↑ {{Speed}} +0.2移速"}, -- The Virus
	[14] = {"14", "过量类固醇", "↑ {{Speed}} +0.3移速#↑ +1.5射程"}, -- Roid Rage
	...
	[70] = {"70", "生长激素", "↑ +1.0伤害#↑ {{Speed}} +0.2移速"}, -- Growth Hormones
	[71] = {"71", "小蘑菇", "↑ {{Speed}} +0.3移速#↑ +1.5射程#↑ 体型缩小"}, -- Mini Mush
	...
	[79] = {"79", "咒印", "↑ +1.0伤害#↑ {{Speed}} +0.2移速#+1黑心"}, -- The Mark
	[80] = {"80", "契约", "↑ +0.5伤害#↑ +0.7射速#+2黑心"}, -- The Pact
	[83] = {"83", "钉子", "+半黑心#↑ +2.0伤害#↓ {{Speed}} -0.18移速#造成接触伤害#粉碎经过的岩石"}, -- The Nail
	[84] = {"84", "我们需要深入挖掘！", "生成1个跳过所在层的活板门#如果在有装饰(草、碎石、宝石、骷颅头等)的地板上使用则改为生成一个暗门"}, -- We Need To Go Deeper!
	...
	[101] = {"101", "光环", "↑ +1心之容器#↑ +0.3伤害#↑ +0.2射速#↑ +0.38射程#↑ {{Speed}} +0.3移速#治疗1红心"}, -- The Halo
	[106] = {"106", "大爆弹先生", "↑ 炸弹伤害x1.85#+5炸弹"}, -- Mr. Mega
	[110] = {"110", "老妈的美瞳", "20%几率发射石化眼泪#↑ +0.38射程"}, -- Mom's Contacts
	[118] = {"118", "硫磺火", "蓄力发射持续造成伤害的鲜血激光#↓ -67%发射速度"},
	[121] = {"121", "怪异蘑菇(大)", "↑ +1心之容器#↑ +1伤害#↑ +0.38射程#↓ {{Speed}} -0.2移速"}, -- Odd Mushroom (Large)
	...
	[149] = {"149", "吐根酊", "爆炸有毒眼泪#↑ +40伤害#↓ {{Shotspeed}} -0.2弹速#↓ -67%发射速度#↓ 射程小幅降低"}, -- Ipecac
	...
	[182] = {"182", "圣心", "↑ +1心之容器#满血#↑ +230%伤害并+1伤害#↓ -0.4射速#↓ {{Shotspeed}} -0.25弹速#跟踪眼泪"}, -- Sacred Heart
	[184] = {"184", "圣杯", "飞行#↑ +1心之容器#治疗1红心"}, -- Holy Grail
	[188] = {"188", "亚伯", "与角色移动互为镜像#向角色发射眼泪#每次射击造成3.5伤害#该隐：7.5伤害"}, -- Abel
	[189] = {"189", "超级食肉男孩死忠粉", "↑ +1心之容器#满血#↑ +0.3伤害#↑ +0.2射速#↑ +1.5射程#↑ {{Speed}} +0.2移速"}, -- SMB Super Fan
	[192] = {"192", "心灵感应傻瓜式教程", "所在房间眼泪有跟踪效果并+3射程"}, -- Telepathy for Dummies
	[193] = {"193", "生肉！", "↑ +1心之容器#↑ +0.3伤害#治疗1红心"}, -- MEAT!
	[194] = {"194", "魔力八号球", "↑ {{Shotspeed}} +0.16弹速#+1卡牌#+15%星象房几率"}, -- Magic 8 Ball
	[197] = {"197", "耶稣果汁", "↑ +0.5伤害#↑ +0.38射程"}, -- Jesus Juice
	[203] = {"203", "慈善捆绑包", "掉落物几率成对出现"}, -- Humbling Bundle
	[205] = {"205", "锋利插头", "使用时，以每格充能半心的代价为主动道具完全充能#优先使用红心"}, -- Sharp Plug
	...
	[222] =	{"222", "反重力", "按住发射键会使眼泪悬空#释放后，所有眼泪会向发射方向前进#↑ +1发射速度"}, -- Anti-Gravity
	[224] = {"224", "柯吉猫的身体", "↓ -20%射程#眼泪击中后会分裂为4个#分裂的眼泪造成一半伤害#↑ -1眼泪延迟，可以使射速超出上限"}, -- Cricket's Body
	[228] = {"228", "老妈的香水", "15%几率发射恐惧眼泪#↑ +0.5射速"}, -- Moms Perfume
	[230] = {"230", "亚巴顿", "↑ +1.5伤害#↑ {{Speed}} +0.2移速#恐惧眼泪#将心之容器变成黑心#+2黑心"}, -- Abaddon
	[232] = {"232", "怀表", "永久敌人减速效果#↑ {{Speed}} +0.3移速"}, -- Stop Watch
	...
	[297] = {"297", "潘多拉魔盒", "{{Warning}} 一次性，根据所在层掉落以下物品：#1章1：2魂心#1章2：2钥匙+2炸弹#2章1：1Boss房道具#2章2：1章1+2章1#3章1：4魂心#3章2：20硬币#4章1：2Boss房道具#4章2：{{Collectible33}}圣经#???：无#地狱：1恶魔房道具+1黑心#大教堂：1天使房道具+1永恒之心#暗室：解锁{{Collectible523}}搬家盒#宝箱层：1硬币#家：{{Collectible580}}红钥匙#若有迷宫诅咒则为章节1层"}, -- Pandora's Box
	[300] = {"300", "白羊座", "↑ {{Speed}} +0.25移速#{{Speed}} 对敌人造成25接触伤害#移速不低于为0.85才能造成伤害，且自己不会受伤"}, -- Aries
	[307] = {"307", "摩羯座", "↑ +1心之容器#↑ +0.5伤害#↑ {{Speed}} +0.1移速#↑ +0.75射程#↑ +0.5发射速度#给予1炸弹，硬币和钥匙"}, -- Capricorn
	[308] = {"308", "水瓶座", "留下水迹#水迹每秒造成66%的角色伤害的接触伤害#水迹与眼泪效果有协同效应"}, -- Aquarius
	[309] =	{"309", "双鱼座", "↑ +0.5发射速度#提高眼泪击退力"},
	[310] =	{"310", "夏娃的睫毛膏", "↑ +100%伤害#↓ -33%射速#↓ {{Shotspeed}} -0.5弹速"},
	[314] = {"314", "霹雳大腿", "↑ +1心之容器#↓ {{Speed}} -0.4移速#治疗1红心#摧毁走过的岩石"}, -- Thunder Thighs
	...
	[331] = {"331", "神性", "↑ +0.5伤害#↓ -0.3射速#↓ {{Shotspeed}} -0.3弹速#眼泪具有伤害光环，每帧造成2伤害#跟踪眼泪"}, -- Godhead
	[336] = {"336", "烂洋葱", "穿透幽灵眼泪#↓ -1.5射程#↓ {{Shotspeed}} -0.4弹速#↑ +50%眼泪大小"}, -- Dead Onion
	[339] = {"339", "安全别针", "↑ +1.5射程#↑ {{Shotspeed}} +0.16弹速#+1黑心"}, -- Safety Pin
	[342] = {"342", "蓝盖蘑菇", "↑ +1心之容器#↑ +0.7射速#↓ {{Shotspeed}} -0.16弹速#治疗1红心"}, -- Blue Cap
	...
	[352] = {"352", "玻璃大炮", "发射一颗巨大的穿透幽灵眼泪((伤害x10)+10)#!!! 受伤时：#额外受到2红心伤害并在当前房间留下血迹#额外伤害不致命#↑ +1.5射程#主动伤害除外"}, -- Glass Canon
	...
	[369] = {"369", "连续统", "↑ +3.0射程#幽灵眼泪#眼泪会穿墙，从另一边回来"}, -- Continuum
	...
	[395] = {"395", "科技X", "能够蓄力并发射穿过整个房间的激光环#蓄力越久伤害越高#完全蓄力伤害为100%"}, -- Tech X
	[397] = {"397", "牵引光束", "角色的眼泪现在受光束指引，与角色一起移动#↑ +0.5射速#↑ +1.5射程#↑ {{Shotspeed}} +0.16弹速"}, -- Tractor Beam
	[399] = {"399", "虚空之喉", "发射3秒后，角色头上会出现红交叉。释放攻击键会产生1圈黑硫磺火环"}, -- Maw of the Void
	[401] = {"401", "爆炸物", "25%几率发射粘性炸弹眼泪#几秒后爆炸并造成角色伤害+60的伤害"}, -- Explosivo
	...
	[407] = {"407", "纯洁", "↑ 根据角色光环颜色对角色属性进行增强#受伤或进入新房间时，获得新的光环：#{{ColorRed}}红色{{CR}} = +4伤害#{{ColorBlue}}蓝色{{CR}} = +2发射速度#{{ColorYellow}}黄色{{CR}} = {{Speed}} +0.5移速#{{ColorOrange}}橙色{{CR}} = +3.0射程"},
	[408] = {"408", "祭祀之刃", "受伤时在角色周围产生黑色硫磺火圈"}, -- Athame
	[415] = {"415", "光明之冠", "+2魂心#如果没有不满的心之容器：#↑ +100%伤害#↑ +1.5射程#↓ {{Shotspeed}} -0.3弹速#受伤后，当前房间无论心之容器是否是满的，效果消失"}, -- Crown Of Light
	...
	[442] = {"442", "黑王子之冠", "!!! 仅有1红心时：#↑ +2发射速度#↑ +1.5射程#↑ {{Shotspeed}} +0.2弹速#没有红心的角色无效)"}, -- Dark Princes Crown
	...
	[501] = {"501", "贪婪的胃袋", "拾取后，每获得25硬币增加1心之容器#最多硬币达到99，+4心之容器#{{Player14}}/{{Player33}}店主也会增加额外的硬币心#{{Collectible416}} 超过99后每100硬币增加1心之容器"}, -- Greed's Gullet
	[503] = {"503", "小魔角", "5%几率发射能召唤巨角恶魔的手的眼泪#手会立即杀死敌人或对Boss造成伤害#冲向敌人造成3.5接触伤害"}, -- Little Horn
	...
	[531] = {"531", "泪血症", "眼泪弧形前进，击中时眼泪分裂成更小的眼泪#↑ +1伤害#↑ +50%伤害系数#↓ 射速降低#↓ -20%射程"}, -- Haemolacria
	...
	[569] = {"569", "血誓", "在每一层开始时只保留半红心#在本层获得以下效果：#↑ +0.15*整红心损失数^2的伤害#↑ {{Speed}} +0.05*半红心损失数的移速"}, --  Blood Oath
	[570] = {"570", "黏土饼干", "使眼泪变为彩色，不同颜色的眼泪有不同的状态效果"}, --  Playdough Cookie
	[571] = {"571", "孤儿的袜子", "免疫来自水迹和尖刺的伤害#↑ {{Speed}} +0.3移速#↑ +2魂心"}, --  Orphan Socks
	[572] = {"572", "邪道之眼", "眼泪飞行中可控制#↑ +1伤害#↑ +2射程#↓ {{Shotspeed}} -0.16弹速"}, --  Eye of the Occult
	...
	[582] = {"582", "迷幻蘑菇", "↑ +0.75发射速度#↓ {{Speed}} -0.03移速#扭曲画面#效果可叠加"}, --  Wavy Cap
	...
	[588] = {"588", "太阳", "揭示{{BossRoom}}Boss房位置#击败Boss后：#使用{{Card20}}太阳#为主动道具充能#移除诅咒#在所在层+3伤害，+1运气"}, --  Sol
	...
	[594] = {"594", "木星", "↑ +2心之容器#治疗半红心#↓ {{Speed}} -0.3移速#角色免疫中毒伤害#{{Speed}} 不移动时累积至多0.5移速#移动时向后释放毒气"}, --  Jupiter
	...
	[600] = {"600", "眼药水", "↑ 只对左眼+30%发射速度#一段时间内第一次发射总是双发#非眼泪攻击+20%发射速度"}, --  Eye Drops
	...
	[617] = {"617", "磁石", "17%几率发射使敌人磁化的眼泪#运气5：100%几率#磁化的敌人吸引掉落物，弹幕和其它敌人"}, --  Lodestone
	[618] = {"618", "烂番茄", "17%几率发射眼泪标记敌人#运气5：100%几率#被标记的敌人受其它敌人攻击"}, --  Rotten Tomato
	...
	[633] = {"633", "教条", "获得飞行和单次{{Collectible313}}神圣斗篷效果#↑ +2.0伤害#↑ {{Speed}} +0.1移速#如果角色少于6心则以红心和魂心治疗至6心"}, --  Dogma
	...
	[637] = {"637", "强力安眠药", "10%几率发射拳头，对敌人造成强力击退和击晕#运气9：100%几率"}, --  Knockout Drops
	...
	[655] = {"655", "幸运转盘", "生成1个陀螺环绕跟班，可阻挡敌人弹幕#每秒造成10.5接触伤害#{{Speed}} 使用时+0.5移速，使所有环绕物加速旋转#对蓝苍蝇和蓝蜘蛛也有效，且使用时无敌"}, --  Spin to Win
	...
	[664] = {"664", "大胃王", "↑ +1心之容器#满血#所有道具会周期性地切换为食物道具#捡起食物道具时获得：#↑ {{Damage}} 临时+3.6伤害#↑ 永久提升2项属性并永久# {{Speed}} -0.03移速#食物道具治疗3红心"}, --  Binge Eater
	...
	[669] = {"669", "腊肠", "↑ +1心之容器#满血#↑ +0.5伤害#↑ {{Speed}} +0.2移速#↑ {{Shotspeed}} +1.2弹速#↑ +0.16射程#↑ +1运气#↑ +6.9%{{DevilRoom}}恶魔房/{{AngelRoom}}天使房几率#↑ +6.9%{{Planetarium}}星象房几率"}, --  Sausage
	...
	[695] = {"695", "血腥怒风", "受伤时，在所在层提升 {{Speed}} 移速和 {{Tears}} 射速#最多+1.02移速，+3发射速度"}, --  Bloody Gust
	...
	[701] = {"701", "以撒的坟墓", "在每层开始时生成1个需要钥匙解锁的老箱子#老箱子含有魂心，饰品或道具#道具为{{AngelRoom}}天使房道具或老爸，老妈相关的道具"}, --  Isaac's Tomb
	[702] = {"702", "复仇之魂", "受伤时，生成魂火环绕跟班，在所在层持续#最多6个#发射眼泪，但无法阻挡敌人弹幕"}, --  Vengeful Spirit
	[703] = {"703", "小以扫", "使用时在当前角色和小以扫之间切换，小以扫初始拥有3黑心，+2伤害和飞行#2个角色不共享生命值和道具#第一次使用时获得与角色等量的随机被动道具#{{Warning}} 任意角色死亡，游戏结束"}, --  Esau Jr.
	[704] = {"704", "狂怒！", "使用时进入狂暴状态5秒：#↑ {{Speed}} +0.4移速#↑ 射速提升#↑ +3.0伤害1只能使用特定近战武器"}, --  Berserk!
	[705] = {"705", "暗仪刺刀", "使用时在1秒内 {{Speed}} +1.0移速，可穿过敌人和弹幕#对每个接触的敌人造成角色伤害x2+3.5的伤害，每经过1个敌人再+3.5#效果结束时的爆炸伤害等于之前伤害的总和"}, --  Dark Arts
	...
	[716] = {"716", "店主的胯袋", "在捡起时生成 {{Coin}} 3硬币和 {{Key}} 1钥匙#{{Shop}} 每花费3个硬币购买物品可获得以下一项提升：#↑ {{Damage}} +0.5伤害#↑ {{Range}} +0.25射程#↑ {{Speed}} +0.03移速"}, --  Keeper's Sack
	...
	[724] = {"724", "高凝血", "受伤时掉落半或整红心#产生的红心在1.5秒后消失"}, --  Hypercoagulation
	[725] = {"725", "大肠激躁症", "造成足够伤害后，停止攻击并触发随机{{Player25}}堕化???的效果：#投掷随机便便#生成增益水迹#放有毒的屁#放置5个激活的炸弹"}, --  IBS
	[726] = {"726", "咯血症", "双击发射键咯血#对前方的敌人造成角色伤害x1.5的伤害#1秒冷却时间#{{BrimstoneCurse}} 被击中的敌人会受到硫磺火束的额外伤害"}, --  Hemoptysis
	...
	[731] = {"731", "麦粒肿", "!!! 只对右眼有效#↑ +1伤害#↑ +7射程#↓ {{Shotspeed}} -0.3弹速"}, --  Stye
...
EID.descriptions[languageCode].bingeEaterBuffs = {
	[22] = "↑ +0.5射速#↑ +1.5射程#↓ {{Speed}} -0.03移速", -- Lunch
	[23] = "↑ +0.5射速#↑ {{Shotspeed}} +0.2弹速#↓ {{Speed}} -0.03移速", -- Dinner
	[24] = "↑ +1.0伤害#↑ {{Shotspeed}} +0.2弹速#↓ {{Speed}} -0.03移速", -- Dessert
	[25] = "↑ {{Shotspeed}} +0.2弹速#↑ +1.5射程#↓ {{Speed}} -0.03移速", -- Breakfast
	[26] = "↑ +1.0伤害#↑ +1.5射程#↓ {{Speed}} -0.03移速", -- Rotten Meat
	[346] = "↑ {{Shotspeed}} +0.2弹速#↑ +1.0运气#↓ {{Speed}} -0.03移速", -- A Snack
	[456] = "↑ +1.0伤害#↑ +1.0运气#↓ {{Speed}} -0.03移速", -- Midnight Snack
	[707] = "↑ +0.5射速#↑ +1.0运气#↓ {{Speed}} -0.03移速", -- Supper
}
...
local repTrinkets={
	...
	[48] = {"48", "遗失的书页", "受伤时5有%几率对房间内所有敌人造成80伤害#黑心和类似{{Collectible35}}死灵之书的效果造成双倍伤害"}, -- A Missing Page
	...
	[101] = {"101", "暗灯泡", "!!! 当主动道具无充能时：#↑ +1.5伤害#↑ {{Speed}} +0.5移速#↑ +1.5射程#↑ +0.5射速#↑ {{Shotspeed}} +0.3弹速#↑ +2运气"}, -- Dim Bulb
	...
	[131] = {"131", "神圣硬币", "捡起硬币时有17%几率掉落半魂心"}, --  Blessed Penny
	...
	[147] = {"147", "充能硬币", "捡起硬币时有17%几率对主动道具充能1格"}, --  Charged Penny
...
local repCards={
	[2] = {"2", "I-魔术师", "所在房间内眼泪有跟踪效果并+3射程"}, -- I - The Magician
	[12] = {"12", "XI-力量", "↑ +1心之容器#↑ +0.3伤害#↑ +50%伤害#↑ +5.25射程#↑ {{Speed}} +0.3移速#仅所在房间"}, -- XI - Strength
	...
	[52] = {"52", "变巨术", "↑ +7伤害#↑ +3射程#粉碎经过的岩石#体型变大#效果在所在房间持续"}, -- Huge Growth
	...
	[75] = {"75", "XIX-太阳？", "获得{{Collectible159}}夜之精灵#↑ +1.5伤害#在所在层持续#将红心转化为骨心，但效果结束后恢复#施加黑暗诅咒"}, -- XIX - The Sun?
	...
	[87] = {"87", "参孙的魂石", "变成狂暴参孙，使用近战攻击10秒#↑ {{Speed}} +0.4移速#↑ 射速提升#↑ +3伤害"}, -- Soul of Samson
