...
local repCollectibles={
	...
	[308] = {"308", "宝瓶座", "角色留下水迹#{{Damage}} 水迹每秒造成6.66x角色伤害, 并继承角色的泪弹效果"}, -- Aquarius
	...
	[319] = {"319", "该隐的另一只眼", "向随机方向发射与角色相同效果的泪弹#{{Damage}} 造成0.75x角色伤害"}, -- Cain's Other Eye
	...
	[395] = {"395", "科技X", "{{Chargeable}} 角色的泪弹由可蓄力的激光环取代#激光环尺寸和伤害随蓄力时间增加, 最多增加至1x"}, -- Tech X
	...
	[432] = {"432", "闪光炸弹", "{{Bomb}} +5炸弹#角色的炸弹爆炸时, 63%概率生成1随机掉落物, 15%概率魅惑炸到的敌人#每次生成掉落物后, 生成概率降低1%"}, -- Glitter Bombs
	...
	[613] = {"613", "", "<道具不存在>"},
	[614] = {"614", "鲜血炸弹", "↑ {{Heart}} +1心之容器#{{HealingRed}} 治疗4红心#{{HalfHeart}} 若角色没有炸弹, 则可以花费半红心放置炸弹#角色的炸弹会留下血迹"}, --  Blood Bombs
	...
	[695] = {"695", "嗜血腥风", "受伤时, 在本层获得:#↑ {{Speed}} 移速提升#↑ {{Tears}} 射速修正提升#最多移速+1.02, 射速修正+3"}, --  Bloody Gust
...
local repTrinkets={
	...
	[162] = {"162", "阿撒泻勒的残角", "{{Player7}} 清理房间后有33%概率变为阿撒泻勒#{{Timer}} 效果持续到清理或离开另一个房间"}, --  Azazel's Stump
...
local repCharacterInfo = {
	...
	[12] = {"犹大之影", "{{Damage}} 伤害修正x2#无法拥有红心#{{BlackHeart}} 体力上升改为获得黑心#{{Player3}} 通关标记为犹大"},
	...
	[31] = {"堕化游魂", "{{Card51}} 生成的卡牌有10%概率为神圣卡#品质{{Quality2}}或以下的道具有20%概率重置#只生成\"攻击性道具\""},
