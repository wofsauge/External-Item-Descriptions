...
local repCollectibles={
	...
	[31] = {"31", "老妈的口红", "↑ {{Range}} +2.25射程#{{UnknownHeart}} 生成1随机心"}, -- Mom's Lipstick
	[37] = {"37", "炸弹先生", "在角色下方放置1个大炸弹，造成185伤害"}, -- Mr. Boom
	[40] = {"40", "神风！", "在角色位置造成1次大爆炸#造成185伤害"}, -- Kamikaze!
	[42] = {"42", "鲍勃的烂头", "{{Poison}} 可投掷的有毒炸弹#造成185+角色伤害#产生毒气"}, -- Bob's Rotten Head
	...
	[52] = {"52", "胎儿博士", "{{Bomb}} 炸弹眼泪#{{Damage}} 每个炸弹造成10倍角色伤害#{{Damage}} 如果结果超过60伤害，以5倍角色伤害+30取代#↓ {{Tears}} -60%射速修正"}, --Dr. Fetus
	...
	[77] = {"77", "彩虹独角兽", "无敌6秒#↑ +0.28移速#每秒造成2次20接触伤害"}, -- My Little Unicorn
	...
	[83] = {"83", "钉子", "{{HalfBlackHeart}} +半黑心#在当前房间获得：#↑ {{Damage}} +2.0伤害#↓ {{Speed}} -0.18移速#造成每秒1次40接触伤害#粉碎经过的岩石"}, -- The Nail
	[84] = {"84", "我们需要深入挖掘！", "生成1个跳过所在层的活板门#{{LadderRoom}} 在有装饰(草、碎石、骷颅头等)的地板上使用则改为生成一个暗门"}, -- We Need To Go Deeper!
	[87] = {"87", "洛基的角", "25%几率向4个方向发射眼泪#{{Luck}} 运气15：100%几率"}, -- Loki's Horns
	[91] = {"91", "探窟帽", "揭示相邻房间的类型#{{SecretRoom}} 也可以揭示隐藏房，超级隐藏房和小Boss房#阻挡上方弹幕的伤害"}, -- Spelunker Hat
	[98] = {"98", "圣遗物", "{{SoulHeart}} 每7-8个房间生成1魂心"}, -- The Relic
	[101] = {"101", "光环", "↑ +1心之容器#↑ {{Damage}} +0.3伤害#↑ {{Tears}} +0.2射速#↑ {{Range}}} +0.38射程#↑ {{Speed}} +0.3移速#{{Heart}} 治疗1红心"}, -- The Halo
	[106] = {"106", "大爆弹先生", "{{Bomb}} +5炸弹#↑ 炸弹伤害x1.85"}, -- Mr. Mega
	[110] = {"110", "老妈的美瞳", "20%几率发射石化眼泪#↑ {{Range}} +0.38射程"}, -- Mom's Contacts
	[118] = {"118", "硫磺火", "{{Chargeable}} 蓄力发射持续造成伤害的鲜血激光#{{Damage}} 每次发射共造成9次100%角色伤害#↓ {{Tears}} -67%射速修正"},
	...
	[139] = {"139", "老妈的钱包", "{{Trinket}} 可以持有2个饰品#{{Trinket}} 生成1个随机饰品"}, -- Mom's Purse
	[140] = {"140", "鲍勃的诅咒", "有毒炸弹#+5炸弹#炸弹会留下毒气#角色免疫中毒伤害"}, -- Bob's Curse
	[142] = {"142", "肩衣", "{{SoulHeart}} 当受伤降至半心时，获得1魂心#(每房间一次)#!!! 被视作献血的伤害(如{{BloodDonationMachine}}，{{Collectible126}}，{{Collectible1205}})不会触发效果#{{SacrificeRoom}} 献祭房中献祭可以触发效果"}, --Scapular
	[147] = {"147", "残损铁镐", "打碎所在房间接触到的岩石并对敌人造成伤害#攻击则降低1格充能#换层时再次充能"}, -- Notched Axe
	[148] = {"148", "害虫横行", "受伤时生成2-6只蓝苍蝇"}, -- Infestation
	[149] = {"149", "吐根酊", "{{Poison}} 爆炸有毒眼泪#↑ {{Damage}} +40伤害#↓ {{Shotspeed}} -0.2弹速#↓ {{Tears}} -67%射速修正#↓ {{Range}} 射程小幅降低"}, -- Ipecac
	...
	[158] = {"158", "水晶球", "揭示全图#掉落随机卡牌，魂心或符文#持有时：#{{PlanetariumChance}} +15%星象房几率#{{PlanetariumChance}} 如果跳过{{TreasureRoom}}道具房则为100%"}, -- Crystal Ball
	...
	[182] = {"182", "圣心", "↑ {{Damage}} x230%伤害修正#↑ {{Damage}} +1额外伤害#↑ +1心之容器#{{Heart}} 满血#↓ {{Tears}} -0.4射速#↓ {{Shotspeed}} -0.25弹速#跟踪眼泪"}, -- Sacred Heart
	...
	[229] = {"229", "萌死戳的肺", "{{Chargeable}} 蓄力且霰弹式发射眼泪#↓ -77%射速修正"}, -- Placenta
	...
	[256] = {"256", "炙热炸弹", "{{Burning}} 燃烧炸弹#{{Bomb}} +5炸弹###角色不再受到火焰伤害#炸弹造成接触伤害"}, -- Hot Bombs
	[261] = {"261", "眼球突出", "↑ {{Damage}} +0.5伤害#↓ 眼泪走得越远伤害越低#近距离伤害为3倍，最大距离无伤害"}, -- Proptosis
	[262] = {"262", "遗失的书页2", "{{BlackHeart}} +1黑心#当降至1心时，对房间内所有敌人造成80伤害#黑心和{{Collectible35}}死灵书伤害翻倍"}, -- Missing Page 2
	[263] = {"263", "透明符文", "{{Rune}} 复制持有符文或魂石的效果#{{Rune}} 掉落1随机符文"}, -- Clear Rune   (REPENTANCE ITEM)
	[273] = {"273", "鲍勃的脑浆子", "{{Throwable}} {{ColorOrange}}可投掷{{CR}}的炸弹跟班#爆炸造成100伤害#伤害无视护甲"}, -- Bob's Brain
	[274] = {"274", "最棒的伙伴", "受伤时获得1个中范围环绕物#环绕物每秒造成150接触伤害"}, -- Best Bud
	[275] = {"275", "硫磺火宝宝", "{{Collectible118}} 发射硫磺火的跟班#激光总共造成20伤害"}, -- Lil Brimston
	...
	[292] = {"292", "撒但圣经", "{{BlackHeart}} +1黑心#{{DevilRoom}} 在Boss战前使用则Boss房道具会变成恶魔交易#!!! 交易道具则会锁定在本局只能进行恶魔交易"}, -- Satanic Bible
	[294] = {"294", "棉豆", "击退附近的敌人和弹幕#将敌人击退到障碍物上会造成10伤害"}, -- Butter Bean
	[295] = {"295", "魔术手指", "{{Damage}} 对房间内所有敌人造成角色伤害x2+10的伤害#{{Coin}} 价格：1硬币"}, -- Magic Fingers
	...
	[311] = {"311", "犹大之影", "{{Player12}} 死后以黑暗犹大重生#{{Damage}} 犹大之影伤害修正x2#{{Player24}} 堕化犹大复活为其自身"}
	...
	[320] = {"320", "???唯一的朋友", "可控制的苍蝇#造成每秒4.3次3.5接触伤害"}, -- ???'s Only Friend
	...
	[331] = {"331", "神性", "↑ {{Damage}} +0.5伤害#↓ {{Tears}} -0.3射速#↓ {{Shotspeed}} -0.3弹速#眼泪具有伤害光环，每帧(每秒30次)造成2伤害#跟踪眼泪"}, -- Godhead
	[336] = {"336", "烂洋葱", "穿透幽灵眼泪#↓ {{Range}} -1.5射程#↓ {{Shotspeed}} -0.4弹速#↑ +50%眼泪大小"}, -- Dead Onion
	[339] = {"339", "安全别针", "↑ {{Range}} +1.5射程#↑ {{Shotspeed}} +0.16弹速#{{BlackHeart}} +1黑心"}, -- Safety Pin
	...
	[354] = {"354", "琥珀爆米花", "↑ +1心之容器#{{Trinket}} 在地上生成随机饰品#{{Heart}} 治疗1红心"}, -- Crack Jacks
	[355] = {"355", "老妈的珍珠项链", "↑ {{Range}} +0.38射程#↑ {{Luck}} +1运气#{{SoulHeart}} +1魂心"}, -- Mom's Pearls
	[360] = {"360", "淫魔", "获得与角色眼泪效果一致的恶魔跟班#{{Damage}} 造成75%角色伤害#{{Player13}} 人物为莉莉丝则造成100%角色伤害"}, -- Incubus
	[365] = {"365", "迷路苍蝇", "沿着房间内的墙/障碍物走#每秒造成56接触伤害#吸引周围敌人以迷路苍蝇为目标"}, -- Scatter Bombs
	...
	[370] = {"370", "玩偶先生", "↑ {{Tears}} +0.7射速#↑ {{Range}} +1.5射程#{{UnknownHeart}} 捡起时生成3随机心"}, -- Mr. Dolly
	[374] = {"374", "圣光", "10%几率发射圣光眼泪，击中时会产生光柱#{{Damage}} 光柱造成3x角色伤害#{{Luck}} 运气9：50%几率"}, -- Holy Light
	[375] = {"375", "寄居骷髅帽", "获得爆炸免疫#阻挡上方弹幕的伤害#20%几率阻挡弹幕"}, -- Host hat
	[376] = {"376", "补货", "商店物品购买后会立刻补货#补充的物品价格缓慢提高"}, -- Restock
	[380] = {"380", "充钱游戏", "{{Coin}} +5硬币#使用硬币而非钥匙打开门和金箱子"}, -- Restock
	[382] = {"382", "友好球", "可以扔向敌人将其捕捉#下一次使用则会生成相同的友好敌人#靠近捕捉后的球会立即将道具充能"}, -- Friendly Ball
	[384] = {"384", "小肉山", "{{Chargeable}} 会蓄力发射并在房间内滑动#每次撞击造成5-20接触伤害，与蓄力时间有关"}, -- Lil Gurdy
	[389] = {"389", "符文袋", "{{Rune}} 每7-8个房间掉落1个随机符文或魂石"}, -- Rune Bag
	...
	[395] = {"395", "科技X", "{{Chargeable}} 能够蓄力并发射穿过整个房间的激光环#蓄力越久则及光环越大，伤害越高#{{Damage}} 激光环对接触的敌人造成每秒15次伤害 #{{Damage}} 完全蓄力伤害为100%"}, -- Tech X
	[397] = {"397", "牵引光束", "角色的眼泪现在受光束指引，与角色一起移动#↑ {{Tears}} +0.5射速#↑ {{Range}} +1.5射程#↑ {{Shotspeed}} +0.16弹速"}, -- Tractor Beam
	[399] = {"399", "虚空之喉", "{{Chargeable}} 射击2.35秒后，角色头上会出现红交叉。释放攻击键会产生1圈黑硫磺火环#{{Damage}} 火环共造成30次100%角色伤害"}, -- Maw of the Void
	[401] = {"401", "爆炸物", "25%几率发射粘性炸弹眼泪#几秒后爆炸并造成角色伤害+60的伤害#{{Luck}} 不受运气影响"}, -- Explosivo
	...
	[415] = {"415", "光明之冠", "{{SoulHeart}} +2魂心#如果没有不满的心之容器：#↑ {{Damage}} +100%伤害倍率#↑ {{Range}} +1.5射程#↓ {{Shotspeed}} -0.3弹速#受伤后，当前房间无论心之容器是否是满的，效果消失"}, -- Crown Of Light
	[416] = {"416", "深口袋", "{{Coin}} 如果房间没有奖励，生成1-3硬币#{{Coin}} 提高硬币上限为999"}, -- Deep Pockets
	[417] = {"417", "魅魔", "在房间内漂浮的跟班，产生伤害光环，每秒造成7-10的伤害#↑ {{Damage}} 站在光环中+50%伤害倍率"}, -- Succubus
	...
	[421] = {"421", "腰豆", "{{Charm}} 使用时将任何范围内的敌人魅惑"}, -- Kidney Bean
	...
	[432] = {"432", "闪光炸弹", "{{Bomb}} +5炸弹#{{Charm}} 炸弹爆炸有15%几率魅惑敌人#炸弹爆炸有63%几率掉落随机掉落物#闪光炸弹每生成一个掉落物，在本层中生成掉落物的几率减少1%"}, -- Multidimensional Baby
	...
	[448] = {"448", "玻璃碎片", "受减红心的伤时：#在角色周围喷洒眼泪#攻击时控制喷出眼泪的方向#每20秒受到半红心伤害#直到捡到红心或无红心效果终止#不致死#{{Heart}} 受伤时有25%几率掉落1红心"}, -- Shard of Glass
	[451] = {"451", "塔罗牌桌布", "{{Card}} 掉落1个随机卡牌或符文#{{Card}} 某些卡牌有额外或双倍效果"}, -- Tarot Cloth
	...
	[459] = {"459", "鼻窦炎", "20%几率发射粘性有毒眼泪#{{Luck}} 不受运气影响#每秒造成角色伤害#能粘住10秒"}, -- Sinus Infection
	...
	[487] = {"487", "土豆削皮刀", "使用时移除1个心之容器#↑ {{Damage}} 使用时+0.2伤害并获得{{Collectible73}}肉块#在但钱房间触发{{Collectible214}}贫血的效果"}, -- Void
	[489] = {"489", "无限面骰", "可作为任何骰子，{{Collectible723}}计数二十面骰除外#按{{ButtonRT}}丢弃键改变当前骰子#根据骰子改变充能，且使用时更新"}, -- D Infinity
	[491] = {"491", "毒瘾宝宝", "{{Pill}} 每7个房间掉落1随机胶囊#{{Poison}} 使用胶囊会使房间内所有敌人中毒"}, -- Acid Baby
	...
	[496] = {"496", "安乐死", "3.33%发射针#{{Luck}} 运气15：25%几率#针会立即杀死一般敌人，并爆出10发眼泪#{{Damage}} 针击中Boss造成300%角色伤害"}, -- Euthanasia
	[501] = {"501", "贪婪的胃袋", "拾取后，每获得25硬币增加1心之容器#最多硬币达到99，+4心之容器#{{Player14}} 店主也会增加额外的硬币心#{{Collectible416}} 超过99后每100硬币增加1心之容器"}, -- Greed's Gullet
	[503] = {"503", "小魔角", "5%几率发射能召唤巨角恶魔的手的眼泪#{{Luck}} 运气12：20%#手会立即杀死敌人或对Boss造成伤害#手冲向敌人造成3次12接触伤害"}, -- Little Horn
	...
	[509] = {"509", "血丝眼", "当附近有敌人时，每0.33秒发射一颗眼泪的环绕物#每次射击造成3.5伤害#每秒造成30接触伤害"}, -- Bloodshot Eye
	...
	[543] = {"543", "圣地大便", "受伤时生成白便便#在白便便的光环中：#↑ {{Damage}} +20%伤害倍率#↑ x250%射速修正#跟踪眼泪#50%几率阻挡伤害"}, -- Hallowed Ground
	[549] =	{"549", "成骨不全症", "{{EmptyBoneHeart}} 以6骨心替换所有心之容器#失去骨心时：#向8个方向发射骨头眼泪#↑ {{Tears}} 永久+0.4射速修正"}, -- Brittle Bones
	[552] =	{"552", "老妈的铲子", "生成通往下一层的活板门#{{LadderRoom}} 在有装饰(草、碎石、骷颅头等)的地板上使用则改为生成一个暗门#!!! 在\"暗室\"的土丘上使用铲子#!!! 解锁某个很酷的东西"}, -- Brittle Bones
	...
	[555] = {"555", "金剃刀片", "将5硬币转换成+1.2伤害，所在房间内有效#{{Coin}} 生成5硬币"}, --  Golden Razor
	...
	[579] = {"579", "英灵剑", "攻击方式改为挥剑#{{Damage}} 造成300%角色伤害#{{Chargeable}} 可蓄力发动旋转攻击，同时发射剑形子弹#红心全满时，挥剑即可发射剑气"}, --  Spirit Sword
	[580] = {"580", "红钥匙", "在合适的墙壁上生成新房间的入口，可生成时墙壁上显示红色的门轮廓#产生的房间可以是特殊房间#{{ErrorRoom}} 在13x13的地图范围外产生的房间，进入时将直接传送到错误房"}, --  Red Key
	...
	[585] = {"585", "白玉香膏盒", "使用时生成：#{{SoulHeart}} 3魂心#{{AngelRoom}} 2个天使房道具#只能通过捡起魂心充能#{{DevilRoom}} 若已进行过恶魔交易，则生成2魂心和1个天使房道具"}, --  Alabaster Box
	[586] = {"586", "天堂阶梯", "{{AngelRoom}} 在每一层的初始房间生成梯子，通向1个特殊的天使房道具商店"}, --  The Stairway
	[587] = {"587", "", "<道具不存在>"}, -- Menorah (Unused but skripted)
	[588] = {"588", "太阳", "揭示{{BossRoom}}Boss房位置#击败Boss后在所在层获得：#{{Card20}} 激发卡牌“太阳”的效果#{{Battery}} 为主动道具充能#{{CurseBlind}} 移除诅咒#↑ {{Damage}} +3.0伤害#↑ {{Luck}} +1运气"}, --  Sol
	...
	[593] = {"593", "火星", "双击移动方向键进行冲锋#冲锋时无敌，造成400%角色伤害#3秒冷却时间"}, --  Mars
	...
	[599] = {"599", "巫毒娃娃头", "{{CursedRoom}} 每层额外生成1个诅咒房#{{CursedRoom}} 升级诅咒房的布局"}, --  Voodoo Head
	...
	[643] = {"643", "终末天启", "连续发射眼泪2.35秒可蓄力发射神圣光柱#{{Damage}} 光柱造成15次100%角色伤害#获得飞行能力#{{SoulHeart}} +2魂心"}, --  Revelation
	[644] = {"644", "安慰奖", "↑ 提升最低的属性#根据持有数量最少的掉落物，生成{{Coin}}3硬币，{{Key}}1钥匙或{{Bomb}}1炸弹"}, --  Consolation Prize
	...
	[659] = {"659", "托吡卡胺", "↑ {{Range}} +1.5射程#↑ {{Tearsize}} 眼泪变大"}, --  Tropicamide
	...
	[666] = {"666", "", "<道具不存在>"},
	[667] = {"667", "稻草人", "{{Bomb}} +1炸弹#{{Player14}} 生成店主作为第二个角色#店主死亡时生成蓝蜘蛛#店主死亡时该道具消失#{{DevilRoom}} 店主活着时恶魔交易花费硬币#!!! 店主能够捡起道具，包括剧情道具，死亡时也会永久移除"}, --  Strawman
	[668] = {"668", "老爸的便条", "踏上回家的路#留在之前{{TreasureRoom}}道具房或{{BossRoom}}Boss房的饰品会变成 {{Card78}} 破裂的钥匙"}, --  Dad's Note
	[669] = {"669", "腊肠", "↑ +1心之容器#{{Heart}} 满血#↑ {{Damage}} +0.5伤害#↑ {{Speed}} +0.2移速#↑ {{Shotspeed}} +1.2弹速#↑ {{Range}} +0.16射程#↑ {{Luck}} +1运气#{{AngelDevilChance}} +6.9%恶魔房/天使房几率#{{Planetarium}} +6.9%星象房几率"}, --  Sausage
	[670] = {"670", "选择？", "如果清理的房间有奖励，产生2种不同的奖励#捡起其一后另1个奖励消失"}, --  Options?
	[671] = {"671", "糖心", "捡起红心时获得永久的属性提升#{{Heart}} 生成1红心"}, --  Candy Heart
	[672] = {"672", "一磅肉", "{{DevilRoom}} 恶魔交易消耗硬币#{{Shop}} 商店里的道具消耗心之容器#{{Shop}} 商店里的其它物品免费，但被尖刺环绕"}, --  A Pound of Flesh
	[673] = {"673", "赎罪", "{{DevilRoom}} 进入恶魔房间但不捡任何物品时，于下一层获得：#{{SoulHeart}} +1魂心#↑  {{Damage}} +1.0伤害"}, --  Redemption
	...
	[678] = {"678", "剖腹产", "{{Chargeable}} 获得短延迟蓄力攻击，发射婴儿样式的跟踪幽灵眼泪#{{Damage}} 胎儿造成每秒5次100%角色伤害"}, --  C Section
	...
	[692] = {"692", "血色羁绊", "在恶魔房间内生成地刺#在地刺上献祭，可以获得以下奖励：#35%：无#33%：↑ {{Damage}}+0.5伤害#15%：{{Coin}}6硬币#10%：{{BlackHeart}}2黑心#5%：{{DevilRoom}}随机恶魔房道具#2%：变形为利维坦"}, --  Sanguine Bond
	[693] = {"693", "虫群", "获得8只环绕苍蝇，苍蝇被击中时变为蓝色苍蝇#每清理1个房间，生成1只环绕苍蝇"}, --  The Swarm
	[694] = {"694", "心碎", "{{BrokenHeart}} 获得3碎心#↑ {{Damage}} 每个碎心+0.25伤害#受致命伤害时增加2碎心#碎心达到 12个时死亡"}, --  Heartbreak
	...
	[701] = {"701", "以撒的坟墓", "在每层开始时生成1个需要钥匙解锁{{DirtyChest}}老箱子#老箱子含有魂心，饰品或道具#道具为{{AngelRoom}}天使房道具或老爸，老妈相关的道具"}, --  Isaac's Tomb
	...
	[724] = {"724", "高凝血", "{{Heart}} 受伤时掉落半或整红心#产生的红心在1.5秒后消失"}, --  Hypercoagulation
	...
	[732] = {"732", "老妈的戒指", "↑ {{Damage}} +1.0伤害#{{Rune}} 生成1随机符文或魂石"}, --  Mom's Ring
