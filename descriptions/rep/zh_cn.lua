...
local repCollectibles={
	...
	[12] = {"12", "魔法蘑菇", "↑ {{Heart}} +1心之容器#↑ {{Speed}} 移速+0.3#↑ {{Damage}} 伤害+0.3#↑ {{Damage}} 伤害修正x1.5#↑ {{Range}} 射程+2.5#↑ 泪弹高度+0.5#体型变大#{{HealingRed}} 回满血"}, -- Magic Mushroom
	...
	[107] = {"107", "锯齿剪", "{{Timer}} 在当前房间中获得:#飞行#角色的身体与头分离, 每秒造成23.5点接触伤害"},
	...
	[158] = {"158", "水晶球", "生成1{{SoulHeart}}魂心/{{Rune}}符文/{{Card}}卡牌#{{Timer}} 揭示全图({{SuperSecretRoom}}超级隐藏房除外)#持有时:#{{PlanetariumChance}} 星象房几率+15%#{{PlanetariumChance}} 若有跳过{{TreasureRoom}}道具房则改为100%"}, -- Crystal Ball
	...
	[280] = {"280", "长腿蛛妹妹", "在有敌人的房间里随机生成蓝蜘蛛, 最多5只#{{Charm}} 魅惑接触的敌人"}, -- Sissy Longlegs
	[283] = {"283", "一百面骰", "复制人房间中的1掉落物#重置角色的移速, 射速, 伤害, 射程和被动道具#重置房间中的所有底座道具, 掉落物和石头#重新开始当前房间, 重生所有敌人并降级"}, -- D100
	[285] = {"285", "十面骰", "使房间内所有敌人降级#例如, 所有红苍蝇变成黑苍蝇"}, -- D10
	...
	-- ↑ Checking finished
	-- ↓ Checking later
	[307] = {"307", "摩羯座", "↑ {{Heart}} +1心之容器#↑ {{Damage}} +0.5伤害#↑ {{Speed}} +0.1移速#↑ {{Range}} +0.75射程#↑ {{Tears}} +0.5射速修正#给予1炸弹，硬币和钥匙"}, -- Capricorn
	...
	[314] = {"314", "霹雳大腿", "↑ {{Heart}} +1心之容器#↓ {{Speed}} -0.4移速#{{Heart}} 治疗1红心#摧毁走过的石头"}, -- Thunder Thighs
	...
	[325] = {"325", "剪刀", "{{Timer}} 当前房间内剪下角色的头#头会留在原地进行射击#只控制角色身体#身体随机抛射眼泪"},
	...
	[342] = {"342", "蓝盖蘑菇", "↑ {{Heart}} +1心之容器#↑ {{Tears}} +0.7射速#↓ {{Shotspeed}} -0.16弹速#{{Heart}} 治疗1红心"}, -- Blue Cap
	[344] = {"344", "火柴盒", "+1黑心#生成2-3炸弹和{{Trinket41}}火柴棒"}, -- Match Book
	[345] = {"345", "合成油脂", "↑ {{Damage}} +1.0伤害#↑ {{Range}} +2.5射程"}, -- Synthoil
	[346] = {"346", "零食", "↑ {{Heart}} +1心之容器#{{Heart}} 治疗1红心"}, -- A Snack
	...
	[354] = {"354", "琥珀爆米花", "↑ {{Heart}} +1心之容器#在地上生成随机饰品#{{Heart}} 治疗1红心"}, -- Crack Jacks
	...
	[433] = {"433", "我的影子", "紧跟着角色的影子#{{Timer}} 当敌人接触到影子时，在当前房间不断生成友好的黑蛆# 黑蛆每秒造成8.7点伤害"},
	...
	[456] = {"456", "夜宵", "↑ {{Heart}} +1心之容器#{{Heart}} 治疗1红心"}, -- Midnight Snack
	...
	[487] = {"487", "土豆削皮刀", "使用时移除1个心之容器#↑ {{Damage}} 使用时+0.2伤害并获得{{Collectible73}}肉块#{{Timer}} 在当前房间触发{{Collectible214}}贫血的效果"},
	...
	[555] = {"555", "金剃刀片", "{{Timer}} 将5硬币转换成+1.2伤害，当前房间有效#{{Coin}} +5硬币"}, --  Golden Razor
	[556] = {"556", "炼金硫磺", "{{Timer}} {{Collectible118}} 所在房间获得硫磺火"}, --  Sulfur
	...
	[560] = {"560", "好疼", "受伤时向四周发射10颗造成10点伤害的眼泪#{{Timer}} 受伤时于当前房间获得：#↑ {{Tears}} 第一次受伤时+1.2射速修正#↑ {{Tears}} 后续受伤+0.4射速"}, --  It Hurts
	...
	[565] = {"565", "嗜血小宠", "会追逐敌人的跟班#击杀15个敌人后，会造成更多伤害，每击杀10个敌人掉落半红心，但也会尝试对角色造成伤害#击杀40个敌人后，会造成更多伤害，掉落整红心，可以摧毁石头#被角色攻击时恢复正常"}, --  Blood Puppy
	...
	[573] = {"573", "无瑕圣心", "↑ {{Heart}} +1心之容器#{{Heart}} 满血#↑ {{Damage}} +20%伤害倍率#几率发射环绕自己的幽灵眼泪"}, --  Immaculate Heart
	...
	[588] = {"588", "太阳", "揭示{{BossRoom}}Boss房位置#{{Timer}} 击败Boss后在所在层获得：# 激发{{Card20}}“太阳”的效果#{{Battery}} 为主动道具充能#{{CurseBlind}} 移除诅咒#↑ {{Damage}} +3.0伤害#↑ {{Luck}} +1运气"}, --  Sol
	[589] = {"589", "月亮", "为每一层增加1个{{SecretRoom}}隐藏房和{{SuperSecretRoom}}超级隐藏房#每层揭示1个{{SecretRoom}}隐藏房#{{Timer}} 隐藏房内有光束，接触时于当前层获得：#{{HalfSoulHeart}} 半个魂心#↑ {{Tears}} +0.5射速修正 #↑ {{Tears}} 每层第一次接触月光额外获得+0.5射速修正"}, --  Luna
	[590] = {"590", "水星", "↑ {{Speed}} +0.4移速#进入房间后门不会关闭"}, --  Mercurius
	[591] = {"591", "金星", "↑ {{Heart}} +1心之容器#{{Heart}} 治疗1红心#{{Charm}} 近距离内的敌人受到魅惑"}, --  Venus
	[592] = {"592", "地球", "↑ {{Damage}} +1.0伤害#眼泪变为石头#每颗伤害不定#可摧毁障碍物#击退增强"}, --  Terra
	[593] = {"593", "火星", "双击移动方向键进行冲锋#{{Damage}} 冲锋时无敌，造成400%角色伤害#{{Timer}} 3秒冷却时间"}, --  Mars
	...
	[604] = {"604", "妈妈的手镯", "可以捡起石头，TNT，便便，友好粪滴，寄居骷髅等障碍物进行投掷#捡起的东西可以带入下1个房间"}, --  Mom's Bracelet
	[605] = {"605", "挖眼勺", "{{Timer}} 在当前房间召唤1个眼球跟班，每秒造成36点伤害并在地上生成血迹#↑ {{Damage}} 右眼眼泪伤害+34%"}, --  The Scooper
	...
	[610] = {"610", "鸟肥笼", "在被击中时跃向敌人的跟班#造成45点伤害并释放石头波#之后追逐敌人造成伤害"}, --  Bird Cage
	[611] = {"611", "声带", "使用时发出怒吼，击退周围的敌人，并造成伤害#充能越多，效果越强"}, --  Larynx
	[612] = {"612", "迷失游魂", "幽灵跟班，被击中时死亡，下一层才能复活#如果存活了整层，则生成3魂心，或2永恒之心，或道具"}, --  Lost Soul
	[613] = {"613", "", "<道具不存在>"},
	[614] = {"614", "鲜血炸弹", "↑ {{Heart}} +1心之容器#{{Heart}} 治疗5红心#炸弹爆炸时产生血迹#没有炸弹时也可放置炸弹，消耗半红心"}, --  Blood Bombs
	...
	[622] = {"622", "创世记", "{{Warning}} 一次性 {{Warning}}#移除持有的全部道具和掉落物#传送到特殊的卧室，内有掉落物，箱子和暗门#每移除1个道具，就显示1组3个道具供你选择"}, --  Genesis
	[623] = {"623", "尖头钥匙", "{{Key}} +5钥匙#使用时发射1钥匙，可造成伤害，摧毁障碍物，打开箱子或门#被其杀死的敌人有几率掉落箱子里的内容，包括道具"}, --  Sharp Key
	[624] = {"624", "扩展包", "{{Card}} 生成5张随机卡牌"}, --  Booster Pack
	[625] = {"625", "超级蘑菇", "{{Timer}} 巨化并获得：# x4伤害修正 持续30秒#提升伤害和射程#持续时间内无敌，能踩碎障碍物和敌人#效果可在多个房间内持续"}, --  Mega Mush
	...
	[630] = {"630", "", "<道具不存在>"},
	[631] = {"631", "切肉刀", "使敌人分裂为2个小型的，其血量降至原先的40%#对无法分裂的敌人造成25点伤害"}, --  Meat Cleaver
	...
	[650] = {"650", "糖梅溜溜笛", "{{Timer}} 使用时，在所在房间召唤1只甜蝇宝宝，持续10秒"}, --  Plum Flute
	...
	[664] = {"664", "大胃王", "↑ {{Heart}} +1心之容器#{{Heart}} 满血#所有道具会周期性地切换为食物道具#捡起食物道具时获得：#↑ {{Damage}} 临时+3.6伤害#↑ 永久提升2项属性#↓ {{Speed}} 永久-0.03移速#{{Heart}} 食物道具治疗3红心"}, --  Binge Eater
	...
	[669] = {"669", "腊肠", "↑ {{Heart}} +1心之容器#{{Heart}} 满血#↑ {{Damage}} +0.5伤害#↑ {{Speed}} +0.2移速#↑ {{Range}} +2.5射程#↑ {{Shotspeed}} +0.16弹速#↑ {{Luck}} +1运气#{{AngelDevilChance}} +6.9%恶魔房/天使房几率#{{Planetarium}} +6.9%星象房几率"}, --  Sausage
	...
	[677] = {"677", "灵魂出窍", "{{Timer}} 受伤时，暂停时间3秒#此时间内变为幽灵#幽灵具有飞行和幽灵眼泪，且免疫一次伤害"}, --  Astral Projection
	...
	[704] = {"704", "狂怒！", "{{Timer}} 使用时进入狂暴状态5秒：#↑ {{Speed}} +0.4移速#↑ {{Tears}} x50%+2.0射速修正#↑ {{Damage}} +3.0伤害#只能使用特定近战武器#{{Timer}} 狂怒状态下击杀敌人可延长此状态持续时间1秒"}, --  Berserk!
	[705] = {"705", "暗仪刺刀", "{{Timer}} 使用时在1秒内：#+1.0移速，可穿过敌人和弹幕#对每个接触的敌人造成角色3.5+200%角色伤害，每经过1个敌人再+3.5#效果结束时的爆炸伤害等于之前伤害的总和"}, --  Dark Arts
	[706] = {"706", "无底坑", "摧毁房间内所有道具，每摧毁1个，生成一只攻击型苍蝇跟班#苍蝇具有的效果与摧毁的道具有关"}, --  Abyss
	[707] = {"707", "晚餐", "↑ {{Heart}} +1心之容器#{{Heart}} 治疗1红心"}, --  Supper
	[708] = {"708", "订书机", "↑ {{Damage}} +1.0伤害#眼泪只从一只眼睛发射"}, --  Stapler
	[709] = {"709", "背摔！", "使用时冲向敌人或Boss，将其举起，再掷向地面#可控制投掷地点#投掷造成50伤害，并产生石头波#伤害和影响范围与角色大小成比例"}, --  Suplex!
	...
	[712] = {"712", "所罗门魔典", "生成1个被动道具魂火跟班#获得该被动道具的效果#生成道具有25%几率为本房间道具池内的道具"}, --  Lemegeton
	[713] = {"713", "圣血吸管", "移除半心并创造1个血凝块跟班#不同心产生的血凝块的血量，伤害和眼泪效果不同"}, --  Sumptorium
	...
	[717] = {"717", "店主的亲友", "石头和障碍物在被摧毁时生成2只蓝蜘蛛#石头在有敌人的房间中偶尔会产生蓝蜘蛛"}, --  Keeper's Kin
...
EID.descriptions[languageCode].bookOfVirtuesWisps = {
	...
	[147] = "摧毁石头时几率生成5选1魂火#几率发射煤炭，迷惑，硬币，双倍伤害或激光眼泪", -- Notched Axe
	...
	[351] = "使用时所有此类魂火产生石头波#摧毁时石化敌人并产生毒气", -- Mega Bean
...
local repCarBattery = {
	...
	[582] = "触发两次", -- Wavy Cap
	[584] = {1, 2}, -- Book of Virtues
	[605] = {1, 2}, -- The Scooper
	[609] = "重置道具两次，消失几率提升至44%", -- Eternal D6
	[611] = "额外触发一次一充能怒吼", -- Larynx
	[625] = {30, 60}, -- Mega Mush
	[635] = "快速交换两次#无法再通过其获取拿不到的物品", -- Stitches
	[639] = {1, 2}, -- Yuck Heart
	[642] = "触发两次", -- Magic Skin
	[650] = {1, 2}, -- Plum Flute
	...
	[705] = {1, 2}, -- Dark Arts
	[712] = {1, 2}, -- Lemegeton
	[713] = {"半心", "一整颗心", 1, 2}, -- Sumptorium
	[719] = {1, 2}, -- Keeper's Box
	[720] = "额外生成一个便便", -- Everything Jar
	[722] = "禁锢2名敌人；如果只有1名敌人，将其禁锢10秒#再次使用会释放最近的被禁锢的敌人", -- Anima Sola
...
local repTrinkets={
	...
	[15] = {"15", "幸运石", "{{Coin}} 摧毁石头有33%几率掉落硬币"},-- Lucky Rock
...
local repCards={
	[2] = {"2", "I-魔术师", "{{Timer}} 当前房间获得：#跟踪泪弹#↑ {{Range}} +3.0射程"}, -- I - The Magician
	[12] = {"12", "XI-力量", "{{Timer}} 当前房间获得：#↑ {{Heart}} +1心之容器#↑ {{Damage}} +0.3伤害#↑ {{Damage}} +50%伤害倍率#↑ {{Range}} +2.5射程#↑ {{Speed}} +0.3移速"}, -- XI - Strength
	...
	[39] = {"39", "保护符文", "{{Timer}} 无敌20秒"}, -- Algiz
	[51] = {"51", "神圣卡", "{{HolyMantle}} 获得神圣斗篷效果#(即免疫一次伤害)#受到伤害前始终有效"}, -- Holy Card
	[52] = {"52", "变巨术", "{{Timer}} 当前房间获得：↑ {{Damage}} +7.0额外伤害#↑ {{Range}} +3.0射程#粉碎经过的石头#体型变大"}, -- Huge Growth
	...
	[57] = {"57", "I-魔术师？", "{{Timer}} 1分钟内获得：#生成较大的光环，排斥弹幕和敌人"}, -- I - The Magician?
	[58] = {"58", "II-女祭司？", "{{Timer}} 妈腿持续践踏1分钟"}, -- II - The High Priestess?
	[59] = {"59", "III-皇后？", "{{Timer}} 获得以下效果，持续1分钟：#↓ {{Speed}} 移速-0.1#↑ {{Tears}} 射速修正+1.5#抹大拉的发型#↑ +2心之容器"}, -- III - The Empress?
	...
	[63] = {"63", "VII-战车？", "{{Timer}} 变成无敌的固定雕像10秒#↑ {{Tears}} 期间获得x400%射速修正"}, -- VII - The Chariot?
	...
	[67] = {"67", "XI-力量？", "{{Timer}} 30秒内获得：#{{Weakness}} 使当前房间内的敌人虚弱，减速并受到双倍伤害"}, -- XI - Strength?
	[68] = {"68", "XII-倒吊人？", "{{Timer}} 30秒内获得：#{{Player14}} 将角色变为店主#获得三重射击并降低移速#杀死敌人掉落随机硬币"}, -- XII - The Hanged Man?
	[69] = {"69", "XIII-死亡？", "产生{{Collectible545}}亡者之书的效果#(所在房间内每杀死1个敌人生成1个骨头实体)"}, -- XIII - Death?
	[70] = {"70", "XIV-节制？", "{{Pill}} 吃下5个随机胶囊"}, -- XIV - Temperance?
	[71] = {"71", "XV-恶魔？", "#{{Timer}} 30秒内获得#产生{{Collectible33}}圣经的效果#获得{{Collectible390}}撒拉弗"}, -- XV - The Devil?
	...
	[75] = {"75", "XIX-太阳？", "{{Timer}} 所在层获得以下效果：#将红心转化为骨心，效果结束后恢复#↑ {{Damage}} +1.5伤害#获得{{Collectible159}}夜之幽魂#!!! {{CurseDarkness}} 施加无法被移除的黑暗诅咒"}, -- XIX - The Sun?
	...
	[82] = {"82", "抹大拉的魂石", "{{Timer}} 所在房间内获得：#角色被冒泡的红色光环围绕#被杀死的敌人掉落半红心，但2秒后消失"}, -- Soul of Magdalene
	...
	[86] = {"86", "夏娃的魂石", "14只{{Collectible117}}死鸟跟班飞入并攻击敌人#{{Timer}} 所在房间有效"}, -- Soul of Eve
	[87] = {"87", "参孙的魂石", "{{Timer}} 变成狂暴参孙，在10秒内使用近战攻击并获得：#↑ {{Speed}} +0.4移速#↑ {{Tears}} x50%+2.0射速修正#↑ {{Damage}} +3.0伤害"}, -- Soul of Samson
...
local repCharacterInfo = {
	[4] = {"???", "无法拥有红心#恶魔交易如果需要1或2颗红心，则改为消耗1或2颗魂心#摧毁粪便会生成1只蓝苍蝇"},
	[8] = {"拉撒路", "每层一次，当你死亡时：#以复活的拉撒路复活#失去1个红心容器#↑ {{Damage}} +0.5伤害"},
	[11] = {"复活的拉撒路 ", "提升属性并获得+40%的伤害倍率#进入新层时会变回拉撒路"},
	[12] = {"黑暗犹大 ", "+100%伤害倍率#无法拥有红心#生命提升道具会给予黑心#统计通关标记时被视为犹大"},
	[14] = {"店主", "通过捡起硬币回复血量#心类掉落物会变成蓝苍蝇#恶魔交易变为支付15或30个硬币"},
	[18] = {"伯大尼", "使用魂心为主动道具充能#无法获得魂心作为生命值"},
	[19] = {"雅各", "同时控制雅各和以扫#当使用炸弹时，两个角色都会丢下一颗炸弹#按住{{ButtonRT}}时，以扫会留在原地#{{ButtonLT}}使用雅各的主动道具，{{ButtonRB}}使用以扫的主动道具，按住{{ButtonRT}}使用他们的卡牌/药丸#在道具多选一时，雅各和以扫可以同时拿起道具"},
	[20] = {"以扫", "同时控制雅各和以扫#当使用炸弹时，两个角色都会丢下一颗炸弹#按住{{ButtonRT}}时，以扫会留在原地#{{ButtonLT}}使用雅各的主动道具，{{ButtonRB}}使用以扫的主动道具，按住{{ButtonRT}}使用他们的卡牌/药丸#在道具多选一时，雅各和以扫可以同时拿起道具"},
	[21] = {"堕化以撒", "道具在两个选项之间切换#你只能携带8个被动道具#使用{{ButtonRT}}切换道具，以选择被替换的道具"},
	[22] = {"堕化抹大拉", "超过2颗红心的生命值会缓慢流失#接触敌人时进行一次近战攻击，造成6倍角色伤害#敌人有几率掉落2秒后消失的半红心#近战击杀时必定掉落半红心#通过非拾取途径获得的治疗效果加倍#红心流失不影响恶魔房开启"},
	[23] = {"堕化该隐", "接触道具会将其转化为各种掉落物#通过在合成宝袋中组合8个拾取物来获得道具#可以通过{{ButtonRT}}调整合成宝袋的替换顺序"},
	[24] = {"堕化犹大", "无法拥有红心#生命值提升道具会给予黑心"},
	[25] = {"堕化???", "无法拥有红心#炸弹被替换为大便#造成伤害时生成大便掉落物#HUD显示大便效果预览#可以存储一个大便以备后用"},
	[26] = {"堕化夏娃", "持续射击会将你的心转换为血团#不同类型的心会生成拥有不同生命值和泪滴效果的血团#血团随着时间流逝会失去生命值#使用圣血吸管将血团吸回你的生命值#按住{{ButtonRT}}时血团会留在原地#当生命值只剩半颗心且没有血团时，在当前房间获得属性提升并使用圣血吸管进行攻击"},
	[27] = {"堕化参孙", "造成或受到伤害会为狂暴状态充能#{{Timer}} 进入狂暴状态时，于5秒内：#↑ {{Speed}} +0.4速度# {{Tears}} x50%+2.0射速修正#↑ {{Damage}} +3.0伤害#攻击变为能反弹子弹的近战攻击#{{Timer}} 每次击杀增加1秒狂暴持续时间并赋予短暂的无敌效果"},
	[28] = {"堕化阿撒泻勒", "开始蓄力时，你会咯血#用咯血击中敌人会将蓄力时间减半#咯血造成150%角色伤害，并诅咒敌人#{{BrimstoneCurse}} 被诅咒的敌人会受到更多的硫磺火伤害#死亡时，受诅咒的敌人会爆炸，并将诅咒传给附近的敌人"},
	[29] = {"堕化拉撒路", "拉撒路有生死两种状态，每种状态都有各自的道具和生命值#每当你清理一个房间/波次或使用生死逆转时，你会切换到另一种状态"},
	[30] = {"堕化伊甸", "当你受到伤害时，会重新随机生成你的属性、道具、饰品和消耗品#道具会重新随机成同一道具池中的另一道具#自伤不会导致重随机"},
	[31] = {"堕化游魂", "生成的卡牌有10%几率为神圣卡牌#品质{{Quality2}}或以下的道具有20%几率被重新生成#只生成攻击性道具"},
	[32] = {"堕化莉莉丝", "按下射击键会发射一个脐带宝宝，造成300%角色伤害#按住射击键会保持宝宝外出，向最近的敌人射击眼泪"},
	[33] = {"堕化店主", "敌人会掉落在2秒内消失的硬币#大多数道具需要15个硬币购买#恶魔交易和天使道具需要支付15或30个硬币#商店不需要钥匙且商品增加"},
	[34] = {"堕化亚伯伦", ""},
	[35] = {"堕化遗骸", "遗骸本体是一堆不能移动的骨头，由灵魂拾起并投掷，造成300%角色#只有灵魂可以受到伤害#炸弹会放置在本体的位置#无法拥有红心"},
	[36] = {"堕落伯大尼", "使用红心为主动道具充能#无法拥有红心#属性提升只有75%效果"},
	[37] = {"堕落雅各", "堕化以扫会追赶你，接近时会向你冲锋#孤魂铁索可以短暂地锁住堕化以扫，5秒后或再次使用孤魂铁索时，堕化以扫会再次冲向你#堕化以扫的冲锋对敌人造成大量伤害，并无视Boss护甲#如果以扫追上你，你会变成一个幽灵，在本层中只要再受一次伤害就会死亡#作为幽灵，每个房间可以免费进行一次恶魔交易"},
	[38] = {"死去的堕化拉撒路", "拉撒路有生死两种状态，每种状态都有各自的道具和生命值#每当你清理一个房间/波次或使用生死逆转时，你会切换到另一种状态"},
	[39] = {"堕化雅各之魂", "#飞行#幽灵眼泪#受到一次伤害即会死亡#每个房间可以免费进行一次恶魔交易"},
	[40] = {"堕化遗骸的灵魂", "遗骸本体是一堆不能移动的骨头，由灵魂拾起并投掷，造成300%角色#只有灵魂可以受到伤害#炸弹会放置在本体的位置#无法拥有红心"},
}
...
local repPills={
	...
	[42] = {"41", "好困…", "{{Slow}} 使房间内所有敌人和角色减速"}, -- I'm Drowsy...
	[43] = {"42", "好兴奋！！！", "{{Timer}} 使房间内所有敌人和角色加速#在30秒以及60秒后再次触发一次"}, -- I'm Excited!!!
...
EID.descriptions[languageCode].horsepills={
	...
	{"27", "你是巫师吗？", "{{Timer}} 进行斜角射击60秒"}, -- R U a Wizard?
	{"28", "止痛药！", "{{Timer}} 所在房间受到的伤害减半"},  -- Percs!
	{"29", "上瘾！", "{{Timer}} 所在房间受到的伤害为整心"}, -- Addicted!
	...
	{"45", "感觉像漫步在阳光下！", "{{Timer}} 触发{{Collectible93}}的效果，在6秒获得：#无敌#{{Fear}} 恐惧所有敌人#无法发射眼泪#造成每秒40点接触伤害#{{HalfHeart}} 吃掉两个敌人回复半个红心"}, -- Feels like I'm walking on sunshine!
