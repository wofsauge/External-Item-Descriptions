...
local repCollectibles={
	...
	[22] = {"22", "午餐", "↑ +1心之容器#治疗1红心"}, -- Lunch
	[23] = {"23", "正餐", "↑ +1心之容器#治疗1红心"}, -- Dinner
	[24] = {"24", "甜点", "↑ +1心之容器#治疗1红心"}, -- Dessert
	[25] = {"25", "早餐", "↑ +1心之容器#治疗1红心"}, -- Breakfast
	[26] = {"26", "烂肉", "↑ +1心之容器#治疗1红心"}, -- Rotten Meat
	...
	[45] = {"45", "美味的心", "治疗1红心#(多人游戏)也治疗其他玩家半红心"}, -- Yum Heart
	[46] = {"46", "幸运脚", "↑ +1.0运气#赌博时赢的几率更高#清理房间后掉落物品的几率更高#将一些坏胶囊变成好胶囊"}, -- Lucky Foot
	[52] = {"52", "胎儿博士", "炸弹眼泪#每个炸弹造成10倍角色伤害#如果结果超过60伤害，以5倍角色伤害+30取代#↓ -60%射速"}, --Dr. Fetus
	...
	[106] = {"106", "大爆弹先生", "↑ 炸弹伤害x1.85#+5炸弹"}, -- Mr. Mega
	[110] = {"110", "老妈的美瞳", "几率发射石化眼泪#↑ +0.38射程"}, -- Mom's Contacts
	[118] = {"118", "硫磺火", "蓄力发射持续造成伤害的鲜血激光#↓ -67%发射速度"},
	[121] = {"121", "怪异蘑菇(大)", "↑ +1心之容器#↑ +1伤害#↑ +0.38射程#↓ -0.2移速"}, -- Odd Mushroom (Large)
	[123] = {"123", "怪物手册", "生成随机跟班#当前层持续"}, -- Monster Manual
	[129] = {"129", "桶装猪油", "↑ +2心之容器#↓ -0.2移速"}, -- Bucket of Lard
	[135] = {"135", "献血袋", "便携式血库#半心=1-2硬币#困难模式：1硬币#店主：0-1硬币"}, -- IV Bag
	[138] = {"138", "圣痕", "↑ +1心之容器#↑ +0.3伤害#治疗1红心"}, -- Stigmata
	[139] = {"139", "老妈的钱包", "可以持有2个饰品#生成1个随机饰品"}, -- Mom's Purse
	[140] = {"140", "鲍勃的诅咒", "有毒炸弹#+5炸弹#炸弹会留下毒气"}, -- Bob's Curse
	[147] = {"147", "残损铁镐", "打碎所在房间接触到的岩石并对敌人造成伤害#攻击则降低1格充能#换层时再次充能"}, -- Notched Axe
	[148] = {"148", "害虫横行", "受伤时生成2-6只蓝苍蝇"}, -- Infestation
	[149] = {"149", "吐根酊", "爆炸有毒眼泪#↑ +40伤害#↓ -0.2弹速#↓ -67%发射速度#↓ 射程小幅降低"}, -- Ipecac
	[152] = {"152", "科技II", "右眼以无限射程的持续穿透激光取代#激光造成13%角色伤害#↓ -33%发射速度"}, -- Technology 2
	...
	[182] = {"182", "圣心", "↑ +1心之容器#满血#↑ +230%伤害并+1伤害#↓ -0.4射速#↓ -0.25弹速#跟踪眼泪"}, -- Sacred Heart
	[184] = {"184", "圣杯", "飞行#↑ +1心之容器#治疗1红心"}, -- Holy Grail
	[188] = {"188", "亚伯", "与角色移动互为镜像#向角色发射眼泪#每次射击造成3.5伤害#如果角色是该隐#{{Blank}} 伤害为7.5"}, -- Abel
	[189] = {"189", "超级食肉男孩死忠粉", "↑ +1心之容器#满血#↑ +0.3伤害#↑ +0.2射速#↑ +1.5射程#↑ +0.2移速"}, -- SMB Super Fan
	[192] = {"192", "心灵感应傻瓜式教程", "所在房间眼泪有跟踪效果#↑ +3射程"}, -- Telepathy for Dummies
	[193] = {"193", "生肉！", "↑ +1心之容器#↑ +0.3伤害#治疗1红心"}, -- MEAT!
	[194] = {"194", "魔力八号球", "↑ +0.16弹速#+1卡牌#+15%星象房几率"}, -- Magic 8 Ball
	[197] = {"197", "耶稣果汁", "↑ +0.5伤害#↑ +0.38射程"}, -- Jesus Juice
	[203] = {"203", "慈善捆绑包", "掉落物几率成对出现"}, -- Humbling Bundle
	[205] = {"205", "锋利插头", "按住空格时，受到半心伤害并为主动道具充能1格"}, -- Sharp Plug
	[206] = {"206", "断头台", "↑ +1伤害#↑ +0.5发射速度#角色的头变成环绕物，不会受伤并造成105接触伤害#角色仍从头发射眼泪"}, -- Guillotine
	[211] = {"211", "蜘蛛宝宝", "受伤时生成3-5只蓝蜘蛛"}, -- Spiderbaby
	[214] = {"214", "贫血", "↑ +1.5射程#受伤时在地上留下能造成伤害的血迹"}, -- Anemic
	[218] = {"218", "胎盘", "↑ +1心之容器#治疗1红心#缓慢恢复生命"}, -- Placenta
	[224] = {"224", "柯吉猫的身体", "↓ -20%射程#眼泪击中后会分裂为4个#分裂的眼泪造成一半伤害#↑ -1眼泪延迟，可以使射速超出上限"}, -- Cricket's Body
	[228] = {"228", "老妈的香水", "几率发射恐惧眼泪#↑ +1射速#↑ -1眼泪延迟，可以使射速超出上限"}, -- Moms Perfume
	[230] = {"230", "亚巴顿", "↑ +1.5伤害#↑ +0.2移速#恐惧眼泪#将心之容器变成黑心#+2黑心"}, -- Abaddon
	[232] = {"232", "怀表", "永久敌人减速效果#↑ +0.3移速"}, -- Stop Watch
	[233] = {"233", "小小星球", "眼泪环绕在角色周围#↑ +6.5射程#幽灵眼泪"}, -- Tiny Planet
	[240] = {"240", "实验性疗法", "↑ 随机提升4项属性#↓ 随机降低2项属性"}, -- Experimental Treatment
	[245] = {"245", "完美视力", "角色眼泪加倍#↓ -25%伤害"}, -- 20/20
	[248] = {"248", "虫群之心", "蓝蜘蛛/苍蝇造成双倍伤害#蜘蛛/苍蝇类跟班变得更强"}, -- Hive Mind
	[253] = {"253", "魔法血痂", "↑ +1心之容器#↑ +1运气#治疗1红心"}, -- Magic Scab
	[254] = {"254", "血块", "!!! 只对左眼有效#↑ +1伤害#↑ +1.5射程"}, -- Blood Clot
	[256] = {"256", "炙热炸弹", "燃烧炸弹#+5炸弹###角色不再受到火焰伤害#炸弹造成接触伤害"}, -- Hot Bombs
	[261] = {"261", "眼球突出", "↑ +0.5伤害#↓ 眼泪走得越远伤害越低#近距离伤害为3倍，最大距离无伤害"}, -- Proptosis
	[262] = {"262", "遗失的书页2", "+1黑心#当降至1心时，对房间内所有敌人造成80伤害#黑心和死灵书伤害翻倍"}, -- Missing Page 2
	[263] = {"263", "透明符文", "复制持有符文或魂石的效果#掉落1随机符文"}, -- Clear Rune   (REPENTANCE ITEM)
	[273] = {"273", "鲍勃的脑浆子", "可投掷的炸弹跟班#爆炸造成100伤害#伤害无视护甲"}, -- Bob's Brain
	[274] = {"274", "最棒的伙伴", "受伤时获得1个中范围环绕物#环绕物每秒造成150接触伤害"}, -- Best Bud
	[275] = {"275", "硫磺火宝宝", "发射硫磺火激光的跟班#激光总共造成20伤害"}, -- Lil Brimston
	[276] = {"276", "以撒的心脏", "让自身无敌#!!! 心脏跟班受伤时角色也受伤#跟班在角色发射时蓄力，释放时发射一串眼泪"}, -- Isaac's Heart
	[278] = {"278", "黑暗乞丐", "!!! 转换：#1.5红心变成1黑心/蜘蛛/胶囊/卡牌/符文"}, -- Dark Bum
	...
	[285] = {"285", "十面骰", "重置房间内所有敌人#尝试将敌人重置成最大生命近似的敌人"}, -- D10
	[287] = {"287", "秘密之书", "施加 {{Collectible54}}藏宝图， {{Collectible21}}罗盘， {{Collectible246}}蓝地图的效果之一#只产生未拥有的效果#如果三者都已拥有，施加 {{Collectible76}}X光透视效果"}, -- Book of Secrets
	[288] = {"288", "蜘蛛盒", "生成4-8只蓝蜘蛛"}, -- Box of Spiders
	[289] = {"289", "红蜡烛", "发射红火#火焰造成5次23伤害后或10秒后消失"}, -- Red Candle
	[291] = {"291", "冲水！", "!!! 立即杀死便便敌人和Boss！#使非Boss敌人变成便便#熄灭火堆#使岩浆池变成可行走的地面"}, -- Flush!
	[292] = {"292", "撒但圣经", "+1黑心#在Boss战前使用则Boss房道具会变成恶魔交易#!!! 交易道具则会锁定在本局只能进行恶魔交易"}, -- Satanic Bible
	[294] = {"294", "棉豆", "击退附近的敌人和弹幕#将敌人击退到障碍物上会造成10伤害"}, -- Butter Bean
	[295] = {"295", "魔术手指", "对房间内所有敌人造成角色伤害x2+10的伤害#价格：1硬币"}, -- Magic Fingers
	[296] = {"296", "转换器", "!!! 转换：#1魂心或黑心变成1心之容器"}, -- Converter
	[297] = {"297", "潘多拉魔盒", "{{Warning}} 一次性 {{Warning}}(按F5调整字大小)#根据所在层掉落以下物品：#1章1：2魂心#1章2：2钥匙+2炸弹#2章1：1Boss房道具#2章2：1章1+2章1#3章1：4魂心#3章2：20硬币#4章1：2Boss房道具#4章2： {{Collectible33}} 圣经#???：无#暗室：解锁 {{Collectible523}} 搬家盒#地狱：1恶魔房道具+1黑心#大教堂：1天使房道具+1永恒之心#宝箱层：1硬币#家： {{Collectible580}} 红钥匙#若有迷宫诅咒则为章节1层"}, -- Pandora's Box
	[300] = {"300", "白羊座", "↑ +0.25移速#对敌人造成25接触伤害#移速不低于为0.85才能造成伤害，且自己不会受伤"}, -- Aries
	[307] = {"307", "摩羯座", "↑ +1心之容器#↑ +0.5伤害#↑ +0.1移速#↑ +0.75射程#↑ +0.5发射速度#给予1炸弹，硬币和钥匙"}, -- Capricorn
	[308] = {"308", "水瓶座", "留下水迹#水迹每秒造成66%的角色伤害的接触伤害#水迹与眼泪效果有协同效应"}, -- Aquarius
	[309] =	{"309", "双鱼座", "↑ +0.5发射速度#提高眼泪击退力"},
	[310] =	{"310", "夏娃的睫毛膏", "↑ 伤害x200%#↓ -33%射速#↓ -0.5弹速"},
	[314] = {"314", "霹雳大腿", "↑ +1心之容器#↓ -0.4移速#治疗1红心#摧毁走过的岩石"}, -- Thunder Thighs
	[315] = {"315", "怪异磁铁", "磁性眼泪#影响敌人，掉落物和饰品#物品会被吸引到眼泪落地处"}, -- Strange Attractor
	[320] = {"320", "???唯一的朋友", "可控制的苍蝇#每秒造成大约52.5接触伤害"}, -- ???'s Only Friend
	[326] = {"326", "生命之息", "按住空格，充能清空时无敌#无敌时，接触到的敌人会被光束攻击#!!! 不要一直按着！"}, -- Breath of Life
	[328] = {"328", "底片", "↑ +1.0伤害#受伤后血量不多于半红心对房间内所有敌人造成40伤害"}, -- The Negative
	[330] = {"330", "豆奶", "↑ 发射速度x5.5#↓ -80%伤害#击退大幅降低"}, -- Soy Milk
	[331] = {"331", "神性", "↑ +0.5伤害#↓ -0.3射速#↓ -0.3弹速#眼泪具有伤害光环，每帧造成2伤害#跟踪眼泪"}, -- Godhead
	[336] = {"336", "烂洋葱", "穿透幽灵眼泪#↓ -1.5射程#↓ -0.4弹速#↑ +50%眼泪大小"}, -- Dead Onion
	[339] = {"339", "安全别针", "↑ +1.5射程#↑ +0.16弹速#+1黑心"}, -- Safety Pin
	[342] = {"342", "蓝盖蘑菇", "↑ +1心之容器#↑ +0.7射速#↓ -0.16弹速#治疗1红心"}, -- Blue Cap
	[344] = {"344", "火柴盒", "+1黑心#生成2-3炸弹掉落物#生成饰品{{Trinket41}}火柴棒"}, -- Match Book
	[345] = {"345", "合成油脂", "↑ +1.0伤害#↑ +1.5射程"}, -- Synthoil
	[346] = {"346", "零食", "↑ +1心之容器#治疗1红心"}, -- A Snack
	[350] = {"350", "毒性休克", "每个房间的一开始所有敌人获得中毒效果#被毒死的敌人留下水迹#对毒气免疫"}, -- Toxic Shock
	[352] = {"352", "玻璃大炮", "发射一颗巨大的穿透幽灵眼泪((伤害x10)+10)#!!! 受伤时：#额外受到2红心伤害#↑ +1.5射程#主动伤害除外"}, -- Glass Canon
	[354] = {"354", "琥珀爆米花", "↑ +1心之容器#在地上生成随机饰品#治疗1红心"}, -- Crack Jacks
	[355] = {"355", "老妈的珍珠项链", "↑ +0.38射程#↑ +1运气#+1魂心"}, -- Mom's Pearls
	[360] = {"360", "淫魔", "获得与角色眼泪效果一致的恶魔跟班#莉莉丝：造成100%角色伤害#其他：造成75%角色伤害"}, -- Incubus
	[366] = {"366", "分裂炸弹", "+5炸弹#炸弹会炸成4-5个小炸弹"}, -- Scatter Bombs
	[368] =	{"368", "流涙症", "向单方向发射会提高发射速度，最多至200%"}, -- Epiphora
	[369] = {"369", "连续统", "↑ +3.0射程#眼泪会穿墙，从另一边回来"}, -- Continuum
	[370] = {"370", "玩偶先生", "↑ +0.7射速#↑ +1.5射程#捡起时生成3随机心"}, -- Mr. Dolly
	[372] = {"372", "充电宝宝", "几率随机掉落1小电池或石化房间内所有敌人#几率对主动道具充能1格"}, -- Charged Baby
	[374] = {"374", "圣光", "几率发射圣光眼泪，击中时会产生光柱#光柱造成角色伤害x3的伤害"}, -- Holy Light
	[375] = {"375", "寄居骷髅帽", "20%几率阻挡弹幕#获得爆炸免疫#阻挡上方弹幕的伤害"}, -- Host hat
	[376] = {"376", "补货", "商店物品购买后会立刻补货#补充的物品价格缓慢提高"}, -- Restock
	[382] = {"382", "友好球", "可以扔向敌人将其捕捉#下一次使用则会生成相同的友好敌人#靠近捕捉后的球会立即将道具充能"}, -- Friendly Ball
	[384] = {"384", "小肉山", "会蓄力发射并在房间内滑动#每次撞击造成5-20接触伤害，与蓄力时间有关"}, -- Lil Gurdy
	[389] = {"389", "符文袋", "每7-8个房间掉落1个随机符文#也会掉落魂石"}, -- Rune Bag
	[393] = {"393", "蛇蝎之吻", "几率发射有毒眼泪#会使接触的敌人中毒#接触中毒的敌人被杀死时有20%几率掉落1黑心"}, -- Serpent`s Kiss
	[394] = {"394", "十字准星", "自动地发射眼泪，方向为玩家控制的地上红色标记#↑ +0.7射速#↑ +3.0射程#跟班也向标记发射"}, -- Marked
	[395] = {"395", "科技X", "能够蓄力并发射穿过整个房间的激光环#伤害基于蓄力进度#完全蓄力伤害为100%"}, -- Tech X
	[397] = {"397", "牵引光束", "角色的眼泪现在受光束指引，与角色一起移动#↑ +0.5射速#↑ +1.5射程#↑ +0.16弹速"}, -- Tractor Beam
	[399] = {"399", "虚空之喉", "发射3秒后，角色头上会出现红交叉。释放攻击键会产生1圈黑硫磺火环"}, -- Maw of the Void
	[401] = {"401", "爆炸物", "几率发射粘性炸弹眼泪#粘住的眼泪定期造成常规眼泪的伤害"}, -- Explosivo
	[404] = {"404", "放屁宝宝", "阻挡弹幕的跟班#如果被击中有几率放屁，效果为魅惑/中毒/击退三种其一#屁造成5-6伤害"}, -- Farting Baby
	...
	[440] = {"440", "肾结石", "发射眼泪时随机停止发射并释放一阵眼泪和一颗肾结石"}, -- Kidney Stone
	[442] = {"442", "黑王子之冠", "!!! 仅有1红心时：#↑ +2发射速度#↑ +1.5射程#↑ +0.2弹速#没有红心的角色无效)"}, -- Dark Princes Crown
	[444] = {"444", "铅笔", "每发射15颗眼泪，发射一串眼泪"}, -- Lead Pencil
	[448] = {"448", "玻璃碎片", "受减红心的伤时，喷出红色眼泪#攻击时控制喷出眼泪的方向#生效后，每20秒受到半心伤害#直到捡到红心或无红心为止#不致死"}, -- Shard of Glass -- TODO: Lines 174 and 175 define the same item, but are different. One of them needs to be removed.
	[448] = {"448", "玻璃碎片", "当受伤时喷出红色眼泪并留下血迹#攻击时控制喷出眼泪的方向#一段时间后红心受伤，有较大几率生成1红心#角色会持续受伤，直到捡到红心或无红心为止"}, -- Shard of Glass -- TODO: Lines 174 and 175 define the same item, but are different. One of them needs to be removed.
	...
	[456] = {"456", "夜宵", "↑ +1心之容器#治疗1红心"}, -- Midnight Snack
	[459] = {"459", "鼻窦炎", "粘性有毒眼泪#每秒造成角色伤害的伤害#能粘住10秒"}, -- Sinus Infection
	[462] = {"462", "彼列之眼", "↑ +1.5射程#穿透眼泪#眼泪击中第1个敌人后，造成双倍伤害并获得跟踪效果"}, -- Eye of Belial
	...
	[494] = {"494", "雅各布天梯", "眼泪击中时会生成1道随机方向电弧#电弧造成角色伤害一半的伤害#电弧可以在敌人间跳跃"}, -- Jacobs Ladder
	[503] = {"503", "小魔角", "几率发射能召唤大霍恩的手的眼泪#手会立即杀死敌人或对Boss造成伤害#冲向敌人会造成3.5接触伤害"}, -- Little Horn
	[504] = {"504", "棕色粪块", "生成1只苍蝇炮塔，能够向敌人发射眼泪#每次发射造成3.5伤害"}, -- Brown Nugget
	[509] = {"509", "血丝眼", "当附近有敌人时，每1/3秒发射一颗眼泪的环绕物#每次射击造成3.5伤害#每秒造成30接触伤害"}, -- Bloodshot Eye
	[517] = {"517", "快速炸弹", "7炸弹#能更快地放置炸弹#炸弹相互之间不会弹开"}, -- Fast Bombs
	[523] = {"523", "搬家盒", "使用时储存所在房间的掉落物，最多10个#再次使用将储存物放回地上#可以在房间之间搬东西"}, -- Moving Box
	[524] = {"524", "科技零", "眼泪以电束连接#电击伤害为角色伤害的1/3"}, -- Technology Zero
	[531] = {"531", "泪血症", "眼泪弧形前进#击中时眼泪分裂成更小的眼泪#↓ 射速降低#↑ +50%伤害#↑ 额外+1伤害"}, -- Haemolacria
	[541] = {"541", "骨髓", "+1骨心#生成3红心"}, -- Marrow
	[543] = {"543", "圣地大便", "受伤时生成白便便#在白便便的光环中：#↑ +25%伤害#↑ +250%发射速度#跟踪眼泪#几率阻挡伤害"}, -- Hallowed Ground
	[549] =	{"549", "成骨不全症", "以6骨心替换所有心之容器#失去骨心时：#向8个方向发射骨头眼泪#↑ 永久+0.4发射速度"}, -- Brittle Bones
	[553] = {"553", "毛霉菌病", "几率发射粘性孢子眼泪#孢子在命中后2.5秒爆炸，造成伤害，使附近敌人中毒，并释放更多孢子"}, --  Mucormycosis
	[554] = {"554", "恐怖如斯", "使近距离内的敌人恐惧"}, --  2Spooky
	[555] = {"555", "金剃刀片", "将5硬币转换成+1.2伤害，所在房间内有效#生成5硬币"}, --  Golden Razor
	[556] = {"556", "炼金硫磺", "所在房间获得 {{Collectible118}} 硫磺火"}, --  Sulfur
	[557] = {"557", "幸运饼干", "获得1魂心，1张塔罗牌，1个饰品，或1条预言"}, --  Fortune Cookie
	[558] = {"558", "眼瘤", "几率向随机方向发射1-2颗额外眼泪"}, --  Eye Sore
	[559] = {"559", "220伏", "连续电击近距离的敌人#电击伤害为角色伤害的75%"}, --  120 Volt
	[560] = {"560", "好疼", "受伤时向四周发射10颗造成10伤害的眼泪#↑ 第一次受伤时+1.2发射速度#↑ 后续受伤+0.4射速"}, --  It Hurts
	[561] = {"561", "杏仁奶", "↑ 发射速度x4#↓ -70%伤害#眼泪获得一些随机道具和蠕虫饰品效果"}, --  Almond Milk
	[562] = {"562", "谷底石", "本局游戏中属性不会再降低"}, --  Rock Bottom
	[563] = {"563", "魅彩炸弹", "+5炸弹#炸弹具有随机爆炸效果"}, --  Nancy Bombs
	[564] = {"564", "肥皂", "↑ +0.57射速#↑ +0.2弹速"}, --  A Bar of Soap
	[565] = {"565", "嗜血小宠", "会追逐敌人的跟班#击杀敌人会变强，但也会尝试对角色造成伤害#被角色攻击时恢复正常"}, --  Blood Puppy
	[566] = {"566", "捕梦网", "进入新一层时+半魂心#在过场动画中显示下一层的宝藏和Boss"}, --  Dream Catcher
	[567] = {"567", "逾越节蜡烛", "↑ 完成房间且不受伤害则+0.4发射速度#最多叠加到+2发射速度"}, --  Paschal Candle
	...
	[577] = {"577", "达摩克里斯之剑", "{{Warning}} 一次性 {{Warning}}#在头顶生成悬浮的剑，所有底座道具额外生成1个#头顶有剑时受伤，在随机时间后，角色会自动死亡"}, --  Damocles
	[578] = {"578", "免费柠檬水", "生成大范围的黄色水迹"}, --  Free Lemonade
	[579] = {"579", "英灵剑", "攻击方式改为挥剑#伤害为角色伤害x3#可蓄力发动旋转攻击，同时发射剑形子弹#红心全满时，挥剑即可发射子弹"}, --  Spirit Sword
	[580] = {"580", "红钥匙", "在合适的墙壁上生成新房间的入口，可生成时墙壁上显示红色的门轮廓#产生的房间可以是特殊房间#在13x13的地图范围外产生的房间，进入时将直接传送到错误房"}, --  Red Key
	...
	[588] = {"588", "太阳", "揭示{{BossRoom}}Boss房位置#击败Boss后自动使用{{Card20}}XIX - 太阳#同时为主动道具充能，并在所在层+3伤害，+1运气"}, --  Sol
	[589] = {"589", "月亮", "为每一层增加1个{{SecretRoom}}隐藏房间和{{SuperSecretRoom}}超级隐藏房间#隐藏房间内有光束，接触时在所在层射速提升，获得半魂心#每层揭示1个{{SecretRoom}}隐藏房"}, --  Luna
	[590] = {"590", "水星", "↑ +0.4移速#进入房间后门不会关闭"}, --  Mercurius
	...
	[594] = {"594", "木星", "+2心之容器#治疗半红心#↓ -0.3移速#不移动时累积至多0.5移速#移动时释放毒气"}, --  Jupiter
	...
	[605] = {"605", "挖眼勺", "在当前房间召唤眼球跟班，在地上生成血迹#右眼眼泪伤害+34%"}, --  The Scooper
	[606] = {"606", "邪眼裂口", "几率发射在落地时生成裂隙的眼泪#裂隙吸引周围的敌人，掉落物，弹幕，并对敌人造成接触伤害"}, --  Ocular Rift
	[607] = {"607", "脓液囊宝宝", "向四周随机喷射眼泪的跟班#每颗眼泪造成3.5或5.3伤害"}, --  Boiled Baby
	[608] = {"608", "冰冻宝宝", "发射石化效果眼泪的跟班#击杀时使敌人冻结"}, --  Freezer Baby
	[609] = {"609", "永恒六面骰", "重置房间内所有道具#道具可能会消失"}, --  Eternal D6
	[610] = {"610", "鸟肥笼", "在被击中时跃向敌人的跟班#造成45伤害并释放岩石波#之后追逐敌人造成伤害"}, --  Bird Cage
	[611] = {"611", "声带", "使用时发出怒吼，击退周围的敌人，并造成伤害#充能越多，效果越强"}, --  Larynx
	[612] = {"612", "迷失游魂", "幽灵跟班，被击中时死亡，下一层才能复活#如果存活了整层，则生成3魂心，或2永恒之心，或道具"}, --  Lost Soul
	[613] = {"613", "", "<道具不存在>"},
	[614] = {"614", "鲜血炸弹", "+1心之容器#治疗5红心#炸弹爆炸时产生血迹#没有炸弹时也可放置炸弹，消耗半红心"}, --  Blood Bombs
	[615] = {"615", "小屁包", "放屁跟班#被击中时放屁，对敌人有伤害，击退，击晕或中毒的效果"}, --  Lil Dumpy
	[616] = {"616", "鸟眼椒", "几率射出火焰，能阻挡敌人弹幕，并造成接触伤害#最大伤害为角色伤害x4"}, --  Bird's Eye
	[617] = {"617", "磁石", "几率发射使敌人磁化的眼泪#磁化的敌人吸引掉落物，弹幕和其它敌人"}, --  Lodestone
	[618] = {"618", "烂番茄", "几率发射眼泪标记敌人#被标记的敌人受其它敌人攻击"}, --  Rotten Tomato
	[619] = {"619", "长子名分", "不同角色效果不同"}, --  Birthright
	[620] = {"620", "", "<道具不存在>"},
	[621] = {"621", "红豆汤", "↑ +21.6伤害#增加的伤害会不断衰减，在3分钟后衰减完毕#效果尚存时击杀敌人会延长时间#满血"}, --  Red Stew
	[622] = {"622", "创世纪", "{{Warning}} 一次性 {{Warning}}#移除持有的全部道具和掉落物#传送到特殊的卧室，内有掉落物，箱子和暗门#每移除1个道具，{{TreasureRoom}}道具房就显示1组3个道具供你选择"}, --  Genesis
	[623] = {"623", "尖头钥匙", "+5钥匙#使用时发射1钥匙，可造成伤害，摧毁障碍物，打开箱子或门#被其杀死的敌人有几率掉落箱子里的内容，包括道具"}, --  Sharp Key
	[624] = {"624", "扩展包", "生成5张随机卡牌"}, --  Booster Pack
	[625] = {"625", "超级蘑菇", "巨化，持续30秒#提升伤害和射程#持续时间内无敌，能踩碎障碍物和敌人#效果可在多个房间内持续"}, --  Mega Mush
	[626] = {"626", "菜刀碎片1", "厨刀跟班的第一部件"}, --  Knife Piece 1
	[627] = {"627", "菜刀碎片2", "与 {{Collectible626}} 厨刀部件结合，生成1个厨刀跟班#可刺杀敌人#能刺开某个血肉之门"}, --  Knife Piece 2
	...
	[632] = {"632", "邪眼护符", "↑ +2运气#免疫烧伤，混乱，毒气"}, --  Evil Charm
	[633] = {"633", "教条", "获得飞行和单次 {{Collectible313}} 神圣斗篷效果#↑ +2.0伤害#↑ +0.1移速#如果角色少于6心则以红心和魂心治疗至6心"}, --  Dogma
	...
	[637] = {"637", "强力安眠药", "几率发射拳形眼泪，对敌人造成强力击退和击晕"}, --  Knockout Drops
	[638] = {"638", "橡皮擦", "使用时掷出橡皮，秒杀击中的敌人#击杀的敌人在本局游戏中不会再出现#对Boss造成15伤害#每层只能使用一次"}, --  Eraser
	[639] = {"639", "难吃的心", "使用时获得1腐心"}, --  Yuck Heart
	[640] = {"640", "灵魂之瓮", "喷射火焰#敌人死亡时获得充能"}, --  Urn of Souls
	[641] = {"641", "血田", "战斗时，在身体后方生成一串眼泪#眼泪造成3.5伤害"}, --  Akeldama
	[642] = {"642", "玄奇驴皮", "消耗1心之容器或2魂心，并将其替换为碎心#从当前房间道具池中生成1个道具#{{Warning}}游魂：一次性#{{Warning}} 使用后如果不再持有，后续生成的道具有几率被魔法皮肤替换掉#使用次数越多几率越大"}, --  Magic Skin
	...
	[646] = {"646", "硫磺火炸弹", "+5炸弹#炸弹爆炸时释放十字硫磺火"}, --  Brimstone Bombs
	[647] = {"647", "4.5伏特", "主动道具清理房间时不充能#改为对敌人造成伤害时充能#充能所需伤害量：40+20*层数"}, --  4.5 Volt
	[648] = {"648", "", "<道具不存在>"},
	[649] = {"649", "果味甜蝇宝", "迷你Baby Plum跟班#在房间内斜着前进，并发射眼泪"}, --  Fruity Plum
	[650] = {"650", "甜蝇溜溜笛", "使用时，在所在房间召唤Baby Plum，持续10秒"}, --  Plum Flute
	[651] = {"651", "伯列恒之星", "向Boss房缓缓移动的跟班#四周有光环，在其中时+20%伤害，+1射速，眼泪有跟踪效果"}, --  Star of Bethlehem
	[652] = {"652", "冰块宝宝", "可被推动的跟班#接触敌人时造成伤害，并具有减速效果，击杀的敌人会被冻结"}, --  Cube Baby
	[653] = {"653", "驱魔护符", "非幽灵的敌人在死亡时生成小的红色幽灵#使用时引爆所有红色幽灵"}, --  Vade Retro
	[654] = {"654", "伪造药学博士证", "识别所有胶囊#+1黑心#好的胶囊自动转化为坏的#↑ 降低属性的胶囊提供+1伤害#其它坏胶囊使用时掉落1黑心"}, --  False PHD
	[655] = {"655", "幸运转盘", "生成1个陀螺环绕跟班，可阻挡敌人弹幕#每秒造成10.5接触伤害#使用时+0.5移速，使所有环绕物加速旋转"}, --  Spin to Win
	[656] = {"656", "达摩克里斯之剑", "<道具无法获得>"}, -- Damocles
	[657] = {"657", "血管炎", "敌人死亡时爆发出眼泪，受角色眼泪效果影响"}, --  Vasculitis
	[658] = {"658", "巨细胞", "受到伤害时生成小以撒#小以撒自动攻击周围的敌人"}, --  Giant Cell
	[659] = {"659", "托吡卡胺", "↑ +1.5射程#眼泪变大"}, --  Tropicamide
	...
	[666] = {"666", "", "<道具不存在>"},
	[667] = {"667", "稻草人", "生成店主#店主死亡时生成蓝蜘蛛#店主死亡时该道具消失"}, --  Strawman
	[668] = {"668", "老爸的便条", "踏上回家的路#留在之前{{TreasureRoom}}道具房或{{BossRoom}}Boss房的饰品会变成 {{Card78}} 破裂的钥匙"}, --  Dad's Note
	[669] = {"669", "腊肠", "满血#↑ +1心之容器#↑ +0.5伤害#↑ +0.2移速#↑ +1.2弹速#↑ +0.16射程#↑ +1运气#↑ +6.9%{{DevilRoom}}恶魔房或{{AngelRoom}}天使房几率#↑ +6.9%{{Planetarium}}星象房几率"}, --  Sausage
	...
	[680] = {"680", "水土不服症", "发射时，可蓄力发射短程硫磺火#从角色后方发射"}, --  Montezuma's Revenge
	...
	[684] = {"684", "饥饿幽魂", "击杀敌人时有几率生成幽灵#幽灵追踪敌人，造成接触伤害#5秒后幽灵爆炸，对敌人造成7伤害#角色不会受到爆炸伤害"}, --  Hungry Soul
	[685] = {"685", "魂火罐", "使用时生成随机灵火，可发射各种眼泪，阻挡弹幕，造成接触伤害#使用次数越多生成数量越多"}, --  Jar of Wisps
	[686] = {"686", "灵魂吊坠", "捡起魂心时获得永久的属性提升#生成1魂心"}, --  Soul Locket
	...
	[695] = {"695", "血腥怒风", "受伤时，在所在层提升移速和射速#最多+1.02移速，+3发射速度"}, --  Bloody Gust
	...
	[698] = {"698", "作孽双子", "2个与角色并排而行的跟班#与角色一起发射眼泪，伤害角色伤害的37.5%"}, --  Twisted Pair
	[699] = {"699", "阿撒泻勒之怒", "清理房间获得怒气#清理4个房间后，在进入新房间时，发射超粗硫磺火"}, --  Azazel's Rage
	...
	[709] = {"709", "背摔！", "使用时冲向敌人或Boss，将其举起，再掷向地面#可控制投掷方向#投掷造成50伤害，并产生岩石波#伤害和影响范围与角色大小成比例"}, --  Suplex!
	[710] = {"710", "合成宝袋", "可收集储存最多8个掉落物，不能再拿出#集满时使用可将掉落物合成为道具#掉落物越稀有，合成的道具品质越高"}, --  Bag of Crafting
	[711] = {"711", "生死逆转", "当进入含有道具底座的房间中，道具后会显示另一个阴影道具#使用后，调换两者位置#拿走第一个道具后使用则两者都可拿走"}, --  Flip
	[712] = {"712", "所罗门魔典", "生成环绕的被动道具形跟班#获得该被动道具的效果#所用道具为本房间道具池内的道具"}, --  Lemegeton
	[713] = {"713", "圣血吸管", "移除半心并创造血凝块跟班#每种心的产生的血凝块的血量，伤害和眼泪效果不同"}, --  Sumptorium
	[714] = {"714", "召回", "使用时立刻召回遗骸的身体"}, --  Recall
	[715] = {"715", "保留", "保存1便便炸弹，以备后用"}, --  Hold
	[716] = {"716", "店主的胯袋", "在商店花费硬币时可提升射程，移速或伤害#捡起时生成3硬币和1钥匙"}, --  Keeper's Sack
	...
	[724] = {"724", "高凝血", "受伤时掉落半或整红心#生成的红心在1.5秒后消失"}, --  Hypercoagulation
	[725] = {"725", "大肠激躁症", "造成足够伤害后：#投掷便便#生成水迹，站在其中属性提升#放屁#放置5个激活的炸弹"}, --  IBS
	[726] = {"726", "咯血症", "双击发射键咯血#对前方的敌人造成角色伤害x1.5的伤害#1秒冷却时间"}, --  Hemoptysis
	[727] = {"727", "幽灵炸弹", "+5炸弹#爆炸时生成幽灵，对敌人造成接触伤害，幽灵10秒后爆炸"}, --  Ghost Bombs
	[728] = {"728", "格罗", "生成附着脑袋上的恶魔跟班#复制角色眼泪，属性和效果"}, --  Gello
	[729] = {"729", "飞头攻击", "使用时将脑袋投掷出去，可在落点发射眼泪#再次使用或接触时可收回脑袋"}, --  Decap Attack
	[730] = {"730", "玻璃眼", "↑ +0.75伤害#↑ +1运气"}, -- Glass Eye
	[731] = {"731", "麦粒肿", "!!! 只对右眼有效#↑ +1伤害#↑ +7射程#↓ -0.3弹速"}, --  Stye
	[732] = {"732", "老妈的戒指", "↑ +1伤害#生成1随机符文或魂石"}, --  Mom's Ring
...
EID.descriptions[languageCode].birthright ={
	{"以撒", "", "所有道具在2个选择间切换"},
	{"抹大拉", "", "↑ +1心之容器#心上限提高到18"},
	{"该隐", "", "↑ +1运气#除暗室和宝箱层外，所有层都含有一个升级的赌博房#极大增强 {{Collectible46}} 幸运脚的获胜几率提高的效果"},
	...
	{"阿撒泻勒", "", "阿撒泻勒的硫磺火变得更宽，就像超级吐息一样#对伤害无影响"},
	{"拉撒路", "", "无特殊效果，除非死亡并以复活的拉撒路重生#复活的拉撒路+21.6额外伤害，并逐渐减退"},
	{"伊甸", "", "从随机道具池生成3个随机道具#只能拿1个"},
	{"游魂", "", "不再产生对游魂无好处的道具#比如：生命提升，飞行，幽灵眼泪，受伤有效的道具"},
	{"复活的拉撒路", "", "获得+21.6额外伤害，并逐渐减退"},
	...
	{"堕化阿撒泻勒", "", "堕化阿撒泻勒的 {{Collectible726}} 咳血喷嚏攻击大小加倍"},
	{"堕化拉撒路", "", "死亡的堕化拉撒路作为幻影出现#幻影免疫伤害，可以发射眼泪#两个角色都有长子权份的效果"},
	{"堕化伊甸", "", "在长子权之前拿到的被动道具不再因为受伤而重置"},
	{"堕化游魂", "", "获得1额外生命#复活的游魂在相同房间中重生并对附近敌人造成200伤害"},
...
EID.descriptions[languageCode].bingeEaterBuffs = {
	[22] = {"22", "", "↑ +0.5射速#↑ +1.5射程#↓ -0.03移速"}, -- Lunch
	[23] = {"23", "", "↑ +0.5射速#↑ +0.2弹速#↓ -0.03移速"}, -- Dinner
	[24] = {"24", "", "↑ +1.0伤害#↑ +0.2弹速#↓ -0.03移速"}, -- Dessert
	[25] = {"25", "", "↑ +0.2弹速#↑ +1.5射程#↓ -0.03移速"}, -- Breakfast
	[26] = {"26", "", "↑ +1.0伤害#↑ +1.5射程#↓ -0.03移速"}, -- Rotten Meat
	[346] = {"346", "", "↑ +0.2弹速#↑ +1.0运气#↓ -0.03移速"}, -- A Snack
	[456] = {"456", "", "↑ +1.0伤害#↑ +1.0运气#↓ -0.03移速"}, -- Midnight Snack
	[707] = {"707", "", "↑ +0.5射速#↑ +1.0运气#↓ -0.03移速"}, -- Supper
}
...
-- TODO: finish translating some of the descriptions
EID.descriptions[languageCode].bookOfVirtuesWisps = {
	...
	[556] = {"短距离硫磺火眼泪"}, -- Sulfur
	[557] = {"每有1此类魂火+0.2幸运"}, -- Fortune Cookie
	[577] = {"无特殊效果"}, -- Damocles
...
local repTrinkets={
	[1] = {"1", "被吞下的硬币", "受伤时生成1硬币#店主：受伤时生成0-1硬币"}, -- Swallowed Penny
	[10] = {"10", "扭扭虫", "眼泪波形前进#↑ +0.4射速#获得幽灵眼泪效果"}, -- Wiggle Worm
	[11] = {"11", "环形虫", "眼泪高速螺旋前进#↑ +0.4射速#获得幽灵眼泪效果"}, -- Ring Worm
	[15] = {"15", "幸运石", "摧毁岩石有33%几率掉落硬币"},-- Lucky Rock
	[24] = {"24", "屁股硬币", "捡起硬币时放屁#屁会击退敌人并使敌人中毒"}, -- Butt Penny
	[26] = {"26", "钩形虫", "眼泪直角前进#↑ +0.4射速#↑ +1.5射程#获得幽灵眼泪效果"}, -- Hook Worm
	...
	[96] = {"96", "衔尾虫", "眼泪螺旋式快速前进#↑ +0.4射速#↑ +1.5射程#获得幽灵眼泪效果#几率为跟踪眼泪"}, -- Ouroboros Worm
	...
	[135] = {"135", "打火机", "进入房间时几率对敌人施加燃烧效果"}, --  A Lighter
	[136] = {"136", "损坏的挂锁", "门，钥匙砖和金箱子可以用爆炸打开#也可以打开前往\"家\"的门"}, --  Broken Padlock
	[137] = {"137", "勿忘草", "当进入新一层时，先前层未收集的最多4个掉落物在初始房间生成"}, --  Myosotis
	[138] = {"138", "'M", "使用主动道具会将其重置"}, --  'M
	[139] = {"139", "泪滴护符", "基于运气的眼泪效果产生的几率更大"}, --  Teardrop Charm
	[140] = {"140", "所多玛之果", "捡起红心可将其变成蓝蜘蛛#满血时也有效#效果可能会消耗用于治疗的红心"}, --  Apple of Sodom
	[141] = {"141", "失落摇篮曲", "提高跟班的射速"}, --  Forgotten Lullaby
	[142] = {"142", "伯大尼的信仰", "在每层开始时生成4个 {{Collectible584}} 美德之书灵火"}, --  Beth's Faith
	[143] = {"143", "老旧电容", "阻止主动道具充能#清理房间后几率生成小电池"}, --  Old Capacitor
	[144] = {"144", "脑形虫", "眼泪如果会打不中敌人，则90度转向敌人"}, --  Brain Worm
	[145] = {"145", "满分考卷", "↑ +10运气#持有时受到怪物，尖刺等非主动伤害时摧毁"}, -- Perfection
	[146] = {"146", "恶魔王冠", "{{TreasureRoom}}道具房现在含有恶魔交易"}, --  Devil's Crown
	[147] = {"147", "充能硬币", "捡起硬币时对主动道具充能"}, --  Charged Penny
	...
	[152] = {"152", "望远镜片", "提高星象房基础几率为10%#第一次产生星象房前额外增加15%几率#生成星象房后仍可生成星象房#在第一次进入后几率保持为15%#星象房可在子宫和尸宫生成"}, --  Telescope Lens
	[153] = {"153", "老妈的发髻", "每个房间获得随机老妈道具的效果"}, --  Mom's Lock
	[154] = {"154", "骰子袋", "每次进入新房间，几率获得1个一次性的随机骰子#离开房间后消失"}, --  Dice Bag
	[155] = {"155", "神圣王冠", "在大教堂里生成{{TreasureRoom}}道具房和商店{{Shop}}"}, --  Holy Crown
	[156] = {"156", "母亲的吻", "持有时获得1心之容器#对店主也有效"}, --  Mother's Kiss
	[157] = {"157", "扑克牌残片", "每15次发射，发射1个 {{Collectible149}} 吐根酊+ {{Collectible5}} 我的镜像眼泪，其射程值极高"}, --  Torn Card
	[158] = {"158", "破损的口袋", "受伤时角色掉落2个所持掉落物#(除了：心，卡牌，胶囊，符文)"}, --  Torn Pocket
	[159] = {"159", "镀金钥匙", "+1钥匙#以金箱子替换所有新箱子#所有金箱子包含卡牌，胶囊或饰品#对巨型箱子无效"}, --  Gilded Key
	[160] = {"160", "幸运袋", "到下一层时生成1福袋"}, --  Lucky Sack
	[161] = {"161", "邪恶王冠", "在地狱生成{{TreasureRoom}}道具房和商店{{Shop}}"}, --  Wicked Crown
	[162] = {"162", "阿撒泻勒的残角", "进入新房间时几率变成阿撒泻勒"}, --  Azazel's Stump
	[163] = {"163", "粪蛋", "清理房间后生成2个友好粪滴"}, --  Dingle Berry
	[164] = {"164", "火药圈", "放置炸弹时生成1个额外炸弹"}, --  Ring Cap
	[165] = {"165", "滚啊！", "在子宫或更深层，将所有掉落物以随机掉落物取代#大概率是炸弹和心#没有钥匙"}, --  Nuh Uh!
	[166] = {"166", "塑型黏土", "每个房间获得随机被动道具效果"}, --  Modeling Clay
	[167] = {"167", "抛光骨头", "清理房间后几率生成友好的骷髅仔"}, --  Polished Bone
	[168] = {"168", "空壳心", "进入新一层时+1骨心"}, --  Hollow Heart
	[169] = {"169", "儿童涂鸦", "持有时当做嗝屁猫套装计数"}, --  Kid's Drawing
	[170] = {"170", "水晶钥匙", "清理房间后几率自动创造 {{Collectible580}} 红钥匙房间"}, --  Crystal Key
	[171] = {"171", "店主的协议", "有几率使恶魔交易花费硬币而不是心"}, --  Keeper's Bargain
	...
	[176] = {"176", "小血团", "生成1个血块跟班，模仿角色的行动，发射方向和眼泪效果"}, --  Lil Clot
	[177] = {"177", "纹身贴", "清理怪物挑战房生成1箱子，清理Boss挑战房生成1道具"}, --  Temporary Tattoo
	[178] = {"178", "被吞下的M80鞭炮", "受伤时角色爆炸"}, --  Swallowed M80
	[179] = {"179", "赛车遥控器", "跟班的移动与玩家控制角色的方式一致"}, --  RC Remote
	[180] = {"180", "复得游魂", "精确跟随角色移动的跟班，发射幽灵眼泪#伤害和眼泪效果与角色一致"}, --  Found Soul
	[181] = {"181", "扩展电路板", "使用主动道具时触发另1个随机主动道具"}, --  Expansion Pack
	[182] = {"182", "伯大尼的精华", "进入天使房时生成5魂火#当给乞丐钱时生成1魂火"}, --  Beth's Essence
	[183] = {"183", "双胞胎", "每个房间：#没有跟班：几率获得 {{Collectible8}} 弟弟波比和/或 {{Collectible67}} 妹妹玛姬#有跟班：几率添加跟班的复制"}, --  The Twins
	[184] = {"184", "领养协议书", "商店会卖跟班#跟班永远打折"}, --  Adoption Papers
	[185] = {"185", "蟋蟀腿", "杀死敌人时生成1只随机蝗虫"}, --  Cricket Leg
	[186] = {"186", "亚玻伦的挚友", "生成1只蝗虫跟班，向发射方向冲锋#击中敌人时返回到角色旁"}, --  Apollyon's Best Friend
	[187] = {"187", "碎掉的眼镜", "有33%几率在道具房添加1个额外的问号道具#几率揭示分支路线的问号道具"}, --  Broken Glasses
	[188] = {"188", "冰块", "进入房间时几率石化1个敌人#击杀石化的敌人可将其冻结"}, --  Ice Cube
	[189] = {"189", "巴风特之印", "杀死敌人时产生1秒护盾"}, --  Sigil of Baphomet
}
...
---------- Cards ----------
-- TODO: check if comments match the card names, they were mass copy and pasted

local repCards={
	[2] = {"2", "I - The Magician", "Homing tears and +3 Range for current room"}, -- I - The Magician -- TODO: translate
	[12] = {"12", "XI-力量", "↑ +1心之容器#↑ +0.3伤害#↑ +50%伤害#↑ +5.25射程#↑ +0.3移速#仅所在房间"}, -- XI - Strength
	...
	[52] = {"52", "Huge Growth", "↑ +7 Damage up#↑ +3 Range up#Destroy rocks when walking over them#Size up#Effect lasts for current room"}, -- Huge Growth -- TODO: translate
	[55] = {"55", "符文碎片", "随机符文效果#触发的符文效果较弱"}, -- Rune Shard
	[56] = {"56", "0-愚者？", "将所有心和掉落物掉在地上#只保留半心#如果数量充足，可作为 {{Collectible74}} 25美分和 {{Collectible19}} 嘣！生成"}, -- 0 - The Fool?
	[57] = {"57", "I-魔术师？", "生成较大的光环，排斥弹幕和敌人#持续1分钟"}, -- I - The Magician?
	[58] = {"58", "II-女祭司？", "妈腿持续践踏1分钟"}, -- II - The High Priestess?
	[59] = {"59", "III-皇后？", "获得1分钟效果：#↑ +2红心#↑ +1.35射速"}, -- III - The Empress?
	[60] = {"60", "IV-皇帝？", "传送至额外Boss房，有额外战利品#Boss是从比当前层深两层的Boss"}, -- IV - The Emperor?
	[61] = {"61", "V-教皇？", "生成2骨心"}, -- V - The Hierophant?
	[62] = {"62", "IV-恋人？", "从所在房间的道具池中生成1个道具#将1心之容器或2魂心转化为1碎心"}, -- VI - The Lovers?
	[63] = {"63", "VII-战车？", "变成无敌的固定雕像10秒#期间射速提升"}, -- VII - The Chariot?
	...
	[67] = {"67", "XI-力量？", "房间内的敌人虚弱，减速并受到双倍伤害"}, -- XI - Strength?
	[68] = {"68", "XII-倒吊人？", "将角色变为店主30秒#获得三重射击并降低移速#杀死敌人掉落随机硬币"}, -- XII - The Hanged Man?
	[69] = {"69", "XIII-死亡？", "产生 {{Collectible545}} 死者之书的效果#(所在房间内每杀死1个敌人生成1个骨头实体)"}, -- XIII - Death?
	[70] = {"70", "XIV-节制？", "施加5个随机胶囊效果"}, -- XIV - Temperance?
	[71] = {"71", "XV-恶魔？", "产生 {{Collectible33}} 圣经的效果#获得 {{Collectible390}} 炽天使#持续30秒"}, -- XV - The Devil?
	...
	[75] = {"75", "XIX-太阳？", "获得 {{Collectible159}} 夜之魂#↑ +1.5伤害#在所在层持续#将红心转化为骨心，但效果结束后恢复#施加黑暗诅咒"}, -- XIX - The Sun?
	...
	[85] = {"85", "???的魂石", "产生8团毒气并留下棕色水迹#然后放置7个大便炸弹#站在水迹中会有+1.35射速并+1伤害"}, -- Soul of ???
	[86] = {"86", "夏娃的魂石", "14只死鸟跟班飞入并攻击敌人#所在房间有效"}, -- Soul of Eve
	[87] = {"87", "参孙的魂石", "变成狂暴参孙，使用近战攻击10秒#↑ +0.4移速#↑ 射速提升#↑ +3伤害"}, -- Soul of Samson
	[88] = {"88", "阿撒泻勒的魂石", "产生{{Collectible441}}超级吐息的效果7.5秒"}, -- Soul of Azazel
	...
	[97] = {"97", "雅各与以扫的魂石", "所在房间生成以扫作为临时第二角色"}, -- Soul of Jacob and Esau
}
...
EID.descriptions[languageCode].tarotClothBuffs = {
	[2] = {"2", "", "同时获得 {{Collectible34}} 彼列之书效果"}, -- I - The Magician
	[3] = {"3", "", "第一只脚落下后马上落下第二只"}, -- II - The High Priestess
	[4] = {"4", "", "属性提升量为4倍"}, -- III - The Empress
	[5] = {"5", "", "如果Boss尚未击败，传送时获得1魂心"}, -- IV - The Emperor
	[6] = {"6", "", "生成3魂心"}, -- V - The Hierophant
	[7] = {"7", "", "生成3红心"}, -- VI - The Lovers
	[8] = {"8", "", "双倍持续时间"}, -- VII - The Chariot
	[9] = {"9", "", "双倍掉落物生成"}, -- VIII - Justice
	[10] = {"10", "", "阻止贪婪在商店生成#如果已与贪婪战斗过，将商店变成普通的商店"}, -- IX - The Hermit
	[11] = {"11", "", "生成2台赌博机"}, -- X - Wheel of Fortune
	[12] = {"12", "", "属性提升量翻倍，伤害倍数除外"}, -- XI - Strength
	[14] = {"14", "", "造成80伤害"}, -- XIII - Death
	[15] = {"15", "", "生成2台献血机"}, -- XIV - Temperance
	[16] = {"16", "", "伤害提升量翻倍"}, -- XV - The Devil
	[17] = {"17", "", "生成12个即爆炸弹"}, -- XVI - The Tower
	[18] = {"18", "", "如果道具房尚未进入过，产生2道具以供选择"}, -- XVII - The Stars
	[21] = {"21", "", "生成2个乞丐"}, -- XX - Judgement
	[56] = {"56", "", "掉落所有道具和掉落物，包括塔罗牌外衣"}, -- 0 - The Fool?
	[59] = {"59", "", "获得3临时的心之容器"}, -- III - The Empress?
	[61] = {"61", "", "生成6骨心"}, -- V - The Hierophant?
	[62] = {"62", "", "添加4碎心并生成4道具"}, -- VI - The Lovers?
	[64] = {"64", "", "生成4-14个金箱子"}, -- VIII - Justice?
	[70] = {"70", "", "吃下20胶囊"}, -- XIV - Temperance?
	[72] = {"72", "", "生成14岩石堆"}, -- XVI - The Tower?
	[73] = {"73", "", "移除2道具并生成4道具"}, -- XVII - The Stars?
	[76] = {"76", "", "生成2台补货机"}, -- XX - Judgement?
}
...
local repPills={
	...
	[12] = {"11", "射程下降", "↓ -0.6射程"}, -- Range Down
	[13] = {"12", "射程上升", "↑ +0.75射程"}, -- Range Up
...
-- TODO: check if comments match the horse pill names, they were mass copy and pasted
-- Also, the "TODO" comments on the following lines are from the original author
EID.descriptions[languageCode].horsepills={
	...
	{"11", "射程下降", "↓ -1.2射程"}, -- Range Down
	{"12", "射程上升", "↑ +0.9射程"}, -- Range Up
	{"13", "移速下降", "↓ -0.24移速"}, -- Speed Down
	{"14", "移速上升", "↑ +0.3移速"}, -- Speed Up
	{"15", "射速下降", "↓ -0.56射速"}, -- Tears Down
	{"16", "射速上升", "↑ +0.70射速"}, -- Tears Up
	{"17", "运气下降", "↓ -2运气"}, -- Luck Down
	{"18", "运气上升", "↑ +2运气"}, -- Luck Up
	{"19", "传送胶囊", "传送到随机房间"}, -- Telepills -- TODO
	{"20", "48小时能量！", "对主动道具充能#生成更多电池"}, -- 48 Hour Energy! -- TODO
	{"21", "呕血", "清空红心但保留1红心#生成更多红心"}, -- Hematemesis -- TODO
	{"22", "麻痹", "不能移动4秒"}, -- Paralysis
	{"23", "我能永远看清！", "打开当前层所有隐藏房间的入口#揭示全图"}, -- I can see forever!
	{"24", "信息素", "将房间内所有敌人永久变成友好的"}, -- Pheromones
	{"25", "失忆症", "隐藏当前层地图"}, -- Amnesia -- TODO
	{"26", "柠檬派对", "生成满房间的水迹并对敌人造成接触伤害"}, -- Lemon Party
	{"27", "你是巫师吗？", "进行斜角射击60秒"}, -- R U a Wizard?
	{"28", "止痛药！", "所在房间受到的伤害减半"},  -- Percs! -- TODO
	{"29", "上瘾！", "所在房间受到的伤害为整心"}, -- Addicted! -- TODO
	{"30", "放-松", "移动生成便便4秒"}, -- Re-Lax -- TODO
	{"31", "？？？", "当前层施加迷惑诅咒的效果"}, -- ??? -- TODO
	...
	{"36", "大力丸！", "短时间无敌#↑ +7伤害#↑ +3射程#所在房间持续"}, -- Power Pill!
	...
	{"41", "好困…", "使房间内所有敌人减速"}, -- I'm Drowsy... -- TODO
	{"42", "好兴奋！！！", "使房间内所有敌人加速"}, --I'm Excited!!! -- TODO
	{"43", "咕噜！", "消耗当前饰品并永久获得其效果"}, -- Gulp! -- TODO
	{"44", "呕！", "发射1串吐根眼泪"}, -- Horf!
...
EID.descriptions[languageCode].CraftingResults =  "(滚动：按住 {{CONFIG_BoC_Toggle}} + {{ButtonY}} {{ButtonA}}，#锁定：{{ButtonX}}，刷新：{{ButtonB}})"
