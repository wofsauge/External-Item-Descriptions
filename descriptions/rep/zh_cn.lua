...
local repCollectibles={
	...
	[41] = {"41", "妈妈的卫生巾", "{{Fear}} 恐惧所在房间内所有敌人5秒#使用时生成一只蓝苍蝇"},
	...
	[144] = {"144", "乞丐朋友", "拾取硬币并给予奖励#可能生成{{Heart}}，{{Bomb}}，{{Key}}，{{Card}}，{{Pill}}，{{Battery}}，饰品和乞丐道具池道具"}, -- Bum Friend
