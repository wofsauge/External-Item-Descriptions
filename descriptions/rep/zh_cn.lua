...
local repCollectibles={
	...
	[83] = {"83", "钉子", "{{BlackHeart}} +半黑心#在当前房间获得：#↑ {{Damage}} +2.0伤害#↓ {{Speed}} -0.18移速#造成每秒1次40点接触伤害#粉碎经过的岩石"}, -- The Nail
	...
	[605] = {"605", "挖眼勺", "在当前房间召唤1个眼球跟班，在地上生成血迹#↑ {{Damage}} 右眼眼泪伤害+34%"}, --  The Scooper
	...
	[650] = {"650", "糖梅溜溜笛", "使用时，在所在房间召唤1只甜蝇宝宝，持续10秒"}, --  Plum Flute
	...
	[713] = {"713", "圣血吸管", "移除半心并创造1个血凝块跟班#每种心的产生的血凝块的血量，伤害和眼泪效果不同"}, --  Sumptorium
