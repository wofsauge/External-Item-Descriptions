...
local repCollectibles={
	...
	[29] = {"29", "妈妈的内裤", "↑ {{Range}} +1.5射程#生成3-6只蓝苍蝇"}, -- Moms Underwear
	[30] = {"30", "妈妈的高跟鞋", "↑ {{Range}} +1.5射程#能对敌人造成12接触伤害"}, -- Mom's Heels
	[31] = {"31", "妈妈的口红", "↑ {{Range}} +2.25射程#{{UnknownHeart}} 生成1随机心"}, -- Mom's Lipstick
	...
	[52] = {"52", "胎儿博士", "{{Bomb}} 炸弹眼泪#{{Damage}} 每个炸弹造成1000%角色伤害#{{Damage}} 如果结果超过60伤害，改为造成30.0+500%角色伤害#↓ {{Tears}} -60%射速修正"}, --Dr. Fetus
	...
	[110] = {"110", "妈妈的美瞳", "20%几率发射石化眼泪#↑ {{Range}} +0.38射程"}, -- Mom's Contacts
	...
	[274] = {"274", "生死之交", "受伤时获得1个中范围环绕物#环绕物每秒造成150接触伤害"}, -- Best Bud
	...
	[308] = {"308", "宝瓶座", "留下水迹#{{Damage}} 水迹每秒造成66%的角色伤害的接触伤害#水迹与眼泪效果有协同效应"}, -- Aquarius
	...
	[355] = {"355", "妈妈的珍珠项链", "↑ {{Range}} +0.38射程#↑ {{Luck}} +1运气#{{SoulHeart}} +1魂心"}, -- Mom's Pearls
	...
	[384] = {"384", "肉山宝宝", "{{Chargeable}} 会蓄力发射并在房间内滑动#每次撞击造成5-20接触伤害，与蓄力时间有关"}, -- Lil Gurdy
	...
	[397] = {"397", "牵引光束", "角色的眼泪现在受光束指引，与角色一起移动#↑ {{Tears}} +1.0射速修正#↑ {{Range}} +1.5射程#↑ {{Shotspeed}} +0.16弹速"}, -- Tractor Beam
	...
	[436] = {"436", "牛奶！", "↑ 受伤后，在所在房间获得+1射速修正"}, -- Milk!
	...
	[455] = {"455", "爸爸丢失的硬币", "↑ {{Range}} +0.38射程#生成1幸运硬币"},
	...
	[579] = {"579", "英灵剑", "攻击方式改为挥剑#{{Damage}} 每次挥舞造成3.5+300%角色伤害#{{Chargeable}} 可蓄力发动旋转攻击，造成10.0+800%角色伤害，同时发射造成4.0+400%角色伤害的剑气#{{Damage}} 总心数大于心之容器数时，挥剑会发射造成2.0+100%角色伤害的剑气"}, --  Spirit Sword
	...
	[615] = {"615", "屁球宝宝", "放屁跟班#被击中时放屁，对敌人有伤害，击退，击晕或中毒的效果"}, --  Lil Dumpy
