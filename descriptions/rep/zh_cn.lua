...
local repCollectibles={
	...
	[12] = {"12", "魔法蘑菇", "↑ +1心之容器#满心#↑ {{Damage}} +0.3伤害#↑ {{Damage}} +50%伤害倍数#↑ {{Range}} +2.5射程#↑ {{Speed}} +0.3移速#体型变大"}, -- Magic Mushroom
	...
	[442] = {"442", "黑王子之冠", "!!! 仅有1红心时：#↑ {{Tears}} +2射速修正#↑ {{Range}} +2.5射程#↑ {{Shotspeed}} +0.2弹速#对无法获得红心的角色无效"}, -- Dark Princes Crown
	...
	[455] = {"455", "爸爸丢失的硬币", "↑ {{Range}} +1.5射程#生成1幸运硬币"},
