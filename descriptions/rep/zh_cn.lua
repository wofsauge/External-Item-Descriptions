...
local repCollectibles={
	...
	[497] = {"497", "迷彩内裤", "{{Confusion}} 进入房间时, 使所有敌人混乱并使角色伪装, 直到角色开始发射#↑ {{Speed}} 伪装时移速+0.5#解除伪装时, 对角色周围造成伤害, 并获得非常短暂的射速修正和伤害提升"}, -- Camo Undies
	...
	[677] = {"677", "灵魂出窍", "{{Timer}} 在有敌人的房间中首次受伤时, 获得:#灵体泪弹#飞行#抵消下次伤害#时间暂停2秒#2秒内大幅提升移速和射速修正"}, --  Astral Projection
