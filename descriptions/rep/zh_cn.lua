...
local repCollectibles={
	...
	[42] = {"42", "鲍勃的烂头", "{{Poison}} 可投掷的有毒炸弹#{{Damage}} 造成185+角色伤害#产生毒气"}, -- Bob's Rotten Head
	...
	[114] = {"114", "老妈的菜刀", "用可控制的刀攻击#{{Damage}} 菜刀对接触的敌人每秒造成20次伤害#{{Damage}} 菜刀的伤害与蓄力时间成正比：未蓄力(未发射)时造成200%角色伤害，蓄力至约1/3时达到最大的600%角色伤害#进一步蓄力仅增加菜刀射程"}, -- Mom's Contacts
	...
	[308] = {"308", "水瓶座", "留下水迹#{{Damage}} 水迹每秒造成66%的角色伤害的接触伤害#水迹与眼泪效果有协同效应"}, -- Aquarius
	[309] =	{"309", "双鱼座", "↑ {{Tears}} +0.5射速修正#提高眼泪击退力"},
	[310] =	{"310", "夏娃的睫毛膏", "↑ {{Damage}} +100%伤害#↓ {{Tears}} -33%射速修正#↓ {{Shotspeed}} -0.5弹速"},
	[311] = {"311", "犹大之影", "死后以{{Player12}}黑暗犹大重生#{{Damage}} 犹大之影拥有200%伤害修正#{{Player24}} 堕化犹大复活为其自身"},
	...
	[399] = {"399", "虚空之喉", "{{Chargeable}} 连续射击2.4秒后，角色头上会出现红交叉。释放攻击键会产生1圈黑硫磺火环，持续2秒#{{Damage}} 火环共造成30次100%角色伤害"}, -- Maw of the Void
	[401] = {"401", "爆炸物", "25%几率发射粘性炸弹眼泪#{{Damage}} 几秒后爆炸并造成角色伤害+60的伤害#{{Luck}} 不受运气影响"}, -- Explosivo
	...
	[459] = {"459", "鼻窦炎", "20%几率发射粘性有毒眼泪#{{Luck}} 不受运气影响#{{Damage}} 每秒造成角色伤害#能粘住10秒"}, -- Sinus Infection
	...
	[552] =	{"552", "老妈的铲子", "生成通往下一层的活板门# 在有装饰(草、碎石、骷颅头等)的地板上使用则改为生成{{LadderRoom}}一个暗门#!!! 在\"暗室\"的土丘上使用铲子#!!! 解锁某个很酷的东西"}, -- Brittle Bones
	...
	[585] = {"585", "白玉香膏盒", "使用时生成3{{SoulHeart}}魂心和2个{{AngelRoom}}天使房道具#只能通过捡起魂心充能#{{DevilChance}} 若已进行过恶魔交易，则生成2{{SoulHeart}}魂心和1{{AngelRoom}}个天使房道具"}, --  Alabaster Box
	[586] = {"586", "天堂阶梯", "{{AngelRoom}} 在每一层的初始房间生成梯子，通向1个特殊的天使房道具商店"}, --  The Stairway
	[587] = {"587", "", "<道具不存在>"}, -- Menorah (Unused but skripted)
	[588] = {"588", "太阳", "揭示{{BossRoom}}Boss房位置#击败Boss后在所在层获得：# 激发卡牌“太阳”的效果#{{Battery}} 为主动道具充能#{{CurseBlind}} 移除诅咒#↑ {{Damage}} +3.0伤害#↑ {{Luck}} +1运气"}, --  Sol
	...
	[599] = {"599", "巫毒娃娃头", "每层额外生成1个{{CursedRoom}}诅咒房#升级{{CursedRoom}}诅咒房的布局"}, --  Voodoo Head
	...
	[643] = {"643", "终末天启", "{{Chargeable}} 连续发射眼泪2.4秒可蓄力发射持续1.3秒神圣光柱#{{Damage}} 光柱造成15次100%角色伤害#获得飞行能力#{{SoulHeart}} +2魂心"}, --  Revelation
	...
	[673] = {"673", "赎罪", "{{DevilChance}} 进入恶魔房间但不捡任何物品时，于下一层获得：#{{SoulHeart}} +1魂心#↑ {{Damage}} +1.0伤害"}, --  Redemption
	...
	[726] = {"726", "咯血症", "双击发射键咯血#{{Damage}} 对前方的敌人造成1.5倍角色伤害#1秒冷却时间#{{BrimstoneCurse}} 被击中的敌人会受到硫磺火束的额外伤害"}, --  Hemoptysis
...
local repTrinkets={
	...
	[98] = {"98", "鼻涕泡", "10%几率发射跟踪粘性有毒眼泪#{{Damage}} 每秒造成角色伤害#能粘住10秒"}, -- Nose Goblin
