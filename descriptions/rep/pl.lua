...
---------- Trinkets ----------
local repTrinkets={
	[1] = {"1", "Swallowed Penny", "Upuszcza 1 monetę, kiedy dostajesz obrażenia#0-1, gdy grasz Dozorcą/Keeperem"}, -- Swallowed Penny
	[10] = {"10", "Wiggle Worm", "Falujące łzy#↑ +0.4 Szybkostrzelności#Gwarantuje widmowe łzy"}, -- Wiggle Worm
	[11] = {"11", "Ring Worm", "Łzy poruszają się spiralnie z dużą prędkością#Gwarantuje widmowe łzy"}, -- Ring Worm
	[15] = {"15", "Lucky Rock", "33% szans na upuszczenie monety, gdy rozwalasz kamienie"},-- Lucky Rock
	[24] = {"24", "Butt Penny", "Pierdzisz kiedy podnosisz monety#Pierd odrzuca i truje przeciwników"}, -- Butt Penny
	[26] = {"26", "Hook Worm", "Łzy poruszają się pod kątem#↑ +10 Zasięgu#Gwarantuje widmowe łzy"}, -- Hook Worm
	[32] = {"32", "Liberty Cap", "Losowy efekt grzyba co pokój"}, -- Liberty Cap
	[33] = {"33", "Umbilical Cord", "Wchodząc do pokoju z połową czerwonego serca lub mniej, otrzymujesz Małego Steven'a#Duża szansa na pojawienie się sojusznika Gemini, gdy dostajesz obrażenia"}, -- Umbilical Cord
	[48] = {"48", "A Missing Page", "Gdy otrzymasz obrażenia, szansa na zadanie obrażeń wszystkim w pokoju#Czarne serca i efekt {{Collectible35}}Necronomicon'u zadaje podwójne obrażenia"}, -- A Missing Page
	[49] = {"49", "Bloody Penny", "25% szans na upuszczenie połowy serca, gdy podniesiesz monetę"}, -- Bloody Penny
	[50] = {"50", "Burnt Penny", "25% szans na upuszczenie bomby, gdy podniesiesz monetę"}, -- Burnt Penny
	[51] = {"51", "Flat Penny", "25% szans na upuszczenie klucza, gdy podniesiesz monetę"}, -- Flat Penny
	...
	[155] = {"155", "Holy Crown", "Pokój Skarbów{{TreasureRoom}} pojawia się w Katedrze"}, --  Holy Crown
	...
	[159] = {"159", "Gilded Key", "Zamienia wszystkie nowe skrzynki w Złote Skrzynki#Wyjątek: Olbrzymia Skrzynia"}, --  Gilded Key
	[160] = {"160", "Lucky Sack", "Pojawia Worek po podróży na kolejny poziom"}, --  Lucky Sack
	[161] = {"161", "Wicked Crown", "Pokój Skarbów{{TreasureRoom}} pojawia się w Szeolu"}, --  Wicked Crown
	...
	[170] = {"170", "Crystal Key", "Gwarantuje szansę na automatyczne stworzenie pokoju Czerwonym Kluczem{{Collectible580}}"}, --  Crystal Key
	...
	[186] = {"186", "Apollyon's Best Friend", "{{Throwable}} {{ColorOrange}}Do rzucania{{CR}} (podwójne kliknięcie przycisku strzału)#Gwarantuje 2 sojusznicze muchy, którymi możemy celować i strzelać"}, --  Apollyon's Best Friend
