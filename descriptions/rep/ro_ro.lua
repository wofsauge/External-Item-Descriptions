...
EID.descriptions[languageCode].bookOfVirtuesWisps = {
	...
	[56] = "Musculițe de mijloc {{MiddleWisp}}#Lacrimi rapide cu rază de atac mică#Musculițele lasă o baltă galbenă", -- Lemon Mishap
	...
	[556] = "Musculițe de mijloc {{MiddleWisp}}#Lacrimi {{Collectible118}} Brimstone cu rază de atac scăzută", -- Sulfur
...
local repTrinkets={
	...
	[26] = {"26", "Ancylostoma", "↑ {{Tears}} +0.4 Lacrimi#↑ {{Range}} +1.5 Rază de atac#Lacrimi Spectrale#Lacrimile lui Isac se mișcă triunghiular"}, -- Hook Worm
	...
	[96] = {"96", "Ouroboros Worm", "↑ +0.4 Lacrimi#↑ {{Range}} +1.5 Rază de atac#Lacrimi spectrale#Șansă pentru lacrimi balistice#{{Luck}} 100% Sansă la 9 noroc#Lacrimile lui Isac se mișcă rapid și spiralat"}, -- Ouroboros Worm
	...
	[157] = {"157", "Carte Ruptă", "La fiecare 15 lacrimi Isac aruncă o lacrimă {{Collectible149}} Ipecac + {{Collectible5}} Reflecția Mea cu rază de atac mare"}, -- Torn Card
...
local repCards={
	...
	[12] = {"12", "XI - Forța", "{{Timer}} Pe durata camerei:#↑ {{Heart}} +1 Inimă#↑ {{Speed}} +0.3 Viteză#↑ {{Damage}} +0.3 Daune#↑ {{Damage}} x1.5 Daune#↑ {{Range}} +2.5 Rază de atac"}, -- XI - Strength
