...
local repTrinkets={
	...
	[98] = {"98", "Muci de Goblin", "10% șansă să arunci cu muci#50% să fie balistică#{{Damage}} Mucii provoacă pagubele lui Isac o dată pe secundă#Mucii stau lipiți 10 secunde"}, -- Nose Goblin
