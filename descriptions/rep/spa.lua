...
local repCollectibles={
	...
	[140] = {"140", "Maldición de Bob", "{{Poison}} Bombas venenosas#+5 bombas#Las bombas dejan una nube de veneno"}, -- Maldición de Bob
	...
	[182] = {"182", "Corazón sagrado", "Lágrimas teledirigidas#↑ +1 de vida#↓ {{Tears}} Lágrimas -0.4#↑ {{Damage}} Daño +1 x 230%#↑ {{Range}} Alcance +0.5#↓ {{Shotspeed}} Vel. de tiro -0.25"},
	...
	[227] = {"227", "El Cochinito", "{{Coin}} +3 monedas#Genera una o dos monedas cuando te golpean#Genera 0 o 1 con Keeper"},
	[228] = {"228", "Perfume de Mamá", "↑ {{Tears}} Lágrimas +0.50 (puede sobrepasar el valor límite)#Las lágrimas asustan a los enemigos"},
	[230] = {"230", "Abadón", "↑ {{Damage}} Daño +1.5#↑ {{Speed}} Velocidad +0.2#Las lágrimas asustan#↓ Convierte todos los corazones rojos en corazones negros#↑ {{BlackHeart}} +2 corazones negros"}, -- Abadón
	[232] = {"232", "Cronómetro", "Efecto ralentizante permanente para los enemigos#↑ {{Speed}} Velocidad +0.3"}, -- Cronómetro
	...
	[259] = {"259", "Materia oscura", "↑ {{Damage}} Daño +1#Las lágrimas asustan a los enemigos"},
	[260] = {"260", "Vela negra", "Inmune a las maldiciones#↑ {{BlackHeart}} +1 corazón negro#{{DevilChance}}/{{AngelChance}} Más probabilidad de que aparezcan las salas del Diablo o del Ángel{"},
	...
	[292] = {"292", "Biblia satánica", "+1 {{BlackHeart}} corazón negro#Si se usa antes de la pelea contra el jefe, el objeto de la habitación será un pacto con el diablo"}, -- Biblia satánica
	...
	[370] = {"370", "Sr. muñequita", "↑ {{Tears}} Lágrimas +0.7#↑ {{Range}} Alcance +1.5#↑ Tamaño de lágrimas +0.5#{{Heart}} Genera 3 corazones aleatorios al tomarlo"}, -- Mr. Dolly
	...
	[394] = {"394", "En la Mira", "Dispara lágrimas automáticamente dirigidas por la cruz roja del suelo que puedes controlar#↑ {{Tears}} Lágrimas +0.7#↑ {{Range}} Alcance +3.0#↑ Tamaño de lágrimas +0.3#Los familiares disparan hacia la cruz"},
	[395] = {"395", "Tecnología X", "{{Chargable}} Cargable#Disparas anillos láser que viajan a través de la habitación#Daño basado en la carga#100% de daño al cargarlo al completo"}, -- Tecnología X
	...
	[443] = {"443", "¡Manzana!", "Dispara cuchillas que infligen un 400 % de daño de manera aleatoria#↑ {{Tears}} +0,3 de lágrimas"},
	...
	[513] = {"513", "Bozo", "↑ {{Damage}} Daño +0.1#↑ {{SoulHeart}} +1 corazón de alma#Posibilidad de encantar/asustar a un enemigo#Posibilidad de generar una caca arcoíris al ser golpeado"},
	...
	[547] = {"547", "Papeles del divorcio", "↑ {{BoneHeart}} +1 un corazón de hueso#↑ {{Tears}} Lágrimas +0.7#Genera el trinket Papel misterioso"},
	[549] = {"549", "Huesos frágiles", "Remplaza todos los contenedores de corazón por 6 corazones de hueso#Perder un corazón de hueso dispara lágrimas en todas las direcciones#↑ {{Tears}} Lágrimas +0.5"},
	...
	[597] = {"597", "Neptuno", "{{Chargable}} Cargable (Automático)#Al no disparar, se empezará a cargar un ataque#Disparar hará que sueltes una ráfaga de lágrimas hasta que dispares a tu cadencia regular#Dejar de disparar recargará el ataque"}, --  Neptuno
	...
	[664] = {"664", "Comedor compulsivo", "+1 corazón rojo#Los pedestales de objetos cambiarán periódicamente entre objetos de comida y otro objeto#tomar el objeto de comida otorga una mejor a temporal de daño de +3,6 de daño y 2 pequeñas mejoras de estadísticas"}, --  Comedor compulsivo
	...
	[673] = {"673", "Redención", "Garantiza 1 corazón de alma y +1,0 de daño al entrar a la sala del pacto con el diablo y salir sin tomar un objeto"}, --  Redención
	...
	[678] = {"678", "Cesárea", "{{Chargable}} Cargable#Dispararás fetos automáticamente al presionar el botón de disparo#Los getos seguirán a los enemigos y los atacarán varias veces"}, --  Sección C
	...
	[686] = {"686", "Relicario del alma", "Otorga una mejora de estadística permanente al tomar corazones de alma#Genera un corazón de alma al tomarlo"}, --  Relicario del alma
	...
	[700] = {"700", "Caja de eco", "Cuando usas una carta, píldora o runa, también usas una copia de todas las cartas, píldoras y runas que hayas usado tras tomar el objeto"}, --  Caja de eco
...
local repTrinkets={
	...
	[49] = {"49", "Moneda sangrienta", "25 % de posibilidad de dejar caer medio corazón al tomar monedas"}, -- Moneda sangrienta
	[50] = {"50", "Moneda quemada", "25 % de posibilidad de dejar una bomba al tomar monedas"}, -- Moneda quemada
	[51] = {"51", "Moneda plana", "25 % de posibilidad de dejar una llave al tomar monedas"}, -- Moneda plana
	...
	[140] = {"140", "Manzana de Sodoma", "Tomar corazones rojos puede convertirlos en arañas azules#Funciona incluso si tienes vida al completo#Puede tragarse corazones que necesitas para curarte"}, --  Manzana de Sodoma
	...
	[147] = {"147", "Moneda cargada", "Toger monedas puede cargar el objeto activable"}, --  Moneda cargada
