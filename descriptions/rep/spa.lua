...
local repCollectibles={
	...
	[121] = {"121", "Hongo Raro (Largo)", "↑ {{Heart}} +1 de Vida#↓ {{Speed}} Velocidad -0.2#↑ {{Damage}} Daño +1#↑ {{Range}} Alcance +1.5#↓ {{Speed}} Velocidad -0.2"}, -- Champiñón raro (grande)
	...
	[214] = {"214", "Anémico", "↑ {{Range}} Alcance +1.5#{{Timer}} Cuando te golpean, deja un rastro de fluido en el suelo durante la habitación#El fluido inflige 6 de daño cada segundo"}, -- Anemic
	...
	[219] = {"219", "Vendaje Viejo", "↑ {{EmptyHeart}} +1 Contenedor de corazón vacío#{{Heart}} 20% de probabilidad de soltar un corazón rojo al recibir daño"}, -- Old Bandage
	...
	[504] = {"504", "Nugget café", "Genera una mosca torreta que dispara a los enemigos#Cada disparo inflige 3.5 de daño"}, -- Pepita marrón
...
local repTrinkets={
	...
	[63] = {"63", "Tijeras de Seguridad", "{{Bomb}} Convierte las bombas troll en bombas recolectables#También te permite recoger giga bombas"}, -- Safety Scissors
	...
	[90] = {"90", "Detonador café", "La caca explota al ser destruida, infligiendo 100 de daño#No afecta a cacas rojas"}, -- Brown Cap
	...
	[98] = {"98", "Duende de Naríz", "5% de probabilidad de disparar lágrimas de moco#{{Damage}} Los mocos infligen tu daño una vez cada segundo#Los mocos se pegan durante 10 segundos#50% de probabilidad de que los mocos sean teledirijidos"}, -- Nose Goblin
