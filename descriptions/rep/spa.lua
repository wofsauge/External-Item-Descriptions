...
local repCollectibles={
	...
	[5] = {"5", "Mi reflejo", "Lágrimas con efecto boomerang#↑ {{Damage}} Daño +1.5#↑ {{Range}} Alcance +1.5#↑ {{Range}} Alcance x2#↑ {{Shotspeed}} Vel. de lágrimas x1.6#↓ {{Luck}} Suerte -1"}, -- My Reflection
	[6] = {"6", "Número 1", "↑ {{Tears}} Lágrimas +1.5#↓ {{Range}} Alcance -1.5#↓ {{Range}} Alcance x0.8"}, -- Number One
	[12] = {"12", "Hongo mágico", "↑ {{Heart}} +1 de Vida#↑ {{Speed}} Velocidad +0.3#↑ {{Damage}} Daño +0.3#↑ {{Damage}} Daño x1.5#↑ {{Range}} Alcance +2.5#{{HealingRed}} Vida al maximo"},  -- Magic Mushroom
	[13] = {"13", "El virus", "↑ {{Speed}} Velocidad +0.2#{{Poison}} Tocar enemigos los envenena#Isaac inflige 48 de daño por contacto cada segundo"}, -- The Virus
	[14] = {"14", "Furia por esteroides", "↑ {{Speed}} Velocidad +0.3#↑ {{Range}} Alcance +2.5"}, -- Roid Rage
	[18] = {"18", "El dólar", "↑ {{Coin}} +100 monedas"}, -- A Dollar
	...
	[31] = {"31", "Pintalabios de Mamá", "↑ {{Range}} Alcance +3.75#{{UnknownHeart}} Genera un corazón aleatorio"}, -- Mom's Lipstick
	[37] = {"37", "Sr. Buum", "Genera una gran bomba a tus pies que inflige 185 de daño"}, -- Mr. Boom
	[40] = {"40", "¡Kamikaze!", "Provoca una gran explosión en la ubicación del jugador#Inflige 185 de daño#{{Warning}} La explosión también lastima a Isaac"}, -- Kamikaze!
	...
	[49] = {"49", "Kamehame... ¡¿Eeeeeeh?!", "Reemplaza el siguiente disparo por un rayo#Inflige x24 Isaac's damage over 0.83 segundos"}, -- Shoop da Whoop!
	...
	[53] = {"53", "Imán", "Acerca los recolectables al jugador#Abre cofres a distancia, ignorando el daño de los cofres de pinchos"}, -- Magneto
	...
	[62] = {"62", "Encanto del vampiro", "↑ {{Damage}} Daño +0.3#{{HealingRed}} Cura medio corazón cada 13 enemigos asesinados"}, -- Charm of the Vampire
	[67] = {"67", "Hermana Maggy", "Familiar de lágrimas normales#Inflige 5 de daño"}, -- Hermana Maggy
	[69] = {"69", "Batido de chocolate", "{{Chargeable}} Permite cargar las lágrimas#↑ {{Damage}} El daño escala con la carga hasta un 400%"}, -- Chocolate Milk
	[70] = {"70", "Hormonas de crecimiento", "↑ {{Speed}} Velocidad +0.2#↑ {{Damage}} Daño +1"}, -- Hormonas de crecimiento
	[71] = {"71", "Mini Champi", "↑ {{Speed}} Velocidad +0.3#↑ {{Range}} Alcance +1.5# ↑ Te haces más pequeño"}, -- Mini Mush
	[72] = {"72", "Rosario", "↑ {{Tears}} Lágrimas +0.5#{{SoulHeart}} +3 corazones de alma#{{Collectible33}} La Biblia se vuelve más común"}, -- Rosario
	[78] = {"78", "Libro de Revelaciones", "{{SoulHeart}} +1 corazón de alma#↑ {{AngelDevilChance}} +17.5% de probabilidad de generar salas de Angel/Diablo#Reemplaza al jefe del piso por un jinete al usarlo"}, -- Book of Revelations
	...
	[84] = {"84", "¡Necesitamos Ir Más Profundo!", "Genera una trampilla para saltar el piso#{{LadderRoom}} Genera una trampilla a una mazmorra al usarla sobre la decoración del suelo"}, -- We Need To Go Deeper!
	...
	[91] = {"91", "Sombrero de espeleólogo", "Revela el tipo de las salas adyacentes a la actual#{{SecretRoom}} {{SuperSecretRoom}} Revela Salas secretas y salas súper secretas#Evita el daño de projectiles que caigan desde arriba"}, -- Spelunker Hat
	...
	[107] = {"107", "Las Tijeras Dentadas", "{{Timer}} Recibes por la habitación:#Vuela#Tu cuerpo se separa y ataca los enemigos#Tu cuerpo inflige 23.5 de daño por contacto cada segundo"}, -- The Pinking Shears
	...
	[114] = {"114", "Cuchillo de mamá", "{{Chargeable}} Recargable#Los disparos del jugador son reemplazados por un cuchillo#{{Damage}} Al tenerlo en la mano inflige tu daño x2, hasta x6 con 1/3 de carga#Cargar más el ataque sólo aumentará el alcance#El daño vuelve a x2 al regresar"}, -- Mom's Knife
	[115] = {"115", "Tabla Ouija", "↑ {{Tears}} Lágrimas +0.4#Lágrimas espectrales"},
	...
	[121] = {"121", "Hongo raro (grande)", "↑ {{Heart}} +1 de Vida#↓ {{Speed}} Velocidad -0.2#↑ {{Damage}} Daño +1#↑ {{Range}} Alcance +1.5#↓ {{Speed}} Velocidad -0.2"}, -- Champiñón raro (grande)
	[123] = {"123", "Manual de monstruos", "Genera un familiar aleatorio para este piso"}, -- Manual de monstruos
	[126] = {"126", "Hoja de Afeitar", "↑ {{Damage}} Daño +1.2 durante la sala#{{Warning}} Inflige 1 corazón de daño al usarlo#Tras el primer uso en la sala, sólo removerá medio corazón#{{Heart}} Remueve primero los corazones rojos"}, -- Razor Blade
	...
	[142] = {"142", "Escapulario", "Si te dañan al tener medio corazón:#{{SoulHeart]] Ganas 1 corazón de alma (por habitación)#{{Warning}} No se activa con las [[DonationMachine}} máquinas de donación"}, -- Escapulario
	...
	[148] = {"148", "Infestación", "Genera 2-6 moscas tras recibir daño"}, -- Infestación
	[149] = {"149", "Ipecacuana", "↑ {{Damage}} Daño +40#↓ {{Tears}} Lágrimas x0.33#↓ {{Range}} Alcance x0.8#↓ {{Shotspeed}} Vel. de lágrimas -0.2#Lágrimas explosivas#{{Poison}} Lágrimas venenosas"}, -- Ipecac
	[152] = {"152", "Tecnología 2", "↓ {{Tears}} Lágrimas x0.67#Reemplaza tu ojo derecho con un laser permanente#{{Damage}} El laser inflige 2 veces tu daño cada segundo"}, -- Technology 2
	[153] = {"153", "Araña mutante", "↓ {{Tears}} Lágrimas x0.42#¡Disparo cuádruple!"}, -- Araña mutante
	...
	[158] = {"158", "Bola de cristal", "Puede generar:#{{SoulHeart}} Un Corazón de Alma, {{Rune}} runa o {{Card}} carta#{{Timer}} Revela el mapa del piso (excepto {{SuperSecretRoom}}{{UltraSecretRoom}} las habitaciones Super/Ultra Secretas)#Mientras lo tienes:#↑ {{PlanetariumChance}} Posibilidad de planetarios +15%#↑ {{PlanetariumChance}} Posibilidad de planetarios +100% si te saltas la habitación del tesoro"}, -- Crystal Ball
	[169] = {"169", "Polifemo", "¡Mega lágrimas!#↑ {{Damage}} Daño +4#↑ {{Damage}} Daño x2#↓ {{Tears}} Lágrimas x0.42"}, -- Polyphemus
	...
	[172] = {"172", "Daga de Sacrificio", "Cuchillo orbital#Bloquea disparos enemigos#Inflige 112.5 de daño cada segundo"}, -- Sacrificial Dagger
	[173] = {"173", "Mitra", "{{SoulHeart}} 33% de probabilidad de que los corazones rojos se generen como corazones de alma"}, -- Mitre
	...
	[182] = {"182", "Corazón sagrado", "↑ {{Heart}} +1 de Vida#↑ {{Damage}} Daño x2.3#↑ {{Damage}} Daño +1#↓ {{Tears}} Lágrimas -0.4#↓ {{Shotspeed}} Vel. de lágrimas -0.25#{{HealingRed}} Salud al maximo#Lágrimas teledirigidas"}, -- Sacred Heart
	[184] = {"184", "Santo Grial", "↑ {{Heart}} +1 de Vida#{{HealingRed}} Cura un corazón#Permite volar"}, -- Holy Grail
	[186] = {"186", "Derecho de sangre", "Inflige 40 puntos de daño a todos los enemigos#{{Warning}} Inflige 1 corazón de daño tras usarlo#Tras el primer uso en la sala, sólo removerá medio corazón#{{Heart}} Remueve primero los corazones rojos"}, -- Blood Rights
	...
	[197] = {"197", "Zumo de Jesús", "↑ {{Damage}} Daño +0.5#↑ {{Range}} Alcance +1.5"}, -- Jesus Juice
	[203] = {"203", "Paquete modesto", "50% de probabilidad de duplicar los recolectables"}, -- Paquete modesto
	[205] = {"205", "Enchufe puntual", "{{Battery}} Usar un objeto activo sin cargas, lo recarga a cambio de medio corazón por carga faltante#{{Heart}} Remueve primero los corazones rojos"}, -- Enchufe puntual
	[206] = {"206", "Guillotina", "↑ {{Tears}} Lágrimas + 0.5#↑ {{Damage}} Daño +1#Tu cabeza se convierte en un orbital#Disparas desde la cabeza#La cabeza inflige 56 de daño por contacto cada segundo"}, -- Guillotine
	[211] = {"211", "Bebé araña", "Genera 3-5 arañas tras recibir daño"}, -- Bebé araña
	[214] = {"214", "Anémico", "↑ {{Range}} Alcance +1.5#{{Timer}} Cuando te golpean, deja un rastro de fluido en el suelo por la habitación#El fluido inflige 6 de daño cada segundo"}, -- Anemic
	...
	[219] = {"219", "Vendaje Viejo", "↑ {{EmptyHeart}} +1 Contenedor de corazón vacío#{{Heart}} Probabilidad de 20% de generar un corazón rojo al recibir daño"}, -- Old Bandage
	[222] = {"222", "Anti-Gravedad", "↑ {{Tears}} Lágrimas +1#Disparar de forma continua provoca que las lágrimas floten en el aire#Soltar el boton de disparo las libera en la dirección que fueron disparadas"}, -- Anti-Gravity
	...
	[224] = {"224", "El cuerpo de Cricket", "↑ {{Tears}} Lágrimas +0.5#↓ {{Range}} Alcance x0.8#Las lágrimas se dividen en 4 al impactar#Las lágrimas partidas infligen la mitad de daño"}, -- Cricket's Body
	...
	[229] = {"229", "Pulmón de Monstro", "↓ {{Tears}} Lágrimas x0.23#{{Chargeable}} Las lágrimas pueden cargarse y lanzarse como si fuera una escopeta"}, -- Monstro's Lung
	...
	[232] = {"232", "Cronómetro", "↑ {{Speed}} Velocidad +0.3#{{Slow}} Ralentiza permanentemente a los enemigos en un 80%"}, -- Cronómetro
	[233] = {"233", "Mini-Planeta", "↑ {{Range}} Alcance +6.5#Lágrimas espectrales#Las lágrimas orbitan a tu alrededor"}, -- Tiny Planet
	[245] = {"245", "20/20", "↓ {{Damage}} Daño x0.8#Duplica tus lágrimas"}, -- 20/20
	[248] = {"248", "Mente colmena", "Las moscas y arañas azules duplican su daño#Las moscas y arañas familiares son más fuertes"}, -- Mente colmena
	[253] = {"253", "Costra mágica", "↑ {{Heart}} +1 de Vida#↑ {{Luck}} Suerte +1#{{HealingRed}} Cura 1 corazón"}, -- Magic Scab
	[254] = {"254", "Coágulo", "Para el ojo izquierdo:#↑ {{Damage}} Daño +1#↑ {{Range}} Rango +1.5"}, -- Blood Clot
	[256] = {"256", "Bombas calientes", "{{Bomb}} +5 Bombas#{{Burning}} Tus bombas hacen daño por contacto#{{Burning}} Tus bombas dejan una llama donde explotan#{{Burning}} Inmunidad al fuego (excepto los proyectiles)"}, -- Bombas calientes
	[261] = {"261", "Proptósis", "↑ {{Damage}} Daño +0.5#↓ {{Damage}} Las lágrimas harán menos daño mientras más distancia recorran#Las lágrimas infligen x3 de daño a quemarropa"}, -- Proptósis
	[262] = {"262", "Página perdida 2", "{{BlackHeart}} +1 corazón negro#Tras recibir daño a menos de 1 corazón, inflige daño a todo enemigo en la sala#{{Collectible35}} Los efectos estilo Necronomicon y los corazones negros infligen el doble de daño"}, -- Página perdida 2
	...
	[272] = {"272", "Mosca Heermosa", "Mosca amigable explosiva#La explosión inflige 100 de daño#{{Warning}} La explosión puede herir a Isaac"}, -- BBF
	[273] = {"273", "Cerebro de Bob", "{{Throwable}} Familiar lanzable#{{Poison}} La explosión inflige 100 de daño y envenena a enemigos#{{Warning}} La explosión puede herir a Isaac"}, -- Cerebro de Bob
	[274] = {"274", "Mejor amigo", "Al ser golpeado, genera un orbital de alcance medio durante la sala#Inflige 150 de daño cada segundo"}, -- Best Bud
	[275] = {"275", "Mini-Azufre", "{{Collectible118}} Familiar que carga y dispara un {{Collectible118}} rayo de sangre#El rayo inflige 24 de daño cada 0.63 segundos"}, -- Lil Brimstone
	[276] = {"276", "Corazón de Isaac", "Te vuelves invulnerable#{{Chargeable}} El familiar carga al disparar, al soltar el botón de disparo, el corazón: #Disparará 8 lágrimas#Soltará Creep rojo#Empujará enemigos y proyectiles#{{Warning}} Cuando golpean al familiar corazón, recibirás daño"}, -- Corazón de Isaac
	...
	[280] = {"280", "Sissy patitas-largas", "Invoca arañas azules en habitaciones hostiles de forma aleatoria#{{Charm}} Encanta a los enemigos al tocarlos"}, -- Sissy Longlegs
	[283] = {"283", "D100", "Duplca 1 recolectable en la sala#Cambia tu velocidad, lágrimas, daño, alcance y objetos pasivos#Cambia los objetos en pedestales, recolectables y rocas en la sala#Reinicia la sala, regenera y degrada a los enemigos de la sala"}, -- D100
	...
	[291] = {"291", "¡Flus-flus!", "Convierte a los enemigos comunes en caca#Mata de forma instantánea a enemigos y jefes de caca#Extingue fuegos#Convierte en suelo las fosas de lava"}, -- ¡Flus-flus!
	[292] = {"292", "Biblia satánica", "{{BlackHeart}} +1 Corazón negro#{{Warning}} Usarlo antes de la pelea contra el jefe vuelve el objeto de la habitación en un pacto del diablo#{{AngelChance}} Tomar un objeto de pacto impedirá que aparezcan {{AngelRoom}} Salas del ángel"}, -- Satanic Bible
	...
	[295] = {"295", "Dedos mágicos", "Inflige el doble de tu daño + 10 a toda la habitación#{{Coin}} Precio: 1 moneda"}, -- Dedos mágicos
	[296] = {"296", "Conversor", "{{Heart}} Convierte 1 corazón de alma/negro en un contenedor de corazón"}, -- Conversor
	...
	[307] = {"307", "Capricornio", "↑ {{Heart}} +1 de Vida#↑ {{Speed}} +0,1 Velocidad#↑ {{Tears}} Lágrimas +0,50#↑ {{Damage}} +0,93 Daño#↑ {{Range}} Alcance +0,75#+1 {{Coin}} moneda, {{Bomb}} bomba y {{Key}} llave#{{HealingRed}} Cura 1 corazón"}, -- Capricorn
	...
	[314] = {"314", "Piernas gordas", "↑ {{Heart}} +1 de Vida#↓ {{Speed}} Velocidad -0.4#{{HealingRed}} Cura 1 corazón#Permite romper rocas caminando sobre ellas"}, -- Thunder Thighs
	[315] = {"315", "Atrayente extraño", "Lágrimas magnéticas#Afecta a los enemigos, recolectables y trinkets#Los objetos irán donde caiga la lágrima"}, -- Strange Attractor
	...
	[320] = {"320", "El único amigo de ???", "Mosca controlable#Inflige 15 de daño por contacto cada segundo"}, -- ???'s Only Friend
	[323] = {"323", "Lágrimas de Isaac", "Dispara 8 lágrimas en todas direcciones#Las lágrimas imitan los efectos del jugador#↑ {{Damage}} Las lágrimas poseen +5 de daño#Se recarga al disparar lágrimas"}, -- Isaac's Tears
	[325] = {"325", "Tijeras", "{{Timer}} Convierte tu cabeza en una torreta durante la habitación#El cuerpo se controla por separado y suelta lágrimas sangrientas en la dirección de disparo"}, -- Scissors
	...
	[328] = {"328", "El negativo", "↑ {{Damage}} Daño +1#Al recibir daño teniendo medio o ningun corazón de vida roja, daña a todos los enemigos de la sala"}, -- El negativo
	...
	[344] = {"344", "Caja de Fósforos", "{{BlackHeart}} +1 corazón negro#{{Bomb}} Genera 2-3 bombas#{{Trinket41}} Genera el trinket Cerilla "}, -- Match Book
	[345] = {"345", "Synthol", "↑ {{Damage}} Daño +1#↑ {{Range}} Alcance +1.5"}, -- Synthoil
	...
	[352] = {"352", "Cañón de vidrio", "Dispara una gran lágrima espectral y penetrante que inflige 10 veces tu daño#{{Warning}} Al recibir daño:#↓ Remueve dos corazones extra#El cañón se rompe y debe volver a cargarse#↑ {{Range}} Alcance +1.5 + un rastro de sangre por la habitación#El daño autoinfligido no activa el efecto"}, -- Glass Cannon
	...
	[360] = {"360", "Íncubo", "Familiar demoníaco que dispara lágrimas con tus efectos y estadísticas#Inflige el 75% de tu daño#{{Player13}} Inflige el 100% de tu daño al jugar con Lilith"}, -- Incubus
	...
	[376] = {"376", "Reabastecimiento", "Las tiendas reponen los objetos que compres instantáneamente#El precio de los objetos repuestos aumenta"}, -- Restock
	...
	[386] = {"386", "D12", "Transforma los obstaculos de la sala en otros de forma aleatoria (e.j. caca, TNT, espinas, piedras, etc.)#Pequeña probabilidad de cambiar obstaculos por botones, killswitches, mazmorras o trampillas"}, -- D12
	...
	[393] = {"393", "Beso de serpiente", "{{Poison}} Posibilidad de lanzar lágrimas venenosas#{{Poison}} Envenena al tocar#{{BlackHeart}} 20% de posibilidad de que los enemigos envenenados dejen caer un corazón negro"}, -- Serpent's Kiss
	[394] = {"394", "En la Mira", "↑ {{Tears}} Lágrimas +0.7#↑ {{Range}} Alcance +3#Dispara lágrimas automáticamente dirigidas por la cruz roja del suelo que puedes controlar#Los familiares disparan hacia la cruz#Puedes dejar de disparar presionando el boton de soltar ({{ButtonRT}})"}, -- Marked
	[395] = {"395", "Tecnología X", "{{Chargeable}} Reemplaza tus lágrimas por anillos láser cargables#El tamaño y el daño incrementan hasta 100% con el tiempo de carga"}, -- Tech X
	...
	[399] = {"399", "Fauces del vacío", "{{Chargeable}} Disparar por 2.35 segundos y soltar el boton crea un aro negro alrededor de Isaac#El aro inflige 30 veces tu daño cada 2 segundos"}, -- Maw of the Void
	...
	[404] = {"404", "Bebé pedorro", "Bloquea proyectiles#Al ser golpeado: 10% de probabilidad de tirarse un pedo y {{Charm}} encantar, {{Poison}} envenenar o empujar a los enemigos cercanos#Los pedos infligen 5-6 de daño"}, -- Farting Baby
	[405] = {"405", "Error de juego", "{{Throwable}} Lanzable#Cambia los enemigos y recolectables que toca"}, -- GB Bug
	[407] = {"407", "Pureza", "↑ Potencia una estadística dependiendo del color del aura#Al recibir daño, remueve el efecto y otorga uno nuevo en la sala siguiente#{{ColorYellow}}Amarillo{{CR}} = {{Speed}} Velocidad +0.5#{{ColorBlue}}Azul{{CR}} = {{Tears}} Lágrimas +2#{{ColorRed}}Rojo{{CR}} = {{Damage}} Daño +4#{{ColorOrange}}Naranja{{CR}} = {{Range}} Alcance +3"}, -- Purity
	...
	[415] = {"415", "Corona de la luz", "{{SoulHeart}} +2 corazones de alma#Al poseer salud maxima, recibirás:#↑ {{Damage}} Daño x2#↓ {{Shotspeed}} Vel. de lágrimas -0.3#Se pierde el efecto al recibir daño"}, -- Crown Of Light
	[416] = {"416", "Bolsillos profundos", "{{Coin}} Si no ha habido recompensa en la habitación, genera 1-3 monedas#{{Coin}} Aumenta el máximo de monedas a 999"}, -- Deep Pockets
	...
	[421] = {"421", "Alubia roja", "{{Charm}} Encanta a los enemigos cercanos"}, -- Alubia roja
	[422] = {"422", "Reloj de arena brillante", "Regresa al jugador a la sala anterior y revierte toda acción cometida#El efecto se puede usar hasta 3 veces por piso#{{Collectible66}} Tras agotar sus usos, se convertirá en El Reloj de Arena, ralentizando a los enemigos por 8 segundos"}, -- Glowing Hourglass
	[426] = {"426", "Fanático obsesionado", "Sigue tus movimientos exactos con 0,66 segundos de retraso#Inflige 30 de daño por contacto cada segundo"}, -- Fanático obsesionado
	[430] = {"430", "Papá mosca", "Sigue tus movimientos con 0,66 segundos de retraso#{{Damage}} Dispara a los enemigos cercanos e inflige tu daño"}, -- Papa Fly
	[431] = {"431", "Bebé multidimensional", "Sigue tus movimientos con 0,66 segundos de retraso#Las lágrimas que lo traspasen se dividen y ganan una mejora de alcance + velocidad"}, -- Multidimensional Baby
	...
	[433] = {"433", "Mi sombra", "Una pequeña sombra seguirá al jugador#{{Timer}} Se creará un black charger por sala cuando un enemigo toque la sombra#El cargador inflige 8.7 puntos de daño por golpe"}, -- My Shadow
	[437] = {"437", "D7", "Reinicia la habitación y vuelve a generar los enemigos#Te permite obtener multiples recompensas de la misma habitación"}, -- D7
	[440] = {"440", "Piedra en el riñón", "De manera aleatoria dejas de disparar hasta que lanzas un grupo de lágrimas y piedra del riñón"}, -- Piedra en el riñón
	[442] = {"442", "Corona del príncipe oscuro", "Al tener un corazón rojo lleno:#↑ {{Tears}} Lágrimas +2#↑ {{Range}} Alcance +1.5#↑ Vel. de disparo +0.2#(No funciona con personajes que no tienen vida roja"}, -- Dark Prince's Crown
	[444] = {"444", "Lápiz", "Disparas un grupo de lágrimas cada 15 lágrimas "}, -- Lead Pencil
	[448] = {"448", "Trozo de vidrio", "Al recibir daño:#{{Heart}} 25% de probabilidad de generar un corazón rojo#{{BleedingOut}} Te desangras, soltando lágrimas en la dirección de tus disparos#El sangrado inflige medio corazón de daño cada 20 segundos#El sangrado se detiene si:#Recoges un Corazón Rojo#Todos los corazones rojos estan vacios#O si el proximo daño te mataria"}, -- Shard of Glass
	[450] = {"450", "Ojo de Codicia", "{{Damage}} Cada 20 lágrimas, disparas una lágrima moneda que inflige tu daño x1.5 + 10#Los enemigos golpeados se volverán de oro#{{Coin}} Matar un enemigo de oro suelta 1-3 monedas#{{Warning}} Las lágrimas moneda cuestan una moneda"}, -- Eye of Greed
	[451] = {"451", "Tapete de Tarot", "{{Card}} Genera una carta aleatoria#Duplica o mejora los efectos de las cartas de tarot"}, -- Tarot Cloth
	[453] = {"453", "Fractura compuesta", "Lágrimas de hueso#Las lágrimas se separan en 1-3 fragmentos de hueso al impactar#↑ {{Range}} Alcance +1.5"}, -- Compound Fracture
	[455] = {"455", "Moneda perdida de Papá", "↑ {{Range}} Alcance +2.5#Genera un penique de la suerte"}, -- Dad's Lost Coin
	[456] = {"456", "Pan mohoso", "↑ {{Heart}} +1 de Vida#{{HealingRed}} Cura 1 corazón"}, -- Pan Mohoso
	[459] = {"459", "Infección sinusal", "{{Poison}} 20% de probabilidad de disparar mocos pegajosos#Los mocos se pegan al enemigo e infligen tu daño cada segundo#{{Luck}} La probabilidad no cambia con la suerte"}, -- Sinus Infection
	[462] = {"462", "Ojo de Belial", "↑ {{Range}} Alcance +1.5#Otorga lágrimas penetrantes#Tras golpear a un enemigo, las lágrimas infligen el doble de daño y se vuelven teledirigidas"}, -- Eye of Belial
	[464] = {"464", "Glifo de balance", "{{SoulHeart}} +2 corazones de alma#Los enemigos campeones y las habitaciones generan recolectables en función de lo que más necesites"}, -- Glyph of Balance
	[468] = {"468", "Sombra", "Sigue tus movimientos exactos con 0,66 segundos de retraso#Inflige 75 de daño por contacto cada segundo#Tras infligir 666 puntos de daño, será absorbida por el jugador, aumentando el daño por contacto"}, -- Shade
	[472] = {"472", "Rey bebé", "Le siguen otros familiares y dispara automaticamente a los enemigos#No se mueve mientras disparas#Se teletransporta a ti cuando dejas de disparar"}, -- Rey bebé
	...
	[477] = {"477", "Vacío", "Consume todo objeto de pedestal en la habitación#Objeto activo: Se añade el efecto al de Vacío(Apilando los efectos)#↑ Objeto pasivo: Pequeña mejora aleatoria"}, -- Void
	...
	[493] = {"493", "Adrenalina", "Por cada medio contenedor de corazón vacío:#↑ {{Damage}} Más daño basado en ((2 * Medios corazones vacíos) ^ 1,6) * 0,1"}, -- Adrenalina
	...
	[495] = {"495", "Pimiento fantasma", "8% de probabilidad de disparar una flama azul que inflige daño y bloquea proyectiles#{{Luck}} 50% de probabilidad con 10 de suerte#El fuego se encoje hasta desaparecer tras 2 segundos"},
	[496] = {"496", "Eutanasia", "3.33% de probabilidad de disparar jeringuillas#{{Luck}} 25% de probabilidad con 13 de suerte#Las jeringuillas matan a los enemigos normales de un golpe, disparando otras 10 jeringuillas#Infligen el triple de tu daño contra jefes"}, -- Euthanasia
	[497] = {"497", "Interior Camuflado", "{{Confusion}} Al entrar a una habitación te camuflas y confunde a los enemigos hasta que dispares#↑ {{Speed}} Velocidad +0.5 al estar camuflado#Al descamuflarse: #Todos los enemigos serán dañados#↑ {{Damage}} Más daño por la sala#↑ {{Tears}} Más lágrimas por la sala"}, -- Camo Undies
	[500] = {"500", "Bolsa de Bolsas", "Genera un saco cada 7-8 salas"}, -- Sack of Sacks
	[501] = {"501", "Esófago de Codicia", "{{Heart}} Otorga 1 contenedor de corazón cada 25 monedas#{{Player14}} Perm8ite a Keeper ganar más monedas-corazones"}, -- Greed's Gullet
	[503] = {"503", "Pequeño cuerno", "5% de probabilidad de disparar una lágrima que invoca una mano de Big Horn#{{Luck}} 20% de probabilidad con 15 de suerte#La mano mata al instante a enemigos normales e inflige 3.5 de daño a los jefes#Infliges 7 de daño por contacto cada segundo"}, -- Little Horn
	[504] = {"504", "Pepita marrón", "Genera una mosca torreta que dispara a los enemigos#Cada disparo inflige 3.5 de daño"}, -- Pepita marrón
	[506] = {"506", "Apuñala espaldas", "{{BleedingOut}} Golpear a un enemigo por detrás inflige el doble de daño y causa sangrado#Los enemigos que sangren dejarán un rastro de fluido y tomaran daño al moverse"}, -- Backstabber
	...
	[509] = {"509", "Ojos rojos", "Orbital que dispara una lágrima cada 0.33 segundos a enemigos cercanos#Inflige 3.5 de daño#Inflige 30 de daño por contacto cada segundo"}, -- Bloodshot Eye
	[514] = {"514", "Modem roto", "Posibilidad de 'laguear' enemigos y proyectiles, haciendo que se congelen por un momento#Los proyectiles enemigos congelados seran removidos#25% de probabilidad de duplicar las recompensas de sala"}, -- Broken Modem
	[517] = {"517", "Bombas Rápidas", "{{Bomb}} +5 Bombas#Permite colocar bombas muy rápido#Las bombas no se empujarán entre sí"}, -- Fast Bombs
	[522] = {"522", "Telequinesia", "Detiene los proyectiles cercanos durante 3 segundos y luego los lanza lejos de ti#Empuja hacia afuera a los enemigos cercanos durante el efecto"}, -- Telekinesis
	[523] = {"523", "Caja de mudanza", "Guarda hasta 10 recolectables y objetos de la habitación#Permite mover cosas entre habitaciones#Al volver a usarlo, suelta todo en la habitación actual"}, -- Moving Box
	[524] = {"524", "Tecnología cero", "Las lágrimas están conectadas con rayos de electricidad#Los rayos infligen 4.5 veces tu daño cada segundo"}, -- Technology Zero
	...
	[549] = {"549", "Huesos frágiles", "{{EmptyBoneHeart}} Remplaza todos los contenedores de corazón por 6 corazones de hueso vacios#Al perder un corazón de hueso:#↑ {{Tears}} Lágrimas +0.4#Dispara 8 lágrimas de hueso en todas direcciones"},
	[552] = {"552", "Pala de Mamá", "Genera una trampilla para saltar el piso#{{LadderRoom}} Genera una trampilla a una mazmorra al usarla sobre la decoración del suelo#Úsala en el montón de tierra en  \"Cuarto Oscuro\"#"},
	...
	[565] = {"565", "Cachorro sangriento", "Familiar que persigue a los enemigos#{{HalfHeart}} Genera medio corazón rojo tras matar 10 enemigos#Tras matar 15 enemigos, se vuelve más poderoso, pero también te intentará atacar a ti#Atacarle lo devuelve a su estado normal"}, -- Blood Puppy
	...
	[572] = {"572", "El ojo de lo oculto", "↑ {{Damage}} Daño +1.0#↑ {{Range}} Alcance +7.5#↓ {{Shotspeed}} Vel. de lágrimas -0.16#Permite controlar la dirección de tus lágrimas"}, -- Eye of the Occult
	[573] = {"573", "Corazón inmaculado", "↑ {{Heart}} +1 de Vida#↑ {{Damage}} Daño x1.2#{{HealingRed}} Vida al completo#20% de probabilidad de disparar una lágrima extra que es orbital y espectral"}, -- Immaculate Heart
	...
	[621] = {"621", "Guisado Rojo", "#↑ {{Damage}} Daño +21.6#{{HealingRed}} Vida al completo#El daño se pierde poco a poco durante 3 minutos#Matar enemigos extiende la duración del efecto"}, -- Red Stew
	...
	[642] = {"642", "Piel mágica", "Genera un objeto del grupo de items de la habitación actual#{{BrokenHeart}} Convierte 1 contenedor de corazón o 2 corazones de alma en un corazón roto#{{Warning}} Reemplaza futuros objetos si no lo tienes{{ColorSilver}}(33% tras 1 uso, 50% tras 2, 100% tras 3)#Probabilidad menor si ya se generó en la planta actual#{{Warning}} Objeto de un solo uso para The Lost"}, -- Magic Skin
	...
	[669] = {"669", "Salchicha", "↑ {{Heart}} +1 corazón#↑ {{Speed}} Velocidad +0.2#↑ {{Damage}} Daño +0.5#↑ {{Tears}} Lágrimas +0.5#↑ {{Range}} Alcance +2.5#↑ {{Shotspeed}} Vel. de lágrimas +0.6#↑ {{Luck}} Suerte +1#{{HealingRed}} Vida al maximo#↑ {{AngelDevilChance}} Posibilidad de sala de Diablo/Ángel +6.9%#↑ {{PlanetariumChance}} Posibilidad de Planetario +6.9% "}, -- Sausage
...
EID.descriptions[languageCode].bookOfBelialBuffs = {
	...
	[127] = "↑ {{Damage}} Daño +2 para el siguiente piso", -- Forget me Now
	[133] = "↑ {{Damage}} Daño +0.5", -- Guppy's Paw
	[135] = "Otorga {{Damage}} Dano temporal +0.66 con cada uso", -- IV Bag
	...
	[282] = "Deja un rastro de fuego que inflige daño por contacto e incendia a los enemigos", -- How to Jump
	...
	[297] = "Genera un familiar demoníaco junto a la recompensa del piso", -- Pandora's Box
	[323] = "Dispara 10 lágrimas espectrales, perforantes y con un mayor daño", -- Isaac's Tears
	[326] = "En vez de luz, Tendrás un aura fogosa al ser invencible#Recibes un {{Damage}} aumento de daño temporal y activas el efecto del {{Collectible35}} Necronomicon en un bloqueo perfecto", -- Breath of Life
	[352] = "Activa {{Collectible34}} El Libro de Belial al romperse#La bonificacion de daño persiste hasta que el cañón es reparado", -- Glass Cannon
	[475] = "Judas reaparece como Dark Judas si tienes una vida extra", -- Plan C
	...
	[577] = "↑ {{Damage}} Aumento de daño permanente", -- Damocles
	[582] = "↑ {{Damage}} Aumento de daño adicional por el resto del piso basado en la cantidad de veces que se usó", -- Wavy Cap
	[585] = "Cambia las recompensas por 2 corazones negros y un objeto de trato con el Diablo#Serán 3 corazones negros y 2 objetos si ya se hizo un pacto con el Diablo", -- Alabaster Box
	...
	[685] = "Otorga 6 fuegos fatuos de {{Collectible292}} Biblia satánica#+10% de probabilidad de sala del Diablo por cada fuego", -- Jar of Wisps
	[705] = "↑ {{Damage}} Aumento temporal de daño por cada enemigo/proyectil golpeado", -- Dark Arts
	[710] = "Los {{Heart}} Corazones Rojos tienen una probabilidad de ser reemplazados por {{BlackHeart}} Corazones Negros", -- Bag of Crafting
	[729] = "Cuando la cabeza es lanzada:#↑ {{Tears}} Lágrimas x3#↑ {{Damage}} Daño +2", -- Decap Attack
}

-- Book of Virtues wisp types
EID.descriptions[languageCode].bookOfVirtuesWisps = {
	[33] = "Fuego orbital interior {{InnerWisp}}#Lágrimas teledirigidos", -- The Bible
	[34] = "Fuego orbital central {{MiddleWisp}}#Lágrimas con daño doble", -- The Book of Belial
	[35] = "Fuego orbital interior {{InnerWisp}}#3.5% de probabilidad de disparar lágrimas {{Fear}} asustadoras#{{Collectible35}} Activa el efecto del Necronomicón al destruirse", -- The Necronomicon
	[36] = "Fuego orbital exterior {{OuterWisp}}#2.5% de probabilidad de disparar lágrimas de {{Collectible236}} E. Coli", -- The Poop
	[37] = "Fuego orbital central {{MiddleWisp}}#Generan bombas de dispersión teledirigidas al destruirse", -- Mr. Boom
	[38] = "Fuego orbital exterior {{OuterWisp}}#Lágrimas rápidas e imprecisas", -- Tammy's Head
	[39] = "Fuego orbital central {{MiddleWisp}}#5% de probabilidad de disparar lágrimas petrificadoras", -- Mom's Bra
	[40] = "Fuego orbital central {{MiddleWisp}}#Lágrimas explosivas#Explotan al destruirse", -- Kamikaze!
	[41] = "Fuego orbital central {{MiddleWisp}}#7.5% de probabilidad de disparar lágrimas {{Fear}} asustadoras", -- Mom's Pad
	[42] = "Fuego orbital central {{MiddleWisp}}#7.5% de probabilidad de disparar lágrimas de {{Collectible149}} Ipecac", -- Bob's Rotten Head
	[44] = "Fuego orbital central{{MiddleWisp}}#10% de probabilidad de disparar lágrimas que teletransportan enemigos#Los fuegos parpadean cada 5 segundos", -- Teleport!
	[45] = "Fuego orbital central {{MiddleWisp}}#20% de probabilidad de que los enemigos suelten 1 {{Heart}} corazón rojo al morir", -- Yum Heart
	[47] = "Fuego orbital central {{MiddleWisp}}#Dispara 3 lágrimas explosivas hacia la cruz al usarse", -- Doctor's Remote
	[49] = "Fuego orbital exterior {{OuterWisp}}#No puede disparar lágrimas#Dispara un rayo de Kamehame... ¡¿Eeeeeeh?! al usarlo", -- Shoop da Whoop!
	[56] = "Fuego orbital central {{MiddleWisp}}#Disparos rápidos de corto rango#Los fuegos dejarán un rastro de fluido amarillo", -- Lemon Mishap
	[58] = "Fuego orbital central {{MiddleWisp}}#Poca salud, pero poséen inmunidad a proyectiles#Inmunidad al daño durante el efecto {{Collectible58}}", -- Book of Shadows
	[65] = "Fuego orbital central {{MiddleWisp}}#Genera una bomba troll al destruírse", -- Anarchist Cookbook
	[66] = "Fuego orbital central {{MiddleWisp}}#{{Slow}} Ralentiza a los enemigos por 3 segundos al destruirse", -- The Hourglass
	[77] = "Fuego orbital central {{MiddleWisp}}#Daño por contacto extra", -- My Little Unicorn
	[78] = "Fuego orbital interior {{InnerWisp}}#No puede disparar lágrimas#Genera una langosta para la habitación al destruirse", -- Book of Revelations
	[83] = "Fuego orbital interior {{InnerWisp}}#Lágrimas con doble daño y empuje", -- The Nail
	[84] = "Fuego orbital central {{MiddleWisp}}#Sin efecto especial", -- We Need to Go Deeper!
	[85] = "Fuego orbital interior {{InnerWisp}}#Genera una {{Card}} carta al destruirse", -- Deck of Cards
	...
	[123] = "Fuego orbital interior {{InnerWisp}}#Lágrimas aleatorias", -- Monster Manual
	[124] = "Genera un fuego del objeto activo que imitó", -- Dead Sea Scrolls
	[126] = "Fuego orbital central {{MiddleWisp}}#Fuego de alta salud", -- Razor Blade
	[127] = "Fuego orbital central {{MiddleWisp}}#Fuego de salud infinita para el piso nuevo", -- Forget Me Now
	[130] = "Fuego orbital central {{MiddleWisp}}#No puede disparar#Los fuegos embestirán hacia la dirección que dispares", -- A Pony
	[133] = "Fuego orbital central {{MiddleWisp}}#3 fuegos de alta salud", -- Guppy's Paw
	[135] = "Fuego orbital exterior {{OuterWisp}}#Fuego de baja salud", -- IV Bag
	[136] = "Fuego orbital central {{MiddleWisp}}#7.5% de probabilidad de disparar lágrimas marcadoras#Los enemigos marcados serám atacados por otros enemigos", -- Best Friend
	[137] = "Fuego orbital interior {{InnerWisp}}#+1 fuego por bomba detonada#Las lágrimas de los fuegos también pueden ser detonadas remotamente", -- Remote Detonator
	[145] = "Fuego orbital exterior {{OuterWisp}}#Se generan fuegos en vez de moscas#Generan una mosca azul al destruirse", -- Guppy's Head
	[146] = "Fuego orbital interior {{InnerWisp}}#Lágrimas teledirigidas", -- Prayer Card
	...
	[186] = "Fuego orbital central {{MiddleWisp}}#Fuego de alta salud", -- Blood Rights
	[192] = "Fuego orbital central {{MiddleWisp}}#Lágrimas teledirigidas", -- Telepathy for Dummies
	[263] = "Fuego orbital central {{MiddleWisp}}#15% de probabilidad de que los enemigos suelten una {{Rune}} runa al morir#Generan una {{Rune}} runa al destruirse", -- Clear Rune
	[282] = "Genera hasta 6 fuegos inmóviles por habitación", -- How to Jump
	...
	[285] = "Fuego orbital central {{MiddleWisp}}#10% de probabilidad de disparar lágrimas con efecto de D10", -- D10
	[286] = "Fuego orbital central {{MiddleWisp}}#15% de probabilidad de que los enemigos suelten una {{Card}} carta al morir#Generan una {{Card}} carta al destruirse", -- Blank Card
	...
	[323] = "Fuego orbital central {{MiddleWisp}}#Genera 6 fuegos#Tiempo de vida de 3 segundos", -- Isaac's Tears
	[324] = "Fuego orbital central {{MiddleWisp}}#{{Collectible570}} Lágrimas de Galleta de plastilina", -- Undefined
	[325] = "Fuego orbital central {{MiddleWisp}}#Conjunto de disparos arqueados", -- Scissors
	[326] = "Fuego orbital interior {{InnerWisp}}#Genera 4 fuegos al realizar un bloqueo de daño perfecto", -- Breath of Life
	[338] = "Fuego orbital central {{MiddleWisp}}#Fuego de una sola habitación#Lágrimas con efecto boomerang", -- The Boomerang
	[347] = "Fuego orbital central {{MiddleWisp}}#Fuego de alta salud con lágrimas de {{Collectible245}} 20/20#Duplica tus otros fuegos", -- Diplopia
	[348] = "Fuego orbital central {{MiddleWisp}}#Genera una {{Pill}} píldora al destruirse", -- Placebo
	[349] = "Fuego orbital central {{MiddleWisp}}#50% de probabilidad de generar una {{Coin}} moneda al destruirse", -- Wooden Nickel
	[351] = "Fuego orbital central {{MiddleWisp}}#Todos los fuegos del Mega Frijol lanzan una onda de piedra al usar el objeto#{{Poison}} Pedo venenoso y petrificador al destruirse", -- Mega Bean
	[352] = "Fuego orbital central {{MiddleWisp}}#Fuego de baja salud que petrifican a los enemigos#Persisten entre habitaciones#Si un fuego del Cañón de cristal se destruye, los otros lo harán", -- Glass Cannon
	[357] = "Fuego orbital central {{MiddleWisp}}#Sin efecto especial#Duplica tus fuegos durante la habitación", -- Box of Friends
	[382] = "Fuego orbital central {{MiddleWisp}}#Los enemigos pueden generar fuegos con 1 de 4 efectos de lágrimas distintos al morir#Los efectos de lagrima dependen del tipo de ataque#Ataque regular, teledirigido, explosivo, o de {{Collectible118}} Azufre", -- Friendly Ball
	[383] = "Fuego orbital central {{MiddleWisp}}#Los disparos de los fuegos pueden ser detonados, explotando en 6 de tus lágrimas#Persisten entre habitaciones#Dispara lágrimas del jugador al destruirse", -- Tear Detonator
	[386] = "Fuego orbital central {{MiddleWisp}}#5% de probabilidad de que las lagrimas cambien al impactar los obstaculos de la habitación", -- D12
	[396] = "No pueden disparar lágrimas#Cada portal tendrá un fuego", -- Ventricle Razor
	[406] = "Fuego orbital central {{MiddleWisp}}#Daño y velocidad de lágrimas aleatorias", -- D8
	[419] = "Fuego orbital central {{MiddleWisp}}#20% de probabilidad de que las lágrimas teletransporten enemigos#Los fuegos parpedean cada 5 segundos", -- Teleport 2.0
	[421] = "Fuego orbital central {{MiddleWisp}}#{{Charm}} Lágrimas encantadoras#Genera un pedo encantador al destruirse", -- Kidney Bean
	[422] = "Fuego orbital central {{MiddleWisp}}#30% de probabilidad de lanzar disparos petrificadores#Revive a todos los fuegos que fueron destruidos en la habitación anterior", -- Glowing Hour Glass
	...
	[434] = "Fuego orbital central {{MiddleWisp}}#Se generan fuegos en vez de moscas#De 5 moscas en adelante se generará un fuego con salud y daño incrementado 1", -- Jar of Flies
	[437] = "Fuego orbital central {{MiddleWisp}}#Efecto del D7 al hacer daño por contacto#Sólo se activa una vez", -- D7
	[439] = "Fuego orbital central {{MiddleWisp}}#Sin efecto especial", -- Mom's Box
	[441] = "Fuego orbital central {{MiddleWisp}}#{{Chargeable}} Lágrimas del {{Collectible275}} Mini-Azufre#Dispara de forma continua mientras se use Mega Ráfaga", -- Mega Blast
	[475] = "Fuego orbital central {{MiddleWisp}}#8 Fuegos de daño alto que persisten tras morir", -- Plan C
	[476] = "Fuego orbital central {{MiddleWisp}}#Genera otro fuego si no se duplica un recolectable", -- D1
	[477] = "Genera los fuegos de todos los objetos activos absorvidos#No genera fuegos por sí solo", -- Void
	[478] = "Fuego orbital central {{MiddleWisp}}#Pausa a todos los enemigos y permite disparar por 3 segundos", -- Pause
	[479] = "Fuego orbital central {{MiddleWisp}}#Probabilidad de generar un {{Trinket}} trinket al destruirse", -- Smelter
	[480] = "Fuego orbital central {{MiddleWisp}}#La salud del fuego aumentará con cada recolectables reciclado#Solo genera un fuego si al menos un recolectable es reciclado", -- Compost
	[481] = "Fuego orbital central {{MiddleWisp}}#5% de probabilidad de disparar lágrimas que transforman a los enemigos en fuegos aleatorios", -- Dataminer
	[482] = "Genera un fuego aleatorio", -- Clicker
	[483] = "Fuego orbital central {{MiddleWisp}}#Genera 8 fuegos que sueltan una bomba troll dorada al destruirse", -- Mama Mega!
	[484] = "Fuego orbital central {{MiddleWisp}}#Fuego de una sola habitación#No puede disparar lágrimas#Activa el efecto de Espera... ¿qué? al destruirse", -- Wait What?
	[485] = "Fuego orbital central {{MiddleWisp}}#Todos los fuegos de la Moneda Doblada pueden ser duplicados o destruidos si uno se daña", -- Crooked Penny
	[486] = "Fuego orbital central {{MiddleWisp}}#No puede disparar lágrimas#Probabilidad de negar el daño recibido y destruirse", -- Dull Razor
	...
	[489] = "Fuego orbital central {{MiddleWisp}}#Genera un fuego normal#Efecto adicional basado en el dado imitado", -- D Infinity
	[490] = "Genera un fuego aleatorio#Se regenera tras limpiar una habitación si fue destruido", -- Eden's Soul
	[504] = "Fuego orbital central {{MiddleWisp}}#Fuego de una sola habitación#Disparos rápidos y apuntados de bajo daño", -- Brown Nugget
	[507] = "Fuego orbital exterior {{OuterWisp}}#Probabilidad de generar fuegos al matar", -- Sharp Straw
	[510] = "Fuego orbital central {{MiddleWisp}}#Lágrimas de {{Collectible229}} Pulmón de Monstro, {{Collectible268}} Bebé Podrido, {{Collectible87}} Cuernos de Loki o {{Collectible118}} Azufre", -- Delirious
	[512] = "Fuego orbital central {{MiddleWisp}}#Lágrimas magnéticas", -- Black Hole
	[515] = "Genera un fuego aleatorio#Se regeneran tras limpiar una habitación si fueron destruidos", -- Mystery Gift
	[516] = "Fuego orbital central {{MiddleWisp}}#Vel. de lágrimas alta#Disparan lágrimas en 8 direcciones, imitando al Aspersor", -- Sprinkler
	[521] = "Fuego orbital central {{MiddleWisp}}#Disparo triple#Comprar algo destruye todos los fuegos del Cupón", -- Coupon
	[522] = "Fuego orbital exterior {{OuterWisp}}#Convierte los proyectiles capturados en fuegos", -- Telekinesis
	[523] = "Fuego orbital central {{MiddleWisp}}#Los fuegos se generan al soltar el contenido de la caja#Generan un recolectable aleatorio al destruirse", -- Moving Box
	[527] = "Fuego orbital central {{MiddleWisp}}#No pueden disparar lágrimas#Abren cofres y puertas al limpiar una habitación", -- Mr. ME!
	[536] = "Fuego orbital central {{MiddleWisp}}#Convierte todos los fuegos en {{HalfHeart}} Medios corazones rojos#Genera un fuego de salud y daño altos al sacrificar", -- Sacrificial Altar
	[545] = "Fuego orbital interior {{InnerWisp}}#Genera un Bony amistoso al destruirse", -- Book of the Dead
	[550] = "Fuego orbital central {{MiddleWisp}}#10% de probabilidad de disparar lágrimas que generan un pisotón sobre el enemigo", -- Broken Shovel
	[552] = "Fuego orbital central {{MiddleWisp}}#10% de probabilidad de disparar lágrimas que generan un pisotón sobre el enemigo#Genera un fuego de salud alta que no dispara", -- Mom's Shovel
	[555] = "Fuego orbital central {{MiddleWisp}}#15% de probabilidad de disparar lágrimas de {{Collectible202}} Toque de midas", -- Golden Razor
	[556] = "Fuego orbital central {{MiddleWisp}}#Lágrimas de {{Collectible118}} Azufre de corto alcance", -- Sulfur
	[557] = "Fuego orbital central {{MiddleWisp}}#↑ {{Luck}} +0.2 de suerte por cada fuego de la Galleta de la fortuna", -- Fortune Cookie
	[577] = "Fuego orbital central {{MiddleWisp}}#Sin efecto especial", -- Damocles
	[578] = "Fuego orbital central {{MiddleWisp}}#Los fuegos dejan un rastro de fluido amarillo", -- Free Lemonade
	[580] = "Fuego orbital central {{MiddleWisp}}#Probabilidad de generar puertas rojas al entrar a una nueva habitación", -- Red Key
	[582] = "Fuego orbital central {{MiddleWisp}}#Fuego de daño bajo#Hasta 1 fuego del Hongo Mareante", -- Wavy Cap
	[584] = "Sin beneficio por copias múltiples", -- Book of Virtues
	[585] = "Fuego orbital central {{MiddleWisp}}#Genera 8 fuegos", -- Alabaster Box
	[604] = "Fuego de una habitación#Se generan 3 fuegos donde aterriza lo que lanzaste#10% de probabilidad de disparar {{Confusion}} lágrimas que confunden", -- Mom's Bracelet
	[605] = "Fuego orbital central {{MiddleWisp}}#Sin efecto especial", -- The Scooper
	[609] = "Fuego orbital central {{MiddleWisp}}#50% de probabilidad de generar un fuego invencibles#50% de probabilidad de que todos los fuegos del D6 Eterno se destruyan al usarse", -- Eternal D6
	[611] = "Fuego orbital central {{MiddleWisp}}#Daño y salud aumentados en base a las cargas del objeto", -- Larynx
	[622] = "Fuego orbital central {{MiddleWisp}}#Reemplaza todos tus fuegos por 3 fuegos normales", -- Genesis
	[623] = "Fuego orbital central {{MiddleWisp}}#Sin efecto especial", -- Sharp Key
	[631] = "Fuego orbital central {{MiddleWisp}}#Divide todos tus fuegos a la mitad (Mitad de salud y daño)#Los fuegos se destruyen si se dividen 3 veces", -- Meat Cleaver
	[635] = "Fuego de una habitación#Genera un fuego estacionario al ser teletransportado#Hasta 6 fuegos", -- Stitches
	[636] = "No hay fuego", -- R Key
	[638] = "Fuego orbital central {{MiddleWisp}}#Inmunidad a proyectiles#Elimina enemigos no-jefes al contacto", -- Eraser
	[639] = "Fuego orbital central {{MiddleWisp}}#No puede disparar#Genera una mosca azul al limpiar una sala", -- Yuck Heart
	[640] = "Fuego orbital central {{MiddleWisp}}#Probabilidad de disparar una flama azul", -- Urn of Souls
	[642] = "Fuego orbital central {{MiddleWisp}}#Disparos venenosos", -- Magic Skin
	[650] = "Fuego orbital central {{MiddleWisp}}#Cuando Ciruelita rebote diagonalmente, Todos los fuegos de la Flauta Ciruela se volverám invencibles y lo harán", -- Plum Flute
	[653] = "No hay fuegos#Los fantasmas rojos pueden disparar lágrimas", -- Vade Retro
	[655] = "Fuegos temporales al usarse#Alta vel. de lágrimas", -- Spin to Win
	[685] = "Triplica los fuegos generados", -- Jar of Wisps
	[687] = "Genera un fuego aleatorio", -- Friend Finder
	[703] = "Fuego orbital central {{MiddleWisp}}#Sin efecto especial", -- Esau Jr.
	[704] = "Fuego orbital central {{MiddleWisp}}#Fuego de alta salud#No puede disparar lágrimas", -- Berserk
	[705] = "Fuego orbital central {{MiddleWisp}}#Los enemigos generan un fuego de una habitación al morir", -- Dark Arts
	[706] = "Fuego orbital central {{MiddleWisp}}#Fuego de alta salud#No puede disparar", -- Abyss
	[709] = "Fuego de una habitación#Se generan 3 fuegos donde aterrices", -- Suplex
	[710] = "Genera un fuego aleatorio al fabricar", -- Bag of Crafting
	[711] = "Fuego orbital central {{MiddleWisp}}#Fuego de alta salud", -- Flip
	[712] = "Los fuegos de objetos lanzan disparos teledirigidos", -- Lemegeton
	[713] = "No genera fuego", -- Sumptorium
	[719] = "Fuego orbital central {{MiddleWisp}}#20% de probabilidad de que los enemigos suelten una {{Coin}} moneda al morir", -- Keeper's Box
	...
	[723] = "Fuego orbital central {{MiddleWisp}}#Genera un fuego aleatorio y convierte a los demas fuegos en el mismo tipo", -- Spindown Dice
	[728] = "Fuego orbital central {{MiddleWisp}}#Todos los fuegos orbitarán a Gello", -- Gello
	[729] = "Fuego estacionario de una sola habitación", -- Decap Attack
}
...
[12] = "{{Collectible118}} Genera un rayo anti-gravedad al infligir daño",
...
-- list of Tear flag descriptions used for Abyss locust effect description  -- TO DO(replace placeholder text)
EID.descriptions[languageCode].TearFlagNames = {
    ...
    [4] = "venenosa",													-- Common cold type tear (poisons on contact)
    [5] = "petrifica",													-- Mom's contact type tear (freezes on contact)
    [6] = "de dispersión",												-- Parasite type tear (splits on collision)
    [7] = "crece con distancia recorrida",								-- Lump of coal type tear (grows by range)
    ...
    [13] = "encantadora",												-- Mom's Eyeshadow tear
    [14] = "aturdidora",												-- Iron Bar tear
    [15] = "hace a los enemigos soltar corazones",						-- These tears cause enemy to drop hearts if killed (33% chance)
    ...
    [19] = "rebota en enemigos",										-- Bounce off of enemies, walls, rocks (Higher priority than PERSISTENT & PIERCING)
    [20] = "asustadora",												-- Mom's Perfume type tear of fear (fear on contact)
    [21] = "encojedora",												-- Proptosis tears start large and shrink
    [22] = "incendiaria",												-- Fire Mind tears cause Burn effect on enemies
    [23] = "iman de recolectables y enemigos",							-- Attracts enemies and pickups
    [24] = "con empuje",												-- Tear impact pushes enemies back further
    [25] = "pulsante",													-- Makes the tear pulse
    [26] = "se mueve en espiral",										-- Makes the tear path spiral
    ...
    [30] = "de movimiento cuadrado",									-- Used for Hook Worm
    [31] = "con aura que inflige daño",									-- Used for GodHead (they will have a glow around them)
    [32] = "ralentiza y cubre de negro al enemigo",						-- Used for Gish player tears (to color enemy black on slowing)
    [33] = "genera fluido verde al impacto",							-- Mysterious Liquid tears spawn damaging green creep when hit
    [34] = "con escudo",												-- Lost Contact tears, block enemy projectiles
    [35] = "bomba de brillos",											-- Used by Bombs (Glitter Bomb)
    [36] = "bomba de dispersión",										-- Used for Scatter bombs
    [37] = "pegajosa",													-- Used for Sticky bombs and Explosivo tears
    [38] = "circula por la pantalla",									-- Tears loop around the screen
    [39] = "genera rayo de luz al impacto",								-- Create damaging light beam on hit
    [40] = "deja una moneda al impacto",								-- Used by Bumbo, spawns a coin when tear hits
    [41] = "deja salud negra al impacto",								-- Enemy drops a black hp when dies
    [42] = "rayo tractor",												-- Tear with this flag will follow parent player's beam
    [43] = "encoje enemigos",											-- God's flesh flag to minimize enemies
    [44] = "genera monedas al impacto",									-- Greed coin tears that has a chance to generate a coin when hit
    [45] = "bomba cruz",												-- Bomber Boy
    [46] = "movimiento en espiral grande",								-- Ouroboros Worm, big radius oscilating tears
    [47] = "aturde permanentemente al impacto",							-- Glaucoma tears, permanently confuses enemies
    [48] = "de moco",													-- Booger tears, stick and do damage over time
    [49] = "genera arañas o moscas al impacto",							-- Egg tears, leave creep and spawns spiders or flies
    [50] = "puede romper entidades de grilla al impacto",        	    -- Sulfuric Acid tears, can break grid entities
    [51] = "genera 1-2 fragmentos de hueso al matar enemigos",			-- Bone tears, splits in 2
    [52] = "perforante + obtiene doble daño y telequinesis despues",	-- Belial tears, piecing tears gets double damage + homing
    [53] = "convierte a enemigos en oro al impacto",					-- Midas touch tears
    [54] = "dispersa en 10 lagrimas al impacto",						-- Needle tears
    [55] = "electicidad al impacto",									-- Jacobs ladder tears
    [56] = "Invoca una mano de big horn al impacto",					-- Little Horn tears
    [57] = "connected with electicity",									-- Technology Zero
    [58] = "rebota con otras",											-- Pop!
    [59] = "absorbe otras",												-- Hungry Tears
    [60] = "disparo laser",												-- Trisagion, generates a laser on top of the tear
    [61] = "skip on ground",											-- Flat Stone
    [62] = "burst split",												-- Haemolacria
    [63] = "rastro de fluido",											-- Bob's Bladder
    [64] = "efecto de golpe al impacto",								-- Knockout Drops
    [65] = "congela al enemigo al morir",								-- Uranus
    [66] = "iman de enemigos y recolectables",							-- Lodestone
    [67] = "efecto de carnada al impacto",								-- Rotten Tomato
    [68] = "Ojo de lo Oculto",											-- Eye of the Occult
    [69] = "movimiento orbital estrecho",								-- Orbiting tears with a more narrow and stable orbit (used by Saturnus and Immaculate Heart)
    [70] = "destruye rocas",											-- Rock tears, chance to break rocks, deal extra damage to rock type enemies
    [71] = "movimiento de 90 grados",									-- Brain Worm, tears turn and go horizontally when moving past an enemy
    [72] = "bomba de sangre",											-- Blood Bombs, leave blood creep on the ground
    [73] = "convierte al enemigo en caca",								-- E. Coli tears, turn enemies into poop
    [74] = "suelta una moneda al matar enemigos",						-- Killed enemies have a chance to drop a random coin (Reverse Hanged Man)
    [75] = "bomba de azufre",											-- Brimstone Bombs, explosion creates a brimstone cross
    [76] = "agujero negro al impacto",									-- Rift tears, creates a black hole on impact
    [77] = "se pega al enemigo y se multiplica al matar",				-- Spore tears, stick to enemies and multiply on enemy death
    [78] = "bomba fantasma",											-- Ghost bombs
    [79] = "suelta una carta al matar",									-- Killed enemies will drop a random tarot card
    [80] = "suelta una runa al matar",									-- Killed enemies will drop a random rune
    [81] = "teletransporta enemgos al impacto",							-- Hit enemies will teleport to a different part of the room
    [82] = "desacelera con el tiempo",									-- Decelerate over time
    [83] = "acelera con el tiempo",										-- Accelerate over time
    [104] = "rebota en las paredes",									-- Similar to TEAR_BOUNCE but only bounces off walls, not enemies
	[106] = "daño extra por detrás + sangrado",							-- Deals extra damage from behind and inflicts bleeding
}
...
local repTrinkets={
	...
	[11] = {"11", "Gusano Circular", "↑ {{Tears}} Lágrimas +0.47#Lágrimas espectrales#Las lágrimas se mueven en espirales a gran velocidad"}, -- Ring Worm
	...
	[92] = {"92", "Corona Quebrada", "↑ Multiplicador de 1.33 para las mejoras de estadísticas (excepto Vel. de disparo)"}, -- Cracked Crown
	[96] = {"96", "Gusano Ouroboros", "↑ {{Tears}} Lágrimas +0.4#↑ {{Range}} Alcance +1.5#Lágrimas espectrales#Probabilidad de disparar lágrimas teledirigidas#{{Luck}} 100% de probabilidad con 9 de suerte#Tus lágrimas se mueven rapidamente en un patron de espiral"}, -- Ouroboros Worm
	[98] = {"98", "Duende de Naríz", "5% de probabilidad de disparar lágrimas de moco teledirigidas#Los mocos infligen tu daño una vez cada segundo#Los mocos se pegan a los enemigos durante 10 segundos#"}, -- Nose Goblin
	...
	[132] = {"132", "Jeringa rota", "25% de probabilidad de activar un efecto de jeringa aleatorio para la habitación actual"}, -- Broken Syringe
	[133] = {"133", "Mecha corta", "{{Bomb}} Tus bombas explotan más rápido"}, -- Short Fuse
	[134] = {"134", "Frijol Gigante", "Aumenta el tamañó de los pedos"}, -- Gigante Bean
	[135] = {"135", "Un encendedor", "{{Burning}} 20% de probabilidad de incendiar a enemigos aleatorios al entrar en una habitación"}, -- A Lighter
	...
	[139] = {"139", "Talismán gota", "{{Luck}} {{Luck}} Suerte +4 para los efectos de lágrima basados en la suerte"}, -- Teardrop Charm
	...
	[141] = {"141", "Canción de cuna olvidada", "Mejora la velocidad de disparo de los familiares"}, -- Forgotten Lullaby
	...
	[151] = {"151", "Lima", "Todas las espinas se retraen, volviendolas inofensivas#{{CursedRoom}} Afecta a las salas malditas, los cofres trampa y cualquier obstaculo con espinas"}, -- Flat File
	...
	[161] = {"161", "Corona maldita", "{{TreasureRoom}} Genera una habitación del tesoro en Sheol"}, -- Wicked Crown
...
local repCards={
	...
	[18] = {"18", "XVII - Las Estrellas", "{{TreasureRoom}} Te teletransporta a la sala del tesoro#{{Planetarium}} Si se generó un planetario, te llevará ahi en su lugar"}, -- XVII - The Stars
	[20] = {"20", "XIX - El Sol", "{{HealingRed}} Vida al maximo#Inflige 100 de daño a todos los enemigos#{{Timer}} Revela el mapa de la planta por completo (excepto las {{SuperSecretRoom}} Habitaciónes Super / {{UltraSecretRoom}} Ultra Secretas)#{{CurseDarkness}} Remueve la Maldición de Oscuridad"}, -- XIX - The Sun
	...
	[68] = {"68", "XII - ¿El Colgado?", "{{Timer}} Otorga durante 30 segundos:#↓ {{Speed}} velocidad -0.1O#Disparo triple#{{Coin}} Los enemigos asesinados dejan caer monedas"}, -- XII - The Hanged Man?
...
EID.descriptions[languageCode].tarotClothBuffs = {
	...
	[14] = {40, 80}, -- XIII - Death
	[11] = {" una ", " 2 ", "máquina", "{{CR}}maquinas", "mendigo demoníaco", "{{CR}}mendigos demoníacos"}, -- XIV - Temperance ( + Greed version)
	[16] = {2, 4}, -- XV - The Devil
	...
	[21] = {" un ", " 2 ", "mendigo", "{{CR}}mendigos", "mendigo demoníaco", "{{CR}}mendigos demoníacos"}, -- XX - Judgement
...
local repCharacterInfo = {
	[4] = {"???", "No puedes tener Corazones rojos#{{SoulHeart}} los Objetos de vida otorgan Corazones de Alma#{{DevilRoom}} Los objetos de pacto del Diablo costaran Corazones de Alma#Genera 1 mosca azul al destruir caca"},
	...
	[12] = {"Judas Oscuro", "{{Damage}} Daño x2#No puedes tener Corazones rojos#{{BlackHeart}} los Objetos de vida otorgan Corazones Negros#{{Player3}} Cuenta como Judas para las marcas de completación"},
	...
	[40] = {"Alma de Forgotten Corrupto", "Forgotten es un monton de huesos inmoviles que son recogidos y lanzados por El Alma#Forgotten inflige 3 veces tu daño al ser lanzado#Solo El Alma puede recibir daño#Las bombas son soltadas en la ubicación de Forgotten#No puedes tener Corazones rojos#{{SoulHeart}} los Objetos de vida otorgan Corazones de Alma"},
}
