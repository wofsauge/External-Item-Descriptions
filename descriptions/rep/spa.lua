...
local repCollectibles={
	...
	[678] = {"678", "Cesárea", "{{Chargeable}} Cargable#Dispararás fetos automáticamente al presionar el botón de disparo#Los getos seguirán a los enemigos y los atacarán varias veces"}, --  Sección C
