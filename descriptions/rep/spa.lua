...
local repCollectibles={
	...
	[201] = {"201", "Barra de hierro", "↑ {{Damage}} Daño +0.3#Posibilidad de aturdir a los enemigos"},
	...
	[278] = {"278", "Vagabundo oscuro", "!!! {{Heart}} Puede convertir 1.5 Corazones rojos en:#{{SoulHeart}}/{{BlackHeart}} 1 corazón de alma/negro#{{Pill}} Una píldora#{{Card}} Una Carta#{{Rune}} Una runa#O una araña"}, -- Vagabundo oscuro
	...
	[287] = {"287", "Libro de secretos", "Otorga el efecto del {{Collectible54}} Mapa del tesoro, {{Collectible21}} La Brújula o {{Collectible246}} el Mapa azul en la planta en la que lo uses#Solo otorga efectos de mapa que no tengas ya#Si están todos los efectos activos,otorga {{Collectible76}} Visión de rayos X"}, -- Libro de secretos
	...
	[556] = {"556", "Azufre", "Garantiza {{Collectible118}} Azufre en la habitación actual"}, --  Sulfuro
