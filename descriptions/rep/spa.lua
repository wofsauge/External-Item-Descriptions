...
local repTrinkets={
	...
	[16] = {"16", "Uña del pie de Mamá", "{{MomBossSmall}} El Pie de Mamá pisoteará un lugar aleatorio de la habitación cada 20 segundos"}, -- Mom's Toenail
	[19] = {"19", "Clip de Papel", "{{GoldenChest}} Permite abrir los Cofres Dorados sin usar llaves#{{MegaChest}} Los Mega Cofres aún necesitan llaves para abrirse"}, -- Paper Clip
	...
	[33] = {"33", "Cordón umbilical", "Al tener medio corazón rojo o menos:#{{Collectible100}} Otorga un pequeño Steven#{{Collectible318}} 30% de probabilidad de otorgar un familiar Géminis al recibir daño#{{Luck}} 100% de probabilidad con 35 de suerte"}, -- Umbilical Cord
	...
	[61] = {"61", "La Mano izquierda", "{{RedChest}} Reemplaza todos los cofres por Cofres Rojos#No convierte cofres que ya han sido generados"}, -- The Left Hand
	...
	[110] = {"110", "Dólar de Plata", "{{Shop}} Aparecerán tiendas en el Útero y en el Cadaver"}, -- Silver Dollar
	[111] = {"111", "Corona Sangrienta", "{{TreasureRoom}} Aparecerán salas del tesoro en el Útero y en el Cadaver"}, -- Bloody Crown
	...
	[134] = {"134", "Frijol Gigante", "{{Poison}} Aumenta el tamaño de los pedos"}, -- Gigante Bean
	[135] = {"135", "Un encendedor", "{{Burning}} 20% de probabilidad de incendiar enemigos aleatorios al entrar en una habitación"}, -- A Lighter
	[136] = {"136", "Candado roto", "{{Bomb}} Permite abrir Puertas, Candados y Cofres Dorados con explosiones#También permite abrir una \"Puerta Extraña\" en las \"Profundidades II\""}, -- Broken Padlock
	...
	[140] = {"140", "Manzana de Sodoma", "{{Heart}} 50% de probabilidad al recoger corazones rojos de convertirlos en arañas azules#100% de probabilidad al tener la salud al maximo#Puede convertir corazones necesarios para curarte"}, -- Apple of Sodom
	...
	[154] = {"154", "Bolsa de dados", "50% de probabilidad de otorgar un dado consumible por habitación#El dado desaparece al cambiar de habitación#El dado no ocupa un lugar de consumible"}, -- Dice Bag
	[155] = {"155", "Corona sagrada", "Genera una {{TreasureRoom}} sala del tesoro y una {{Shop}} tienda en la Catedral"}, -- Holy Crown
	...
	[173] = {"173", "Tu alma", "{{DevilRoom}} Permite llevarse un objeto de pacto del Diablo gratis#{{Warning}} Tomar objetos de pacto afectará las probabilidades de encontrar salas de Ángel"}, -- Your Soul
	...
	[175] = {"175", "Llave extraña", "Abre el pasaje hacia \"???\" (Vientre azul) sin importar el tiempo#{{Collectible297}} La Caja de Pandora consume la llave y genera 6 objetos de grupos aleatorios"}, -- Strange Key
	...
	[181] = {"181", "Paquete de expansión", "Tu objeto activo obtendrá el efecto aleatorio de un objeto activo adicional de 1-2 cargas"}, -- Expansion Pack
	[182] = {"182", "Esencia de Beth", "Entrar a una {{AngelRoom}} Sala del Ángel generará 5 fuegos fatuos#25% de probabilidad de generar un fuego al dar dinero a los mendigos"}, -- Beth's Essence
...
local repCards={
	...
	[71] = {"71", "XV - ¿El Diablo?", "{{Timer}} Otorga durante 30 segundos:#{{Collectible33}} Activa el efecto de La Biblia#{{Collectible390}} Genera un familiar Serafín#{{MomsHeart}} Mata al Pie de Mamá y al Corazón de Mamá de forma instantanea#{{Warning}} Te mata al usarlo contra Satán"}, -- XV - The Devil?
