...
local repTrinkets={
	...
	[119] = {"119", "Célula madre", "{{HealingRed}} Cura la mitad de tus corazones rojos/de hueso al entrar a un nuevo piso#{{HalfRedHeart}} Cura medio corazón como mínimo"}, -- Stem Cell
