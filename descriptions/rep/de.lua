...
local repCards={
	...
	[71] = {"71", "XV - Der Teufel?", "{{Timer}} Erhalte für 30 Sekunden:#{{Collectible33}} Aktiviert die Bibel (Flug)#{{Collectible390}} Seraphim-Begleiter#{{MomsHeart}} Tötet Mamas Fuß und Mamas Herz sofort#{{Warning}} Tötet Isaac, wenn es gegen Satan verwendet wird"}, -- XV - The Devil?
