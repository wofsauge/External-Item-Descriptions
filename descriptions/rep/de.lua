...
local repCollectibles={
	...
	[59] = {"59", "Das Buch von Belial", "{{AngelDevilChance}} +12.5% Teufels/Engelsraumchance bei Besitz#{{Timer}} Erhalte für den Raum:#↑ {{Damage}} +2 Schaden#{{Collectible7}} x1.5 Schadensmultiplikator, wenn Isaac Blood of the Martyr hat"}, -- The Book of Belial (Judas's Birthright Version)
	...
	[101] = {"101", "Die Halo", "↑ {{Heart}} +1 Gesundheit#↑ {{Speed}} +0.3 Geschwindigkeit#↑ {{Tears}} +0.2 Tränen#↑ {{Damage}} +0.3 Schaden#↑ {{Range}} +1.5 Reichweite#{{Heart}} Heilt 1 Herz"}, -- The Halo
	...
	[115] = {"115", "Ouija-Brett", "↑ {{Tears}} +0.5 Tränen#Spektrale Tränen"},
	...
	[135] = {"135", "IV-Beutel", "{{Coin}} Verletzt Isaac um ein halbes Herz und spawnt 1-2 Münzen#{{HardMode}} Spawnt auf dem Hard Mode 1 Münze#{{Player14}} Spawnt als Keeper 0-1 Münze"}, -- IV Bag
	...
	[161] = {"161", "Ankh", "{{Player4}} Wiederbelebung als ??? (Blue Baby) bei Tod#{{Player25}} Tainted ??? wird einfach wiederbelebt"}, -- Ankh
	...
	[203] = {"203", "Bescheidenes Bündel", "Pickups haben eine 50% ige Chance, verdoppelt zu werden"}, -- Humbling Bundle
	...
	[222] =	{"222", "Anti-Gravity", "↑ {{Tears}} +1 Feuerrate#Das Halten der Feuertasten lässt Tränen in der Luft schweben#Das Loslassen der Feuertasten schießt sie in die Richtung, in die sie abgefeuert wurden"}, -- Anti-Gravity
	...
	[224] = {"224", "Krickets Körper", "↑ {{Tears}} +0.5 Feuerrate#↑ {{Tearsize}} +0.1 Tränengröße#↓ {{Range}} x0.8 Reichweitenmultiplikator#Tränen teilen sich bei Treffern in 4 Teile#Geteilte Tränen richten halben Schaden an"}, -- Cricket's Body
	...
	[228] = {"228", "Mamas Parfüm", "↑ {{Tears}} +0.5 Feuerrate#{{Fear}} 15% ige Chance, Furchttränen zu schießen"}, -- Mom's Perfume
	...
	[232] = {"232", "Stoppuhr", "↑ {{Speed}} +0.3 Geschwindigkeit#{{Slow}} Feinde sind dauerhaft auf 80% ihrer Angriffs- und Bewegungsgeschwindigkeit verlangsamt"}, -- Stopuhr
	...
	[264] = {"264", "Kluge Fliege", "Orbital#Greift Feinde an, wenn Isaac Schaden nimmt#Verursacht 6,5 Schaden pro Sekunde"},
	...
	[275] = {"275", "Kleiner Brimstone", "{{Chargeable}} Begleiter, der einen {{Collectible118}} Blutstrahl auflädt und schießt#Verursacht 3 Schaden pro Tick, insgesamt 24 Schaden"}, -- Lil Brimstone
	...
	[286] = {"286", "Leere Karte", "Löst den Effekt der Karte aus, die Isaac hält, ohne sie zu verwenden"}, -- Blank Card
	...
	[297] = {"297", "Pandoras Schachtel", "{{Warning}} EINMALIGE VERWENDUNG {{Warning}} Erzeugt Belohnungen basierend auf der Etage:#B1: 2{{SoulHeart}}; B2: 2{{Bomb}} + 2{{Key}}#C1: Boss-Gegenstand; C2: B1+C1#D1: 4{{SoulHeart}}; D2: 20{{Coin}}#W1: 2 Boss-Gegenstände#W2: {{Collectible33}} Die Bibel#???/Leere: Nichts#Sheol: Teufelsgegenstand + 1{{BlackHeart}}#Kathedrale: Engelsgenstand + 1{{EternalHeart}}#Dunkler Raum: Schaltet {{Collectible523}} Die Umzugskiste frei; Truhe: 1{{Coin}}#Zuhause: {{Collectible580}} Roter Schlüssel"}, -- Pandoras Schachtel
	[300] = {"300", "Widder", "↑ {{Speed}} +0.25 Geschwindigkeit#Bewegung über 0,85 Geschwindigkeit macht Isaac immun gegen Berührungsschaden und fügt Feinden 25 Schaden zu"}, -- Widder
	[307] = {"307", "Steinbock", "↑ {{Heart}} +1 Gesundheit#↑ {{Speed}} +0.1 Geschwindigkeit#↑ {{Tears}} +0.5 Feuerrate#↑ {{Damage}} +0.5 Schaden#↑ {{Range}} +0.75 Reichweite#+1 {{Coin}} Münze, {{Bomb}} Bombe und {{Key}} Schlüssel"}, -- Steinbock
	[308] = {"308", "Wassermann", "Isaac hinterlässt eine Spur aus Klecksen#{{Damage}} Der Klecks fügt 66% des Schadens von Isaac pro Sekunde zu und übernimmt seine Träreffekte"}, -- Wassermann
	[309] = {"309", "Fische", "↑ {{Tears}} +0.5 Feuerrate#↑ {{Tearsize}} +0.12 Tränengröße#Erhöht den Rückstoß der Tränen"}, -- Fische
	[310] = {"310", "Evas Mascara", "↑ {{Damage}} x2 Schadensmultiplikator#↓ {{Tears}} x0.66 Tränenmultiplikator#↓ {{Shotspeed}} -0.5 Schussschnelligkeit"},
	[311] = {"311", "Judas' Schatten", "{{Player12}} Beim Tod wiederbeleben als Dunkler Judas mit einem 2x Schadensmultiplikator#{{Player24}} Befleckter Judas wird einfach wiederbelebt"}, -- Judas' Schatten
	[314] = {"314", "Donner-Oberschenkel", "↑ {{Heart}} +1 Gesundheit#↓ {{Speed}} -0.4 Geschwindigkeit#{{Heart}} Heilt 1 Herz#Isaac kann Felsen zerstören, indem er darüber läuft"}, -- Donner-Oberschenkel
	[315] = {"315", "Seltsamer Anzieher", "Isaacs Tränen ziehen Feinde, Aufsammelobjekte und Trinkets an#Der Anziehungseffekt ist am Ende des Tränenweges viel stärker"}, -- Seltsamer Anzieher
	[316] = {"316", "Verfluchte Träne", "Aufgeladene Welle aus 5 Tränen#{{Warning}} Bei teilweise aufgeladenem Schuss bewirkt Schaden einen zufälligen Raumwechsel für Isaac#{{Collectible260}} Die Schwarze Kerze entfernt den Teleportationseffekt"}, -- Verfluchte Träne
	[319] = {"319", "Cains anderes Auge", "Schießt Tränen in zufällige Richtungen mit denselben Effekten wie Isaac#{{Damage}} Fügt 75% des Schadens von Isaac zu"}, -- Cains anderes Auge
	[320] = {"320", "???s Einziger Freund", "Steuerbare Fliege#Fügt 15 Kontaktschaden pro Sekunde zu"}, -- ???s Einziger Freund
	[323] = {"323", "Isaacs Tränen", "Schießt 8 Tränen in alle Richtungen#Die Tränen kopieren Isaacs Träreffekte, plus 5 Schaden#Lädt sich durch das Abschießen von Tränen wieder auf"}, -- Isaacs Tränen
	[326] = {"326", "Atem des Lebens", "Das Halten der BENUTZEN-Taste leert die Ladeleiste#Isaac ist vorübergehend unverwundbar, wenn die Ladeleiste leer ist#Isaac ruft Lichtstrahlen hervor, wenn er Feinde berührt, während er unverwundbar ist#Wenn Schaden mit perfektem Timing blockiert wird, schießt ein 4-Wege-Heiligkeitsstrahl und gewinnt einen kurzen Schild#{{Warning}} Das Halten für zu lange fügt Isaac Schaden zu"}, -- Atem des Lebens
	[328] = {"328", "Das Negative", "↑ {{Damage}} +1 Schaden#Wenn er bei einem halben roten Herz oder gar keinem Schaden nimmt, erleiden alle Feinde im Raum Schaden"}, -- Das Negative
	[330] = {"330", "Sojamilch", "↑ {{Tears}} x5.5 Feuerratenmultiplikator#↓ {{Damage}} x0.2 Schadensmultiplikator#↓ {{Tearsize}} -0.3 Tränengröße#Reduziert den Rückstoß drastisch"}, -- Sojamilch
	[331] = {"331", "Gotteskopf", "↑ {{Damage}} +0.5 Schaden#↓ {{Tears}} -0.3 Tränen#↓ {{Shotspeed}} -0.3 Schussschnelligkeit#Heilige Tränen#Tränen erhalten eine Aura, die pro Sekunde 60 Schaden verursacht"}, -- Gotteskopf
	[332] = {"332", "Lazarus' Lappen", "{{Player11}} Beim Tod wiederbeleben als Lazarus (Auferstanden)#{{Player29}} Befleckter Lazarus wird einfach wiederbelebt"},
	[336] = {"336", "Tote Zwiebel", "↑ {{Tearsize}} +0.22 Tränengröße#↓ {{Range}} -1.5 Reichweite#↓ {{Shotspeed}} -0.4 Schussschnelligkeit#Durchdringende + spektrale Tränen"}, -- Tote Zwiebel
	[339] = {"339", "Sicherheitsnadel", "↑ {{Range}} +2.5 Reichweite#↑ {{Shotspeed}} +0.16 Schussschnelligkeit#{{BlackHeart}} +1 Schwarzes Herz"}, -- Sicherheitsnadel
	[342] = {"342", "Blaue Mütze", "↑ {{Heart}} +1 Gesundheit#↑ {{Tears}} +0.7 Tränen#↓ {{Shotspeed}} -0.16 Schussschnelligkeit#{{Heart}} Heilt 1 Herz"}, -- Blaue Mütze
	[344] = {"344", "Streichholzschachtel", "{{BlackHeart}} +1 Schwarzes Herz#{{Bomb}} Erzeugt 3 Bomben#{{Trinket41}} Erzeugt den Streichholztrinket"}, -- Streichholzschachtel
	[345] = {"345", "Synthöl", "↑ {{Damage}} +1 Schaden#↑ {{Range}} +2.5 Reichweite"}, -- Synthöl
	[346] = {"346", "Ein Snack", "↑ {{Heart}} +1 Gesundheit#{{Heart}} Heilt 1 Herz"}, -- Ein Snack
	[352] = {"352", "Glas-Kanone", "{{Damage}} Schießt eine große durchdringende spektrale Träne ab, die 10x Isaacs Schaden verursacht#{{Warning}} Beim Halten bewirkt Schaden:#↓ Entfernt zusätzlich 2 Herzen Gesundheit#↓ Zerbricht die Kanone für einige Räume#↑ {{Range}} +1.5 Reichweite und hinterlässt einen Blutpfad für den Raum#Der zusätzliche Schaden kann Isaac nicht töten#Selbstschaden löst den Effekt nicht aus"}, -- Glas-Kanone
	[354] = {"354", "Krachkekse", "↑ {{Heart}} +1 Gesundheit#{{Heart}} Heilt 1 Herz#{{Trinket}} Erzeugt ein Trinket"}, -- Krachkekse
	[355] = {"355", "Mamas Perlen", "↑ {{Range}} +2.5 Reichweite#↑ {{Luck}} +1 Glück#{{SoulHeart}} +1 Seelengefäß"}, -- Mamas Perlen
	[360] = {"360", "Brutus", "Schießt Tränen mit denselben Effekten wie Isaac ab#{{Damage}} Verursacht 75% des Schadens von Isaac#{{Player13}} Verursacht 100% Schaden, während man als Lilith spielt"}, -- Brutus
	[365] = {"365", "Verlorene Fliege", "Bewegt sich entlang von Wänden/Hindernissen im Raum#Fügt 30 Kontaktschaden pro Sekunde zu#Nahegelegene Feinde nehmen die Fliege ins Visier"},
	[366] = {"366", "Streubomben", "{{Bomb}} +5 Bomben#Isaacs Bomben zerplatzen in 4-5 winzige Bomben"}, -- Streubomben
	[367] = {"367", "Klebrige Bomben", "{{Bomb}} +5 Bomben#{{Slow}} Isaacs Bomben haften an Feinden und hinterlassen weißes, verlangsamendes Klecksen#Das Töten eines Feindes mit einer Bombe beschwört blaue Spinnen herbei"}, -- Klebrige Bomben
	[368] = {"368", "Epiphora", "↑ {{Tears}} Das Schießen in eine Richtung erhöht allmählich die Feuerrate auf bis zu 200%"}, -- Epiphora
	[369] = {"369", "Kontinuum", "↑ {{Range}} +3 Reichweite#Spektraltränen#Tränen können durch eine Bildschirmseite reisen und auf der anderen Seite wieder herauskommen"}, -- Kontinuum
	[370] = {"370", "Mr. Dolly", "↑ {{Tears}} +0.7 Tränen#↑ {{Range}} +2.5 Reichweite#{{UnknownHeart}} Erzeugt 3 zufällige Herzen"}, -- Mr. Dolly
	[374] = {"374", "Heiliges Licht", "10% Chance, heilige Tränen abzufeuern, die beim Treffen einen Lichtstrahl erzeugen#{{Luck}} 50% Chance bei 9 Glück#{{Damage}} Der Strahl fügt 3x Isaacs Schaden zu"}, -- Heiliges Licht
	[375] = {"375", "Sternenhut", "Verleiht Immunität gegen Explosionen und fallende Projektile#25% Chance, feindliche Schüsse abzuprallen"}, -- Sternenhut
	[376] = {"376", "Auffüllen", "Der Kauf eines Gegenstands im Laden füllt ihn sofort wieder auf#Aufgefüllte Gegenstände steigen mit jedem Mal im Preis"}, -- Auffüllen
	[380] = {"380", "Bezahle zum Spielen", "{{Coin}} +5 Münzen#Verschlossene Blöcke, Türen und Truhen müssen mit Münzen anstelle von Schlüsseln geöffnet werden"},
	[382] = {"382", "Freundesball", "Kann auf Feinde geworfen werden, um sie zu fangen#Die Verwendung des Gegenstands nach dem Fangen eines Feindes beschwört ihn als freundlichen Begleiter#Das Überqueren des Balls nach dem Fangen lädt den Gegenstand sofort wieder auf"}, -- Freundesball
	...
	[389] = {"389", "Runenbeutel", "{{Rune}} Erzeugt alle 7-8 Räume eine zufällige Rune oder Seelenstein"}, -- Runenbeutel
	[391] = {"391", "Verrat", "Feinde können sich gegenseitig mit ihren Geschossen treffen und bekämpfen"}, -- Verrat
	[393] = {"393", "Schlangenkuss", "{{Poison}} 15% Chance, Gifttränen abzufeuern#{{Poison}} Vergiftet Feinde bei Kontakt#{{BlackHeart}} Feinde, die durch Kontaktgift getötet werden, haben die Chance, ein Schwarzes Herz beim Tod fallen zu lassen"}, -- Schlangenkuss[394] = {"394", "Markiert", "↑ {{Tears}} +0,7 Tränen#↑ {{Range}} +3 Reichweite#Isaac schießt automatisch Tränen auf ein bewegliches rotes Ziel am Boden#Begleiter schießen ebenfalls auf das Ziel#Das Schießen kann gestoppt und der Standort des Ziels zurückgesetzt werden, indem die Abwurftaste ({{ButtonRT}}) gedrückt wird"}, -- Marked
	...
	[397] = {"397", "Traktorstrahl", "↑ {{Tears}} +1 Schussrate#↑ {{Range}} +2,5 Reichweite#↑ {{Shotspeed}} +0,16 Schussgeschwindigkeit#Isaacs Tränen bewegen sich immer entlang eines Lichtstrahls vor ihm"},
	...
	[422] = {"422", "Leuchtende Sanduhr", "Bringt Isaac zurück in den vorherigen Raum und kehrt alle Handlungen um, die im Raum durchgeführt wurden, in dem das Item verwendet wurde#Die Rückspulung kann dreimal pro Etage verwendet werden#{{Collectible66}} Wirkt wie die Sanduhr, wenn die Rückspulungen aufgebraucht sind und verlangsamt Feinde für 8 Sekunden"}, -- Glowing Hourglass (ehemals Glowing Hour Glass)
	...
	[431] = {"431", "Multidimensionales Baby", "Imitiert Isaacs Bewegungen mit einer Verzögerung von 0,66 Sekunden#Tränen, die durch es hindurch gehen, werden verdoppelt und erhalten einen Reichweiten- und Schussgeschwindigkeitsschub"},
	[432] = {"432", "Glitzerbomben", "{{Bomb}} +5 Bomben#{{Charm}} Bomben haben eine 63% ige Chance, eine zufällige Belohnung fallen zu lassen und eine 15% ige Chance, Feinde zu verzaubern, wenn sie explodieren#Die Wahrscheinlichkeit, dass eine Belohnung erscheint, sinkt um 1% für jede Belohnung in dieser Etage"}, -- Glitter Bombs
	...
	[464] = {"464", "Glyph of Balance", "{{SoulHeart}} +2 Seelenherzen#Champion-Gegner und Raum-Belohnungen werden zu der Belohnung, die Isaac am meisten braucht"}, -- Glyph of Balance
	...
	[514] = {"514", "Gebrochenes Modem", "Veranlasst einige Feinde und Geschosse, sich in zufälligen Intervallen kurzzeitig zu pausieren#Pausierte Geschosse verschwinden#25% Chance, Raum-Belohnungen zu verdoppeln#(Verdoppelt keine Kisten-, Karten- oder Pillenbelohnungen)"}, -- Broken Modem
	...
	[553] = {"553", "Mucormykose", "25% Chance, eine klebrige Sporenträne zu schießen#{{Luck}} Nicht von Glück beeinflusst#{{Poison}} Sporen explodieren nach 2,5 Sekunden und verursachen Schaden, vergiften nahegelegene Feinde und setzen weitere Sporen frei"}, -- Mucormycosis
	...
	[566] = {"566", "Traumfänger", "{{HalfSoulHeart}} +1 halbes Soul Heart beim Betreten einer neuen Etage#Der Albtraumübergang zeigt den Bosskampf und den Schatzraum des nächsten Stockwerks"}, -- Dream Catcher
	...
	[569] = {"569", "Blutpakt", "{{Warning}} Das Betreten einer neuen Etage entleert alle roten Herzen von Isaac, gewährt jedoch Geschwindigkeits- und Schadensboni für jedes verlorene Herz#Jedes halbe Herz zählt als einzelner Treffer für Effekte bei Treffern"}, -- Blood Oath
	...
	[595] = {"595", "Saturnus", "Das Betreten eines Raums lässt 7 Tränen um Isaac kreisen#Diese Tränen halten 13 Sekunden an und verursachen 1,5x Isaacs Schaden +5#Feindliche Geschosse haben die Chance, um Isaac zu kreisen"}, -- Saturnus
	...
	[597] = {"597", "Neptunus", "{{Tears}} Kein Schießen baut über 3 Sekunden einen Tränenbonus auf#Der Tränenbonus nimmt ab, wenn Isaac schießt"}, -- Neptunus
	...
	[612] = {"612", "Verlorene Seele", "Stirbt bei einem Treffer und spawnt am Anfang der nächsten Etage neu#Wenn sie lebendig zur nächsten Etage gebracht wird, kann sie spawnt:#{{SoulHeart}} 3 Seelenherzen#{{EternalHeart}} 2 Ewige Herzen#{{TreasureRoom}} Ein Schatzraum-Gegenstand#{{AngelRoom}} Ein Engelsraum-Gegenstand"}, -- Lost Soul
	[613] = {"613", "", "<Gegenstand existiert nicht>"}, -- Salt Shaker
	...
	[621] = {"621", "Rotes Eintopf", "↑ {{Damage}} +21.6 Schadensmultiplikator#{{heart}} Vollgesundheit#Der Schadensbonus lässt in 3 Minuten nach#Töten von Feinden während des aktiven Effekts verlängert diesen"}, -- Red Stew
	[622] = {"622", "Genesis", "{{Warning}} EINMAL VERWENDEN {{Warning}}#Entfernt alle von Isaac's Gegenständen und Aufsammlungen#Teleportiert Isaac zu einem Schlafzimmer mit Aufsammlungen und Truhen#Für jeden entfernten Gegenstand kann Isaac zwischen 3 Gegenständen aus demselben Pool wählen#Verlassen des Schlafzimmers teleportiert Isaac zum nächsten Stock"}, -- Genesis
	...
	[629] = {"629", "Bot Fly", "Schießt geschützte Tränen ab, um feindliche Geschosse zu zerstören"}, -- Bot Fly
	...
	[636] = {"636", "R-Taste", "{{Warning}} EINMAL VERWENDEN {{Warning}}#Startet den gesamten Lauf neu#Alle gesammelten Gegenstände, Trinkets, Stats und Aufsammlungen bleiben erhalten#Der Timer wird nicht zurückgesetzt"}, -- R Key
	...
	[641] = {"641", "Akeldama", "Erzeugt eine Kette von Tränen hinter Isaac in feindlichen Räumen#Die Tränen verursachen 3,5 Schaden"}, -- Akeldama
	...
	[649] = {"649", "Fruchtige Pflaume", "Katapultiert sich diagonal durch den Raum und schießt Tränen auf ihrem Weg, die 3 Schaden verursachen#Verursacht 6 Kontakt-Schaden pro Sekunde"}, -- Fruity Plum
	[650] = {"650", "Pflaumenflöte", "{{Timer}} Beschwört für 10 Sekunden einen freundlichen Baby Plum im Raum"}, -- Plum Flute
	...
	[654] = {"654", "Falsche PHD", "{{BlackHeart}} +1 Schwarzes Herz#{{Pill}} Identifiziert alle Pillen#Konvertiert alle guten Pillen in schlechte Pillen#↑ {{Damage}} Das Essen einer Stat-Down-Pille gewährt +0,6 Schaden#{{BlackHeart}} Das Essen anderer schlechter Pillen beschwört ein Schwarzes Herz herbei"}, -- False PHD
	...
	[658] = {"658", "Riesenzelle", "Das Nehmen von Schaden beschwört ein Minisaak herbei#Minisaaks jagen und schießen auf nahe Feinde"}, -- Giant Cell
	[659] = {"659", "Tropicamid", "↑ {{Range}} +2,5 Reichweite#↑ {{Tearsize}} +0,22 Tränengröße"} -- Tropicamide
	[660] = {"660", "Kartendeutung", "Beschwört zwei Portale im ersten Raum jeder Etage herbei#Das Verlassen des Raumes lässt die Portale verschwinden#{{Blank}} {{ColorRed}}Rot: {{CR}}{{BossRoom}} Bossraum#{{Blank}} {{ColorYellow}}Gelb: {{CR}}{{TreasureRoom}} Itemraum#{{Blank}} {{ColorBlue}}Blau: {{CR}}{{SecretRoom}} Geheimraum"}, -- Card Reading
	...
	[662] = {"662", "Pazifist (Entfernter Gegenstand)", "<Gegenstand existiert nicht>"}, -- Pacifist (Entfernter Gegenstand)
	...
	[669] = {"669", "Wurst", "↑ {{Heart}} +1 Gesundheit#↑ {{Speed}} +0,2 Geschwindigkeit#↑ {{Tears}} +0,5 Tränen#↑ {{Damage}} +0,5 Schaden#↑ {{Range}} +2,5 Reichweite#↑ {{Shotspeed}} +0,16 Schussschnelligkeit#↑ {{Luck}} +1 Glück#{{Heart}} Volle Gesundheit#↑ {{AngelDevilChance}} +6,9% Teufels-/Engelsraum-Chance#↑ {{PlanetariumChance}} +6,9% Planetarium-Chance"}, -- Sausage
	...
	[673] = {"673", "Erlösung", "{{DevilRoom}} Das Betreten einer neuen Etage nach dem Besuch eines Teufelsraums und dem Nichtannehmen von Gegenständen/Abholungen gewährt:#↑ {{Damage}} +1 Schaden#{{SoulHeart}} +1 Seelenherz"}, -- Redemption
	...
	[676] = {"676", "Leeres Herz", "{{EmptyHeart}} +1 Leeres Herz-Container, wenn zu Beginn einer neuen Etage 1 Rotes Herz oder weniger vorhanden ist#Keine Wirkung für Charaktere, die keine roten Herzen haben können"}, -- Empty Heart
	...
	[678] = {"678", "C-Schnitt", "{{Chargeable}} Ersetzt Isaacs Tränen durch einen Ladeangriff, der homing, spektrale Fötustränen schießt#{{Damage}} Fötustränen verursachen etwa 2,8-fachen Schaden von Isaacs pro Sekunde"}, -- C Section
	...
	[694] = {"694", "Herzensschmerz", "↑ {{Damage}} +0,25 Schaden für jedes gebrochene Herz#{{BrokenHeart}} +3 Gebrochene Herzen#{{BrokenHeart}} Jeder tödliche Treffer gewährt +2 Gebrochene Herzen#Isaac stirbt bei 12 Gebrochenen Herzen"}, -- Heartbreak
	[695] = {"695", "Blutiger Windstoß", "Beim Einstecken von Schaden für die Etage erhalten:#↑ {{Speed}} +0,4 Geschwindigkeit#↓ {{Tears}} x0,5 Feuerratenmultiplikator#↑ {{Tears}} +2 Feuerrate#↑ {{Damage}} +3 Schaden#Schaltet Angriffe auf Nahkampf um#{{Timer}} Jeder Mord erhöht die Dauer um 1 Sekunde"}, -- Bloody Gust
	[696] = {"696", "Heilung", "Isaac ist von einem Halo umgeben#Feinde, die sich zu lange im Halo aufhalten, werden von einem kreuzförmigen Lichtstrahl getroffen#Das Aufnehmen von Schaden erhöht die Größe des Halos für die Etage"}, -- Salvation
	...
	[701] = {"701", "Isaaks Grab", "Spawnt zu Beginn jeder Etage eine {{DirtyChest}} Alte Truhe#Alte Truhen müssen mit einem Schlüssel geöffnet werden und können {{SoulHeart}} Seelenherzen, {{Trinket}} Trinkets oder Mamas, Papas und Engelgegenstände enthalten"}, -- Isaac's Tomb
	...
	[708] = {"708", "Heftzwecke", "↑ {{Damage}} +1 Schaden#Alle Tränen von Isaac werden aus dem rechten Auge abgefeuert"}, -- Stapler
	...
	[729] = {"729", "Decap Attack", "Wirft Isaacs Kopf in eine Richtung#Der Kopf verursacht Kontaktschaden und schießt Tränen aus der Stelle, an der er landet#Erneutes Verwenden des Gegenstands oder Betreten des Kopfes befestigt ihn wieder"}, -- Decap Attack
	[730] = {"730", "Glass Eye", "↑ {{Damage}} +0,75 Schaden#↑ {{Luck}} +1 Glück"}, -- Glass Eye
	[731] = {"731", "Stye", "↑ {{Damage}} x1,28 Schadensmultiplikator für das rechte Auge#↑ {{Range}} +6,5 Reichweite für das rechte Auge#↓ {{Shotspeed}} -0,3 Schussgeschwindigkeit für das rechte Auge"}, -- Stye
...
EID.descriptions[languageCode].bingeEaterBuffs = {
	...
	[23] = {"23", "Abendessen", "↑ {{Tears}} +0,5 Tränen#↑ {{Shotspeed}} +0,2 Schussgeschwindigkeit#↓ {{v}} -0,03 Geschwindigkeit", -- Dinner
...
local repTrinkets={
	...
	[129] = {"129", "Jawbreaker", "{{Damage}} 10%ige Chance, Zähne abzufeuern, die 3,2x Isaacs Schaden zufügen#{{Luck}} 100%ige Chance bei 9 Glück"}, -- Jawbreaker
	...
	[134] = {"134", "Gigante Bean", "Erhöht die Furzgröße"}, -- Gigante Bean
	...
	[137] = {"137", "Vergissmeinnicht", "Beim Betreten einer neuen Etage erscheinen bis zu 4 nicht eingesammelte Pickups aus dem vorherigen Stock im Startraum"}, -- Myosotis
	...
	[156] = {"156", "Mutterkuss", "{{Heart}} +1 Herzcontainer solange es gehalten wird#{{Player14}} +1 Münzcontainer für Keeper"}, -- Mother's Kiss
	...
	[176] = {"176", "Lil Clot", "Erzeugt einen Blutklumpen, der Isaacs Bewegungen nachahmt#Kopiert Isaacs Werte, Träneneffekte und 35% seines Schadens#Respawned jeden Raum"}, -- Lil Clot
	...
	[185] = {"185", "Cricket-Bein", "Das Töten eines Feindes hat eine 17%ige Chance, eine zufällige Heuschrecke erscheinen zu lassen"}, -- Cricket Leg
...
local repCards={
	...
	[60] = {"60", "IV - Der Kaiser?", "Teleportiert Isaac zu einem zusätzlichen Bossraum, der für einen Gegenstand besiegt werden kann#Der Boss wird aus zwei Etagen tiefer als der aktuelle ausgewählt"}, -- IV - The Emperor?
	...
	[81] = {"81", "Seele von Isaak", "Lässt alle Gegenstandspodeste im Raum zwischen zwei verschiedenen Gegenständen wechseln"}, -- Soul of Isaac
	...
	[91] = {"91", "Seele des Verlorenen", "{{Player10}} Verwandelt den Spieler in The Lost für den Raum#Ermöglicht das kostenlose Nehmen eines {{DevilRoom}} Devil Room-Gegenstands#Ermöglicht das kostenlose Betreten der Mausoleum- oder Gehenna-Tür"}, -- Soul of the Lost
...
local repPills={
	...
	[50] = {"49", "Experimentelle Pille", "↑ Erhöht 1 zufällige Statistik#↓ Verringert 1 zufällige Statistik#Keine Statistikverringerung mit {{Collectible75}}PHD, {{Collectible46}}Lucky Foot oder {{Collectible303}}Virgo#Keine Statistiksteigerung mit {{Collectible654}}False PHD"}, -- Experimentelle Pille
...
EID.descriptions[languageCode].horsepills={
    ...
    {"49", "Experimentelle Pille", "↑ Erhöht eine zufällige Stat zweimal#↓ Verringert eine zufällige Stat zweimal#Keine Stat-Verringerung mit {{Collectible75}} PHD, {{Collectible46}} Glücklicher Fuß oder {{Collectible303}} Jungfrau#Keine Stat-Erhöhung mit {{Collectible654}} Falsche PHD"}, -- Experimental Pill
