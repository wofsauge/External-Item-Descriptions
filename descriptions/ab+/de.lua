...
------------------------------------------------------------------
-----  Basic German descriptions based on Platinumgod.co.uk -----
------------------------------------------------------------------
...
EID.descriptions["de"].collectibles={
    ...
    {"251", "Starter Deck", "Du kannst zwei Karten halten#Konvertiert alle Pillen zu Karten"},
    {"252", "Little Baggy", "Du kannst zwei Pillen halten#Konvertiert alle Karten zu Pillen"},
