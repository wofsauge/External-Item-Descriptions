...
EID.descriptions[languageCode].collectibles={
	...
	{"55", "Occhio di Mamma", "50% di chance di sparare una lacrima extra dietro di sé#{{Luck}} 100% di chance con 2 in Fortuna"},
	{"56", "Limonata Accidentale", "Versa una pozza di liquame#TIl liquame infligge 24 danni da contatto al secondo"},
	...
	{"63", "La Pila", "{{Battery}} Gli oggetti attivi possono essere sovraccaricati fino a 2 cariche complete"},
	...
	{"86", "Dente di Monstro", "Monstro cade su 1 nemico e infligge 120 danni#{{Warning}} Se la stanza non ha nemici Monstro cade su Isaac"},
	{"87", "Corna di Loki", "25% di chance di sparare in 4 direzioni#{{Luck}} 100% di chance con 7 in Fortuna"},
	{"88", "Cicciottella", "Si lancia in avanti nella direzione in cui Isaac sta sparando#Infligge 52.5 danni di contatto al secondo"},
	{"89", "Morso di Ragno", "{{Slow}} 25% di chance di sparare lacrime rallentanti#{{Luck}} 100% di chance con 15 in Fortuna"},
	...
	{"97", "Il Libro del Peccato", "Genera 1 consumabile casuale"},
	...
	{"103", "Il Raffreddore", "{{Poison}} 25% di chance di sparare lacrime velenose#{{Luck}} 100% di chance con 12 in Fortuna"},
	...
	{"110", "Lentine di Mamma", "↑ {{Range}} +0.25 Gittata#↑ +0.5 Altezza Lacrime#20% di chance di sparare lacrime pietrificanti#{{Luck}} 50% di chance con 20 in Fortuna"},
	...
	{"116", "9 Volt", "{{Battery}} Carica automaticamente la 1° barra degli oggetti attivi#{{Battery}} Quando viene raccolto ricarica pienamente l'oggetto attivo"},
	...
	{"123", "Manuale dei Mostri", "{{Timer}} Genera 1 famiglio casuale fino all'uscita dalla stanza"},
	{"124", "Pergamene del Mar Morto", "Attiva l'effetto di 1 oggetto attivo casuale#Sceglie l'effetto da un elenco definito di oggetti"},
	...
	{"134", "Coda di Guppy", "{{Chest}} 33% di chance di rimpiazzare la ricompensa per completamento stanza con 1 baule#33% di chance di non generare alcuna ricompensa per completamento stanza"},
	...
	{"150", "Amor Duro", "{{Damage}} 10% di chance di sparare denti che infliggono i danni di Isaac x3.2#{{Luck}} 100% di chance con 9 in Fortuna"},
	{"151", "Mosca al Naso", "Colpire 1 nemico con una lacrima ha un 1/6 di chance di generare 1 mosca"},
	...
	{"162", "Croce Celtica", "Subire danni ha il 20% di chance di rendere Isaac temporaneamente invincibile#{{Luck}} 100% di chance con 27 in Fortuna"},
	...
	{"167", "Bebè Arlecchino", "Spara 2 lacrime in una traiettoria a forma di V#Infligge 4 danni a lacrima"},
	...
	{"170", "Papà Gambalunga", "Schiaccia 1 nemico casuale#Infligge 40 danni al secondo"},
	...
	{"178", "Acqua Santa", "Subire danni fa versare una pozza di liquame#Il liquame infligge 24 danni al secondo"},
	{"179", "Destino", "{{EternalHeart}} +1 Cuore Eterno#Volo"},
	{"180", "Il Fagiolo Nero", "Quando Isaac viene danneggiato scoreggia#{{Poison}} La scoreggia avvelena i nemici"},
	...
	{"187", "Palla di Pelo di Guppy", "Muoversi fa oscillare la palla di pelo#La palla cresce quando uccide 1 nemico#I danni inflitti dalla palla aumentano con il suo ingrandimento"},
	...
	{"198", "Scatola", "Genera 1 consumabile di ciascuna tipologia"},
	{"199", "Chiave di Mamma", "{{Key}} +2 Chiavi#I bauli contengono più consumabili"},
	{"200", "Ombretto di Mamma", "Lacrime ammalianti"},
	{"201", "Lingotto di Ferro", "↑ {{Damage}} +0.3 Danni#{{Confusion}} 10% di chance di sparare lacrime stordenti#{{Luck}} 100% di chance con 27 in Fortuna"},
	{"202", "Tocco di Mida", "{{Petrify}} Toccare i nemici li pietrifica e li trasforma in oro#Isaac infligge danni da contatto in base al suo numero di monete#{{Coin}} Uccidere 1 nemico dorato genera monete#La cacca generata da Isaac ha un'alta chance di essere cacca dorata"},
	...
	{"217", "Parrucca di Mamma", "{{HealingRed}} Cura di 1 cuore#5% di chance di generare 1 ragno blu sparando lacrime#{{Luck}} 100% di chance con 10 in Fortuna"},
	{"218", "Placenta", "{{HealingRed}}Cura di 1 cuore#5% di chance di generare 1 ragno blu sparando lacrime#{{Luck}} 100% di chance con 10 in Fortuna"},
	...
	{"231", "Palla di Catrame", "{{Slow}} 10% di chance di sparare lacrime rallentanti#{{Luck}} 100% chance con 18 in Fortuna#{{Slow}} Isaac lascia una scia di liquame rallentante"},
	...
	{"234", "Infestazione 2", "Uccidere 1 nemico genera 1 ragno blu"},
	{"235", "", "<item does not exist>"},
	{"236", "E. Coli", "Toccare 1 nemico lo trasforma in cacca"},
	...
	{"244", "Tecn. 0.5", "Oltre alle lacrime Isaac spara certe volte dei laser"},
	...
	{"257", "Mente in Fiamme", "{{Burning}} Le lacrime di Isaac appiccano fuoco ai nemici#10% di chance che le lacrime esplodano all'impatto con il nemico#{{Luck}} 100% di chance con 13 in Fortuna#{{Warning}} Le esplosioni possono ferire Isaac"},
	{"258", "Missing No.", "Quando viene raccolto e ad ogni nuovo piano risorteggia tutti gli oggetti e le statistiche di Isaac"},
	{"259", "Materia Oscura", "↑ {{Damage}} +1 Danni#{{Fear}} 33% di chance di sparare lacrime spaventoso#{{Luck}} 100% di chance con 20 in Fortuna"},
	...
	{"266", "Sacca Colante", "{{Slow}} Lascia del liquame rallentante#Genera 1-2 ragni blu dopo aver completato una stanza"},
	...
	{"269", "Bebè Decapitato", "Lascia del liquame che infligge 6 danni al secondo"},
	{"270", "Sanguisuga", "Insegue i nemici#{{HealingRed}} Quando uccide 1 nemico cura Isaac di mezzo cuore#Infligge 3.2 danni al secondo"},
	...
	{"273", "Cervello di Bob", "Scatta nella direzione verso cui Isaac sta sparando#Esplode quando colpisce 1 nemico#{{Poison}} L'esplosione infligge 60 danni e avvelena i nemici#{{Warning}} L'esplosione può ferire Isaac"},
	{"274", "Scudiero", "Subire danni genera un orbitale dal medio raggio fino all'uscita dalla stanza#Infligge 75 danni al secondo"},
	{"275", "Mini Zolfo Fuso", "{{Chargeable}} Famiglio che carica e spara un {{Collectible118}} raggio di sangue#Infligge 3.5 danni per tocco, per un totale di 31.5 danni"},
	...
	{"278", "Scroccoscuro", "{{Heart}} Raccoglie i Cuori Rossi nelle vicinanze#{{SoulHeart}} Genera 1 Cuore Celeste o 1 ragno per ogni 1.5 Cuori Rossi raccolti"},
	...
	{"287", "Libro dei Segreti", "{{Timer}} Conferisce 1 dei seguenti effetti fino all'uscita dal piano:#{{Collectible54}} \"Mappa del Tesoro\"#{{Collectible21}} \"La Bussola\"#{{Collectible246}} \"Mappa Blu\""},
	...
	{"308", "Acquario", "Isaac lascia una scia di liquame#Il liquame infligge 6 danni al secondo"},
	...
	{"313", "Manto Sacro", "Annulla il 1° danno preso in una stanza"},
	...
	{"317", "liquame Misterioso", "Le lacrime di Isaac lasciano del liquame#Il liquame infligge 30 danni al secondo"},
	...
	{"350", "Shock Tossico", "{{Poison}} Entrare in una stanza avvelena tutti i nemici#I nemici uccisi lasciano una pozza di liquame#Il liquame infligge 30 danni al secondo"},
	...
	{"356", "Batteria per Auto", "{{Battery}} Usare un oggetto attivo attiva 2 volte il suo effetto"},
	{"357", "Scatola degli Amici", "{{Timer}} Raddoppia tutti i famigli fino all'uscita dalla stanza#{{Collectible113}} Se Isaac non ha famigli conferisce 1 \"Bebè Demone\" fino all'uscita dalla stanza"},
	...
	{"367", "Bombe Appiccicose", "{{Bomb}} +5 Bombe#Le bombe di Isaac si attaccano ai nemici#Uccidere 1 nemico con una bomba genera dei ragni blu"},
	...
	{"372", "Bebè Carico", "Ogni 30 secondi in una stanza non completata, il famiglio può:#{{Battery}} Generare 1 pila (max 2 per stanza)#{{Battery}} Aggiungere 1 carica all'oggetto attivo (max 2 per stanza)#{{Petrify}} Pietrificare tutti i nemici nella stanza"},
	...
	{"374", "Luce Sacra", "10% di chance di sparare lacrime sacre, che quando colpiscono generano un raggio di luce#{{Luck}} 50% di chance con 9 in Fortuna#{{Damage}} Il raggio infligge i danni di Isaac x4"},
	...
	{"378", "La Numero Due", "Tenere premuto il tasto di fuoco per 2.35 secondi genera 1 Bomba Popò"},
	...
	{"381", "Benedizione di Eden", "↑ {{Tears}} +0.7 Lacrime#Conferisce 1 oggetto casuale all'inizio della prossima run"},
	{"382", "Sfera Amikè", "Può essere lanciata ai nemici per catturarli#{{Friendly}} Usare l'oggetto dopo aver catturato 1 nemico lo genera come compagno amichevole"},
	...
	{"392", "Zodiaco", "Conferisce 1 effetto di un oggetto dello zodiaco casuale ad ogni piano"},
	...
	{"404", "Bebè Scoreggione", "Blocca i proiettili#Se colpito, 10% di chance di scoreggiare e di {{Charm}} ammaliare, {{Poison}} avvelenare o respingere i nemici"},
	...
	{"410", "Malocchio", "3.33% di chance di sparare un occhio#{{Luck}} 10% chance con 20 in Fortuna#L'occhio si muove in linea retta e spara lacrime nella stessa direzione di Isaac"},
	{"411", "Sangue Furente", "↑ {{Damage}} +0.5 Danni per ogni nemico ucciso nella stanza#Si massimizza a +5 Danni dopo 10 uccisioni"},
	{"412", "Immorale Concezione", "Subire danni per 15 volte genera 1 famiglio demoniaco permanente#Dopo 2 famigli, ne occorrono 30 invece di 15#Si massimizza a 4 famigli"},
	{"413", "Immacolata Concezione", "Raccogliere 15 cuori genera 1 famiglio angelico permanenente#Si massimizza a 5 famigli#{{SoulHeart}} Se sono stati presi tutti i famigli, genera invece 1 Cuore Celeste"},
	...
	{"416", "Tasche profonde", "Permette ad Isaac di portare 2 rune/carte/pillole"},
	...
	{"420", "Polvere nera", "Camminare in cerchio tracccia un pentagramma per terra, il quale infligge 10 danni per tocco"},
	...
	{"424", "Testa di Sacco", "I consumabili hanno una chance di venire rimpiazzati da 1 {{GrabBag}sacco:#{{Coin}}: 10%, {{Bomb}}{{Key}}{{Pill}}{{Rune}}{{Battery}}: 20%#{{GrabBag}} Genera 1 sacco"},
	...
	{"429", "Testa del Mercante", "{{Coin}} Colpire 1 nemico con una lacrima ha il 5% di chance di generare 1 Penny"},
	...
	{"434", "Barattolo di Mosche", "Uccidere 1 nemico aggiunge 1 mosca blu nelle giara, fino a un totale di 20#Usare l'oggetto libera tutte le mosche"},
	...
	{"440", "Calcolo Renale", "↑ +2 Altezza Lacrime#↓ {{Speed}} -0.2 Velocità#↓ {{Range}} -17 Gittata#Isaac certe volte smette di sparare e carica un attacco che rilascia uno scroscio di lacrime e un calcolo renale"},
	...
	{"443", "Mela!", "↑ {{Tears}} +0.3 Lacrime#{{Damage}} 6.66% di chance di sparare lamette che infliggono i danni di Isaac x4#{{Luck}} 100% di chance con 14 in Fortuna"},
	...
	{"450", "Occhio di Avarizia", "Ogni 20 lacrime, Isaac spara una lacrima-moneta che infligge il doppio dei danni#{{Petrify}} I nemici colpiti dalla moneta vengono pietrificati e tramutati in oro#{{Coin}} 1 nemico dorato ucciso butta a terra 1-4 monete#{{Warning}} Sparare una lacrima-moneta costa 1 moneta"},
	...
	{"454", "Polidattilia", "Quando viene raccolto genera 1 {{Rune}} runa, {{Card}} carta o {{Pill}} pillola#Permette ad Isaac di portare 2 rune/carte/pillole"},
	{"455", "Moneta Perduta di Papà", "↑ {{Range}} +1.5 Gittata#↑ +1 Altezza Lacrime#{{Luck}} Genera 1 Penny Fortunato"},
	...
	{"461", "Parassitoide", "15% di chance di sparare sacche ovali#{{Luck}} 50% di chance con 5 in Fortuna#{{Slow}} Quando le sacche ovali colpiscono generano del liquame rallentante e 1 ragno o mosca blu"},
	{"462", "Occhio di Belial", "↑ {{Range}} +1.5 Gittata#↑ +1 Altezza Lacrime#Lacrime penetranti#Colpire 1 nemico rende la lacrima a ricerca e ne raddoppia i danni"},
	...
	{"466", "Contagio", "{{Poison}} Il 1° nemico ucciso in una stanza esplode e avvelena tutti i nemici nelle vicinanze#I nemici avvelenati quando muoiono esplodono e avvelenano i nemici nelle vicinanze"},
	...
	{"469", "Depressione", "Lascia una scia di liquame#Il liquame infligge 6 danni al secondo#I nemici che toccano la nuvola possono essere colpiti da un raggio di luce sacra"},
	...
	{"477", "Vuoto", "Consuma tutti i piedistalli nella stanza#Oggetti attivi: Attiva i loro effetti, e lo stesso vale per ogni uso futuro di \"Vuoto\"#↑ Gli oggetti passivi conferiscono 2 aumenti a statistiche casuali"},
	{"478", "Pausa", "Blocca tutti i nemici nella stanza fino a quando Isaac non spara#Toccare 1 nemico bloccato infligge comunque danni ad Isaac#I nemici si sbloccano dopo 30 secondi"},
	...
	{"481", "Dataminer", "↑ Aumento di 1 statistica casuale#↓ Diminuzione di 1 statistica casuale#{{Timer}} Fino all'uscita dalla stanza un effetto di lacrime casuale#{{Blank}} Corrompe tutti gli sprite e la musica della stanza"},
	...
	{"487", "Pelapatate", "{{EmptyHeart}} Rimuove 1 Portacuori per:#↑ {{Damage}} +0.2 Danni#{{Collectible73}} 1 \"Cubo di Carne\"#{{Timer}} Conferisce fino all'uscita dalla stanza:#↑ {{Range}} +5 Gittata#{{Collectible214}} Lascia una scia di sangue"},
	...
	{"491", "Bebè Acido", "{{Pill}} Genera 1 pillola casuale ogni 3 stanze#{{Poison}} Usare 1 pillola avvelena i nemici nella stanza"},
	...
	{"496", "Eutanasia", "3.33% di chance di sparare un ago#{{Luck}} 100% di chance con 15 in Fortuna#Gli aghi uccidono istantaneamente i nemici normali, scoppiando in 10 lacrime#{{Damage}} Contro i boss gli aghi infliggono i danni di Isaac x3"},
	{"497", "Mutande Camo", "Entrare in una stanza confonde tutti i nemici fino a quando Isaac non inizia a sparare"},
	{"498", "Dualismo", "{{AngelDevilChance}} Nei casi in cui comparirebbe una Stanza dell'Angelo o del Diavolo vengono generate entrambe#Entrare in una delle 2 stanze fa sparire l'altra"},
	{"499", "Eucaristia", "{{AngelChance}} 100% di chance di generare una Stanza dell'Angelo"},
	{"500", "Sacco di Sacchi", "Genera 1 sacco ogni 5-6 stanze"},
	{"501", "Gozzo di Avarizia", "{{Heart}} +1 Portacuori per ogni 25 monete ottenute dopo aver preso \"Gozzo di Avarizia\""},
	{"502", "Brufolone", "{{Slow}} Sparando viene certe volte scagliata una lacrima con liquame bianco che infligge il doppio dei danni e rallenta i nemici#Subire danni fa sparare una lacrima con liquame bianco"},
	{"503", "Piccolo Corno", "5% di chance di sparare lacrime che uccidono istantaneamente i nemici#{{Luck}} 20% di chance con 15 in Fortuna#Isaac infligge 3.5 danni da contatto"},
	{"504", "Pepita Marrone", "Genera una mosca torretta che spara ai nemici#Ogni colpo infligge 2 danni"},
	{"505", "Pokè Go", "{{Friendly}} Entrare in una stanza ostile ha una chance di generare 1 nemico amichevole"},
	{"506", "Pugnalatore", "{{BleedingOut}} Colpire 1 nemico da dietro infligge il doppio dei danni e causa sanguinamento, che infligge il 10% della salute massima del nemico ogni 5 secondi"},
	{"507", "Cannuccia Appuntita", "{{Damage}} Infligge a tutti i nemici i danni di Isaac +10% della salute massima di ogni nemico#{{HalfHeart}} Infliggere danni con la cannuccia può generare mezzi cuori#{{HalfSoulHeart}} Non avere portacuori genera invece Cuori Celesti"},
	...
	{"511", "Moscarrabbiata", "Orbita attorno a 1 nemico casuale finché esso non muore#Infligge 30 danni da contatto agli altri nemici"},
	...
	{"513", "Pagliaccio", "↑ {{Damage}} +0.1 Danni#{{SoulHeart}} +1 Cuore Celeste#{{Charm}} Ammalia/spaventa i nemici in maniera casuale#Subire ha una chance casuale di generare 1 Cacca Arcobaleno"},
	...
	{"519", "Mini Delirio", "Si trasforma ogni 10 secondi in 1 famiglio casuale"},
	...
	{"530", "Lista Nera", "Uccidere i nemici nell'ordine imposto dal marchio {{DeathMark}} sopra di loro conferisce 1 consumabile casuale o un aumento di 1 statistica"},
	...
	{"535", "Copertina", "{{HealingRed}} Cura 1 cuore#{{SoulHeart}} +1 Cuore Celeste#{{HolyMantle}} Entrare in una Stanza Boss conferisce 1 scudo di \"Manto Sacro\" (previene i danni per 1 volta)"},
	...
	{"537", "Mini Conato", "{{Pill}} Quando viene raccolto genera 1 pillola casuale#Spara una striscia di liquame#Il tipo di liquame cambia ad ogni uso di una pillola"},
	...
	{"539", "Uovo Misterioso", "{{Friendly}} Subire danni genera 1 nemico amichevole#Genera amici più forti quanto più vengono completate stanze senza subire danni"},
	...
	{"543", "Terra Consacrata", "Subire danni genera 1 Cacca Bianca#Dentro l'aura della cacca:#↑ {{Tears}} x0.5 Moltiplicatore Delay tra Lacrime#Chance di bloccare i danni"},
	...
	{"549", "Osteogenesi Imperfetta", "{{EmptyBoneHeart}} Rimpiazza tutti i Cuori Rossi di Isaac con 6 Cuori Ossei vuoti#Se si perde 1 Cuore Osseo:#↑ {{Tears}} +0.5 Lacrime#Spara 8 lacrime ossute in tutte le direzioni"},
...
EID.descriptions[languageCode].carBattery = {
	...
	[37] = {" una ", " 2 ", "grossa bomba", "{{CR}}grosse bombe", "infligge", "{{CR}}infliggono"}, -- Mr. Boom
	...
	[105] = "Risorteggia 2 volte, esaurendo più velocemente le categorie di oggetti", -- The D6
	[107] = "Genera 2 corpi", -- The Pinking Shears
	[111] = {5, 10}, -- The Bean
	[123] = {" 1 ", " 2 ", "famiglio casuale", "{{CR}}famigli casuali"}, -- Monster Manual
	[124] = {" l'effetto", "{{CR}}2 effetti", "1 oggetto attivo casuale", "{{CR}}2 oggetti attivi casuali"}, -- Dead Sea Scrolls
	[136] = {" un'esca ", " 2 esche ", "attrae", "{{CR}}attraggono", "esplode", "{{CR}}esplodono"}, -- Best Friend
	...
	[283] = "Risorteggia 2 volte, aiutando con il progresso della trasfromazione ma esaurendo più velocemente le categorie di oggetti", -- D100
	[284] = "Risorteggia 2 volte, aiutando con il progresso della trasfromazione ma esaurendo più velocemente le categorie di oggetti", -- D4
	[286] = "Lo attiva 2 volte", -- Blank Card
	[287] = {"1", "2"}, -- Book of Secrets
	...
	[348] = "Lo attiva 2 volte", -- Placebo
	[349] = "Attiva la chance 2 volte", -- Wooden Nickel
	[351] = {5, 10}, -- Mega Bean
	[357] = {"Raddoppia", "Triplica"}, -- Box of Friends
	[383] = {6, 36}, -- Tear Detonator
	[421] = {5, 10}, -- Kidney Bean
	[427] = {" un ", " 2 ", "blocco di TNT spostabile", "{{CR}}blocchi di TNT spostabili", "il blocco", "{{CR}}i blocchi"}, -- Mine Crafter
	[439] = {1, 2, "ninnolo casuale", "{{CR}}ninnoli casuali"}, -- Mom's Box
	[476] = {1, 2, "consumabile casuale", "{{CR}}consumabili casuali"}, -- D1
	[477] = "Attiva ogni effetto assorbito 2 volte", -- Void
	[480] = {"Raddoppia", "Quadruplica"}, -- Compost
	[481] = "2 aumenti e diminuzioni di statistica", -- Dataminer
	[482] = "Cambia 2 volte il personaggio e rimuove 2 oggetti", -- Clicker
	...
	[486] = {"gli effetti", "{{CR}}{{BlinkYellowGreen}}2 volte gli effetti"}, -- Dull Razor
	[488] = "Lo attiva 2 volte, ma rimane solo il secondo effetto", -- Metronome
	[489] = {" l'effetto ", " gli effetti "}, -- D Infinity (TODO: d infinity's desc addon is not visible in item reminder)
	[504] = {" 1 ", " 2 ", "mosca", "{{CR}}mosche", "spara", "{{CR}}sparano"}, -- Brown Nugget
	[507] = "Si attiva 2 volte", -- Sharp Straw
	[510] = {"una", "2", "forma", "{{CR}}forme", "amichevole", "{{CR}}amichevoli"}, -- Delirious
	[516] = {"un", "2", "irrigatore che spara", "{{CR}}irrigatori che sparano"}, -- Sprinkler
	[521] = {"un", "2", "oggetto casuale", "{{CR}}oggetti casuali"}, -- Coupon
	[523] = "Scambia i contenuti della scatola con i consumabili nella stanza", -- Moving Box
	[545] = {8, 16}, -- Book of the Dead
	[550] = "Ferma i pestoni per 2 stanze (o 2 ondate della Boss Rush)", -- Broken Shovel
}
...
EID.descriptions[languageCode].BFFSSynergies = {
	...
	["5.100.266"] = "Genera 1 ragno blu extra", -- Juicy Sack
	...
	["5.100.537"] = "Aumenta la grandezza del liquame, ma non i danni", -- Lil Spewer
...
EID.descriptions[languageCode].trinkets={
	...
	{"5", "Cuore Viola", "Chance doppie di nemici campioni"},
	...
	{"17", "Rossetto Nero", "{{BlackHeart}} +10% di chance che i Cuori Celesti casuali possano venire generati come Cuori Neri"},
	...
	{"21", "Foglio Misterioso", "Conferisce ad intervalli casuali 1 degli effetti di: #{{Collectible327}} \"La Polaroid\"#{{Collectible328}} \"Il Negativo\"#{{Trinket48}} \"Una Pagina Mancante\"#{{Trinket23}} \"Volantino 'Smarrito'\""},
	...
	{"24", "Penny Popò", "{{Coin}} Chance più alte del 20% di generare monete dalla cacca#Raccogliere monete fa scoreggiare Isaac"},
	{"25", "Caramella Misteriosa", "Isaac scoreggia o genera cacca ogni 30 secondi"},
	...
	{"30", "Congiuntivite", "{{Poison}} 10% di chance di sparare lacrime velenose#{{Luck}} 100% di chance con 18 in Fortuna"},
	{"31", "Puntina", "10% di chance di sparare lacrime penetranti + spettrali#{{Luck}} 100% di chance con 18 in Fortuna"},
	{"32", "Fungo della Libertà", "25% di chance di un effetto di 1 fungo casuale a stanza#Può rivelare stanze speciali sulla minimappa"},
	...
	{"40", "Toppa Rossa", "{{Timer}} Subire danni ha il 20% di chance di conferire ↑ {{Damage}} +1.8 Danni fino all'uscita dalla stanza#{{Luck}} 100% chance con 8 in Fortuna"},
	...
	{"46", "Forchetta di Isaac", "{{HealingRed}} Completare una stanza ha il 10% di chance di curare di mezzo cuore#{{Luck}} 100% di chance con 18 in Fortuna"},
	...
	{"54", "Testa Di Isaac", "Famiglio con lacrime penetranti#Infligge 3.5 danni per lacrima"},
	{"55", "Fede di Madda", "{{EternalHeart}} Entrare in nuovo piano conferisce +1 Cuore Eterno"},
	{"56", "Lingua di Giuda", "{{DevilRoom}} Abbassa tutti i costi di un patto col diavolo a 1 Portacuori#Non abbassa il costo da 3 Cuori Celesti "},
	{"57", "Anima di ???", "Famiglio che rimbalza attorno alla stanza#Spara nella stessa direzione di Isaac#Infligge 3.5 danni a lacrima"},
	{"58", "Ciocca di Sansone", "{{Timer}} Uccidere 1 nemico ha il 6.66% di chance di conferire ↑ {{Damage}} +0.5 Danni fino all'uscita dalla stanza#{{Luck}} 100% di chance con 10 in Fortuna"},
	{"59", "Occhio di Caino", "Entrare in un nuovo piano ha il 25% di chance di rivelare icone sulla mappa#{{Luck}} 100% di chance con 3 in Fortuna"},
	{"60", "Zampa d'Uccello di Eva", "{{Collectible117}} Uccidere 1 nemico ha il 5% di chance di generare un \"Uccello Morto\"#{{Luck}} 100% di chance con 8 in Fortuna"},
	...
	{"67", "Dado Incrinato", "Subire danni ha il 50% di attivare 1 dei seguenti effetti:#{{Collectible105}} D6#{{Collectible406}} D8#{{Collectible386}} D12 #{{Collectible166}} D20"},
	...
	{"70", "Pidocchio", "Certe volte genera 1 ragno blu nelle stanze ostili"},
	{"71", "Vescica di Bob", "Le bombe di Isaac lasciano liquame danneggiante"},
	...
	{"73", "Minicicciolo", "{{Bomb}} 10% di chance che le bombe che scoppiano buttino a terra 1 bomba consumabile"},
	...
	{"91", "Meconio", "33% di chance che si generi 1 Cacca Nera#{{BlackHeart}} Distruggere Cacche Nere ha un 5% di chance di generare un Cuore Nero"},
	...
	{"96", "Verme Uroboro", "↑ {{Range}} +4 Gittata#↑ +2 Altezza Lacrime#Lacrime spettrali#Chance di lacrime a ricerca#{{Luck}} 100% di chance con 9 in Fortuna#Le lacrime di Isaac si muovono velocemente a spirale"},
	{"97", "Tonsilla", "Subire danni 12-20 volte genera 1 famiglio che blocca i proiettili#Sparisce dopo aver generato 2 famigli"},
	{"98", "Pepita Verde", "10% di chance di sparare una lacrima adesiva#50% di chance che sia a ricerca#{{Damage}} Le caccole infliggono i danni di Isaac 1 volta al secondo#Le caccole si incollano per 60 secondi"},
	...
	{"106", "Tappo di Sughero Smarrito", "Aumenta il raggio del liquame non nemico"},
	...
	{"113", "Locusta della Guerra", "Entrare in una stanza ostile genera 1 mosca esplosiva d'assalto#La mosca infligge i danni di Isaac x2 + danni esplosivi"},
	{"114", "Locusta della Pestilenza", "{{Poison}} Entrare in una stanza ostile genera 1 mosca velenosa d'assalto#La mosca infligge i danni di Isaac x2"},
	{"115", "Locusta della Carestia", "{{Slow}} Entrare in una stanza ostile genera 1 mosca rallentante d'assalto#La mosca infligge i danni di Isaac x2"},
	{"116", "Locusta dela Morte", "Entrare in una stanza ostile genera 1 mosca d'assalto#La mosca infligge i danni di Isaac x4"},
	{"117", "Locusta della Conquista", "Entrare in una stanza ostile genera 1-4 mosche d'assalto#Ogni mosca infligge i danni di Isaac x2"},
	{"118", "Ali di Pipistrello", "{{Timer}}Uccidere 1 nemico ha il 5% di chance di conferire il volo fino all'uscita dalla stanza"},
	{"119", "Cellula Staminale", "{{HealingRed}} Entrare in un nuovo piano cura di mezzo cuore"},
	{"120", "Forcina per Capelli", "{{Battery}} Entrare in una stanza boss non completata ricarica totalmente gli oggetti attivi"},
	{"121", "Croce di Legno", "{{Collectible313}} Conferisce 1 scudo di \"Manto Sacro\" che nega il 1° danno preso nel piano"},
...
EID.descriptions[languageCode].cards={
	{"1", "0 - Il Matto", "Teletrasporta Isaac nella 1° stanza del piano"},
	{"2", "I - Il Bagatto", "{{Timer}} Lacrime a ricerca fino all'uscita dalla stanza"},
	{"3", "II - La Papessa", "Il piede di Mamma calpesta 1 nemico#Se non ci sono nemici il piede di Mamma calpesta Isaac"},
	...
	{"11", "X - Ruota della Fortuna", "Genera 1 {{Slotmachine}} Slot Machine#{{FortuneTeller}} 25% di chance che sia 1 Macchina dei Desideri"},
	...
	{"15", "XIV - Temperanza", "{{DonationMachine}} Genera 1 Macchina di Donazione Sangue"},
	...
	{"21", "XX - Il Giudizio", "Genera 1 Mendicante#{{DemonBeggar}} 33% di chance che sia 1 Mendicacuori#2% di chance che sia 1 Chiavaiolo o Scroccabombe"},
	...
	{"40", "Runa Muta", "Attiva l'effetto di 1 runa casuale#Se usata 25% di chance di autoduplicarsi"},
	...
	{"48", "Carta ?", "Concede 1 uso gratuito dell'oggetto attivo di Isaac"},
	{"49", "Scheggia di Dado", "Risorteggia tutti i piedistalli e i consumabili nella stanza"},
	{"50", "Contatto di Emergenza", "2 mani di Mamma scendono giù e afferrano 1 nemico ciascuno"},
...
EID.descriptions[languageCode].tarotClothBuffsAB = {
	...
	[11] = {" 1 ", " 2 ", "Macchina", "{{CR}}Macchine"," sia 1 Macchina dei Desideri", " siano 2 {{CR}}Macchine dei Desideri"}, -- X - Wheel of Fortune
	[12] = {1, 2, 0.3, 0.6, 0.3, 0.6, 5.25, 10.5}, -- XI - Strength
	[14] = {40, 80}, -- XIII - Death
	[15] = {" 1 ", " 2 ", "Macchina", " {{CR}}Macchine", "un Mendicacuore", "2 {{CR}}Mendicacuori"},-- XIV - Temperance (+ Greed version) 
	[17] = {6, 12}, -- XVI - The Tower
	[20] = {100, 200}, -- XIX - The Sun
	[21] = {" 1 Mendicante", " 2 {{CR}}Mendicanti", "sia 1 Mendicauori", "siano 2 {{CR}}Mendicacuori", "sia 1 Chiavaiolo o Scroccabombe", "siano 2 {{CR}}Chiavaioli o Scroccabombe"}, -- XX - Judgement
...
EID.descriptions[languageCode].pills={
	{"0", "Gas Nocivo", "{{Poison}} Isaac scoreggia e avvelena i nemici nelle vicinanze"},
	{"1", "Brutto Trip", "{{Warning}} Infligge 1 cuore di danno ad Isaac#{{Heart}} Con 1 cuore o meno diventa 1 pillola \"Salute al Massimo\""},
	...
	{"5", "Salute al Massimo", "{{HealingRed}} Cura tutti i Portacuori"},
	{"6", "Meno Salute", "↓ {{EmptyHeart}} -1 Salute#{{Heart}} Con 0 o 1 cuore diventa 1 pillola \"Più Salute\""},
	...
	{"20", "Energia per 48 Ore!", "{{Battery}} Ricarica totalmente l'oggetto attivo#{{Battery}} Genera 1-2 pile"},
	...
	{"39", "Liqui-Lax", "Genera una pozza di liquame scivoloso"},
	{"40", "Qualcosa Non Quadra...", "{{Slow}} Genera una pozza di liquame rallentante"},
...
EID.descriptions[languageCode].CharacterInfo = {
	...
	[10] = {"Lo Smarrito", "Volo#Lacrime spettrali#{{Warning}} Niente Salute#{{DevilRoom}} I patti col diavolo possono essere stretti gratuitamente 1 volta per stanza"},
...
EID.descriptions[languageCode].sacrifice={
	...
	{"6", "", "{{AngelRoom}} 33% di chance di teletrasportarsi nella Stanza dell'Angelo#{{DevilRoom}} Teletrasporta nella Stanza del Diavolo se la sua porta è stata generata nel piano corrente#{{Chest}} 67% di chance di 1 baule casuale"},
...
EID.descriptions[languageCode].ConditionalDescs = {
	...
	["5.300.15"] = {"{{DemonBeggar}} Genera 1 Mendicacuori"}, -- Temperance (Greed)
	["5.300.19"] = {"Teletrasporta Isaac nella 1° stanza del piano"}, -- The Moon (Greed)
	["5.300.20"] = {"{{HealingRed}} Salute al massimo#Infligge 100 danni a tutti i nemici"}, -- XIX - The Sun (Greed)
	["5.100.483 (Greed)"] = "{{GreedMode}} Non si attiva per ogni ondata, bensì per ogni stanza", -- Mama Mega (Greed)
	...
	["5.350.34"] = {"{{Heart}} 33% di chance di 1 cuore extra da bauli, rocce colorate e da macchine distrutte"}, -- Child's Heart
	["5.350.36"] = {"{{Key}} 33% di chance di 1 chiave extra da bauli, rocce colorate e da macchine distrutte"}, -- Rusted Key
	["5.350.41"] = {"{{Bomb}} 33% di chance di 1 bomba extra da bauli, rocce colorate e da macchine distrutte#{{Warning}} Rimuove {{Trinket53}} \"Zecca\""}, -- Match Stick
	["5.350.44"] = {"{{Pill}} 33% di chance di 1 pillola extra da bauli, rocce colorate e da macchine distrutte"}, -- Safety Cap
	["5.350.45"] = {"{{Card}} 33% di chance di 1 carta extra da bauli, rocce colorate e da macchine distrutte"}, -- Ace of Spades
	["5.350.72"] = {"{{Battery}} +10% di chance che un consumabile casuale sia 1 pila#{{Battery}} 5% di chance di aggiungere 1 carica all'oggetto attivo tenuto mentre si completa un'ondata"}, -- Watch Battery
	...
	["Technology 2 One Eye"] = "Con {1} il laser rimpiazza del tutto le lacrime",
	...
	["Ghost Pepper Fart"] = "Scoreggiare fa sparare una fiamma dietro ad Isaac",
	["Damage Multiplier Stack"] = "Il moltiplicatore danni non scala",
	["White Poop"] = "Genera invece 1 Cacca Bianca",
	["White Poop Chance"] = "Chance di generare 1 Cacca Bianca",
	["Golden Poop Chance"] = "Chance di generare 1 Cacca Dorata",
	["5.100.483"] = "{{GoldenBomb}} Avere una bomba dorata mentre si usa l'oggetto lo consuma e concede 1 uso ulteriore di \"Mamma Mega\"",
	...
	["5.300.18 (Late Greed)"] = {"Teletrasporta Isaac nella 1° stanza del piano"}, -- XVII - The Stars (Greed Last Floors)
