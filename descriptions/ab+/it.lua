...
EID.descriptions[languageCode].collectibles={
	...
	{"49", "Shoop da Whoop!", "{{Collectible118}}Usare l'oggetto e sparare in una direzione aziona un laser dai danni elevati#Infligge 24x i danni di Isaac in 0.9 secondi"},
	...
	{"173", "Mitra", "{{SoulHeart}} 50% di possibilità che i Cuori Rossi vengano generati come Cuori Celesti"},
