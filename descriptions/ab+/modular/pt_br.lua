...
local additionalCollectibleInformations = {
	[C_ID .. 8] = "Atira lágrimas normais (3.5 de dano)", -- Brother Bobby
	-- Full old Desc: "Atira lágrimas normais (3.5 de dano)"
	-- English: "Shoots normal tears"

	[C_ID .. 9] = "Todos as moscas inimigas são amigáveis", -- Skatole
	-- English: "All fly enemies are friendly"

	[C_ID .. 11] = "Renascer com saúde total", -- 1up!
	-- Full old Desc: "↑ +1 Vida#Renascer com saúde total"
	-- English: "Isaac respawns with full health on death"

	[C_ID .. 13] = "{{BlackHeart}} Inimigos podem soltar Corações Negros se envenenados", -- The Virus
	-- Full old Desc: "{{Poison}} Toque venenoso#↓ {{Speed}} -0.1 Velocidade#{{BlackHeart}} Inimigos podem soltar Corações Negros se envenenados"
	-- English: "{{Poison}} Touching enemies poisons them#{{BlackHeart}} Poisoned enemies can drop Black Hearts"

	[C_ID .. 21] = "Revela os ícones no mapa#Não mostra o layout do mapa", -- The Compass
	-- English: "Reveals icons on the map#Does not reveal the layout of the map"

	[C_ID .. 33] = "Voo para o sala atual#{{MomsHeart}} Mata o Pé da Mãe e o Coração da Mãe instantaneamente#!!! Mata VOCÊ quando usado no Satan", -- The Bible
	...
	[C_ID .. 36] = "Solte um cocô e empurre os inimigos#Pode ser colocado próximo a um poço e destruído com uma bomba para fazer uma ponte", -- The Poop
	-- English: "Spawns one poop and knocks back enemies#Can be placed next to a pit and destroyed with a bomb to make a bridge"

	[C_ID .. 38] = "Dispara 10 lágrimas em um círculo ao redor do personagem", -- Tammy's Head
	...
	[C_ID .. 40] = "Causa uma explosão no local do jogador", -- Kamikaze!
	-- Full old Desc: "Causa uma explosão no local do jogador#Causa 40 de dano"
	...
	[C_ID .. 42] = "{{Poison}} Bomba venenosa arremessável", -- Bob's Rotten Head
	-- English: "Using the item and firing in a direction throws the head#{{Poison}} The head explodes on impact and poisons enemies"

	[C_ID .. 44] = "Teleporta o personagem para uma sala aleatória", -- Teleport!
	-- English: "Teleports Isaac into a random room, except I AM ERROR rooms"

	[C_ID .. 46] = "Aumenta a chance de ganhar em jogos e em máquinas", -- Lucky Foot
	-- Full old Desc: "↑ {{Luck}} +1 Sorte#Aumenta a chance de ganhar em jogos e em máquinas"
	-- English: "+8% room clear reward chance#Better chance to win while gambling"

	[C_ID .. 47] = "{{Collectible168}} Ao usar, comece a apontar uma mira#Um míssil cai na mira após 1.5 segundos#Causa 20x o seu dano", -- Doctor's Remote
	...
	[C_ID .. 52] = "↓ {{Tears}} Atraso de lágrima x 2.5", -- Dr. Fetus
	-- Full old Desc: "{{Bomb}} Lágrimas de bomba#{{Damage}} Cada bomba causa 5x o seu dano + 30#↓ {{Tears}} Atraso de lágrima x 2.5"
	...
	[C_ID .. 54] = "Revela o layout do andar#Não mostra os ícones das salas", -- Treasure Map
	-- English: "Reveals the floor layout#Does not reveal room icons"

	[C_ID .. 56] = "Derrama uma poça de limonada#Causa 24 de dano por segundo", -- Lemon Mishap
	...
	-- Full old Desc: "Mosca orbital de média distância#Causa 75 de dano ao contato por segundo"
	-- English: "Mid-range fly orbital"

	[C_ID .. 60] = "Caminhe por pequenas lacunas", -- The Ladder
	-- English: "Allows Isaac to cross 1-tile gaps"

	[C_ID .. 62] = "{{HalfHeart}} Cura Meio Coração a cada 13 inimigos mortos", -- Charm of the Vampire
	...
	[C_ID .. 64] = "{{Shop}} 50% de desconto em itens de loja#Conseguir dois deixará tudo de graça", -- Steam Sale
	-- English: "{{Shop}} Shop items cost 50% less"

	[C_ID .. 65] = "Gera 6 bombas trolls próximo ao centro da sala", -- Anarchist Cookbook
	...
	[C_ID .. 67] = "Familiar que dispara lágrimas normais", -- Sister Maggy
	-- Full old Desc: "Familiar que dispara lágrimas normais#Causa 3.5 de dano por lágrima"
	-- English: "Shoots normal tears"

	[C_ID .. 68] = "Lágrimas agora são lasers", -- Technology
	-- English: "Isaac shoots lasers instead of tears"

	[C_ID .. 69] = "{{Chargeable}} Lágrimas carregadas#↑ {{Damage}} Até 400% de Dano#↓ {{Tears}} Lágrimas", -- Chocolate Milk
	...
	[C_ID .. 75] = "{{Heart}} Cura 2 Corações", -- PHD
	-- Full old Desc: "{{Pill}} Pílulas melhores#{{Pill}} Gera uma pílula ao pegar#{{Pill}} Pílulas identificadas#{{Heart}} Cura 2 Corações#{{DonationMachine}} Mais dinheiro da Blood Donation Machines e {{Collectible135}} IV Bag"
	...
	[C_ID .. 78] = "↑ {{AngelDevilChance}} +17.5% oportunidade de Sala do Diabo/Anjo enquanto segurar", -- Book of Revelations
	-- Full old Desc: "{{SoulHeart}} +1 Coração de Alma#Alta chance de Chefes Cavaleiros#↑ {{AngelDevilChance}} +17.5% oportunidade de Sala do Diabo/Anjo enquanto segurar"
	-- English: "Using the item has a high chance to replace the floor's boss with a horseman"

	[C_ID .. 81] = "Renascer com 1 Coração#↓ Define seus contêineres de Coração Vermelho para 1", -- Dead Cat
	-- Full old Desc: "↑ +9 Vidas#Renascer com 1 Coração#↓ Define seus contêineres de Coração Vermelho para 1#!!! Personagens que não podem ter Corações Vermelhos ficam com 1 Coração de Alma/Negro"
	...
	-- Full old Desc: "{{SoulHeart}} +1 Coração de Alma#↑ {{Damage}} +0.7 Dano#↓ {{Speed}} -0.18 Velocidade#Causa 40 de dano ao contato por segundo#Destrói pedras ao andar sobre elas"
	-- English: "{VAR:ONUSEEFFECT}#{VAR:ROOMEFFECT}#{{IND}}Allows Isaac to destroy rocks by walking into them"

	[C_ID .. 84] = "Cria um alçapão para o próximo andar#{{LadderRoom}} 10% de chance de criar um alçapão com escada", -- We Need To Go Deeper!
	...
	[C_ID .. 88] = "Familiar que avança para frente", -- Little Chubby
	-- Full old Desc: "Familiar que avança para frente#Causa 52.5 de dano ao contato por segundo"
	...
	-- Full old Desc: "Curta invencibilidade#{{Fear}} Amedrontra todos os inimigos#Causa 40 de Dano ao contato por segundo#{{HalfHeart}} Dois inimigos comidos reabastecem Meio Coração"
	-- English: "{VAR:TIMEDEFFECT}#{{IND}}{{HealingRed}} Killing 2 enemies heals half a heart#{{IND}}{{Fear}} Fears all enemies in the room"

	[C_ID .. 94] = "{{Coin}} Solta moedas aleatórias a cada 2 salas", -- Sack of Pennies
	...
	[C_ID .. 96] = "{{HalfHeart}} Solta Meio Coração a cada 3 salas", -- Little C.H.A.D.
	-- English: "{{HalfHeart}} Spawns a half Red Heart every 3 rooms"

	[C_ID .. 99] = "{{Slow}} Lágrimas que causam lentidão", -- Little Gish
	-- Full old Desc: "{{Slow}} Lágrimas que causam lentidão#Causa 3.5 de dano por disparo"
	-- English: "{{Slow}} Shoots slowing tears"

	[C_ID .. 100] = "Lágrimas teleguiadas", -- Little Steven
	-- Full old Desc: "Lágrimas teleguiadas#Causa 3.5 de dano por disparo"
	-- English: "Shoots homing tears"

	[C_ID .. 104] = "Lágrimas se dividem em duas ao contato#Lágrimas divididas causam metade do dano", -- The Parasite
	...
	[C_ID .. 109] = "↑ {{Damage}} +0.04 Dano para cada {{Coin}} moeda que você tem#↑ +3.96 Dano com 99 moedas", -- Money = Power
	...
	-- Full old Desc: "Orbital#Acelera todos os orbitais#Bloqueia projéteis#Causa 105 de dano ao contato por segundo"
	-- English: "Speeds up all other orbitals"

	[C_ID .. 113] = "Torreta de disparo automático", -- Demon Baby
	-- Full old Desc: "Torreta de disparo automático#Causa 3 de dano por disparo"
	-- English: "Shoots enemies that get close to him"

	[C_ID .. 114] = "{{Chargeable}} Carregável#Cencede uma faca controlável#A faca causa 2x seu dano enquanto segurar e 6x quando arremessado a distância máxima", -- Mom's Knife
	...
	[C_ID .. 116] = "-1 carga necessária para itens ativáveis#{{Battery}} Recarrega completamente seu item ativo", -- 9 Volt
	-- English: "{{Battery}} Automatically charges the first bar of active items#{{Battery}} Fully recharges the active item on pickup"

	[C_ID .. 117] = "Gera um pássaro quando você é atingido", -- Dead Bird
	-- Full old Desc: "Gera um pássaro quando você é atingido#Causa 4 de dano por segundo"
	-- English: "Taking damage spawns a bird that attacks enemies"

	[C_ID .. 122] = "!!! Quando estiver com meio Coração Vermelho ou menos#{VAR:EFFECTLIST}", -- Whore of Babylon
	-- Full old Desc: "!!! Quando estiver com meio Coração Vermelho ou menos#↑ {{Damage}} +1.5 Dano#↑ {{Speed}} +0.3 Velocidade"
	-- English: "When on half a Red Heart or less:#{VAR:EFFECTLIST}"

	[C_ID .. 123] = "Concede um familiar aleatório para a sala atual", -- Monster Manual
	-- English: "{{Timer}} Spawns a random familiar for the room"

	[C_ID .. 124] = "Efeito aleatório de um item ativo", -- Dead Sea Scrolls
	...
	[C_ID .. 126] = "↑ {{Damage}} +1.2 Dano#↓ -1 Saúde", -- Razor Blade
	...
	[C_ID .. 130] = "Concede voo enquanto segura#Arrancada em uma direção cruzando a tela (40 de dano ao contato)#{{Speed}} Define sua velocidade para 1.5 se você tem menos que 1.5", -- A Pony
	-- English: "While held:#{{Speed}} Sets your Speed to at least 1.5#Flight#Upon use, dashes in the direction of Isaac's movement"

	[C_ID .. 131] = "{{Bomb}} Solta 1 bomba coletável a cada 2-3 salas", -- Bomb Bag
	-- English: "{{Bomb}} Spawns 1 bomb pickup every 3 rooms"

	[C_ID .. 132] = "{{Damage}} Lágrimas causam mais dano quanto mais elas viajam", -- A Lump of Coal
	-- English: "{{Damage}} Tears deal more damage the further they travel"

	[C_ID .. 133] = "!!! Ao usar converte#1 Contêiner de Coração Vermelho em 3 Corações de Alma", -- Guppy's Paw
	-- English: "{{SoulHeart}} Converts 1 heart container into 3 Soul Hearts"

	[C_ID .. 134] = "{{Chest}} 33% de chance da recompesa por limpar a sala ser um baú#33% de chance de não receber nenhuma recompensa ao limpar a sala", -- Guppy's Tail
	-- English: "{{Chest}} 33% chance to replace the room clear reward with a chest#33% chance to spawn no room clear reward"

	[C_ID .. 135] = "Banco de sangue portátil#Metade de um Coração = 1-3 Moedas#{{Player14}} 0-1 moeda como Keeper", -- IV Bag
	...
	[C_ID .. 139] = "{{Trinket}} Agora você pode segurar 2 trinkets", -- Mom's Purse
	...
	[C_ID .. 142] = "{{SoulHeart}} Uma vez por sala, quando ficar com Meio Coração, você ganha 1 Coração de Alma", -- Scapular
	...
	[C_ID .. 144] = "{{Coin}} Coleta moedas do chão#Gera pickups aleatórios em troca", -- Bum Friend
	...
	[C_ID .. 151] = "16% Chance de gerar uma mosca quando lágrimas atingem um inimigo", -- The Mulligan
	-- English: "Tears have a 1/6 chance to spawn a blue fly when hitting an enemy"

	[C_ID .. 152] = "↓ {{Damage}} -35% Dano#↓ {{Tears}} Atraso da Lágrima x 2", -- Technology 2
	-- Full old Desc: "Troca as lágrimas do seu olho direito por um laser contínuo#O laser causa 20% do seu dano#↓ {{Damage}} -35% Dano#↓ {{Tears}} Atraso da Lágrima x 2"
	...
	[C_ID .. 156] = "{{Battery}} +1 carga quando você for atingido", -- Habit
	-- English: "{{Battery}} Taking damage adds 1 charge to the active item"

	[C_ID .. 157] = "!!! Quando você é atingido#↑ {{Damage}} Dano#Dura todo o andar", -- Bloody Lust
	...
	-- Full old Desc: "Revelar todo o mapa do andar#Solta carta aleatória ou Coração de Alma"
	-- English: "Spawns a {{SoulHeart}} Soul Heart, {{Rune}} rune or {{Card}} card#{VAR:EFFECTLIST}"

	[C_ID .. 160] = "Gera 5 raios de luz próximos aos inimigos#Causa seu dano + 20", -- Crack the Sky
	...
	[C_ID .. 163] = "Familiar que dispara lágrimas espectrais", -- Ghost Baby
	-- Full old Desc: "Familiar que dispara lágrimas espectrais#Causa 3 de dano por disparo"
	-- English: "Shoots spectral tears"

	[C_ID .. 164] = "Lança uma chama azul#Causa dano ao contato#Bloqueia lágrimas de inimigos#Some após 2 segundos", -- The Candle
	...
	[C_ID .. 168] = "Em vez de lágrimas, aponta uma mira#Um míssil cai na mira após 1,5 segundos#Causa 20 vezes o seu dano", -- Epic Fetus
	...
	[C_ID .. 174] = "Familiar que dispara lágrimas de tipo aleatória", -- Rainbow Baby
	-- Full old Desc: "Familiar que dispara lágrimas de tipo aleatória#Causa 3-5 de dano por disparo"
	...
	[C_ID .. 178] = "Deixa uma poça quando você é atingido#Causa 24 de dano por segundo", -- Holy Water
	...
	[C_ID .. 181] = "Concede Voo#{{Speed}} Define sua velocidade para 1.5 se você tem menos que 1.5#Holy Dash ao usar", -- White Pony
	...
	[C_ID .. 187] = "Bola de pelo em crescimento#Balança ao seu redor#Cresce ao matar um inimigo#Bola maior causa mais dano", -- Guppy's Hairball
	...
	-- Full old Desc: "Espelha seu movimento#Atira em direção ao jogador#Causa 3.5 de dano por disparo"
	-- English: "Mirrors Isaac's movement#Shoots towards Isaac"

	[C_ID .. 191] = "Efeito de lágrima aleatório a cada 2-3 segundos", -- 3 Dollar Bill
	...
	[C_ID .. 199] = "Mais itens de baús", -- Mom's Key
	-- Full old Desc: "{{Key}} +2 chaves#Mais itens de baús"
	-- English: "Chests contain more pickups"

	[C_ID .. 202] = "Transforma inimigos em ouro ao tocar#Causa dano ao contato baseado na quantidade de moedas que você tem#{{Coin}} Inimigos dourados soltam moedas#Alta chance de efeitos que geram Cocôs gerarem Cocôs Dourados", -- Midas' Touch
	...
	[C_ID .. 204] = "50% de chance de soltar um pickup aleatório quando for atingido", -- Fanny Pack
	-- English: "Taking damage has a 50% chance to spawn a random pickup"

	[C_ID .. 205] = "{{Battery}} Ao usar, recarrega completamente seu item ativo ao custo de 2 Corações#!!! Só funciona quando o item não tem cargas!", -- Sharp Plug
	...
	[C_ID .. 208] = "↑ {{Damage}} +1 Dano", -- Champion Belt
	-- Full old Desc: "+15% de chance de Inimigos Campeões aparecerem#↑ {{Damage}} +1 Dano"
	-- English: "Champion enemy chance goes from 5% to 20%#Doesn't increase chance of champion bosses"

	[C_ID .. 209] = "{{Confusion}} Explosões confundem e danificam todos os inimigos na sala", -- Butt Bombs
	-- Full old Desc: "{{Bomb}} +5 Bombs#{{Confusion}} Explosões confundem e danificam todos os inimigos na sala"
	-- English: "{{Confusion}} Explosions concuss and damage every enemy in the room"

	[C_ID .. 210] = "Invencível ao ficar parado por 1 segundo", -- Gnawed Leaf
	-- English: "After 1 second of inactivity, Isaac becomes invincible"

	[C_ID .. 212] = "50% de chance de reviver com Meio Coração após morrer", -- Guppy's Collar
	-- English: "50% chance to revive with half a heart on death"

	[C_ID .. 213] = "Lágrimas bloqueiam projéteis inimigos", -- Lost Contact
	-- Full old Desc: "Lágrimas que protejem#Lágrimas bloqueiam projéteis inimigos#↓ {{Shotspeed}} -0.15 Velocidade de Disparo"
	-- English: "Isaac's tears destroy enemy shots"

	[C_ID .. 214] = "Deixa em rastro que causa dano após receber dano", -- Anemic
	-- Full old Desc: "↑ {{Range}} +5 Alcance#Deixa em rastro que causa dano após receber dano"
	-- English: "{{Timer}} When taking damage Isaac leaves a trail of blood creep for the room#The creep deals 6 damage per second"

	[C_ID .. 218] = "{{HalfHeart}} chance de curar Meio Coração a cada minuto", -- Placenta
	-- Full old Desc: "↑ {{Heart}} +1 Saúde#{{HalfHeart}} chance de curar Meio Coração a cada minuto"
	-- English: "{{HealingRed}} 50% chance to heal half a heart every minute"

	[C_ID .. 220] = "{{Bomb}} +5 Bombas", -- Sad Bombs
	-- Full old Desc: "Explosões de bombas também disparam 10 lágrimas em um círculo#{{Bomb}} +5 Bombas"
	-- English: "Isaac's bombs shoot 10 tears in a circle when they explode"

	[C_ID .. 221] = "Lágrimas ricocheteiam nas paredes, inimigos e objetos", -- Rubber Cement
	-- English: "Isaac's tears bounce off enemies and obstacles"

	[C_ID .. 222] = "Ao soltar, todas elas dispararão na direção que foram disparadas#↑ {{Tears}} -2 Atraso da Lágrima", -- Anti-Gravity
	-- Full old Desc: "Segurar o botão de disparo faz com que as lágrimas fiquem paradas no ar#Ao soltar, todas elas dispararão na direção que foram disparadas#↑ {{Tears}} -2 Atraso da Lágrima"
	...
	-- Full old Desc: "Explosões curam o personagem#{{Bomb}} +5 Bombas"
	-- English: "Immunity to explosions, rock waves, and stomp attacks#{{HealingRed}} Getting hit by explosions heals 1 heart"

	[C_ID .. 224] = "↓ {{Range}} -10.0 Alcance", -- Cricket's Body
	-- Full old Desc: "Lágrimas divididas em 4 ao acertar#Lágrimas divididas cusam metade do dano#↑ {{Tears}} +1 Lágrimas#↓ {{Range}} -10.0 Alcance"
	-- English: "Tears split up in 4 on hit#Split tears deal half damage"

	[C_ID .. 225] = "{{SoulHeart}} Chance de soltar um Coração de Alma ao ser atingido#{{HalfHeart}} Inimigos tem a chance de soltar Meio Coração ao morrerem", -- Gimpy
	...
	[C_ID .. 228] = "↑ {{Tears}} +1 Lágrimas", -- Mom's Perfume
	-- Full old Desc: "{{Fear}} 15% de cahnce de disparar lagrimas de medo#↑ {{Tears}} +1 Lágrimas"
	-- English: "{{Fear}} 15% chance to shoot fear tears"

	[C_ID .. 229] = "↓ {{Tears}} 4.3x Atraso da Lágrima", -- Monstro's Lung
	-- Full old Desc: "{{Chargeable}} As lágrimas agora podem ser carregadas e disparadas com maior força#↓ {{Tears}} 4.3x Atraso da Lágrima"
	-- English: "{{Chargeable}} Tears are charged and released in a shotgun style attack"

	[C_ID .. 230] = "{{BlackHeart}} +6 Corações Negros", -- Abaddon
	-- Full old Desc: "↑ {{Damage}} +1.5 Dano#↑ {{Speed}} +0.2 Velocidade#{{Fear}} Lágrimas que amedrontam inimigos#↓ {{EmptyHeart}} Remove todos os Espçoes de Corações#{{BlackHeart}} +6 Corações Negros"
	...
	-- Full old Desc: "Deixe um rastro de lentidão#{{Slow}} 10% de chance de lágrimas lentas#{{Luck}} 100% de chance com 18 de Sorte"
	...
	-- Full old Desc: "{{Slow}} Ao ser atingido, desacelera todos os inimigos na sala permanentemente#↑ {{Speed}} +0.3 Velocidade"
	-- English: "{{Slow}} Taking damage slows all enemies in the room permanently"

	[C_ID .. 233] = "↑ {{Range}} Alcance", -- Tiny Planet
	-- Full old Desc: "Lágrimas orbitam em torno do personagem#↑ +7 Altura da Lágrima#↑ {{Range}} Alcance#Lágrimas espectrais"
	...
	[C_ID .. 236] = "Ao ser atingido, transforme o inimigo em cocô", -- E. Coli
	-- English: "Touching an enemy turns it into poop"

	[C_ID .. 241] = "Duplica todas as recompensas ao limpar a sala#33% de chance de não receber recompensa por limpar a sala#{{GreedMode}} Não afeta o Modo Greed", -- Contract from Below
	-- English: "Doubles all room clear rewards#33% chance for no room clear reward"

	[C_ID .. 242] = "50% de chance de bloquear lágrimas", -- Infamy
	-- English: "50% chance to block enemy shots"

	[C_ID .. 243] = "Escudo que bloqueia projéteis", -- Trinity Shield
	-- English: "Blocks enemy shots coming from the direction Isaac is shooting"

	[C_ID .. 244] = "Ocasionalmente, dispare lasers além de suas lágrimas", -- Tech.5
	...
	[C_ID .. 251] = "{{Card}} Transforma todas as pílulas em cartas#{{Card}} Solta uma carta ao pegar", -- Starter Deck
	-- Full old Desc: "{{Card}} Você pode carregar 2 cartas#{{Card}} Transforma todas as pílulas em cartas#{{Card}} Solta uma carta ao pegar"
	-- English: "Isaac can carry 2 cards#Turns all pills into cards"

	[C_ID .. 252] = "{{Pill}} Transforma todas as cartas em pílulas#{{Pill}} Solta uma pílula ao pegar", -- Little Baggy
	-- Full old Desc: "{{Pill}} Você pode carregar 2 pílulas#{{Pill}} Transforma todas as cartas em pílulas#{{Pill}} Solta uma pílula ao pegar"
	...
	[C_ID .. 257] = "!!! A explosão pode te machucar!", -- Fire Mind
	-- Full old Desc: "{{Burning}} Lágrimas flamejantes#Chance de lágrimas explodirem#{{Luck}} 100% de chance com 13 de Sorte#!!! A explosão pode te machucar!"
	...
	[C_ID .. 258] = "Troca todos os seus itens e status ao pegar e toda vez que você troca de andar", -- Missing No.
	-- English: "Rerolls all of Isaac's items and stats on pickup and at every new floor"

	[C_ID .. 260] = "{{CurseCursed}} Imunidade a maldições", -- Black Candle
	-- Full old Desc: "{{CurseCursed}} Imunidade a maldições#{{BlackHeart}} +1 Coração Negro#{{DevilChanceAB}} / {{AngelChanceAB}} +15% chance de Sala do Diabo/Anjo"
	-- English: "{{CurseBlind}} Immune to curses"

	[C_ID .. 261] = "↓ {{Damage}} Lágrimas causam menos dano à medida que viajam", -- Proptosis
	-- Full old Desc: "↑ {{Damage}} +100% Dano#↓ {{Damage}} Lágrimas causam menos dano à medida que viajam"
	-- English: "↓ Tears deal less damage the further they travel"

	[C_ID .. 262] = "Quando ficar com 1 Coração, causa dano a todos os inimigos na sala", -- Missing Page 2
	-- Full old Desc: "{{BlackHeart}} +1 Coração Negro#Quando ficar com 1 Coração, causa dano a todos os inimigos na sala"
	-- English: "Taking damage down to 1 heart damages all enemies in the room"

	[C_ID .. 264] = "Quando você for atingido ele atacará os inimigos", -- Smart Fly
	-- Full old Desc: "Orbital#Quando você for atingido ele atacará os inimigos#Causa 22.5 de dano por segundo"
	-- English: "Attacks enemies when Isaac takes damage"

	[C_ID .. 265] = "Quando ele for atingido por lágrimas inimigas, tem 10% de chance de causar dano em todos os inimigos na sala", -- Dry Baby
	-- English: "10% chance to damage all enemies in the room when it is hit by an enemy tear"

	[C_ID .. 266] = "Deixa um rastro de lentidão#Gera 1-2 aranhas amigáveis após limpar uma sala", -- Juicy Sack
	-- English: "{{Slow}} Leaves slowing creep#Spawns 1-2 friendly spiders after clearing a room"

	[C_ID .. 267] = "Atira lasers#Move em direção aos seus disparos", -- Robo-Baby 2.0
	-- Full old Desc: "Atira lasers#Causa 3.5 de dano por disparo#Move em direção aos seus disparos"
	-- English: "Shoots lasers#Moves in the direction Isaac is shooting"

	[C_ID .. 268] = "Familiar que gera moscas azuis quando o player está disparando", -- Rotten Baby
	...
	[C_ID .. 270] = "{{HalfHeart}} Cura Meio Coração quando mata um inimigo#Causa 3.2 de dano por segundo", -- Leech
	-- Full old Desc: "{{HalfHeart}} Cura Meio Coração quando mata um inimigo#Causa 3.2 de dano por segundo"
	-- English: "Chases enemies#{{HealingRed}} Heals Isaac for half a heart when it kills an enemy"

	[C_ID .. 271] = "Solta pickups aleatórios a cada poucas salas", -- Mystery Sack
	-- English: "Spawns a random pickup every 5-6 rooms"

	[C_ID .. 272] = "Mosca amigável explosiva", -- BBF
	-- Full old Desc: "Mosca amigável explosiva#A explosão causa 60 de dano"
	-- English: "Friendly exploding fly#The explosion deals {VAR:1} damage#{{Warning}} The explosion can hurt Isaac"

	[C_ID .. 273] = "Familiar bomba arremessável#A explosão causa 60 de dano", -- Bob's Brain
	-- Full old Desc: "Familiar bomba arremessável#A explosão causa 60 de dano"
	...
	[C_ID .. 274] = "Quando você for atingido, ganha um orbital de médio alcance para a sala", -- Best Bud
	-- Full old Desc: "Quando você for atingido, ganha um orbital de médio alcance para a sala#Orbital causa 75 de dano por segundo"
	...
	[C_ID .. 276] = "Ganhe invulnerabilidade#!!! Quando o familiar coração é atingido, você sofre dano", -- Isaac's Heart
	...
	[C_ID .. 277] = "Familiar fantasma amigável", -- Lil Haunt
	-- Full old Desc: "Familiar fantasma amigável#Causa 4 de dano por segundo"
	-- English: "{{Fear}} Chases and fears enemies"

	[C_ID .. 278] = "{{Heart}} Coleta Corações Vermelhos do chão#A cada 1.5 Corações, gera um Coração de Alma/Negro ou uma aranha", -- Dark Bum
	...
	[C_ID .. 280] = "Gera aranhas azuis aleatóriamente ao entrar em uma sala hostíl", -- Sissy Longlegs
	-- English: "Randomly spawns blue spiders in hostile rooms"

	[C_ID .. 281] = "Familiar isca#Os inimigos o atacarão", -- Punching Bag
	...
	[C_ID .. 284] = "Troca todos os itens passivos que você estiver segurando", -- D4
	...
	[C_ID .. 286] = "Imita o efeito da carta que você estiver segurando", -- Blank Card
	-- English: "Triggers the effect of the rune or card Isaac holds without using it"

	[C_ID .. 289] = "Lança uma chama vermelha#A chama persiste até causar dano ou bloquear disparos 5 vezes", -- Red Candle
	...
	[C_ID .. 290] = "{{Heart}} Armazena até 4 pickups de Corações Vermelhos para uso futuro", -- The Jar
	...
	[C_ID .. 291] = "Transforma todos os inimigos não chefes em cocô#Mata instântaneamente inimigos e chefes cocôs", -- Flush!
	-- English: "Turns all non-boss enemies into poop#Instantly kills poop enemies and bosses"

	[C_ID .. 293] = "{{Collectible118}} Atira laser brimstone nas 4 direções", -- Head of Krampus
	-- Full old Desc: "{{Collectible118}} Atira laser brimstone nas 4 direções"
	-- English: "{{Collectible118}} Shoot a 4-way blood beam#They each deal {VAR:1} damage over 1.33 seconds"

	[C_ID .. 294] = "Afasta inimigos e projéteis próximos", -- Butter Bean
	-- Full old Desc: "Afasta inimigos e projéteis próximos#10% de chance de se tornar o mais forte {{Collectible484}}Wait What? Ao trocá-lo por um item ativo diferente e pegá-lo novamente"
	...
	[C_ID .. 295] = "Causa dano em toda a sala com 2x o seu dano#{{Coin}} Preço: 1 moeda", -- Magic Fingers
	-- English: "Deals 2x Isaac's damage to all enemies#{{Coin}} Costs 1 coin"

	[C_ID .. 296] = "Converte 2 Corações de Alma/Negro em 1 Contêiner de Coração Vermelho", -- Converter
	-- English: "{{Heart}} Converts 2 Soul/Black Hearts into 1 heart container"

	[C_ID .. 299] = "↑ {{Speed}} Ganhe velocidade lentamente enquanto estiver em salas hostis#{{Collectible77}} Com 2 de velocidade, ganha invencibilidade e causa dano ao contato#Depois, perca o aumento de velocidade do Taurus para a sala", -- Taurus
	-- Full old Desc: "↓ {{Speed}} -0.3 Velocidade#↑ {{Speed}} Ganhe velocidade lentamente enquanto estiver em salas hostis#{{Collectible77}} Com 2 de velocidade, ganha invencibilidade e causa dano ao contato#Depois, perca o aumento de velocidade do Taurus para a sala"
	...
	-- Full old Desc: "↑ {{Speed}} +0.25 Velocidade#Inflinge dano aos inimigos ao toca-los"
	-- English: "Touching enemies deals contact damage"

	[C_ID .. 301] = "Depois de ser atingido, ganhe redução de dano (-50% do dano recebido)", -- Cancer
	-- Full old Desc: "{{SoulHeart}} +3 Corações de Alma#Depois de ser atingido, ganhe redução de dano (-50% do dano recebido)"
	...
	[C_ID .. 303] = "Chance de obter invencibilidade ao ser atingido#{{Pill}} Converte pílulas negativas em positivas", -- Virgo
	...
	[C_ID .. 304] = "Equilibra suas estatísticas#!!! Todas as estatísticas posteriores também serão afetadas", -- Libra
	-- Full old Desc: "+6 {{Coin}} Moedas, {{Bomb}} Bombas, {{Key}} Chaves#Equilibra suas estatísticas#!!! Todas as estatísticas posteriores também serão afetadas"
	...
	[C_ID .. 312] = "Agora todos os Corações Vermelhos curam o dobro do seu valor", -- Maggy's Bow
	-- Full old Desc: "↑ {{Heart}} +1 Saúde#{{Heart}} Cura um Coração Vermelho#Agora todos os Corações Vermelhos curam o dobro do seu valor"
	...
	-- Full old Desc: "↑ {{Heart}} +1 Saúde#↓ {{Speed}} -0.4 Velocidade#Quebra pedras ao andar sobre elas"
	-- English: "Isaac can destroy rocks by walking into them"

	[C_ID .. 315] = "Lágrimas magnéticas#Afeta inimigos, pickups e trinkets", -- Strange Attractor
	-- English: "Isaac's tears attract enemies, pickups and trinkets"

	[C_ID .. 316] = "!!! Quando atingido enquanto estiver parcialmente carregado, teleporta você para uma sala aleatória", -- Cursed Eye
	-- Full old Desc: "Onda carregada de lágrimas#!!! Quando atingido enquanto estiver parcialmente carregado, teleporta você para uma sala aleatória#{{Collectible260}} Não te teleporta se você tem a Black Candle"
	-- English: "Charged wave of {VAR:1} tears#{{Warning}} Taking damage while partially charged teleports Isaac to a random room"

	[C_ID .. 317] = "Lágrimas deixam rastro tóxico#O rastro causa 30 de dano por segundo", -- Mysterious Liquid
	...
	[C_ID .. 319] = "Salta pela sala#Atira em direção ao personagem#{{Damage}} O dano dele é igual ao seu dano", -- Cain's Other Eye
	-- English: "Bounces around the room#Low accuracy tears that deal Isaac's damage"

	[C_ID .. 320] = "Familiar controlável", -- ???'s Only Friend
	-- Full old Desc: "Familiar controlável#Causa 5 de dano ao contato por segundo"
	-- English: "Controllable fly"

	[C_ID .. 321] = "Bola arremessável que pode destruir pedras", -- Samson's Chains
	-- Full old Desc: "Bola arremessável que pode destruir pedras#Causa 10.7 de dano ao contato por segundo"
	...
	[C_ID .. 323] = "Quando usado, dispara 8 lágrimas em todas as direções#Recarrega ao disparar", -- Isaac's Tears
	-- English: "Shoots 8 tears in all directions#The tears copy Isaac's tear effects#Recharges by shooting tears"

	[C_ID .. 324] = "Teleporta você para#{{TreasureRoom}} Sala do Tesouro, {{SecretRoom}} Sala Secreta, {{SuperSecretRoom}} Sala Super Secreta ou a Sala {{ErrorRoom}} I AM ERROR", -- Undefined
	...
	[C_ID .. 325] = "Corta sua cabeça#A cabeça se torna um familiar estacionário#Controle seu corpo separadamente", -- Scissors
	...
	[C_ID .. 326] = "Invencibilidade enquanto estiver ativando#!!! Qaundo não estiver com carga, você levará dano", -- Breath of Life
	...
	[C_ID .. 327] = "Invencibilidade ao ser atingido e estiver com Meio Coração Vermelho ou nenhum", -- The Polaroid
	-- English: "Taking damage at half a Red Heart or none makes Isaac temporarily invincible"

	[C_ID .. 328] = "Causa dano a todos os inimigos da sala ao ser atingido e estiver com Meio Coração Vermelho ou nenhum", -- The Negative
	-- English: "Taking damage at half a Red Heart or none damages all enemies in the room"

	[C_ID .. 329] = "Em vez de disparar lágrimas você controla uma lágrima gigante", -- The Ludovico Technique
	-- English: "Replaces Isaac's tears with one giant controllable tear"

	[C_ID .. 331] = "↑ {{Tearsize}} 50% Tamanho da Lágrima", -- Godhead
	-- Full old Desc: "Lágrimas teleguiada#Lágrimas ganham uma aura que causa dano aos inimigos#↑ {{Damage}} +0.5 Dano#↑ {{Range}} +1.2 Alcance#↓ {{Tears}} -0.3 Lágrimas#↓ {{Shotspeed}} -0.3 Velocidade de Disparo#↑ {{Tearsize}} 50% Tamanho da Lágrima#↑ +0.5 Altura da Lágrima"
	-- English: "{{Damage}} Tears gain an aura that deals 4.5x Isaac's damage per second"

	[C_ID .. 332] = "{{Player11}} Ao morrer renasce como Lázaro (Revivido)", -- Lazarus' Rags
	...
	[C_ID .. 335] = "Concede um aura que desvia projéteis e inimigos", -- The Soul
	-- Full old Desc: " {{SoulHeart}}+2 Corações de Alma#Concede um aura que desvia projéteis e inimigos"
	...
	[C_ID .. 338] = "Boomerang arremessável#Atordoa os inimigos e causa 2x seu dano#Pode pegar itens", -- The Boomerang
	-- English: "Throwable boomerang#{{Petrify}} Petrifies enemies and deals 2x Isaac's damage#Can grab and bring back items"

	[C_ID .. 347] = "Duplica todos os itens de pedestal e consumíveis na sala atual", -- Diplopia
	-- English: "Duplicates all item pedestals and pickups in the room"

	[C_ID .. 348] = "{{Pill}} Copia o efeito da pílula que você está segurando no momento", -- Placebo
	-- English: "{{Pill}} Triggers the effect of the pill Isaac holds without using it"

	[C_ID .. 350] = "{{Poison}} No início de cada sala, todo inimigo recebe um efeito de veneno#Inimigos mortos deixam uma poça", -- Toxic Shock
	...
	[C_ID .. 351] = "Congele todos os inimigos na sala atual#Causa 5 de dano de envenenamento a qualquer inimigo próximo#Envia uma onda de espinhos pela sala#Pode ser usado para abrir Salas Secretas", -- Mega Bean
	...
	[C_ID .. 352] = "!!! Reduz a sua saúde para Meio Coração#Dispara uma grande lágrima espectral penetrante ((seu dano + 1) x 10)", -- Glass Cannon
	...
	[C_ID .. 357] = "Duplique seus familiares para a sala atual#Se você não tem nenhum familiar, {{Collectible113}} Demon Baby será gerado para a sala atual", -- Box of Friends
	...
	-- Full old Desc: "Dispare 2 lágrimas de uma vez na diagonal#Lágrimas espectrais"
	-- English: "Isaac shoots 2 tears at once diagonally"

	[C_ID .. 359] = "Aumenta o recuo", -- 8 Inch Nails
	-- Full old Desc: "↑ {{Damage}} +1.5 Dano#Aumenta o recuo"
	-- English: "Increases knockback"

	[C_ID .. 360] = "Dispara lágrimas com mesmo dano, status e efeitos que as suas", -- Incubus
	-- English: "Shoots tears with the same tear rate, damage and effects as Isaac"

	[C_ID .. 361] = "Familiar que dispara lágrimas com o seu dano e efeitos de lágrima", -- Fate's Reward
	-- English: "Shoots tears with the same damage and effects as Isaac#Shoots at half the rate of other familiars"

	[C_ID .. 362] = "Solta um pickup aleatório em algumas salas", -- Lil Chest
	-- English: "35% chance to spawn a pickup every room"

	[C_ID .. 363] = "Bloqueia e atrai projéteis#Bloquear 10 lágrimas em uma sala solta um Coração Eterno", -- Sworn Protector
	-- Full old Desc: "Familiar orbital#Causa 105 de dano ao contato por segundo#Bloqueia e atrai projéteis#Bloquear 10 lágrimas em uma sala solta um Coração Eterno"
	...
	[C_ID .. 365] = "Move-se pelas paredes e obstáculos na sala", -- Lost Fly
	-- Full old Desc: "Move-se pelas paredes e obstáculos na sala#Causa 105 de dano ao contato por segundo"
	...
	[C_ID .. 368] = "Atirar em uma direção aumenta sua Taxa de Disparo em até 200%", -- Epiphora
	-- English: "↑ {{Tears}} Shooting in one direction gradually decreases tear delay up to 200% and decreases accuracy"

	[C_ID .. 369] = "Suas lágrimas viajam através das paredes e reaparecem na parede oposta", -- Continuum
	-- Full old Desc: "↑ {{Range}} +2.25 Alcance#↑ +1.5 Altura da Lágrima#Lágrimas espectrais#Suas lágrimas viajam através das paredes e reaparecem na parede oposta"
	-- English: "Tears can travel through one side of the screen and come out the other side"

	[C_ID .. 371] = "Gera 6 bombas trolls sempre que você for atingido#É afetado por itens de bombas", -- Curse of the Tower
	-- English: "{{Warning}} Taking damage spawns 6 Troll Bombs#The Troll Bombs inherit Isaac's bomb effects"

	[C_ID .. 372] = "A cada 30 segundos em que estiver em uma sala não limpa, concede um efeito aleatório:#Adiciona uma carga ao seu item ativo (max. de 2 por sala)#Congela todos os inimigos na sala", -- Charged Baby
	...
	[C_ID .. 373] = "↑ {{Damage}} +12.5% Dano ou +25% para cada lágrima que atinge com sucesso um inimigo(max. +100%)", -- Dead Eye
	-- English: "↑ {{Damage}} Consecutive tear hits on enemies grant +25% damage (max +100%)#Missing has a chance to reset the multiplier"

	[C_ID .. 375] = "Concede imunidade a explosão e imunidade a pisões da Mãe e Satan#20% de chance de bloquear lágrimas", -- Host Hat
	...
	[C_ID .. 377] = "As aranhas são inofensivas", -- Bursting Sack
	-- English: "Spider enemies no longer target or deal contact damage to Isaac"

	[C_ID .. 378] = "Disparar lágrimas por 3 segundos solta um Butt Bomb", -- No. 2
	-- English: "Holding a fire button for 2.35 seconds spawns a lit Butt Bomb"

	[C_ID .. 380] = "Você pode abrir portas com moedas ao invés de chaves", -- Pay To Play
	-- Full old Desc: "{{Coin}} +5 Moedas#Você pode abrir portas com moedas ao invés de chaves"
	...
	-- Full old Desc: "↑ {{Tears}} +0.7 Lágrimas#Fornece um item aleatório no início de sua próxima "run""
	-- English: "Grants a random item at the start of the next run"

	[C_ID .. 382] = "Pode ser jogado em inimigos para capturá-los#No próximo uso, o inimigo capturado reaparecerá como companheiro", -- Friendly Ball
	...
	[C_ID .. 383] = "Detone qualquer lágrima na tela e faz com que cada uma se divida em mais 6 lágrimas que sairão em círculo", -- Tear Detonator
	-- English: "Splits all of Isaac's tears currently on screen in a circle of 6 tears"

	[C_ID .. 384] = "{{Chargeable}} Se lança e desliza ao redor da sala com velocidade baseada na quantidade de cargas#Causa 5-90 de dano ao contato por segundo dependendo da velocidade", -- Lil Gurdy
	...
	[C_ID .. 385] = "Pega todas as moedas próximas#A cada 6 moedas ele sobe de nível, exceto o nível 4, que leva 12 moedas#LVL1: Apenas pega moedas#LVL2: Solta pickups aleatórios#LVL3: Atira lágrimas#LVL4: Não irá dispara lágrimas. Ele irá perseguir o inimigo e causar dano ao contato. Chance de gerar bombas", -- Bumbo
	...
	[C_ID .. 386] = "Troca quanquer objeto de cenário em outro tipo de objeto aleatório (ex. cocôs, potes, TNT, cocôs vermelhos, blocos de pedra, etc.)", -- D12
	-- English: "Rerolls any obstacle into another random obstacle (e.g. poop, pots, TNT, red poop, stone blocks etc.)"

	[C_ID .. 387] = "Cria uma enorme aura de luz que retarda os inimigos e projéteis dentro dela", -- Censer
	-- English: "{{Slow}} Familiar surrounded by a huge aura of light that slows down enemies and projectiles in it"

	[C_ID .. 388] = "Converte chaves em baús aleatórios", -- Key Bum
	-- English: "{{Key}} Picks up nearby keys#{{Chest}} Spawns random chests in return"

	[C_ID .. 389] = "{{Rune}} Solta uma runa aleatória a cada 5-6 salas", -- Rune Bag
	-- English: "{{Rune}} Spawns a random rune every 5-6 rooms"

	[C_ID .. 390] = "Atira lágrimas Sacred Heart", -- Seraphim
	-- Full old Desc: "Atira lágrimas Sacred Heart#Causa 10 de dano por disparo"
	...
	[C_ID .. 392] = "Dará a você um efeito aleatório de item zodíaco a cada andar", -- Zodiac
	-- English: "Grants a random zodiac item effect every floor"

	[C_ID .. 393] = "{{Poison}} 15% de chance de disparar lágrimas que envenenam#{{Poison}} Cause dano por veneno ao contato#{{BlackHeart}} Inimigos envenenados têm chance de soltar um Coração Negro ao morrerem", -- Serpent's Kiss
	...
	[C_ID .. 394] = "↑ +0.3 Altura da Lágrima", -- Marked
	-- Full old Desc: "Atira lágrimas direcionadas automaticamente a um alvo vermelho no chão controlado pelo jogador#↑ {{Tears}} +0.7 Lágrimas#↑ {{Range}} +3.15 Alcance#↑ +0.3 Altura da Lágrima"
	-- English: "Isaac automatically shoots tears at a movable red target on the ground"

	[C_ID .. 395] = "{{Chargeable}} Troca lágrimas por um laser carregável em forma de anel que atravessa a sala#O anel tem tamanho maior com cargas maiores", -- Tech X
	-- English: "{{Chargeable}} Isaac's tears are replaced by a chargeable laser ring#Ring size increases with charge amount"

	[C_ID .. 396] = "Cria até dois portais para viajar entre eles#Pode ser colocado em salas diferentes", -- Ventricle Razor
	...
	-- Full old Desc: "Agora, suas lágrimas viajam diretamente para a frente do local onde você está olhando mesmo que você se mova ou se vire#↑ {{Tears}} +0.5 Lágrimas#↑ {{Range}} +5.25 Alcance#↑ {{Shotspeed}} +0.16 Velocidade de Disparo#↑ +0.5 Altura da Lágrima"
	-- English: "Isaac's tears always travel along a beam of light in front of him"

	[C_ID .. 398] = "Lágrimas podem encolher inimigos#Inimigos encolhidos podem ser mortos ao andar sobre eles", -- God's Flesh
	-- English: "{{Shrink}} Tears can shrink enemies#Shrunken enemies can be crushed and killed by walking over them"

	[C_ID .. 399] = "{{BlackHeart}} Inimigos mortos pelo anel preto têm chance de derrubar Corações Negros", -- Maw of the Void
	-- Full old Desc: "↑ {{Damage}} +1 Dano#↑ +0.5 Altura da Lágrima#{{Chargeable}} Depois de disparar lágrimas por 3 segundos, cria um anel preto danificando os inimigos dentro dele#{{BlackHeart}} Inimigos mortos pelo anel preto têm chance de derrubar Corações Negros"
	...
	[C_ID .. 400] = "Cria uma lança na sua frente#Causa 2 vezes o seu dano#Chance de amedrontar inimigos ao contato", -- Spear of Destiny
	-- English: "Isaac holds a spear in front of him#{{Fear}} The spear deals twice his damage and can fear enemies on contact"

	[C_ID .. 401] = "25% de chance de disparar lágrimas de bombas pegajosas#Bombas pegajosas não causam dano ao atingir", -- Explosivo
	-- English: "25% chance to shoot sticky bomb tears#Sticky bomb tears do not deal damage on hit and explode after a few seconds"

	[C_ID .. 402] = "Agora, itens de pedestais serão escolhidos aleatóriamente", -- Chaos
	-- Full old Desc: "Agora, itens de pedestais serão escolhidos aleatóriamente#Gera 1-6 pickups aleatórios"
	-- English: "All items are chosen from random item pools"

	[C_ID .. 403] = "Permite que você veja seu dano de lágrima e as barras de saúde de todos os inimigos#Inflige um efeito de status aleatório no contato#Solta baterias aleatoriamente", -- Spider Mod
	...
	[C_ID .. 404] = "Ao ser atingido tem 10% de chance de peidar, o que irá, encantar, envenenar ou empurrar inimigos", -- Farting Baby
	-- Full old Desc: "Familiar que bloqueia projéteis#Ao ser atingido tem 10% de chance de peidar, o que irá, encantar, envenenar ou empurrar inimigos"
	-- English: "When hit, 10% chance to fart and {{Charm}} charm, {{Poison}} poison or knockback enemies"

	[C_ID .. 405] = "Salta pela sala", -- GB Bug
	-- Full old Desc: "Salta pela sala#Causa 120 de dano por segundo e aplica um efeito de status aleatório"
	-- English: "Bounces around the room#Applies random status effects to enemies on contact"

	[C_ID .. 406] = "Troca suas estatísticas#Afetará apenas estatísticas de dano: Lágrimas, Alcance e Velocidade", -- D8
	...
	[C_ID .. 407] = "↑ Aumente uma das estatísticas do personagem, dependendo da cor da aura ao seu redor#Quando sofrer dano, você perderá a aura nesta sala e receberá uma nova na próxima sala#Vermelha = +4 {{Damage}} Dano#Azul = -4 {{Tears}} Atraso da lágrima#Amarelo = +0.5 {{Speed}} Velocidade#Laranja = +7.5 {{Range}} Alcance", -- Purity
	...
	[C_ID .. 408] = "Quando você recebe dano, um anel preto aparecerá ao redor do personagem, causando dano ao contato##{{BlackHeart}} Inimigos mortos com ele têm a chance de derrubar um Coração Negro", -- Athame
	...
	[C_ID .. 409] = "Quando o personagem não tem Corações Vermelhos:#Recebe Voo#A cada 40 segundos em uma sala hostíl recebe um escudo por 10 segundos", -- Empty Vessel
	-- Full old Desc: "{{BlackHeart}} +2 Corações Negro#Quando o personagem não tem Corações Vermelhos:#Recebe Voo#A cada 40 segundos em uma sala hostíl recebe um escudo por 10 segundos"
	...
	[C_ID .. 411] = "↑ {{Damage}} +0.5 Dano para cada inimigo morto na sala atual# Máximo de +5 de Dano após 10 mortes", -- Lusty Blood
	-- English: "↑ {{Damage}} +0.5 Damage for each enemy killed in the room#Caps at +5 Damage after 10 kills"

	[C_ID .. 412] = "Depois de sofrer dano 15 vezes, o personagem ganha um familiar demônio permanente#Máximo de 4 familiares", -- Cambion Conception
	...
	[C_ID .. 413] = "Depois de pegar 15 Corações, o personagem ganha um familiar angelical permanente#Máximo de 5 familiares", -- Immaculate Conception
	...
	[C_ID .. 414] = "{{TreasureRoom}} 2 itens surgem em cada Sala do Tesouro#Você pode pegar somente um", -- More Options
	-- English: "{{TreasureRoom}} Allows Isaac to choose between 2 items in treasure rooms"

	[C_ID .. 415] = "Se você não tem nenhum Contêiner de Coração Vermelho danificado:#{VAR:EFFECTLIST}#Desativa para a sala atual quando receber um dano completo", -- Crown Of Light
	-- Full old Desc: "{{SoulHeart}} +2 Coração de Alma#Se você não tem nenhum Contêiner de Coração Vermelho danificado:#↑ {{Damage}} +100% Dano#↑ {{Range}} +5.25 Alcance#↑ +0.5 Tamanho da Lágrima#↓ {{Shotspeed}} -0.3 Velocidade de Disparo#Desativa para a sala atual quando receber um dano completo"
	-- English: "If Isaac has no damaged heart containers:#{VAR:EFFECTLIST}#Taking any damage removes the effect for the room"

	[C_ID .. 416] = "Permite carregar 2 cartas, pílulas ou runas", -- Deep Pockets
	-- English: "Allows Isaac to carry two runes/cards/pills"

	[C_ID .. 417] = "Salta ao redor da sala com uma aura que causa 129% do seu dano a cada segundo#↑ {{Damage}} +50% dano enquanto estiver na aura", -- Succubus
	...
	[C_ID .. 419] = "Teleporta você para outra sala aleatória que ainda não foi limpa", -- Teleport 2.0
	-- Full old Desc: "Teleporta você para outra sala aleatória que ainda não foi limpa#Hierarquia: {{Room}}>{{BossRoom}}>{{SuperSecretRoom}}>{{Shop}}>{{TreasureRoom}}>{{SacrificeRoom}}> {{DiceRoom}}>{{Library}}>{{CursedRoom}}>{{MiniBoss}}>{{ChallengeRoom}}{{BossRushRoom}}>{{IsaacsRoom}}{{BarrenRoom}}>{{ArcadeRoom}}>{{ChestRoom}}>{{SecretRoom}}>{{DevilRoom}}{{AngelRoom}}>{{ErrorRoom}}"
	-- English: "Teleports Isaac to a room that has not been cleared yet#Hierarchy: {VAR:TEXT}"

	[C_ID .. 420] = "Andar em círculo gerará um símbolo de pentagrama no chão (10 de dano ao contato)", -- Black Powder
	-- English: "Walking in a circle draws a pentagram on the floor, which deals 130 damage over 4 seconds"

	[C_ID .. 421] = "{{Charm}} Encanta quaisquer inimigos próximos e causa 5 de dano a eles", -- Kidney Bean
	-- English: "{{Charm}} Charms and deals 5 damage to all enemies in close range"

	[C_ID .. 422] = "Qualquer dano sofrido ou consumíveis usados na sala atual serão redefinidos para o estado anterior", -- Glowing Hourglass
	-- English: "Brings Isaac back to the previous room and reverses all actions done in the room the item was used in"

	[C_ID .. 423] = "Grande auréola ao seu redor que causa seu dano ao contato a cada segundo#Chance de refletir projéteis inimigos", -- Circle of Protection
	...
	[C_ID .. 424] = "Pickups tem 33% de chance de serem substituídos por um saco#Gera um saco", -- Sack Head
	...
	[C_ID .. 425] = "Gera um cone de luz na sua frente que retarda inimigos e projéteis dentro dele", -- Night Light
	-- English: "{{Slow}} Spawns a slowing cone of light in front of Isaac"

	[C_ID .. 427] = "Gera um barril TNT empurrável#Se usado uma segunda vez na mesma sala enquanto o último barril de TNT ainda estiver lá, ele explodirá", -- Mine Crafter
	-- English: "Spawns a pushable TNT barrel#Using the item a second time in the same room remotely detonates the barrel"

	[C_ID .. 429] = "{{Coin}} Inimigos tem 5% de chance de soltar uma moeda ao serem atingidos por suas lágrimas", -- Head of the Keeper
	-- English: "{{Coin}} Hitting an enemy with a tear has a 5% chance to spawn a Penny"

	[C_ID .. 430] = "Dispara lágrimas em inimigos próximos que causam dano igual ao seu", -- Papa Fly
	-- Full old Desc: "Segue seu padrão de movimento com atraso de 1 segundos#Dispara lágrimas em inimigos próximos que causam dano igual ao seu"
	-- English: "{{Damage}} Shoots tears at nearby enemies that deal Isaac's damage"

	[C_ID .. 431] = "As lágrimas do personagem que passam pelo bebê, se dividem e aceleram", -- Multidimensional Baby
	-- Full old Desc: "Segue seu padrão de movimento com atraso de 2 segundos#As lágrimas do personagem que passam pelo bebê, se dividem e aceleram"
	-- English: "Tears that pass through it are doubled and gain a range + shot speed boost"

	[C_ID .. 432] = "Bombas tem a chance de soltarem pickups aleatórios ou encantar inimigos quando explodem", -- Glitter Bombs
	-- Full old Desc: "{{Bomb}} +5 bombas#Bombas tem a chance de soltarem pickups aleatórios ou encantar inimigos quando explodem"
	-- English: "{{Charm}} Isaac's bombs have a 25% chance to drop a random pickup and a 15% chance to charm enemies when they explode"

	[C_ID .. 433] = "Toda vez que você sofrer dano, causará medo a todos os inimigos na sala e gerará um familiar que atacará por você.", -- My Shadow
	-- Full old Desc: "Toda vez que você sofrer dano, causará medo a todos os inimigos na sala e gerará um familiar que atacará por você.#Ele será morto se estiver muito danificado"
	-- English: "{{Fear}} Taking damage fears all enemies in the room and spawns a friendly black charger"

	[C_ID .. 434] = "Toda vez que você mata um inimigo, uma mosca azul é adicionada ao pote#Guarda até 20 moscas#Usar o item libera todas as moscas", -- Jar of Flies
	-- English: "Killing an enemy adds a blue fly to the jar, up to 20 flies#Using the item releases all the flies"

	[C_ID .. 435] = "Dispara 4 lágrimas em um padrão cruzado", -- Lil Loki
	-- Full old Desc: "Dispara 4 lágrimas em um padrão cruzado#Causa 3.5 de dano por disparo"
	-- English: "Shoots 4 tears in a cross pattern"

	[C_ID .. 436] = "{{Tears}} Ao sofrer dano você ganha um aumento de Lágrimas para o resto da sala", -- Milk!
	-- English: "{{Tears}} Taking damage grants a Tears up for the duration of the room"

	[C_ID .. 437] = "Faz ressurgir todos os inimigos da sala#Permite você ganhar as recompensas da sala quando ela for limpa novamente#!!! Se usado em uma luta do Greed, ele pode trocar os itens da Loja", -- D7
	...
	[C_ID .. 440] = "↑ +2 Altura da Lágrima", -- Kidney Stone
	-- Full old Desc: "As vezes, você para de disparar e tem que carregar um ataque que libera uma explosão de lágrimas e pedras nos rins#↓ {{Speed}} -0.2 Velocidade#↓ {{Range}} -17 Alcance#↑ +2 Altura da Lágrima"
	...
	[C_ID .. 442] = "!!! Enquanto estiver com 1 Coração Vermelho:#{VAR:EFFECTLIST}", -- Dark Prince's Crown
	-- Full old Desc: "!!! Enquanto estiver com 1 Coração Vermelho:#↑ {{Range}} +1.5 Alcance#↑ {{Tears}} +0.75 Lágrimas#↑ {{Shotspeed}} +0.2 Velocidade de Disparo#!!! Não funciona com personagens sem Corações Vermelhos"
	...
	[C_ID .. 445] = "{{LadderRoom}} Um som de latido tocará ao entrar em uma sala com um alçapão embaixo de uma pedra", -- Dog Tooth
	-- Full old Desc: "↑ {{Damage}} +0.3 Dano#↑ {{Speed}} +0.1 Velocidade#{{SecretRoom}} Um lobo uiva se você entrar em uma sala ao lado de uma Sala Secreta/Super Secreta#{{LadderRoom}} Um som de latido tocará ao entrar em uma sala com um alçapão embaixo de uma pedra"
	...
	[C_ID .. 446] = "Ao disparar, você obtém uma aura verde que envenena qualquer inimigo ao contato#O veneno causa o mesmo dano que você", -- Dead Tooth
	-- English: "{{Poison}} While firing, Isaac is surrounded by a green aura that poisons enemies"

	[C_ID .. 447] = "Enquanto disparar sem parar gera uma nuvem de cocô a cada 7.5 segundos#A nuvem causa 3.5 de dano 5 vezes por segundo#A nuvem dura 15 segundos#Pode ser movida ao disparar nela", -- Linger Bean
	...
	[C_ID .. 448] = "Ao receber dano:#{{Heart}}25% de chance de soltar um Coração Vermelho#{{Collectible214}} 10% de chance de obter ↑ +5 de alcance e deixar rastro de sangue na sala atual", -- Shard of Glass
	...
	[C_ID .. 449] = "Projéteis inimigos têm 25% de chance de serem desviados como lágrimas que confundem", -- Metal Plate
	-- Full old Desc: "{{SoulHeart}} +1 Coração de Alma#Projéteis inimigos têm 25% de chance de serem desviados como lágrimas que confundem"
	-- English: "{{Confusion}} Enemy bullets have a 25% chance to be reflected as concussive tears"

	[C_ID .. 450] = "A cada 20 lágrimas, dispara uma lágrima de moeda que causa o dobro de dano#Transforma os inimigos em ouro temporariamente#Inimigos transformados em ouro soltam 1-4 moedas se mortos#!!! A lágrima de moeda custa 1 moeda", -- Eye of Greed
	...
	-- Full old Desc: "{{Card}} Solta uma carta aleatória#{{Card}} Dobra o efeito de cartas"
	-- English: "{{Card}} Card effects are doubled or enhanced"

	[C_ID .. 452] = "Ao sofrer dano, atire 10 lágrimas em um círculo ao seu redor#As lágrimas causam seu dano + 25", -- Varicose Veins
	-- English: "Taking damage shoots 10 tears in a circle around Isaac#The tears deal Isaac's damage + 25"

	[C_ID .. 453] = "↑ {{Range}} +1.5 Alcance", -- Compound Fracture
	-- Full old Desc: "Lágrimas de osso#As lágrimas se quebram em 1-3 fragmentos de osso menores ao atingir qualquer coisa#↑ {{Range}} +1.5 Alcance#↑ +1 Altura da Lágrima"
	-- English: "Tears shatter into 1-3 small bone shards upon hitting anything"

	[C_ID .. 454] = "Permite que o personagem carregue duas cartas, runas ou pílulas#Solta uma carta, runa ou pílula aleatória", -- Polydactyly
	...
	-- Full old Desc: "↑ {{Range}} +1.5 Alcance#↑ +1 Altura da Lágrima#Solta uma moeda da sorte"
	-- English: "{{Luck}} Spawns a Lucky Penny"

	[C_ID .. 457] = "20% de chance de ignorar danos", -- Cone Head
	-- Full old Desc: "{{SoulHeart}} +1 Coração de Alma#20% de chance de ignorar danos"
	-- English: "20% chance to negate damage taken"

	[C_ID .. 458] = "{{Trinket}} Solta um trinket ou pickup aleatório", -- Belly Button
	-- Full old Desc: "{{Trinket}} Solta um trinket ou pickup aleatório#{{Trinket}} Concede 1 espaço extra para trinkets"
	-- English: "{{Trinket}} Allows Isaac to carry 2 trinkets"

	[C_ID .. 459] = "{{Poison}} 20% de chance de disparar lágrimas venenosas que grudam#Gruda por 60 segundos", -- Sinus Infection
	-- Full old Desc: "{{Poison}} 20% de chance de disparar lágrimas venenosas que grudam#Causa seu dano a cada segundo#Gruda por 60 segundos"
	...
	[C_ID .. 460] = "{{Confusion}} 25% de chance de disparar lágrimas que confundem#Deixa a tela um pouco mais escura", -- Glaucoma
	-- English: "{{Confusion}} 5% chance to shoot concussive tears#Makes the screen slightly darker"

	[C_ID .. 462] = "Depois de atingir o primeiro inimigo, as lágrimas causam dano duplo e ganha um efeito de teleguiado", -- Eye of Belial
	-- Full old Desc: "↑ {{Range}} +1.5 Alcance#↑ +1 Altura da Lágrima#Concede lágrimas que atravessam inimigos#Depois de atingir o primeiro inimigo, as lágrimas causam dano duplo e ganha um efeito de teleguiado"
	-- English: "Hitting an enemy makes the tear homing and doubles its damage"

	[C_ID .. 463] = "Chance de destruir pedras e abrir portas com suas lágrimas", -- Sulfuric Acid
	-- Full old Desc: "↑ {{Damage}} +0.3 Dano#Chance de destruir pedras e abrir portas com suas lágrimas"
	-- English: "Isaac's tears can destroy rocks and open doors"

	[C_ID .. 464] = "Os inimigos Campeões soltam pickups que você mais precisa", -- Glyph of Balance
	-- Full old Desc: "{{SoulHeart}} +2 Corações de Alma#Os inimigos Campeões soltam pickups que você mais precisa"
	-- English: "Champion enemies drop whatever pickup Isaac needs the most"

	[C_ID .. 465] = "Permite disparar lágrimas na diagonal", -- Analog Stick
	-- Full old Desc: "↑ {{Tears}} +0.3 Lágrimas#Permite disparar lágrimas na diagonal"
	-- English: "Allows Isaac to shoot tears in any direction"

	[C_ID .. 466] = "{{Poison}} O primeiro inimigo morto na sala explodirá e envenenará todos os inimigos próximos", -- Contagion
	...
	[C_ID .. 467] = "{{Damage}} Causa 10% do seu dano aos inimigos constantemente na direção em que o dedo aponta", -- Finger!
	...
	[C_ID .. 470] = "Salta pela sala#Para de se mover enquanto você disparar#Quando parado pode bloquear projéteis", -- Hushy
	-- Full old Desc: "Salta pela sala#Causa dano ao contato#Para de se mover enquanto você disparar#Quando parado pode bloquear projéteis"
	-- English: "Bounces around the room#Stops moving when Isaac shoots#Blocks projectiles when stopped"

	[C_ID .. 471] = "Cada lágrima causa 3.5 de Dano", -- Lil Monstro
	-- Full old Desc: "{{Chargeable}} Carrega seus tiros e solte-os como um efeito espingarda similar ao {{Collectible229}} Monstro's Lung#Cada lágrima causa 3.5 de Dano"
	-- English: "{{Chargeable}} Charges a shotgun attack similar to {{NameC229}}#Each tear deals 3.5 damage"

	[C_ID .. 472] = "Outros familiares o seguem#Enquanto disparar lágrimas, ele para de se mover#Teleportará de volta para você quando parar de disparar", -- King Baby
	...
	-- Full old Desc: "Mata você 3 segundos depois do uso#Causa 9.999.999 de dano a todos os inimigos"
	-- English: "{{Warning}} Kills Isaac 3 seconds later"

	[C_ID .. 476] = "Duplica 1 pickup aleatório na sala atual", -- D1
	-- English: "Duplicates a random pickup in the room"

	[C_ID .. 477] = "Quando usado, consuma todos os itens de pedestal na sala#Item ativo: Seu efeito ativa e será ativado a cada uso futuro do Void#Item passivo: Pequeno aumento de estatística para duas estatísticas aleatórias", -- Void
	...
	[C_ID .. 478] = "Congela todos os inimigos na sala até você disparar novamente#Tocar em um inimigo congelado ainda irá ferir você#Os inimigos descongelam após 30 segundos", -- Pause
	...
	[C_ID .. 480] = "Converte pickups em moscas ou aranhas azuis#Dobras suas moscas/aranhas azuis atuais#Gera 1 mosca ou aranha azul quando você não tem nenhuma", -- Compost
	...
	[C_ID .. 482] = "Transforma você em um personagem diferente#Remove o último item que você coletou", -- Clicker
	-- English: "Changes your character to a random character#Removes the most recent item collected"

	[C_ID .. 483] = "Afeta o andar inteiro#Explode todos os objetos#{VAR:EFFECTLIST}#Abre a porta do Boss Rush, Hush e todas as Salas secretas#!!! Se você tem uma Bomba Dourada, consome ela ao usar em vez da Mama Mega", -- Mama Mega!
	-- Full old Desc: "Afeta o andar inteiro#Explode todos os objetos#Causa 200 de dano a todos os inimigos#Abre a porta do Boss Rush, Hush e todas as Salas secretas#!!! Se você tem uma Bomba Dourada, consome ela ao usar em vez da Mama Mega"
	...
	[C_ID .. 485] = "50% Chance de dobrar todos os itens, consumíveis e baús no sala#50% Chance de remover itens ou pickups na sala e gerar 1 moeda", -- Crooked Penny
	...
	[C_ID .. 488] = "Concede um efeito de item aleatório para a sala atual", -- Metronome
	-- English: "Grants a random item effect for the room"

	[C_ID .. 489] = "Efeito de dado aleatório a cada uso", -- D Infinity
	-- English: "Triggers a random dice effect each use"

	[C_ID .. 490] = "Cria 2 itens aleatórios baseado nos tipos de item da sala atual#Começa com nenhuma carga", -- Eden's Soul
	-- English: "Spawns 2 random items depending on the current room's item pool#Starts with no charges"

	[C_ID .. 491] = "{{Poison}} Usar pílulas envenenam os inimigos na sala atual", -- Acid Baby
	-- Full old Desc: "{{Pill}} Solta uma pílula aleatória a cada 3 salas#{{Poison}} Usar pílulas envenenam os inimigos na sala atual"
	-- English: "{{Pill}} Spawns a random pill every {VAR:1} rooms#{{Poison}} Using a pill poisons all enemies in the room"

	[C_ID .. 492] = "Destaca a localização de {{SecretRoom}} Salas Secretas, pedras marcadas e alçapões", -- YO LISTEN!
	-- Full old Desc: "↑ {{Luck}} +1 Sorte#Destaca a localização de {{SecretRoom}} Salas Secretas, pedras marcadas e alçapões"
	-- English: "Highlights the location of {{SecretRoom}} secret rooms, tinted rocks and {{LadderRoom}} crawlspaces"

	[C_ID .. 493] = "Para cada Contêiner de Coração que estiver vazio:#{VAR:EFFECTLIST}", -- Adrenaline
	-- Full old Desc: "Para cada Contêiner de Coração que estiver vazio:#↑ {{Damage}} +0.2 Dano"
	-- English: "For every empty heart container:#{VAR:EFFECTLIST}"

	[C_ID .. 494] = "Lágrimas geram 1-2 faíscas de eletricidade quando atingem algo#Físcas causam metade do dano", -- Jacob's Ladder
	-- English: "Tears spawn 1-2 sparks of electricity on impact#Sparks deal half of Isaac's damage"

	[C_ID .. 495] = "Chance de disparar uma chama que bloqueia disparos inimigos e causa dano ao contato#A chama fica até que ela tenha causado dano ou bloqueado disparos 5 vezes", -- Ghost Pepper
	...
	[C_ID .. 496] = "Agulhas matam inimigos normais instântaneamente, explodindo eles em 10 lágrimas#Agulhas causam 3x o dano contra chefes", -- Euthanasia
	-- Full old Desc: "3.33% de chance de disparar agulhas#{{Luck}} 100% de chance com 15 de Sorte#Agulhas matam inimigos normais instântaneamente, explodindo eles em 10 lágrimas#Agulhas causam 3x o dano contra chefes"
	...
	[C_ID .. 497] = "Fique camuflado ao entrar em uma sala até começar a disparar", -- Camo Undies
	-- English: "{{Confusion}} Entering a room confuses all enemies until Isaac starts shooting"

	[C_ID .. 498] = "{{AngelDevilChance}} Gera uma porta da Sala do Diabo E Sala do Anjo#Ao entrar em uma a outra desaparecerá", -- Duality
	...
	[C_ID .. 502] = "Enquanto disparar, ocasionalmente dispara uma lágrimas que deixa um rastro branco que causa o dobro de dano#Dispara uma lágrimas que deixa um rastro branco quando receber dano", -- Large Zit
	...
	[C_ID .. 506] = "Lágrimas que causam sangramento (10% do dano total de pontos de vida dos inimigos a cada 5 segundos)", -- Backstabber
	...
	[C_ID .. 507] = "{{Damage}} Danifique os inimigos com seu dano + 10% do dano igual à vida máxima do inimigo#Afeta todos os inimigos na sala#{{HalfHeart}} Chance de soltar Meio Coração quando causar dano#{{HalfSoulHeart}} Solta Corações de Alma em vez disso se você não tem HP vermelho", -- Sharp Straw
	...
	[C_ID .. 508] = "Orbital que causa sangramento que causa 10% do dano total de pontos de vida máximos dos inimigos a cada 5 segundos#Causa 300% do seu dano ao contato#Não bloqueia disparos", -- Mom's Razor
	...
	[C_ID .. 509] = "Orbital que dispara uma lágrima a cada 2 segundos em uma direção aleatória#Não bloqueia disparos", -- Bloodshot Eye
	-- Full old Desc: "Orbital que dispara uma lágrima a cada 2 segundos em uma direção aleatória#Causa 3.5 de dano por lágrima#Causa 30 de dano ao contato por segundo#Não bloqueia disparos"
	-- English: "Orbital that shoots a tear in a random direction every 2 seconds#Does not block shots"

	[C_ID .. 510] = "Gera uma versão amigável do chefe Delirium branco para a sala atual", -- Delirious
	...
	-- Full old Desc: "Orbita em torno de um inimigo aleatório até que ele morra#Causa dano ao contato"
	-- English: "Orbits a random enemy until that enemy dies"

	[C_ID .. 512] = "Buraco negro jogável que suga todos os inimigos para dentro dele#Inimigos presos levam dano rápidamente", -- Black Hole
	-- English: "Throwable black hole, which sucks in everything#Deals 6 damage per second#Destroys nearby rocks#Lasts 6 seconds"

	[C_ID .. 513] = "Chance aleatória de encantar ou amedrontar um inimigo#Chance de gerar um cocô de arco-íris ao receber dano", -- Bozo
	-- Full old Desc: "↑ {{Damage}} +0.1 Dano#{{SoulHeart}} +1 Coração de Alma#Chance aleatória de encantar ou amedrontar um inimigo#Chance de gerar um cocô de arco-íris ao receber dano"
	...
	[C_ID .. 515] = "Cria um item aleatório da sala atual", -- Mystery Gift
	...
	-- Full old Desc: "{{Bomb}} +7 Bombas#Permite que você coloque rapidamente bombas no chão"
	-- English: "Removes the delay between bomb placements"

	[C_ID .. 518] = "Dá a você um familiar aleatório#Tem um efeito de lágrima aleatória#Será trocado novamente a cada andar", -- Buddy in a Box
	-- English: "Familiar which looks like a random co-op baby#Has random tear effects#Effects change every floor"

	[C_ID .. 519] = "Um familiar que se transforma em outro familiar aleatório a cada 10 segundos", -- Lil Delirium
	...
	[C_ID .. 521] = "Quando usado, faz com que um item aleatório da {{Shop}} Loja ou {{DevilRoom}} Sala do Diabo fique gratuito#{{Shop}} Enquanto segurar, garante que um item da Loja estará a venda", -- Coupon
	...
	[C_ID .. 522] = "Projéteis inimigos próximos a você são mantidos no lugar por 3 segundos#Recarrega após 2 segundos", -- Telekinesis
	-- English: "Stops all enemy projectiles that come close to Isaac for 3 seconds and throws them away from him afterwards"

	[C_ID .. 523] = "Quando usado, armazena todos os pickups da sala atual#A utilização novamente as colocará no chão", -- Moving Box
	...
	[C_ID .. 524] = "Lágrimas serão conectadas por raios de eletricidade#Eletricidade causa o mesmo dano que você", -- Technology Zero
	-- English: "Isaac's tears are connected with beams of electricity#The beams deal Isaac's damage"

	[C_ID .. 525] = "Ao receber dano, irá gerar um orbital que bloqueia projéteis#Máximo de 3 orbitais ao mesmo tempo#Os orbitais podem ser destruídos se sofrerem muito dano", -- Leprosy
	...
	[C_ID .. 526] = "Dá a você um familiar cavaleiro que gera seu respectivo gafanhoto#O cavaleiro muda a cada 10 segundos", -- 7 Seals
	-- English: "Spawns a small horseman familiar that spawns locusts#The horseman and its locust changes every 10 seconds"

	[C_ID .. 527] = "Familiar usável que faz tarefas para você:#Abre portas ou baús#Traz um item#50% de chance de roubar da Loja ou Sala do Diabo#Ataca um inimigo até ele morrer#Explode pareder, pedras, shopkeepers, estátuas do anjo, máquinas, mendigos", -- Mr. ME!
	...
	[C_ID .. 528] = "Prima obrbital#As lágrimas que atingem o prisma se dividirão em 4 novas lágrimas", -- Angelic Prism
	-- English: "Orbital prism#Friendly tears hitting it split into 4"

	[C_ID .. 529] = "Lágrimas se comportarão como bolas de bilhar", -- Pop!
	-- English: "Isaac's tears bounce off each other and disappear when they stop moving"

	[C_ID .. 530] = "Concede um pickup ou aumento de status se você matar inimigos na ordem em que estão marcados", -- Death's List
	-- English: "Killing enemies in the order dictated by the mark {{DeathMark}} above them grants a random pickup or stat increase"

	[C_ID .. 531] = "↑ {{Damage}} 31% Dano", -- Haemolacria
	-- Full old Desc: "Lágrimas voam em um arco#Lágrimas explodem em lágrimas menores com o impacto#↓ {{Tears}} Lágrimas#↑ {{Damage}} 31% Dano"
	-- English: "Isaac's tears fly in an arc and burst into smaller tears on impact"

	[C_ID .. 532] = "As lágrimas diminuem enquanto viaja pela sala#Ao parar, eles explodem em 8 lágrimas menores#As lágrimas podem ser disparadas em outras lágrimas, aumentando-as", -- Lachryphagy
	-- English: "Isaac's tears progressively slow down, stop, then explode into 8 smaller tears#Tears can merge and become bigger"

	[C_ID .. 533] = "Lágrimas são trocadas por feixes de luz#{{Damage}} Causa 33% de dano, mas pode atingir inimigos múltiplas vezes", -- Trisagion
	-- English: "Replaces Isaac's tears with piercing beams of light#The beams deal 33% damage but can hit enemies multiple times"

	[C_ID .. 534] = "Permite segurar 2 itens ativos#Troque entre eles pressionando o botão de Soltar ({{ButtonRT}})", -- Schoolbag
	...
	-- Full old Desc: "{{SoulHeart}} +1 Coração de Alma#{{HealingRed}} Cura 1 Coração Vermelho#{{Collectible313}} Concede um escudo ao entrar na sala do chefe"
	...
	[C_ID .. 537] = "{{Pill}} +1 Pílula aleatória ao pegar#Familiar que dispara uma linha de rastro#O tipo de rastro muda toda vez que o jogador usa uma pílula", -- Lil Spewer
	...
	-- Full old Desc: "{{Trinket}} Solta 3 trinkets aleatórios#{{Collectible479}} Ao receber dano, tem a chance de consumir permanentemente o trinket atual"
	-- English: "{{Collectible479}} Taking damage has a 10% chance to consume Isaac's held trinket and grant its effects permanently"

	[C_ID .. 539] = "Ao receber dano, gera um inimigo amigavel#Gera amigáveis mais fortes quanto mais salas forem limpas sem receber dano", -- Mystery Egg
	...
	[C_ID .. 543] = "Gera um cocô branco quando você recebe dano#Enquanto estiver dentro da aura do cocô:#{VAR:EFFECTLIST}#Chance de bloquear danos", -- Hallowed Ground
	-- Full old Desc: "Gera um cocô branco quando você recebe dano#Enquanto estiver dentro da aura do cocô:#↑ {{Tears}} -50% Atraso de Lágrimas#Chance de bloquear danos"
	...
	-- Full old Desc: "{{EmptyBoneHeart}} +1 Coração de Osso#↑ {{Tears}} +0.7 Lágrimas#{{Trinket21}} Gera o trinket Mysterious Paper"
	...
	[C_ID .. 550] = "!!! Primeira parte da pá quebrada#O Pé da Mãe constantemente o ataca#O uso dela para o ataque para a sala atual#(Tente vencer o Boss Rush com ele)", -- Broken Shovel
	...
	[C_ID .. 551] = "!!! Segunda parte de uma pá quebrada", -- Broken Shovel
	-- English: "Completes Mom's Shovel#{{Warning}} Use the shovel on the mound of dirt in the "Dark Room""

	[C_ID .. 552] = "Cria um alçapão para o próximo andar#Desbloqueia algo legal", -- Mom's Shovel
...
local additionalTrinketInformations = {
	...
	[T_ID .. 2] = "50% de chance de drops de cocôs", -- Petrified Poop
	...
	[T_ID .. 4] = "Teleporta você ao usar um item ativo", -- Broken Remote
	-- English: "{{Collectible44}} Using an active item teleports Isaac to a random room"

	[T_ID .. 5] = "Dobra a chance de aparecer inimigos campeões", -- Purple Heart
	...
	[T_ID .. 9] = "Lágrimas pulsantes#Afeta a hitbox de lágrimas", -- Pulse Worm
	-- English: "Isaac's tears pulsate#Affects tear hitbox"

	[T_ID .. 10] = "↑ {{Tears}} +0.3 Lagrimas", -- Wiggle Worm
	-- Full old Desc: "Lágrimas se movem em ondas#↑ {{Tears}} +0.3 Lagrimas"
	-- English: "Isaac's tears move in waves"

	[T_ID .. 11] = "Lágrimas se movem em espiral em alta velocidade", -- Ring Worm
	-- English: "Isaac's tears move in spirals with high speed"

	[T_ID .. 12] = "Lágrimas 50% maiores#Aumenta o recuo", -- Flat Worm
	-- English: "50% wider tears#Increases knockback"

	[T_ID .. 13] = "{{Shop}} Todos os itens de loja são gratuitos#!!! Ao comprar qualquer item de loja com 0 moedas, este trinket desaparece", -- Store Credit
	...
	[T_ID .. 17] = "{{BlackHeart}} +1% de chance de Corações Negros", -- Black Lipstick
	-- English: "{{BlackHeart}} +10% chance for random Soul Hearts to spawn as Black Hearts"

	[T_ID .. 18] = "{{EternalHeart}} +3% de chance de Corações Eternos", -- Bible Tract
	-- English: "{{EternalHeart}} +3% chance for Eternal Hearts"

	[T_ID .. 19] = "Abra baús sem usar chaves", -- Paper Clip
	-- English: "{{GoldenChest}} Gold chests can be opened for free"

	[T_ID .. 20] = "{{BlackHeart}} Quando estiver com Meio Coração de saúde, gere um Coração Negro#!!! Até 3 usos", -- Monkey Paw
	...
	[T_ID .. 21] = "Imita aleatóriamente:#{VAR:TEXT}", -- Mysterious Paper
	-- Full old Desc: "Imita aleatóriamente:#{{Collectible327}} Polaroid#{{Collectible328}} The Negative#{{Trinket48}} A Missing Page#{{Trinket23}} Missing Poster"
	-- English: "Randomly grants the effect of:#{VAR:TEXT}"

	[T_ID .. 22] = "{{Heart}} Diminui a chance de aparição de Corações em 20%#{{BlackHeart}} Pickups de Corações se tornam Corações Negros#{{Key}} Aumenta a chance de aparição de chaves", -- Daemon's Tail
	...
	[T_ID .. 23] = "{{Player10}} Renasce como The Lost quando morrer#Se ele não estiver desbloqueado, morra em uma {{SacrificeRoom}} Sala do Sacrifício enquanto segurar este trinket para desbloqueá-lo", -- Missing Poster
	-- English: "{{Player10}} Respawn as The Lost on death"

	[T_ID .. 24] = "{{Coin}} Chance 20% maior de cocôs soltarem moedas#Peida ao pegar moedas#O peido somente empurra os inimigos", -- Butt Penny
	-- English: "{{Coin}} 20% higher chance for coins to spawn from poop#Picking up coins makes Isaac fart"

	[T_ID .. 25] = "Peide ou solte um cocô a cada 30 segundos", -- Mysterious Candy
	-- English: "Isaac farts or spawns poop every 30 seconds"

	[T_ID .. 26] = "↑ {{Range}} +10 Alcance", -- Hook Worm
	-- Full old Desc: "As lágrimas se movem em padrões angulares#↑ {{Range}} +10 Alcance"
	...
	[T_ID .. 32] = "Receba um efeito aleatório de cogumelo por sala#Pode revelar salas especiais no minimapa", -- Liberty Cap
	-- English: "25% chance for a random mushroom effect per room#Can reveal special rooms on the minimap"

	[T_ID .. 34] = "{{Heart}} 10% de chance da recompensa por limpar a sala ser um Coração Vermelho aleatório#Chance de um Coração bônus para baús, pedras marcadas e máquinas destruídas", -- Child's Heart
	...
	[T_ID .. 36] = "{{Key}} 10% de chance da recompensa por limpar a sala ser uma chave#Chance de uma chave bônus para baús, pedras marcadas e máquinas destruídas", -- Rusted Key
	...
	[T_ID .. 38] = "+10% de chance para drops aleatórios de coração vermelho serem: #{{SoulHeart}} Coração de Alma#{{BlackHeart}} Coração Negro#{{EmptyBoneHeart}} Coração de Osso", -- Mom's Pearl
	-- English: "+10% chance for heart drops to be {{SoulHeart}} Soul Hearts, {{BlackHeart}} Black Hearts or {{EmptyBoneHeart}} Bone Hearts"

	[T_ID .. 40] = "↑ {{Damage}} 20% de chance de ganhar +1.8 Dano ao ser atingido", -- Red Patch
	-- Full old Desc: "↑ {{Damage}} 20% de chance de ganhar +1.8 Dano ao ser atingido#{{Luck}} 100% de chance com 8 de Sorte#Efeito dura somente para a sala atual"
	-- English: "{{Timer}} Taking damage has a {VAR:LUCKCHANCE}% chance to grant ↑ {{Damage}} +1.8 damage for the room"

	[T_ID .. 41] = "10% de chance da recompensa por limpar a sala ser uma bomba#{{Bomb}} Chance de uma bomba bônus para baús, pedras marcadas e máquinas destruídas #!!! Remove o trinket {{Trinket53}} The Tick", -- Match Stick
	...
	[T_ID .. 42] = "+8% chance de recompensa por limpar a sala#Pickups extras para baús, pedras marcadas e máquinas destruídas", -- Lucky Toe
	-- Full old Desc: "↑ {{Luck}} +1 Sorte#+8% chance de recompensa por limpar a sala#Pickups extras para baús, pedras marcadas e máquinas destruídas"
	-- English: "+8% room clear reward chance#33% chance for an extra pickup from chests, tinted rocks, and destroyed machines"

	[T_ID .. 43] = "Quando sofrer dano de Meio Coração ou menos, teleporta o personagem para uma sala aleatória", -- Cursed Skull
	-- English: "When damaged down to half a heart or less, Isaac is teleported to a random room"

	[T_ID .. 44] = "{{Pill}} 10% de chance da recompensa por limpar a sala ser uma pílula#{{Pill}} Chance de uma pílula bônus para baús, pedras marcadas e máquinas destruídas", -- Safety Cap
	...
	[T_ID .. 45] = "{{Card}} 10% de chance da recompensa por limpar a sala ser uma carta#{{Card}} Chance de uma carta bônus para baús, pedras marcadas e máquinas destruídas", -- Ace of Spades
	...
	[T_ID .. 49] = "{{HalfHeart}} 50% de chance de gerar Meio Coração Vermelho ao pegar moedas", -- Bloody Penny
	...
	[T_ID .. 53] = "!!! Só consiguirá soltá-lo com o trinket {{Trinket41}} Match Stick#-15% da vida dos Chefes#{{BossRoom}} Cura 1 Coração Vermelho ao entrar na Sala do Chefe", -- Tick
	...
	[T_ID .. 54] = "Familiar com lágrimas que atravessam inimigos", -- Isaac's Head
	-- Full old Desc: "Familiar com lágrimas que atravessam inimigos#Causa 3.5 de dano por lágrima"
	-- English: "Familiar with piercing tears"

	[T_ID .. 55] = "{{EternalHeart}} Consiga um Coração Eterno ao iniciar um novo andar", -- Maggy's Faith
	-- English: "{{EternalHeart}} Entering a new floor grants +1 Eternal Heart"

	[T_ID .. 56] = "{{DevilRoom}} Reduz os preços de todos itens do Arcodo com o Diabo de 2 Contêineres de Coração para 1", -- Judas' Tongue
	-- English: "{{DevilRoom}} Reduces all devil deal prices to 1 heart container#Doesn't reduce 3 Soul Heart prices"

	[T_ID .. 57] = "Familiar que salta ao redor da sala#Atira na mesma direção que o personagem", -- ???'s Soul
	-- Full old Desc: "Familiar que salta ao redor da sala#Atira na mesma direção que o personagem#Causa 3.5 de dano por lágrima"
	-- English: "Familiar that bounces around the room#Shoots in the same direction as Isaac"

	[T_ID .. 58] = "↑ {{Damage}} 1/15 de chance de +0.5 Dano ao matar um inimigo na sala atual", -- Samson's Lock
	-- Full old Desc: "↑ {{Damage}} 1/15 de chance de +0.5 Dano ao matar um inimigo na sala atual#{{Luck}} 100% de chance com 10 de Sorte#O efeito dura somente para a sala atual"
	...
	[T_ID .. 62] = "Pedras marcadas e pedras com um alçapão em baixo a cada 10 segundos", -- Shiny Rock
	-- English: "Crawlspace rocks and tinted rocks blink every 10 seconds"

	[T_ID .. 63] = "Transforma bombas trolls em bombas coletáveis", -- Safety Scissors
	-- English: "{{Bomb}} Turns Troll Bombs into bomb pickups"

	[T_ID .. 64] = "Efeito de minhoca aleatória a cada 3 segundos", -- Rainbow Worm
	...
	[T_ID .. 71] = "{{Bomb}} Bombas deixam poça venenosa que causa dano aos inimigos ao contato", -- Bob's Bladder
	-- English: "Isaac's bombs leave damaging creep"

	[T_ID .. 72] = "{{Battery}} 6.66% de chance da recompensa por limpar a sala ser uma bateria#+10% de chance de pickups aleatórios serem uma bateria#5% de chance de adicionar 1 carga ao item ativo ao limpar uma sala", -- Watch Battery
	...
	[T_ID .. 73] = "10% de chance de soltar uma bomba coletável quando uma bomba explodir", -- Blasting Cap
	-- English: "{{Bomb}} 10% chance for exploding bombs to drop a bomb pickup"

	[T_ID .. 74] = "0.5% de chance de revelar um alçapão ao quebrar pedras", -- Stud Finder
	-- English: "{{LadderRoom}} +0.5% chance to reveal a crawlspace when breaking a rock"

	[T_ID .. 75] = "Efeito de trinket aleatório em todas as salas", -- Error
	-- English: "Grants a random trinket effect every room"

	[T_ID .. 76] = "Baús tem 50/50 de chance de gerarem pickup extras ou um inimigo Mosca", -- Poker Chip
	-- English: "↑ 50% chance for chests to spawn extra pickups#↓ 50% chance for chests to contain a single fly"

	[T_ID .. 77] = "Aumenta o recuo das lágrimas", -- Blister
	-- English: "Increases knockback"

	[T_ID .. 78] = "Duração dos efeitos em inimigos 2x maior", -- Second Hand
	-- English: "Status effects applied to enemies last twice as long"

	[T_ID .. 79] = "25% de chance de ao usar pílulas/cartas solta uma cópia dela no chão", -- Endless Nameless
	...
	[T_ID .. 82] = "{{TreasureRoom}} +15% de chance de ter 2 itens na Sala do Tesouro nos próximos andares#Você pode pegar apenas um", -- Golden Horse Shoe
	...
	[T_ID .. 84] = "5% mais moedas e menos Corações para a recompensas ao limpar salas#Greed e Super Greed não aparecem mais em {{Shop}}Lojas ou {{SecretRoom}}Salas Secretas", -- Rib of Greed
	...
	[T_ID .. 87] = "Cura Meio Coração quando você usa chaves#Meios Corações aparecem como Corações Cheios", -- Mom's Locket
	-- English: "{{HealingRed}} Using a key heals half a heart#{{Heart}} Turns half hearts into full hearts"

	[T_ID .. 88] = "Impede que itens ativáveis apareçam", -- NO!
	...
	[T_ID .. 91] = "Aumenta a chance de o cocô preto aparecer#Chance de gerar um Coração Negro quando o cocô preto é destruido", -- Meconium
	-- English: "33% chance for Black Poops to spawn#{{BlackHeart}} Destroying Black Poop has a 5% chance to spawn a Black Heart"

	[T_ID .. 92] = "↑ {{Tears}} +0.2 Lagrimas", -- Cracked Crown
	-- Full old Desc: "↑ Aumento de estatísticas de seus itens são 33% mais eficazes#↑ {{Tears}} +0.2 Lagrimas#↑ {{Tears}} +1 Atraso da lágrima"
	...
	[T_ID .. 93] = "15% de chance por sala para todas as Moscas inimigas se tornarem amigáveis", -- Used Diaper
	...
	[T_ID .. 97] = "Máximo de +2 Familiares", -- Tonsil
	-- Full old Desc: "Recebe um familiar que bloqueia projéteis após receber dano 12-20 vezes#Máximo de +2 Familiares"
	-- English: "Taking damage {VAR:RANGE} times spawns a projectile blocking familiar#Disappears after spawning 2 familiars"

	[T_ID .. 98] = "{{Poison}} 10% de chance de disparar lágrimas teleguiadas, pegajosas e venenosas#Causa o seu dano a cada segundo#Gruda por 10 segundos", -- Nose Goblin
	-- Full old Desc: "{{Poison}} 10% de chance de disparar lágrimas teleguiadas, pegajosas e venenosas#Causa o seu dano a cada segundo#Gruda por 10 segundos"
	...
	[T_ID .. 99] = "10% de chance de disparar lágrimas saltitantes", -- Super Ball
	...
	-- Full old Desc: "!!! Enquanto estiver com o item totalmente carregado:#↑ +0.25 Velocidade#↑ +0.75 Alcance#↑ +0.2 Lagrimas#↑ +0.10 Velocidade de Disparo#↑ +0.5 Dano#↑ +1 Sorte"
	...
	-- Full old Desc: "!!! Enquanto estiver com o item totalmente descarregado:#↑ +0.5 Velocidade#↑ +1.5 Alcance#↑ +0.4 Lagrimas#↑ +0.3 Velocidade de Disparo#↑ +1.5 Dano#↑ +2 Sorte"
	...
	[T_ID .. 103] = "!!! Quando o número de moedas, chaves e bombas são iguais:#Transforma metade dos consumíveis em consumíveis duplos", -- Equality!
	...
	[T_ID .. 107] = "O dano recebido ignora os Corações de Alma/Negros, fazendo com que seus Contêineres de Coração Vermelhos se esgote primeiro", -- Crow Heart
	...
	[T_ID .. 108] = "!!!É destruído depois#Chance de soltar um pickup ou trinket ao ser atingido por uma explosão", -- Walnut
	...
	[T_ID .. 110] = "{{Shop}} As Lojas agora aparecerão no Womb", -- Silver Dollar
	...
	[T_ID .. 112] = "{{RestockMachine}} As máquinas de reabastecimento sempre aparecem nas {{TreasureRoom}} Sala do Tesouro", -- Pay To Win
	-- English: "{{RestockMachine}} Restock boxes always spawn in {{TreasureRoom}} Treasure Rooms"

	[T_ID .. 113] = "Gera uma mosca explosiva de ataque ao entrar em uma sala hostil#A mosca causa o dobro do seu dano + dano de explosão", -- Locust of War
	...
	[T_ID .. 115] = "Gera uma mosca de ataque de lentidão ao entrar em uma sala hostil#A mosca causa o dobro do seu dano", -- Locust of Famine
	...
	[T_ID .. 118] = "5% de chance de ganhar voo após matar um inimigo#Persiste para a sala atual", -- Bat Wing
	-- English: "{{Timer}} Killing an enemy has a 5% chance to grant flight for the room"

	[T_ID .. 119] = "{{HalfHeart}} Cura Meio Coração Vermelho ao viajar para o próximo andar", -- Stem Cell
	-- English: "{{HealingRed}} Entering a new floor heals half a heart"

	[T_ID .. 120] = "Recarrega totalmente seu item ativo no início de uma batalha contra um chefe", -- Hairpin
	-- English: "{{Battery}} Entering an uncleared boss room fully recharges active items"

	[T_ID .. 121] = "{{Collectible313}} Protege você do primeiro dano que recebe em cada andar", -- Wooden Cross
	-- English: "{{Collectible313}} Grants a Holy shield that prevents damage once per floor"

	[T_ID .. 122] = "Ao usar seu item ativo ele cairá de volta em um pedestal no chão#Ao receber dano há 2% de chance de soltar um dos seus itens passivos", -- Butter!
	...
	[T_ID .. 123] = "Faz com que os chefes Anjos deixem itens normais em vez de peças da chave", -- Filigree Feather
...
local additionalCardInformations = {
	...
	[Card_ID .. 3] = "Faz com que o Pé da Mãe pise em um inimigo (300 de dano)", -- II - The High Priestess
	-- English: "Mom's Foot stomps on an enemy#Mom's Foot stomps Isaac if there are no enemies"

	[Card_ID .. 5] = "{{BossRoom}} Teleporta você para a Sala do Chefe", -- IV - The Emperor
	...
	[Card_ID .. 10] = "{{Shop}} Teleporta você para a Loja", -- IX - The Hermit
	...
	[Card_ID .. 15] = "{{DonationMachine}} Cria uma máquina de doação de sangue#{{GreedMode}} Gera um Devil Beggar no Greed Mode", -- XIV - Temperance
	...
	[Card_ID .. 18] = "{{TreasureRoom}} Teleporta você para a Sala do Tesouro", -- XVII - The Stars
	-- English: "{{TreasureRoom}} Teleports Isaac to the Treasure Room"

	[Card_ID .. 19] = "{{SecretRoom}} Teleporta você para a Sala Secreta", -- XVIII - The Moon
	...
	[Card_ID .. 26] = "!!! Só tem efeito curativo#{{Heart}} Duplique seus Corações Vermelhos", -- 2 of Hearts
	...
	[Card_ID .. 30] = "{{Heart}} Transforma todos os pickups em Corações", -- Ace of Hearts
	-- English: "{{UnknownHeart}} Turns all pickups into random hearts"

	[Card_ID .. 31] = "{{AngelDevilChance}} Teleporta você para Sala do Diabo ou Sala do Anjo", -- Joker
	...
	[Card_ID .. 34] = "Cria um alçapão para o próximo andar", -- Ehwaz
	-- English: "Spawns a trapdoor to the next floor#{{LadderRoom}} 8% chance for a crawlspace trapdoor"

	[Card_ID .. 35] = "{{CurseCursed}} Remove os efeitos de maldição", -- Dagaz
	-- Full old Desc: "{{SoulHeart}} +1 Coração de Alma#{{CurseCursed}} Remove os efeitos de maldição"
	...
	[Card_ID .. 40] = "Efeito de rúna aleatória#25% de chance de soltar esta runa novamente", -- Blank Rune
	...
	[Card_ID .. 42] = "Ao usar, arremessa a carta na direção em que você está se movendo#Mata imediatamente QUALQUER inimigo que ela tocar (exceto Delirium)", -- Chaos Card
	-- English: "Using the card throws it in the direction Isaac is moving#Instantly kills ANY enemy it touches (except Delirium)"

	[Card_ID .. 43] = "Remove o preço de todos os itens da {{Shop}} Loja atual ou {{DevilRoom}} Acordo com o Diabo, tudo fica de graça", -- Credit Card
	...
	[Card_ID .. 46] = "Mata o personagem e gera muitos pickups, itens e/ou baús na mesma sala", -- Suicide King
	...
	[Card_ID .. 50] = "Mãos da Mãe descem e agarram um inimigo", -- Emergency Contact
	-- English: "Two of Mom's Hands come down and grab an enemy each"

	[Card_ID .. 51] = "{{Collectible313}} Concede o efeito Holy Mantle por uma sala#(Proteção contra dano)#25% de chance de gerar outro Holy Card", -- Holy Card
	...
	-- Full old Desc: "!!! Efeito dura para a sala atual#↑ {{Damage}} +7 Dano#↑ {{Range}} +30 Alcance#Aumenta seu tamanho#Quebra pedras ao contato"
	...
	-- Full old Desc: "{{Slow}} Diminui a velocidade dos inimigos#↓ {{Speed}} -0.5 Velocidade#↓ {{Shotspeed}} -1 Velocidade de Disparo#Efeito dura para a sala atual"
...
local additionalPillInformations = {
	...
	[Pill_ID .. 2] = "Causa 1 Coração de dano a você#Se torna uma pílula de Saúde Cheia se você tem 1 coração ou menos", -- Bad Trip
	-- English: "{{Warning}} Deals 1 heart of damage to Isaac#Becomes a Full Health pill at 1 heart or less"

	[Pill_ID .. 4] = "Trocar o número de bombas pelo número de chaves", -- Bombs are Key
	-- English: "Swaps Isaac's number of {{Bomb}} bombs and {{Key}} keys"

	[Pill_ID .. 5] = "Solta 5 bombas trolls no local que você está", -- Explosive Diarrhea
	-- English: "Isaac quickly spawns 5 lit bombs"

	[Pill_ID .. 7] = "Se torna uma pílula Health Up se você tem 0 ou 1 Contêiner de Coração", -- Health Down
	-- Full old Desc: "↓ {{Heart}} Saúde#Se torna uma pílula Health Up se você tem 0 ou 1 Contêiner de Coração"
	-- English: "Becomes a Health Up pill at 0 or 1 heart containers"

	[Pill_ID .. 10] = "{{Adult}} Consumir 3 pílulas concederá a transformação Adulto (+1 Contêiner de Coração Vazio)#{VAR:EFFECTLIST}", -- Puberty
	-- Full old Desc: "Sem efeito#{{Adult}} Consumir 3 pílulas concederá a transformação Adulto (+1 Contêiner de Coração Vazio)"
	-- English: "Eating 3 grants the Adult transformation:#{VAR:EFFECTLIST}"

	[Pill_ID .. 20] = "Teletransporta você para uma sala aleatória#{{ErrorRoom}} Baixa chance de te teleportar para a sala I AM ERROR", -- Telepills
	...
	[Pill_ID .. 22] = "Drena todos os Contêineres de Corações, exceto um", -- Hematemesis
	-- Full old Desc: "Drena todos os Contêineres de Corações, exceto um#{{Heart}} Gera 1-4 Corações Vermelhos"
	...
	[Pill_ID .. 27] = "Cria uma grande poça de limonada no chão que causa dano aos inimigos", -- Lemon Party
	...
	[Pill_ID .. 29] = "Tome apenas Meio Coração de dano para a sala atual", -- Percs!
	-- English: "{{Timer}} Reduces all damage taken to half a heart for the room"

	[Pill_ID .. 30] = "Danos sofridos na sala atual levam um Coração Inteiro", -- Addicted!
	-- English: "{{Timer}} Increases all damage taken to a full heart for the room"

	[Pill_ID .. 31] = "Gera cocô enquanto caminha por 2 segundos", -- Re-Lax
	...
	-- Full old Desc: "Aumeta seu tamanho#Não afeta seu hitbox"
	...
	[Pill_ID .. 35] = "Gera 1 aranha azul por cocô na sala", -- Infested!
	-- English: "Spawns 1 blue spider for each poop in the room"

	[Pill_ID .. 36] = "Gera 1 aranha azul por inimigo na sala#Gera 1-3 aranhas azuis quando nenhum inimigo está na sala", -- Infested?
	...
	[Pill_ID .. 40] = "Gera uma poça de fluido escorregadio", -- X-Lax
	-- English: "Spawns a pool of slippery creep"

	[Pill_ID .. 41] = "{{Slow}} Gera uma poça de fluido de lentidão", -- Something's wrong...
	...
	[Pill_ID .. 45] = "{{Collectible149}} Atira uma lágrima do Ipecac", -- Horf!
	-- English: "{{Collectible149}} Shoots one Ipecac tear"

	[Pill_ID .. 47] = "{{Pill}} Gera a última pílula usada", -- Vurp!
