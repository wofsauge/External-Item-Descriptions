...
EID.descriptions[languageCode].collectibles={
	...
	{"4", "Cricketova Hlava", "↑ {{Damage}} +0.5 Větší Poškození#↑ {{Damage}} +50% Násobič Poškození"},
	...
	{"64", "Výprodej na Steamu", "{{Shop}} -50% na předměty v obchodě#Pokud tuto položku získáte dvakrát, bude vše zdarma"},
	...
	{"157", "Krvavá Chtíč", "↑ {{Damage}} Větší Poškození pokaždé co dostanete zásah#Aplikuje se až 6krát za patro#Trvá po celé patro"},
	...
	{"219", "Starý Obvaz", "↑ {{EmptyHeart}} +1 Prázdné místo pro Srdce#{{Heart}} Náhodná šance na vytvoření Červených Srdcí, když dostanete zásah"},
	...
	{"224", "Cricketovo Tělo", "↑ {{Tears}} +1 Více Slz#↓ {{Range}} -10 Menší Dostřel#Slzy se při zásahu rozdělují na 4#Rozdělené slzy způsobí poloviční poškození"},
	...
	{"233", "Maličká Planeta", "Slzy kolem tebe obíhají#↑ {{Range}} O Hodně Větší Dostřel!#↑ +7 Výška Slz#Spektrální slzy"},
	...
	{"319", "Cainovo Druhé Oko", "Odráží se po místnosti#Střílí směrem k Izákovi#{{Damage}} Jeho poškození se rovná tvému poškození"},
	...
	{"382", "Kamarádská Koule", "Můžeš ji vrhnout na nepřátele k jejich zachycení#Při dalším použití se znovu objeví stejný nepřítel ale jakožto přátelský společník"},
	...
	{"422", "Zářící Přesýpací Hodiny", "Přetočíš čas a vrátíš se zpět do předchozí místnosti, ve které jsi byl předtím a do stejného stavu oné místnosti"},
	...
	{"472", "Královské Dítě", "Ostatní spojenci ho následují#Přestane se pohybovat, když střílíte#Když přestanete střílet, teleportují se zpět k tobě"},
	...
	{"475", "Plán C", "!!! JEDNO POUŽITÍ !!!#Způsobí 9,999,999 poškození všem nepřátelům a tebe zabije o 3 sekundy později"},
	...
	{"515", "Tajemný Dárek", "!!! JEDNO POUŽITÍ !!!#Vytvoří náhodný předmět ze skupiny předmětů aktuální místnosti#Šance místo toho vytvořit Hroudu Uhlí nebo Hovno"},
	...
	{"534", "Školní Aktovka", "Umožňuje ti držet 2 aktivní předměty#Přepínej mezi nimi stisknutím tlačítka Drop (tlačítko držte za \"The Forgotten\")"},
	...
	{"536", "Obětní Oltář", "!!! JEDNO POUŽITÍ !!!#Obětuje 1-2 spojence, aby vytvořil Ďábelský předmět#Promění tvé modré pavouky/mouchy na mince"},
...
EID.descriptions[languageCode].trinkets={
	...
	{"42", "Palec Šťestí", "↑ {{Luck}} +1 Zvýšení Štěstí#+8% šance na odměnu z vyčištěné místnosti#Extra pickupy z truhel, zbarvených kamenů a rozbitých strojů"},
...
EID.descriptions[languageCode].pills={
	...
	{"36", "Power Pilulka!", "Krátká nesmrtelnost#Udělujete kontaktní poškození"},
