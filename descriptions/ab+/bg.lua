...
EID.descriptions[languageCode].collectibles={
	...
	{"169", "Полифем", "Мега сълзи!#↑ {{Damage}} Увеличена щета: (Щета + 4) x 2#↓ {{Tears}} 2 скорост на стреляне#Сълзите продължават след убито чудовище"},    -- Typed out exact Damage formula. The en desc is grossly incorrect in this regard (at least, 4 additional damage should be 8 if we are describing it that way).
	...
	{"297", "Кутията на Пандора", "Нещата, които може да пусне са зависимост от етажа:#B1: 2 Духовни сърца#B2:2 ключа, 2 бомби#C1:1 Boss предмет#C2:B1 + C1#D1:4 Духовни сърца#D2: 30 Монети#W1:2 Boss предмета#W2: Библия#Sheo1: 1 Дяволски предмет+Черное сърце#Cat: 1 Ангелски предмет+Духовно сърце#Съндък: 1 Монета"},
