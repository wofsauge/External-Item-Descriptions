...
EID.descriptions["pl"].collectibles={
	...
	{"442", "Korona Księcia Mroku", "!!! Mając 1 pełne, czerwone serce:#↑ +1.5 Zasięgu#↑ +0.7 Szybkostrzelności#↑ +0.2 Prędkości Strzałów#(Nie działa na Zaginionym/The Lost)"},
	...
	{"450", "Chciwe Oko", "Łzy mogą zamieniać przeciwników w złoto"},
	...
	{"455", "Zgubiona Moneta Taty", "↑ +1.5 Zasięgu#Tworzy szczęśliwy grosz"},
