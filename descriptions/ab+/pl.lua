...
EID.descriptions["pl"].collectibles={
	...
	{"475", "Plan C", "!!! JEDNORAZOWE ! #Zadaje 9,999,999 obrażeń wszystkim przeciwnikom w pokoju i zabija cię 3 sekundy później"},
	...
	{"478", "Pauza", "Zamraża wszystkich wrogów w pokoju, dopóki nie zaczniesz strzelać#Dotknięcie zamrożonego wroga cię zrani"},
	...
	{"483", "Mama Mega!", "!!! JEDNORAZOWE ! #Wpływa na całe piętro#Wysadza wszystkie obiekty#Zadaje 200 obrażeń wszystkim przeciwnikom#Otwiera:#drogę na Boss Rush#drzwi do Husha#Sekretne Pokoje"},
	...
	{"490", "Dusza Edena", "!!! JEDNORAZOWE !#Tworzy 2 losowe przedmioty z puli pokoju, w którym zostanie użyte"},
	...
	{"515", "Tajemniczy Prezent", "!!! JEDNORAZOWE !#Tworzy losowy przedmiot z puli obecnego pokoju#Szansa na stworzenie Bryły Węgla{{Collectible132}} lub Kupy{{Collectible36}}"},
	...
	{"536", "Ołtarz Ofiarny", "!!! JEDNORAZOWE !#Poświęcasz 1-2 sojuszników i tworzysz przedmiot z puli Pokoju Diabła{{DevilRoom}}#Zmienia twoje niebieskie pająki/muchy w monety"},
	...
	{"547", "Papiery Rozwodowe", "+1 Kościane Serce#↑ +0.7 Szybkostrzelności#Tworzy trynkiet#{{Blank}} {{Trinket21}} Mysterious Paper"},
