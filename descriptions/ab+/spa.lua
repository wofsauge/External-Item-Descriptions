...
EID.descriptions[languageCode].collectibles={
	...
	{"11", "¡+1!", "↑ +1 Vida#Reapareces con la vida al completo"},
	{"12", "Hongo mágico", "↑ {{Heart}} +1 de Vida#↑ {{Speed}} Velocidad +0.3#↑ {{Range}} Alcance +5.25#↑ {{Damage}} Daño x1.5 + 0.3#↑ {{Tearsize}} Tamaño de lágrimas +0.5#{{HealingRed}} Vida al completo"},
	...
	{"15", "<3", "↑ {{Heart}} +1 de Vida#{{HealingRed}} Vida al completo"},
	{"16", "Hígado crudo", "↑ {{Heart}} +2 de Vida#{{HealingRed}} Vida al completo"},
	{"17", "Llave esquelética", "+99 llaves"},
	{"18", "Un dólar", "+99 monedas"},
	{"19", "¡Buum!", "↑ {{Bomb}} +10 Bombas"},
	{"20", "Transcendencia", "¡Vuela!"},
	{"21", "La Brújula", "Muestra todos los iconos del mapa#No muestra el plano del mapa"},
	{"22", "Almuerzo", "↑ {{Heart}} +1 de Vida"},
	{"23", "Cena", "↑ {{Heart}} +1 de Vida"},
	{"24", "Postre", "↑ {{Heart}} +1 de Vida"},
	{"25", "Desayuno", "↑ {{Heart}} +1 de Vida"},
	{"26", "Carne podrida", "↑ {{Heart}} +1 de Vida"},
	...
	{"45", "Delicioso Corazón", "{{HealingRed}} Cura 1 corazón"},
	...
	{"62", "Encanto del Vampiro", "{{HealingRed}} Cura medio corazón cada 13 enemigos asesinados"},
	...
	{"75", "PHD", "{{HealingRed}} Cura 2 corazones#{{Pill}} Genera 1 píldora#{{Pill}} Transforma las píldoras malas en píldoras buenas#{{BloodDonationMachine}} Las máquinas de donación de sangre otorgan más {{Coin}} monedas"},
	...
	{"92", "Super Vendaje", "↑ {{Heart}} +1 de Vida#{{HealingRed}} Cura 1 corazón#{{SoulHeart}} +2 Corazones de Alma"},
	{"93", "El Gamekid", "{{Timer}} Recibes por 6,5 segundos:#Invincibilidad#Isaac no puede disparar pero hace 40 de daño por contacto cada segundo#{{HealingRed}} Matar 2 enemigos cura medio corazón#{{Fear}} Asusta a todos los enemigos en la habitación"},
	...
	{"101", "El Halo", "↑ {{Heart}} +1 de Vida#↑ {{Speed}} Velocidad +0.3#↑ {{Damage}} Daño +0.#↑ {{Tears}} Lágrimas +0.2#↑ {{Range}} Alcance +0.25#↑ {{Tearsize}} Tamaño de lágrimas +0.5"},
	...
	{"106", "Sr. Mega", "↑ {{Bomb}} +5 Bombas#↑ x2,25 el daño de bomba"},
	...
	{"137", "Detonador remoto", "↑ {{Bomb}} +5 Bombas#Detona bombas al gusto"},
	{"138", "Estigma", "↑ {{Heart}} +1 de Vida#↑ {{Damage}} Daño +0.3"},
	{"139", "Bolso de Mamá", "Puedes tener 2 trinkets"},
	{"140", "Maldición de Bob", "↑ {{Bomb}} +5 Bombas#Bombas venenosas"},
	...
	{"182", "Sagrado corazón", "↑ {{Heart}} +1 de Vida#↑ {{Damage}} Multiplicador de daño del 230%#↑ {{Damage}} Daño +1#↑ {{Range}} Alcance +4.125#↓ {{Tears}} Lágrimas -0.4#↓ {{Shotspeed}} Vel. de tiro -25%#{{HealingRed}} Vida al completo#Lágrimas teledirigidas"},
	{"183", "Mondadientes", "↑ {{Tears}} Lágrimas +0.7 de lágrimas#↑ {{Shotspeed}} Vel. de tiro +0.16"},
	{"184", "Santo Grial", "↑ {{Heart}} +1 de Vida#Permite volar"},
	...
	{"189", "Súper Fan de SMB", "↑ {{Heart}} +1 de Vida#↑{{Speed}} Velocidad +0.2#↑ {{Range}} Alcance +0.5#↑ {{Tears}} Lágrimas +0.2#↑ {{Damage}} Daño +0.3#↑ {{Tearsize}} Tamaño de lágrimas +1.0#{{HealingRed}} Vida al completo"},
	...
	{"209", "Bombas de Trasero", "↑ {{Bomb}} +5 Bombas#Las explosiones aturden y dañan a todos los enemigos de la habitación"},
	...
	{"223", "Piromaníaco", "↑ {{Bomb}} +5 Bombas#{{HealingRed}} Ser golpeado por explosiones cura 1 corazón"},
	...
	{"253", "Costra mágica", "↑ +1 de suerte#↑ {{Heart}} +1 de Vida"},
	...
	{"256", "Bombas Ardientes", "↑ {{Bomb}} +5 Bombas#{{Burning}} Las bombas queman"},
	...
	{"270", "Sanguijuela", "Persigue enemigos#{{HealingRed}} Cura a Isaac medio corazón cuando mata a un enemigo#Hace 3.2 de daño cada segundo"},
	...
	{"307", "Capricornio", "↑ {{Heart}} +1 de Vida#↑ {{Speed}} +0,1 Velocidad#↑ {{Tears}} +0,50 Lágrimas#↑ {{Damage}} +0,5 Daño#↑ {{Range}} +1,5 Alcance#+1 {{Coin}} moneda, {{Bomb}} bomba y {{Key}} llave"},
	...
	{"312", "Moño de Maggy", "↑ {{Heart}} +1 de Vida#{{HealingRed}} Cura 1 corazón#Todos los corazones rojos curarán 2 contenedores"},
	...
	{"353", "Bomber Boy", "↑ {{Bomb}} +5 Bombas#Las bombas explotan en forma de cruz"},
	...
	{"366", "Bombas de dispersión", "↑ {{Bomb}} +5 Bombas#Hace que las bombas exploten en 2-4 bombas pequeñas"},
	{"367", "Bombas Pegajosas", "↑ {{Bomb}} +5 Bombas#Cuando la bomba mata un enemigo, genera una araña azul#Hace que las bombas se peguen a los enemigos"},
	...
	{"428", "Pijama", "+4 corazones de alma#{{HealingRed}} Vida al completo"},
	...
	{"432", "Bombas Brillantes", "↑ {{Bomb}} +5 Bombas#Las bombas pueden generar recolectables aleatorios al explotar (llaves, monedas, bombas)"},
	...
	{"456", "Bocadillo nocturno", "↑ {{Heart}} +1 de Vida"},
...
EID.descriptions[languageCode].trinkets={
	...
	{"8", "Cartucho", "{{Timer}} 5% de probabilidad al recibir daño de recibir por 6,5 segundos:#Invincibilidad#Isaac no puede disparar pero hace 40 de daño por contacto cada segundo#{{HealingRed}} Matar 2 enemigos cura medio corazón#{{Fear}} Asusta a todos los enemigos en la habitación"},
	...
	{"46", "Tenedor de Isaac", "{{HealingRed}} Limpiar una habitación tiene una probabilidad del 10% de curar medio corazón#{{Luck}} 100% de probabilidad con 18 de suerte"},
	{"47", "", "<unused>"},
	...
	{"53", "La garrapata", "{{HealingRed}} Cura 1 corazón al entrar a una {{BossRoom}} Sala de Jefe#El jefe empieza con -15% de vida#{{Warning}} Al ser recogido, no puede ser quitado#Solo es quitable con {{Trinket41}} la Cerilla o tragándotelo"},
	...
	{"85", "Karma", "{{DonationMachine}} Usar una Máquina de Donación tiene una probabilidad del 33% de:#{{HealingRed}} Curar 1 corazón (40%)#{{Coin}} Otorgar 1 moneda (40%)#{{Luck}} Otorgar +1 de suerte (15%)#{{Beggar}} Generar un Mendigo (5%)"},
	{"86", "Pequeña larva", "Romper una caca genera una mosca azul"},
	{"87", "Medallón de Mamá", "{{HealingRed}} Cura medio corazón al usar llaves#{{Heart}} Los medios corazones aparecen como corazones enteros"},
	...
	{"119", "Célula madre", "{{HealingRed}} Cura medio corazón al cambiar de piso"},
...
EID.descriptions[languageCode].cards={
	...
	{"20", "XIX - El Sol", "{{HealingRed}} Vida al completo#Inflige 100 de daño a todos los enemigos#Muestra el mapa completo (excepto la {{SuperSecretRoom}} Sala Super Secreta)"},
	...
	{"26", "2 de corazones", "{{HealingRed}} Duplica el número de Corazones Rojos de Isaac {{ColorSilver}}(No los contenedores){{CR}}"},
...
EID.descriptions[languageCode].pills={
	...
	{"36", "Píldora de visión", "{{Timer}} Recibes por 6,5 segundos:#Invincibilidad#Isaac no puede disparar pero hace 40 de daño por contacto cada segundo#{{HealingRed}} Matar 2 enemigos cura medio corazón#{{Fear}} Asusta a todos los enemigos en la habitación"},
	...
	{"45", "¡Es como si caminara sobre el sol!", "{{Timer}} Recibes por 6 segundos:#Invincibilidad#Isaac no puede disparar (Sin daño por contacto)"},
