...
EID.descriptions[languageCode].collectibles={
	...
	{"259", "Materia oscura", "↑ {{DamageAB}} Daño +1#{{Fear}} Las lágrimas asustan a los enemigos"},
	{"260", "Vela negra", "{{CurseCursed}} Inmune a las maldiciones#↑ {{BlackHeart}} +1 corazón negro#{{DevilChanceAB}}/{{AngelChanceAB}} Más probabilidad de que aparezcan las salas del Diablo o del Ángel"},
	...
	{"293", "Cabeza de Krampus", "{{Collectible118}} Dispara un rayo de Azufre en las 4 direcciones"},
	...
	{"306", "Sagitario", "↑ {{SpeedAB}} Velocidad +0.2#Lágrimas penetrantes"},
	...
	{"310", "Rímel de Eva", "↓ {{TearsAB}} Menos lágrimas#↓ {{ShotspeedAB}} Vel. de tiro -0.5#↑ {{DamageAB}} Daño x2"},
	...
	{"331", "Divinidad", "Lágrimas teledirigidas#↑ {{RangeAB}} Alcance +1.2#↓ {{TearsAB}} Lágrimas -0.3#↓{{ShotspeedAB}} Vel. de tiro -30%#↑ {{DamageAB}} Daño +0.5#↑ {{TearsizeAB}} Tamaño de lágrimas +0.8#Las lágrimas adquieren un aura que hace tu daño al 30%"},
	...
	{"339", "El Gancho", "↑ {{RangeAB}} Alcance +5.25#↑ {{ShotspeedAB}} Vel. de tiro +0.16#↑ {{BlackHeart}} +1 corazón negro#↑ {{TearsizeAB}} Tamaño de lágrimas +0.5"},
