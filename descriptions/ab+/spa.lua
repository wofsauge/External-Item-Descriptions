...
EID.descriptions[languageCode].collectibles={
	...
	{"33", "La Biblia", "{{Timer}} Permite volar en la habitación actual#Mata el Pie de Mamá y el Corazón de Mamá instantaneamente#{{Warning}} Te mata al usarlo contra Satán"}, -- The Bible
	...
	{"58", "Libro de las Sombras", "{{Timer}} Otorga un escudo de invencibilidad durante 10 segundos"}, -- Book of Shadows
	...
	{"81", "Gato muerto", "↑ +9 Vidas#Reaparece con 1 contenedor de corazón tras morir#{{Warning}} Establece en 1 tus contenedores de corazón al recogerlo"}, -- Dead Cat
	...
	{"157", "Lujuria de Sangre", "↑ {{Damage}} Aumenta tu daño hasta 6 veces al recibir daño#La bonificación se reinicia al pasar a un nuevo piso"}, -- Bloody Lust
	...
	{"175", "Llave de Papá", "Abre todas las puertas en la habitación actual#Puede abrir las {{SecretRoom}}{{SuperSecretRoom}}Habitaciónes Secretas, {{ChallengeRoom}}{{BossRushRoom}}Salas de Desafio y la puerta de Mega Satán"}, -- Dad's Key
	...
	{"240", "Tratamiento experimental", "↑ Aumenta 4 estadísticas aleatorias#↓ Disminuye 2 estadísticas aleatorias"}, -- Experimental Treatment
	...
	{"296", "Conversor", "{{Heart}} Convierte 2 Corazones Negros/de Alma en un Contenedor de corazón"}, -- Converter
	...
	{"336", "Cebolla Muerta", "↑ {{Range}} Alcance +0.25#↑ {{Tearsize}} Tamaño de lágrima x1.5#↓ {{Tearsize}} Tamaño de lágrima -0.5#↓ {{Shotspeed}} Vel. de lágrimas -0.4#Lágrimas perforantes y espectrales"},
	...
	{"425", "Luz Nocturna", "{{Slow}} Genera un cono de luz ralentizante en frente del jugador#Ralentiza a los enemigos y proyectiles"}, -- Night Light
	...
	{"461", "Parasitoide", "15% de probabilidad de disparar sacos de huevos#{{Luck}} 50% de probabilidad con 5 de suerte#{{Slow}} Genera un fluido ralentizante y una mosca o araña azul al impacto"}, -- Parasitoid
	...
	{"483", "¡Mamá Mega!", "Afecta a todoa la planta#Destruye todos los obstaculos de la habitación#Inflige 200 de daño a todos los enemigos#{{SecretRoom}}/{{SuperSecretRoom}} Abre las habitaciónes secretas y súper secretas#Abre la Boss rush/puerta de Hush sin importar el tiempo"}, -- Mama Mega!
...
EID.descriptions[languageCode].trinkets={
	...
	{"41", "Fósforo", "{{Bomb}} 10% de probabilidad de que la recompensa de la sala sea una bomba#{{Bomb}} 33% de probabilidad de obtener bombas extra de los cofres, las rocas marcadas y las máquinas destruidas#{{Warning}} Remueve {{Trinket53}} la garrapata"}, -- Match Stick
	{"42", "Dedo de la Suerte", "↑ {{Luck}} Suerte +1"},
	{"43", "Cráneo maldito", "Al recibir daño estando a medio corazón, serás teletransportado a una habitación aleatoria"}, -- Cursed Skull
	{"44", "Tapa de Seguridad", "{{Pill}} 10% de probabilidad de que la recompensa de la sala sea una pildora#{{Pill}} 33% de probabilidad de obtener pildoras extra de los cofres, las rocas marcadas y las máquinas destruidas"}, -- Safety Cap
	{"45", "As de Espadas", "{{Card}} 10% de probabilidad de que la recompensa de la sala sea una carta#{{Card}} 33% de probabilidad de obtener cartas extra de los cofres, las rocas marcadas y las máquinas destruidas"}, -- Ace of Spades
	...
	{"52", "Moneda Falsificada", "{{Coin}} 50% de probabilidad de duplicar el valor de las monedas al recogerlas"}, -- Counterfeit Penny
	...
	{"57", "Alma de ???", "Familiar que rebota por la habitación#Dispara en la misma dirección que el jugador#Inflige 3.5 de daño"}, -- ???'s Soul
	...
	{"62", "Rocas brillantes", "Las rocas marcadas y de trampilla brillan cada 10 segundos"}, -- Shiny Rock
	...
	{"65", "Gusano Estirado", "↑ {{Range}} Alcance x2#↓ {{Tearsize}} Tamaño de lágrima x0.5"}, -- Tape Worm
	{"66", "Gusano Perezoso", "↑ {{Range}} Alcance +4#↑ {{Tearsize}} Tamaño de lágrima +2#↓ {{Shotspeed}} Vel. de lágrimas -0.4#"}, -- Lazy Worm
	{"67", "Dado Roto", "Recibir daño tiene un 50% de probabilidad de activar uno de los siguientes efectos:#{{Collectible105}} D6#{{Collectible406}} D8#{{Collectible386}} D12 #{{Collectible166}} D20"},
	...
	{"72", "Batería de Reloj", "{{Battery}} 6.66% de probabilidad de reemplazar la recompensa de la habitación por una batería#{{Battery}} +10% de probabilidad de que los recolectables sean baterías#{{Battery}} 5% de probabilidad de añadir una carga al objeto activo al limpiar una habitación"}, -- Watch Battery
	{"73", "Detonador", "{{Bomb}} 10% de probabilidad de que las explosiones generen bombas recolectables"}, -- Blasting Cap
	...
	{"76", "Ficha de póker", "Al abrir un cofre:#↑ 50% de probabilidad de conseguir más recolectables#↓ 50% de probabilidad de generar una mosca azul"}, -- Poker Chip
	{"77", "Ampolla", "Aumenta el empuje"}, -- Blister
	{"78", "Segunda mano", "Duplica la duración de efectos en los enemigos"}, -- Second Hand
	...
	{"82", "Herradura de oro", "{{TreasureRoom}} +15% de posibilidad de obtener dos salas del tesoro en el siguiente piso"}, -- Golden Horse Shoe
	...
	{"85", "Karma", "{{DonationMachine}} 33% de probabilidad al usar una Máquina de Donación de:#{{HealingRed}} Curar 1 corazón (40%)#{{Coin}} Generar 1 moneda (40%)#{{Luck}} +1 de Suerte (15%)#{{Beggar}} Generar un Mendigo (5%)"}, -- Karma
	...
	{"90", "Detonador café", "La caca explota al ser destruida, infligiendo 100 de daño"}, -- Brown Cap
	...
	{"92", "Corona Quebrada", "↑ {{Tears}} Lágrimas +0.2#↑ Multiplica las estadisticas x1.33 si se encuentran por encima del valor base"}, -- Cracked Crown
	{"93", "Pañal usado", "15% de probabilidad por habitación de volver amistosas a todas las moscas enemigas"}, -- Used Diaper
	{"94", "Cola de pescado", "Duplica todas las moscas azules y arañas generadas"}, -- Fish Tail
	{"95", "Diente negro", "{{Poison}} 3% de probabilidad de disparar un diente negro venenoso#Los dientes infligen el doble de tu daño"}, -- Black Tooth
	{"96", "Gusano Ouroboros", "↑ {{Range}} +4 de Alcance#↑ {{Tearsize}} Tamaño de lágrima +2#Lágrimas espectrales#Probabilidad de disparar lágrimas teledirigidas#{{Luck}} 100% de probabilidad con 9 de suerte#Las lágrimas se mueven rapidamente en espiral"}, -- Ouroboros Worm
	{"97", "Angina", "Recibir daño 12-20 veces genera un familiar que bloquea proyectiles#Limite de 2 familiares"}, -- Tonsil
	{"98", "Duende de Naríz", "10% de probabilidad de disparar lágrimas de moco teledirigidas#{{Damage}} Los mocos infligen tu daño una vez cada segundo#Los mocos se pegan durante 60 segundos"}, -- Nose Goblin
	{"99", "Super Bola", "10% de probabilidad de disparar lágrimas que rebotan"}, -- Super Ball
	{"100", "Bombilla Vibrante", "Otorga al tener un objeto activo cargado:#↑ {{Speed}} Velocidad +0.25#↑ {{Tears}} Lágrimas +0.2#↑ {{Damage}} Daño +0.5#↑ {{Range}} Alcance +0.75#↑ {{Shotspeed}} Vel. de lágrimas +0.1#↑ {{Luck}} +1 de Suerte"}, -- Vibrant Bulb
	{"101", "Bombilla Muerta", "Otorga al tener un objeto activo descargado:#↑ {{Speed}} Velocidad +0.5#↑ {{Tears}} Lágrimas +0.4#↑ {{Damage}} Daño +1.5#↑ {{Range}} Alcance +1.5#↑ {{Shotspeed}} Vel. de lágrimas +0.3#↑ {{Luck}} +2 de Suerte"}, -- Dim Bulb
	...
	{"106", "Corcho Perdido", "Aumenta el radio del rastro de fluido producido por el jugador"}, -- Lost Cork
	{"107", "Corazón de cuervo", "Los corazones rojos recibien el daño antes que los de alma o negros#No reduce tu probabilidad de obtener pactos del Diablo/Ángel"},
	...
	{"109", "Cinta adhesiva", "Hace que los familiares dejen de moverse"}, -- Duct Tape
	{"110", "Dólar de Plata", "{{Shop}} Las tiendas aparecerán en el Útero"}, -- Silver Dollar
	{"111", "Corona sangrienta", "{{TreasureRoom}} Las Salas del Tesoro aparecerán en el Útero"},
	...
	{"113", "Langosta de Guerra", "Genera una langosta explosiva al entrar a una habitación hostil#La langosta inflige el doble de tu daño + la explosión"}, -- Locust of War
	{"114", "Langosta de Pestilencia", "{{Poison}} Genera una langosta venenosa al entrar a una habitación hostil#La langosta inflige el doble de tu daño"}, -- Locust of Pestilence
	{"115", "Langosta de Hambruna", "{{Slow}} Genera una langosta que ralentiza al entrar a una habitación hostil#La langosta inflige el doble de tu daño"}, -- Locust of Famine
	{"116", "Langosta de Muerte", "Genera una langosta al entrar a una habitación hostil#La langosta inflige cuatro veces tu daño"}, -- Locust of Death
	...
	{"119", "Célula madre", "{{HealingRed}} Entrar a un nuevo piso cura medio corazón"}, -- Stem Cell
	{"120", "Horquilla", "{{Battery}} Recarga tu objeto activo por completo al entrar a una sala del jefe"},-- Hairpin
	{"121", "Cruz de madera", "{{Collectible313}} Te protege del primer daño recibido en cada planta"}, -- Wooden Cross
	{"122", "Mantequilla", "Usar tu objeto activo lo suelta en un pedestal#2% de probabilidad de soltar uno de tus objetos pasivos al recibir daño"}, -- Butter!
	{"123", "Pluma de filigrana", "Los ángeles soltarán objetos de ángel en lugar de piezas de llave"}, -- Filigree Feather
	{"124", "Tope de puerta", "La última puerta usada se mantendrá abierta"}, -- Door Stop
	{"125", "Cable de Extensión", "Conecta a los familiares con rayos de electricidad#La electricidad inflige 6 de daño"}, -- Extension Cord
	{"126", "Moneda Podrida", "Genera una mosca azul al recoger una moneda"}, -- Rotten Penny
	{"127", "Bebé Doblador", "Otorga lágrimas teledirigidas a todos tus familiares"}, -- Baby-Bender
	{"128", "Hueso del Dedo", "{{EmptyBoneHeart}} 2% de probabilidad de soltar un corazón de hueso al recibir daño"}, -- Finger Bone
}
...
EID.descriptions[languageCode].cards={
	...
	{"19", "XVIII - La Luna", "{{SecretRoom}} Teletransporta a la habitación secreta"},
...
EID.descriptions[languageCode].pills={
	...
	{"3", "Las bombas son llaves", "Cambia el número de {{Bomb}} bombas por el de {{Key}} llaves"},
	...
	{"19", "¡Teletransporta!", "Te teletransporta a una habitación aleatoria"},
	...
	{"22", "Parálisis", "Congelado!#No puedes moverte ni disparar por 2 segundos"},
	{"23", "¡Puedo ver para siempre!", "{{SecretRoom}} Abre las entradas de las habitaciones secretas del nivel actual"},
	{"24", "Feromonas", "{{Charm}} Encanta a todos los enemigos en la habitación"},
	{"25", "Amnesia", "{{CurseLost}} Oculta el mapa"},
	{"26", "Fiesta de limonada", "Genera un charco que daña a los enemigos"},
	{"27", "¿Eres un mago?", "{{Timer}}Isaac dispara en diagonal durante 60 segundos "},
	{"28", "¡Percs!", "{{Timer}} Solo recibes la mitad del daño en la habitación actual"},
	{"29", "¡Adicto!", "{{Timer}} Incrementa el daño recibido a un corazón en la habitación actual"},
	{"30", "Relaxante", "Isaac genera una caca al andar durante 2 segundos"},
	{"31", "¿¿??", "{{CurseMaze}} Maldición del Laberinto durante todo el nivel"},
	{"32", "Una te hace grande", "Te hace mas grande#No afecta a la hitbox"},
	...
	{"35", "¿Infestado?", "Genera 1 araña azul por cada enemigo de la habitación#Genera 1-3 arañas cuando no hay enemigos"},
	{"36", "Píldora de visión", "{{Timer}} Otorga durante 6.5 segundos:#Invencibilidad#Isaac no puede disparar pero hace 40 de daño por contacto cada segundo#{{HealingRed}} Matar 2 enemigos cura medio corazón#{{Fear}} Asusta a todos los enemigos en la habitación"},
	{"37", "¡Visión retro!", "{{Timer}} Pixela la pantalla 3 veces durante 30 segundos"},
	{"38", "¡Amigos hasta el fin!", "Invoca 3 moscas aliadas"},
	{"39", "X-Lax", "Genera una piscina de fluido resbaladizo"},
	{"40", "Hay algo mal", "{{Slow}} Genera una piscina de fluido ralentizante"},
	{"41", "Tengo mucho sueño...", "{{Slow}} Ralentiza a todos los enemigos de la habitación"},
	...
	{"45", "¡Es como si caminara sobre el sol!", "{{Timer}} Otorga durante 6 segundos:#Invencibilidad#Isaac no puede disparar (Sin daño por contacto)"},
...
EID.descriptions[languageCode].ConditionalDescs = {
	...
	["No Red"] = "Ningún efecto en personajes que no pueden tener Corazones rojos",
	...
	------ ACHIEVEMENT CHECKS ------
	["5.350.23"] = "{{Warning}} Morir en una {{SacrificeRoom}} Sala del Sacrificio al tener este trinket desbloquea a El Perdido", -- Missing Poster (Unlock The Lost)
	...
	["Bulb Zero"] = "Los objetos activos con 0 cargas maximo activan el efecto", -- Vibrant/Dim Bulb + zero charge actives
