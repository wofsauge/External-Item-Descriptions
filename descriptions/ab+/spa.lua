...
EID.descriptions[languageCode].collectibles={
	...
	{"114", "Cuchillo de Mamá", "{{Chargeable}} Cargable#Cuchillo controlable#{{Damage}} El daño varía dependiendo de la distancia a la que se lance#{{DamageAB}} Daño al contacto (sin lanzarlo) x2#{{DamageAB}} Daño x6 al recorrer su máxima distancia"},
...
EID.descriptions[languageCode].trinkets={
	...
	{"27", "Gusano látigo", "↑ {{ShotspeedAB}} Vel. de tiro +0.5"},
	...
	{"42", "Pulgar de la suerte", "↑ {{LuckAB}} Suerte +1"},
	...
	{"92", "Corona rota", "↑ Las estadísticas basadas en objetos de Isaac son un 33 % más efectivas#↑ +0,2 de lágrimas"},
	...
	{"111", "Corona sangrienta", "{{TreasureRoom}} Ahora aparecen salas del tesoro en el Útero de Mamá"},
...
EID.descriptions[languageCode].cards={
	...
	{"10", "IX - El Ermitaño", "{{Shop}} Teletransporta a la tienda"},
	...
	{"37", "Perthro", "{{Collectible105}} Cambia los objetos coleccionables"},
...
EID.descriptions[languageCode].pills={
	...
	{"31", "¿¿??", "{{CurseMaze}} Maldición del Laberinto en la planta actual"},
