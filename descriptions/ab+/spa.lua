...
EID.descriptions[languageCode].trinkets={
	...
	{"8", "Cartucho", "{{Collectibe93}} Probabilidad de activar el efecto de The Gamekid al recibir daño"},
	...
	{"59", "Ojo de Caín", "{{Collectibe21}} 25% de posibilidad de revelar los iconos del mapa al empezar una nueva planta"},
...
EID.descriptions[languageCode].cards={
	...
	{"22", "XXI - El Mundo", "{{Collectibe54}} Muestra el mapa completo y {{Collectible21}} los tipos de habitación"},
