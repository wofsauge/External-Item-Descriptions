...
EID.descriptions[languageCode].collectibles={
	...
	{"149", "Ipecac", "Lágrimas explosivas#{{Poison}} Lágrimas venenosas#↓ {{TearsAB}} Lágrimas -66% aproximadamente#↑ {{DamageAB}} Daño +40"},
	...
	{"157", "Lujuria de Sangre", "↑ {{DamageAB}} Más daño cuando te golpean#Se aplica hasta 6 veces en cada planta#Dura toda la planta"},
	...
	{"201", "Barra de hierro", "↑ {{DamageAB}} Daño +0.3#{{Confusion}} Posibilidad de aturdir a los enemigos"},
	...
	{"232", "Cronómetro", "{{Slow}} Ralentiza automáticamente (se activa por primera vez cuando te golpean)#↑ {{SpeedAB}} Velocidad +0.3"},
	{"233", "Mini-Planeta", "Las lágrimas orbitan a tu alrededor#↑ {{TearsizeAB}} Tamaño de lágrima +7.0#Lágrimas espectrales"},
	...
	{"237", "Toque de la Muerte", "¡Dispara guadañas!#↑ {{DamageAB}} Daño +1.5#↓ {{TearsAB}} Lágrimas -0.3#Lágrimas penetrantes"},
	...
	{"399", "Fauces del Vacío", "{{Chargeable}} Cargable#↑ {{DamageAB}} Daño +1.0#Tras disparar lágrimas durante 3 segundos, crea un anillo negro que daña a los enemigos que están dentro de él#{{BlackHeart}} Los enemigos asesinados con el anillo negro pueden generar corazones negros"},
