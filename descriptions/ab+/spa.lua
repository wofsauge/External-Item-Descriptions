...
EID.descriptions[languageCode].collectibles={
	...
	{"46", "Pie de la suerte", "↑ {{Luck}} Suerte +1.0#Más probabilidad de ganar al apostar#Aumenta las posibilidades de que caiga un recolectable al limpiar una habitación#Cambia todas píldoras malas por buenas"},
	...
	{"309", "Piscis", "↑ {{Tears}} Más lagrimas#Lágrimas con empuje"},
...
EID.descriptions[languageCode].trinkets={
	...
	{"35", "Cuerno torcido", "↑ {{Damage}} Daño +2"},
