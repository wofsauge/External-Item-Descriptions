...
EID.descriptions[languageCode].collectibles={
	{"1", "눈물나는 양파", "↑ {{TearsSmall}}연사 +0.7"}, -- The Sad Onion
	...
	{"5", "거울상", "↑ {{RangeSmall}}사거리 +1.5#↑ 눈물 높이 +1#↑ {{ShotspeedSmall}}탄속 +0.6#공격이 캐릭터가 있는 방향으로 되돌아옵니다."}, -- My Reflection
	{"6", "오줌싸개", "↑ {{TearsSmall}}연사 +1.5#↓ {{RangeSmall}}사거리 -17.62#↑ 눈물 높이 +0.76"}, -- Number One
	{"7", "순교자의 피", "↑ {{DamageSmall}}공격력 +1#{{Collectible34}} Book of the Belial#{{Card16}} 혹은 The Devil 효과가 발동 중인 경우:#↑ {{DamageSmall}}공격력 배율 x1.5"}, -- Blood of the Martyr
	...
	{"12", "마법의 버섯", "↑ {{Heart}}최대 체력 +1#{{Heart}} 체력을 모두 회복합니다.#↑ {{DamageSmall}}공격력 +0.5#↑ {{DamageSmall}}공격력 배율 x1.5#↑ {{RangeSmall}}사거리 +5.25#↑ 눈물 높이 +0.5#↑ {{SpeedSmall}}이동속도 +0.3#캐릭터의 크기가 커집니다."}, -- Magic Mushroom // 요술 버섯
	{"13", "바이러스", "↓ {{SpeedSmall}}이동속도 -0.1#{{Poison}} 적에게 접촉시 적에게 12의 피해를 주고 적을 중독시킵니다.#중독된 적이 죽을시 20% 확률로 {{BlackHeart}}블랙하트가 드랍됩니다."}, -- The Virus
	...
	{"34", "벨리알의 서", "사용 시 그 방에서 {{DamageSmall}}공격력 +2 증가하며 {{Collectible7}}Blood of the Martyr 소지 시 {{DamageSmall}}공격력 배율 x1.5 추가 적용#소지중일 때 {{DevilChanceSmall}}악마방 확률 +12.5%"}, -- The Book of Belial
	{"35", "네크로노미콘", "사용 시 방 전체 적에게 40의 피해를 줍니다."}, -- The Necronomicon
	{"36", "응아", "사용 시 똥을 쌉니다."}, -- The Poop
	...
	{"45", "맛있는 심장", "{{Heart}}사용 시 체력 1칸을 회복합니다."}, -- Yum Heart
	...
	{"52", "태아 박사", "↓ {{TearsSmall}}공격 딜레이 x2.5#공격이 폭탄 발사 공격으로 변경됩니다.#폭탄 공격력: x5 +30"}, -- Dr. Fetus
	{"53", "자석", "픽업 아이템이 캐릭터에게 끌려옵니다."}, -- Magneto
	{"54", "보물 지도", "맵에 스테이지 구조를 표시합니다."}, -- Treasure Map
	{"55", "엄마의 눈알", "50%의 확률로 캐릭터의 뒤에서 공격이 나갑니다.#!!! {{LuckSmall}}행운 수치 비례: 행운 2 이상일 때 100% 확률"}, -- Mom's Eye
	{"56", "레몬빛 사고", "사용 시 캐릭터의 주위에 노란 장판이 생성되며 장판에 닿은 적은 초당 24의 피해를 입습니다."}, -- Lemon Mishap
	{"57", "짝사랑", "캐릭터 주위를 돌며 접촉하는 적에게 초당 75의 피해를 입힙니다."}, -- Distant Admiration
	{"58", "그림자의 서", "사용 시 10초간 무적 상태가 됩니다."}, -- Book of Shadows
	...
	{"62", "흡혈귀의 부적", "적 13기 처치 시 {{HalfHeart}}체력을 0.5칸 회복합니다."}, -- Charm of the Vampire
	...
	{"69", "초코 우유", "↓ {{TearsSmall}}공격 딜레이 x2.5#{{Chargeable}} 눈물을 충전하며 발사합니다. #충전 상태에 따라 공격력 배율이 x0.1 ~ x4로 증감합니다."}, -- Chocolate Milk
	...
	{"73", "고기조각", "획득할 때마다 성장합니다.#1단계: 캐릭터 주위를 돌며 적의 탄환을 막아줍니다.#2단계: 1단계 + 공격하는 방향으로 공격력 3.5의 눈물을 발사합니다.#3단계: 적을 따라다니며 접촉한 적에게 초당 7의 피해를 입힙니다.#4단계: 적을 따라다니며 접촉한 적에게 초당 11의 피해를 입힙니다."}, -- Cube of Meat
	...
	{"77", "나의 작은 유니콘", "사용 시 6초간 무적 상태가 되며 접촉한 적에게 초당 40의 피해를 입힙니다."}, -- My Little Unicorn
	{"78", "요한묵시록", "사용 시 {{SoulHeart}}소울하트 +1#가능한 경우, 현재 층의 보스를 4기사로 교체합니다.#소지중일 때 {{DevilChanceSmall}}악마방 확률 +17.5%"}, -- Book of Revelations
	...
	{"84", "아래로 내려가자!", "사용 시 다음 스테이지로 가는 다락문을 생성합니다.#10%의 확률로 {{LadderRoom}}사다리방으로 가는 다락문을 생성합니다."}, -- We Need To Go Deeper!
	{"85", "카드 덱", "사용 시 {{Card}}카드를 하나 드랍합니다."}, -- Deck of Cards
	{"86", "몬스트로의 이빨", "사용 시 몬스트로가 랜덤한 적에게 떨어져 120의 피해를 입힙니다."}, -- Monstro's Tooth
	{"87", "로키의 뿔", "25%의 확률로 공격이 4방향으로 나갑니다.#!!! {{LuckSmall}}행운 수치 비례: 행운 7 이상일 때 100% 확률"}, -- Loki's Horns
	{"88", "리틀 처비", "공격하는 방향으로 돌진해 접촉하는 적에게 초당 52.5의 피해를 입힙니다."}, -- Little Chubby
	{"89", "거미물림", "{{Slow}} 25%의 확률로 적을 둔화시키는 공격이 나갑니다.#!!! {{LuckSmall}}행운 수치 비례: 행운 15 이상일 때 100% 확률"}, -- Spider Bite // 물어버리는 거미
	{"90", "돌멩이", "↑ {{DamageSmall}}공격력 +1#↑ {{TearsSmall}}연사 +0.2#↓ {{SpeedSmall}}이동속도 -0.2"}, -- The Small Rock
	{"91", "탐험가 모자", "캐릭터가 있는 방에 인접한 곳에 있는 특수방을 맵에 표시합니다."}, -- Spelunker Hat // 광부 모자
	{"92", "슈퍼 밴디지", "↑ {{Heart}}최대 체력 +1#↑ {{SoulHeart}}소울하트 +2"}, -- Super Bandage
	{"93", "게임키드", "사용 시 6초간 무적 상태가 되며 접촉한 적에게 초당 40의 피해를 입힙니다.#{{Fear}} 적들이 아이작에게서 도망가며 적 2기를 죽일 때마다 {{HalfHeart}}체력을 반 칸 회복합니다."}, -- The Gamekid
	...
	{"97", "죄악의 서", "사용 시 랜덤한 픽업 아이템을 드랍합니다."}, -- The Book of Sin
	...
	{"103", "감기", "{{Poison}} 25%의 확률로 적을 중독시키는 공격이 나갑니다.#!!! {{LuckSmall}}행운 수치 비례: 행운 12 이상일 때 100% 확률"}, -- The Common Cold
	{"104", "기생충", "눈물이 무언가에 부딪힐 때마다 양옆으로 갈라집니다.#갈라진 눈물의 공격력은 갈라지기 이전의 절반입니다."}, -- The Parasite // 기생 생물
	...
	{"108", "제병", "캐릭터가 받는 모든 피해가 체력 반칸으로 고정됩니다."}, -- The Wafer // 밀빵
	{"109", "돈 = 힘", "동전 1개당 {{DamageSmall}}공격력 +0.04#{{Blank}} (최대 +3.96)"}, -- Money = Power // 돈의 힘
	{"110", "엄마의 렌즈", "↑ {{RangeSmall}}사거리 +0.25#↑ 눈물 높이 +0.5#20%의 확률로 적을 멈추게 만드는 공격이 나갑니다.#!!! {{LuckSmall}}행운 수치 비례: 행운 20 이상일 때 50% 확률"}, -- Mom's Contacts
	...
	{"116", "9볼트 건전지", "획득 시 액티브 아이템 충전량을 모두 충전합니다.#액티브 아이템 사용 시 충전량을 한칸 보존합니다.#1칸짜리 액티브 아이템의 경우 {{ColorOrange}}적이 있는 방에서{{CR}} 15초의 충전 쿨타임을 가집니다.#충전형 액티브 아이템의 경우 쿨타임의 절반을 보존합니다."}, -- 9 Volt
	...
	{"119", "혈액 팩", "↑ {{Heart}}최대 체력 +1#↑ {{Heart}}빨간하트 +4#↑ {{SpeedSmall}}이동속도 +0.3"}, -- Blood Bag // 혈액 주머니
	{"120", "수상한 버섯", "↓ {{DamageSmall}}공격력 x0.9 -0.4#↑ {{TearsSmall}}연사 +1.7#↑ {{SpeedSmall}}이동속도 +0.3#캐릭터의 머리가 작아집니다."}, -- Odd Mushroom
	{"121", "수상한 버섯", "↑ {{EmptyHeart}}빈 최대 체력 +1#↑ {{DamageSmall}}공격력 +0.3#↑ {{RangeSmall}}사거리 +0.25#↑ 눈물 높이 +0.5#↓ {{SpeedSmall}}이동속도 -0.1#캐릭터의 머리가 커집니다."}, -- Odd Mushroom
	...
	{"127", "잊어줘 알약", "{{Warning}} 일회용 {{Warning}}#스테이지를 재시작합니다."}, -- Forget Me Now
	{"128", "영원한 솔로", "캐릭터 주위를 돌며 접촉하는 적에게 초당 30의 피해를 입힙니다."}, -- Forever alone
	{"129", "돼지기름", "↑ {{EmptyHeart}}빈 최대 체력 +2#↑ {{HalfHeart}}빨간하트 +0.5#↓ {{SpeedSmall}}이동속도 -0.2"}, -- Bucket of Lard
	...
	{"146", "기도자 카드", "사용 시 {{EthernalHeart}}이터널하트 +1"}, -- Prayer Card
	{"147", "각진 곡괭이", "사용 시 그 방의 장애물을 부술 수 있습니다."}, -- Notched Axe
	{"148", "감염", "피격 시 파란 아군 파리를 1~3마리 소환합니다."}, -- Infestation
	{"149", "구토제", "↑ {{DamageSmall}}공격력 +40#↓ {{TearsSmall}}연사 x0.5#폭발하는 독눈물을 곡선형으로 발사합니다."}, -- Ipecac
	{"150", "사랑의 매", "10%의 확률로 공격력 x3.2의 공격이 나갑니다.#!!! {{LuckSmall}}행운 수치 비례: 행운 9 이상일 때 100% 확률"}, -- Tough Love
	{"151", "멀리건", "적 명중 시 1/6 확률로 파란 아군 파리를 소환합니다."}, -- The Mulligan
	{"152", "기계장치 2", "↓ {{DamageSmall}}공격력 배율 x0.65#한쪽 눈에서 공격력 20%의 지속 레이저를 발사합니다."}, -- Technology 2
	{"153", "돌연변이 거미", "↓ {{TearsSmall}}공격 딜레이 x2.1 +3#공격이 4발로 나갑니다."}, -- Mutant Spider
	{"154", "화학 박피제", "한쪽 눈에서 {{DamageSmall}}공격력 +2의 공격을 발사합니다."}, -- Chemical Peel
	{"155", "엿보기 눈깔", "대각선으로 돌아다니며 접촉한 적에게 초당 17.1의 피해를 입힙니다."}, -- The Peeper // 엿보기
	...
	{"162", "켈트 십자가", "피격 시 20%의 확률로 7초간 무적 상태가 됩니다.#!!! {{LuckSmall}}행운 수치 비례: 행운 27 이상일 때 100% 확률"}, -- Celtic Cross
	...
	{"168", "굉장한 태아", "공격이 조준점을 이동시킨 곳으로 발사하는 미사일 공격으로 변경됩니다.#미사일 공격력: x20"}, -- Epic Fetus
	{"169", "폴리페무스", "↑ {{DamageSmall}}공격력 (+4)x2#↓ {{TearsSmall}}공격 딜레이 x2.1 +3#적을 죽인 경우 여분의 공격력을 남긴 채 관통합니다."}, -- Polyphemus
	{"170", "장님거미", "4초마다 다리가 적에게 떨어지며 40의 피해를 입힙니다."}, -- Daddy Longlegs
	{"171", "거미 궁둥이", "{{Slow}} 사용 시 방 안의 모든 적에게 10의 피해를 주고 4초간 둔화시킵니다."}, -- Spider Butt
	{"172", "제례용 단검", "캐릭터 주위를 돌며 적의 탄환을 막아주고 접촉하는 적에게 초당 225의 피해를 입힙니다."}, -- Sacrificial Dagger
	{"173", "주교관", "빨간하트가 드랍될 때 50% 확률로 {{SoulHeart}}소울하트로 바뀝니다."}, -- Mitre // 미트라
	...
	{"181", "흰 조랑말", "소지중일 때 비행 능력을 얻습니다.#{{SpeedSmall}}이동속도가 1.5 이상으로 고정됩니다.#사용 시 바라보는 방향으로 돌진하여 접촉한 적에게 40의 피해를 입히고 5개의 빛줄기를 소환합니다."}, -- White Pony
	...
	{"184", "성배", "↑ {{Heart}}최대 체력 +1#비행 능력을 얻습니다."}, -- Holy Grail
	...
	{"192", "텔레파시 입문서", "사용 시 그 방에서 공격이 적에게 유도됩니다."}, -- Telepathy For Dummies
	...
	{"196", "쥐어짜기", "↑ {{TearsSmall}}연사 +0.4#{{SoulHeart}}소울하트를 2개 드랍합니다."}, -- Squeezy
	{"197", "예수 음료수", "↑ {{DamageSmall}}공격력 +0.5#↑ {{RangeSmall}}사거리 +0.25#↑ 눈물 높이 +0.5"}, -- Jesus Juice
	{"198", "상자", "모든 종류의 픽업 아이템을 하나씩 드랍합니다."}, -- Box
	{"199", "엄마의 열쇠", "↑ {{Key}}열쇠 +2#{{Chest}} 상자를 열 때 드랍되는 픽업 아이템의 수가 증가합니다."}, -- Mom's Key
	{"200", "엄마의 아이섀도우", "{{Charm}} 10%의 확률로 적을 매혹시키는 공격이 나갑니다.#!!! {{LuckSmall}}행운 수치 비례: 행운 27 이상일 때 100% 확률"}, -- Mom's Eyeshadow
	{"201", "철괴", "↑ {{DamageSmall}}공격력 +0.3#{{Confusion}} 10%의 확률로 적을 혼란시키는 공격이 나갑니다.#!!! {{LuckSmall}}행운 수치 비례: 행운 27 이상일 때 100% 확률"}, -- Iron Bar
	{"202", "미다스의 손길", "적에게 접촉시 접촉한 적을 멈추게 만들며 멈춘 적 처치 시 {{Coin}}동전을 1~3개 드랍합니다.#!!! 접촉 대미지 : 소지 동전 수"}, -- Midas' Touch
	{"203", "험블링 번들", "{{Heart}}빨간하트, {{Coin}}동전, {{Bomb}}폭탄, {{Key}}열쇠 픽업이 1+1로 나옵니다."}, -- Humbleing Bundle
	{"204", "주머니 가방", "피격 시 50% 확률로 픽업 아이템을 드랍합니다."}, -- Fanny Pack // 작은 주머니
	{"205", "플러그", "액티브 아이템의 충전량이 없을 때 액티브 아이템 사용 시 체력 두 칸을 깎고 액티브의 충전량을 모두 충전합니다."}, -- Sharp Plug
	{"206", "단두대", "↑ {{DamageSmall}}공격력 +1#↑ {{TearsSmall}}연사 +0.2#머리가 분리되어 몸의 주변을 돌며 적의 탄환을 막아주고 접촉하는 적에게 초당 105의 피해를 입힙니다."}, -- Guillotine
	{"207", "밴드 덩어리", "획득할 때마다 성장합니다.#1단계: 캐릭터 주위를 돌며 적의 탄환을 막아줍니다.#{{Charm}} 2단계: 1단계 상태에서 공격하는 방향으로 공격력 3.5의 매혹 눈물을 발사합니다.#3단계: 적을 따라다니며 접촉한 적에게 초당 7의 피해를 입힙니다. 공격하는 방향으로 공격력 3.5의 매혹 눈물을 발사합니다.#4단계: 적을 따라다니며 접촉한 적에게 초당 11의 피해를 입히며 처치 시 일정 확률로 {{Heart}}빨간하트를 드랍합니다."}, -- Ball of Bandages
	{"208", "챔피언 벨트", "↑ {{DamageSmall}}공격력 +1#!!! 적이 챔피언으로 바뀔 확률 +15%"}, -- Champion Belt
	{"209", "궁둥이 폭탄", "↑ {{Bomb}}폭탄 +5#{{Confusion}} 폭탄이 터질 때 방 안의 모든 적에게 10의 피해를 주고 4초간 혼란시킵니다.#!!! 똥 타입 보스의 체력을 25% 회복시킵니다."}, -- Butt Bombs
	{"210", "벌레 먹은 나뭇잎", "2초간 어떤 키도 입력하지 않을시 무적 상태가 됩니다."}, -- Gnawed Leaf // 벌레 먹은 잎사귀
	...
	{"213", "잃어버린 렌즈", "↓ {{ShotspeedSmall}}탄속 -0.16#공격이 적의 탄환을 막습니다."}, -- Lost Contact
	...
	{"216", "의식용 로브", "↑ {{BlackHeart}}블랙하트 +3#↑ {{DamageSmall}}공격력 +1"}, -- Ceremonial Robes // 의식용 예복
	{"217", "엄마의 가발", "공격 시 일정 확률로 파란 아군 거미를 소환합니다.(최대 5마리)#!!! {{LuckSmall}}행운 수치 비례: 행운 10 이상일 때 100% 확률"}, -- Mom's Wig
	{"218", "태반", "↑ {{Heart}}최대 체력 +1#타이머가 1분 00초가 될 때마다 일정 확률로 {{HalfHeart}}체력 반 칸을 회복합니다."}, -- Placenta
	{"219", "낡은 밴드", "↑ {{EmptyHeart}}빈 최대 체력 +1#피격 시 일정 확률로 {{Heart}}빨간하트를 하나 드랍합니다.#!!! {{LuckSmall}}행운 수치 비례: 행운 29 이상일 때 50% 확률"}, -- Old Bandage
	{"220", "눈물 폭탄", "↑ {{Bomb}}폭탄 +5#폭탄이 터질 때 폭탄 기준 10방향으로 공격력 +25의 눈물을 발사합니다."}, -- Sad Bombs
	{"221", "고무풀", "공격이 무언가에 부딪힐 때 반대 각도로 튕겨져 나갑니다."}, -- Rubber Cement
	{"222", "반중력", "↑ {{TearsSmall}}연사 +0.3#공격키를 누르고 있을 시 눈물이 생성된 장소에서 멈추며 공격키를 떼거나 일정 시간이 지나면 발사됩니다."}, -- Anti-Gravity
	{"223", "폭파광", "↑ {{Bomb}}폭탄 +5#폭발 및 지진파 공격에 피해를 입지 않으며 폭발을 맞으면 {{Heart}}체력을 1칸 회복합니다."}, -- Pyromaniac
	{"224", "크리켓의 몸뚱이", "↑ {{TearsSmall}}연사 +0.2#↓ {{RangeSmall}}사거리 -10#눈물이 무언가에 부딪힐 때 네갈래로 갈라집니다."}, -- Cricket's Body
	{"225", "김피", "적 처치 시 일정 확률로 {{HalfHeart}}빨간하트가 반칸 드랍됩니다.#피격 시 일정 확률로 {{SoulHeart}}소울하트 또는 {{BlackHeart}}블랙하트를 드랍합니다.#!!! {{LuckSmall}}행운 수치 비례: 행운 22 이상일 때 50% 확률"}, -- Gimpy
	...
	{"230", "아바돈", "최대 체력이 모두 제거됩니다.#↑ {{BlackHeart}}블랙하트 +6#↑ {{DamageSmall}}공격력 +1.5#↑ {{SpeedSmall}}이동속도 +0.2#15%의 확률로 적을 {{Fear}}도망가게 하는 공격이 나갑니다.#!!! {{LuckSmall}}행운 수치 비례: 행운 85 이상일 때 100% 확률"}, -- Abaddon
	{"231", "타르 덩어리", "{{Slow}} 캐릭터가 지나간 자리에 검은 장판이 생기며 닿은 적은 느려집니다.#{{Slow}} 10%의 확률로 적을 둔화시키는 공격이 나갑니다.#!!! {{LuckSmall}}행운 수치 비례: 행운 18 이상일 때 100% 확률"}, -- Ball of Tar
	{"232", "스톱워치", "↑ {{SpeedSmall}}이동속도 +0.3#피격 시 방 안의 모든 적들을 영구적으로 둔화시킵니다."}, -- Stop Watch
	...
	{"241", "악마의 계약", "방 클리어 보상이 하나 더 나옵니다.#방 클리어 보상이 33%의 확률로 등장하지 않습니다.#{{Blank}} (중첩 시 보상 개수 증가, 보상 미등장 확률 감소)"}, -- Contract from Below
	...
	{"247", "", "패밀리어들의 공격력이 2배로 증가합니다."}, -- BFFS! // 최고의 친구들!
	{"248", "군체의식", "파란 아군 파리 및 거미의 공격력이 2배로 증가합니다."}, -- Hive Mind
	{"249", "선택권", "{{BossRoom}}보스방 보상 아이템이 2개가 나오며 하나를 선택하면 나머지는 사라집니다."}, -- There's Options
	...
	{"253", "마법의 딱지", "↑ {{Heart}}최대 체력 +1#↑ {{LuckSmall}}행운 +1"}, -- Magic Scab // 요술 딱지
	{"254", "응혈", "한쪽 눈에서 {{DamageSmall}}공격력 +1, {{RangeSmall}}사거리 +5의 공격을 발사합니다."}, -- Blood Clot
	...
	{"265", "말라빠진 아기", "캐릭터를 따라다니며 적의 탄환을 막아줍니다.#{{Collectible35}} 탄환을 막을 시 10% 확률로 방 안의 모든 적에게 40의 피해를 입힙니다."}, -- Dry Baby
	...
	{"271", "신비한 주머니", "방 5~6개 클리어 시 랜덤한 픽업 아이템을 드랍합니다."}, -- Mystery Sack
	...
	{"275", "꼬마 유황", "{{Chargeable}} 공격하는 방향으로 최대 공격력 31.5의 혈사포를 충전하여 발사합니다."}, -- Lil Brimstone // 작은 유황불
	...
	{"280", "눈나 거미", "방 안에 적이 있을 때 랜덤하게 파란 아군 거미를 소환합니다."}, -- Sissy Longlegs // 누님거미
	{"281", "샌드백", "방 안을 돌아다니며 6초 간격으로 적을 유인합니다."}, -- Punching Bag
	{"282", "점프 교본", "사용 시 이동 방향으로 점프합니다."}, -- How to Jump
	...
	{"286", "빈 카드", "사용 시 현재 소지중인 {{Card}}카드 또는 {{Rune}}룬의 효과를 발동합니다."}, -- Blank Card // 백지 카드
	{"287", "비밀의 서", "사용 시 맵에 {{Collectible21}}특수방 위치, {{Collectible246}}비밀방 위치, {{Collectible54}}스테이지 구조 중 하나를 표시합니다."}, -- Book of Secrets
	...
	{"295", "유료 안마기", "사용 시 동전 하나를 소모해 방 안의 모든 적에게 눈물 공격력 x2의 피해를 줍니다."}, -- Magic Fingers
	...
	{"303", "처녀자리", "부정적인 알약 효과가 등장하지 않습니다.#피격 시 일정 확률로 7초간 무적 상태가 됩니다.#!!! {{LuckSmall}}행운 수치 비례: 행운 10 이상일 때 100% 확률"}, -- Virgo
	...
	{"306", "궁수자리", "↑ {{SpeedSmall}}이동속도 +0.2#공격이 적을 관통합니다."}, -- Sagittarius
	{"307", "염소자리", "↑ {{Heart}}최대 체력 +1#↑ {{Coin}}동전, {{Bomb}}폭탄, {{Key}}열쇠 +1#↑ {{DamageSmall}}공격력 +0.5#↑ {{TearsSmall}}연사 +0.2#↑ {{RangeSmall}}사거리 +1.5#↑ {{SpeedSmall}}이동속도 +0.1"}, -- Capricorn
	{"308", "물병자리", "캐릭터가 지나간 자리에 파란 장판이 생기며 닿은 적은 초당 6의 피해를 입습니다."}, -- Aquarius
	{"309", "물고기자리", "↑ {{TearsSmall}}연사 +0.2#공격이 적을 밀쳐냅니다."}, -- Pisces
	...
	{"330", "두유", "↓ {{DamageSmall}}공격력 배율 x0.2#↑ {{TearsSmall}}연사 배율 x4 +2"}, -- Soy Milk
	{"331", "신", "↑ {{DamageSmall}}공격력 +0.5#↓ {{TearsSmall}}연사 -0.3#↑ {{RangeSmall}}사거리 +1.2#↑ 눈물 높이 +0.8#↓ {{ShotspeedSmall}}탄속 -0.3#공격이 적에게 유도됩니다.#눈물에 후광이 생기며 후광에 닿은 적은 초당 공격력의 129%의 피해를 입습니다."}, -- Godhead
	{"332", "나사로의 누더기", "↑ 목숨 +1#{{Player11}} 사망 시 즉시 Lazarus 캐릭터#{{Blank}} (1{{Heart}}/{{DamageSmall}}공격력 배율 x1.2/{{Collectible214}}Anemic)로 부활합니다."}, -- Lazarus' Rags
	{"333", "정신", "맵에 스테이지 구조, 특수방 위치, 비밀방 위치가 표시됩니다."}, -- The Mind
	{"334", "신체", "↑ {{Heart}}최대 체력 +3"}, -- The Body
	{"335", "영혼", "↑ {{SoulHeart}}소울하트 +2#적의 탄환이 캐릭터를 피해갑니다."}, -- The Soul
	{"336", "죽은 양파", "↑ {{RangeSmall}}사거리 +0.25#↓ 눈물 높이 -0.5#↓ {{ShotspeedSmall}}탄속 -0.4#공격이 적과 장애물을 관통합니다."}, -- Dead Onion
	{"337", "고장난 손목시계", "4번째 방마다 방 안의 모든 적이 빨라지거나 느려집니다."}, -- Broken Watch
	...
	{"340", "카페인 정", "↑ {{SpeedSmall}}이동속도 +0.3#{{Pill}}알약을 1개 드랍합니다.#캐릭터의 크기가 작아집니다."}, -- Caffeine Pill
	...
	{"353", "봄버맨", "↑ {{Bomb}}폭탄 +5#폭탄의 범위가 십자방향으로 두칸 증가합니다."}, -- Bomber Boy // 폭탄 소년
	{"354", "식품 완구", "↑ {{Heart}}최대 체력 +1#장신구를 하나 드랍합니다."}, -- Crack Jacks
	{"355", "엄마의 진주", "↑ {{RangeSmall}}사거리 +1.25#↑ 눈물 높이 +0.5#↑ {{LuckSmall}}행운 +1"}, -- Mom's Pearls
	{"356", "자동차 배터리", "액티브 아이템 사용 시 효과가 두번 발동됩니다."}, -- Car Battery
	{"357", "친구 상자", "사용 시 그 방에서 소지중인 패밀리어를 복사합니다.#복사할 수 있는 패밀리어가 없다면 그 방에서 {{Collectible113}}Demon Baby 패밀리어를 소환합니다."}, -- Box of Friends
	{"358", "법사", "공격이 2발로 나가며 각각 대각선으로 나갑니다.#공격이 장애물을 관통합니다."}, -- The Wiz
	{"359", "8인치 대못", "↑ {{DamageSmall}}공격력 +1.5#공격이 적을 밀쳐냅니다."}, -- 8 Inch Nails
	{"360", "인큐버스", "공격하는 방향으로 캐릭터의 공격과 같은 공격을 발사합니다."}, -- Incubus // 악몽
	{"361", "운명의 보상", "공격하는 방향으로 캐릭터의 눈물과 같은 눈물을 발사합니다."}, -- Fate's Reward
	{"362", "꼬마 상자", "방 클리어 시 25% 확률로 픽업 아이템 또는 10% 확률로 장신구를 드랍합니다."}, -- Lil Chest // 작은 상자
	{"363", "맹세한 수호자", "캐릭터 주위를 돌며 적의 탄환을 막아주고 접촉하는 적에게 초당 105의 피해를 입힙니다.#그 방에서 탄환 10회 방어시 {{EthernalHeart}}이터널하트를 하나 드랍합니다."}, -- Sworn Protector // 수호자
	...
	{"370", "돌리 씨", "↑ {{TearsSmall}}연사 +0.7#↑ {{RangeSmall}}사거리 +5.25#↑ 눈물 높이 +0.5#{{Heart}}빨간하트, {{SoulHeart}}소울하트, {{BlackHeart}}블랙하트 중 3개를 랜덤하게 드랍합니다."}, -- Mr. Dolly // 인형 아저씨
	{"371", "탑의 저주", "피격 시 방 안에 트롤폭탄 6개를 생성합니다."}, -- Curse of the Tower // 타워의 저주
	{"372", "충전지 아기", "방안에 적이 있을 때 랜덤으로 배터리를 드랍하거나, 액티브 아이템의 충전량을 한칸 채워주거나, 모든 적을 2초간 석화 상태로 만듭니다."}, -- Charged Baby // 충전완료 아기
	{"373", "명사수의 눈", "눈물이 적에게 명중할 때마다 {{DamageSmall}}공격력이 +25%씩 최대 2배까지 증가합니다.#눈물이 빗나갈 시 일정 확률로 공격력 증가치가 초기화 됩니다."}, -- Dead Eye // 죽은 눈
	{"374", "성스러운 빛", "10%의 확률로 적에게 명중 시 공격력 x4의 빛줄기가 떨어지는 공격이 나갑니다.#!!! {{LuckSmall}}행운 수치 비례: 행운 9 이상일 때 50% 확률"}, -- Holy Light
	...
	{"378", "떵싸개", "공격키를 3초간 누르고 있을시 캐릭터의 자리에 똥폭탄이 생성됩니다."}, -- No. 2
	{"379", "두개의 눈동자", "눈물의 범위가 넓어집니다.#공격이 장애물을 관통합니다."}, -- Pupula Duplex
	{"380", "정액제", "↑ {{Coin}}동전 +5#열쇠를 소모하는 문을 열때 동전을 대신 소모합니다."}, -- Pay To Play
	{"381", "에덴의 축복", "↑ {{TearsSmall}}연사 +0.7#다음 게임에서 랜덤한 아이템을 하나 들고 시작합니다."}, -- Eden's Blessing
	{"382", "친절한 공", "사용 시 공격하는 방향으로 몬스터볼을 던집니다.#몬스터볼에 맞은 적은 포획되며 다음 사용 시 아군 상태로 소환됩니다."}, -- Friendly Ball
	{"383", "눈물 기폭제", "사용 시 방 안의 모든 눈물이 6갈래로 분열합니다."}, -- Tear Detonator
	{"384", "꼬마 거디", "{{Chargeable}} 공격키를 누르고 있는 동안 충전되며 공격키를 떼면 공격했던 방향으로 돌진해 벽에 튕겨다니며 적을 공격합니다."}, -- Lil Gurdy // 리틀 거디
	{"385", "범보", "방 안을 돌아다니며 동전을 먹으며 일정 개수 이상 먹으면 성장합니다.#1단계({{Coin}}~5): X#2단계({{Coin}}6~11): 방 클리어 시 때때로 픽업 아이템을 드랍합니다.#3단계({{Coin}}12~23): 적에게 공격력 3.5의 일정 확률로 맞추면 동전을 드랍하는 눈물을 발사합니다.#4단계({{Coin}}24~): 적을 따라다니며 접촉한 적에게 초당 37.5의 피해를 입히며 {{ColorOrange}}때때로 {{Bomb}}폭탄을 설치합니다.{{CR}}"}, -- Bumbo
	{"386", "12면 주사위", "사용 시 방 안의 모든 장애물을 바꿉니다."}, -- D12
	{"387", "향로", "{{Slow}} 오라를 가지고 캐릭터를 따라다니며 오라 안에 들어온 적과 탄환을 둔화시킵니다."}, -- Censer
	{"388", "열쇠 거지", "방 안을 돌아다니며 열쇠를 먹으며 일정 개수 이상 먹으면 랜덤한 {{Chest}}상자를 드랍합니다."}, -- Key Bum
	...
	{"392", "황도대", "스테이지마다 랜덤한 별자리 아이템의 효과를 가집니다."}, -- Zodiac
	{"393", "악마의 키스", "{{Poison}} 15%의 확률로 적을 중독시키는 공격이 나갑니다.#중독된 적이 죽을때 20% 확률로 {{BlackHeart}}블랙하트가 드랍됩니다."}, -- Serpent's Kiss
	{"394", "조준", "↑ {{TearsSmall}}연사 +0.7#↑ {{RangeSmall}}사거리 +3.15#↑ 눈물 높이 +0.3#조준점을 조종할 수 있으며 자동으로 조준점이 있는 방향을 향해 눈물을 발사합니다."}, -- Marked
	{"395", "기술 X", "{{Chargeable}} 공격이 충전형 레이저 고리 공격으로 변경됩니다.#레이저는 사거리 제한이 없으며 적과 장애물을 관통합니다."}, -- Tech X
	{"396", "심실 절단기", "사용 시 파란 포탈을 생성하고, 다음 사용 시 주황 포탈을 생성합니다.#각 포탈로 입장하면 다른쪽 포탈로 나올 수 있습니다."}, -- Ventricle Razor
	{"397", "조종빔", "↑ {{TearsSmall}}연사 +0.5#↑ {{RangeSmall}}사거리 +5.25#↑ {{ShotspeedSmall}}탄속 +0.16#눈물이 캐릭터가 바라보는 방향의 일직선으로만 나갑니다."}, -- Tractor Beam
	{"398", "신의 살점", "10%의 확률로 적을 작아지게 만드는 공격이 나갑니다.#작아진 적은 밟아 죽일 수 있습니다."}, -- God's Flesh
	{"399", "공허의 구렁텅이", "↑ {{DamageSmall}}공격력 +1#{{Chargeable}} 공격키를 2.5초 이상 누르면 충전되며 공격키를 떼면 캐릭터 주위에 검은 고리가 둘러져 접촉한 적에게 현재 공격력만큼의 피해를 줍니다.#고리로 적 처치 시 5% 확률로 {{BlackHeart}}블랙하트를 드랍합니다."}, -- Maw Of The Void
	{"400", "운명의 창", "캐릭터의 정면에 창이 생기며 창에 닿은 적은 공격력 x2의 피해를 입습니다."}, -- Spear Of Destiny
	{"401", "폭발물", "25%의 확률로 접착 눈물이 나갑니다.#접착 눈물이 적에게 붙을 시 몇초 후 폭발하여 60의 피해를 입힙니다."}, -- Explosivo // 아주 강하게!
	{"402", "혼돈", "픽업 아이템을 1~6개 드랍합니다.#등장 아이템의 방 배열 구분이 사라집니다."}, -- Chaos
	{"403", "스파이더모드", "방 안을 돌아다니며 접촉한 적에게 랜덤한 상태이상을 부여합니다.#적의 체력과 적에게 주는 피해량이 수치로 표시됩니다.#방 클리어 시 일정 확률로 배터리 픽업이나 자폭 거미를 드랍합니다."}, -- Spider Mod // 거미 모드
	...
	{"407", "순도", "캐릭터 머리에 오라가 생기며 오라 색에 따라 특정 능력치가 증가합니다.#피격시 비활성화되며 방 이동시 다른 색으로 변합니다.#{{ColorRed}}빨강:{{CR}} {{DamageSmall}}공격력 +4.0#{{ColorCyan}}파랑:{{CR}} {{TearsSmall}}연사 +1.2#{{ColorOrange}}주황:{{CR}} {{RangeSmall}}사거리 +7.5, 눈물 높이 +1#{{ColorYellow}}노랑:{{CR}} {{SpeedSmall}}이동속도 +0.5"}, -- Purity
	...
	{"411", "욕망의 피", "적 처치 시 그 방에서 {{DamageSmall}}공격력이 +0.5씩(최대 +5) 증가합니다."}, -- Lusty Blood // 건강한 피
	...
	{"419", "순간이동 2.0", "사용 시 가보지 않은 방들 중 하나로 정해진 우선순위에 따라서 순간이동합니다.#!!! 순서: {{Room}}>{{BossRoom}}>{{SuperSecretRoom}}>{{Shop}}>{{TreasureRoom}}>{{SacrificeRoom}}> {{DiceRoom}}>{{Library}}>{{CursedRoom}}>{{MiniBoss}}>{{ChallengeRoom}}>{{IsaacsRoom}}> {{ArcadeRoom}}>{{ChestRoom}}>{{SecretRoom}}>{{DevilRoom}}{{AngelRoom}}> 오류방"}, -- Teleport 2.0 // 텔레포트 2.0
	{"420", "흑색 가루", "캐릭터가 지나간 곳에 검은 가루가 남으며, 가루로 원을 그리면 마법진이 생성되어 마법진 위의 적에게 틱당 10의 피해를 줍니다."}, -- Black Powder
	...
	{"425", "휴대용 손전등", "{{Slow}} 캐릭터의 몸통이 바라보는 방향으로 손전등을 비추며 빛 안에 들어온 적이나 탄환을 둔화시킵니다."}, -- Night Light
	{"426", "홀려버린 추종자", "캐릭터가 지나간 길을 3초 후 따라가며 접촉한 적에게 초당 30의 피해를 입힙니다."}, -- Obsessed Fan
	{"427", "마인크래프터", "사용 시 이동식 TNT를 생성합니다."}, -- Mine Crafter
	{"428", "잠옷", "↑ {{SoulHeart}}소울하트 +4#{{Heart}} 체력을 모두 회복합니다."}, -- PJs
	{"429", "키퍼의 머리통", "눈물이 적에게 명중 시 5% 확률로 {{Coin}}동전을 드랍합니다."}, -- Head of the Keeper
	...
	{"435", "꼬마 로키", "공격력 3.5의 눈물을 4갈래로 발사합니다."}, -- Lil Loki // 리틀 로키
	{"436", "우유!", "피격 시 그 방에서 {{TearsSmall}}연사 +0.3"}, -- Milk!
	{"437", "7면체 주사위", "사용 시 그 방을 다시 시작하며, 방 클리어 시 이전과 다른 보상이 드랍됩니다."}, -- D7
	{"438", "쪽쪽이", "↑ {{SoulHeart}}소울하트 +1#↑ {{TearsSmall}}연사 +0.7#캐릭터의 크기가 작아집니다."}, -- Binky // 아기처럼
	{"439", "엄마의 상자", "사용 시 랜덤한 장신구를 하나 드랍합니다.#소지중일 때 {{LuckSmall}}행운이 1 증가하며 들고있는 장신구의 효과가 2배 증가합니다."}, -- Mom's Box
	{"440", "신장 결석", "↓ {{RangeSmall}}사거리 -15#↓ {{SpeedSmall}}최대 이동속도 -0.2#공격중에 때때로 충전이 진행되고 충전이 끝났을 때 공격키를 떼면 {{TearsSmall}}연사가 최대가 되며 눈물을 한번에 발사합니다."}, -- Kidney Stone
	{"441", "메가 블래스트", "사용 시 15초 동안 공격력 x5의 대형 혈사포를 발사합니다."}, -- Mega Blast // 거대 돌풍
	{"442", "다크 프린스의 왕관", "{{Heart}}빨간하트가 1칸일 때 {{TearsSmall}}연사 +0.7, {{RangeSmall}}사거리 +1.5, 눈물 높이 +1, {{ShotspeedSmall}}탄속 +0.2"}, -- Dark Princes Crown
	{"443", "사과!", "↑ {{TearsSmall}}연사 +0.3#일정 확률로 공격력 x4의 공격이 나갑니다.#!!! {{LuckSmall}}행운 수치 비례: 행운 14 이상일 때 100% 확률"}, -- Apple!
	{"444", "연필", "눈물을 15번 발사할 때마다 공격력 x2의 눈물 다발이 나갑니다."}, -- Lead Pencil // 샤프 펜슬
	...
	{"447", "링거 콩", "7.5초동안 피격을 받지 않고 공격을 유지할 시 갈색 구름이 생성되며 구름에 닿은 적은 공격력 x5의 피해를 줍니다."}, -- Linger Bean
	{"448", "유리 조각", "피격 시 25% 확률로 {{Heart}}빨간하트가 드랍되며 그 방에서 캐릭터가 지나간 자리에 빨간 장판이 생기고 장판에 닿은 적은 초당 6의 피해를 입습니다."}, -- Shard of Glass
	{"449", "강철판", "↑ {{SoulHeart}}소울하트 +1#적 탄환에 맞았을 때 25%의 확률로 유도 반사탄을 발사합니다."}, -- Metal Plate // 메탈 플레이트
	...
	{"456", "곰팡이 핀 빵", "↑ {{Heart}}최대 체력 +1"}, -- Moldy Bread // 야식
	...
	{"460", "녹내장", "5%의 확률로 적을 혼란하게 하는 공격이 나갑니다.#화면이 조금 어두워집니다."}, -- Glaucoma
	{"461", "포식기생", "15%의 확률로 알주머니 눈물이 나가며 알주머니가 적에게 명중 시 파란 아군 거미 또는 파리를 소환합니다.#!!! {{LuckSmall}}행운 수치 비례: 행운 5 이상일 때 50% 확률"}, -- Parasitoid
	...
	{"467", "핑거!", "공격하는 방향으로 움직이며 가리킨 방향에 있는 적에게 공격력의 10%의 지속 피해를 입힙니다."}, -- Finger!
	...
	{"473", "빅 처비", "공격하는 방향으로 느리게 돌진해 접촉하는 적에게 초당 40.5의 피해를 입힙니다."}, -- Big Chubby
	{"474", "편도선", "."}, -- Tonsil
	...
	{"491", "산성 아기", "{{Pill}} 방 2개 클리어 시 알약을 하나 드랍합니다.#{{Poison}} 알약 사용 시 방 안의 모든 적을 1초간 중독시킵니다."}, -- Acid Baby
	...
	{"496", "안락사", "3.33%의 확률로 적을 즉사시키며 눈물이 10방향으로 퍼지는 눈물이 나갑니다.#!!! {{LuckSmall}}행운 수치 비례: 행운 15 이상일 때 100% 확률"}, -- Euthanasia
	...
	{"505", "포켓 GO", "!!! 방 입장 시 20%의 확률로 아래 중 하나의 아군 적을 소환합니다:#Attack Fly#Pooter#One Tooth#Fat Bat#Frowning Gaper#Vis"}, -- Poke Go
	...
	{"508", "엄마의 면도기", "{{BleedingOut}} 캐릭터 주위를 돌며 접촉하는 적에게 초당 공격력의 300%의 피해를 입히고 출혈 상태로 만듭니다."}, -- Mom's Razor
	{"509", "충혈된 눈", "캐릭터 주위를 돌며 자신이 바라보는 방향으로 공격력 3.5의 눈물을 발사합니다."}, -- Bloodshot Eye
	...
	{"513", "보조", "↑ {{SoulHeart}}소울하트 +1#↑ {{DamageSmall}}공격력 +0.1#일정 확률로 적 하나를 {{Charm}}매혹시키거나 {{Fear}}캐릭터에게서 멀어지게 합니다.#피격 시 확률적으로 무지개똥을 쌉니다."}, -- Bozo
	{"514", "고장난 모뎀", "적과 적의 탄환이 때때로 1초간 멈춥니다.#방 클리어 보상이 25% 확률로 두배로 나옵니다."}, -- Broken Modem
	{"515", "비밀의 선물", "!!! 일회용#사용 시 그 방의 아이템, A Lump of Coal, The Poop 중 하나를 생성합니다."}, -- Mystery Gift
	{"516", "스프링클러", "사용 시 360도 방향으로 캐릭터의 공격과 같은 공격을 발사하는 스프링클러를 소환합니다."}, -- Sprinkler
	{"517", "신속 폭탄", "↑ {{Bomb}}폭탄 +7#폭탄을 설치할 때 지연 없이 빠르게 설치할 수 있습니다."}, -- Fast Bombs
	{"518", "상자 안의 친구", "공격하는 방향으로 특수 효과 눈물을 발사합니다.#효과는 스테이지마다 바뀝니다."}, -- Buddy in a Box
	{"519", "꼬마 델리리움", "10초마다 랜덤한 패밀리어로 바뀝니다."}, -- Lil Delirium
	{"520", "부스터 케이블", "적 15기 처치 시 액티브 아이템 충전량을 한칸 충전합니다."}, -- Jumper Cables
	{"521", "쿠폰", "{{Shop}}상점이나 {{DevilRoom}}악마방에서 사용 시 랜덤 상품 하나를 거래없이 얻을 수 있습니다."}, -- Coupon
	{"522", "염력", "사용 시 3초동안 캐릭터에게 날아오는 적의 탄환을 붙잡습니다.#3초가 끝나면 붙잠은 탄환을 다시 되돌려 발사합니다."}, -- Telekinesis
	{"523", "이삿짐 상자", "사용 시 방 안의 모든 아이템과 픽업 아이템을 상자에 저장합니다.#다음 사용 시 저장했던 아이템들을 드랍합니다."}, -- Moving Box
	{"524", "테크놀로지 제로", "눈물마다 레이저가 연결되며 나갑니다."}, -- Technology Zero
	{"525", "나병", "피격 시 캐릭터 주위를 돌며 적의 탄환을 막아줍니다.#탄환을 일정 개수 이상 막을 시 사라집니다."}, -- Leprosy
	{"526", "7개의 도장", "방을 돌아다니며 접촉한 적에게 피해를 입히고 아군 파리를 소환합니다.#10초마다 모습이 바뀌며 적에게 주는 피해와 소환하는 아군 파리의 종류가 달라집니다."}, -- 7 Seals // 일곱 봉인
	{"527", "미스터 미!", "사용 시 조준점으로 목표를 설정하며 유령이 나타나 목표하는 대상에 상호작용합니다."}, -- Mr. ME!
	{"528", "엔젤릭 프리즘", "캐릭터 주위를 돌며 공격이 통과하면 4갈래로 갈라져 나갑니다."}, -- Angelic Prism
	{"529", "뿅!", "눈물이 체공하며 다른 눈물과 부딪힐 시 서로 튕겨나가며 움직입니다."}, -- Pop!
	{"530", "죽음의 살생부", "해골마크가 뜬 적을 순차적으로 처치 시 픽업 아이템이 드랍되거나 랜덤한 능력치가 하나 증가합니다."}, -- Death's List
	{"531", "피눈물", "↓ {{TearsSmall}}공격 딜레이 x2 +10#공격력 x3.1의 눈물을 포물선으로 발사하며 무언가에 부딪힐 시 파열되어 작은 눈물이 흩어집니다."}, -- Haemolacria
	{"532", "눈물먹이", "눈물이 체공하며 눈물에 눈물이 흡수됩니다.#최대 5번 흡수 시 파열되어 8방향으로 작은 눈물이 발사됩니다."}, -- Lachryphagy // 눈물을 마시는 새
	...
	{"535", "담요", "↑ {{SoulHeart}}소울하트 +1#↑ {{Heart}}빨간하트 +1#{{HolyMantleSmall}} {{BossRoom}}보스방에서 피격 시 피해를 1회 무시하는 보호막을 1회 제공합니다."}, -- Blanket
	{"536", "희생 제단", "!!! 일회용#사용 시 생물 패밀리어를 최대 2마리 제거하고 제거한 패밀리어 수 만큼 {{DevilRoom}}악마방 아이템을 생성합니다."}, -- Sacrificial Altar
	...
	{"540", "평평한 돌", "눈물이 바닥을 튀면서 발사됩니다.#눈물의 최대 사거리가 캐릭터의 사거리보다 40% 더 멀리 나갑니다.#눈물이 튈 때 주변에 있는 적에게 공격력의 25%의 피해를 입힙니다."}, -- Flat Stone
	{"541", "골수", "↑ {{EmptyBoneHeart}}뼈하트 +1#{{Heart}}빨간하트를 3개 드랍합니다."}, -- Marrow
	{"542", "미끄러운 늑골", "캐릭터 주위를 돌며 적의 탄환을 반사합니다."}, -- Slipped Rib
	{"543", "성지", "피격 시 오라를 가진 하얀 똥을 설치합니다.오라 안에 있을 시 {{TearsSmall}}연사가 2배가 되며 피해를 확률적으로 무시합니다."}, -- Hallowed Ground
	{"544", "뾰족한 늑골", "캐릭터가 보는 방향에서 앞뒤로 움직이면서 접촉하는 적에게 초당 캐릭터의 공격력 x6의 피해를 입힙니다."}, -- Pointy Rib
	{"545", "망자의 서", "사용 시 방에서 죽인 적의 수만큼 일회용 뼛조각 배리어를 생성하며 확률적으로 아군 해골 적을 소환합니다."}, -- Book of the Dead
...
EID.descriptions[languageCode].trinkets={
	...
	{"8", "카트리지", "피격 시 5%의 확률로 6초간 무적 상태가 되며 접촉한 적에게 40의 피해를 입힙니다.#!!! {{LuckSmall}}행운 수치 비례: 행운 38 이상일 때 100% 확률"}, -- Cartridge
	...
	{"12", "납작벌레", "눈물이 납작해진 모양으로 날아갑니다.#눈물이 적을 살짝 밀쳐냅니다."}, -- Flat Worm
	...
	{"24", "똥전", "똥 오브젝트에서 {{Coin}}동전이 나올 확률이 20% 증가합니다.#동전 획득 시 적을 밀쳐내는 방귀를 뀝니다."}, -- Butt Penny
	{"25", "이상한 초콜릿", "!!! 30초마다 일정 확률로:#똥을 싸거나;#적을 밀쳐내는 방귀를 뀝니다."}, -- Mysterious Candy
	...
	{"30", "분홍 눈알", "10%의 확률로 적을 {{Poison}}중독시키는 공격이 나갑니다.#!!! {{LuckSmall}}행운 수치 비례: 행운 18 이상일 때 100% 확률"}, -- Pinky Eye
	{"31", "고정핀", "10%의 확률로 적과 장애물을 관통하는 공격이 나갑니다.#!!! {{LuckSmall}}행운 수치 비례: 행운 18 이상일 때 100% 확률"}, -- Push Pin
	...
	{"46", "아이작의 포크", "방 클리어 시 10% 확률로 {{HalfHeart}}체력을 반칸 회복합니다.#!!! {{LuckSmall}}행운 수치 비례: 행운 18 이상일 때 100% 확률"}, -- Isaac's Fork
	{"47", "The Polariod", "<Item does not exist>"}, -- The Polariod
	{"48", "찢어진 페이지", "피격 시 5%의 확률로 방 안의 모든 적에게 40의 피해를 줍니다.#!!! {{LuckSmall}}행운 수치 비례: 행운 65 이상일 때 50% 확률"}, -- A Missing Page
	...
	{"58", "삼손의 머리채", "적 처치 시 1/15의 확률로 그 방에서 {{DamageSmall}}공격력이 0.5씩 (최대 +5) 증가합니다.#!!! {{LuckSmall}}행운 수치 비례: 행운 10 이상일 때 100% 확률"}, -- Samson's Lock
	{"59", "카인의 오른쪽 눈", "스테이지 입장 시 25%의 확률로 그 스테이지에서 맵에 특수방의 위치를 보여줍니다.#!!! {{LuckSmall}}행운 수치 비례: 행운 3 이상일 때 100% 확률"}, -- Cain's Eye
	{"60", "이브의 새 다리", "적 처치 시 5%의 확률로 {{Collectible117}}Dead Bird를 소환합니다.#!!! {{LuckSmall}}행운 수치 비례: 행운 8 이상일 때 100% 확률"}, -- Eve's Bird Foot
	...
	{"72", "손목시계용 전지", "{{Battery}} 방 클리어 보상이 배터리 픽업으로 교체될 확률이 5%에서 6.67%로 증가합니다.#{{Battery}} 픽업 아이템 드랍 시 2%의 확률로 배터리 픽업으로 바꿉니다.#방 클리어 시 5% 확률로 충전량을 한칸 더 채워줍니다."}, -- Watch Battery
	...
	{"102", "조각난 카드", "스테이지 입장 시 {{SecretRoom}}비밀방이 2개 생성됩니다."}, -- Fragmented Card
...
EID.descriptions[languageCode].sacrifice={
	...
	{"6", "희생 6회", "[67%] {{Chest}}상자 1개#[33%] {{AngelRoom}}천사방/{{DevilRoom}}악마방으로 순간이동"},
