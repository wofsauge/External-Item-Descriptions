...
EID.descriptions[languageCode].collectibles={
	...
	{"36", "똥", "사용 시 똥을 싸며 주변의 적을 밀쳐냅니다.#1칸짜리 구덩이 바로 옆에서 똥을 싸고 폭탄으로 터트리면 해당 구덩이를 메울 수 있습니다."}, -- The Poop
	...
	{"63", "건전지", "액티브 아이템의 최대 충전량이 2배로 증가합니다.#2번 완충된 액티브 아이템은 연속으로 사용할 수 있습니다."}, -- The Battery
	...
	{"93", "게임키드", "사용 시 6초간 무적 상태가 되며 접촉한 적에게 초당 40의 피해를 입힙니다.#{{Fear}} 적들이 캐릭터에게서 도망가며 적 2기를 죽일 때마다 {{HalfHeart}}체력을 반 칸 회복합니다."}, -- The Gamekid
	...
	{"120", "이상한 버섯", "↓ {{DamageSmall}}공격력 {{ColorOrange}}증가량{{CR}} 배율 x0.9#↓ {{DamageSmall}}최종 공격력 -0.4#↑ {{TearsSmall}}연사 +1.7#↑ {{SpeedSmall}}이동속도 +0.3#캐릭터의 머리가 작아집니다."}, -- Odd Mushroom
	...
	{"150", "사랑의 매", "10%의 확률로 캐릭터의 공격력 x3.2의 공격이 나갑니다.#!!! {{LuckSmall}}행운 수치 비례: 행운 9 이상일 때 100% 확률"}, -- Tough Love
	...
	{"154", "화학 박피제", "왼쪽 눈에서 {{DamageSmall}}공격력 +2의 공격을 발사합니다."}, -- Chemical Peel
	...
	{"162", "켈트 십자가", "피격 시 20%의 확률로 캐릭터가 7초간 무적 상태가 됩니다.#!!! {{LuckSmall}}행운 수치 비례: 행운 27 이상일 때 100% 확률"}, -- Celtic Cross
	...
	{"208", "챔피언 벨트", "↑ {{DamageSmall}}공격력 +1#!!! 적이 챔피언으로 바뀔 확률 +15%#챔피언 몬스터는 체력이 평소의 2배, 캐릭터에게 최소 체력 1칸의 피해를 주며 색상별로 특수 효과가 적용됩니다."}, -- Champion Belt
	...
	{"283", "100면 주사위", "사용 시 방 안의 아이템, 픽업 아이템, 소지중인 패시브 아이템을 모두 바꿉니다."}, -- D100
	...
	{"298", "유니콘의 잘린 뿔", "사용 시 6초간 캐릭터의 {{SpeedSmall}}이동속도 +0.28, 공격불능 무적 상태가 됩니다."}, -- Unicorn Stump
