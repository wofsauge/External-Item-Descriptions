...
EID.descriptions[languageCode].collectibles={
	...
	{"85", "카드 덱", "사용 시 {{Card}}카드를 하나 드랍합니다."}, -- Deck of Cards
	...
	{"102", "엄마의 약병", "사용 시 {{Pill}}알약을 하나 드랍합니다."}, -- Mom's Bottle of Pills
	...
	{"140", "밥의 저주", "↑ {{Bomb}}폭탄 +5#폭탄에 독 효과가 생깁니다."}, -- Bob's Curse
	...
	{"194", "마법의 8번 공", "↑ {{Shotspeed}}탄속 +0.16#{{Card}}카드를 하나 드랍합니다."}, -- Magic 8 Ball
	...
	{"199", "엄마의 열쇠", "↑ {{Key}}열쇠 +2#상자를 열 때 드랍되는 픽업 아이템의 수가 증가합니다."}, -- Mom's Key
	...
	{"202", "미다스의 손길", "적에게 접촉시 접촉한 적을 멈추게 만들며 멈춘 적 처치 시 {{Coin}}동전을 1~3개 드랍합니다.#!!! 접촉 대미지 : 소지 동전 수"}, -- Midas' Touch
	...
	{"209", "궁둥이 폭탄", "↑ {{Bomb}}폭탄 +5#폭탄이 터질 때 방 안의 모든 적에게 10의 피해를 주고 4초간 혼란시킵니다.#!!! 똥 타입 보스의 체력을 25% 회복시킵니다."}, -- Butt Bombs
	...
	{"223", "방화광", "↑ {{Bomb}}폭탄 +5#폭발 및 지진파 공격에 피해를 입지 않으며 폭발을 맞으면 체력을 1칸 회복합니다."}, -- Pyromaniac
	...
	{"286", "빈 카드", "사용 시 현재 소지중인 {{Card}}카드 또는 {{Rune}}룬의 효과를 발동합니다."}, -- Blank Card
	...
	{"340", "카페인 정", "↑ {{Speed}}이동속도 +0.3#{{Pill}}알약을 1개 드랍합니다.#캐릭터의 크기가 작아집니다."}, -- Caffeine Pill
	{"341", "찢어진 사진", "↑ {{Tears}}연사 +0.7#↑ {{Shotspeed}}탄속 +0.16"}, -- Torn Photo
	{"342", "파란 환각버섯", "↑ {{Heart}}최대 체력 +1#↑ {{Tears}}연사 +0.7#↓ {{Shotspeed}}탄속 -0.16"}, -- Blue Cap
	{"343", "현관 열쇠", "↑ {{SoulHeart}}소울하트 +1#↑ {{Luck}}행운 +1#{{Key}}열쇠를 2개 드랍합니다."}, -- Latch Key
	{"344", "종이 성냥", "↑ {{BlackHeart}}블랙하트 +1#{{Bomb}}폭탄을 2~3개 드랍합니다."}, -- Match Book
	...
	{"367", "끈끈이 폭탄", "↑ {{Bomb}}폭탄 +5#폭탄이 적에게 접촉 시 달라붙으며 달라붙은 상태에서 폭발 시 파란 아군 거미 2~5마리를 소환합니다."}, -- Sticky Bombs
	...
	{"389", "룬 가방", "방 5~6개 클리어 시 {{Rune}}룬을 하나 드랍합니다."}, -- Rune Bag
	...
	{"432", "반짝이 폭탄", "↑ {{Bomb}}폭탄 +5#폭탄이 터질 때 일정 확률로 랜덤한 픽업 아이템 또는 장신구가 드랍되거나 랜덤한 적을 매혹시킵니다."}, -- Glitter Bombs
	...
	{"450", "탐욕의 눈", "눈물을 20번 발사할 때마다 동전을 1개 소모하고 적을 멈추게 만드는 눈물을 발사합니다.#멈춘 적 처치 시 {{Coin}}동전을 1~4개 드랍합니다."}, -- Eye of Greed
	...
	{"455", "아빠의 잃어버린 동전", "↑ {{Range}}사거리 +1.5#↑ 눈물 높이 +1#{{Coin}}행운 동전을 하나 드랍합니다."}, -- Dad's Lost Coin
	...
	{"491", "산성 아기", "방 2개 클리어 시 {{Pill}}알약을 하나 드랍합니다.#알약 사용 시 방 안의 모든 적을 1초간 중독시킵니다."}, -- Acid Baby
	...
	{"537", "꼬마 구토쟁이", "{{Pill}}알약을 1개 드랍합니다.#공격하는 방향으로 장판을 충전하여 뱉습니다.#장판의 효과는 알약을 사용할 때마다 달라집니다."}, -- Lil Spewer
...
EID.descriptions[languageCode].trinkets={
	...
	{"44", "안전 마개", "방 클리어 보상이 10% 확률로 {{Pill}}알약으로 바뀝니다.#상자에서 {{Pill}}알약이 드랍될 확률이 증가합니다."}, -- Safety Cap
	{"45", "스페이드 A", "방 클리어 보상이 10% 확률로 {{Card}}카드로 바뀝니다.#상자에서 {{Card}}카드가 드랍될 확률이 증가합니다."}, -- Ace of Spades
	...
	{"85", "업보", "기부기계에 기부 시 확률적으로 아래 효과 중 하나 발동:#{{Blank}} {{Coin}}동전 +1#{{Blank}} {{Heart}}빨간하트 한칸 회복#{{Blank}} {{Luck}}행운 +1#{{Blank}} 거지 소환#{{Blank}}"}, -- Karma
