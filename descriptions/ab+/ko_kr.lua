...
EID.descriptions[languageCode].collectibles={
	...
	{"39", "엄마의 브래지어", "사용 시 그 방의 적들을 4초간 멈추게 합니다."}, -- Mom's Bra
	...
	{"269", "머리없는 아기", "캐릭터를 따라다니며 지나간 자리에 빨간 장판이 생깁니다.#빨간 장판에 닿은 적은 초당 6의 피해를 입습니다."}, -- Headless Baby
	...
	{"308", "물병자리", "캐릭터가 지나간 자리에 파란 장판이 생깁니다.#파란 장판에 닿은 적은 초당 6의 피해를 입습니다."}, -- Aquarius
	...
	{"338", "부메랑", "사용 후 공격방향으로 부메랑을 던집니다.#부메랑에 맞은 적에게 공격력 x2의 피해를 주며 2초간 멈추게 만듭니다."}, -- The Boomerang
	...
	{"351", "대빵 큰 콩", "사용 시 그 방의 적을 2초간 석화시키며 바라보는 방향으로 충격파를 발사합니다."}, -- Mega Bean
	...
	{"372", "충전지 아기", "방안에 적이 있을 때 30초마다 랜덤으로:#{{ArrowGrayRight}} 배터리 픽업을 드랍하거나(최대 2회);#{{ArrowGrayRight}} 액티브 아이템의 충전량을 한칸 채워주거나(최대 2회);#{{ArrowGrayRight}} 그 방의 적을 2초간 석화 상태로 만듭니다."}, -- Charged Baby
	...
	{"468", "셰이드", "캐릭터가 지나간 길을 1초 후 따라옵니다.#접촉한 적에게 초당 30의 피해를 줍니다."}, -- Shade
	...
	{"487", "감자칼", "!!! {{NoLB}}사용 시 {{EmptyHeart}} 최대 체력 1칸을 깎으며 이하의 피격 효과 발동:#{{ArrowGrayRight}} {{DamageSmall}}공격력 +0.2#{{ArrowGrayRight}} {{Collectible73}}Cube of Meat +1#{{Timer}} 그 방에서:#{{ArrowGrayRight}} {{RangeSmall}}사거리 +5#{{ArrowGrayRight}} 캐릭터가 지나간 자리에 빨간 장판이 생기며 닿은 적은 초당 6의 피해를 입습니다."}, -- Potato Peeler
	...
	{"505", "포켓 GO", "!!! 방 입장 시 20%의 확률로 아래 중 하나의 아군 적을 소환합니다:#{{ArrowGrayRight}} Attack Fly#{{Blank}} Pooter#{{Blank}} One Tooth#{{Blank}} Fat Bat#{{Blank}} Frowning Gaper#{{Blank}} Vis"}, -- Poke Go
	...
	{"546", "아빠의 반지", "캐릭터 주위에 작은 고리가 생깁니다.#고리에 닿은 적을 즉시 멈추게 합니다."}, -- Dad's Ring
