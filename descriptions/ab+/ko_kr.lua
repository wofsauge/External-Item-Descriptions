...
EID.descriptions[languageCode].collectibles={
	...
	{"13", "바이러스", "↓ {{Speed}}이동속도 -0.1#적에게 접촉시 적에게 12의 피해를 주고 적을 {{Poison}}중독시킵니다.#중독된 적이 죽을시 20% 확률로 {{BlackHeart}}블랙하트가 드랍됩니다."}, -- The Virus
	...
	{"41", "엄마의 패드", "사용 시 방 안의 모든 적들을 5초간 캐릭터에게서 {{Fear}}도망가게 합니다."}, -- Mom's Pad
	...
	{"66", "모래시계", "사용 시 방 안의 모든 적들을 8초간 {{Slow}}둔화시킵니다."}, -- The Hourglass
	{"67", "매기", "공격하는 방향으로 공격력 3.5의 눈물을 발사합니다."}, -- Sister Maggy
	{"68", "기계장치", "공격이 레이저 공격으로 변경됩니다.#레이저는 사거리 제한이 없으며 적을 관통합니다."}, -- Technology
	{"69", "초콜릿 우유", "{{Chargable}} 눈물을 충전하며 발사합니다. #충전 상태에 따라 공격력 배율이 x0.3 ~ x4로 증감합니다."}, -- Chocolate Milk
	...
	{"89", "거미물림", "25%의 확률로 적을 {{Slow}}둔화시키는 공격이 나갑니다.#!!! {{Luck}}행운 수치 비례: 행운 15 이상일 때 100% 확률"}, -- Spider Bite
	...
	{"99", "리틀 기쉬", "공격하는 방향으로 공격력 3.5의 적을 {{Slow}}둔화시키는 눈물을 발사합니다."}, -- Little Gish
	...
	{"103", "감기", "25%의 확률로 적을 {{Poison}}중독시키는 공격이 나갑니다.#!!! {{Luck}}행운 수치 비례: 행운 12 이상일 때 100% 확률"}, -- The Common Cold
	...
	{"114", "엄마의 식칼", "{{Chargable}} 공격이 발사 후 돌아오는 근접 식칼로 변경됩니다.#공격키를 누르고 있으면 충전되며 충전량에 따라 사거리가 증가합니다.#칼 공격력: 기본 x2 ~ 최대 거리일때 x6"}, -- Mom's Knife
	...
	{"118", "유황", "{{Chargable}} 공격이 충전형 혈사포 공격으로 변경됩니다.#혈사포는 다단히트로 최대 13번의 피해를 입힙니다."}, -- Brimstone
	...
	{"171", "거미 엉덩이", "사용 시 방 안의 모든 적에게 10의 피해를 주고 4초간 {{Slow}}둔화시킵니다."}, -- Spider Butt
	...
	{"200", "엄마의 아이섀도우", "10%의 확률로 적을 {{Charm}}매혹시키는 공격이 나갑니다.#!!! {{Luck}}행운 수치 비례"}, -- Mom's Eyeshadow
	...
	{"228", "엄마의 향수", "↑ {{Tears}}연사 +0.2#15%의 확률로 적을 {{Fear}}도망가게 하는 공격이 나갑니다.#!!! {{Luck}}행운 수치 비례"}, -- Mom's Perfume
	{"229", "몬스트로의 폐", "↓ {{Tears}}공격 딜레이 x4.3#{{Chargable}} 공격을 충전한 다음 여러 개의 눈물을 흩뿌리면서 발사합니다."}, -- Monstro's Lung
	{"230", "아바돈", "최대 체력이 모두 제거됩니다.#↑ {{BlackHeart}}블랙하트 +6#↑ {{Damage}}공격력 +1.5#↑ {{Speed}}이동속도 +0.2#12.5%의 확률로 적을 {{Fear}}도망가게 하는 공격이 나갑니다.#!!! {{Luck}}행운 수치 비례"}, -- Abaddon
	{"231", "타르 덩어리", "캐릭터가 지나간 자리에 검은 장판이 생기며 닿은 적은 {{Slow}}느려집니다.#10%의 확률로 적을 {{Slow}}둔화시키는 공격이 나갑니다.#!!! {{Luck}}행운 수치 비례: 행운 18 이상일 때 100% 확률"}, -- Ball of Tar
	...
	{"266", "축축한 알집", "캐릭터를 따라다니며 지나간 자리에 하얀 장판이 생기며 닿은 적은 {{Slow}}느려집니다.#방 클리어 시 파란 아군 거미를 1~2마리 소환합니다."}, -- Juicy Sack
	...
	{"275", "꼬마 유황", "{{Chargable}} 공격하는 방향으로 최대 공격력 31.5의 혈사포를 충전하여 발사합니다."}, -- Lil Brimstone
	{"276", "아이작의 심장", "캐릭터를 따라다니며 캐릭터가 무적이 되고 심장이 피격당할 시 캐릭터가 피해를 입습니다."}, -- Isaac's Heart
	{"277", "꼬마 유령", "적을 따라다니며 접촉하는 적에게 초당 4의 피해를 주고 {{Fear}}도망가게 합니다."}, -- Lil Haunt
	...
	{"316", "저주받은 눈알", "{{Chargable}} 눈물을 충전한 다음 최대 4발의 눈물을 일렬로 발사합니다.#!!! 충전중 피격 시 스테이지 안의 랜덤한 방으로 순간이동합니다."}, -- Cursed Eye
	...
	{"384", "꼬마 거디", "{{Chargable}} 공격키를 누르고 있는 동안 충전되며 공격키를 떼면 공격했던 방향으로 돌진해 벽에 튕겨다니며 적을 공격합니다."}, -- Lil Gurdy
	...
	{"387", "향로", "오라를 가지고 캐릭터를 따라다니며 오라 안에 들어온 적과 탄환을 {{Slow}}둔화시킵니다."}, -- Censer
	...
	{"391", "배신", "피격 시 방 안의 모든 적을 5초간 {{Charm}}매혹시킵니다."}, -- Betrayal
	{"392", "황도궁", "스테이지마다 랜덤한 별자리 아이템의 효과를 가집니다."}, -- Zodiac
	{"393", "독뱀의 키스", "확률적으로 적을 {{Poison}}중독시키는 공격이 나갑니다.#중독된 적이 죽을때 20% 확률로 {{BlackHeart}}블랙하트가 드랍됩니다."}, -- Serpent's Kiss
	{"394", "조준", "↑ {{Tears}}연사 +0.7#↑ {{Range}}사거리 +3.15#↑ 눈물 높이 +0.3#조준점을 조종할 수 있으며 자동으로 조준점이 있는 방향을 향해 눈물을 발사합니다."}, -- Marked
	{"395", "기계 X", "{{Chargable}} 공격이 충전형 레이저 고리 공격으로 변경됩니다.#레이저는 사거리 제한이 없으며 적과 장애물을 관통합니다."}, -- Tech X
	...
	{"399", "공허의 구렁텅이", "↑ {{Damage}}공격력 +1#{{Chargable}} 공격키를 2.5초 이상 누르면 충전되며 공격키를 떼면 캐릭터 주위에 검은 고리가 둘러져 접촉한 적에게 현재 공격력만큼의 피해를 줍니다.#고리로 적 처치 시 5% 확률로 {{BlackHeart}}블랙하트를 드랍합니다."}, -- Maw Of The Void
	...
	{"421", "강낭콩", "사용 시 {{Charm}}매혹 방귀를 뀝니다."}, -- Kidney Bean
	...
	{"425", "손전등", "캐릭터의 몸통이 바라보는 방향으로 손전등을 비추며 빛 안에 들어온 적이나 탄환을 {{Slow}}둔화시킵니다."}, -- Night Light
	...
	{"446", "죽은 이빨", "공격 시 캐릭터 주위에 적을 {{Poison}}중독시키는 독가스가 나옵니다."}, -- Dead Tooth
	...
	{"471", "꼬마 몬스트로", "{{Chargable}} 공격하는 방향으로 공격력 3.5의 눈물다발을 충전하여 발사합니다."}, -- Lil Monstro
	...
	{"491", "산성 아기", "방 2개 클리어 시 {{Pill}}알약을 하나 드랍합니다.#알약 사용 시 방 안의 모든 적을 1초간 {{Poison}}중독시킵니다."}, -- Acid Baby
	...
	{"508", "엄마의 면도칼", "캐릭터 주위를 돌며 접촉하는 적에게 초당 공격력의 300%의 피해를 입히고 {{BleedingOut}}출혈 상태로 만듭니다."}, -- Mom's Razor
	...
	{"513", "멍청이", "↑ {{SoulHeart}}소울하트 +1#↑ {{Damage}}공격력 +0.1#일정 확률로 적 하나를 {{Charm}}매혹시키거나 {{Fear}}캐릭터에게서 멀어지게 합니다.#피격 시 확률적으로 무지개똥을 쌉니다."}, -- Bozo
	...
	{"537", "꼬마 구토쟁이", "{{Pill}}알약을 1개 드랍합니다.#{{Chargable}} 공격하는 방향으로 장판을 충전하여 뱉습니다.#장판의 효과는 알약을 사용할 때마다 달라집니다."}, -- Lil Spewer
...
EID.descriptions[languageCode].trinkets={
	...
	{"95", "검은 이빨", "3%의 확률로 공격력 2배의 적을 {{Poison}}중독시키는 공격이 나갑니다.#!!! {{Luck}}행운 수치 비례"}, -- Black Tooth
...
EID.descriptions[languageCode].cards={
	...
	{"54", "시간 여행", "그 방에서 {{Speed}}이동속도 +0.5, {{Shotspeed}}탄속 -1.0#방 안의 모든 적들이 영구적으로 {{Slow}}느려집니다."}, -- Era Walk
}
