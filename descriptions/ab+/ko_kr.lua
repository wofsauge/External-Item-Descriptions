...
EID.descriptions[languageCode].collectibles={
	...
	{"62", "뱀파이어의 부적", "적 13기 처치 시 {{HalfHeart}}체력을 0.5칸 회복합니다."}, -- Charm of the Vampire
	...
	{"93", "게임키드", "사용 시 6초간 무적 상태가 되며 접촉한 적에게 40의 피해를 입힙니다.#적들이 아이작에게서 도망가며 적 2기를 죽일 때마다 {{HalfHeart}}체력을 반 칸 회복합니다."}, -- The Gamekid
	...
	{"218", "태반", "↑ {{Heart}}최대 체력 +1#타이머가 1분 0초가 될 때마다 일정 확률로 {{HalfHeart}}체력 반 칸을 회복합니다."}, -- Placenta
...
EID.descriptions[languageCode].trinkets={
	...
	{"46", "아이작의 포크", "방 클리어 시 10% 확률로 {{HalfHeart}}체력을 반칸 회복합니다."}, -- Isaac's Fork
	...
	{"53", "진드기", "!!! 교체불가#방 입장 시 체력이 60 이상인 적의 체력을 15% 깎습니다.#{{BossRoom}}보스방 입장 시 {{Heart}}체력을 한칸 회복합니다."}, -- Tick
