...
EID.descriptions[languageCode].collectibles={
	...
	{"7", "순교자의 피", "↑ {{DamageSmall}}공격력 +1#{{Collectible34}}Book of the Belial, 혹은 {{Card16}}The Devil 효과가 발동 중인 경우 {{DamageSmall}}공격력 배율 x1.5"}, -- Blood of the Martyr
	...
	{"13", "바이러스", "↓ {{SpeedSmall}}이동속도 -0.1#적에게 접촉시 적에게 12의 피해를 주고 적을 {{Poison}}중독시킵니다.#중독된 적이 죽을시 20% 확률로 {{BlackHeart}}블랙하트가 드랍됩니다."}, -- The Virus
	...
	{"34", "벨리알의 책", "사용 시 그 방에서 {{DamageSmall}}공격력 +2 증가하며 {{Collectible7}}Blood of the Martyr 소지 시 {{DamageSmall}}공격력 배율 x1.5 추가 적용#소지중일 때 {{DevilChanceSmall}}악마방 확률 +12.5%"}, -- The Book of Belial
	...
	{"89", "거미물림", "25%의 확률로 적을 {{Slow}}둔화시키는 공격이 나갑니다.#!!! {{LuckSmall}}행운 수치 비례: 행운 15 이상일 때 100% 확률"}, -- Spider Bite
	...
	{"103", "감기", "25%의 확률로 적을 {{Poison}}중독시키는 공격이 나갑니다.#!!! {{LuckSmall}}행운 수치 비례: 행운 12 이상일 때 100% 확률"}, -- The Common Cold
	...
	{"120", "이상한 버섯", "↓ {{DamageSmall}}공격력 x0.9 -0.4#↑ {{TearsSmall}}연사 +1.7#↑ {{SpeedSmall}}이동속도 +0.3#캐릭터의 머리가 작아집니다."}, -- Odd Mushroom
	...
	{"162", "켈트 십자가", "피격 시 20%의 확률로 7초간 무적 상태가 됩니다.#!!! {{LuckSmall}}행운 수치 비례"}, -- Celtic Cross
	...
	{"200", "엄마의 아이섀도우", "10%의 확률로 적을 {{Charm}}매혹시키는 공격이 나갑니다.#!!! {{LuckSmall}}행운 수치 비례"}, -- Mom's Eyeshadow
	{"201", "철괴", "↑ {{DamageSmall}}공격력 +0.3#10%의 확률로 적을 혼란시키는 공격이 나갑니다.#!!! {{LuckSmall}}행운 수치 비례"}, -- Iron Bar
	...
	{"219", "낡은 밴드", "↑ {{EmptyHeart}}빈 최대 체력 +1#피격 시 일정 확률로 {{Heart}}빨간하트를 하나 드랍합니다.#!!! {{LuckSmall}}행운 수치 비례"}, -- Old Bandage
	...
	{"225", "김피", "적 처치 시 일정 확률로 {{HalfHeart}}빨간하트가 반칸 드랍됩니다.#피격 시 일정 확률로 {{SoulHeart}}소울하트 또는 {{BlackHeart}}블랙하트를 드랍합니다.#!!! {{LuckSmall}}행운 수치 비례"}, -- Gimpy
	...
	{"228", "엄마의 향수", "↑ {{TearsSmall}}연사 +0.2#15%의 확률로 적을 {{Fear}}도망가게 하는 공격이 나갑니다.#!!! {{LuckSmall}}행운 수치 비례"}, -- Mom's Perfume
	{"229", "몬스트로의 폐", "↓ {{TearsSmall}}공격 딜레이 x4.3#{{Chargeable}} 공격을 충전한 다음 여러 개의 눈물을 흩뿌리면서 발사합니다."}, -- Monstro's Lung
	{"230", "아바돈", "최대 체력이 모두 제거됩니다.#↑ {{BlackHeart}}블랙하트 +6#↑ {{DamageSmall}}공격력 +1.5#↑ {{SpeedSmall}}이동속도 +0.2#12.5%의 확률로 적을 {{Fear}}도망가게 하는 공격이 나갑니다.#!!! {{LuckSmall}}행운 수치 비례"}, -- Abaddon
	{"231", "타르 덩어리", "캐릭터가 지나간 자리에 검은 장판이 생기며 닿은 적은 {{Slow}}느려집니다.#10%의 확률로 적을 {{Slow}}둔화시키는 공격이 나갑니다.#!!! {{LuckSmall}}행운 수치 비례: 행운 18 이상일 때 100% 확률"}, -- Ball of Tar
	...
	{"238", "열쇠 조각 1", "Key Piece 2와 조합 시 최종보스 문을 열 수 있습니다.#↑ {{AngelChanceSmall}}천사방 확률 +25%"}, -- Key Piece 1
	{"239", "열쇠 조각 2", "Key Piece 1와 조합 시 최종보스 문을 열 수 있습니다.#↑ {{AngelChanceSmall}}천사방 확률 +25%"}, -- Key Piece 2
	...
	{"257", "불타는 마음", "적에게 {{Burning}}화상을 입히는 공격이 나갑니다.#일정 확률로 공격력의 2배의 피해를 주고 불꽃이 남는 폭발을 일으키는 눈물이 나갑니다.#!!! {{LuckSmall}}행운 수치 비례: 행운 13 이상일 때 100% 확률"}, -- Fire Mind
	{"258", "", "획득 시 및 스테이지를 넘어갈 때마다 소지중인 아이템과 능력치를 모두 바꿉니다."}, -- Missing No.
	{"259", "암흑 물질", "↑ {{DamageSmall}}공격력 +1#33%의 확률로 적을 {{Fear}}도망가게 하는 공격이 나갑니다.#!!! {{LuckSmall}}행운 수치 비례: 행운 20 이상일 때 100% 확률"}, -- Dark Matter
	...
	{"261", "안구 돌출증", "↑ {{DamageSmall}}공격력 x2#공격이 멀리 나갈수록 공격력이 최대 0.7 감소합니다."}, -- Proptosis
	...
	{"297", "판도라의 상자", "!!! 일회용#사용 시 스테이지마다 다른 보상을 드랍합니다.#1: {{SoulHeart}}소울하트 2개#2: {{Bomb}}폭탄 2개, {{Key}}열쇠 2개#3: {{BossRoom}}보스방 아이템 1개#4: {{SoulHeart}}소울하트 2개, {{BossRoom}}보스방 아이템 1개#5: {{SoulHeart}}소울하트 4개#6: {{Coin}}동전 30개#7: {{BossRoom}}보스방 아이템 2개#8: 성경#Sheol: {{BlackHeart}}블랙하트 2개, {{DevilRoom}}악마방 아이템#Cath: {{EthernalHeart}}이터널하트 1개, {{AngelRoom}}천사방 아이템#Chest: {{Coin}}동전 1개"}, -- Pandora's Box
	...
	{"370", "돌리 씨", "↑ {{TearsSmall}}연사 +0.7#↑ {{RangeSmall}}사거리 +5.25#↑ 눈물 높이 +0.5#{{Heart}}빨간하트, {{SoulHeart}}소울하트, {{BlackHeart}}블랙하트 중 3개를 랜덤하게 드랍합니다."}, -- Mr. Dolly
	...
	{"374", "신성한 빛", "10%의 확률로 적에게 명중 시 공격력 x4의 빛줄기가 떨어지는 공격이 나갑니다.#!!! {{LuckSmall}}행운 수치 비례: 행운 9 이상일 때 50% 확률"}, -- Holy Light
	...
	{"390", "세라핌", "공격하는 방향으로 공격력 10, {{TearsSmall}}연사 -0.25의 유도 눈물을 발사합니다."}, -- Seraphim
	...
	{"499", "성찬", "{{AngelChanceSmall}}천사방 등장 확률이 100%로 고정됩니다."}, -- Eucharist
...
EID.descriptions[languageCode].trinkets={
	...
	{"8", "카트리지", "피격 시 5%의 확률로 6초간 무적 상태가 되며 접촉한 적에게 40의 피해를 입힙니다.#!!! {{LuckSmall}}행운 수치 비례"}, -- Cartridge
	...
	{"48", "찢어진 페이지", "피격 시 5%의 확률로 방 안의 모든 적에게 40의 피해를 줍니다.#!!! {{LuckSmall}}행운 수치 비례"}, -- A Missing Page
	...
	{"85", "업보", "기부기계에 기부 시 확률적으로 아래 효과 중 하나 발동:#{{Blank}} {{Coin}}동전 +1#{{Blank}} {{Heart}}빨간하트 한칸 회복#{{Blank}} {{LuckSmall}}행운 +1#{{Blank}} 거지 소환#{{Blank}}"}, -- Karma
	...
	{"95", "검은 이빨", "3%의 확률로 공격력 2배의 적을 {{Poison}}중독시키는 공격이 나갑니다.#!!! {{LuckSmall}}행운 수치 비례"}, -- Black Tooth
...
EID.descriptions[languageCode].cards={
	...
	{"54", "시간 여행", "그 방에서 {{SpeedSmall}}이동속도 +0.5, {{ShotspeedSmall}}탄속 -1.0#방 안의 모든 적들이 영구적으로 {{Slow}}느려집니다."}, -- Era Walk
}
