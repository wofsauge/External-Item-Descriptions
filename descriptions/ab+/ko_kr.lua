...
EID.descriptions[languageCode].collectibles={
	...
	{"162", "켈트 십자가", "피격 시 20%의 확률로 캐릭터가 7초간 무적 상태가 됩니다.#{{LuckSmall}} 행운 27 이상일 때 100% 확률"}, -- Celtic Cross
	...
	{"303", "처녀자리", "부정적인 알약 효과가 등장하지 않습니다.#피격 시 일정 확률로 7초간 무적 상태가 됩니다.#{{LuckSmall}} 행운 10 이상일 때 100% 확률"}, -- Virgo
