...
EID.descriptions[languageCode].collectibles={
	...
	{"75", "박사학위", "↑ {{Heart}}빨간하트 +2#{{Pill}}알약을 하나 드랍합니다.#사용하지 않은 알약의 효과를 알 수 있습니다.#부정적인 알약 효과가 등장하지 않습니다.#헌혈기 및 {{Collectible135}}IV Bag 사용 시 동전 1~2개를 추가로 드랍합니다."}, -- PHD
	...
	{"116", "9볼트 건전지", "획득 시 액티브 아이템 충전량을 모두 충전합니다.#액티브 아이템 사용 시 충전량을 한칸 보존합니다.#1칸짜리 액티브 아이템의 경우 적이 있는 방에서 15초의 충전 쿨타임을 가집니다.#충전형 액티브 아이템의 경우 쿨타임의 절반을 보존합니다."}, -- 9 Volt
	...
	{"134", "구피의 꼬리", "방 클리어 보상이 33%의 확률로 상자로 바뀝니다.#방 클리어 보상이 33%의 확률로 등장하지 않습니다."}, -- Guppy's Tail
	...
	{"200", "엄마의 아이섀도우", "{{Charm}} 10%의 확률로 적을 매혹시키는 공격이 나갑니다.#!!! {{LuckSmall}}행운 수치 비례"}, -- Mom's Eyeshadow
	{"201", "철괴", "↑ {{DamageSmall}}공격력 +0.3#{{Confusion}} 10%의 확률로 적을 혼란시키는 공격이 나갑니다.#!!! {{LuckSmall}}행운 수치 비례"}, -- Iron Bar
	...
	{"393", "독뱀의 키스", "{{Poison}} 확률적으로 적을 중독시키는 공격이 나갑니다.#중독된 적이 죽을때 20% 확률로 {{BlackHeart}}블랙하트가 드랍됩니다."}, -- Serpent's Kiss
