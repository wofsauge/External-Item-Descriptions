...
EID.descriptions[languageCode].collectibles={
	...
	{"230", "아바돈", "최대 체력이 모두 제거됩니다.#↑ {{BlackHeart}}블랙하트 +6#↑ {{DamageSmall}}공격력 +1.5#↑ {{SpeedSmall}}이동속도 +0.2#12.5%의 확률로 적을 {{Fear}}도망가게 하는 공격이 나갑니다.#!!! {{LuckSmall}}행운 수치 비례: 행운 85 이상일 때 100% 확률"}, -- Abaddon
...
EID.descriptions[languageCode].trinkets={
	...
	{"48", "찢어진 페이지", "피격 시 5%의 확률로 방 안의 모든 적에게 40의 피해를 줍니다.#!!! {{LuckSmall}}행운 수치 비례: 행운 60 이상일 때 100% 확률"}, -- A Missing Page
