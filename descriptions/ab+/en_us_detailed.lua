...
EID.descriptions["en_us_detailed"].collectibles={{"1","","+0.7 Tears up."},
...
{"162","","Luck dependant chance to grant the Book of Shadows effect for 7 seconds on taking damage. #Base chance of activate is 20%, capping at 100% at 27 or higher luck."},
...
{"251","","Spawns a random card. #Allows the player to hold two cards. #Replaces all cards with pills. #The only exception is the single pill dropped by the item Caffeine Pill. #By default, the key to cycle between cards is Control (PC), R2 (PlayStation) or RT (XBox)."},
{"252","","Spawns a random pill. #Allows the player to hold two pills. #Replaces all pills with cards. #By default, the key to cycle between pills is Control (PC), R2 (PlayStation) or RT (XBox)."},
...
{"1", "", "Drops a penny, nickel or dime upon taking damage. #This effect not reduced by playing as the Keeper like other similar items are."},
