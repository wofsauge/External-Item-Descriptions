...
EID.descriptions[languageCode].collectibles={
	{"1", "悲伤洋葱", "↑ {{TearsSmall}} 射速+0.7"},
	{"2", "内眼", "↓ {{TearsSmall}} 射速修正x0.48#↓ {{TearsSmall}} 射击延迟+3#角色一次发射3颗泪弹"},
	{"3", "弯勺魔术", "追踪泪弹"},
	{"4", "柯吉猫的头", "↑ {{DamageSmall}} 伤害+0.5#↑ {{DamageSmall}} 伤害修正x1.5"},
	{"5", "我的镜像", "↑ {{RangeSmall}} 射程+1.5#↑ 泪弹高度+1#↑ {{ShotspeedSmall}} 弹速+0.6#↑ +1泪弹高度#泪弹具有回旋效果"},
	{"6", "小号", "↑ {{TearsSmall}} 射速+1.5#↑ 泪弹高度+0.76#↓ {{RangeSmall}} 射程-17.62"},
	{"7", "殉道者之血", "↑ {{DamageSmall}} 伤害+1"},
	{"8", "波比兄弟", "发射普通泪弹#泪弹造成3.5点伤害"},
	{"9", "粪臭素", "所有敌对苍蝇变得友好"},
	{"10", "苍蝇光环", "环绕苍蝇+2#阻挡弹幕"},
	{"11", "1UP!", "↑ 生命+1#角色重生后回满血"},
	{"12", "魔法蘑菇", "↑ {{Heart}} +1心之容器#↑ {{SpeedSmall}} 移速+0.3#↑ {{DamageSmall}} 伤害+0.3#↑ {{DamageSmall}} 伤害修正x1.5#↑ {{RangeSmall}} 射程+5.25#↑ 泪弹高度+0.5#体型变大#{{HealingRed}} 回满血"},
	{"13", "病毒", "↓ {{SpeedSmall}} 移速-0.1#{{Poison}} 接触敌人使其中毒#{{BlackHeart}} 中毒的敌人死亡时20%几率掉1黑心"},
	{"14", "过量类固醇", "↑ {{SpeedSmall}} 移速+0.6#↑ {{RangeSmall}} 射程+5.25#↑ 泪弹高度+0.5"},
	...
	{"25", "早餐", "↑ {{Heart}} +1心之容器"},
	{"26", "烂肉", "↑ {{Heart}} +1心之容器"},
	{"27", "木头勺子", "↑ {{SpeedSmall}} 移速+0.3"},
	{"28", "皮带", "↑ {{SpeedSmall}} 移速+0.3"},
	{"29", "妈妈的内裤", "↑ {{RangeSmall}} 射程+5.25#↑ 泪弹高度+0.5"},
	{"30", "妈妈的高跟鞋", "↑ {{RangeSmall}} 射程+5.25#↑ 泪弹高度+0.5"},
	{"31", "妈妈的口红", "↑ {{RangeSmall}} 射程+5.25#↑ 泪弹高度+0.5"},
	{"32", "铁丝衣架", "↑ {{TearsSmall}} 射速+0.7"},
	{"33", "圣经", "{{Timer}} 在当前房间飞行#{{MomsHeart}} 立即击杀妈腿和妈心#{{Warning}} 当对撒但使用时, 角色会死亡"},
	{"34", "彼列之书", "{{AngelDevilChance}} 持有时, 恶魔房/天使房几率+12.5%#{{Timer}} 使用后, 在当前房间中获得:#↑ {{DamageSmall}} 伤害+2"},
	...
	{"46", "幸运脚", "↑ {{LuckSmall}} 幸运+1#房间清理奖励几率+8%#赌博时赢的几率更高"},
	{"47", "胎儿博士的遥控器", "{{Collectible168}} 使用时, 瞄准十字准星#1.5秒后导弹降落在准星处#造成20x角色伤害"},
	{"48", "丘比特之箭", "穿刺泪弹"},
	{"49", "嗖-哒-呜！", "下一次泪弹由激光取代#在0.9秒内造成26x角色伤害"},
	{"50", "史蒂文", "↑ {{DamageSmall}} 伤害+1"},
	{"51", "五芒星", "↑ {{DamageSmall}} 伤害+1#{{AngelDevilChance}} 恶魔房/天使房几率+10%"},
	...
	{"70", "生长激素", "↑ {{SpeedSmall}} 移速+0.4#↑ {{DamageSmall}} 伤害+1"},
	{"71", "小蘑菇", "↑ {{SpeedSmall}} 移速+0.3#↑ 泪弹高度+1.5#↑ 体型变小#↓ {{RangeSmall}} 射程-4.25#泪弹高度和射程的总体影响为射程稍微提升"},
	{"72", "念珠", "{{SoulHeart}} +3魂心#{{Collectible33}} 圣经添加至所有道具池"},
	{"73", "肉块", "1级: 环绕物#2级: 可发射泪弹的环绕物#3级: 食肉男孩#4级: 超级食肉男孩"},
	{"74", "25美分", "{{Coin}} +25硬币"},
	{"75", "药学博士证", "{{HealingRed}} 治疗2红心#{{Pill}} 生成1胶囊#{{Pill}} 将负面胶囊变为正面的#从{{BloodDonationMachine}} 献血机和{{Collectible135}}献血袋得到的{{Coin}}硬币更多"},
	{"76", "X光透视", "{{SecretRoom}} 打开所有隐藏房入口"},
	{"77", "彩虹独角兽", "{{Timer}} 在6秒内获得:#↑ {{SpeedSmall}} 移速+0.28#无敌#角色无法发射泪弹, 但每秒造成40点接触伤害"},
	{"78", "启示录", "{{SoulHeart}} +1魂心#{{AngelDevilChance}} 持有时, 恶魔房/天使房几率+17.5%#使用后, 本层头目由天启骑士取代的几率更高"},
	{"79", "咒印", "↑ {{SpeedSmall}} 移速+0.2#↑ {{DamageSmall}} 伤害+1#{{SoulHeart}} +1魂心"},
	{"80", "契约", "↑ {{TearsSmall}} 射速+0.7#↑ {{DamageSmall}} 伤害+0.5#{{SoulHeart}} +2魂心"},
	{"81", "嗝屁猫", "↑ 生命+9#死亡时, 角色以1心之容器重生#{{Warning}} 拾起时, 将角色的心之容器设置为1个"},
	{"82", "深渊领主", "↑ {{SpeedSmall}} 移速+0.3#飞行"},
	{"83", "钉子", "使用后:#{{SoulHeart}} +1魂心#{{Timer}} 在当前房间中获得:#↑ {{DamageSmall}} 伤害+0.7#↓ {{SpeedSmall}} 移速-0.18#角色每秒造成40点接触伤害#角色可粉碎接触的岩石"},
	...
	{"90", "小石头", "↑ {{TearsSmall}} 射速+0.2#↑ {{DamageSmall}} 伤害+1#↓ {{SpeedSmall}} 移速-0.2"},
	{"91", "探窟帽", "揭示相邻房间的类型#{{SecretRoom}} 可以揭示隐藏房和超级隐藏房"},
	{"92", "超级绷带", "↑ {{Heart}} +1心之容器#{{HealingRed}} 治疗1红心#{{SoulHeart}} +2魂心"},
	{"93", "游戏掌机", "{{Timer}} 在6.5秒内获得:#无敌#角色无法发射, 但每秒造成40点接触伤害#{{HalfHeart}} 击杀2个敌人治疗半红心#{{Fear}} 使房间中的所有敌人恐惧"},
	...
	{"101", "光环", "↑ {{Heart}} +1心之容器#↑ {{SpeedSmall}} 移速+0.3#↑ {{TearsSmall}} 射速+0.2#↑ {{DamageSmall}} 伤害+0.3#↑ {{RangeSmall}} 射程+0.25#↑ 泪弹高度+0.5"},
	...
	{"108", "圣饼", "大多数伤害降低为半心"},
	{"109", "金钱=力量", "↑ {{DamageSmall}} 角色每持有{{Coin}}1硬币, 伤害+0.04"},
	{"110", "妈妈的美瞳", "↑ {{RangeSmall}} +0.25射程#↑ 泪弹高度+0.5#20%几率发射石化泪弹#{{Luck}} 幸运20: 50%几率"},
	...
	{"118", "硫磺火", "↓ {{TearsSmall}} 射速修正x0.33#{{Chargeable}} 角色的泪弹由可蓄力的鲜血激光取代#{{Damage}} 在0.9秒内造成13x角色伤害"},
	{"119", "血袋", "↑ {{Heart}} +1心之容器#↑ {{SpeedSmall}} 移速+0.3#{{HealingRed}} 治疗4红心"},
	{"120", "怪异蘑菇(小)", "↑ {{SpeedSmall}} 移速+0.3#↑ {{TearsSmall}} 射速+1.7#↓ {{DamageSmall}} 伤害修正x0.9#↓ {{DamageSmall}} 伤害-0.4"},
	{"121", "怪异蘑菇(大)", "↑ {{EmptyHeart}} +1空心之容器#↑ {{DamageSmall}} 伤害+0.3#↑ {{RangeSmall}} 射程+0.25#↑ 泪弹高度+0.5#↓ {{SpeedSmall}} 移速-0.1"},
	{"122", "巴比伦大淫妇", "当不多于半红心时:#↑ {{SpeedSmall}} 移速+0.3#↑ {{DamageSmall}} 伤害+1.5"},
	{"123", "怪物手册", "{{Timer}} 在当前房间中生成1个随机跟班"},
	{"124", "死海古卷", "触发1次随机主动道具的效果"},
	{"125", "波比炸弹", "{{Bomb}} +5炸弹#追踪炸弹"},
	{"126", "剃刀片", "使用后:#↑ {{DamageSmall}} 在当前房间中伤害+1.2#{{Warning}} 对角色造成1心伤害#{{Heart}} 优先消耗红心"},
	{"127", "遗忘药", "重置整层"},
	{"128", "孤独一生", "远范围苍蝇环绕物#每秒造成30点接触伤害"},
	{"129", "桶装猪油", "↑ {{EmptyHeart}} +2空心之容器#↓ {{SpeedSmall}} 移速-0.2#{{HealingRed}} 治疗半红心"},
	...
	{"138", "圣痕", "↑ {{Heart}} +1心之容器#↑ {{DamageSmall}} 伤害+0.3"},
	...
	{"143", "混合麻药", "↑ {{SpeedSmall}} 移速+0.3#↑ {{ShotspeedSmall}} 弹速+0.2"},
	{"144", "乞丐朋友", "{{Coin}} 捡起附近的硬币#每3-4硬币生成1随机掉落物"},
	{"145", "嗝屁猫的头", "生成2-4只蓝苍蝇"},
	{"146", "祈祷卡", "{{EternalHeart}} +1永恒之心"},
	{"147", "残损铁镐", "{{Timer}} 在当前房间中角色可粉碎接触的岩石和隐藏房的墙"},
	{"148", "害虫横行", "受伤时, 生成1-3只蓝苍蝇"},
	{"149", "吐根酊", "↑ {{DamageSmall}} +40伤害#↓ {{TearsSmall}} 射速修正x0.5#↓ {{Tears}} 射击延迟+10#角色的泪弹呈弧形射出#{{Poison}} 泪弹会爆炸并使击中的敌人中毒"},
	{"150", "严厉的爱", "{{Damage}} 10%几率发射牙齿, 造成3.2x角色伤害#{{Luck}} 幸运9: 100%几率"},
	{"151", "虫群复击", "泪弹击中敌人时有1/6几率生成1只蓝苍蝇"},
	{"152", "科技II", "#↓ {{TearsSmall}} 射速修正x0.5#↓ {{DamageSmall}} 伤害修正x0.65#角色右泪弹弹由持续激光取代#{{Damage}} 激光每秒造成3x角色伤害"},
	{"153", "变异蜘蛛", "↓ {{Tears}} 射速修正x0.48#↓ {{Tears}} 射击延迟+3#角色同时发射4颗泪弹"},
	{"154", "化学剥皮法", "↑ {{DamageSmall}} 左眼伤害+2"},
	{"155", "窥眼", "在房间中四处漂浮#每秒造成17点接触伤害"},
	{"156", "修女服", "{{Battery}} 受伤时, 为主动道具回复1格充能"},
	{"157", "嗜血", "↑ {{DamageSmall}} 受伤时, 伤害增加#每层能叠加6次#效果在当前层持续"},
	{"158", "水晶球", "生成1{{SoulHeart}}魂心, {{Rune}}符文或{{Card}}卡牌#{{Timer}} 揭示全图({{SuperSecretRoom}}超级隐藏房除外)"},
	{"159", "夜之幽魂", "灵体泪弹#飞行"},
	...
	{"165", "九尾鞭", "↑ {{DamageSmall}} 伤害+1#↑ {{ShotspeedSmall}} 弹速+0.23"},
	{"166", "二十面骰", "重置房间中的所有掉落物"},
	{"167", "小丑宝宝", "以V字形发射2颗泪弹#泪弹造成4点伤害"},
	{"168", "史诗胎儿博士", "发射泪弹改为瞄准十字准星#1.5秒后火箭降落在准星处#{{Damage}} 火箭造成20x角色伤害"},
	{"169", "巨人独眼", "#↑ {{DamageSmall}} 伤害+4#↑ {{DamageSmall}} 伤害修正x2#↓ {{TearsSmall}} 射速修正x0.48#↓ {{Tears}} 射击延迟+3#泪弹击杀敌人伤害溢出时会穿透敌人前进"},
	...
	{"176", "干细胞", "↑ {{Heart}} +1心之容器#↑ {{ShotspeedSmall}} 弹速+0.16"},
	...
	{"182", "圣心", "↑ {{Heart}} +1心之容器#↑ {{DamageSmall}} 伤害修正x2.3#↑ {{DamageSmall}} 伤害+1#↑ {{RangeSmall}} 射程+0.38#↑ 泪弹高度+0.75#↓ {{TearsSmall}} 射速-0.4#↓ {{ShotspeedSmall}} 弹速-0.25#{{HealingRed}} 回满血#追踪泪弹"},
	{"183", "牙签", "↑ {{TearsSmall}} 射速+0.7#↑ {{ShotspeedSmall}} 弹速+0.16"},
	{"184", "圣杯", "↑ {{Heart}} +1心之容器#飞行"},
	{"185", "死鸽", "灵体泪弹#飞行"},
	{"186", "血之权利", "对每个敌人造成40点伤害#{{Warning}} 对角色造成1心伤害#{{Heart}} 优先消耗红心"},
	{"187", "嗝屁猫的毛球", "移动时会使毛球摇动#毛球击杀敌人时变大#球越大, 造成的伤害越高"},
	{"188", "亚伯", "与角色移动互为镜像#向角色发射泪弹#泪弹造成3.5点伤害"},
	{"189", "超级食肉男孩死忠粉", "↑ {{Heart}} +1心之容器#↑ {{SpeedSmall}} 移速+0.2#↑ {{TearsSmall}} 射速+0.2#↑ {{DamageSmall}} 伤害+0.3#↑ {{RangeSmall}} 射程+0.5#↑ 泪弹高度+1#{{HealingRed}} 回满血"},
	{"190", "烟火盛宴", "{{Bomb}} +99炸弹"},
	{"191", "3美元纸币", "角色的泪弹每2-3秒获得随机效果"},
	{"192", "心灵感应傻瓜式教程", "{{Timer}} 在当前房间中泪弹有追踪效果"},
	{"193", "生肉！", "↑ {{Heart}} +1心之容器#↑ {{DamageSmall}} 伤害+0.3"},
	{"194", "魔力八号球", "↑ {{ShotspeedSmall}} 弹速+0.16#{{Card}} 生成1卡牌"},
	{"195", "妈妈的零钱包", "{{Pill}} 生成4胶囊"},
	{"196", "挤压玩具", "↑ {{TearsSmall}} 射速+0.4#{{SoulHeart}} 生成2魂心"},
	{"197", "耶稣果汁", "↑ {{DamageSmall}} 伤害+0.5#↑ {{RangeSmall}} 射程+0.25#↑ 泪弹高度+0.5"},
	{"198", "盒子", "每种掉落物生成1个"},
	{"199", "妈妈的钥匙", "{{Key}} +2钥匙#箱子中的掉落物更多"},
	{"200", "妈妈的眼影", "{{Charm}} 10%几率发射魅惑泪弹#{{Luck}} 幸运27: 100%几率"},
	{"201", "铁块", "↑ {{DamageSmall}} 伤害+0.3#{{Confusion}} 10%几率发射眩晕泪弹#{{Luck}} 幸运27: 100%几率"},
	{"202", "弥达斯之触", "接触敌人时使其石化并变成金块#角色根据持有硬币量造成接触伤害#{{Coin}} 击杀金敌人会生成硬币#角色生成的大便为金大便的几率更高"},
	{"203", "慈善捆绑包", "所有掉落物成对出现(若可能)"},
	{"204", "挎包", "受伤时, 50%几率生成1随机掉落物"},
	{"205", "锋利插头", "{{Battery}} 使用未充能的主动道具时, 花费2心使其完全充能#只有道具完全没有充能时有效"},
	{"206", "断头台", "↑ {{Tears}} 射击延迟-1#↑ {{DamageSmall}} 伤害+1#角色的头变成环绕物, 不会承受受伤, 每秒造成105点接触伤害"},
	{"207", "绷带球", "1级: 环绕物#{{Charm}} 2级: 发射魅惑泪弹的环绕物#{{Charm}} 3级: 绷带女孩#{{Charm}} 4级: 超级绷带女孩"},
	{"208", "冠军腰带", "↑ {{DamageSmall}} 伤害+1#精英敌人几率从5%增至20%#不增加精英头目的几率"},
	{"209", "屁股炸弹", "{{Bomb}} +5炸弹#{{Confusion}} 爆炸会使房间中所有敌人眩晕并造成10点伤害"},
	{"210", "狸猫树叶", "完全不行动1秒后, 角色无敌"},
	{"211", "蜘蛛宝宝", "受伤时, 生成1-2只蓝蜘蛛"},
	{"212", "嗝屁猫的项圈", "死亡时, 50%几率以半心重生"},
	{"213", "丢失的隐形眼镜", "↓ {{ShotspeedSmall}} 弹速-0.15#角色的泪弹能摧毁敌人的弹幕"},
	{"214", "贫血", "↑ {{RangeSmall}} 射程+5#{{Timer}} 受伤时, 在房间中留下血迹#血迹每秒造成6点伤害"},
	{"215", "山羊头", "{{AngelDevilChance}} 100%恶魔房/天使房几率"},
	{"216", "仪式法袍", "↑ {{DamageSmall}} 伤害+1#{{BlackHeart}} +3黑心"},
	...
	{"222", "反重力", "↑ {{TearsSmall}} 射击延迟-2#按住发射键会使泪弹悬空#松开后, 所有泪弹会向发射方向继续前进"},
	{"223", "纵火狂", "{{Bomb}} +5炸弹#免疫爆炸, 岩石波, 践踏的伤害#{{HealingRed}} 受爆炸击中时治疗1红心"},
	{"224", "柯吉猫的身体", "↑ {{TearsSmall}} 射击延迟-1#↑ {{TearsizeSmall}} 泪弹尺寸x1.2#↓ {{RangeSmall}} 射程-10#泪弹击中后会分裂为4颗#分裂的泪弹造成的伤害减半"},
	{"225", "兽性面具", "{{SoulHeart}} 受伤时几率生成1魂心#{{HalfHeart}} 敌人死亡时几率掉落1半红心"},
	{"226", "黑莲花", "↑ {{Heart}} +1心之容器#{{SoulHeart}} +1魂心#{{BlackHeart}} +1黑心"},
	{"227", "小猪存钱罐", "{{Coin}} +3硬币#受伤时, 生成1-2硬币"},
	{"228", "妈妈的香水", "↑ {{TearsSmall}} 射击延迟-1#{{Fear}} 15%几率发射恐惧泪弹"},
	{"229", "萌死戳的肺", "#↓ {{TearsSmall}} 射击延迟x4.3#{{Chargeable}} 泪弹可蓄力并在松开时散射"},
	{"230", "亚巴顿", "↑ {{SpeedSmall}} 移速+0.2#↑ {{DamageSmall}} 伤害+1.5#↓ {{EmptyHeart}} 移除所有心之容器#{{BlackHeart}} +6黑心#{{Fear}} 15%几率发射恐惧泪弹"},
	{"231", "焦油球", "{{Slow}} 10%几率发射减速泪弹#{{Luck}} 幸运18: 100%几率#{{Slow}} 角色会留下减速水迹"},
	{"232", "怀表", "↑ {{SpeedSmall}} 移速+0.3#{{Slow}} 受伤时, 使房间中的所有敌人永久减速"},
	{"233", "小小星球", "#↑ 泪弹高度+7#灵体泪弹#角色的泪弹环绕在角色周围"},
	{"234", "害虫横行II", "击杀敌人时, 生成1只蓝蜘蛛"},
	{"235", "", "<道具不存在>"},
	{"236", "大肠杆菌", "接触敌人时, 使其变成大便"},
	{"237", "死神之触", "↑ {{DamageSmall}} 伤害+1.5#↑ {{TearsizeSmall}} 泪弹尺寸x2#↓ {{TearsSmall}} 射速-0.3#穿刺泪弹"},
	...
	{"249", "额外选择", "允许角色击败头目后从2件道具中选择"},
	{"250", "炸弹买一送一", "{{Bomb}} 所有炸弹掉落物变成一对炸弹"},
	{"251", "新手牌组", "{{Card}} 拾起时, 生成1卡牌#角色能携带2卡牌#将所有胶囊变成卡牌"},
	{"252", "小药袋", "{{Pill}} 拾起时, 生成1胶囊#角色能携带2胶囊#将所有卡牌变成胶囊"},
	{"253", "魔法血痂", "↑ {{Heart}} +1心之容器#↑ {{LuckSmall}} 幸运+1"},
	{"254", "血块", "↑ {{DamageSmall}} 左眼伤害+1#↑ {{RangeSmall}} 左眼射程+5#↑ 泪弹高度+0.5"},
	{"255", "螺丝", "↑ {{TearsSmall}} 射速+0.5#↑ {{ShotspeedSmall}} 弹速+0.2"},
	...
	{"259", "暗物质", "↑ {{DamageSmall}} 伤害+1#{{Fear}} 33%几率发射恐惧泪弹# {{Luck}} 幸运20: 100%几率"},
	{"260", "黑蜡烛", "{{CurseBlind}} 免疫诅咒#{{BlackHeart}} +1黑心#{{AngelDevilChance}} 恶魔房/天使房几率+15%"},
	{"261", "眼球突出", "↑ {{DamageSmall}} 伤害修正x2#↓ 泪弹前进越远伤害越低"},
	{"262", "遗失的书页2", "{{BlackHeart}} +1黑心#受伤至1心时, 对房间中所有敌人造成40点伤害"},
	{"263", "", "<道具不存在>"},
	...
	{"278", "黑暗乞丐", "{{Heart}} 捡起附近的红心#{{SoulHeart}} 每捡起1.5红心, 生成1魂心, 黑心或蜘蛛"},
	...
	{"297", "潘多拉魔盒", "{{NoLB}}根据所在层生成奖励:#1章1: 2{{SoulHeart}}; 1章2: 2{{Bomb}}+2{{Key}}#{{NoLB}}2章1: 1{{BossRoom}}道具; 2章2: 2章1+2{{SoulHeart}}#3章1: 4{{SoulHeart}}; 3章2: 20{{Coin}}#4章1: 2{{BossRoom}}道具; 4章2: {{Collectible33}}圣经#???/虚空: 无#阴间: 1{{DevilRoom}}道具+1{{BlackHeart}}; 教堂: 1{{AngelRoom}}道具+1{{EternalHeart}}#暗室: 解锁{{Collectible523}}搬家盒; 玩具箱: 1{{Coin}}"},
	{"298", "独角兽的残角", "{{Timer}} 在6秒内获得:#↑ {{SpeedSmall}} 移速+0.28#无敌#角色无法发射(也没有接触伤害)"},
	{"299", "金牛座", "#↓ {{SpeedSmall}} 移速-0.3#↑ {{SpeedSmall}} 在有敌人的房间中, 移速缓慢增加#移速达到2时, 角色无敌并造成接触伤害, 持续5秒#随后, 在当前房间中失去金牛座移速加成"},
	{"300", "白羊座", "↑ {{SpeedSmall}} 移速+0.25#移速大于0.85时, 对敌人造成18点接触伤害"},
	{"301", "巨蟹座", "{{SoulHeart}} +3魂心#受伤后, 在当前房间中后续所受伤害降低为半心"},
	{"302", "狮子座", "体型变大#粉碎接触的岩石"},
	{"303", "室女座", "受伤时, 几率获得10秒无敌#{{Luck}} 幸运10: 100%几率#将负面胶囊变成正面的"},
	{"304", "天秤座", "+6{{Coin}}硬币, {{Bomb}}炸弹, {{Key}}钥匙#平衡角色属性#后续的属性变化会分散到各个属性"},
	{"305", "天蝎座", "{{Poison}} 有毒泪弹"},
	{"306", "人马座", "↑ {{SpeedSmall}} 移速+0.2#穿刺泪弹"},
	{"307", "摩羯座", "↑ {{Heart}} +1心之容器#↑ {{SpeedSmall}} 移速+0.1#↑ {{TearsSmall}} 射击延迟-1#↑ {{DamageSmall}} 伤害+0.5#↑ {{RangeSmall}} 射程+1.5#+1{{Coin}}硬币, {{Bomb}}炸弹, {{Key}}钥匙"},
	{"308", "宝瓶座", "角色留下水迹#水迹每秒造成6点伤害"},
	{"309", "双鱼座", "↑ {{TearsSmall}} 射击延迟-1#↑ {{TearsizeSmall}} 泪弹尺寸x1.25#提高泪弹击退力"},
	{"310", "夏娃的睫毛膏", "↑ {{DamageSmall}} 伤害修正x2#↓ {{TearsSmall}} 射速修正x0.5#↓ {{ShotspeedSmall}} 弹速-0.5"},
	{"311", "犹大的影子", "{{Player12}} 死亡时, 以伤害修正x2的犹大之影重生"},
	{"312", "抹大拉的蝴蝶结", "↑ {{Heart}} +1心之容器#所有红心治疗量翻倍"},
	{"313", "神圣屏障", "阻挡每个房间第一次受到的伤害"},
	{"314", "霹雳大腿", "↑ {{Heart}} +1心之容器#↓ {{SpeedSmall}} 移速-0.4#角色摧毁接触的岩石"},
	...
	{"319", "该隐的另一只眼", "在房间中四处漂浮#与角色同方向射击, 造成1x角色伤害"},
	{"320", "???唯一的朋友", "可控制的苍蝇#每秒造成37.5点接触伤害"},
	{"321", "参孙的脚镣", "可拖动的球, 能够摧毁岩石#每秒造成10.7点接触伤害"},
	{"322", "蒙戈宝宝", "复制其他跟班的泪弹效果#造成2x所复制跟班的伤害#若没有跟班, 则发射普通的3.5伤害泪弹"},
	{"323", "以撒的泪盆", "向8个方向发射泪弹#泪弹复制角色的泪弹的效果#发射泪弹时充能"},
	{"324", "未定义", "传送至{{TreasureRoom}}道具房, {{SecretRoom}}隐藏房, {{SuperSecretRoom}}超级隐藏房, 或{{ErrorRoom}}错误房"},
	...
	{"328", "底片", "若不多于半红心时受伤, 则对房间中所有敌人造成40点伤害"},
	{"329", "鲁多维科科技", "角色的泪弹由1颗巨大的可控泪弹取代"},
	{"330", "豆奶", "↑ {{TearsSmall}} 射速修正x4#↑ {{TearsSmall}} 发射延迟-2#↓ {{DamageSmall}} 伤害修正x0.2#↓ {{TearsizeSmall}} 泪弹尺寸x0.5"},
	{"331", "神性", "↑ {{DamageSmall}} 伤害+0.5#↑ {{RangeSmall}} 射程+1.2#↓ {{TearsSmall}} 射速-0.3#↓ {{ShotspeedSmall}} 弹速-0.3#追踪泪弹#{{Damage}} 泪弹具有光环, 每秒造成4.5x角色伤害"},
	{"332", "拉撒路的绷带", "{{Player11}} 死亡时, 以'复活的拉撒路'重生"},
	{"333", "思想", "获得完整的地图效果"},
	{"334", "肉体", "↑ {{Heart}} +3心之容器"},
	{"335", "灵魂", "{{SoulHeart}} +2魂心#获得排斥敌人和弹幕的光环"},
	{"336", "烂洋葱", "↑ {{RangeSmall}} 射程+0.25#↑ {{Tearsize}} 泪弹尺寸x1.5#↓ -0.5泪弹高度#↓ {{ShotspeedSmall}} 弹速-0.4#穿刺+灵体泪弹"},
	{"337", "损坏的怀表", "{{Slow}} 每4个房间减速一次#13%几率由加速取代"},
	{"338", "回旋镖", "可投掷的回旋镖#使敌人石化并造成2x角色伤害#可带回物品"},
	{"339", "安全别针", "↑ {{RangeSmall}} 射程+5.25#↑ 泪弹高度+0.5#↑ {{ShotspeedSmall}} 弹速+0.16#{{BlackHeart}} +1黑心"},
	{"340", "咖啡因片", "↑ {{SpeedSmall}} 移速+0.3#↑ 体型变小#{{Pill}} 生成1随机胶囊"},
	{"341", "撕碎的照片", "↑ {{TearsSmall}} 射速+0.7#↑ {{ShotspeedSmall}} 弹速+0.16"},
	{"342", "蓝盖蘑菇", "↑ {{Heart}} +1心之容器#↑ {{TearsSmall}} 射速+0.7#↓ {{ShotspeedSmall}} 弹速-0.16"},
	{"343", "弹簧锁钥匙", "↑ {{LuckSmall}} 幸运+1#{{SoulHeart}} +1魂心#{{Key}} 生成2钥匙"},
	{"344", "火柴盒", "{{BlackHeart}} +1黑心#{{Bomb}} 生成3炸弹"},
	{"345", "合成油脂", "↑ {{DamageSmall}} 伤害+1#↑ {{RangeSmall}} 射程+5.25#↑ 泪弹高度+0.5"},
	{"346", "零食", "↑ {{Heart}} +1心之容器"},
	...
	{"368", "溢泪症", "↑ {{Tears}} 持续向单方向射击会逐渐降低射击延迟, 最多降至50%"},
	{"369", "连续统", "↑ {{RangeSmall}} 射程+2.25#↑ 泪弹高度+1.5#灵体泪弹#泪弹会过屏幕, 从另一边回来"},
	{"370", "玩偶先生", "↑ {{TearsSmall}} 射速+0.7#↑ {{RangeSmall}} 射程+5.25#↑ 泪弹高度+0.5#{{UnknownHeart}} 生成3随机心"},
	...
	{"373", "死亡之眼", "↑ {{DamageSmall}} 每次成功击中敌人伤害+25%(最高+100%)#未击中时, 几率重置修正"},
	...
	{"379", "双瞳", "↑ {{TearsizeSmall}} 泪弹尺寸x2#灵体泪弹"},
	{"380", "充钱游戏", "{{Coin}} +5硬币#{{Coin}} 单钥匙门必须用硬币打开而不是钥匙"},
	{"381", "伊甸的祝福", "↑ {{TearsSmall}} 射速+0.7#下一局开始时, 获得1随机道具"},
	...
	{"386", "十二面骰", "将障碍物重置为其他随机类型的障碍物(大便, 罐子, TNT, 红大便, 岩石等)"},
	...
	{"393", "蛇蝎之吻", "{{Poison}} 15%几率发射有毒泪弹#{{Poison}} 使接触的敌人中毒#{{BlackHeart}} 中毒敌人死亡时, 20%几率掉落黑心"},
	{"394", "十字准星", "↑ {{TearsSmall}} 射速+0.7#↑ {{RangeSmall}} 射程+3.15#↑ 泪弹高度+0.3#角色自动向地上的可控红色标记发射泪弹"},
	{"395", "科技X", "{{Chargeable}} 角色的泪弹由可蓄力的激光环取代#激光环尺寸随蓄力时间增加"},
	{"396", "心室手术刀", "创造最多2个传送门#可以在不同房间放置"},
	{"397", "牵引光束", "↑ {{TearsSmall}} 射速+0.5#↑ {{RangeSmall}} 射程+5.25#↑ 泪弹高度+0.5#↑ {{ShotspeedSmall}} 弹速+0.16#角色的泪弹角色面前的受光束指引"},
	{"398", "神体蘑菇", "泪弹能使敌人缩小#缩小的敌人可以被踩死"},
	{"399", "虚空之喉", "↑ {{DamageSmall}} 伤害+1#{{Chargeable}} 持续发射泪弹2.35秒后, 松开发射键会产生1个黑硫磺火圈#黑圈在2秒内造成30x角色伤害#{{BlackHeart}} 被黑圈击杀的敌人有5%几率掉落1黑心"},
	{"400", "命运之矛", "在角色面前生成一根矛#{{Fear}} 每秒造成约8.57x角色伤害, 几率使接触到的敌人恐惧"},
	{"401", "爆炸物", "25%几率发射粘性炸弹泪弹#泪弹击中时不造成伤害"},
	{"402", "混沌", "底座道具会从随机道具池产生#生成1-6随机掉落物"},
	{"403", "蜘蛛模组", "显示泪弹伤害和所有敌人的血条#接触敌人时, 施加随机状态效果#清理房间后, 几率生成蓝蜘蛛或小电池"},
	...
	{"407", "纯洁", "↑ 根据光环颜色对角色属性进行增强#受伤时, 移除光环, 在下个房间获得新的光环#{{ColorYellow}}黄色{{CR}} = ↑ {{SpeedSmall}} 移速+0.5#{{ColorBlue}}蓝色{{CR}} = ↑ {{TearsSmall}} 射击延迟-4#{{ColorRed}}红色{{CR}} = ↑ {{DamageSmall}} 伤害+4#{{ColorOrange}}橙色{{CR}} = ↑ {{Range}} 射程+7.5, ↑ 泪弹高度+1"},
	...
	{"411", "血嗜", "↑ {{DamageSmall}} 击杀敌人时, 在当前房间中伤害+0.5#最多击杀10个敌人伤害+5"},
	{"412", "恶魔受胎", "受伤15次, 30次, 60次, 90次时, 永久获得1个恶魔跟班#最多产生4个跟班"},
	{"413", "圣灵受胎", "每拾起15次心, 永久获得1个天使跟班并生成1魂心#最多产生5个跟班"},
	{"414", "更多选择", "{{TreasureRoom}} 允许道具房道具二选一"},
	{"415", "光明之冠", "{{SoulHeart}} +2魂心#若角色无不满的心之容器:#↑ {{DamageSmall}} 伤害修正x2#↑ {{RangeSmall}} 射程+5.25#↑ 泪弹高度+0.5#↓ {{ShotspeedSmall}} 弹速-0.3#受伤后, 效果消失"},
	{"416", "深口袋", "允许角色携带2卡牌/胶囊/符文"},
	{"417", "魅魔", "在房间中漂浮的跟班, 产生伤害光环, 每秒造成1.29x角色伤害#↑ {{DamageSmall}} 站在光环中伤害修正x1.5"},
	{"418", "水果蛋糕", "每颗泪弹都有不同效果"},
	{"419", "传送2.0", "传送至另1个未探索的随机房间#等级: {{Room}}>{{BossRoom}}>{{SuperSecretRoom}}>{{Shop}}>{{TreasureRoom}}>{{SacrificeRoom}}> {{DiceRoom}}>{{Library}}>{{CursedRoom}}>{{MiniBoss}}>{{ChallengeRoom}}>{{IsaacsRoom}}{{BarrenRoom}}> {{ArcadeRoom}}>{{ChestRoom}}>{{SecretRoom}}>{{DevilRoom}}{{AngelRoom}}>{{ErrorRoom}}"},
	{"420", "黑色粉末", "在地上走1个圈会产生五角星符号, 4秒内造成130点接触伤害"},
	{"421", "腰豆", "{{Charm}} 对近距离所有敌人造成5点伤害并魅惑"},
	...
	{"432", "闪光炸弹", "{{Bomb}} +5炸弹#角色的炸弹爆炸时, 25%几率生成1随机掉落物, 15%几率魅惑敌人"},
	{"433", "我的影子", "{{Fear}} 受伤时, 使所有敌人恐惧, 并生成1个友好的黑蛆#黑蛆每秒造成5点接触伤害"},
	{"434", "苍蝇罐", "击杀敌人时, 在罐子里加入1只蓝苍蝇, 至多20只#使用时, 释放所有苍蝇"},
	{"435", "洛基宝宝", "十字发射泪弹#泪弹造成3.5点伤害"},
	{"436", "牛奶！", "{{Tears}} 受伤后, 在当前房间中获得射速提升"},
	{"437", "七面骰", "重新开始房间并重生所有敌人#能够重复获得清理房间奖励#若在与贪婪战斗中使用, 则将房间重置为普通商店/隐藏房"},
	{"438", "奶嘴", "↑ {{TearsSmall}} 射速+0.75#{{SoulHeart}} +1魂心#↑ 体型变小"},
	{"439", "妈妈的盒子", "{{Trinket}} 生成1随机饰品#持有时:#↑ {{LuckSmall}} 幸运+1#{{Trinket}} 饰品效果翻倍"},
	{"440", "肾结石", "↑ 泪弹高度+2#↓ {{SpeedSmall}} 移速-0.2#↓ {{RangeSmall}} 射程-17#角色约每25秒停止发射并蓄力, 释放散射泪弹和1颗肾结石"},
	{"441", "超级喷射", "{{Timer}} 发射超级撒但激光15秒#激光在房间和层之间持续存在"},
	{"442", "黑王子之冠", "红心为1时:#↑ {{TearsSmall}} 射速+0.75#↑ {{RangeSmall}} 射程+1.5#↑ 泪弹高度+1#↑ {{ShotspeedSmall}} 弹速+0.2"},
	{"443", "苹果！", "↑ {{TearsSmall}} 射速+0.3#{{Damage}} 6.66%几率发射刀片, 造成4x角色伤害#{{Luck}} 幸运14: 100%几率"},
	{"444", "铅笔", "角色每发射15颗泪弹, 抛射大量泪弹#抛射的泪弹造成2x角色伤害"},
	{"445", "狗牙", "↑ {{SpeedSmall}} 移速+0.1#↑ {{DamageSmall}} 伤害+0.3#{{SecretRoom}} 在隐藏房/超级隐藏房相邻房间时会有一声狼嚎#{{LadderRoom}} 进入岩石下有暗门的房间时会有一声吠叫"},
	...
	{"449", "金属板", "{{SoulHeart}} +1魂心#{{Confusion}} 使敌人的弹幕有25%几率反弹为眩晕泪弹"},
	{"450", "贪婪的眼睛", "每发射20颗泪弹, 发射1颗造成2x角色伤害的硬币泪弹#被击中的敌人石化并变为金块#{{Coin}} 击杀金敌人掉落1-4硬币#{{Warning}} 发射硬币泪弹消耗1硬币"},
	{"451", "塔罗牌桌布", "{{Card}} 生成1随机卡牌#{{Card}} 使用的卡牌效果翻倍或增强"},
	{"452", "静脉曲张", "受伤时:#围着角色发射10颗高伤害泪弹#{{Damage}} 泪弹造成1x角色伤害+25的伤害#{{Collectible214}} 20%几率获得贫血效果"},
	{"453", "复杂性骨折", "↑ {{RangeSmall}} 射程+1.5#↑ 泪弹高度+1#泪弹击中时碎成1-3个小骨片"},
	{"454", "多指畸形", "生成1{{Rune}}符文, {{Card}}卡牌或{{Pill}}胶囊#允许角色携带2卡牌/符文/胶囊"},
	{"455", "爸爸丢失的硬币", "↑ {{RangeSmall}} 射程+1.5#↑ 泪弹高度+1#{{Luck}} 生成1幸运硬币"},
	{"456", "夜宵", "↑ {{Heart}} +1心之容器"},
	{"457", "蛋头", "{{SoulHeart}} +1魂心#20%几率阻挡伤害"},
	{"458", "肚脐", "{{Trinket}} 生成1随机饰品#{{Trinket}} 允许角色携带2饰品"},
	{"459", "鼻窦炎", "20%几率发射粘性鼻屎#{{Damage}} 鼻屎每秒造成1x角色伤害, 能粘住60秒"},
	{"460", "青光眼", "{{Confusion}} 5%几率发射眩晕泪弹#屏幕会稍暗一些"},
	{"461", "拟寄生物", "15%几率发射虫卵#{{Luck}} 幸运5: 50%几率#{{Slow}} 虫卵击中时, 生成减速水迹和1只蓝蜘蛛或蓝苍蝇"},
	{"462", "彼列之眼", "↑ {{RangeSmall}} 射程+1.5#↑ 泪弹高度+1#穿刺泪弹#泪弹击中敌人后, 获得追踪效果并伤害翻倍"},
	{"463", "硫酸", "↑ {{DamageSmall}} 伤害+0.3#25%几率发射能摧毁岩石和打开门的泪弹"},
	{"464", "平衡符号", "{{SoulHeart}} +2魂心#精英怪掉落角色最需要的掉落物"},
	{"465", "模拟摇杆", "↑ {{TearsSmall}} 射速+0.35#按住2个方向键可斜角发射泪弹#若使用手柄, 则可任意方向"},
	{"466", "传染病", "{{Poison}} 房间中首个击杀的敌人会产生毒气并使周围敌人中毒#被中毒的敌人死亡仍会产生毒气"},
	{"467", "手指！", "{{Damage}} 对手指指向的敌人每秒造成10次0.1x角色伤害"},
	...
	{"476", "一面骰", "随机复制房间中1掉落物"},
	{"477", "虚空", "消耗房间中所有底座道具:#主动道具: 激活其效果, 以后每次使用虚空时也会激活#↑ 被动道具: 小幅提升2项随机属性"},
	{"478", "暂停", "暂停房间中所有敌人, 直到角色发射#角色接触暂停的敌人仍会受伤#30秒后解除暂停"},
	{"479", "熔炉", "{{Trinket}} 消耗角色持有的饰品并永久获得饰品效果#提高饰品的生成率"},
	{"480", "堆肥", "将掉落物变成蓝苍蝇或蓝蜘蛛#使现有的蓝苍蝇/蓝蜘蛛翻倍#若没有则生成1只蓝苍蝇或蓝蜘蛛"},
	...
	{"484", "等等，啥？", "使用时, 推走敌人并生成岩石波#岩石波可以开门或摧毁岩石"},
	{"485", "被掰弯的硬币", "50%几率使房间中所有道具, 掉落物和箱子翻倍#50%几率将上述内容移除并生成1硬币"},
	{"486", "钝剃刀片", "使角色受伤但不掉血#触发'受伤时触发'道具的效果"},
	{"487", "土豆削皮刀", "{{EmptyHeart}} 移除1心之容器, 获得:#↑ {{DamageSmall}} 伤害+0.2#{{Collectible73}} 肉块#{{Timer}} 当前房间中获得:#↑ {{RangeSmall}} 射程+5#{{Collectible214}} 留下血迹"},
	...
	{"492", "嘿，听好！", "↑ {{LuckSmall}} 幸运+1#使{{SecretRoom}}隐藏房, 标记石头和{{LadderRoom}}暗门的地点高亮"},
	{"493", "肾上腺素", "每有1空心之容器:#↑ {{DamageSmall}} 伤害+0.2"},
	...
	{"513", "派对帽", "↑ {{DamageSmall}} 伤害+0.1#{{SoulHeart}} +1魂心#{{Charm}} 几率魅惑/恐惧敌人#受伤时, 5%几率生成1个彩虹大便"},
	{"514", "损坏的调制解调器", "随机间隔使一些敌人和弹幕短暂停滞#25%几率使清理房间奖励翻倍"},
	{"515", "神秘礼物", "根据当前房间的道具池生成1个随机道具#几率生成{{Collectible132}}煤块或{{Collectible36}}便便"},
	...
	{"521", "代金券", "使{{Shop}}商店或{{DevilRoom}}恶魔房的随机1个物品免费#{{Shop}} 持有时, 进入商店必有1个商店物品打折"},
	{"522", "念力", "使靠近角色的敌人弹幕停滞3秒, 结束后弹幕会被抛开"},
	{"523", "搬家盒", "使用时, 储存当前房间的所有掉落物#再次使用将储存物放回地上#允许角色在房间之间搬东西"},
	...
	{"531", "泪血症", "↑ {{DamageSmall}} 伤害修正x1.31#↓ {{TearsSmall}} 射速修正x0.5#↓ {{TearsSmall}} 射击延迟+10#角色的泪弹弧形前进, 击中时分裂成更小的泪弹"},
	...
	{"536", "祭坛", "献祭至多2个跟班并生成同样数量的{{DevilRoom}}恶魔房道具#{{Coin}} 将蓝蜘蛛/蓝苍蝇变成硬币"},
	...
	{"542", "滑肋骨", "环绕物#反弹敌人弹幕"},
	{"543", "圣地大便", "受伤时, 生成白大便#在大便光环中时:#↑ {{TearsSmall}} 射速修正x2#50%几率阻挡伤害"},
	{"544", "尖肋骨", "漂浮在角色前方的骨刺#每秒造成6x角色伤害"},
	{"545", "亡者之书", "当前房间中每击杀1个敌人, 生成1个骨头环绕物或魅惑的骷髅仔#至多生成8个"},
	{"546", "爸爸的戒指", "获得能使敌人石化的光环"},
	{"547", "离婚协议书", "↑ {{TearsSmall}} 射速+0.7#{{EmptyBoneHeart}} +1骨心#{{Trinket21}} 生成神秘纸片饰品"},
	{"548", "颌骨", "回旋镖状的跟班#造成7点接触伤害#能捡起并带回掉落物"},
	{"549", "脆骨症", "{{EmptyBoneHeart}} 角色所有的心之容器由6空骨心取代#失去骨心时:#↑ {{TearsSmall}} 射速+0.5#向四周方向发射10颗骨头泪弹"},
...
EID.descriptions[languageCode].carBattery = {
	...
	[485] = "25%几率使道具, 掉落物和箱子翻四倍, 25%几率使其翻倍并移除原有物品, 50%几率全部移除并生成1硬币", -- Crooked Penny
...
EID.descriptions[languageCode].trinkets={
	...
	{"8", "游戏卡带", "{{Timer}} 受伤时, 5%几率在6.5秒内获得:#无敌#角色无法发射, 但每秒造成40点接触伤害#{{HalfHeart}} 击杀2个敌人治疗半红心#{{Fear}} 使房间中的所有敌人恐惧"},
	{"9", "搏动虫", "角色的泪弹搏动#影响泪弹命中区域"},
	{"10", "扭扭虫", "↑ {{TearsSmall}} 射速+0.3#角色的泪弹波形前进"},
	{"11", "环形虫", "角色的泪弹高速螺旋前进"},
	{"12", "扁形虫", "泪弹宽50%#提高击退力"},
	{"13", "商店积分", "{{Shop}} 允许角色免费拿1件商店道具"},
	{"14", "老茧", "不再受到水迹和地刺的伤害"},
	{"15", "幸运石", "{{Coin}} 摧毁岩石会生成硬币"},
	...
	{"26", "钩形虫", "↑ {{RangeSmall}} 射程+10#泪弹直角前进"},
	{"27", "鞭形虫", "↑ {{ShotspeedSmall}} 弹速+0.5"},
	...
	{"53", "血虱", "{{HealingRed}} 进入{{BossRoom}}头目房时, 治疗1红心#头目血量-15%#{{Warning}} 捡起后, 无法被其他饰品替换#只能被{{Trinket41}}火柴棍移除或吞下"},
	...
	{"58", "参孙的发髻", "{{Timer}} 击杀敌人时, 1/15几率在当前房间中获得:#↑ {{DamageSmall}} 伤害+0.5#{{Luck}} 幸运10: 100%几率"},
	{"59", "该隐的眼睛", "25%几率揭示新一层的地图图标#{{Luck}} 幸运3: 100%几率"},
	{"60", "夏娃的鸟爪", "{{Collectible117}} 击杀敌人时, 5%几率生成死鸟#{{Luck}} 幸运8: 100%几率"},
	{"61", "左断手", "{{RedChest}} 将所有箱子变成红箱子"},
	{"62", "闪亮岩石", "暗门岩石和标记石头每10秒闪烁一次"},
	{"63", "安全剪刀", "{{Bomb}} 将即爆炸弹变成炸弹掉落物"},
	{"64", "彩虹虫", "每3秒获得随机蠕虫效果"},
	{"65", "长条虫", "↑ {{RangeSmall}} 射程修正x2#↓ 泪弹高度x0.5"},
	{"66", "懒散虫", "↑ {{RangeSmall}} 射程+4#↑ 泪弹高度+2#↓ {{ShotspeedSmall}} 弹速-0.4"},
	...
	{"74", "饰钉定位器", "摧毁岩石时, 出现{{LadderRoom}}暗门的几率+0.5%"},
	{"75", "错误", "每个房间获得随机饰品效果"},
	{"76", "筹码", "↑ 箱子有50%几率生成额外掉落物#↓ 箱子有50%几率只有1只红苍蝇"},
	{"77", "水疱", "提高击退力"},
	{"78", "秒针", "状态效果影响敌人两倍久"},
	{"79", "无名无尽", "使用{{Rune}}符文, {{Card}}卡牌, {{Pill}}胶囊时, 25%几率生成其复制"},
	{"80", "黑色羽毛", "↑ {{DamageSmall}} 每持有1个'邪恶上升'道具, 伤害+0.2"},
	{"81", "盲目的怒火", "受伤后的无敌变为两倍久"},
	{"82", "黄金马蹄铁", "{{TreasureRoom}} 后续层道具房能道具二选一的几率+15%"},
	{"83", "商店钥匙", "{{Shop}} 免费开启商店"},
	...
	{"92", "碎裂的王冠", "↑ {{TearsSmall}} 射击延迟x0.8#↑ 高于{{SpeedSmall}}移速1, {{DamageSmall}}伤害3.5, {{RangeSmall}}射程23.75, {{Shotspeed}}射速1的部分修正x1.33"},
	{"93", "用过的尿布", "每房间15%几率使所有苍蝇敌人变得友好"},
	{"94", "鱼尾", "使蓝苍蝇/蓝蜘蛛生成翻倍"},
	{"95", "黑牙", "{{Poison}} 3%几率发射有毒牙齿#牙齿造成2x角色伤害"},
	{"96", "衔尾虫", "↑ {{RangeSmall}} 射程+4#↑ 泪弹高度+2#灵体泪弹#几率为追踪泪弹#{{Luck}} 幸运9: 100%几率#角色的泪弹螺旋快速前进"},
	{"97", "扁桃体", "受伤12-20次后, 获得阻挡弹幕的跟班#最多+2个跟班"},
	{"98", "鼻涕泡", "10%几率发射追踪粘性有毒泪弹#{{Damage}} 每秒造成1x角色伤害#能粘住60秒"},
	{"99", "超级弹球", "10%几率发射弹性泪弹"},
	{"100", "亮灯泡", "持有完全充能的主动道具时:#↑ {{SpeedSmall}} 移速+0.25#↑ {{TearsSmall}} 射速+0.2#↑ {{DamageSmall}} 伤害+0.5#↑ {{RangeSmall}} 射程+0.75#↑ {{ShotspeedSmall}} 弹速+0.1#↑ {{LuckSmall}} 幸运+1"},
	{"101", "暗灯泡", "持有完全未充能的主动道具时:#↑ {{SpeedSmall}} 移速+0.5#↑ {{TearsSmall}} 射速+0.4#↑ {{DamageSmall}} 伤害+1.5#↑ {{RangeSmall}} 射程+1.5#↑ {{ShotspeedSmall}} 弹速+0.3#↑ {{LuckSmall}} 幸运+2"},
	...
	{"109", "胶带", "跟班被粘住, 随玩家同步移动"},
	{"110", "银币", "{{Shop}} 商店会出现在子宫层"},
	{"111", "染血王冠", "{{TreasureRoom}} 道具房会出现在子宫层"},
	{"112", "充钱游戏", "{{RestockMachine}} {{TreasureRoom}}道具房永远生成补货机"},
...
EID.descriptions[languageCode].cards={
	...
	{"4", "III-皇后", "{{Timer}} 当前房间中获得:#↑ {{SpeedSmall}} 移速+0.3#↑ {{DamageSmall}} 伤害+1.5"},
	{"5", "IV-皇帝", "{{BossRoom}} 将角色传送至头目房"},
	{"6", "V-教皇", "{{SoulHeart}} 生成2魂心"},
	{"7", "IV-恋人", "{{Heart}} 生成2红心"},
	{"8", "VII-战车", "{{Timer}} 在6秒内获得:#↑ {{SpeedSmall}} 移速+0.28#无敌#角色无法发射泪弹, 但每秒造成40点接触伤害"},
	...
	{"12", "XI-力量", "{{Timer}} 当前房间中获得:#↑ +1心之容器#↑ {{SpeedSmall}} 移速+0.3#↑ {{DamageSmall}} 伤害+0.3#↑ {{DamageSmall}} 伤害修正x1.5#↑ {{RangeSmall}} 射程+5.25#↑ 泪弹高度+0.5"},
	{"13", "XII-倒吊人", "{{Timer}} 当前房间中获得飞行"},
	{"14", "XIII-死亡", "对房间中所有敌人造成40点伤害"},
	{"15", "XIV-节制", "{{DonationMachine}} 生成1台献血机"},
	{"16", "XV-恶魔", "{{Timer}} 当前房间中获得:#↑ {{DamageSmall}} 伤害+2"},
	{"17", "XVI-塔", "生成6个即爆炸弹"},
	...
	{"21", "XX-审判", "生成1个乞丐或恶魔乞丐#2%几率为特殊乞丐"},
	...
	{"31", "鬼牌", "{{AngelDevilChance}} 将角色传送至恶魔房或天使房"},
	{"32", "冰雹符文", "摧毁房间中所有岩石"},
	{"33", "收获符文", "复制房间中所有掉落物"},
	{"34", "马骑符文", "生成1个前往下层的活板门#{{LadderRoom}} 8%几率为暗门"},
	...
	{"43", "信用卡", "使{{Shop}}商店或{{DevilRoom}}恶魔房的所有道具和掉落物免费"},
	...
	{"51", "神圣卡", "{{HolyMantle}} 当前房间获得神圣屏障护盾, 阻挡1次伤害#25%几率生成另1张神圣卡"},
	{"52", "变巨术", "{{Timer}} 当前房间中获得:#↑ {{DamageSmall}} 伤害+7#↑ {{RangeSmall}} 射程+30#体型变大#角色可粉碎接触的岩石"},
	{"53", "先祖召唤", "{{Card}} 生成3随机卡牌"},
	{"54", "时空漫步", "{{Timer}} 当前房间中获得:#↑ {{SpeedSmall}} 移速+0.5#↓ {{ShotspeedSmall}} 弹速-1#{{Slow}} 使敌人减速"},
}
...
EID.descriptions[languageCode].pills={
	...
	{"10", "漂亮苍蝇", "+1苍蝇环绕物"},
	{"11", "射程下降", "↓ {{RangeSmall}} 射程-2"},
	{"12", "射程上升", "↑ {{RangeSmall}} 射程+2.5"},
	{"13", "移速下降", "↓ {{SpeedSmall}} 移速-0.12"},
	{"14", "移速上升", "↑ {{SpeedSmall}} 移速+0.15"},
	{"15", "射速下降", "↓ {{TearsSmall}} 射速-0.28"},
	{"16", "射速上升", "↑ {{TearsSmall}} 射速+0.35"},
	{"17", "运气下降", "↓ {{LuckSmall}} 幸运-1"},
	{"18", "运气上升", "↑ {{LuckSmall}} 幸运+1"},
	{"19", "传送胶囊", "将角色传送至随机房间#{{ErrorRoom}} 小概率传送至{{ErrorRoom}}错误房"},
	{"20", "48小时能量！", "{{Battery}} 对主动道具完全充能#{{Battery}} 生成1-2电池"},
	...
	{"45", "感觉像漫步在阳光下！", "{{Timer}} 在6秒内获得:#↑ {{SpeedSmall}} 移速+0.28#无敌#角色无法发射(也没有接触伤害)"},
	{"46", "嗝！", "生成上次使用的胶囊"},
}
...
EID.descriptions[languageCode].CharacterInfo = {
	...
	[14] = {"店主", "{{CoinHeart}} 通过捡起硬币来治疗#最多2硬币心#心类掉落物变成蓝苍蝇"},
	[15] = {"亚伯伦", ""},
...
EID.descriptions[languageCode].sacrifice={
	...
	{"6", "", "{{AngelChance}} 33%几率传送到天使房#{{DevilChance}} 若本层已生成恶魔房则传送到恶魔房#{{Chest}} 67%几率是1随机箱子"},
...
EID.descriptions[languageCode].dice={
	...
	{"2", "", "重置当前房间所有掉落物"},
	{"3", "", "重置整层所有掉落物和饰品#不影响{{AngelDevilChance}}恶魔房/{{AngelRoom}}天使房或{{LadderRoom}}夹层"},
	{"4", "", "重置整层所有底座道具#不影响{{DevilRoom}}恶魔房/{{AngelRoom}}天使房或{{LadderRoom}}夹层"},
	{"5", "", "重置当前层并重新开始"},
...
EID.descriptions[languageCode].PurityBoosts = {[0] = "↑ {{DamageSmall}} 伤害+4", "↑ {{TearsSmall}} 射击延迟-4", "↑ {{SpeedSmall}} 移速+0.5", "↑ {{RangeSmall}} 射程+7.5#↑ 泪弹高度+1"}
...
EID.descriptions[languageCode].MCM = {
	...
	DemoObjectText = "这份文本是中文的#一条又酷又长的描述, 用来模拟EID文本框自动分行功能!#{{Collectible4}} 这也是很酷的一行#{{Heart}} 爱来自这行#{{AngelDevilChance}} 天使还是恶魔,这是一个问题#\1 {{DamageSmall}} 属性+1, 原地起飞",
}
...
EID.descriptions[languageCode].ConditionalDescs = {
	...
	["5.300.19"] = {"将角色传送至本层起始房间"}, -- The Moon (Greed)
	...
	["5.100.549"] = "{1}: 只在拾起时↑ {{TearsSmall}} 射速+0.4", -- Brittle Bones (Keeper+Lost)
	["5.100.501"] = "{1}: 获得额外硬币心容器", -- Greed's Gullet
	["5.100.230 (Keeper)"] = "{{Warning}} {1}: 直接死亡", -- Abaddon


	------ DUPLICATE COPIES OF ITEMS ------
	["5.100.2 (Copies)"] = "角色再多发射3颗泪弹#属性不变", -- The Inner Eye
	["5.100.153 (Copies)"] = "角色再多发射4颗泪弹#属性不变", -- Mutant Spider
	...
	["Black Feather"] = "↑ {{DamageSmall}} 伤害+0.2", -- Black Feather items
	...
	["Ludovico Ipecac"] = "泪弹伤害+4, 但不爆炸或中毒",
	["Technology Ipecac"] = "激光伤害+4并使目标中毒",
	["Chocolate Milk Overrides"] = "↑ {{TearsSmall}} 射速修正x1.25",
	...
	["5.300.18 (Late Greed)"] = {"将角色传送至本层起始房间"}, -- XVII - The Stars (Greed Last Floors)
