...
EID.descriptions[languageCode].trinkets={
	...
	{"39", "癌症", "↑ -2眼泪延迟"},
	{"40", "红补丁", "↑ 受伤时20%几率+1.8伤害#运气为8时几率为100%#离开房间后重置"},
	...
	{"58", "参孙的发髻", "杀死敌人时有1/15几率+0.5伤害#运气为10时几率为100%#离开房间后重置"},
	{"59", "该隐的眼睛", "25%几率揭示新一层的地图图标#运气为3时几率为100%"},
	{"60", "夏娃的鸟爪", "杀死敌人时有5%几率生成 {{Collectible117}} 死鸟#运气为8时几率为100%"},
	{"61", "左断手", "将所有箱子变成红箱子"},
