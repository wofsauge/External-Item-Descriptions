...
EID.descriptions[languageCode].collectibles={
	...
	{"5", "我的镜像", "↑ {{Range}} 射程+1.5#↑ 泪弹高度+1#↑ {{Shotspeed}} 弹速+0.6#↑ +1泪弹高度#泪弹具有回旋效果"},
	...
	{"46", "幸运脚", "↑ {{Luck}} 幸运+1#房间清理奖励几率+8%#赌博时赢的几率更高"},
	...
	{"83", "钉子", "使用后:#{{SoulHeart}} +1魂心#{{Timer}} 在当前房间中获得:#↑ {{Damage}} 伤害+0.7#↓ {{Speed}} 移速-0.18#角色每秒造成40点接触伤害#角色可粉碎接触的岩石"},
	...
	{"110", "妈妈的美瞳", "↑ {{Range}} +0.25射程#↑ 泪弹高度+0.5#20%几率发射石化泪弹#{{Luck}} 幸运20: 50%几率"},
	...
	{"126", "剃刀片", "使用后:#↑ {{Damage}} 在当前房间中伤害+1.2#{{Warning}} 对角色造成1心伤害#{{Heart}} 优先消耗红心"},
	{"127", "遗忘药", "重置整层"},
	...
	{"149", "吐根酊", "↑ {{Damage}} +40伤害#↓ {{Tears}} 射速修正x0.5#↓ {{Tears}} 射击延迟+10#角色的泪弹呈弧形射出#{{Poison}} 泪弹会爆炸并使击中的敌人中毒"},
	{"150", "严厉的爱", "{{Damage}} 10%几率发射牙齿, 造成3.2x角色伤害#{{Luck}} 幸运9: 100%几率"},
	{"151", "虫群复击", "泪弹击中敌人时有1/6几率生成1只蓝苍蝇"},
	{"152", "科技II", "#↓ {{Tears}} 射速修正x0.5#↓ {{Damage}} 伤害修正x0.65#角色右泪弹弹由持续激光取代#{{Damage}} 激光每秒造成3x角色伤害"},
	...
	{"201", "铁块", "↑ {{Damage}} 伤害+0.3#{{Confusion}} 10%几率发射眩晕泪弹#{{Luck}} 幸运27: 100%几率"},
	...
	{"314", "霹雳大腿", "↑ {{Heart}} +1心之容器#↓ {{Speed}} 移速-0.4#角色摧毁接触的岩石"},
	...
	{"336", "烂洋葱", "↑ {{Range}} 射程+0.25#↑ {{Tearsize}} 泪弹尺寸x1.5#↓ -0.5泪弹高度#↓ {{Shotspeed}} 弹速-0.4#穿刺+灵体泪弹"},
	...
	{"397", "牵引光束", "↑ {{Tears}} 射速+0.5#↑ {{Range}} 射程+5.25#↑ 泪弹高度+0.5#↑ {{Shotspeed}} 弹速+0.16#角色的泪弹角色面前的受光束指引"},
	{"398", "神体蘑菇", "泪弹能使敌人缩小#缩小的敌人可以被踩死"},
	{"399", "虚空之喉", "↑ {{Damage}} 伤害+1#{{Chargeable}} 持续发射泪弹2.35秒后, 松开发射键会产生1个黑硫磺火圈#黑圈在2秒内造成30x角色伤害#{{BlackHeart}} 被黑圈击杀的敌人有5%几率掉落1黑心"},
	...
	{"415", "光明之冠", "{{SoulHeart}} +2魂心#若角色无不满的心之容器:#↑ {{Damage}} 伤害修正x2#↑ {{Range}} 射程+5.25#↑ 泪弹高度+0.5#↓ {{Shotspeed}} 弹速-0.3#受伤后, 效果消失"},
	...
	{"445", "狗牙", "↑ {{Speed}} 移速+0.1#↑ {{Damage}} 伤害+0.3#{{SecretRoom}} 在隐藏房/超级隐藏房相邻房间时会有一声狼嚎#{{LadderRoom}} 进入岩石下有暗门的房间时会有一声吠叫"},
	...
	{"463", "硫酸", "↑ {{Damage}} 伤害+0.3#25%几率发射能摧毁岩石和打开门的泪弹"},
	{"464", "平衡符号", "{{SoulHeart}} +2魂心#精英怪掉落角色最需要的掉落物"},
	{"465", "模拟摇杆", "↑ {{Tears}} 射速+0.35#按住2个方向键可斜角发射泪弹#若使用手柄, 则可任意方向"},
	...
	{"531", "泪血症", "↑ {{Damage}} 伤害修正x1.31#↓ {{Tears}} 射速修正x0.5#↓ {{Tears}} 射击延迟+10#角色的泪弹弧形前进, 击中时分裂成更小的泪弹"},
	...
	{"549", "脆骨症", "{{EmptyBoneHeart}} 角色所有的心之容器由6空骨心取代#失去骨心时:#↑ {{Tears}} 射速+0.5#向四周方向发射10颗骨头泪弹"},
...
EID.descriptions[languageCode].trinkets={
	...
	{"92", "碎裂的王冠", "↑ {{Tears}} 射击延迟x0.8#↑ 高于{{Speed}}移速1, {{Damage}}伤害3.5, {{Range}}射程23.75, {{Shotspeed}}射速1的部分修正x1.33"},
...
EID.descriptions[languageCode].cards={
	...
	{"12", "XI-力量", "{{Timer}} 当前房间中获得:#↑ +1心之容器#↑ {{Speed}} 移速+0.3#↑ {{Damage}} 伤害+0.3#↑ {{Damage}} 伤害修正x1.5#↑ {{Range}} 射程+5.25#↑ 泪弹高度+0.5"},
	...
	{"52", "变巨术", "{{Timer}} 当前房间中获得:#↑ {{Damage}} 伤害+7#↑ {{Range}} 射程+30#体型变大#角色可粉碎接触的岩石"},
