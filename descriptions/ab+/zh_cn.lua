...
EID.descriptions[languageCode].collectibles={
	...
	{"237", "死神之触", "镰刀眼泪！#↑ {{Damage}} +1.5伤害#↓ {{Tears}} -0.3射速#穿透眼泪"},
	...
	{"256", "炙热炸弹", "燃烧炸弹#+5炸弹"},
	{"257", "火焰意志", "眼泪会点燃敌人#击中敌人时眼泪有几率爆炸#{{LuckSmall}} 运气13：100%几率#!!! 爆炸也会伤到自己！"},
	{"258", "编号丢失", "每换一层重置一次持有道具和掉落物#同时重置角色属性"},
	{"259", "暗物质", "↑ {{Damage}} +1.0伤害#33%几率发射恐惧眼泪"},
	...
	{"297", "潘多拉魔盒", "{{Warning}} 一次性，根据所在层掉落以下物品：#1章1：2魂心#1章2：2钥匙+2炸弹#2章1：1Boss房道具#2章2：1章1+2章1#3章1：4魂心#3章2：20硬币#4章1：2Boss房道具#4章2：{{Collectible33}}圣经#???：无#地狱：1恶魔房道具+1黑心#大教堂：1天使房道具+1永恒之心#暗室：解锁{{Collectible523}}搬家盒#宝箱：1硬币#若有迷宫诅咒则为章节1层"},
	...
	{"311", "犹大的影子", "死后以黑暗犹大重生#↑ {{Damage}} (伤害x2)"},
	...
	{"370", "玩偶先生", "↑ {{Tears}} +0.7射速#↑ {{Range}} +5.25射程#↑ +0.5眼泪高度#捡起时生成3随机心"},
	...
	{"399", "虚空之喉", "↑ {{Damage}} +1.0伤害#持续射击3秒后，1个红十字出现在角色的头上#释放攻击键后，制造1个黑色硫磺火圈#被黑圈杀死的敌人有几率掉落1黑心"},
	...
	{"407", "纯洁", "↑ 根据角色光环颜色对角色属性进行增强#受伤时获得新的光环#{{ColorRed}}红色{{CR}} = {{Damage}} +4.0伤害#{{ColorBlue}}蓝色{{CR}} = -4眼泪延迟#{{ColorYellow}}黄色{{CR}} = {{Speed}} +0.5移速#{{ColorOrange}}橙色{{CR}} = {{Range}} +7.5射程，+1眼泪高度"},
	...
	{"415", "光明之冠", "+2魂心#如果没有不满的心之容器：#↑ {{Damage}} +100%伤害#↑ {{Range}} +5.25射程#↑ +0.5眼泪高度#↓ {{Shotspeed}} -0.3弹速#受伤后，在所在房间内无论心之容器是否是满的，效果消失"},
