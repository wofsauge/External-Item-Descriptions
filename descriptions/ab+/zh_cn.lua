...
EID.descriptions[languageCode].collectibles={
	...
	{"355", "老妈的珍珠项链", "↑ {{Range}} +1.25射程#↑ +1运气#↑ +0.5眼泪高度"},
	...
	{"455", "老爸丢失的硬币", "↑ {{Range}} +1.5射程#↑ +1眼泪高度#生成1运气硬币"},
	{"456", "发霉的面包", "↑ +1心之容器"},
...
EID.descriptions[languageCode].trinkets={
	...
	{"39", "癌症", "↑ -2眼泪延迟"},
	{"40", "红补丁", "↑ {{Damage}} 受伤时20%几率+1.8伤害#运气8：100%几率#离开房间后重置"},
	...
	{"58", "参孙的发髻", "{{Damage}} 杀死敌人时有1/15几率+0.5伤害#运气10：100%几率#离开房间后重置"},
	...
	{"99", "超级弹球", "10%几率发射弹性眼泪"},
	{"100", "亮灯泡", "!!! 当主动道具满充能时：#↑ {{Damage}} +0.5伤害#↑ {{Speed}} +0.25移速#↑ {{Range}} +0.75射程#↑ {{Tears}} +0.2射速#↑ {{Shotspeed}} +0.1弹速#↑ +1运气"},
	{"101", "暗灯泡", "!!! 当主动道具无充能时：#↑ {{Damage}} +1.5伤害#↑ {{Speed}} +0.5移速#↑ {{Range}} +1.5射程#↑ {{Tears}} +0.4射速#↑ {{Shotspeed}} +0.3弹速#↑ +2运气"},
