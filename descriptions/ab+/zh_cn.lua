...
EID.descriptions[languageCode].collectibles={
	...
	{"3", "弯勺魔术", "跟踪眼泪"}, 
	{"4", "柯吉猫的头", "↑ {{Damage}} +0.5伤害#↑ {{Damage}} +50%伤害倍数"},
	{"5", "我的镜像", "眼泪有回旋效果#↑ {{Range}} +1.5射程#↑ {{Shotspeed}} +0.6弹速#↑ +1眼泪高度"},
	{"6", "小号", "↑ {{Tears}} +1.5射速#↓ {{Range}} -17.62射程#↑ +0.76眼泪高度"},
	{"7", "殉道者之血", "↑ {{Damage}} +1.0伤害#↑ 如果有彼列之书或激活了恶魔牌则再+50%伤害倍数"},
	{"8", "波比兄弟", "普通眼泪跟班#每次射击造成3.5伤害"},
	{"9", "粪臭素", "所有敌对苍蝇变得友好"},
	{"10", "苍蝇光环", "+2环绕苍蝇#阻挡敌人弹幕"},
	{"11", "1UP!", "↑ +1生命#重生后满血"},
	{"12", "魔法蘑菇", "↑ +1心之容器#满血#↑ {{Damage}} +0.3伤害#↑ {{Damage}} +50%伤害倍数#↑ {{Range}} +5.25射程#↑ {{Speed}} +0.3移速#↑ +0.5眼泪高度#体型变大"},
	...
	{"34", "彼列之书", "↑ {{Damage}} +2伤害#↑ +12.5%恶魔房几率#{{Collectible7}} 如果有殉道者之血再+50%伤害倍数"},
	...
	{"68", "科技", "眼泪变成激光"},
	{"69", "巧克力牛奶", "蓄力眼泪#↑ {{Damage}} 最高400%伤害#↓ {{Tears}} 射速降低"},
	...
	{"119", "血袋", "↑ +1心之容器#↑ {{Speed}} +0.3移速#治疗4红心"},
	...
	{"129", "桶装猪油", "↑ +2心之容器#↓ {{Speed}} -0.2移速#治疗半红心"},
	...
	{"148", "害虫横行", "受伤时生成蓝苍蝇"},
	{"149", "吐根酊", "爆炸有毒眼泪#↑ {{Damage}} +40伤害#↓ {{Tears}} 射速降低"},
	{"150", "严厉的爱", "{{Damage}} 10%几率发射牙齿#牙齿造成3.2x伤害"},
	{"151", "虫群复击", "眼泪击中敌人时有1/6的几率生成1只蓝苍蝇"},
	{"152", "科技II", "永久激光攻击！#↓ {{Damage}} -35%伤害"},
	...
	{"165", "九尾鞭", "↑ {{Damage}} +1伤害#↑ {{Shotspeed}} +0.23弹速"},
	{"166", "二十面骰", "重置掉落物"},
	...
	{"182", "圣心", "↑ +1心之容器#满血#↑ {{Damage}} +230%伤害并+1伤害#↓ {{Tears}} -0.4射速#↓ {{Shotspeed}} -0.25弹速#↑ {{Range}} +0.38射程#↑ +0.75眼泪高度#跟踪眼泪"},
	...
	{"189", "超级食肉男孩死忠粉", "↑ +1心之容器#满血#↑ {{Damage}} +0.3伤害#↑ {{Tears}} +0.2射速#↑ {{Range}} +0.5射程#↑ {{Speed}} +0.2移速#↑ +1.0眼泪高度"},
	{"190", "烟火盛宴", "+99炸弹"},
	...
	{"228", "老妈的香水", "15%几率发射恐惧眼泪#↑ {{Tears}} +1射速"},
	{"229", "萌死戳的肺", "蓄力且霰弹式发射眼泪#↓ 眼泪延迟x4.3"},
	{"230", "亚巴顿", "↑ {{Damage}} +1.5伤害#↑ {{Speed}} +0.2移速#恐惧眼泪#↓ 移除所有心之容器#+6黑心"},
	{"231", "焦油球", "10%几率发射减速眼泪#{{Luck}} 运气18：100%几率#留下减速水迹"},
	{"232", "怀表", "永久减速效果#(受伤时激活)#↑ {{Speed}} +0.3移速"},
	...
	{"254", "血块", "↑ {{Damage}} +1伤害#↑ {{Range}} +5射程#!!! 只对左眼有效"},
	{"255", "螺丝", "↑ {{Tears}} +0.5射速#↑ {{Shotspeed}} +0.2弹速"},
	{"256", "炙热炸弹", "燃烧炸弹#+5炸弹"},
	{"257", "火焰意志", "眼泪会点燃敌人#击中敌人时眼泪有几率爆炸#{{Luck}} 运气13：100%几率#!!! 爆炸也会伤到自己！"},
	{"258", "编号丢失", "每换一层重置一次持有道具和掉落物#同时重置角色属性"},
	{"259", "暗物质", "↑ {{Damage}} +1伤害#33%几率发射恐惧眼泪"},
	...
	{"492", "嘿，听好！", "↑ {{Luck}} +1运气#使隐藏房，宝藏岩石和暗门的地点高亮"},
