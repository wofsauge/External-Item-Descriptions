...
EID.descriptions[languageCode].collectibles={
	...
	{"5", "我的镜像", "↑ {{Range}} 射程+1.5#↑ 泪弹高度+1#↑ {{Shotspeed}} 弹速修正x1.6#↑ 泪弹高度+1#泪弹具有回旋效果"},
	...
	{"68", "科技", "角色会发射激光而不是泪弹"},
	{"69", "巧克力牛奶", "{{Chargeable}} 可蓄力泪弹#{{Damage}} 伤害随蓄力时间提升, 最高4x#{{Tears}} 最大蓄力时间为2.5x射击延迟"},
	...
	{"92", "超级绷带", "↑ {{Heart}} +1心之容器#{{SoulHeart}} +2魂心"},
	...
	{"134", "嗝屁猫的尾巴", "{{Chest}} 33%概率将房间清理奖励变成箱子#22%概率使奖励消失"},
	...
	{"168", "史诗胎儿博士", "发射泪弹改为瞄准十字准星#1.5秒后导弹降落在准星处#{{Damage}} 导弹造成20x角色伤害"},
	...
	{"206", "断头台", "↑ {{Tears}} 射击延迟-1#↑ {{Damage}} 伤害+1#角色的头变成环绕物, 不会受到伤害, 每秒造成105点接触伤害"},
	{"207", "绷带球", "1级: 环绕物#{{Charm}} 2级: 发射魅惑泪弹的环绕物#{{Charm}} 3级: 绷带女孩#{{Charm}} 4级: 超级绷带女孩"},
	{"208", "冠军腰带", "↑ {{Damage}} 伤害+1#精英敌人概率+15%#不增加精英头目的概率"},
	...
	{"222", "反重力", "↑ {{Tears}} 射击延迟-2#按住发射键会使泪弹悬空#松开后, 所有泪弹会向被发射方向继续前进"},
	...
	{"225", "兽性面具", "{{SoulHeart}} 受伤时, 10%概率生成1魂心#{{HalfHeart}} 敌人死亡时概率掉落1半红心"},
	...
	{"238", "钥匙碎片1", "{{Warning}} 集齐两个钥匙碎片可开启金色大门#{{AngelChance}} 天使房概率+25%#{{EternalHeart}} 永恒之心概率+2.5%"},
	{"239", "钥匙碎片2", "{{Warning}} 集齐两个钥匙碎片可开启金色大门#{{AngelChance}} 天使房概率+25%#{{EternalHeart}} 永恒之心概率+2.5%"},
	...
	{"274", "生死之交", "受伤时, 在房间中生成1个中距离环绕物#环绕物每秒造成75点接触伤害"},
	...
	{"303", "室女座", "受伤时, 25%概率获得10秒无敌#{{Luck}} 幸运10: 100%概率#将负面胶囊变成正面的"},
	...
	{"322", "蒙戈宝宝", "复制其他跟班的泪弹效果#造成2x所复制跟班的伤害#若没有跟班, 则发射普通的7伤害泪弹"},
	...
	{"330", "豆奶", "↑ {{Tears}} 射速修正x4#↑ {{Tears}} 射击延迟-2#↑ 泪弹高度+0.8#↓ {{Damage}} 伤害修正x0.2#↓ {{Tearsize}} 泪弹尺寸x0.5"},
	...
	{"369", "连续统", "↑ {{Range}} 射程+2.25#↑ 泪弹高度+1.5#灵体泪弹#泪弹可以飞出屏幕一侧, 并从另一侧回来"},
	...
	{"378", "大号", "持续发射2.35秒后, 生成1大便炸弹"},
	{"379", "双瞳", "↑ {{Tearsize}} 泪弹尺寸x2#灵体泪弹"},
	{"380", "充钱游戏", "{{Coin}} +5硬币#{{Coin}} 单钥匙门必须用硬币打开而不是钥匙"},
	{"381", "伊甸的祝福", "↑ {{Tears}} 射速+0.7#下一局开始时, 获得1随机道具"},
	{"382", "友好球", "可以扔向敌人将其捕捉#{{Friendly}} 成功捕捉后，下一次使用则会生成相同的友好敌人"},
	{"383", "眼泪引爆器", "引爆屏幕中的泪弹, 每颗泪弹分裂为6颗并以环状散开"},
	{"384", "肉山宝宝", "{{Chargeable}} 弹出并在房间中反弹, 速度基于蓄力时间#根据冲撞速度, 每秒造成5-90点接触伤害"},
	{"385", "乞丐宝", "{{Coin}} 捡起附近的硬币#捡起6, 12, 24硬币时升级#2级: 清理房间后, 概率生成掉落物或道具#3级: 发射泪弹, 击中时概率生成硬币#4级: 追击敌人, 每秒造成37.5点接触伤害#4级: 继续捡硬币, 能生成掉落物或道具"},
	{"386", "十二面骰", "将障碍物重置为其他随机类型的障碍物(大便/罐子/TNT/红大便/石头等)"},
	{"387", "香炉", "{{Slow}} 被大片光环围绕的跟班, 能够使其中的敌人和弹幕减速"},
	{"388", "钥匙乞丐", "{{Key}} 捡起附近的钥匙#{{Chest}} 生成随机箱子作为回报"},
	...
	{"413", "圣灵受胎", "{{SoulHeart}} 每拾起15次心, 永久获得1个天使跟班并生成1魂心#最多产生5个跟班"},
	...
	{"418", "水果蛋糕", "每颗泪弹都有不同效果"},
	{"419", "传送2.0", "传送至未探索的随机房间#顺序: {{Room}}>{{BossRoom}}>{{SuperSecretRoom}}>{{Shop}}>{{TreasureRoom}}>{{SacrificeRoom}}{{DiceRoom}}>{{Library}}>{{CursedRoom}}> {{MiniBoss}}>{{ChallengeRoom}}{{BossRushRoom}}>{{ArcadeRoom}}{{ChestRoom}}>{{IsaacsRoom}}{{BarrenRoom}}>{{SecretRoom}}>{{DevilRoom}}{{AngelRoom}}>{{ErrorRoom}}"},
	...
	{"429", "店主的头", "{{Coin}} 敌人被泪弹击中时, 5%概率掉落1硬币"},
	...
	{"441", "超级喷射", "{{Timer}} 发射超级撒但血激光柱15秒#激光在房间和层之间持续存在"},
	...
	{"452", "静脉曲张", "受伤时:#围着角色发射10颗泪弹#{{Damage}} 泪弹造成1x角色伤害+25的伤害#{{Collectible214}} 20%概率获得持续2秒的贫血效果"},
	...
	{"461", "拟寄生物", "15%概率发射虫卵#{{Luck}} 幸运5: 50%概率#{{Slow}} 虫卵击中时, 生成减速水迹和1-2只蓝蜘蛛/蓝苍蝇"},
	...
	{"467", "手指！", "{{Damage}} 对手指指向的敌人持续造成10%角色伤害"},
	...
	{"499", "圣餐", "{{AngelChance}} 天使房的概率变为100%"},
	...
	{"515", "神秘礼物", "根据当前房间的道具池生成1个随机道具#概率生成{{Collectible132}}煤块/{{Collectible36}}大便"},
	...
	{"524", "科技零", "泪弹以电弧连接#{{Damage}} 电弧造成1x角色伤害"},
	{"525", "麻风病", "受伤时, 生成1个阻挡弹幕的环绕物#最多有3个环绕物#每秒造成105点接触伤害#环绕物受伤过多后被摧毁"},
	...
	{"551", "铲子碎片", "铲子碎片的第二部分#{{Warning}} 在\"暗室\"的土丘上使用铲子"},
...
EID.descriptions[languageCode].trinkets={
	...
	{"9", "波动虫", "角色的泪弹波动#影响泪弹碰撞箱"},
	{"10", "扭扭虫", "↑ {{Tears}} 射速+0.4#角色的泪弹波形前进"},
	{"11", "环形虫", "角色的泪弹高速螺旋前进"},
	{"12", "扁形虫", "泪弹宽50%#提高击退力"},
	{"13", "商店积分", "{{Shop}} 允许角色免费拿1个商店道具"},
	{"14", "老茧", "不再受到水迹和地刺的伤害"},
	{"15", "幸运石", "{{Coin}} 摧毁石头会生成硬币"},
	{"16", "妈妈的脚趾甲", "每60秒妈腿会践踏房间中的随机位置"},
	{"17", "黑色口红", "{{BlackHeart}} 魂心生成为黑心的概率+10%"},
	...
	{"24", "屁股硬币", "{{Coin}} 大便生成硬币的概率+20%#角色拾起硬币时放屁"},
	...
	{"32", "裸盖蘑菇", "每个房间25%概率获得随机蘑菇效果#可能在地图上显示特殊房间"},
	...
	{"58", "参孙的发髻", "{{Timer}} 击杀敌人时, 6.66%概率在当前房间中获得:#↑ {{Damage}} 伤害+0.5#{{Luck}} 幸运10: 100%概率"},
	...
	{"66", "懒懒虫", "↑ {{Range}} 射程+4#↑ 泪弹高度+2#↓ {{Shotspeed}} 弹速-0.5"},
	...
	{"88", "不！", "阻止主动道具生成"},
	{"89", "儿童栓绳", "跟班离角色更近"},
	{"90", "棕色雷管", "大便摧毁时爆炸, 造成60点伤害"},
	{"91", "胎粪", "33%概率生成黑大便#{{BlackHeart}} 摧毁黑大便时, 5%概率生成1黑心"},
	...
	{"96", "衔尾虫", "↑ {{Range}} 射程+4#↑ 泪弹高度+2#灵体泪弹#10%概率为追踪泪弹#{{Luck}} 幸运9: 100%概率#角色的泪弹螺旋快速前进"},
	{"97", "扁桃体", "受伤12-20次后, 获得阻挡弹幕的跟班#生成2个跟班后消失"},
	{"98", "鼻涕泡", "10%概率发射粘性泪弹#50%概率带有追踪效果#{{Damage}} 每秒造成1x角色伤害#能粘住60秒"},
	{"99", "超级弹球", "10%概率发射弹性泪弹"},
	...
	{"102", "塔罗牌残片", "{{SecretRoom}} 持有时, 每层+1个隐藏房"},
	...
	{"107", "乌鸦的心", "受伤时, 首先消耗红心, 然后消耗魂心/黑心#{{Warning}} 红心伤害会降低恶魔房/天使房概率"},
	{"108", "核桃", "受到爆炸后, 33%概率摧毁该饰品并生成1{{UnknownHeart}}随机心, 1{{Coin}}随机硬币, 1{{Key}}随机钥匙和1{{Trinket}}随机饰品#不必要受伤"},
...
EID.descriptions[languageCode].tarotClothBuffsAB = {
	...
	[38] = {3, 6, 3, 6}, -- Berkano
	[39] = {30, 60}, -- Algiz
	[40] = "触发2次符文效果, 并尝试复制自身2次", -- Blank Rune
	[41] = {40, 80}, -- Black Rune
...
EID.descriptions[languageCode].CharacterInfo = {
	...
	[5] = {"夏娃", ""},
	[6] = {"参孙", ""},
	[7] = {"阿撒泻勒", "飞行#{{Collectible118}} 泪弹由短程硫磺火取代"},
	[8] = {"拉撒路", "死亡时, 以\"复活的拉撒路\"重生, 具有1心之容器"},
	[9] = {"伊甸", "每局游戏开始时, 具有随机属性和道具"},
	[10] = {"游魂", "飞行#灵体泪弹#{{Warning}} 没有血量#{{DevilRoom}} 可以免费进行恶魔交易"},
	[11] = {"复活的拉撒路", "提升属性, 伤害修正x1.2"},
	[12] = {"犹大之影", "{{Damage}} 伤害修正x2#{{Player3}} 通关标记记为犹大的"},
	[13] = {"莉莉丝", "不能发射泪弹#{{Collectible360}} 通过淫魔射出泪弹"},
	[14] = {"店主", "{{CoinHeart}} 通过拾起硬币来治疗#最多2硬币心容器#心类掉落物变成蓝苍蝇"},
	[15] = {"亚玻伦", ""},
	[16] = {"遗骸", "有一根可以蓄力并投掷的近战骨头#{{BoneHeart}} 可以拥有最多6骨心#{{Player17}} 按{{ButtonRT}}切换到遗骸之魂"},
	[17] = {"遗骸之魂", "{{SoulHeart}} 遗骸之魂可以拥有最多6魂心/黑心, 具有飞行, 灵体泪弹#遗骸之魂以小范围锁链与遗骸相连#{{Player16}} 按{{ButtonRT}}切换到遗骸"},
    }
...
EID.descriptions[languageCode].RoomTypeNames = { "普通房间", "商店", "错误房", "宝箱房", "头目房", "小头目房", "隐藏房", "超级隐藏房", "赌博房", "诅咒房", "挑战房", "图书馆", "献祭房", "恶魔房", "天使房", "夹层", "头目车轮战房", "以撒的卧室", "肮脏的卧室", "宝库", "骰子房", "黑市", "出口房", "星象房", "传送入口房", "传送出口房", "替代章节入口房", "蓝色房间", "究极隐藏房",
...
EID.descriptions[languageCode].ConditionalDescs = {
	...
	["Can't Charge"] = "无法给{1}充能",
	["Can't Be Charged"] = "无法被{1}充能",
	...
	["5.100.549"] = "{1}: 只在拾起时↑ {{Tears}} 射速+0.5", -- Brittle Bones (Keeper+Lost)
	...
	["Proptosis Anti-Gravity"] = "泪弹移动前不会减少伤害",
	["Epic Fetus Soy Milk"] = "瞄准时间不缩短, 但导弹伤害大幅下降",
	["Eye of Belial Dr. Fetus"] = "炸弹穿透, 但不追踪也没有额外伤害",
	["Epic Fetus Brimstone"] = "{1}优先#导弹射出10束激光",
	["Epic Fetus Mom's Knife"] = "{1}优先#导弹射出10把菜刀",
