...
EID.descriptions[languageCode].collectibles={
	...
	{"259", "暗物质", "↑ {{Damage}} +1.0伤害#{{Fear}} 几率发射恐惧眼泪# {{LuckSmall}} 运气20：100%几率"},
	...
	{"400", "命运之矛", "在角色面前生成一根矛#每7帧(每秒4.29次)造成角色伤害2倍的伤害#几率恐惧接触到的敌人"},
	...
	{"438", "奶嘴", "+1魂心#↑ {{Tears}} +0.75射速#↑ 使角色变得非常小，被命中区域也减小"},
	{"439", "老妈的盒子", "生成1个随机饰品#↑ {{LuckSmall}} 持有时+1运气#持有时，饰品效果翻倍"},
	...
	{"443", "苹果！", "随机发射造成四倍伤害的刀片#↑ {{Tears}} +0.3射速"},
	{"444", "铅笔", "每发射15颗眼泪，发射一串眼泪#眼泪串中的眼泪造成双倍伤害"},
	{"445", "狗牙", "↑ {{Damage}} +0.3伤害#↑ {{Speed}} +0.1移速#如果角色在{{SecretRoom}}{{SuperSecretRoom}}隐藏房旁则有一声狼嚎#当进入有暗门的房间时则有一声吠叫"},
	...
	{"492", "嘿，听好！", "↑ {{LuckSmall}} +1运气#使隐藏房，宝藏岩石和暗门的地点高亮"},
	...
	{"513", "派对帽", "↑ {{Damage}} +0.1伤害#+1魂心#几率魅惑/恐惧1个敌人#受伤后几率生成1个彩虹便便"},
	...
	{"547", "离婚协议书", "+1骨心#↑ {{Tears}} +0.7射速#生成神秘纸张饰品"},
	{"548", "颌骨", "回旋镖状的跟班#造成7接触伤害#能捡起掉落物"},
	{"549", "成骨不全症", "以6骨心替换所有心之容器#失去骨心时：#向8个方向发射骨头眼泪#↑ {{Tears}} 永久+0.5射速"},
