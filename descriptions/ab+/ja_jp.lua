...
EID.descriptions[languageCode].collectibles={
    ...
    {"238", "Key Piece 1", "!!! メガサタンのドアを開く 鍵のかけら#↑ 天使部屋の出現率 +25%"},
    {"239", "Key Piece 2", "!!! メガサタンのドアを開く 鍵のかけら#↑ 天使部屋の出現率 +25%"},
...
EID.descriptions[languageCode].MCM = {
    ...
    DemoObjectText = "日本語の表示サンプル#↑ 行間 +0.5#↓ 文字のサイズ +0.25#説明文は、単語間の半角 スペースで自動的に改行 されます#!!! 日本語はスペースを使用 しないので、改行位置に 半角スペースを決め打ち しています 表示幅をデフォルトから 変更すると表示が崩れる 可能性があります#デフォルトの表示幅:130 全角13文字が一行の限界#最終更新日：2022-08-04",
}
