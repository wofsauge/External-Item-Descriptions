...
EID.descriptions[languageCode].collectibles={
    ...
    {"120", "Odd Mushroom (Thin)", "↑ 連射速度 +1.7#↑ 移動速度 +0.3#↓ 攻撃力　 -10%#↓ 攻撃力　 -0.4"},
    ...
    {"218", "Placenta", "↑ 最大体力 +1#1分間に1回、50%の確率で 半赤ハート回復する"},
    {"219", "Old Bandage", "↑ 最大体力 +1#ダメージを受けた時、 一定確率で赤ハートが スポーンする#確率：運0=10%、27=50%"},
    ...
    {"223", "Pyromaniac", "爆風を浴びると 体力が1回復する#踏み潰し・地割れ 攻撃を無効化#爆弾 +5"},
    {"224", "Cricket's Body", "↑ 連射間隔 -1#↓ 射程　　 -10#↓ 涙サイズ +20%#衝突した涙が四つに分裂する#分裂した涙はダメージ量が 半減する"},
    {"225", "Gimpy", "ダメージを受けた時、 一定確率で青ハートが スポーンする#確率：運0=10%、20=50%#死んだ敵が一定確率で 半赤ハートを落とす"},
    ...
    {"257", "Fire Mind", "涙に火傷効果を付与する#一定確率で敵と衝突した 涙が爆発し、炎を残す#確率：運0=10%、13=100%#!!! 自爆の危険あり"},
    ...
    {"278", "Dark Bum", "赤ハートを拾い集める 乞食の使い魔#1.5個拾うたび、青ハート・ 青クモ・敵クモのいずれかを スポーンする"},
    ...
    {"342", "Blue Cap", "↑ 最大体力 +1#↑ 連射速度 +0.7#↓ 弾速　　 -0.16"},
    ...
    {"375", "Host Hat", "爆発耐性を付与#踏み潰し・地割れ 攻撃を無効化#敵の弾を25%の確率で ブロックし、跳ね返す"},
    ...
    {"461", "Parasitoid", "一定確率で涙が卵に置き  換わり、敵に当たると、  1～2匹の青クモ／ハエが  スポーンする#卵の衝突地点に白い液体が 広がり、触れた敵をスロー 状態にする#確率：運0=15%、5=50%"},
...
EID.descriptions[languageCode].carBattery = {
	[58] = "効果時間2倍", -- Book of Shadows
	[66] = "効果時間2倍", -- The Hourglass
	[77] = "効果時間2倍", -- My Little Unicorn
	[93] = "効果時間2倍", -- The Gamekid
	[111] = "ダメージ2倍", -- The Bean
	[124] = "二種類の効果を同時発動", -- Dead Sea Scrolls
	[145] = "青ハエを4～7匹スポーン", -- Guppy's Head
	[171] = "ダメージ2倍", -- Spider Butt
	[293] = "ダメージ2倍", -- Head of Krampus
	[298] = "効果時間2倍", -- Unicorn Stump
	[351] = "ダメージ2倍", -- Mega Bean
	[383] = "涙の分裂量6倍", -- Tear Detonator
	[421] = "ダメージ2倍", -- Kidney Bean
	[427] = "TNTを二つスポーン", -- Mine Crafter
	[477] = "吸収されたアイテムにも 2倍効果が適用", -- Void
	[482] = "2回変化し、アイテムが 2個削除される", -- Clicker
	[485] = "2回発動し、25%の確率で 4倍複製する ※複製失敗→成功の順で 発動した場合、複製元は 消滅し、複製品のみ残る", -- Crooked Penny
	[486] = "効果を2回有効化する", -- Dull Razor
	[488] = "二つのアイテム効果を付与", -- Metronome
	[489] = "二種類の効果を同時発動 ※二番目の効果はランダム", -- D Infinity
	[523] = "箱と部屋の中身を 入れ替える", -- Moving Box
	[550] = "踏み潰し攻撃を 二部屋の間停止する ボスラッシュ・チャレンジ ルームでは2ウェーブの間 停止する", -- Broken Shovel
}
...
EID.descriptions[languageCode].trinkets={
    ...
    {"85", "Karma", "寄付マシーンへの寄付時、 33%の確率で以下の効果：#40%：体力を1回復#40%：キャッシュバック#15%：運 +1#5%：乞食がスポーン"},
...
EID.descriptions[languageCode].cards={
    ...
    {"4", "III - The Empress", "その部屋に居る間：#↑ 攻撃力　 +1.5#↑ 移動速度 +0.3"},
