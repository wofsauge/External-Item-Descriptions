...
EID.descriptions[languageCode].collectibles={
    ...
    {"93", "ゲームキッド", "6秒間パックマン化し、 以下の効果を得る：#無敵状態#全ての敵に恐怖を与える#40の接触ダメージ#敵を2体倒すたび 半赤ハート回復#涙攻撃不可"}, -- The Gamekid
    ...
    {"127", "フォーゲットミーなぅ", "{{Warning}} 使い切りアイテム {{Warning}}#現在のフロアを再生成する"}, -- Forget Me Now
    {"128", "永遠の孤独", "青いハエがアイザックを 周回し、接触した敵に 毎秒30ダメージを与える"}, -- Forever Alone
    {"129", "一杯の背アブラ", "↑ 最大体力 +2#↓ 移動速度 -0.2#体力0.5回復"}, -- Bucket of Lard
    {"130", "ポニー", "保持中、飛行能力を付与#1.5以下の移動速度を 1.5に修正する#使用すると進行方向に 突進し、接触した敵に 40のダメージを与える#突進中は無敵"}, -- A Pony
    ...
    {"134", "ガッピーの尻尾", "部屋のクリア報酬が 33%の確率で宝箱に、 33%の確率で無報酬に、 それぞれ置き換わる"}, -- Guppy's Tail
    {"135", "静脈注射", "いつでも売血#1ダメージ = 1～3コイン#キーパー使用時は0～1枚"}, -- IV Bag
    ...
    {"150", "タフなラブ", "一定確率で涙が歯に置き 換わり、攻撃力ｘ3.2の ダメージを与える#確率：運0=15%、9=100%"}, -- Tough Love
    ...
    {"157", "血まみれの欲望", "↑ ダメージを受けるたび 攻撃力がアップ (最大6回、+6.5)#効果は次のフロアまで有効"}, -- Bloody Lust
    ...
    {"175", "パパのカギ", "全てのドアと隠し部屋の 入り口を開放する#条件を満たしていない {{ChallengeRoom}}{{BossRushRoom}}チャレンジルーム・ メガサタンのドアも開放"}, -- Dad's Key
    ...
    {"181", "ホワイトポニー", "保持中、飛行能力を付与#1.5以下の移動速度を 1.5に修正する#使用すると進行方向に 突進し、接触した敵に 40のダメージを与える#突進中は無敵#突進時に光線が降り注ぎ、 触れた敵に攻撃力+20の ダメージを与える"}, -- White Pony
    ...
    {"187", "ガッピーの毛玉", "毛玉がアイザックを追従し、 敵に接触ダメージを与え、 弾をブロックする#毛玉で敵を倒すと、毛玉の サイズとダメージ量が増え、 最大5倍になる"}, -- Guppy's Hairball
    ...
    {"202", "マイダスタッチ", "接触した敵に所持金と 等しいダメージを与え、 黄金化し、動きを止める#黄金化状態の敵を倒すと 1～4枚のコインを落とす#うんちをスポーンする時、 黄金うんちになる可能性が アップする"}, -- Midas' Touch
    ...
    {"217", "ママのウィッグ", "攻撃中、一定確率で 青クモがスポーン#体力を1回復"}, -- Mom's Wig
    ...
    {"223", "放火魔", "爆風を浴びると 体力が1回復する#踏み潰し・地割れ 攻撃を無効化#爆弾 +5"}, -- Pyromaniac
    {"224", "クリケットの体", "↑ 連射間隔 -1#↓ 射程　　 -10#↓ 涙サイズ +20%#衝突した涙が四つに分裂する#分裂した涙はダメージ量が 半減する"}, -- Cricket's Body
    {"225", "ギンピー", "ダメージを受けた時、 一定確率で青ハートが スポーンする#確率：運0=10%、20=50%#死んだ敵が一定確率で 半赤ハートを落とす"}, -- Gimpy
    {"226", "ブラックロータス", "↑ 最大体力 +1#青ハート +1#黒ハート +1"}, -- Black Lotus
    {"227", "貯金箱", "コイン +3#ダメージを受けるたび コインを1～2枚スポーン#キーパープレイ時は 0～1枚のスポーン"}, -- Piggy Bank
    {"228", "ママの香水", "一定確率で涙に 恐怖効果を付与#確率：運0=12%、85=100%#↑ 連射間隔 -1"}, -- Mom's Perfume
    {"229", "モンストロの肺", "涙をチャージ式に置き換え、 一度に14発の涙を同時発射 できるようになる#↓ 連射間隔 ｘ4.3"}, -- Monstro's Lung
    {"230", "アバドン", "↑ 攻撃力　 +1.5#↑ 移動速度 +0.2#最大体力を0にし、6個の 黒ハートを付与する#一定確率で涙に 恐怖効果を付与"}, -- Abaddon
    ...
    {"241", "闇からの契約", "部屋のクリア報酬が2倍に なるが、1/3の確率でゼロ 報酬になる#グリードモードでは 効果なし"}, -- Contract From Below
    ...
    {"258", "けつばん", "取得時と毎フロア開始時、 全てのステータスと アイテムをリロールする"}, -- Missing No.
    ...
    {"279", "ビッグファン", "巨大なハエがアイザックを 周回し、敵に接触ダメージ を与え、弾をブロックする#毎秒10の接触ダメージ"}, -- Big Fan
    ...
    {"297", "パンドラの箱", "{{Warning}} 使い切りアイテム#使用フロアで効果が変化：#B1:青ハート 2個#B2:爆弾と鍵 各2個#C1:ボスアイテム 1個#C2:B1+C1#D1:青ハート 4個#D2:コイン 20枚#W1:ボスアイテム 2個#W2:{{Collectible33}} 聖書#???/Void:なし#Sheol:悪魔部屋アイテム1個 　　　黒ハート 1個#Cat:天使部屋アイテム 1個 　　白ハート 1個#DarkRoom:{{Collectible523}}お引越し用の箱 　　　　　 をアンロック#Chest:コイン 1枚"}, -- Pandora's Box
    ...
    {"318", "ふたご座", "アイザックと肉の鎖で つながれた使い魔が 敵を追いかけ攻撃し、 毎秒8ダメージを与える"}, -- Gemini
    ...
    {"347", "複視症状", "!!! 使い切りアイテム !!!#部屋の全てのアイテムと ピックアップを複製する"}, -- Diplopia
    ...
    {"374", "聖なる光", "一定確率で聖なる涙が 発射され、衝突すると 近くの敵に光線が降り注ぐ#光線は攻撃力ｘ4の ダメージを与える#確率：運0=9%、9=50%"}, -- Holy Light
    ...
    {"393", "サーペントのくちづけ", "一定確率で涙に毒効果が 付与される#接触した敵に毒を与える#毒を受けた敵が死んだ時、 20%の確率で黒ハートを 落とす"}, -- Serpent's Kiss
    ...
    {"398", "神々の肉", "一定確率で涙に収縮化 効果が付与される#収縮した敵は踏み潰して 倒せる"}, -- God's Flesh
    ...
    {"401", "エクスプロシボ", "一定確率で涙が敵に くっ付き、数秒後に 爆発する#くっ付いた涙は敵に ダメージを与えない"}, -- Explosivo
    ...
    {"460", "緑内障", "一定確率で涙に 混乱効果を付与#ゲーム画面が暗くなる"}, -- Glaucoma
    ...
    {"463", "硫酸", "↑ 攻撃力 +0.3#一定確率で酸の涙を 発射し、障害物や壁、 ドアを破壊する"}, -- Sulfuric Acid
    ...
    {"475", "プランＣ", "!!! 使い切りアイテム !!!#全ての敵に9,999,999の ダメージを与え、3秒後に アイザックを殺す"}, -- Plan C
    ...
    {"483", "マ・マ・メガ！", "!!! 使い切りアイテム !!!#部屋の全ての障害物を 破壊し、全ての敵に 200ダメージを与える#効果はフロア全体で発動#ボスラッシュ・ハッシュ・ 隠し部屋の入り口も破壊#!!! 金爆弾を所持している時、 ママメガ！の代わりに それを消費して効果を 発動できる"}, -- Mama Mega!
    ...
    {"490", "エデンの魂", "!!! 使い切りアイテム !!!#現在の部屋のアイテム プールから、2つの ランダムなアイテムを スポーンする#初期チャージ量が空の ため、要チャージ"}, -- Eden's Soul
    ...
    {"502", "大きなニキビ", "攻撃中、一定確率で 皮脂の弾が発射される#皮脂は2倍のダメージを 与え、敵をスロー状態に する白い液体を床に残す"}, -- Large Zit
    ...
    {"513", "ボゾ", "↑ 攻撃力 +0.1#青ハート +1#敵をランダムに恐怖か チャーム状態にする#ダメージを受けた時、 一定確率で虹色うんちを スポーンする"}, -- Bozo
    {"514", "壊れたモデム", "敵と弾がランダムな 間隔で遅延を起こす#25%の確率で部屋の クリア報酬が2倍になる"}, -- Broken Modem
    {"515", "ミステリーギフト", "!!! 使い切りアイテム !!!#現在の部屋のアイテム プールから、ランダムな アイテムを1つスポーン#低確率で{{Collectible132}}炭の塊か {{Collectible36}}うんちがスポーンする"}, -- Mystery Gift
    ...
    {"536", "いけにえの祭壇", "!!! 使い切りアイテム !!!#使い魔をランダムに最大 2体生贄に捧げ、等しい 数の悪魔部屋アイテムを スポーンする#所有する青ハエ／クモが コインに変換される"}, -- Sacrificial Altar
    {"537", "リトルゲロゲロ", "アイザックの攻撃に連動 してチャージを溜め、 解放時に有害な液体を 床に吐き出す使い魔#ピルを使用するたびに 液体の効果がランダムに 変化する#取得時、ランダムな ピルを1個スポーン"}, -- Lil Spewer
    {"538", "ビー玉", "取得時、ランダムな トリンケットを3つ スポーンする#ダメージを受けた時、 5%の確率で保持中の トリンケットが吸収 され、効果が永続化する"}, -- Marbles
    ...
    {"543", "神聖なる土", "ダメージを受けると 白いうんちがスポーン#うんちオーラの範囲内 では連射速度が増加し、 一定確率でダメージが 無効化される"}, -- Hallowed Ground
    ...
    {"550", "壊れたシャベル", "保持中、数秒おきに アイザックを狙った 踏み潰し攻撃が発生する#使用すると、その部屋に 居る間、踏み潰し攻撃が 停止する#!!! (ボスラッシュに挑戦！)"}, -- Broken Shovel
...
EID.descriptions[languageCode].trinkets={
    ...
    {"10", "ウィグル ワーム", "涙が波打つように飛ぶ#↑ 連射速度 +0.3"}, -- Wiggle Worm
    ...
    {"20", "猿の手", "ダメージを受け、残りの 体力が半ハートになった 時、黒ハートを1個落とす#3個まで有効"}, -- Monkey Paw
    ...
    {"23", "尋ね人ポスター", "保持中に生贄部屋で死ぬと ザ・ロストをアンロック#アンロック済みの場合： 死ぬと、その部屋で ザ・ロストとして復活"}, -- Missing Poster
    ...
    {"34", "子供の心", "部屋クリア時の報酬が 10%の確率でランダムな ハートに置き換わる#宝箱・ｘ岩・破壊された 機械から追加のハートが スポーンすることがある"}, -- Child's Heart
    {"35", "曲がった角", "↑ 攻撃力 +2"}, -- Curved Horn
    {"36", "さびたカギ", "部屋クリア時の報酬が 10%の確率で鍵に置き 換わる　　　#宝箱・ｘ岩・破壊された 機械から、追加の鍵が スポーンすることがある"}, -- Rusted Key
    ...
    {"41", "マッチ棒", "部屋クリア時の報酬が 10%の確率で爆弾に置き 換わる#宝箱・ｘ岩・破壊された 機械から、追加の爆弾が スポーンすることがある#!!! {{Trinket53}}ダニを除去できる"}, -- Match Stick
    {"42", "幸運の足指", "↑ 運 +1#部屋クリア時の報酬 出現率が8%アップ#宝箱・ｘ岩・破壊された 機械から、追加のピック アップがスポーンする ことがある"}, -- Lucky Toe
    {"43", "呪いのしゃれこうべ", "ダメージを受け、残りの 体力が半ハートになると ランダムな部屋にテレポート"}, -- Cursed Skull
    {"44", "ボトルキャップ", "部屋クリア時の報酬が 10%の確率でピルに置き 換わる#宝箱・ｘ岩・破壊された 機械から、追加のピルが スポーンすることがある"}, -- Safety Cap
    {"45", "スペードのエース", "部屋クリア時の報酬が 10%の確率でカードに置き 換わる#宝箱・ｘ岩・破壊された 機械から、追加のカードが スポーンすることがある"}, -- Ace of Spades
    {"46", "アイザックのフォーク", "部屋クリア時、10%の 確率で半赤ハート回復#確率は運18で最大100%に"}, -- Isaac's Fork
    {"47", "", "<Item does not exist>"},
    {"48", "失くしたページ", "ダメージを受けた時、 ネクロノミコン効果が  一定確率で発動する （全ての敵に40ダメージ）"}, -- A Missing Page
    ...
    {"53", "ダニ", "ボスのHPが15%減少#ボス部屋に入った時、 赤ハート1個回復#!!! 取得すると取り外せない#{{Trinket41}}マッチ棒で除去可能"}, -- Tick
    {"54", "アイザックの頭", "貫通効果付き涙で攻撃する 使い魔を付与"}, -- Isaac's Head
    {"55", "マギーの信念", "フロア開始時、白ハートを 1個付与する"}, -- Maggy's Faith
    {"56", "ユダの舌", "ハート2個の悪魔取引を ハート1個に割り引く"}, -- Judas' Tongue
    ...
    {"72", "時計の電池", "部屋クリア時の報酬に 電池が出現する確率が 6.67%アップ#ランダムピックアップが 電池になる確率が2%アップ#部屋をクリアした時、 5%の確率でアクティブ アイテムが1チャージ される　　　"}, -- Watch Battery
    {"73", "キャップ飛ばし", "爆発した爆弾が10%の 確率で爆弾をスポーン"}, -- Blasting Cap
    {"74", "トゲトゲファインダー", "岩を壊した時、0.5%の 確率でクロールスペースが 生成される"}, -- Stud Finder
    ...
    {"82", "金の蹄鉄", "15%の確率でトレジャー ルームのアイテムが2つ になり、どちらかを選択 できる"}, -- Golden Horse Shoe
    {"83", "店の鍵", "鍵を使わずにお店へ 入ることができる"}, -- Store Key
    {"84", "強欲アバラ骨", "お店・隠し部屋で グリードが現れなくなる#部屋のクリア報酬に コインの出現率が増え、 ハートの出現率が減る"}, -- Rib of Greed
    {"85", "カルマ", "寄付マシーンへの寄付時、 33%の確率で以下の効果：#40%：体力を1回復#40%：キャッシュバック#15%：運 +1#5%：乞食がスポーン"}, -- Karma
    ...
    {"93", "使用されたオムツ", "特定の部屋で{{Collectible9}}スカトール 効果が付与され、ハエ系の 敵が中立化する"}, -- Used Diaper
    {"94", "フィッシュテール", "青ハエ／クモをスポーン するタイプのアイテム・ トリンケットの効果を 2倍にする"}, -- Fish Tail
    ...
    {"108", "クルミ", "1～9回の爆発を受けると 消滅し、コイン・鍵・ ハート・トリンケットを スポーンする#爆発ダメージが無効化 されている状態でも 回数にカウントされる"}, -- Walnut
    ...
    {"112", "勝つためにはコインをいれる", "トレジャールームに リロールマシーンが 常時出現する"}, -- Pay to Win
...
EID.descriptions[languageCode].cards={
    ...
    {"15", "XIV - 節制", "献血機をスポーン#グリードモードでは 悪魔乞食をスポーン"}, -- Temperance
    ...
    {"49", "ダイスの破片", "全てのピックアップと アイテムをリロールする"}, -- Dice Shard
