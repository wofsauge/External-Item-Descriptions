...
EID.descriptions["fr"].collectibles={
	...
	{"210", "Feuille Grignotée", "Rester immobile pendant une seconde rend Isaac invulnérable"},
...
EID.descriptions["fr"].cards={
	...
	{"2", "I - Le Bateleur", "Larmes autoguidées#{{Blank}}#Persiste pour la durée d'une salle"},
