...
EID.descriptions["fr"].collectibles={
	...
	{"461", "Parasitoïde", "15% de chances de tirer un cocon#Toucher un ennemi avec un cocon invoque 1-2 mouches ou araignées bleues et répand une flaque ralentissante#{{Blank}}#{{LuckSmall}} Effet affecté par la statistique de chance#{{Blank}} {{ColorSilver}}(50% à 5 Chance)"},
