...
EID.descriptions["fr"].trinkets={
	...
	{"85", "Karma", "Faire un don à une boîte à dons {{DonationMachine}} peut invoquer un mendiant {{Beggar}}, faire apparaître 1 pièce ou soigner 1 cœur rouge#Augmente la probabilité d'obtenir {{ColorLime}}chance +1{{ColorWhite}}après un don"},
