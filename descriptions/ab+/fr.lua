...
EID.descriptions["fr"].collectibles={
	...
	{"93", "Jeu-Garçon", "Rend Isaac invulnérable#Terrifie tous les ennemis de la salle#Tuer un ennemi peut soigner Isaac d'un demi-cœur rouge#{{Blank}}#{{Timer}} Persiste pendant 6.5 secondes"},
	...
	{"136", "Mon Meilleur Ami", "Place une peluche en forme d'Isaac#La peluche attire les ennemis et explose après 5 secondes"},
	...
	{"231", "Boule de Goudron", "10% de chances de tirer une larme ralentissante#Isaac répand une traînée de goudron ralentissante#{{Blank}}#{{LuckSmall}} Effet affecté par la statistique de chance#{{Blank}} {{ColorSilver}}(100% à 18 Chance)"},
	...
	{"527", "Boîte à Larbin", "Utiliser l'objet affiche un curseur déplaçable#{{Blank}} Après quelques secondes, invoque un familier qui va interagir avec l'élément le plus proche du curseur#Peut être utilisé pour voler des objets, ouvrir des serrures ou exploser un élément"},
...
EID.descriptions["fr"].pills={
	...
	{"36", "Vitamines !", "Rend Isaac invulnérable#Terrifie tous les ennemis de la salle#Tuer un ennemi peut soigner Isaac d'un demi-cœur rouge#{{Blank}}#{{Timer}} Persiste pendant 6.5 secondes"},
