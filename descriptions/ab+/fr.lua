...
EID.descriptions[languageCode].collectibles={
	...
	{"45", "Joli Cœur", "{{HealingRed}} Soigne un cœur rouge"},
	...
	{"92", "Super Pansement", "{{Heart}} +1 réceptacle de cœur#{{HealingRed}} Soigne un cœur rouge#{{SoulHeart}} +2 cœurs d'âme"},
	...
	{"217", "Perruque de Maman", "{{HealingRed}} Soigne un cœur rouge#Tirer une larme invoque parfois une araignée bleue#{{LuckSmall}} Effet affecté par la statistique de chance#{{Blank}} {{ColorSilver}}(100% à 10 Chance)"},
	...
	{"535", "Couverture", "{{SoulHeart}} +1 cœur d'âme#{{HealingRed}} Soigne un cœur rouge#Nullifie le premier dégât subi dans une salle de boss"},
...
EID.descriptions[languageCode].trinkets={
	...
	{"53", "Tique", "{{HealingRed}} Entrer dans une salle de boss soigne un cœur rouge#Retire 15% des PV des boss#{{Warning}} Ne peut pas être retiré sans {{ColorYellow}}Match Stick{{ColorWhite}} {{Trinket41}}"},
