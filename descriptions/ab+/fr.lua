...
EID.descriptions["fr"].collectibles={
	...
	{"86", "Dent de Monstro", "{{ColorCyan}}Monstro{{ColorWhite}} tombe et écrase un ennemi#S'il n'y a pas d'ennemis, {{ColorCyan}}Monstro{{ColorWhite}} écrase Isaac"},
	...
	{"93", "Jeu-Garçon", "Isaac devient brièvement invulnérable et inflige des dégâts de contact#Terrifie tous les ennemis de la salle#Tuer deux ennemis soigne Isaac d'un demi-cœur rouge"},
	...
	{"104", "Parasite", "Les larmes d'Isaac se divisent en deux au contact d'un objet ou d'un ennemi"},
	{"105", "D6", "Rejoue les objets sur piédestal de la salle"},
	{"106", "M. Méga", "↑ Dégâts des bombes {{ColorLime}}x2.25#{{Bomb}} +5 Bombes"},
	{"107", "Ciseaux Cranteurs", "Sépare la tête d'Isaac de son corps#Le joueur contrôle la tête#Le corps pourchasse les ennemis et inflige des dégâts de contact"},
	...
	{"136", "Mon Meilleur Ami", "Place une peluche en forme d'Isaac#La peluche attire les ennemis et explose après quelques secondes"},
	...
	{"168", "Super Fœtus", "Les larmes d'Isaac sont remplacées par un curseur déplaçable avec les boutons de tir#Un missile frappe le sol à l'emplacement du curseur après quelques secondes"},
	...
	{"201", "Lingot de Fer", "↑ Dégâts {{ColorLime}}+0.3#10% de chances de tirer une larme étourdissante#{{Blank}}#{{LuckSmall}} Effet affecté par la statistique de chance#{{Blank}} {{ColorSilver}}(100% à 27 Chance)"},
	...
	{"210", "Feuille Mâchouillée", "Rester immobile pendant une seconde rend Isaac invulnérable"},
	...
	{"218", "Placenta", "{{Heart}} +1 réceptacle de cœur#Chance de régénérer un demi-cœur rouge à chaque minute du chronomètre"},
