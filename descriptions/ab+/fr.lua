...
EID.descriptions["fr"].collectibles={
	...
	{"7", "Sang du Martyr", "↑ Dégâts {{ColorLime}}+1.0#↑ {{ColorLime}}+50% si Isaac tient {{ColorYellow}}Book of Belial {{Collectible34}}"},
	{"8", "Frère Bobby", "Suit Isaac et tire en même temps que lui#{{Blank}}#{{DamageSmall}} 3.5 par larme"},
	{"9", "Scatol", "Les mouches ennemies deviennent inoffensives"},
	{"10", "Couronne de Mouches", "2 mouches orbitent Isaac#Les mouches bloquent les projectiles ennemis"},
	{"11", "1-UP !", "↑ +1 Vie#Isaac reçoit un soin complet en ressucitant"},
	...
	{"33", "Bible", "Permet à Isaac de voler pour durée de la salle#Tue instantanément {{ColorCyan}}Mom's Foot{{ColorWhite}}, {{ColorCyan}}Mom's Heart{{ColorWhite}} et {{ColorCyan}}It Lives!{{ColorWhite}}#{{Warning}} Tue Isaac si utilisée pendant le combat contre {{ColorCyan}}Satan"},
	...
	{"40", "Kamikaze !", "Isaac explose#Inflige 40 dégâts aux ennemis à proximité#{{Warning}} Inflige un demi-cœur de dégâts à Isaac"},
	...
	{"47", "Télécommande du Docteur", "Affiche un curseur déplaçable avec les boutons de tir#Une bombe aérienne frappe la position du curseur après quelques secondes"},
	...
	{"54", "Carte au Trésor", "Révèle la disposition des salles de l'étage sur la carte"},
	{"55", "Œil de Maman", "50% de chances de tirer une larme dans la direction opposée#{{Blank}}#{{LuckSmall}} Effet affecté par la statistique de chance#{{Blank}} {{ColorSilver}}(100% à 5 Chance)"},
	{"56", "Petit Acident", "Répand une flaque jaune au sol#Les ennemis qui marchent dans la flaque subissent 66 dégâts par seconde"},
	{"57", "Admiration Distante", "Orbite autour d'Isaac##{{Blank}}#{{DamageSmall}} 75 par seconde au contact"},
	...
	{"65", "Livre de Recettes Anarchistes", "Invoque 6 troll bombs dans la salle"},
	{"66", "Sablier", "Ralentit les ennemis pendant 8 secondes"},
	{"67", "Sœurette Maggy", "Suit Isaac et tire en même temps que lui#{{Blank}}#{{DamageSmall}} 3.5 par larme"},
	...
	{"75", "Doctorat", "{{Pill}} +1 pilule#Les pilules ne peuvent plus avoir d'effet négatif#Soigne 2 cœurs rouges#Les machines de don du sang {{BloodDonationMachine}} et {{ColorYellow}}IV Bag{{ColorWhite}} {{Collectible135}} donnent davantage de pièces"},
	...
	{"81", "Chat Mort", "↑ +9 Vies#↓ Réduit le nombre de réceptacles de cœurs rouges d'Isaac à 1#Isaac ressucite avec 1 réceptacle de cœur"},
	...
	{"86", "Dent de Monstro", "{{ColorCyan}}Monstro{{ColorWhite}} tombe et écrase un ennemi#Dans une salle sans ennemis, {{ColorCyan}}Monstro{{ColorWhite}} écrase Isaac"},
	{"87", "Cornes de Loki", "25% de chances de tirer dans 4 directions à la fois#{{Blank}}#{{LuckSmall}} Effet affecté par la statistique de chance#{{ColorGrey}}(100% à 7 Chance}}"},
	{"88", "P'tit Dodu", "S'élance dans la direction des tirs d'Isaac#{{Blank}}#{{DamageSmall}} 52.5 par seconde au contact"},
	{"89", "Morsure d'Araignée", "25% de chances de tirer une larme ralentissante#{{Blank}}#{{LuckSmall}} Effet affecté par la statistique de chance#{{Blank}} {{ColorSilver}}(100% à 15 Chance)"},
	...
	{"93", "Jeu-Garçon", "Isaac devient temporairement invulnérable et inflige 40 Dégâts de contact#Terrifie tous les ennemis de la salle#Tuer deux ennemis soigne Isaac d'un demi-cœur rouge"},
	{"94", "Bourse", "Fait apparaître une pièce toutes les 2 salles"},
	{"95", "Robo-Bébé", "Tire des lasers##{{Blank}}#{{DamageSmall}} 3.5 par laser"},
	...
	{"99", "P'tit Gish", "Tire des larmes ralentissantes#{{Blank}}#{{DamageSmall}} 3.5 par larme"},
	{"100", "P'tit Steven", "Tire des larmes autoguidées#{{Blank}}#{{DamageSmall}} 3.5 par larme"},
	...
	{"103", "Rhume", "25% de chances de tirer une larme empoisonnée#{{Blank}}#{{LuckSmall}} Effet affecté par la statistique de chance#{{Blank}} {{ColorSilver}}(100% à 12 Chance)"},
	{"104", "Parasite", "Les larmes d'Isaac se divisent en deux au contact d'un objet ou d'un ennemi#Les larmes divisées infligent 50% de dégâts"},
	{"105", "D6", "Rejoue les objets sur piédestal de la salle"},
	{"106", "M. Méga", "↑ Dégâts des bombes {{ColorLime}}x2.25#{{Bomb}} +5 Bombes"},
	{"107", "Ciseaux Cranteurs", "Sépare la tête d'Isaac de son corps#Le joueur contrôle la tête#Le corps pourchasse les ennemis et inflige 82.5 dégâts de contact par seconde"},
	...
	{"110", "Lentille de Maman", "20% de chances de tirer une larme paralysante#↑ Portée {{ColorLime}}+0.25#↑ Hauteur des larmes {{ColorLime}}+0.5#{{Blank}}#{{LuckSmall}} Effet affecté par la statistique de chance#{{Blank}} {{ColorSilver}}(100% à ~20 Chance)"},
	{"111", "Haricot", "Isaac pète et empoisonne les ennemis à proximité"},
	{"112", "Ange Gardien", "Orbite autour d'Isaac#Bloque les projectiles ennemis#Augmente la vitesse de rotation des autres familiers#{{Blank}}#{{DamageSmall}} 105 par seconde au contact"},
	{"113", "Bébé Démoniaque", "Tire automatiquement sur les ennemis à proximité#{{Blank}}#{{DamageSmall}} 3 par larme"},
	...
	{"117", "Oiseau Mort", "Quand Isaac subit un dégât, l'oiseau s'éveille et pourchasse les ennemis#{{DamageSmall}} 4 par seconde au contact"},
	...
	{"128", "Seul à Jamais", "Orbite autour d'Isaac#{{Blank}}#{{DamageSmall}} 30 par seconde au contact"},
	{"129", "Seau de Saindoux", "{{EmptyHeart}} +2 réceptacles de cœur#↓ Vitesse {{ColorError}}-0.2#Soigne un demi-cœur rouge"},
	{"130", "Poney Noir", "Permet à Isaac de voler#↑ Vitesse ≥1.5#Utiliser l'objet déclenche une ruée dans la direction où se déplace Isaac#Isaac est invulnérable durant la ruée"},
	...
	{"134", "Queue de Guppy", "{{ColorLime}}33%{{ColorWhite}} de chance de remplacer la récompense d'une salle par un coffre#{{ColorError}}33%{{ColorWhite}} de chance d'annuler la récompense d'une salle"},
	{"135", "Perfusion", "Inflige un demi-cœur de dégâts à Isaac#Fait apparaître 1-3 pièces"},
	{"136", "Mon Meilleur Ami", "Place une peluche en forme d'Isaac#La peluche attire les ennemis puis explose après quelques secondes"},
	...
	{"139", "Sac à Main de Maman", "Permet à Isaac de porter 2 trinkets"},
	...
	{"145", "Tête de Guppy", "Invoque 2-4 mouches bleues"},
	...
	{"148", "Infestation", "Subir un dégât invoque 1-3 mouches bleues"},
	...
	{"150", "Poing Américain", "10% de chances de tirer une dent#Les dents infligent {{ColorLime}}dégâts x3.2#{{Blank}}#{{LuckSmall}} Effet affecté par la statistique de chance#{{Blank}} {{ColorSilver}}(100% à 9 Chance)"},
	...
	{"155", "Œil Baladeur", "Rebondit contre les murs de la salle#{{Blank}}#{{DamageSmall}} 17.1 par seconde au contact"},
	...
	{"158", "Cristal", "Révèle l'intégralité de l'étage sur la carte#Fait apparaître une carte ou un cœur d'âme"},
	{"159", "Esprit de la Nuit", "Permet à Isaac de voler#Larmes spectrales"},
	{"160", "Fissure Céleste", "5 rayons de lumière frappent à proximité des ennemis#Les rayons de lumière infligent {{ColorLime}}dégâts +20"},
	{"161", "Ânkh", "Réincarne Isaac en {{ColorLightOrange}}???{{ColorWhite}} à sa mort"},
	{"162", "Croix Celte", "Subir un dégât peut rendre Isaac temporairement invulnérable#{{Blank}}#{{LuckSmall}} Effet affecté par la statistique de chance#{{Blank}} {{ColorSilver}}(100% à 27 Chance)"},
	{"163", "Bébé Fantôme", "Tire des larmes spectrales#{{Blank}}#{{DamageSmall}} 3.5 par larme"},
	{"164", "Bougie Bleue", "Lance une flamme bleue dans la direction des tirs d'Isaac#La flamme inflige des dégâts de contact, bloque les projectiles et disparaît au bout de 2 secondes"},
	...
	{"167", "Bébé Arlequin", "Tire deux larmes écartées#{{Blank}}#{{DamageSmall}} 4 par larme"},
	{"168", "Super Fœtus", "Les larmes d'Isaac sont remplacées par un curseur déplaçable avec les boutons de tir#Une bombe aérienne frappe le sol à l'emplacement du curseur après quelques secondes#Les attaques aériennes infligent {{ColorLime}}dégâts x20"},
	{"169", "Polyphème", "↑ Dégâts {{ColorLime}}x2 +4#↓ Débit diminué#Les larmes qui tuent un ennemi le transpercent"},
	{"170", "Le Faucheux", "Écrase parfois un ennemi##{{Blank}}#{{DamageSmall}} 40 par seconde au contact"},
	{"171", "Filière d'Araignée", "Ralentit tous les ennemis pendant 4 secondes#Inflige 10 dégâts à tous les ennemis"},
	{"172", "Dague Sacrificielle", "Orbite autour d'Isaac#Bloque les projectiles ennemis#{{Blank}}#{{DamageSmall}} 225 par seconde au contact"},
	{"173", "Mitre", "Augmente les chances de trouver des cœurs d'âme"},
	{"174", "Bébé Arc-en-Ciel", "Tire des larmes aléatoires#{{Blank}}#{{DamageSmall}} 3-5 par larme"},
	{"175", "Clé de Papa", "Ouvre toutes les portes de la salle#Peut également ouvrir la majorité des portes spéciales"},
	{"176", "Cellules Souches", "{{Heart}} +1 réceptacle de cœur#↑ Vitesse des tirs {{ColorLime}}+0.16"},
	{"177", "Casino Portatif", "Retire 1 pièce à Isaac#Peut faire apparaître une ressource"},
	{"178", "Eau Bénite", "Subir un dégât répand une flaque d'eau#{{Blank}}#{{DamageSmall}} 24 par seconde pour la flaque"},
	{"179", "Destin", "Permet à Isaac de voler#{{EternalHeart}} +1 cœur éternel"},
	{"180", "Haricot Noir", "Subir un dégât fait péter Isaac"},
	{"181", "Poney Blanc", "Permet à Isaac de voler#↑ Vitesse ≥1.5#Utiliser l'objet déclenche une ruée dans la direction où se déplace Isaac#Des rayons de lumière frappent aléatoirement le sol pendant la ruée#Isaac est invulnérable pendant la ruée"},
	...
	{"187", "Boule de Poils de Guppy", "Peut être projetée en bougeant#Grandit à chaque ennemi qu'elle tue#La taille de la boule se réinitialise à chaque nouvel étage#{{Blank}}#{{DamageSmall}} 10-14-18-22-26 selon sa taille"},
	{"188", "Abel", "Réfléchit les mouvements d'Isaac#Tire en direction d'Isaac#{{Blank}}#{{DamageSmall}} 3.5 par larme"},
	...
	{"191", "Billet de Trois", "Donne aux larmes un effet aléatoire toutes les 2-3 secondes"},
	{"192", "La Télépathie Pour les Nuls", "Larmes autoguidées pour la durée d'une salle"},
	...
	{"200", "Fard à Paupières de Maman", "10% de chances de tirer une larme envoûtante#{{Blank}}#{{LuckSmall}} Effet affecté par la statistique de chance#{{Blank}} {{ColorSilver}}(100% à 27 Chance)"},
	{"201", "Lingot de Fer", "↑ Dégâts {{ColorLime}}+0.3#10% de chances de tirer une larme étourdissante#Recharge entièrement la {{ColorYellow}}Pioche en Fer {{Collectible147}}#{{Blank}}#{{LuckSmall}} Effet affecté par la statistique de chance#{{Blank}} {{ColorSilver}}(100% à 27 Chance)"},
	...
	{"210", "Feuille Mâchouillée", "Rester immobile pendant 1 seconde rend Isaac invulnérable"},
	{"211", "Bébé Araignée", "Subir un dégât invoque 1-2 araignées bleues"},
	...
	{"214", "Anémie", "↑ Portée {{ColorLime}}+5#Subir un dégât répand une traînée de sang derrière Isaac pour la durée d'une salle#{{Blank}}#{{DamageSmall}} 6 par seconde pour la flaque"},
	...
	{"217", "Perruque de Maman", "Soigne un cœur rouge#Tirer une larme a une chance d'invoquer une araignée bleue#{{Blank}}#{{LuckSmall}} Effet affecté par la statistique de chance#{{Blank}} {{ColorSilver}}(100% à 10 Chance)"},
	{"218", "Placenta", "{{Heart}} +1 réceptacle de cœur#Chance de régénérer un demi-cœur rouge à chaque minute du chronomètre#Régénère une pièce pour le Gardien"},
	{"219", "Vieux Pansement", "{{EmptyHeart}} +1 réceptacle de cœur#Subir un dégât a une chance de faire apparaître un cœur rouge#{{Blank}}#{{LuckSmall}} Effet affecté par la statistique de chance#{{Blank}} {{ColorSilver}}(50% à 29 Chance)"},
	...
	{"224", "Corps de Cricket", "↑ Débit {{ColorLime}}+1.0#↓ Portée {{ColorError}}-10.0#Les larmes se divisent en 4 au contact d'un obstacle ou d'un ennemi"},
	{"225", "Latex", "Subir un dégât a une chance de faire apparaître un cœur d'âme#Tuer un ennemi a une chance de faire apparaître un demi-cœur rouge#{{Blank}}#{{LuckSmall}} Effet affecté par la statistique de chance#{{Blank}} {{ColorSilver}}(50% à 22 Chance)"},
	{"226", "Lotus Noir", "{{Heart}} +1 réceptacle de cœur#{{SoulHeart}} +1 cœur d'âme#{{BlackHeart}} +1 cœur noir"},
	{"227", "Tirelire Cochon", "{{Coin}} +3 Pièces#Subir un dégât fait apparaître 1-2 pièces#Fait apparaître 0-1 pièce pour {{ColorLightOrange}}Keeper"},
	{"228", "Parfum de Maman", "↑ Débit {{ColorLime}}+1.0#15% de chances de tirer une larme terrifiante#Les ennemis terrifiés fuient Isaac#{{Blank}}#{{LuckSmall}} Effet affecté par la statistique de chance#{{Blank}} {{ColorSilver}}(100% à 85 Chance)"},
	...
	{"230", "Abaddon", "↑ Dégâts {{ColorLime}}+1.5#↑ Vitesse {{ColorLime}}+0.2#{{BlackHeart}} +6 cœurs noirs#Retire tous les réceptacles de cœur#12.5% de chances de tirer une larme terrifiante#{{Blank}}#{{LuckSmall}} Effet affecté par la statistique de chance#{{Blank}} {{ColorSilver}}(100% à 85 Chance)"},
	{"231", "Boule de Goudron", "10% de chances de tirer une larme ralentissante#Laisse une traînée de goudron ralentissante derrière Isaac#{{Blank}}#{{LuckSmall}} Effet affecté par la statistique de chance#{{Blank}} {{ColorSilver}}(100% à 18 Chance)"},
	...
	{"238", "Premier Fragment de Clé", "Combiner ce morceau de clé avec l'autre {{Collectible239}} permet d'ouvrir la grande porte dorée dans {{ColorTransform}}Chest{{ColorWhite}} et {{ColorTransform}}Dark Room #{{AngelDevilChanceSmall}} Augmente les chances d'Angel Rooms {{AngelRoom}}"},
	{"239", "Second Fragment de Clé", "Combiner ce morceau de clé avec l'autre {{Collectible238}} permet d'ouvrir la grande porte dorée dans {{ColorTransform}}Chest{{ColorWhite}} et {{ColorTransform}}Dark Room #{{AngelDevilChanceSmall}} Augmente les chances d'Angel Rooms {{AngelRoom}}"},
	...
	{"244", "Tech 0,5", "Tire aléatoirement des lasers en plus des larmes d'Isaac"},
	...
	{"251", "Deck du Débutant", "Permet à Isaac de porter 2 cartes#Transforme toutes les pilules en cartes"},
	{"252", "Petit Sachet", "Permet à Isaac de porter 2 pilules#Transforme toutes les cartes en pilules"},
	{"253", "Croûte Magique", "↑ Chance {{ColorLime}}+1#{{Heart}} +1 réceptacle de cœur"},
	{"254", "Caillot de Sang", "↑ Dégâts {{ColorLime}}+1#↑ Portée {{ColorLime}}+5#Ne s'applique qu'aux larmes tirées de l'oeil gauche"},
	...
	{"257", "Esprit de Feu", "Enflamme les ennemis touchés par les larmes d'Isaac#Les larmes d'Isaac ont une chance d'exploser au contact d'un ennemi#{{Warning}} Ces explosions peuvent infliger des dégâts à Isaac#{{Blank}}#{{LuckSmall}} Effet affecté par la statistique de chance#{{Blank}} {{ColorSilver}}(100% à 13 Chance)"},
	{"258", "Missing No.", "Rejoue tous les objets d'Isaac au changement d'étage"},
	{"259", "Matière Noire", "↑ Dégâts {{ColorLime}}+1.0#33% de chances de tirer une larme terrifiante#{{Blank}}#{{LuckSmall}} Effet affecté par la statistique de chance#{{Blank}} {{ColorSilver}}(100% à 20 Chance)"},
	...
	{"264", "Mouche Maline", "Orbite autour d'Isaac#Attaque les ennemis qui infligent des dégâts à Isaac#{{Blank}}#{{DamageSmall}} 22.5 par seconde au contact"},
	...
	{"266", "Cocon Juteux", "Répand une traînée de liquide ralentissant derrière lui#Invoque 1-2 araignées bleues quand Isaac termine une salle"},
	{"267", "Robo-Bébé 2.0", "Tire des lasers#Se déplace dans la direction des tirs d'Isaac#{{Blank}}#{{DamageSmall}} 3.5 par laser"},
	{"268", "Bébé Putride", "Crache des mouches bleues quand Isaac tire"},
	{"269", "Bébé Décapité", "Répand une traînée de sang derrière lui#{{Blank}}#{{DamageSmall}} 6 par seconde pour la flaque"},
	{"270", "Sangsue", "Pourchasse les ennemis#Soigne un demi-cœur rouge pour chaque ennemi qu'elle tue#{{Blank}}#{{DamageSmall}} 3 par seconde au contact"},
	{"271", "Pochon Mystère", "Fait apparaître une ressource toutes les 5-6 salles"},
	{"272", "BGM", "Rebondit contre les murs de la salle#Explose au contact d'un ennemi#{{Warning}} L'explosion peut infliger des dégâts à Isaac#{{Blank}}#{{DamageSmall}} 10 au contact#{{Blank}} 60 par explosion"},
	{"273", "Cerveau de Bob", "Peut être projeté en ligne droite avec les boutons de tir#Explose au contact d'un ennemi#{{Warning}} L'explosion peut infliger des dégâts à Isaac#{{Blank}}#{{DamageSmall}} 60 par explosion"},
	{"274", "Meilleure Pote", "Subir un dégat fait apparaître une mouche qui orbite autour d'Isaac pour la durée d'une salle#{{Blank}}#{{DamageSmall}} 75 par seconde au contact"},
	{"275", "P'tit Soufre", "Charge et crache un laser Brimstone quand Isaac tire#{{Blank}}#{{DamageSmall}} 31.5 sur la durée d'un laser"},
	...
	{"277", "P'tit Revenu", "Pourchasse les ennemis#Terrifie les ennemis#{{Blank}}#{{DamageSmall}} 4 par seconde au contact"},
	{"278", "Mendiant des Ombres", "Ramasse les cœurs rouges au sol et convertit 1,5 cœurs rouges en 1 cœur d'âme ou une araignée"},
	{"279", "Mon Plus Gros Fan", "Orbite autour d'Isaac#Bloque les projectiles#{{Blank}}#{{DamageSmall}} 30 par seconde au contact"},
	...
	{"286", "Carte Blanche", "Active l'effet de la carte portée par Isaac sans la consommer"},
	{"287", "Livre des Secrets", "Donne l'effet de {{ColorYellow}}Treasure Map{{ColorWhite}} {{Collectible54}}, {{ColorYellow}}The Compass{{ColorWhite}} {{Collectible21}} ou {{ColorYellow}}Blue Map{{ColorWhite}} {{Collectible246}} pour la durée de l'étage"},
	{"288", "Boîte d'Araignées", "Invoque 1-4 araignées bleues"},
	{"289", "Bougie Rouge", "Lance une flamme rouge#La flamme disparaît après avoir infligé des dégâts ou bloqué des tirs 5 fois"},
	{"290", "Bocal en Verre", "Marcher sur un cœur rouge quand tous les réceptacles de cœurs rouge d'Isaac sont remplis le place dans le bocal#Utiliser l'objet sort tous les cœurs rouges du bocal et les place sur le sol"},
	...
	{"294", "Haricot Blanc", "Isaac pète et repousse les ennemis et projectiles à proximité#10% de chances de devenir {{ColorYellow}}Wait What?{{ColorWhite}}{{Collectible484}} quand il est échangé avec un autre objet activable"},
	...
	{"298", "Corne Brisée", "{{Blank}}#{{Blank}} Pendant 6 secondes :#↑ Vitesse {{ColorLime}}+0.28#Rend Isaac invulnérable"},
	{"299", "Taureau", "↓ Vitesse {{ColorError}}-0.3#La vitesse d'Isaac augmente progressivement dans les salles hostiles#Quand la stat de vitesse atteint 2.0, Isaac devient invulnérable pour quelques secondes"},
	{"300", "Bélier", "↑ Vitesse {{ColorLime}}+0.25#Entrer en contact avec un ennemi lui inflige des dégâts"},
	{"301", "Cancer", "{{SoulHeart}} +3 cœurs d'âme#Quand Isaac subit un dégât, réduit tous les prochains dégâts subis à un demi-cœur pour la durée d'une salle"},
	{"302", "Lion", "Taille augmentée#Permet à Isaac de détruire les rochers en marchant dessus"},
	{"303", "Vierge", "Les pilules ne peuvent plus avoir d'effets négatifs#Subir un dégât a une chance de rendre Isaac temporairement invulnérable#{{Blank}}#{{LuckSmall}} Effet affecté par la statistique de chance#{{Blank}} {{ColorSilver}}(100% à 10 Chance)"},
	...
	{"312", "Chouchou de Maggy", "{{Heart}} +1 réceptacle de cœur#Double la quantité de PV soignée par les cœurs rouges"},
	...
	{"318", "Gémeaux", "S'attache à Isaac et pourchasse les ennemis à proximité#{{Blank}}#{{DamageSmall}} 6 par seconde au contact"},
	{"319", "Œil Gauche de Caïn", "Rebondit contre les murs de la salle#Tire dans la même direction qu'Isaac#{{Blank}}#{{DamageSmall}} Identiques à ceux d'Isaac"},
	{"320", "La Seule Amie de ???", "Déplaçable avec les boutons de tir#{{Blank}}#{{DamageSmall}} 37.5 par seconde au contact"},
	...
	{"322", "Bébé Moqueur", "Imite les tirs d'un des familiers d'Isaac#{{Blank}}#{{DamageSmall}} Identiques à ceux du familier imité"},
	...
	{"324", "erreur", "{{Blank}} Téléporte Isaac vers l'une de ces salles :#{{Blank}}#{{TreasureRoom}} Treasure Room#{{SecretRoom}} Secret Room#{{SuperSecretRoom}} Super Secret Room#I AM ERROR Room"},
	...
	{"335", "L'Âme", "{{SoulHeart}} +2 cœurs d'âme#Isaac est entouré d'un halo qui dévie les ennemis et leurs projectiles"},
	...
	{"344", "Boîte d'Allumettes", "{{BlackHeart}} +1 cœur noir#Fait apparaître 2-3 Bombes"},
	...
	{"347", "Diplopie", "{{Warning}} USAGE UNIQUE {{Warning}}#Duplique tous les objets sur piédestal et ressources de la salle"},
	{"348", "Placebo", "Active l'effet de la pilule portée par Isaac sans la consommer"},
	{"349", "Pièce en Bois", "50% de chances de faire apparaître une pièce"},
	{"350", "Choc Toxique", "Empoisonne tous les ennemis en entrant dans une salle#Les ennemis répandent une flaque toxique à leur mort"},
	...
	{"353", "Homme Bombeur", "{{Bomb}} +5 Bombes#Les bombes explosent en forme de croix"},
	...
	{"357", "Boîte de Potes", "Duplique tous les familiers d'Isaac pour la durée d'une salle#Utiliser l'objet plus d'une fois dans la même salle rajoute une copie de chaque familier à chaque utilisation"},
	{"358", "Bonnet d'Âne", "Isaac tire 2 larmes en diagonale#Larmes spectrales"},
	{"359", "Gros Clous", "↑ Dégâts {{ColorLime}}+1.5#Augmente le le recul infligé par les larmes d'Isaac"},
	{"360", "Incube", "Imite les stats et effets des larmes d'Isaac#{{Blank}}#{{DamageSmall}} Identiques à ceux d'Isaac"},
	{"361", "Récompense du Destin", "Tire des larmes à faible débit#{{Blank}}#{{DamageSmall}} Identiques à ceux d'Isaac"},
	{"362", "P'tit Coffre", "{{Blank}} Peut faire apparaître à la fin d'une salle :#Ressource {{ColorSilver}}(25%)#Trinket {{ColorSilver}}(10%)"},
	{"363", "Protecteur Dévoué", "Orbite autour d'Isaac#Attire et bloque les projectiles ennemis#Peut faire apparaître un cœur éternel s'il bloque 10 projectiles dans une même salle#{{Blank}}#{{DamageSmall}} 105 par seconde au contact"},
	{"364", "Relation à Distance", "Orbite autour d'Isaac#{{Blank}}#{{DamageSmall}} 45 par seconde au contact"},
	{"365", "Mouche Égarée", "Longe les murs et les obstacles#{{Blank}}#{{DamageSmall}} 105 par seconde au contact"},
	{"366", "Bombes à Fragmentation", "{{Bomb}} +5 Bombes#Les bombes d'Isaac se divisent en 2-4 mini-bombes en explosant"},
	{"367", "Bombes Arachnides", "{{Bomb}} +5 Bombes#Les bombes placées par Isaac collent aux ennemis#Les ennemis tués par des bombes invoquent 2-4 araignées bleues"},
	...
	{"373", "Œil de Lynx", "↑ Dégâts {{ColorLime}}+12.5%{{ColorWhite}} pour chaque larme consécutive qui touche un ennemi#Plafonne à {{ColorLime}}dégâts x2#Ne pas toucher d'ennemi avec une larme a une chance de remettre le bonus à zéro"},
	{"374", "Saint Éclat", "10% de chances de tirer une larme sacrée qui frappe l'ennemi touché d'un rayon de lumière#Le rayon inflige 400% des dégâts d'Isaac#{{Blank}}#{{LuckSmall}} Effet affecté par la statistique de chance#{{Blank}} {{ColorSilver}}(50% à 9 Chance)"},
	...
	{"376", "Réapprovisionnement", "Les objets et ressources achetés à la boutique sont réapprovisionnées instantanément, permettant d'en acheter plusieurs#Fait apparaître 3 ressources"},
	{"377", "Cocon Éclaté", "Les araignées ennemies ne prennent plus pour cible ni n'infligent de dégâts à Isaac"},
	...
	{"380", "Fente Magique", "{{Coin}} +5 Pièces#Les portes qui doivent être ouvertes par une clé se dévérouillent avec une pièce"},
	...
	{"383", "Détonateur Lacrymal", "Divise en 6 toutes les larmes d'Isaac présentes à l'écran"},
	{"384", "P'tit Boris", "Charge quand Isaac tire, puis se propulse à traverse la salle et rebondit contre les murs quand les boutons de tirs sont relâchés#{{Blank}}#{{DamageSmall}} 0-90 par seconde selon sa vitesse"},
	{"385", "Bumbo", "{{Blank}} Ramasse les pièces au sol et évolue :#Niveau 2 {{ColorSilver}}(6 {{Coin}}){{ColorWhite}} :#{{Blank}} Fait apparaître des ressources, coffres ou objets#Niveau 3 {{ColorSilver}}(12 {{Coin}}){{ColorWhite}} :#{{Blank}} Tire dans la même direction qu'Isaac#Niveau 4+ {{ColorSilver}}(24 {{Coin}}){{ColorWhite}} :#{{Blank}} Ne tire plus mais poursuit les ennemis et fait apparaître des bombes amorcées#{{Blank}}#{{Blank}} Peut faire apparaître une ressource pour chaque pièce ramassée"},
	{"386", "D12", "Rejoue tous les obstacles de la salle"},
	{"387", "Encensoir", "Suit Isaac#Est entouré d'une aura de lumière qui ralentit les ennemis et projectiles qui y entrent"},
	...
	{"390", "Séraphin", "Tire des larmes autoguidées#{{Blank}}#{{DamageSmall}} 10 par larme"},
	{"391", "Trahison", "Subir un dégât envoûte tous les ennemis de la salle"},
	{"392", "Zodiaque", "Donne à Isaac l'effet d'un objet du zodiaque aléatoire#L'effet accordé par l'objet change à chaque étage"},
	...
	{"396", "Scalpel Ventriculaire", "Utiliser l'objet place un trou orange ou bleu sur le sol#Si les deux sont posés, entrer dans l'un des trous téléporte Isaac à l'autre#Placer un nouveau trou remplace le plus ancien des deux"},
	...
	{"400", "Sainte Lance", "Isaac brandit devant lui une lance qui inflige {{ColorLime}}dégâts x2#La lame peut terrifier les ennemis au contact#La lance ne remplace pas les larmes d'Isaac"},
	...
	{"402", "Chaos", "Tous les futurs objets proviendront d'une banque d'objet aléatoire au lieu de celle de la salle où ils sont générés#Fait apparaître 1-6 ressources"},
	...
	{"407", "Pureté", "↑ Augmente une stat en fonction de la couleur de l'aura qui entoure Isaac#{{Blank}}#{{ColorRed}}Rouge{{ColorWhite}} = Dégâts {{ColorLime}}+4.0#{{ColorCyan}}Bleu{{ColorWhite}} = Débit {{ColorLime}}+4.0#{{ColorYellow}}Jaune{{ColorWhite}} = Vitesse {{ColorLime}}+0.5#{{ColorOrange}}Orange{{ColorWhite}} = Portée {{ColorLime}}+7.5#{{Blank}}#L'effet disparaît en recevant des dégâts et revient à la salle suivante"},
	{"408", "Athamé", "Quand Isaac subit des dégâts, un anneau noir apparaît autour de lui et inflige des dégâts aux ennemis#Les ennemis tués par le halo noir ont une chance de lâcher un cœur noir"},
	...
	{"410", "Mauvais Œil", "Chance de tirer un œil qui se déplace lentement en ligne droite#L'œil tire des larmes identiques à celles d'Isaac dans la même direction que lui#{{Blank}}#{{LuckSmall}} Effet affecté par la statistique de chance"},
	...
	{"413", "Immaculée Conception", "Ramasser 15 cœurs invoque un familier angélique de manière permanente#Peut invoquer jusqu'à 5 familiers"},
	...
	{"417", "Succube", "Rebondit à travers la salle entourée d'une aura#↑ Dégâts {{ColorLime}}+50%{{ColorWhite}} tant qu'Isaac reste dans l'aura#{{Blank}}#{{DamageSmall}} {{ColorLime}}1.3x{{ColorWhite}} les dégâts d'Isaac par seconde aux ennemis dans l'aura"},
	...
	{"423", "Cercle de Protection", "Entoure Isaac d'un halo de lumière#Le halo inflige des dégâts de contact et peut renvoyer les projectiles ennemis"},
	{"424", "Sac en Papier", "Les ressources ont 10% de chances d'être converties en sachet {{GrabBag}}"},
	{"425", "Veilleuse", "Éclaire dans la direction des mouvements d'Isaac#Ralentit les ennemis pris dans le rayon de lumière"},
	{"426", "Admiratrice Obsessionnelle", "Imite les mouvements d'Isaac avec 3 secondes de délai#{{Blank}}#{{DamageSmall}} 30 par seconde au contact"},
	{"427", "Bloc de TNT", "Place un tonneau de TNT pouvant être déplacé#Utiliser l'objet une seconde fois fait exploser le tonneau à distance"},
	...
	{"430", "Papa Mouche", "Imite les mouvements d'Isaac avec 3 secondes de délai#Tire des larmes sur les ennemis à proximité#{{Blank}}#{{DamageSmall}} Identiques à ceux d'Isaac"},
	...
	{"435", "P'tit Loki", "Tire dans 4 directions à la fois#{{Blank}}#{{DamageSmall}} 3.5 par larme"},
	{"436", "Tasse de Lait", "Subir un dégât donne {{ColorLime}}débit +2{{ColorWhite}} pour la durée d'une salle"},
	{"437", "D7", "Fait réapparaître tous les ennemis de la salle et ferme les portes#Éliminer les ennemis fera apparaître la récompense de la salle à nouveau"},
	{"438", "Tétine", "{{SoulHeart}} +1 cœur d'âme#↑ Débit {{ColorLime}}+0.7#↑ Taille diminuée"},
	...
	{"443", "Pomme !", "↑ Débit {{ColorLime}}+0.4#7% de chances de tirer une lame de rasoir#Les lames infligent {{ColorLime}}dégâts x4#{{Blank}}#{{LuckSmall}} Effet affecté par la statistique de chance#{{Blank}} {{ColorSilver}}(100% à 14 Chance)"},
	...
	{"447", "Haricot Péteux", "Tirer pendant 7.5 secondes crée un nuage brun qui inflige des dégâts de contact aux ennemis"},
	...
	{"450", "Œil d'Avarice", "Toutes les 20 larmes, Isaac tire une larme en forme de pièce qui transforme les ennemis en statues d'or#Tuer un ennemi doré fait appraître 1-4 pièces#Tirer une larme en forme de pièce retire 1 pièce à Isaac"},
	...
	{"453", "Fracture Ouverte", "↑ Portée +1.5#Remplace les larmes d'Isaac par des os#Les os se brisent en 1-3 morceaux au contact d'un objet, d'un ennemi ou d'un mur"},
	...
	{"459", "Sinusite", "20% de chances de tirer une crotte de nez#Les crottes de nez se collent aux ennemis et infligent les dégâts d'Isaac une fois par seconde#Les crottes de nez se décollent si l'ennemi meurt, s'enterre, saute hors de l'écran ou au bout de 60 secondes"},
	...
	{"461", "Parasitoïde", "15% de chances de tirer un cocon#Toucher un ennemi avec un cocon invoque 1-2 mouches ou araignées bleues et répand une flaque ralentissante#{{Blank}}#{{LuckSmall}} Effet affecté par la statistique de chance#{{Blank}} {{ColorSilver}}(50% à 20 Chance)"},
	...
	{"467", "Doigt Accusateur", "Inflige des dégâts aux ennemis qu'il pointe#Peut éteindre les feux et détruire les cacas##{{Blank}}#{{DamageSmall}} 10% des dégâts d'Isaac 10x par seconde"},
	{"468", "Ombre", "Suit les mouvements d'Isaac avec un délai d'une seconde#Après avoir infligé 600 dégâts, il est absorbé par Isaac et lui permet d'infliger des dégâts de contact#{{Blank}}#{{DamageSmall}} 30 par seconde au contact"},
	{"469", "Dépression", "Suit Isaac et répand une traînée d'eau derrière lui#Les ennemis qui entrent en contact avec le nuage ont une chance de se faire frapper par un rayon de lumière#{{Blank}}#{{DamageSmall}} 6 par seconde pour la traînée d'eau"},
	{"470", "P'tit Murmure", "Rebondit contre les murs de la salle#S'immobilise quand Isaac tire#{{Blank}}#{{DamageSmall}} 30 par seconde au contact"},
	{"471", "P'tit Monstro", "Charge et crache une gerbe de larmes similaire à celles de {{ColorCyan}}Monstro#{{Blank}}#{{DamageSmall}} 3.5 par larme"},
	{"472", "Bébé Roi", "Tirer immobilise tous les familiers#Arrêter de tirer téléporte les familiers à Isaac"},
	{"473", "Gros Dodu", "Se déplace lentement dans la direction des tirs d'Isaac#Bloque les projectiles ennemis#{{Blank}}#{{DamageSmall}} 40.5 par seconde au contact"},
	...
	{"476", "D1", "Duplique une des ressources présentes dans la salle"},
	...
	{"480", "Composte", "Convertit toutes les ressources présentes dans la salle en mouches ou araîgnées bleues#Double les mouches et araignées bleues déjà présentes"},
	{"481", "Pioche Pirate", "↑ Augmente une stat aléatoire#↓ Diminue une stat aléatoire#Donne un effet de larmes aléatoire pour la durée d'une salle#Déforme visuellement les éléments de la salle"},
	{"482", "Télécommande", "Transforme Isaac en un autre personnage aléatoire#Retire de l'inventaire du personnage le dernier objet obtenu"},
	{"483", "Mama Méga", "{{Warning}} USAGE UNIQUE {{Warning}}#{{Blank}} Provoque une onde de choc qui ravage toutes les salles inexplorées de l'étage d'une énorme explosion#{{Blank}}#Si Isaac possède une bombe dorée, utiliser Mama Méga la consomme et permet à l'objet d'être utilisé une seconde fois"},
	{"484", "Attends, Quoi ?", "Isaac pète, repousse les ennemis et provoque une vague de rochers"},
	{"485", "Pièce Tordue", "{{ColorLime}}50%{{ColorWhite}} de chances de dupliquer les objets, ressources et coffres de la salle#{{Blank}}#{{ColorError}}50%{{ColorWhite}} de chances de faire disparaître les objets, ressources et coffres de la salle et de faire apparaître une pièce"},
	{"486", "Lame Émoussée", "Inflige un dégât factice à Isaac qui ne retire pas de points de vie#Déclenche les effets qui s'activent en subissant des dégâts"},
	...
	{"488", "Métronome", "Active l'effet d'un objet activable ou passif aléatoire pour la durée d'une salle"},
	...
	{"495", "Piment Fantôme", "Chance de tirer une flamme qu inflige des dégâts de contact et bloque les projectiles ennemis#La flamme disparait après avoir bloqué 5 projectiles ou infligé des dégâts 5 fois"},
	{"496", "Euthanasie", "3.33% de chances de tirer une seringue#Les seringues tuent instantanément les ennemis#{{Blank}}#{{LuckSmall}} Effet affecté par la statistique de chance#{{Blank}} {{ColorSilver}}(25% à 15 Chance)"},
	...
	{"500", "Sac de Sacs", "Génère un sachet {{GrabBag}} toutes les 5-6 salles"},
	...
	{"502", "Grosse Pustule", "Isaac tire parfois une pustule en plus de ses larmes#Les pustules infligent le double de dégâts et répandent une flaque ralentissante#Subir un dégât tire une pustule"},
	{"503", "P'tite Corne", "5% de chances de tirer une larme transperçante qui tue instantanément les ennemis qu'elle touche#{{Blank}}#{{LuckSmall}} Effet affecté par la statistique de chance"},
	{"504", "Bout de Crotte", "Invoque une mouche qui tire automatiquement sur les ennemis à proximité"},
	{"505", "Poké Go", "20% de chances d'invoquer un monstre allié au début de chaque salle"},
	{"506", "Traîtrise", "Toucher un ennmi dans le dos avec une larme inflige le double de dégâts et le fait saigner#Le saignement retire 10% des PV totaux de l'ennemi toutes les 5 secondes"},
	{"507", "Paille Aiguisée", "Inflige les dégâts d'isaac à tous les ennemis de la salle#Retire 10% des PV totaux de tous les ennemis de la salle#Infliger des dégâts avec cet objet a 15% de chance de générer des demi-cœurs"},
	{"508", "Rasoir de Maman", "Orbite autour d'Isaac#Fait saigner les ennemis qui entrent en contact avec lui#Le saignement retire 10% des PV totaux de l'ennemi toutes les 5 secondes#{{Blank}}#{{DamageSmall}} 2x les dégâts d'Isaac par seconde au contact"},
	{"509", "Nœnœil", "Orbite autour d'Isaac#Tire une larme toutes les 2 secondes#{{Blank}}#{{DamageSmall}} 30 par seconde au contact"},
	{"510", "Délire", "Invoque un boss allié pour la durée d'une salle"},
	{"511", "Mouche Enragée", "Orbite un ennemi#Attaque parfois l'ennemi qu'elle orbite#{{Blank}}#{{DamageSmall}} 30 par seconde au contact"},
	{"512", "Trou Noir", "Permet à Isaac de lancer un trou noir#Le trou noir attire les ennemis et projectiles#Le trou noir inflige des dégâts de contact et détruit les rochers à proximité"},
	{"513", "Bozo", "↑ Dégâts {{ColorLime}}+0.1#{{SoulHeart}} +1 cœur d'âme#Envoûte ou terrifie parfois un ennemi#Subir un dégât peut faire apparaître un caca arc-en-ciel"},
	{"514", "Routeur Cassé", "Paralyse parfois les ennemis et projectiles#25% de chances de dupliquer une récompense de salle#{{Blank}}#{{LuckSmall}} Effet affecté par la statistique de chance"},
	...
	{"518", "Pote en Boîte", "Invoque un familier aléatoire#L'apparence du familier et l'effet de ses larmes changent à chaque étage#{{Blank}}#{{DamageSmall}} 2-6 par larme"},
	...
	{"521", "Coupon", "Rend gratuit un objet payant présent dans la salle#Fonctionne pour les coûts en pièces et en PV#Garantit un objet en solde au Shop {{Shop}} tant qu'Isaac porte l'objet"},
	{"522", "Télékinésie", "Entoure Isaac d'une aura qui ralentit puis immobilise les projectiles ennemis#Après 3 secondes, les projectiles immobilisés sont renvoyés"},
	{"523", "Carton de Déménagement", "Utiliser l'objet absorbe toutes les ressources, babioles et objets de la salle#Utiliser l'objet à nouveau pose les objets absorbés sur le sol#Permet de déplacer des ressources et objets d'une pièce à l'autre"},
	{"524", "Technologie Zéro", "Connecte les larmes entre elles par un arc électrique"},
	{"525", "Lèpre", "Subir un dégât invoque une boule de chair qui bloque les projectiles ennemis#Limité à 3 boules à la fois#Les boules de chair peuvent être détruites si elles subissent trop de dégâts"},
	...
	{"527", "Boîte à Larbin", "Utiliser l'objet affiche un curseur déplaçable#{{Blank}} Après quelques secondes, invoque un familier qui va, selon le curseur :#Ouvrir une serrure#Attraper et rapporter un objet ou une ressource#Voler un objet payant#Pourchasser un ennemi#Appuyer sur un bouton#Exploser et détruire une machine, un mendiant ou un obstacle"},
	{"528", "Prisme Angélique", "Les larmes d'Isaac ou de ses familiers qui traversent le prisme sont quadruplées"},
	...
	{"536", "Autel Sacrificiel", "{{Warning}} USAGE UNIQUE#Sacrifie jusqu'à 2 familiers parmi ceux d'Isaac#Chaque familier sacrifié fait apparaître un objet diabolique"},
	{"537", "P'tit Spewer", "Crache une flaque de liquide#Avaler une pilule change la couleur et l'effet des flaques du familier#Fait apparaître une pilule#{{Blank}}#{{DamageSmall}} 0-47 par seconde selon la couleur de la flaque"},
	...
	{"539", "Œuf Mystère", "Subir un dégât invoque un monstre envoûté#Plus Isaac termine de salles sans prendre de dégâts, plus le monstre invoqué est puissant"},
	...
	{"542", "Côte Cassée", "Orbite autour d'Isaac#Dévie les projectiles"},
	{"543", "Terre sacrée", "Subit des dégâts fait apparaître un caca sacré entouré d'une aura#{{Blank}}#{{Blank}} Quand Isaac se tient à l'intérieur de l'aura :#↑ Débit augmenté#Chance de nullifier un dégât subi"},
	{"544", "Côte Pointue", "Pointe dans la direction des tirs d'Isaac#{{Blank}}#{{DamageSmall}} 6x les dégâts d'Isaac au contact"},
	{"545", "Livre des Morts", "Invoque une entité squelettique pour chaque ennemi tué dans la salle"},
	...
	{"548", "Mandibule", "Part dans la direction des tirs d'Isaac puis revient#Peut attraper et ramener des ressources#{{Blank}}#{{DamageSmall}} 2x les dégâts d'Isaac au contact"},
	...
	{"550", "Pelle Brisée", "Le pied de {{ColorCyan}}Mom{{ColorWhite}} tente en permanence d'écraser Isaac#Utiliser cet objet cesse les attaques pour la durée d'une salle ou d'une vague#{{Warning}} Poser cet objet sur un piédestal puis quitter la salle le fait disparaître#{{Blank}}#{{Warning}} Emporte la pelle avec toi le plus loin possible"},
	{"551", "Pelle Brisée", "Le deuxième morceau d'une pelle maudite#{{Blank}}#{{UltraSecretRoom}} Permet de déterrer quelque chose d'enfoui dans la {{ColorTransform}}Dark Room"},
	{"552", "Pelle de Maman", "Ouvre une trappe vers l'étage suivant#{{Blank}}#{{UltraSecretRoom}} Permet de déterrer quelque chose d'enfoui dans la {{ColorTransform}}Dark Room"},
...
EID.descriptions["fr"].trinkets={
	...
	{"2", "Caca Pétrifié", "Augmente les chances de trouver des récompenses en détruisant des cacas"},
	{"3", "Pile AAA", "Charge automatiquement la dernière barre des objets activables"},
	{"4", "Télécommande Cassée", "Utiliser un objet activable téléporte Isaac dans une salle aléatoire"},
	{"5", "Cœur Violet", "Augmente les chances de rencontrer des ennemis et boss d'élite"},
	{"6", "Aimant Démagnétisé", "Attire les pièces à Isaac"},
	...
	{"8", "Cartouche", "Subir un dégât a 5% de chances d'activer l'effet de {{ColorYellow}}The Gamekid{{Collectible93}}#{{Blank}}#{{LuckSmall}} Effet affecté par la statistique de chance#{{Blank}} {{ColorSilver}}(100% à 38 Chance)"},
	...
	{"12", "Ver Plat", "Les larmes d'Isaac sont élargies"},
	...
	{"22", "Queue de Diablotin", "Diminue la fréquence d'apparition des cœurs#Tous les cœurs deviennent des cœurs noirs"},
	{"23", "Avis de Recherche", "À sa mort, Isaac ressucite en {{ColorLightOrange}}The Lost#Mourir dans une Sacrifice Room {{SacrificeRoom}} en portant ce trinket débloque {{ColorLightOrange}}The Lost#Le trinket disparaît à la mort d'Isaac"},
	...
	{"28", "Ânkh Brisée", "À sa mort, Isaac a 22% de chance de ressuciter en {{ColorLightOrange}}???"},
	{"29", "Tête de Poisson", "Subir un dégât invoque une mouche bleue"},
	{"30", "Conjonctivite", "10% de chances de tirer une larme empoisonnée#{{Blank}}#{{LuckSmall}} Effet affecté par la statistique de chance#{{Blank}} {{ColorSilver}}(100% à 18 Chance)"},
	{"31", "Punaise", "10% de chances de tirer une larme spectrale transperçante#{{Blank}}#{{LuckSmall}} Effet affecté par la statistique de chance#{{Blank}} {{ColorSilver}}(100% à 18 Chance)"},
	...
	{"40", "Lambeau de Tissu", "Subir un dégât peut donner {{ColorLime}}dégâts +1.8{{ColorWhite}} pour la durée d'une salle#{{Blank}}#{{LuckSmall}} Effet affecté par la statistique de chance#{{Blank}} {{ColorSilver}}(100% à 8 Chance)"},
	...
	{"43", "Crâne Maudit", "Téléporte Isaac dans une salle aléatoire si sa vie totale descend à un demi-cœur"},
	...
	{"46", "Fourchette d'Isaac", "Terminer une salle peut soigner Isaac d'un demi-cœur rouge#{{Blank}}#{{LuckSmall}} Effet affecté par la statistique de chance#{{Blank}} {{ColorSilver}}(100% à 18 Chance)"},
	{"47", "", "<Inutilisé>"},
	{"48", "Page Déchirée", "Subir un dégât a 5% d'infliger 40 dégâts à tous les ennemis de la salle#{{Blank}}#{{LuckSmall}} Effet affecté par la statistique de chance#{{Blank}} {{ColorSilver}}(50% à ~55 Chance)"},
	...
	{"54", "Tête d'Isaac", "Fair apparaître un familier qui suit Isaac et tire des larmes transperçantes#{{Blank}}#{{DamageSmall}} 3.5 par larme"},
	{"55", "Foi de Magdalene", "{{EternalHeart}} +1 cœur éternel au début de chaque étage"},
	...
	{"57", "Âme de ???", "Fait apparaître un familier qui rebondit contre les murs et tire des larmes spectrales autoguidées#{{Blank}}#{{DamageSmall}} 3.5 par larme"},
	{"58", "Mèche de Samson", "Tuer un ennemi a 7% de chances de donner {{ColorLime}}dégâts +0.5{{ColorWhite}} pour la durée d'une salle#{{Blank}}#{{LuckSmall}} Effet affecté par la statistique de chance#{{Blank}} {{ColorSilver}}(100% à 10 Chance)"},
	{"59", "Œil de Caïn", "25% de chances de donner l'effet de {{ColorYellow}}The Compass{{ColorWhite}} {{Collectible21}} pour la durée d'un étage#{{Blank}}#{{LuckSmall}} Effet affecté par la statistique de chance#{{Blank}} {{ColorSilver}}(100% à 3 Chance)"},
	{"60", "Serre de l'Oiseau d'Ève", "Tuer un ennemi a 5% de chances d'invoquer un {{ColorYellow}}Dead Bird{{ColorWhite}} pour la durée d'une salle#{{Blank}}#{{LuckSmall}} Effet affecté par la statistique de chance#{{Blank}} {{ColorSilver}}(100% à 8 Chance)"},
	...
	{"68", "Aimant au Néodyme", "Attire les ressources et les ennemis vers Isaac"},
	{"69", "Positif Décoloré", "Camoufle parfois Isaac et étourdit les ennemis"},
	{"70", "Lente", "Invoque parfois une araignée bleue"},
	{"71", "Vessie de Bob", "Les bombes d'Isaac répandent une flaque corrosive sur le sol#Les flaques infligent des dégâts de contact aux ennemis"},
	...
	{"73", "Détonateur", "Les bombes peuvent faire apparaître une autre bombe ramassable en explosant"},
	...
	{"76", "Jeton de Poker", "50% de chances de doubler le contenu d'un coffre#50% de remplacer le contenu d'un coffre par une mouche"},
	{"77", "Cloque", "Augmente le recul infligé par les larmes d'Isaac"},
	{"78", "Grande Aiguille", "Augmente la durée des effets infligés aux ennemis"},
	{"79", "Histoire Sans Fin", "Utiliser une pilule, une carte ou une rune a 25% de chances de faire apparaître une copie de celle-ci"},
	...
	{"85", "Karma", "Faire des dons à une boîte à dons {{DonationMachine}} peut faire apparaître un mendiant {{Beggar}} ou soigner Isaac d'un cœur rouge#Augmente la probabilité que faire un don augmente la statistique de chance"},
	{"86", "Petite Larve", "Détruire un caca fait apparaître une mouche bleue"},
	...
	{"90", "Bouchon Brun", "Les cacas détruits explosent"},
	...
	{"95", "Dent Noircie", "Chance de tirer une dent morte#Les dents mortes infligent le double de dégâts et empoisonnent les ennemis#{{Blank}}#{{LuckSmall}} Effet affecté par la statistique de chance#{{Blank}} {{ColorSilver}}(100% à 32 Chance)"},
	{"96", "Ver d'Ouroboros", "↑ Portée {{ColorLime}}+4.0#La trajectoire des larmes forme une très grande spirale#Larmes spectrales#Chance de tirer une larme autoguidée#{{Blank}}#{{LuckSmall}} Effet affecté par la statistique de chance#{{Blank}} {{ColorSilver}}(100% à 5 Chance)"},
	...
	{"99", "Balle Rebondissante", "Chance de tirer une larme rebondissante"},
	{"100", "Ampoule Allumée", "{{Blank}} Porter un objet activable entièrement chargé donne :#↑ Vitesse {{ColorLime}}+0.25#↑ Portée {{ColorLime}}+0.75#↑ Débit {{ColorLime}}+0.2#↑ Vitesse des tirs {{ColorLime}}+0.10#↑ Dégâts {{ColorLime}}+0.5#↑ Chance {{ColorLime}}+1"},
	{"101", "Ampoule Éteinte", "{{Blank}} Porter un objet activable entièrement déchargé donne :#↑ Vitesse {{ColorLime}}+0.5#↑ Portée {{ColorLime}}+1.5#↑ Débit {{ColorLime}}+0.4#↑ Vitesse des tirs {{ColorLime}}+0.3#↑ Dégâts {{ColorLime}}+1.5#↑ Chance {{ColorLime}}+2"},
	{"102", "Carte Scindée", "Génère une Secret Room {{SecretRoom}} supplémentaire à chaque étage#Ne peut pas rajouter de Secret Room {{SecretRoom}} à un étage déjà généré"},
	{"103", "Égalité !", "Quand les compteurs de pièces, bombes et clés sont identiques, transforme les ressources en leur version doublée"},
	{"104", "Os de Poulet", "Subir un dégât a 2% de chance de détruire le trinket et de faire apparaître un objet provenant de la banque d'objets de la salle"},
	{"105", "Sac de Friandises", "Subir un dégât a 2% de chance de détruire le trinket et de faire apparaître {{ColorYellow}}Lunch{{ColorWhite}} {{Collectible22}}"},
	{"106", "Bouchon de Liège", "Aumgente la taille des flaques créées par Isaac"},
	...
	{"108", "Noix", "Subir 1-9 explosions détruit le trinket et fait apparaître une bombe, une pièce, une clé et un trinket"},
	{"109", "Ruban Adhésif", "Immobilise tous les familiers d'Isaac"},
	{"110", "Pièce d'Argent", "Des Shops {{Shop}} apparaîssent dans le {{ColorTransform}}Womb"},
	{"111", "Couronne Sanglante", "Des Treasure Rooms {{TreasureRoom}} apparaîssent dans le {{ColorTransform}}Womb"},
	{"112", "Microtransactions", "Des Restock Machines {{RestockMachine}} apparaîssent dans toutes les Treasure Rooms {{TreasureRoom}}"},
	...
	{"117", "Locuste de Conquête", "Entrer dans une salle hostile invoque 2-5 locustes"},
	{"118", "Aile de Chauve-Souris", "Tuer un ennemi a une chance de permettre à Isaac de voler pour la durée d'une salle"},
	{"119", "Cellule Souche", "Entrer dans un nouvel étage soigne Isaac d'un demi-cœur rouge"},
	{"120", "Épingle à Cheveux", "Entrer dans une salle de boss {{BossRoom}} recharge entièrement l'objet activable"},
	{"121", "Croix de Bois", "Entoure Isaac d'un bouclier sacré {{HolyMantleSmall}} qui nullifie le premier dégât subi dans l'étage#Le bouclier se régénère en entrant dans un nouvel étage"},
	{"122", "Plaquette de Beurre", "Utiliser un objet activable le retire de l'inventaire d'Isaac et le pose sur un piédestal"},
...
EID.descriptions["fr"].cards={
	...
	{"2", "I - Le Bateleur", "Larmes téléguidées#{{Blank}}#Persiste pour la durée d'une salle"},
	{"3", "II - La Papesse", "Le pied de {{ColorCyan}}Mom{{ColorWhite}} écrase l'ennemi de la salle avec le plus de PV#Dans une salle sans ennemis, le pied écrase Isaac"},
	{"4", "III - L'Impératrice", "↑ Dégâts {{ColorLime}}+2.35#↑ Vitesse {{ColorLime}}+0.3#{{Blank}}#Persiste pour la durée d'une salle"},
	...
	{"8", "VII - Le Chariot", "{{Blank}} Pendant 6 secondes :#↑ Vitesse {{ColorLime}}+0.28#Isaac devient invulnérable#Isaac inflige 40 dégâts de contact par seconde"},
	...
	{"12", "XI - La Force", "{{Heart}} +1 Réceptacle de cœur#↑ Dégâts {{ColorLime}}+0.3 x1.5#↑ Vitesse {{ColorLime}}+0.3#↑ Portée {{ColorLime}}+5.25#{{Blank}}#{{Timer}} Persiste pour la durée d'une salle"},
	{"13", "XII - Le Pendu", "Permet à Isaac de voler#{{Blank}}#Persiste pour la durée d'une salle"},
	{"14", "XIII - La Mort", "Inflige 40 dégâts à tous les ennemis de la salle"},
	{"15", "XIV - Tempérance", "Fait apparaître une machine de don du sang {{BloodDonationMachine}}"},
	{"16", "XV - Le Diable", "↑ Dégâts {{ColorLime}}+2#{{Blank}}#Persiste pour la durée d'une salle"},
	...
	{"21", "XX - Le Jugement", "Invoque un mendiant {{Beggar}}"},
	...
	{"26", "2 de Cœur", "Double le nombre de cœurs rouges d'Isaac#Soigne 1 cœur rouge si tous les réceptacles de cœur d'Isaac sont vides"},
	...
	{"40", "Rune Vierge", "Active l'effet d'une rune au hasard"},
	...
	{"47", "Carte Chance", "Ouvre toutes les portes de la salle#Peut également ouvrir la majorité des portes spéciales"},
	...
	{"50", "Appel d'Urgence", "2 mains de {{ColorCyan}}Mom{{ColorWhite}} attrappent un ennemi chacune, leur infligent 40 dégâts et les paralysent"},
	{"51", "Carte Sacrée", "Entoure Isaac d'un bouclier sacré {{HolyMantleSmall}} qui nullifie le prochain dégât subi dans la salle"},
	{"52", "Croissance Colossale", "↑ Dégâts {{ColorLime}}+7#↑ Portée {{ColorLime}}+30#↑ Taille augmentée#Permet à Isaac de détruire les rochers en marchant dessus#{{Blank}}#Persiste pour la durée d'une salle"},
	{"53", "Rappel Ancestral", "Fait apparaître 3 cartes"},
	{"54", "Marche Temporelle", "↑ Vitesse {{ColorLime}}+0.5#↓ Vitesse des tirs {{ColorError}}-1#Ralentit les ennemis#{{Blank}}#Persiste pour la durée d'une salle"},
}
...
EID.descriptions["fr"].pills={
	...
	{"20", "Survolté !", "Recharge l'objet activable d'Isaac#Fait apparaître 1-2 piles"},
	{"21", "Hématémèse", "Vide tous les réceptacles de cœur d'Isaac sauf 1#Fait apparaître 1-4 cœurs rouges"},
	...
	{"35", "Infesté ?", "Invoque une araignée bleue pour chaque ennemi dans la salle#Utilisée dans une salle vide, invoque 1-3 araignées"},
	{"36", "Vitamines !", "{{Blank}} Pour quelques secondes :#Rend Isaac invulnérable#Terrifie tous les ennemis de la salle#Soigne Isaac d'un demi-cœur tous les deux ennemis tués"},
...
EID.descriptions["fr"].sacrifice={
	{"1", "", "1 pièce {{ColorSilver}}(50%)#Rien {{ColorSilver}}(50%)#{{Blank}}#1 bombe {{ColorSilver}}(100% au premier étage si le boss a été battu en moins d'une minute)"},
	{"2", "", "1 pièce {{ColorSilver}}(50%)#Rien {{ColorSilver}}(50%)#{{Blank}}#1 bombe {{ColorSilver}}(100% au premier étage si le boss a été battu en moins d'une minute)"},
