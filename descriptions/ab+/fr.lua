...
EID.descriptions["fr"].collectibles={
	...
	{"450", "Œil d'Avarice", "Toutes les 20 larmes, Isaac tire une larme en forme de pièce qui transforme les ennemis en statues d'or#Tuer un ennemi doré fait apparaître 1-4 pièces#Tirer une larme en forme de pièce retire 1 pièce à Isaac"},
	...
	{"495", "Piment Fantôme", "Chance de tirer une flamme qui inflige des dégâts de contact et bloque les projectiles ennemis#La flamme disparait après avoir bloqué 5 projectiles ou infligé des dégâts 5 fois"},
...
EID.descriptions["fr"].trinkets={
	...
	{"28", "Ânkh Brisée", "À sa mort, Isaac a 22% de chance de ressusciter en {{ColorLightOrange}}???"},
