...
EID.descriptions["fr"].collectibles={
	...
	{"298", "Corne Brisée", "{{Blank}} Pendant 6 secondes :#↑ Vitesse {{ColorLime}}+0.28#Rend Isaac invulnérable"},
	...
	{"443", "Pomme !", "↑ Débit {{ColorLime}}+0.4#7% de chances de tirer une lame de rasoir qui inflige {{ColorLime}}dégâts x4#{{Blank}}#{{LuckSmall}} Effet affecté par la statistique de chance#{{Blank}} {{ColorSilver}}(100% à 14 Chance)"},
	...
	{"469", "Dépression", "Suit Isaac et répand une traînée d'eau derrière lui#L'eau inflige des dégâts de contact#Les ennemis qui entrent en contact avec le nuage peuvent se faire frapper par un rayon de lumière"},
	...
	{"481", "Pioche Pirate", "↑ Augmente une stat#↓ Diminue une stat#Donne un effet de larmes aléatoire pour la durée d'une salle#Déforme visuellement les éléments de la salle"},
	...
	{"485", "Pièce Tordue", "{{ColorLime}}50%{{ColorWhite}} de chances de dupliquer les objets, ressources et coffres de la salle#{{ColorError}}50%{{ColorWhite}} de chances de faire disparaître les objets, ressources et coffres de la salle et de faire apparaître une pièce"},
	...
	{"512", "Trou Noir", "Permet à Isaac de lancer un trou noir#Le trou noir attire les ennemis et projectiles, inflige des dégâts de contact et détruit les rochers à proximité"},
	...
	{"529", "Pop !", "Les larmes d'Isaac sont remplacées par des globes oculaires qui rebondissent entre eux et contre les murs et les obstacles"},
