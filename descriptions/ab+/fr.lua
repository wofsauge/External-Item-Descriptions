...
EID.descriptions["fr"].collectibles={
	...
	{"67", "Sœurette Maggy", "Suit Isaac et tire en même temps que lui"},
	...
	{"117", "Oiseau Mort", "Subir un dégât réveille l'oiseau#L'oiseau éveillé pourchasse et inflige des dégâts aux ennemis"},
	...
	{"272", "BGM", "Rebondit contre les murs de la salle#Explose au contact d'un ennemi#{{Warning}} L'explosion peut infliger des dégâts à Isaac"},
	{"273", "Cerveau de Bob", "Peut être projeté en ligne droite avec les boutons de tir#Explose au contact d'un ennemi#{{Warning}} L'explosion peut infliger des dégâts à Isaac"},
	{"274", "Meilleure Pote", "Subir un dégat fait apparaître une mouche qui orbite autour d'Isaac et inflige des dégâts de contact pour la durée d'une salle"},
	...
	{"318", "Gémeaux", "S'attache à Isaac et pourchasse les ennemis à proximité"},
	...
	{"322", "Bébé Moqueur", "Imite les tirs d'un des familiers d'Isaac"},
	...
	{"363", "Protecteur Dévoué", "Orbite autour d'Isaac#Inflige des dégâts de contact#Attire et bloque les projectiles ennemis#Peut faire apparaître un cœur éternel s'il bloque 10 projectiles dans une même salle"},
	...
	{"468", "Ombre", "Suit les mouvements d'Isaac avec un délai d'une seconde#Après avoir infligé 600 dégâts, il est absorbé par Isaac et lui permet d'infliger des dégâts de contact"},
	{"469", "Dépression", "Suit Isaac et répand une traînée d'eau derrière lui#L'eau inflige des dégâts de contact#Les ennemis qui entrent en contact avec le nuage ont une chance de se faire frapper par un rayon de lumière"},
	{"470", "P'tit Murmure", "Rebondit contre les murs de la salle#S'immobilise quand Isaac tire"},
	...
	{"473", "Gros Dodu", "Se déplace lentement dans la direction des tirs d'Isaac#Bloque les projectiles ennemis#Inflige des dégâts de contact"},
	...
	{"518", "Pote en Boîte", "Invoque un familier aléatoire#L'apparence du familier et les effets de ses larmes changent à chaque étage"},
	...
	{"537", "P'tit Spewer", "Crache des flaques de liquide#Avaler une pilule change la couleur et l'effet des flaques du familier#Fait apparaître une pilule"},
	...
	{"544", "Côte Pointue", "Pointe dans la direction des tirs d'Isaac et inflige des dégâts de contact"},
	...
	{"548", "Mandibule", "Part dans la direction des tirs d'Isaac puis revient#Peut attraper et ramener des ressources#Inflige des dégâts de contact"},
...
EID.descriptions["fr"].trinkets={
	...
	{"57", "Âme de ???", "Fait apparaître un familier qui rebondit contre les murs et tire des larmes spectrales autoguidées"},
