...
EID.descriptions["ru"].collectibles={
    ...
    {"12","Волшебный Гриб","↑ +1 к здоровью#↑ 0.3 к урону#↑ +50% множитель урона#↑ +5.25 дальность стрельбы#↑ +0.3 к скорости#↑ +0.5 высота слезы#Восстанавливает здоровье!"},
    ...
    {"75","Лицензия Доктора","Все пилюли имеют либо положительный, либо нейтральный эффекты# +1 пилюля#Лечит 2 сердца#Больше монет из автомата для сдачи крови"},
    {"76","Рентген-Зрение","Открывает секретные комнаты"},
    {"77","Мой Маленький Единорог","Неуязвимость#Возможность нанести 40 контактного урона"},
    ...
    {"83","Гвоздь","При использовании:#+1 Сердце Души#↑ +0.7 к урону#↓ -0.18 скорость#Возможность наносить контактный урон#Разрушение камней"},
    ...
    {"88","Малютка Чабби","Спутник, летит в направлении стрельбы#Наносит 52.5 урона в секунду"},
    ...
    {"99","Малютка Гиш","Спутник с замедляющими слезами#Наносит 3.5 урона"},
    {"100","Стивен Младший","Спутник с самонаводящимися слезами#Наносит 3.5 урона"},
    ...
    {"109","Деньги = Сила","↑ +0.04 к урону за каждую монетку#Чем больше монеток поднимает персонаж, тем меньше урона они дают#На бонус действуют множители персонажей"}, --оставить другую часть описания на детальный раздел русского описания?
    ...
    {"117","Мертвая Птица","Атакует врагов после того, как вы получите урон#Наносит 4 контактного урона в секунду"},
    ...
    {"127","Забудь Меня","{{Warning}} ОДНОРАЗОВЫЙ ПРЕДМЕТ {{Warning}}#Текущий уровень перезапускается и генерируется заново"},
    ...
    {"130","Пони","Полет, если вы держите этот предмет#Если стандартная скорость персонажа менее чем 1.5, то при подборе артефакта она будет увеличена до 1.5#Атака рывком в выбранном направлении"}, --потом добавить про скорость
    ...
    {"157","Жажда Крови","↑ к урону, если вас ранят#Эффект сохраняется до конца этажа"}, --потом дополнить
    ...
    {"190","Пиро","+99 Бомб"},
    {"191","Трехдолларовая Банкнота","Дает слезам случайные эффекты каждые 2-3 секунды"},
    ...
    {"238","Первая Часть Ключа","!!! Часть ключа от двери к Мега-Сатане!#Выше вероятность появления комнаты Ангела{{AngelRoom}}"},
    {"239","Вторая Часть Ключа","!!! Часть ключа от двери к Мега-Сатане!#Выше вероятность появления комнаты Ангела{{AngelRoom}}"},
    {"240","Экспериментальное Лечение","↑/↓ Ваши параметры меняются случайным образом"},
    {"241","Договор с Преисподней","Все предметы, падающие после зачистки комнаты, дублируются#Не влияет в Режиме Жадности "},
    ...
    {"260","Черная Свеча","Иммунитет к Проклятиям#+1 Черное Сердце#Высокий шанс на появление комнаты Дьявола{{DevilRoom}}/Ангела{{AngelRoom}}"},
    ...
    {"265","Высушенный Малыш","Спутник, блокирует снаряды#После блокирования с шансом 10% может нанести урон всем врагам в комнате"},
    ...
    {"275","Малютка Сера","Стреляет заряжающимся кровавым лазером#Наносит 31.5 урона в секунду"},
    {"276","Сердце Исаака","Ваш персонаж неуязвим#!!! Вы теряете здоровье, когда ваш спутник-сердце получает урон"},
    {"277","Малютка Призрак","Спутник, атакующий врагов и пугающий их#Наносит 4 урона в секунду"},
    {"278","Темный Бездельник","Спутник, собирающий красные сердца и дающий Сердца Души или пауков взамен"},
    ...
    {"310","Тушь Евы","Урон x2#↓ скорострельность#↓ -0.5 скорость слезы"},
    ...
    {"324","Неопределенный","Телепортирует в:#{{SecretRoom}}{{SuperSecretRoom}}Секретную комнату-, Комнату Я - ОШИБКА- или {{TreasureRoom}}Комнату с артефактом"},
    ...
    {"359","8-Дюймовые Гвозди","↑ +1.5 к урону#Увеличивает отдачу"},
    ...
    {"384","Малютка Герди","Заряжается и атакует врагов с разгона#Наносит 90 контактного урона в секунду"},
    ...
    {"415","Корона Света","+2 Сердца Души#↑ Урон x2, если нет неполных красных сердец#При получении урона бонус сбрасывается и обновляется при переходе в другую комнату"},
    ...
    {"420","Черный Порошок","Вы оставляете за собой на полу черный след#Образовавшийся из него круг создаст пентаграмму, которая наносит врагам 10 урона за тик"},
    ...
    {"435","Малютка Локи","Спутник, стреляет в 4 стороны#Наносит 3.5 урона за выстрел"},
    ...
    {"445","Собачий Зуб","↑ +0.3 к урону#↑ +0.1 к скорости#Вы услышите собачий вой, если рядом будет секретная комната#Вы услышите собачий лай, если в комнате спрятан люк в ретро-сокровищницу"},
    ...
    {"450","Глаз Жадности","Слезы могут превратить врага в золото"},
    ...
    {"457","Коническая Голова","+1 Сердце Души#20% шанс блокировать урон от снаряда"},
    ...
    {"471","Малютка Монстро","Заряжает свою атаку#Атакует так же, как и босс Монстро#Каждая слеза наносит по 3.5 урона"},
    ...
    {"484","Стоп, Что?","При использовании отталкивает врагов и создает взрывную волну#Может открывать двери и разрушать камни"},
    ...
    {"500","Мешочек с Мешочками","Со случайным шансом дает мешочки с предметами"}, --update later
    {"501","Пищевод Жадности","За каждые 25 монет дает ↑ +1 к здоровью#Позволяет Хранителю иметь больше здоровья"},
    ...
    {"512","Черная Дыра","Кидает на землю черную дыру, засасывающую в себя все, в т.ч. врагов#Наносит 0.4 урона за тик#Разрушает близлежащие камни#Длится 6 секунд"},
    ...
    {"514","Сломанный Модем","Вызывает 'лаги' у врагов и их снарядов случайным образом"}, --update later
    ...
    {"522","Телекинез","Замораживает ближайшие вражеские снаряды на 3 секунды#Затем они улетают обратно#Перезаряжается за 3 секунды"},
    ...
    {"534","Рюкзак","Позволяет носить 2 активных предмета#Переключение на CTRL (держите CTRL играя за \"Забытого\")"},
...
{"7", "Бусинка от Четок", "Повышает шанс появления комнаты Ангела{{AngelRoom}}"},
...
{"21", "Загадочная Бумажка", "Имитирует \"Полароид\", \"Негатив\", \"Потерянная страница\" и \"Плакат о пропавшем без вести\""},
{"22", "Хвост Демона", "!!! Меняет сердца в комнатах на черные, или на другие предметы#Уменьшает выпадение сердец"},
{"23", "Плакат о Пропавшем Без Вести", "После смерти в Комнате Жертвоприношений{{SacrificeRoom}} вы появитесь в виде \"Потерянного\"#Если он уже открыт, то персонаж может возродиться за него за пределами Комнаты Жертвоприношений"},
...
{"26", "Крюкообразный Червь", "Слезы летят по Г-образной траектории#↑ +10 дальность стрельбы"},
...
{"53", "Клещ", "- 15% здоровье Босса#Лечит на 1 сердце, когда вы заходите в комнату с Боссом ({{BossRoom}})#Вы не сможете снять его после взятия (только брелоком 'Спичка')"},
...
{"58", "Локон Самсона", "↑ 1/15 Шанс получить +0.5 к урону за убийство##Эффект остается в пределах коматы"},
...
{"83", "Ключ от Магазина", "Открывает все магазины {{Shop}}"},
...
{"110", "Серебряный Доллар", "В Утробе будут появляться Магазины {{Shop}}"},
{"111", "Кровавая Корона", "В Утробе будут появляться Золотые Комнаты {{TreasureRoom}}"},
{"112", "Плати и Выигрывай", "Автомат Обновления всегда будет в комнате с предметами ({{TreasureRoom}})"},
...
{"5", "Император", "Телепортирует в комнату с Боссом ({{BossRoom}})"},
...
{"10", "Отшельник", "Телепортирует в магазин {{Shop}}, если он есть на уровне"},
{"11", "Колесо Фортуны", "Создает игровой автомат"},
{"12", "Сила", "↑ +1 к здоровью#↑ +0.3 к урону#↑ +50% множитель урона#↑ +5.25 дальность стрельбы↑ +0.3 к скорости#В пределах комнаты"},
...
{"18", "Звезды", "Телепортирует в золотую комнату ({{TreasureRoom}}), если она есть на уровне"},
{"19", "Луна", "Телепортирует в секретную комнату ({{SecretRoom}})"},
...
{"3", "", "67% вероятность повысить шанс появления Комнаты Ангела{{AngelRoom}}."},
{"4", "", "50% шанс на 1 случайный Сундук"},
{"5", "", "33% шанс на 3 Монеты#67% вероятность повысить шанс появления Комнаты Ангела{{AngelRoom}}."},
{"6", "", "33% шанс телепортироваться в комнату Ангела{{AngelRoom}}/Дьявола{{DevilRoom}}#67% шанс на случайный сундук"},
{"7", "", "33% шанс на 1 случайный предмет из Комнаты Ангела{{AngelRoom}}#67% шанс на 1 Сердце Души"},
...
{"1", "", "Меняет все артефакты персонажа на случайные"},
{"2", "", "Меняет все подбираемые предметы, находящиеся в комнате"},
{"3", "", "Меняет все подбираемые предметы, находящиеся на данном этаже"},
{"4", "", "Меняет все артефакты, находящиеся на данном этаже#Не влияет на комнаты Дьявола{{DevilRoom}}/Ангела{{AngelRoom}}, ретро-сокровищницу, чёрный рынок"},
{"5", "", "Меняет и перезагружает весь этаж"},
