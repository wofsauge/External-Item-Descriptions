...
EID.descriptions[languageCode].collectibles={
	...
	{"114", "Мамин нож", "Мамин нож", "Заменяет слёзы на управляемый нож, который пронзает врагов#Наносит 2x урона персонажа пока находится в руках#Урон при броске достигает 6x при заряде на 1/3; дальнейший заряд увеличивает только дальность#Когда нож летит назад наносит фиксированный 2x урон" },
