...
EID.descriptions["ru"].trinkets={
	...
	{"40", "Красная заплатка", "20% шанс получить +1.8 к урону, если вы получили урон#100% шанс при удаче 8"},
	...
	{"42", "Счастливый палец", "↑ +1 к удаче#+8% к шансу получить награду при зачистке комнаты#Дополнительные предметы из сундуков"},
	...
	{"60", "Лапка птички Евы", "Шанс появления {{Collectible117}}Мертвой Птицы при убийстве врага"},
