...
EID.descriptions["ru"].collectibles={
    ...
    {"2","Внутренний Глаз","Тройной выстрел#↓ к скорострельности"},
    {"3","Сгибатель Ложек","Самонаводящиеся слезы"},
    {"4","Голова Крикета","↑ 0.5 к урону#↑ 50% множитель урона #+ к отдаче"},
    {"5","Мое Отражение","Дает слезам эффект бумеранга#↑ 1.5 дальность стрельбы#↑ 0.6 скорость слезы#↑ 1 высота слезы"},
    {"6","Номер Один","↑ 1.5 скорострельность#↓ 15.78 дальность стрельбы#↑ 0.45 высота слезы"},
    {"7","Кровь Мученика","↑ 1.0 к урону#+50% урона, если есть Книга Белиала"},
    {"8","Братик Бобби","Атакующий спутник"},
    {"9","Скатол","Все вражеские мужи становятся нейтральными"},
    {"10","Нимб из Мух","↑ 2 орбитальные мухи"},
    {"11","1UP!","↑ 1 дополнительная жизнь#Возрождение с полным здоровьем"},
    {"12","Волшебный Гриб","↑ 1 к здоровью#↑ 0.3 к урону#↑ 50% множитель урона#↑ 5.25 дальность стрельбы#↑ 0.3 к скорости#↑ 0.5 высота слезы#Восстанавливает здоровье!#Этот предмет необходим для трансформации 'Топтун'"},
    ...
    {"29","Мамино Нижнее Белье","↑ 5.25 дальность стрельбы#↑ 0.5 высота слезы"},
    {"30","Мамины Туфли","↑ 5.25 дальность стрельбы#↑ 0.5 высота слезы"},
    {"31","Мамина Помада","↑ 5.25 дальность стрельбы#↑ 0.5 высота слезы"},
    {"32","Вешалка Из Проволоки","↑ 0.7 к скорострельности"},
    {"33","Библия","Полет в пределах комнаты#Моментально убивает Маму и Сердце Мамы#Убивает ВАС при использовании на Сатане!"},
    {"34","Книга Белиала","↑ 2 к урону#+12.5% шанс сделки с дьяволом#+50% к урону, если есть Кровь Мученика (Blood of the Martyr)"},
    ...
    {"37","Мистер Бум","При истользовании появляется большая бомба, которая наносит 110 урона"},
    {"38","Голова Тамми","Выстреливает 10 слез вокруг персонажа#Каждая слеза имеет +25 к урону"},
    {"39","Мамин Бюстгальтер","При использовании замораживает всех врагов в комнате на 4 секунды"},
    {"40","Камикадзе!","Вызывает взрыв вокруг персонажа#Персонаж получает урон от взрыва"},
    ...
    {"43","000","<я - ошибка!>"},
    {"44","Телепорт!","Телепортирует персонажа в случайную комнату"},
    {"45","Ням Сердце","При использовании лечит на 1 красное сердце"},
    {"46","Счастливая Нога ","↑ 1.0 к удаче#Высокий шанс выигрыша в автоматах и у наперсточников"},
    ...
    {"49","Шуп Да Вуп!","Атака серным лазером#Наносит большой урон"},
    {"50","Стивен","↑ 1 к урону"},
    {"51","Пентаграмма","↑ 1.0 к урону#+10% шанс сделки с дьяволом"},
    {"52","Доктор Зародыш","Слезы становятся бомбами!"},
    {"53","Магнито","Притягивает подбираемые предметы к персонажу"},
    {"54","Карта Сокровищ","Показывает карту уровня"},
    {"55","Мамин Глаз","Случайный шанс выстрелить назад#100% шанс с удачей +2"},
    {"56","Лимонная Авария","При активации создает под вами лужу, которая наносит врагам урон"},
    {"57","Сдержанное Восхищение","Орбитальная муха#Летает на средней дистанции#Наносит большой контактный урон"},
    {"58","Книга Теней","При использовании делает неуязвимым на 10 секунд"},
    {"59","000","<я - ошибка!>"},
    {"60","Лестница","Позволяет ходить через пропасти шириной в 1 клетку"},
    {"61","000","<я - ошибка!>"},
    {"62","Очарование Вампира","Лечит на пол-сердца за каждые 13 убитых врагов"},
    {"63","Батарейка","Активный предмет можно зарядить дважды"},
    {"64","Распродажа в Steam","Скидка 50% в магазине#Вторая скидка сделает товары бесплатными"},
    ...
    {"67","Сестра Мэгги","Атакующий спутник"},
    {"68","Технология","Заменяет слезы на лазер"},
    {"69","Шоколадное Молоко","Заряжающиеся слезы"},
    {"70","Гормоны Роста","↑ 1.0 к урону#↑ 0.4 к скорости"},
    {"71","Мини Гриб","↑ 0.3 к скорости#↓ дальность стрельбы#Уменьшает вас"},
    {"72","Четки","+3 Сердца Души#Больше шанс найти Библию"},
    ...
    {"75","Лицензия Доктора","Все пилюли имеют либо положительный, либо нейтральный эффекты# +1 пилюля"},
    {"76","Рентген-Зрение","Открывает секретные комнаты"},
    {"77","Мой Маленький Единорог","Неуязвимость + контактный урон при активации"},
    ...
    {"81","Мертвая Кошка","Дает 9 жизней#Отнимает все Красные Сердца, кроме одного#Возрождение с 1 сердцем"},
    {"82","Повелитель Ям","Полет#↑ 0.3 к скорости"},
    {"83","Гвоздь","При использовании:#+1 Сердце Души#↑ 0.7 к урону#↑ 0.18 скорость#Разрушение камней"},
    {"84","Нам Нужно Глубже!","При использовании создает на полу люк на следующий уровень#10% шанс создать люк в черный рынок"},
    ...
    {"88","Малютка Чабби","Спутник, летит в направлении стрельбы и наносит врагам контактный урон"},
    {"89","Паучий Укус","Шанс замедлить врагов#100% шанс с удачей +15"},
    ...
    {"95","Робо-Малыш","Спутник, атакующий лазером"},
    {"96","Малютка Ч.А.Д.","Дает пол-сердца каждые 3 комнаты"},
    {"97","Книга Греха","При использовании создает на полу случайный подбираемый предмет"},
    {"98","Реликвия","Дает Сердце Души каждые 4 комнаты"},
    {"99","Малютка Гиш","Спутник с замедляющими слезами"},
    {"100","Стивен Младший","Спутник с самонаводящимися слезами"},
    {"101","Нимб","↑ 1 к здоровью#↑ 0.3 к урону#↑ 0.2 скорострельность#↑ 0.25 дальность стрельбы#↑ 0.3 скорость#↑ 0.5 высота слезы"},
    {"102","Мамин Пузырек с Пилюлями","При использовании дает случайную пилюлю"},
    {"103","Простуда","Шанс отравить врага слезой#100% шанс с удачей +12"},
    {"104","Паразит","Слезы разлетаются на две части при столкновении"},
    {"105","D6","Меняет артефакты на пьедесталах в комнате"},
    {"106","Мистер Мега","Урон от бомб ‡2.25#+5 Бомб"},
    {"107","Фестонные Ножницы","Полет в пределах комнаты#Ваше тело атакует врагов"},
    {"108","Облатка","Любой урон отнимает лишь пол-сердца"},
    {"109","Деньги = Сила","↑ к урону за каждую монетку#Чем больше монеток поднимает персонаж, тем меньше урона они дают#На бонус действуют множители персонажей"},
    {"110","Мамины Линзы","Шанс заморозить врагов (зависит от удачи)#↑ дальность стрельбы#При удаче +12 шанс увеличивается до максимального (50%)"},
    {"111","Боб","Ядовитые газы"},
    {"112","Ангел-Хранитель","Орбитальный спутник#Ускоряет всех спутников"},
    {"113","Малыш-Демон","Авто-наводящийся помощник#Имеет небольшой радиус действия"},
    ...
    {"117","Мертвая Птица","Атакует врагов после того, как вы получите урон"},
    {"118","Сера","Заряжаемый кровавый лазер, наносящий много урона"},
    {"119","Пакет с Кровью","↑ 1 к здоровью#↑ 0.3 к скорости#Лечит на 5 сердец"},
    {"120","Странный Гриб","↑ 1.7 скорострельность#↑ 0.3 скорость#↓ к урону (небольшой)"},
    {"121","Странный Гриб","↑ +1 пустое сердце#↑ 0.3 к урону#↑ 0.25 дальность стрельбы#↓ 0.1 скорость#↑ 0.5 высота слезы"},
    ...
    {"124","Свитки Мертвого Моря","Эффект случайного активного предмета"},
    ...
    {"127","Забудь Меня","ОДНОРАЗОВЫЙ ПРЕДМЕТ!#Текущий уровень перезапускается и генерируется заново"},
    {"128","Один навсегда","Орбитальныя муха#Летает далеко от вас"},
    {"129","Ведро Сала","↑ 2 к здоровью#↓ 0.2 скорость#Лечит лишь на пол-сердца"},
    {"130","Пони","Полет, если вы держите этот предмет#Атака рывком в выбранном направлении"},
    ...
    {"134","Хвост Гаппи","Появляется больше сундуков"},
    ...
    {"140","Проклятие Боба","Ядовитые бомбы#+5 Бомб"},
    ...
    {"146","Икона","При использовании дает вечное сердце"},
    ...
    {"150","Жесткая Любовь","Шанс выстрелить зубом, наносящим двойной урон#100% шанс с удачей +9"},
    ...
    {"154","Химический Ожог","↑ 2 к урону (для левого глаза, или с шансом 50%)"},
    {"155","Наблюдатель","Летает по комнате#Наносит контактный урон"},
    ...
    {"160","Разверзшиеся Небеса","При использовании на врагов упадут Лучи Света, наносящие большой урон"},
    ...
    {"163","Малыш Призрак","Помощник со спектральными слезами"},
    {"164","Свеча","Стреляет синим пламенем"},
    {"165","Девятихвостая плеть","↑ 1 к урону#↑ 0.23 скорость слезы"},
    {"166","D20","Меняет подбираемые предметы в комнате"},
    {"167","Малыш Арлекин","Стреляет слезами по V-образной траектории"},
    {"168","Эпический Зародыш","Слезы заменяются на ракеты!"},
    {"169","Полифем","Мега слезы!#↑ к урону#↓ к скорострельности"},
    {"170","Папочка Длинные Ноги","За вами следует нога Папочки, которая давит врагов"},
    {"171","Паучья Жопка","Замедляет всех врагов#Наносит им небольшой урон"},
    {"172","Жертвенный Кинжал","Орбитальный нож#Наносит большой контактный урон"},
    {"173","Митра","Высокий шанс найти Сердце Души"},
    {"174","Радужный Малыш","Спутник, стреляет слезами со случайным эффектом"},
    ...
    {"178","Святая Вода","Если вы получите урон, она разобьется#На полу появится лужа, которая наносит урон врагам"},
    {"179","Судьба","Полет#+1 вечное сердце"},
    {"180","Черный Боб","При получении урона вы отравляете врагов ядовитым газом"},
    {"181","Белый Пони","Полет, если вы держите этот предмет#Атака рывком и небесными лучами"},
    {"182","Священное Сердце","Самонаводящиеся слезы#↑ 1 к здоровью#↑ урон ‡2.5#↓ 0.4 к скорострельности#↓ 0.25 скорость слезы#↑ 0.375 дальность стрельбы"},
    {"183","Зубочистки","↑ 0.7 скорострельность.#↑ 0.16 скорость слезы"},
    {"184","Святой Грааль","Полет#↑ 1 к здоровью"},
    {"185","Мертвая Голубка","Полет#Спектральные слезы"},
    {"186","Право На Кровь","При использовании наносит 40 урона всем в комнате#За использование ранит игрока на 1 сердце"},
    {"187","Комок Шерсти Гаппи","Атакующий комок шерсти#Катается вокруг вас и растет, когда убивает врагов"},
    {"188","Авель","Зеркально повторяет ваши движения#Стреляет в сторону игрока"},
    ...
    {"190","Пиро","+99 Бомб"},
    {"191","Трехдолларовая Банкнота","Дает слезам случайные эффекты"},
    ...
    {"194","Магический 8-й шар","↑ 0.16 скорость слезы#Дает случайную карту"},
    ...
    {"202","Прикосновение Мидаса","Превращает врагов в золото при касании#Если их разбить, из них выпадут монеты"},
    ...
    {"206","Гильотина","↑ 1 к урону#↑ скорострельность#Ваша голова теперь движется вокруг вас по орбите"},
    ...
    {"208","Пояс Чемпиона","↑ 1 к урону#Враги-чемпионы встречаются чаще"},
    ...
    {"211","Малыш-Паук","При получении вами урона появляется союзный паук"},
    {"212","Ошейник Гаппи","50% шанс возродиться после смерти"},
    {"213","Потерянная Линза","У слез появится щит, блокирующий другие снаряды#При столкновении такой слезы и снаряда обе исчезнут"},
    {"214","Анемия","↑ 5 дальность стрельбы#При получении урона вы начинаете оставлять ядовитый след в пределах комнаты"},
    {"215","Козья Голова","100% шанс появления комнаты Ангела/Дьявола"},
    {"216","Церемониальная Мантия","↑ 1 к урону#+3 Черных Сердца"},
    {"217","Мамин Парик","Со случайным шансом создает союзных пауков во время стрельбы"},
    {"218","Плацента","Очень медленная регенерация#↑ 1 к здоровью"},
    {"219","Старый Пластырь","↑ +1 пустое сердце#При получении урона случайный шанс создать красное сердце"},
    ...
    {"222","Анти-гравитация","↑ к скорострельности#Слезы висят в воздухе, пока вы стреляете"},
    {"223","Пироманьяк","Взрывы лечат вас!#+5 Бомб"},
    {"224","Тело Крикета","↑ к скорострельности#↓ 10.0 дальность стрельбы#Слезы разлетаются на 4 части при столкновении"},
    {"225","Убогий","Шанс создать Сердце Души/Черное Сердце при получении урона"},
    {"226","Черный Лотос","↑ 1 к здоровью#+1 Сердце Души#+1 Черное Сердце"},
    {"227","Свинка Копилка","+3 Монеты#При получении урона дает монету"},
    {"228","Мамины Духи","↑ к скорострельности#Шанс напугать врагов"},
    {"229","Легкие Монстро","Слезы заряжаются и выстреливают россыпью#Атака аналогична атаке Монстро"},
    {"230","Абаддон","↑ 1.5 к урону#↑ 0.2 к скорости#Шанс напугать врагов#Лишает вас красных сердец#+6 Черных Сердец"},
    {"231","Шар из Смолы","Замедляющие слезы#Вы оставляете за собой на полу замедляющую слизь"},
    {"232","Остановившиеся Часы","При получении урона, враги в комнате перманентно замедляются"},
    {"233","Крошечная Планета","Слезы летают вокруг вас по орбите#↑ 7.0 к высоте слез"},
    ...
    {"237","Прикосновение Смерти","Слезы превращаются в косы!#↑ 1.5 к урону#↓ 0.3 к скорострельности"},
    {"238","Первая Часть Ключа","Часть ключа от двери к Мега-Сатане!#Выше вероятность появления комнаты Ангела"},
    {"239","Вторая Часть Ключа","Часть ключа от двери к Мега-Сатане!#Выше вероятность появления комнаты Ангела"},
    {"240","Экспериментальное Лечение","Ваши параметры меняются случайным образом"},
    {"241","Договор с Преисподней","Все предметы, падающие после зачистки комнаты, дублируются"},
    {"242","Позор","Шанс блокировать летящие снаряды#Блокирует с любой стороны"},
    {"243","Триединый Щит","Щит, блокирующий снаряды"},
    {"244","Техно.5","Атака лазером#Лазер имеет случайные эффекты"},
    ...
    {"249","Выбор Есть","После босса появляются два артефакта на выбор#Взять можно только один"},
    ...
    {"378","No 2.","После непрерывной стрельбы в течение 3 секунд, создает под вами Butt-бомбу"},
