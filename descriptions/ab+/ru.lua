...
EID.descriptions[languageCode].collectibles={
	...
	{"114", "Мамин нож", "Заменяет слёзы на управляемый нож, который пронзает врагов#Наносит 2x урона персонажа пока находится в руках#Урон при броске достигает 6x при заряде на 1/3; дальнейший заряд увеличивает только дальность#Когда нож летит назад наносит фиксированный 2x урон" },
...
[215] = { "Козья голова", "{{DevilRoom}}/{{AngelRoom}} +100% к шансу появление сделки с Дьяволом/Ангелом#Дверь в комнату сделки никогда не пропадает" },
	...
	{"299", "Телец", "{{Speed}} -0.3 Скорость#Вы становитесь быстрее в комнате с врагами#При скорости 2.0, временная неуязвимость и контактный урон" },
	...
	{"309", "Рыбы", "{{Tears}} +0.5 Скорострельность#+0.12 Размер слез#Увеличивает отдачу от слёз" },
...
EID.descriptions[languageCode].cards={
	...
	{"38", "Беркано", "Призывает 3 союзных саранчи на одну комнату"},
