...
EID.descriptions["ru"].collectibles={
	...
	{"2", "Внутренний глаз", "Тройной выстрел#↓ Множитель х0.51 к скорострельности"},
	...
	{"92", "Суперпластырь", "↑ +1 к здоровью#+2 Сердца Души#Лечит 1 красное сердце"},
	...
	{"96", "Маленький Ч.А.Д.", "Дает пол-сердца каждые 3 комнаты"},
	...
	{"120", "Странный гриб (тонкий)", "↑ +1.7 скорострельность#↑ +0.3 скорость#↓ Множитель x0.9 и -0.4 от урона)"},
	...
	{"182", "Священное сердце", "Самонаводящиеся слезы#↑ +1 к здоровью#↑ урон ‡2.5#↓ -0.4 к скорострельности#↓ -0.25 скорость слезы#↑ +0.375 дальность стрельбы#Полное лечение"},
	...
	{"213", "Потерянная линза", "У слез появится щит, блокирующий другие снаряды#При столкновении такой слезы и снаряда обе исчезнут#↓ -0.16 от скорости слезы"},
	...
	{"304", "Весы", "+6 Монет, +6 Ключей, +6 Бомб#Балансирует ваши параметры!#!!! Все последующие улучшения будут распределяться между всеми вашими параметрами"},
	...
	{"309", "Рыбы", "↑ +0.5 к скорострельности#Увеличивает отдачу"},
	...
	{"312", "Бант Мэгги", "↑ +1 к здоровью#Лечит 1 красное сердце#Удваивает эффект лечения сердец"},
	...
	{"323", "Слёзы Исаака", "При использовании выпускает 8 слез вокруг персонажа#Заряжается во время стрельбы"},
	...
	{"398", "Божья плоть", "Случайный шанс уменьшить врага#Уменьшенного врага можно убить, раздавив его"},
...
EID.descriptions["ru"].trinkets={
	...
	{"3", "Батарейка ААА", "Уменьшает количество необходимых зарядов для предмета на 1"},
	{"4", "Сломанный пульт", "Телепортирует в случайную комнату, когда вы используете активный предмет"},
	{"5", "Пурпурное сердце", "Больше монстров-чемпионов и боссов-чемпионов"},
	...
	{"80", "Чёрное перо", "↑ +0.2 к урону за каждый имеющийся дьявольский артефакт"},
	...
	{"122", "Масло", "При использовании активируемого предмета он окажется на полу на пьедестале#При получении урона шанс 2%, что случайный пассивный артефакт персонажа выпадет на пол."},
...
EID.descriptions["ru"].dice={
    {"1", "", "Меняет все пассивные артефакты персонажа на случайные из пула {{TreasureRoom}} Комнаты Сокровищ"},
