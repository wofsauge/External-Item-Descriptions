...
EID.descriptions["ru"].collectibles={
	...
	{"5", "Моё отражение", "Дает слезам эффект бумеранга#↑ +1.5 дальность стрельбы#↑ +0.6 скорость слезы#↑ +1 высота слезы"},
	...
	{"120", "Странный гриб (тонкий)", "↑ +1.7 скорострельность#↑ +0.3 скорость#↓ к урону (небольшой)"},
	{"121", "Странный гриб (большой)", "↑ +1 пустое сердце#↑ +0.3 к урону#↑ +0.25 дальность стрельбы#↓ -0.1 скорость#↑ +0.5 высота слезы"},
	...
	{"373", "Мёртвый глаз", "↑ 12.5% к урону за каждое точное попадание (макс. +100%)"},
	...
	{"378", "Номер 2", "После непрерывной стрельбы в течение 3 секунд, создает под вами Butt-бомбу"},
	...
	{"383", "Слезный детонатор", "Детонирует каждую слезу в комнате#Каждая слеза разлетается на 6"},
	...
	{"442", "Корона Тёмного принца", "!!! Если есть ровно 1 красное сердце:#↑ +1.5 дальность стрельбы#↑ +0.7 скорострельность#↑ +0.2 скорость слезы#(Не работает с Потерянным)"},
	...
	{"457", "Коническая головка", "+1 Сердце Души#20% шанс блокировать урон от снаряда"},
...
EID.descriptions["ru"].trinkets={
	...
	{"17", "Чёрная помада", "Больше Черных Сердец"},
	...
	{"32", "Вольная шляпка", "Каждую комнату дает эффект случайного гриба или Компаса"},
	...
	{"60", "Лапка птички Евы", "Шанс появления Мертвой Птицы за убийство"},
	...
	{"67", "Сломанный Кубик", "Шанс срабатывания эффекта случайного кубика при получении урона"},
	...
	{"112", "Заплати чтобы выиграть", "Автомат Обновления всегда будет в комнате с предметами ({{TreasureRoom}})"},
...
EID.descriptions["ru"].cards={
	...
	{"12", "XI - Сила", "↑ +1 к здоровью#↑ +0.3 к урону#↑ +50% множитель урона#↑ +5.25 дальность стрельбы↑ +0.3 к скорости#В пределах комнаты"},
...
EID.descriptions["ru"].pills={
	...
	{"20", "Энергия на 48 яасов", " Перезаряжает ваш активный предмет#Создает 1-2 батарейки"},
