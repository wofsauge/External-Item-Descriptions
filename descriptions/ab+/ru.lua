...
EID.descriptions["ru"].trinkets={
	...
	{"7", "Бусинка от четок", "Повышает шанс появления {{AngelRoom}} Комнаты Ангела"},
	{"8", "Картридж", "Шанс активировать эффекта артефакта Геймкид при получении урона#(короткая неуязвимость + контактный урон)"},
...
EID.descriptions["ru"].sacrifice={
    ...
    {"9", "", "100% шанс появления ангела \"Уриила\""},
    {"10", "", "50% шанс на 7 синих сердец#50% шанс на 30 монет"},
    {"11", "", "100% шанс появления ангела \"Гавриила\""},
...
EID.descriptions["ru"].dice={
    {"1", "", "Меняет все пассивыне артефакты персонажа на случайные из пула той комнаты, в которой они были получены"},
