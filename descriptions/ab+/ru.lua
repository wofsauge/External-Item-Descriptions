...
EID.descriptions[languageCode].collectibles={
	...
	{"297", "Ящик Пандоры", "!!! ОДНОРАЗОВЫЙ!!!# В зависимости от этажа:#ПI:2 Сердца Души#ПII:2 ключа, 2 бомбы#КI:1 артефакт Босса#KII:ПI+КI#ГI:4 Сердца Души#ГII: 30 Монет#УI:2 артефакта Босса#УII: Библия#???: Ничего#Шеол: 1 артефакт Дьявола+Черное Сердце#Собор: 1 артефакт Ангела+Сердце Души#Темная комната: разблокировать {{Collectible523}}Moving Box#Сундук: 1 Монета"},
