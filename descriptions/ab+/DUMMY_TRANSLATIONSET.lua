...
EID.descriptions["DUMMY"].collectibles={
    ...
    {"14", "Roid Rage", "↑ +0.6 Speed up#↑ +5.25 Range up#↑ +0.5 Shot Height"},
    ...
    {"36", "The Poop", "Spawns one poop#Can be placed next to a pit and destroyed to make a bridge"},
    ...
    {"40", "Kamikaze!", "Causes an explosion at the players location"},
    ...
    {"64", "Steam Sale", "-50% on shop items#Getting two will make everything free"},
    ...
    {"76", "X-Ray Vision", "Reveals secret rooms"},
    ...
    {"81", "Dead Cat", "↑ +9 Lives#Respawn with 1 Heart"},
    ...
    {"91", "Spelunker Hat", "Reveals what`s behind the doors"},
    ...
    {"98", "The Relic", "Spawns 1 Soul heart every 4 rooms"},
    ...
    {"114", "Mom's Knife", "Controllable knife attack"},
    ...
    {"120", "Odd Mushroom", "↑ +1.7 Tears up#↑ +0.3 Speed up#↓ -10% Damage down"},
    ...
    {"165", "Cat-o-nine-tails", "↑ +1 Damage up#↑ +23% Shoot speed up"},
    ...
    {"169", "Polyphemus", "Mega Tears!#↑ Damage up#↓ Tears down"},
    ...
    {"182", "Sacred Heart", "Homing tears#↑ +1 Health up#↑ Damage way up#↓ -0.4 Tears down#↓ -25% Shot Speed down#↑ +4.125 Range up"},
    {"183", "Tooth Picks", "↑ +0.7 Tears up.#↑ +16% Shot Speed up"},
    ...
    {"194", "Magic 8 Ball", "↑ +0.16 Shoot speed up#+1 card"},
    ...
    {"213", "Lost Contact", "Shielded tears#Tears block enemy shots#↓ -16% Shot Speed down"},
    ...
    {"255", "Screw", "↑ +0.5 Tears up#↑ +0.2 Shoot Speed up"},
    ...
    {"310", "Eve's Mascara", "↑ +100% Damage#↓ Tears down#↓ -0.5 Shoot speed down"},
    {"311", "Judas' Shadow", "When dead, respawn as Black judas#↓ (Damage X 2)"},
    {"312", "Maggy's Bow", "↑ +1 Health up#All red hearts now heal double their value"},
    ...
    {"331", "Godhead", "Homing tears#↑ +0.5 Damage up#↑ +1.2 Range up#↓ -0.3 Tears down#↓ -30% Shot Speed down#↑ +0.8 Tear Height"},
    ...
    {"336", "Dead Onion", "Piercing + spectral tears#↑ +0.25 Range up#↓ -0.4 Shot Speed down"},
    ...
    {"339", "Safety Pin", "↑ +5.25 Range up#↑ +16% Shot Speed up#+1 Black Heart#↑ +0.5 Tear Height"},
    {"340", "Caffeine Pill", "↑ +0.3 Speed up#↑ Player Size down#Gives you a random pill when picked up"},
    {"341", "Torn Photo", "↑ +0.7 Tears up#↑ +16% Shot Speed up"},
...
---------- Trinkets ----------
EID.descriptions["DUMMY"].trinkets={
...
EID.descriptions["DUMMY"].unidentifiedPill = "- Unidentified Pill"

EID.descriptions["DUMMY"].pills={
...
---------- Sacrifice Room ----------
EID.descriptions["DUMMY"].sacrificeHeader = "[Next Sacrifice Room payout]"

EID.descriptions["DUMMY"].sacrifice={
...
---------- Dice Room ----------
EID.descriptions["DUMMY"].diceHeader = "[Dice effect]"

EID.descriptions["DUMMY"].dice={
...
---------- Transformations ----------
EID.descriptions["DUMMY"].transformations = {
    "",					-- 0 = none
    "Guppy",			-- 1
    "Fun Guy",			-- 2
    "Lord of the Flies",-- 3
