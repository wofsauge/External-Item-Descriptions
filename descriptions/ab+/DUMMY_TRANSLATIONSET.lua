...
EID.descriptions["DUMMY"].collectibles={
    ...
    {"338", "The Boomerang", "Throwable boomerang#Stuns enemies on hit#Can grab items"},
    ...
    {"534", "Schoolbag", "Allows holding 2 active items#Switch between them by pressing CTRL (hold CTRL as \"The Forgotton\")"},
