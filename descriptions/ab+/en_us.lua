...
EID.descriptions[languageCode].collectibles={
	...
	{"33", "The Bible", "{{Timer}} Flight for the room#{{MomsHeart}} Kills Mom's Foot and Mom's Heart instantly#!!! Kills Isaac when used on Satan"},
	...
	{"126", "Razor Blade", "↑ {{Damage}} +1.2 Damage for the room#!!! Deals 1 heart of damage to Isaac#{{Heart}} Removes Red Hearts first"},
	...
	{"297", "Pandora's Box", "!!! SINGLE USE !!! Spawns rewards based on floor:#B1: 2{{SoulHeart}}; B2: 2{{Bomb}} + 2{{Key}}#C1: Boss item; C2: B1+C1#D1: 4{{SoulHeart}}; D2: 20{{Coin}}#W1: 2 Boss items#W2: {{Collectible33}} The Bible#???/Void: Nothing#Sheol: Devil item + 1{{BlackHeart}}#Cathe: Angel item + 1{{EternalHeart}}#Dark Room: {{Collectible523}} Moving Box; Chest: 1{{Coin}}"},
	...
	{"347", "Diplopia", "!!! SINGLE USE !!!#Duplicates all item pedestals and consumables in the room"},
	...
	{"357", "Box of Friends", "{{Timer}} Receive for the room:#A dublication of every familiar#{{Collectible113}} A Demon Baby if Isaac has no familiars"},
	...
	{"375", "Host Hat", "Immune to to explosions, rock wave attacks and Mom and Satan's stomp attacks#25% chance to reflect enemy shots"},
	...
	{"388", "Key Bum", "{{Key}} Picks up keys and spawns random {{Chest}} chests"},
	...
	{"415", "Crown Of Light", "{{SoulHeart}} +2 Soul Hearts#{{Blank}} If Isaac has no damaged Red Heart containers:#↑ {{Damage}} x2 Damage multiplier#↑ {{Range}} +5.25 Range#↑ +0.5 Tear height#↓ {{Shotspeed}} -0.3 Shot speed#Taking any damage removes the effect for the room"},
	...
	{"487", "Potato Peeler", "Removes 1 heart container for:#↑ {{Damage}} +0.2 Damage#{{Collectible73}} A Cube of Meat#{{Timer}} Receive for the room:#↑ {{Range}} +5 Range#{{Collectible214}} Leave a trail of blood creep"},
