...
EID.descriptions[languageCode].collectibles={
	{"1", "The Sad Onion", "↑ {{TearsAB}} +0.7 Tears up"},
	{"2", "The Inner Eye", "Triple shot#↓ {{TearsAB}} Tears down"},
	{"3", "Spoon Bender", "Homing tears"},
	{"4", "Cricket's Head", "↑ {{DamageAB}} +0.5 Damage up#↑ {{DamageAB}} +50% Damage Multiplier"},
	{"5", "My Reflection", "Gives tears a boomerang effect#↑ {{Range}} +1.5 Range up#↑ {{ShotspeedAB}} +0.6 Shot Speed up#↑ +1 Tear Height"},
	{"6", "Number One", "↑ {{TearsAB}} +1.5 Tears up#↓ {{Range}} -17.62 Range down#↑ +0.76 Tear Height"},
	{"7", "Blood of the Martyr", "↑ {{Damage}} +1 Damage up"},
	...
	{"12", "Magic Mushroom", "↑ +1 Health up#Full health#↑ {{DamageAB}} +0.3 Damage up#↑ {{Damage}} +50% Damage Multiplier#↑ {{Range}} +5.25 Range up#↑ {{Speed}} +0.3 Speed up#↑ +0.5 Tear Height#Size up"},
	...
	{"27", "Wooden Spoon", "↑ {{SpeedAB}} +0.3 Speed up"},
	{"28", "The Belt", "↑ {{SpeedAB}} +0.3 Speed up"},
	{"29", "Mom's Underwear", "↑ {{RangeAB}} +5.25 Range up#↑ +0.5 Tear Height"},
	{"30", "Mom's Heels", "↑ {{RangeAB}} +5.25 Range up#↑ +0.5 Tear Height"},
	{"31", "Mom's Lipstick", "↑ {{RangeAB}} +5.25 Range up#↑ +0.5 Tear Height"},
	{"32", "Wire Coat Hanger", "↑ {{TearsAB}} +0.7 Tears up"},
	{"33", "The Bible", "Flight for current room#Kills Mom's Foot and Mom's Heart instantly#!!! Kills YOU when used on Satan"},
	{"34", "The Book of Belial", "↑ +2 Damage up#↑ {{DevilChanceAB}} / {{AngelChanceAB}} +12.5% Devil/Angel Room chance"},
	...
	{"41", "Mom's Pad", "Fears all enemies in the current room for 5 seconds"},
	...
	{"46", "Lucky Foot", "↑ {{LuckAB}} +1 Luck up#+8% room clear reward chance#Better chance to win while gambling"},
	...
	{"50", "Steven", "↑ {{DamageAB}} +1 Damage up"},
	{"51", "Pentagram", "↑ {{DamageAB}} +1 Damage up#↑ {{DevilChanceAB}} / {{AngelChanceAB}} +10% Devil/Angel Room chance"},
	{"52", "Dr. Fetus", "Bomb tears#{{Damage}} Each bomb deals 5x your damage + 30#↓ {{TearsAB}} Tear Delay x 2.5"},
	...
	{"66", "The Hourglass", "Slow down enemies for 8 seconds"},
	{"67", "Sister Maggy", "Normal tear familiar#Deals 3.5 damage per tear"},
	{"68", "Technology", "Tears are now lasers"},
	{"69", "Chocolate Milk", "{{Chargeable}} Chargeable tears#↑ {{DamageAB}} Up to 400% Damage#↓ {{TearsAB}} Tears down"},
	{"70", "Growth Hormones", "↑ {{DamageAB}} +1 Damage up#↑ {{SpeedAB}} +0.4 Speed up"},
	{"71", "Mini Mush", "↑ {{SpeedAB}} +0.3 Speed up#↓ {{RangeAB}} -4.25 Range down*#↑ +1.5 Tear Height*#(*both add up to a slight Range up)#↑ Size down"},
	...
	{"75", "PHD", "Better pills#Spawns 1 pill on pickup#Heals 2 Red Hearts#{{DonationMachine}} More money from Blood Donation Machines and {{Collectible135}} IV Bag"},
	{"76", "X-Ray Vision", "{{SecretRoom}} Reveals secret rooms entrances"},
	{"77", "My Little Unicorn", "Invincibility#40 contact damage"},
	{"78", "Book of Revelations", "{{SoulHeart}} +1 Soul Heart#Higher horsemen chance if used#↑ {{DevilChanceAB}} / {{AngelChanceAB}} +17.5% Devil/Angel Room chance"},
	{"79", "The Mark", "↑ {{DamageAB}} +1 Damage up#↑ {{SpeedAB}} +0.2 Speed up#{{SoulHeart}} +1 Soul Heart"},
	{"80", "The Pact", "↑ {{DamageAB}} +0.5 Damage up#↑ {{TearsAB}} +0.7 Tears up#{{SoulHeart}} +2 Soul Hearts"},
	...
	{"82", "Lord of the Pit", "Flight#↑ {{SpeedAB}} +0.3 Speed up"},
	{"83", "The Nail", "{{SoulHeart}} +1 Soul Heart#↑ {{DamageAB}} +0.7 Damage up#↓ {{SpeedAB}} -0.18 Speed down#Deal contact damage#Destroy rocks when walking over them"},
	...
	{"87", "Loki's Horns", "25% chance to shoot in 4 directions#{{LuckAB}} 100% chance at 7 Luck"},
	{"88", "Little Chubby", "Familiar that charges forward#Deals 52.5 contact damage per second"},
	{"89", "Spider Bite", "{{Slow}} 25% chance to shoot slowing tears#{{LuckAB}} 100% chance at 15 Luck"},
	{"90", "The Small Rock", "↑ {{DamageAB}} +1 Damage up#↑ {{TearsAB}} +0.2 Tears up#↓ {{SpeedAB}} -0.2 Speed down"},
	...
	{"101", "The Halo", "↑ +1 Health up#↑ {{DamageAB}} +0.3 Damage up#↑ {{TearsAB}} +0.2 Tears up#↑ {{RangeAB}} +0.25 Range up#↑ {{Speed}} +0.3 Speed up#↑ +0.5 Tear Height"},
	{"102", "Mom's Bottle of Pills", "Spawns 1 Pill"},
	{"103", "The Common Cold", "{{Poison}} 25% chance to shoot Poison tears#{{LuckAB}} 100% chance at 12 Luck"},
	...
	{"109", "Money = Power", "↑ {{DamageAB}} +0.04 Damage up for every {{Coin}} coin you have"},
	{"110", "Mom's Contacts", "20% chance to shoot Freezing tears#↑ +0.25 Range up#↑ +0.5 Tear Height"},
	...
	{"116", "9 Volt", "-1 charge needed for active items#Fully recharges your active item"},
	...
	{"119", "Blood Bag", "↑ +1 Health up#↑ +0.3 Speed up#Heals 4 Hearts"},
	{"120", "Odd Mushroom (Thin)", "↑ {{TearsAB}} +1.7 Tears up#↑ {{SpeedAB}} +0.3 Speed up#↓ {{DamageAB}} -10% Damage down#↓ {{DamageAB}} -0.4 additional Damage down"},
	{"121", "Odd Mushroom (Large)", "↑ +1 Empty heart container#↑ {{DamageAB}} +0.3 Damage up#↑ {{RangeAB}} +0.25 Range up#↓ {{SpeedAB}} -0.1 Speed down#↑ +0.5 Tear Height"},
	{"122", "Whore of Babylon", "!!! When on half a Red Heart or less:#↑ {{DamageAB}} +1.5 Damage up#↑ {{SpeedAB}} +0.3 Speed up"},
	...
	{"126", "Razor Blade", "↑ {{DamageAB}} +1.2 Damage up for current Room#↓ Deals 1 heart of damage to you#Prioritizes Red Hearts"},
	...
	{"130", "A Pony", "Grants flight while held#{{SpeedAB}} Sets your speed to 1.5 if you have less than 1.5#Dash in a direction on use"},
	...
	{"133", "Guppy's Paw", "!!! Convert:#1 heart container to 3 Soul Hearts"},
	{"134", "Guppy's Tail", "33% chance for room clear reward to be a chest#33% chance for no room clear reward"},
	{"135", "IV Bag", "Portable blood bank#Half a heart = 1-3 coins"},
	{"136", "Best Friend", "Exploding Decoy#Attracts enemies"},
	{"137", "Remote Detonator", "Detonate bombs on demand#+5 bombs"},
	{"138", "Stigmata", "↑ +1 Health up#↑ {{DamageAB}} +0.3 Damage up"},
	...
	{"144", "Bum Friend", "Converts coins into pickups"},
	...
	{"149", "Ipecac", "{{Poison}} Explosive poison tears#↑ {{DamageAB}} +40 Damage up#↓ {{TearsAB}} Tears down"},
	{"150", "Tough Love", "10% chance to shoot teeth#{{DamageAB}} Teeth deal 3.2x your damage#{{LuckAB}}100% chance at 9 Luck"},
	{"151", "The Mulligan", "1/6 chance to spawn a fly when tears hit an enemy"},
	{"152", "Technology 2", "Permanent laser attack!#↓ {{DamageAB}} -35% Damage down"},
	{"153", "Mutant Spider", "Quad Shot!#↓ {{TearsAB}} Tears down"},
	{"154", "Chemical Peel", "↑ {{DamageAB}} +2 Damage up for left eye"},
	{"155", "The Peeper", "Floats around the room#Deals 17.1 contact damage per second"},
	{"156", "Habit", "+1 charge when you get hit"},
	{"157", "Bloody Lust", "↑ {{DamageAB}} Damage up every time you get hit#Applies up to 6 times per floor#Lasts for whole floor"},
	...
	{"165", "Cat-o-nine-tails", "↑ {{DamageAB}} +1 Damage up#↑ {{ShotspeedAB}} +0.23 Shot speed up"},
	...
	{"169", "Polyphemus", "↑ {{DamageAB}} +100% Damage up#↑ {{DamageAB}} +4 additional Damage up#↓ {{TearsAB}} Tears down#Tears keep going after killing an enemy"},
	...
	{"176", "Stem Cells", "↑ {{Heart}} +1 Health up#↑ {{ShotspeedAB}} +0.16 Shot Speed up"},
	...
	{"183", "Tooth Picks", "↑ {{TearsAB}} +0.7 Tears up#↑ {{ShotspeedAB}} +0.16 Shot Speed up"},
	...
	{"193", "MEAT!", "↑ {{Heart}} +1 Health up#↑ {{DamageAB}} +0.3 Damage up"},
	{"194", "Magic 8 Ball", "↑ {{ShotspeedAB}} +0.16 Shot speed up#{{Card}} +1 card"},
	{"195", "Mom's Coin Purse", "{{Pill}} Drops 4 Pills"},
	{"196", "Squeezy", "{{SoulHeart}} Spawns 2 Soul Hearts#↑ {{TearsAB}} +0.4 Tears up"},
	...
	{"201", "Iron Bar", "↑ {{DamageAB}} +0.3 Damage up#{{Confusion}} 10% chance to shoot concussive tears"},
	...
	{"206", "Guillotine", "↑ {{DamageAB}} +1 Damage up#↑ {{TearsAB}} Tears up#Your Head is now an orbital#You will shoot from the head#The head deals 105 contact damage"},
	{"207", "Ball of Bandages", "LVL1: Orbital#LVL2: Shooting orbital#LVL3: Bandage Girl LVL1#LVL4: Bandage Girl LVL2"},
	{"208", "Champion Belt", "↑ {{DamageAB}} +1 Damage up#!!! +15% chance for champion enemies"},
	{"209", "Butt Bombs", "{{Bomb}} +5 Bombs#Explosions concuss and damage every enemy in the room"},
	...
	{"214", "Anemic", "↑ {{RangeAB}} +5 Range up#Leave creep on floor when getting hit"},
	{"215", "Goat Head", "↑ {{DevilChanceAB}} / {{AngelChanceAB}} 100% chance for Devil/Angel Rooms"},
	{"216", "Ceremonial Robes", "↑ +1 Damage up#+3 Black Hearts"},
	{"217", "Mom's Wig", "Random chance to spawn blue spider when shooting tears#Heals 1 Red Heart"},
	...
	{"220", "Sad Bombs", "Tear explosion!#{{Bomb}} +5 Bombs"},
	{"221", "Rubber Cement", "Bouncing tears"},
	{"222", "Anti-Gravity", "Holding the fire buttons causes tears to hover in midair#When released, they will all shoot in the direction they were fired#↑ -2 Tear Delay"},
	{"223", "Pyromaniac", "Explosions heal you#+5 Bombs"},
	{"224", "Cricket's Body", "↑ {{TearsAB}} +1 Tears up#↓ {{RangeAB}} -10 Range down#Tears split up in 4 on hit#Splitted tears deal half damage"},
	{"225", "Gimpy", "Chance to spawn a Soul Heart when taking damage#Monsters have a chance to drop a Half Red Heart on death"},
	...
	{"228", "Mom's Perfume", "{{Fear}} 15% chance to shoot Fear tears#↑ {{TearsAB}} +1 Tears up"},
	{"229", "Monstro's Lung", "Tears can now be charged and released in a shotgun style attack#↓ {{TearsAB}} 4.3x Tear Delay up"},
	{"230", "Abaddon", "↑ {{DamageAB}} +1.5 Damage up#↑ {{SpeedAB}} +0.2 Speed up#{{Fear}} Fear tears#↓ {{Heart}} Removes all heart containers#{{BlackHeart}} +6 Black Hearts"},
	{"231", "Ball of Tar", "{{Slow}} 10% chance to shoot slowing tears#{{LuckAB}} 100% chance at 18 Luck#Leave trail of slowing creep"},
	{"232", "Stop Watch", "Permanent slow effect#(activated when getting hit)#↑ +0.3 Speed up"},
	{"233", "Tiny Planet", "Tears orbit around you#↑ {{RangeAB}} Range way up!#↑ +7 Tear Height#Spectral tears"},
	...
	{"238", "Key Piece 1", "!!! Key piece for Mega Satan door!#More {{AngelRoom}}Angel Rooms appear"},
	{"239", "Key Piece 2", "!!! Key piece for Mega Satan door!#More {{AngelRoom}}Angel Rooms appear"},
	...
	{"251", "Starter Deck", "{{Card}} You can carry 2 Cards#{{Card}} Turns all Pills into Cards#{{Card}} Spawns 1 card on pickup"},
	{"252", "Little Baggy", "{{Pill}} You can carry 2 Pills#{{Pill}} Turns all Cards into Pills#{{Pill}} Spawns 1 pill on pickup"},
	{"253", "Magic Scab", "↑ {{LuckAB}} +1 Luck up#↑ {{Heart}} +1 Health up"},
	{"254", "Blood Clot", "↑ {{DamageAB}} +1 Damage up#↑ {{RangeAB}} +5 Range up#!!! Applies only for the left eye"},
	{"255", "Screw", "↑ {{TearsAB}} +0.5 Tears up#↑ {{ShotspeedAB}} +0.2 Shot Speed up"},
	...
	{"260", "Black Candle", "{{CurseCursed}} Immunity to Curses#{{BlackHeart}} +1 Black Heart#{{DevilChanceAB}} / {{AngelChanceAB}} +15% Devil/Angel Room chance"},
	{"261", "Proptosis", "↑ {{DamageAB}} +100% Damage up#↓ Dealt damage decreases for traveled distance of the tear"},
	...
	{"299", "Taurus", "↓ {{SpeedAB}} -0.3 Speed down#↑ {{SpeedAB}} Get faster in hostile rooms!#Invincibility when fast enough"},
	{"300", "Aries", "↑ {{SpeedAB}} +0.25 Speed up#Touching enemies hurts them"},
	{"301", "Cancer", "{{SoulHeart}}v+3 Soul Hearts#Halves taken damage in room when you already got hit"},
	...
	{"304", "Libra", "+6 {{Coin}} Coins / {{Key}} Keys / {{Bomb}} Bombs#Balances your stats!#!!! Every stats up afterwards will affect other stats too"},
	{"305", "Scorpio", "{{Poison}} Poison tears"},
	{"306", "Sagittarius", "↑ {{Speed}} +0.2 Speed up#Piercing tears"},
	{"307", "Capricorn", "↑ {{Heart}} +1 Health / {{Key}} Key / {{Bomb}} Bomb / {{Coin}} Coin#↑ {{Damage}} AB+0.5 Damage up#↑ {{SpeedAB}} +0.1 Speed up#↑ {{RangeAB}} +1.5 Range up#↑ {{TearsAB}} Tears up"},
	{"308", "Aquarius", "Leave trail of creep#Creep deals 6 damage per second"},
	{"309", "Pisces", "↑ {{TearsAB}} -1 Tear Delay#Increases knockback"},
	{"310", "Eve's Mascara", "↑ {{DamageAB}} +100% Damage up#↓ {{TearsAB}} -50% Tears down#↓ {{ShotspeedAB}} -0.5 Shot speed down"},
	...
	{"330", "Soy Milk", "↑ {{TearsAB}} Very high Tears up: (delay /4) - 2#↓ {{DamageAB}} -80% Damage down"},
	{"331", "Godhead", "Homing tears#↑ {{DamageAB}} +0.5 Damage up#↑ {{RangeAB}} +1.2 Range up#↓ {{TearsAB}} -0.3 Tears down#↓ {{ShotspeedAB}} -0.3 Shot Speed down#↑ +0.8 Tear Height#Tears gain a damaging aura"},
	...
	{"336", "Dead Onion", "Piercing + spectral tears#↑ {{RangeAB}} +0.25 Range up#↓ {{ShotspeedAB}} -0.4 Shot Speed down#↓ -0.5 Tear Height#↑ {{TearsizeAB}}+50% Tear size"},
	...
	{"339", "Safety Pin", "↑ {{RangeAB}}+5.25 Range up#↑ {{ShotspeedAB}} +0.16 Shot Speed up#↑ +0.5 Tear Height#{{BlackHeart}} +1 Black Heart"},
	{"340", "Caffeine Pill", "↑ {{SpeedAB}} +0.3 Speed up#↑ Size down#{{Pill}} Spawns a random pill when picked up"},
	{"341", "Torn Photo", "↑ {{TearsAB}} +0.7 Tears up#↑ {{ShotspeedAB}} +0.16 Shot Speed up"},
	...
	{"355", "Mom's Pearls", "↑ {{RangeAB}} +1.25 Range up#↑ {{LuckAB}} +1 Luck up#↑ +0.5 Tear Height"},
	...
	{"359", "8 Inch Nails", "↑ {{DamageAB}} +1.5 Damage up#Increases knockback"},
	...
	{"366", "Scatter Bombs", "{{Bomb}} +5 bombs#{{Bomb}} Causes your bombs to explode into 2-4 tiny bombs"},
	...
	{"369", "Continuum", "↑ {{RangeAB}} +2.25 Range up#↑ +1.5 Tear Height#Spectral tears#Tears travel through walls and appear out of the opposite wall"},
	{"370", "Mr. Dolly", "↑ {{TearsAB}} +0.7 Tears up#↑ {{RangeAB}} +5.25 Range up#↑ +0.5 Tear Height#Spawns 3 random hearts when picked up"},
	...
	{"373", "Dead Eye", "↑ {{DamageAB}} +25% Damage up for every tear that successfully hits an enemy (max +100%)#Chance to lose the multiplier when you miss"},
	...
	{"381", "Eden's Blessing", "↑ {{TearsAB}} +0.7 Tears up#Gives you a random item at the start of your next run"},
	...
	{"394", "Marked", "Fire tears automatically directed at a red target on the ground which is controlled by the player#↑ {{TearsAB}} +0.7 Tears up#↑ {{RangeAB}} +3.15 Range up#↑ +0.3 Tear Height"},
	{"395", "Tech X", "{{Chargeable}} Gain the ability to charge and fire a laser ring that travels across the room"},
	...
	{"399", "Maw of the Void", "↑ {{DamageAB}} +1 Damage up#After firing tears for 3 seconds, a red cross appears on Isaac's head. Upon releasing the fire button, creates a black brimstone ring#{{BlackHeart}} Enemies killed with the black ring have a chance to drop Black Hearts"},
	...
	{"407", "Purity", "↑ Boost one of your stats depending on the color of the aura around you#When you take damage, you will get a new aura#{{ColorRed}}Red{{CR}} = {{DamageAB}} +4 Damage#{{ColorBlue}}Blue{{CR}} = {{TearsAB}} -4 Tear Delay#{{ColorYellow}}Yellow{{CR}} = {{SpeedAB}} +0.5 Speed up#{{ColorOrange}}Orange{{CR}} = {{RangeAB}} +7.5 Range up, +1 Tear Height"},
	...
	{"409", "Empty Vessel", "{{BlackHeart}} +2 Black Hearts#When Isaac has no Red Hearts, gain flight and chance to trigger a shield"},
	{"410", "Evil Eye", "3.33% chance to shoot an eye across the screen which fires tears in the same direction as Isaac"},
	{"411", "Lusty Blood", "↑ {{DamageAB}} +0.5 Damage up for each enemy killed in current room#{{DamageAB}} Maximum of +5 Damage up after 10 kills"},
	...
	{"415", "Crown Of Light", "{{SoulHeart}} +2 Soul Hearts#If you don't have any damaged Red Heart containers:#↑ {{DamageAB}} +100% Damage up#↑ {{RangeAB}} +5.25 Range up#↑ +0.5 Tear Height#↓ {{ShotspeedAB}} -0.3 Shot Speed down#Deactivates for the current room when damaged at all"},
	{"416", "Deep Pockets", "Allows you to carry two cards/pills/runes"},
	{"417", "Succubus", "Bounces around the room with a damaging aura, dealing 129% of your damage every second#↑ {{DamageAB}} +50% damage while standing in the aura,"},
	...
	{"438", "Binky", "{{SoulHeart}} +1 Soul Heart#↑ {{TearsAB}} +0.75 Tears up#↑ Makes Isaac very small, reducing his hitbox size"},
	{"439", "Mom's Box", "{{Trinket}} Spawns a random trinket#{{Trinket}} While held, doubles the effect of trinkets#↑ {{LuckAB}} +1 Luck while held"},
	...
	{"442", "Dark Prince's Crown", "!!! While at 1 full Red Heart:#↑ {{RangeAB}} +1.5 Range up#↑ {{TearsAB}} +0.75 Tears up#↑ {{ShotspeedAB}} +0.2 Shot Speed up#↑ +1 Tear Height#Does not work with characters without red HP"}, -- Dark Princes Crown (apostrophe added to the name in Repentance)
	{"443", "Apple!", "Randomly fire razor blades which deal 400% damage#↑ {{TearsAB}} +0.3 Tears up"},
	{"444", "Lead Pencil", "Every 15 tears fired, you fire a cluster of tears#Each tear in the cluster deals double damage"},
	{"445", "Dog Tooth", "↑ {{DamageAB}} +0.3 Damage up#↑ {{SpeedAB}} +0.1 Speed up#{{SecretRoom}} / {{SuperSecretRoom}} A wolf howls if you enter a room next to a Secret/Super Secret Room#A barking sound will play when entering a room with a crawlspace under a rock"},
	...
	{"454", "Polydactyly", "You can carry two {{Card}} cards, {{Rune}} runes or {{Pill}} pills#Spawns a card, pill or rune on pickup"},
	{"455", "Dad's Lost Coin", "↑ {{RangeAB}} +1.5 Range up#↑ +1 Tear Height#Spawns a lucky penny"},
	...
	{"462", "Eye of Belial", "↑ {{RangeAB}} +1.5 Range up#↑ +1 Tear Height#Grants piercing tears#After hitting the first enemy, the tear deals double damage and gains a homing effect"},
	{"463", "Sulfuric Acid", "↑ {{DamageAB}} +0.3 Damage up#Chance to destroy rocks and open doors with your tears"},
	{"464", "Glyph of Balance", "{{SoulHeart}} +2 Soul Hearts#Champion enemies drop pickups more frequently"},
	{"465", "Analog Stick", "↑ {{TearsAB}} +0.3 Tears up#Allows you to fire tears diagonally by firing in two directions"},
	{"466", "Contagion", "{{Poison}} First killed enemy in the room will explode and poison all nearby enemies"},
	{"467", "Finger!", "{{DamageAB}} Deals constant 10% of your damage to enemies in the direction the finger points at"},
	...
	{"471", "Lil Monstro", "{{Chargeable}} Chargeable shotgun attack similar to {{Collectible229}} Monstro's Lung#Each tear deals 3.5 damage"},
	...
	{"487", "Potato Peeler", "Removes one Red Heart Container and gives you: #↑ {{DamageAB}} +0.2 Damage#{{Collectible73}} A Cube of Meat"},
	...
	{"492", "YO LISTEN!", "↑ {{LuckAB}} +1 Luck up#Highlights the location of {{SecretRoom}} secret rooms, tinted rocks and crawlspaces"},
	...
	{"498", "Duality", "{{DevilChanceAB}} / {{AngelChanceAB}} Spawns Devil AND Angel Room doors#When entering one, the other disappears"},
	...
	{"507", "Sharp Straw", "{{DamageAB}} Deals your damage + 10% of the enemy's max health#Affects all enemies in the room#{{HalfHeart}}Chance to drop half hearts when it deals damage"},
	...
	{"533", "Trisagion", "Fire piercing blasts of light#{{DamageAB}} They deal 33% damage but can hit enemies multiple times"},
	...
	{"543", "Hallowed Ground", "Spawn white poop when you get hit#White poop has a ↑ {{TearsAB}} Tears up aura and can block damage"},
	...
	{"547", "Divorce Papers", "{{EmptyBoneHeart}} +1 Bone Heart#↑ {{TearsAB}} +0.7 Tears up#{{Trinket21}} Spawns a Mysterious Paper trinket"},
...
EID.descriptions[languageCode].trinkets={
	...
	{"7", "Rosary Bead", "{{AngelRoom}} 50% higher Angel Room chance#{{Collectible33}} Higher chance to find The Bible in {{Shop}} Shops and {{Library}} Libraries"},
	{"8", "Cartridge", "{{Collectible93}} 5% chance for Gamekid effect on hit"},
	{"9", "Pulse Worm", "Pulsating tears#Affects tear hitbox"},
	{"10", "Wiggle Worm", "Tears move in waves#↑ {{TearsAB}} +0.3 Tears up"},
	...
	{"27", "Whip Worm", "↑ {{ShotspeedAB}} +0.5 Shot Speed up"},
	{"28", "Broken Ankh", "{{Player4}} 22% chance to respawn as \"Blue Baby\""},
	...
	{"35", "Curved Horn", "↑ {{DamageAB}} +2 Damage up"},
	...
	{"37", "Goat Hoof", "↑ {{SpeedAB}} +0.15 Speed up"},
	{"38", "Mom's Pearl", "+10% chance for: #{{SoulHeart}} Soul heart#{{BlackHeart}} Black heart and#{{EmptyBoneHeart}} Bone heart"}, -- base chance is 10%
	{"39", "Cancer", "↑ {{TearsAB}} -2 Tear Delay"},
	{"40", "Red Patch", "{{DamageAB}} 20% chance to get +1.8 Damage up when getting hit#{{LuckAB}} 100% chance at 8 Luck#Effect lasts for current room"},
	...
	{"42", "Lucky Toe", "↑ {{LuckAB}} +1 Luck up#+8% room clear reward chance#Extra pickups from chests, tinted rocks, and destroyed machines"},
	...
	{"58", "Samson's Lock", "{{DamageAB}} 1/15 chance for +0.5 Damage up when killing an enemy#{{LuckAB}} 100% chance at 10 Luck#Effect lasts for current room"},
	{"59", "Cain's Eye", "25% chance to reveal map icons at start of new floor#100% chance at 3 Luck"},
	{"60", "Eve's Bird Foot", "{{Collectible117}} 5% chance to spawn a Dead Bird when killing an enemy#{{LuckAB}} 100% chance at 8 Luck"},
	...
	{"65", "Tape Worm", "↑ {{RangeAB}} Doubles your Range#-50% Tear Height"},
	{"66", "Lazy Worm", "↓ {{ShotspeedAB}} -0.4 Shot Speed down#↑ {{RangeAB}} +4 Range up#↑ +2 Tear Height"},
	...
	{"80", "Black Feather", "↑ {{DamageAB}} +0.2 Damage up for each {{DevilRoom}} devil item held"},
...
EID.descriptions[languageCode].cards={
	...
	{"4", "III - The Empress", "For current room grants: #↑ {{DamageAB}} +2.35 Damage up#↑ {{SpeedAB}}  +0.3 Speed up"},
	...
	{"12", "XI - Strength", "For current room grants: #↑ {{Heart}} +1 Health up#↑ {{DamageAB}} +0.3 Damage up#↑ {{DamageAB}} +50% Damage#↑ {{RangeAB}} +5.25 Range up#↑ +0.5 Tear Height#↑ {{SpeedAB}} +0.3 Speed up"},
	{"13", "XII - The Hanged Man", "Grants flight for current room"},
	{"14", "XIII - Death", "Deals 40 damage to all enemies in the room"},
	{"15", "XIV - Temperance", "{{DonationMachine}} Spawns a Blood Donation Machine#{{GreedMode}} / {{GreedierMode}} Spawns a Devil Beggar in Greed Mode"},
	{"16", "XV - The Devil", "↑ {{DamageAB}} +2 Damage up for current room"},
	...
	{"31", "Joker", "{{DevilRoom}} / {{AngelRoom}} Teleports you to the Devil or Angel Room"},
	...
	{"52", "Huge Growth", "↑ {{DamageAB}} +7 Damage up#↑ {{RangeAB}} +30 Range up#Destroy rocks when walking over them#Size up#Effect lasts for current room"},
	{"53", "Ancient Recall", "{{Card}} Spawns 3 random cards when used"},
	{"54", "Era Walk", "{{Slow}} Slow down enemies#↑ {{SpeedAB}} +0.5 Speed up#↓ {{ShotspeedAB}} -1 Shot Speed down#Effect lasts for current room"},
}
...
EID.descriptions[languageCode].pills={
	...
	{"11", "Range Down", "↓ {{RangeAB}} -2 Range down"},
	{"12", "Range Up", "↑ {{RangeAB}} +2.5 Range up"},
	{"13", "Speed Down", "↓ {{SpeedAB}} -0.12 Speed down"},
	{"14", "Speed Up", "↑ {{SpeedAB}} +0.15 Speed up"},
	{"15", "Tears Down", "↓ {{TearsAB}} -0.28 Tears down"},
	{"16", "Tears Up", "↑ {{TearsAB}}  +0.35 Tears up"},
	{"17", "Luck Down", "↓ {{LuckAB}} -1 Luck down"},
	{"18", "Luck Up", "↑ {{LuckAB}} +1 Luck up"},
