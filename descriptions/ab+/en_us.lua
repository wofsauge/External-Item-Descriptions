...
EID.descriptions[languageCode].AdditionalInformations = {
	...
	[C_ID .. 77] = "{VAR:TIMEDEFFECT}#Isaac can't shoot but deals 40 contact damage per second", -- My Little Unicorn
	...
	[C_ID .. 83] = "{VAR:ONUSEEFFECT}#{VAR:ROOMEFFECT}#Isaac deals 40 contact damage per second#Allows Isaac to destroy rocks by walking into them", -- The Nail
	...
	[C_ID .. 93] = "{VAR:TIMEDEFFECT}#Isaac can't shoot but deals 40 contact damage per second#{{HealingRed}} Killing 2 enemies heals half a heart#{{Fear}} Fears all enemies in the room", -- The Gamekid
	...
	[C_ID .. 107] = "{VAR:ROOMEFFECT}#Isaac's body separates from his head and attacks enemies with {VAR:1} contact damage per second", -- The Pinking Shears
	...
	[C_ID .. 254] = "↑ {{Damage}} +1 Damage for the left eye#↑ {{Range}} +{VAR:1} Range for the left eye", -- Blood Clot
	...
	[C_ID .. 298] = "{VAR:TIMEDEFFECT}#Isaac can't shoot (No contact damage)", -- Unicorn Stump
...
local additionalTrinketInformations = {
	...
	[T_ID .. 8] = "{{Timer}} {VAR:LUCKCHANCE}% chance upon taking damage to receive for 6.5 seconds:#Invincibility#Isaac can't shoot but deals 40 contact damage per second#{{HealingRed}} Killing 2 enemies heals half a heart#{{Fear}} Fears all enemies in the room", -- Cartridge
	...
	[T_ID .. 21] = "Randomly grants the effect of: #{{Collectible327}} The Polaroid#{{Collectible328}} The Negative#{{Trinket48}} A Missing Page#{{Trinket23}} Missing Poster", -- Mysterious Paper
	...
	[T_ID .. 33] = "{{Timer}} Spawns {{Collectible100}} Little Steven for the room when Isaac's health is reduced to half a heart", -- Umbilical Cord
	...
	[T_ID .. 67] = "Taking damage has a 50% chance to trigger one of these effects:#{{Collectible105}} D6#{{Collectible406}} D8#{{Collectible386}} D12 #{{Collectible166}} D20", -- Cracked Dice
...
local additionalPillInformations = {
    ...
    [Pill_ID .. 37] = "{VAR:TIMEDEFFECT}#Isaac can't shoot but deals 40 contact damage per second#{{HealingRed}} Killing 2 enemies heals half a heart#{{Fear}} Fears all enemies in the room", -- Power Pill!
    ...
    [Pill_ID .. 46] = "{VAR:TIMEDEFFECT}#Isaac can't shoot (No contact damage)", -- Feels like I'm walking on sunshine!
