...
EID.descriptions[languageCode].collectibles={
	...
	{"152", "Technology 2", "Replaces your right eye with a continuous laser#↓ {{Damage}} -35% Damage down#{{Damage}} Laser deals 20% of your damage"},
	...
	{"213", "Lost Contact", "Shielded tears#Tears block enemy shots#↓ {{Shotspeed}} -0.16 Shot Speed down"},
	...
	{"465", "Analog Stick", "↑ {{Tears}} +0.3 Tears up#Allows you to fire tears diagonally by firing in two directions"},
	...
	{"507", "Sharp Straw", "{{Damage}} Deals your damage + 10% of the enemy's max health#Affects all enemies in the room#{{HalfHeart}} Chance to drop half hearts when it deals damage"},
	...
	{"543", "Hallowed Ground", "Spawn white poop when you get hit#White poop has a ↑ {{Tears}} Tears up aura and can block damage"},
	...
	{"549", "Brittle Bones", "Replaces all your Red Heart containers with 6 Bone Hearts#Upon losing a Bone Heart:#Fires 8 bone tears in all directions#↑ {{Tears}} +0.5 Tears up permanently"},
...
EID.descriptions[languageCode].trinkets={
	...
	{"80", "Black Feather", "↑ {{Damage}} +0.2 Damage up for each {{DevilRoom}} devil item held"},
