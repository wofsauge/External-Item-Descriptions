...
EID.descriptions[languageCode].collectibles={
	...
	{"93", "The Gamekid", "Grants invincibility#{{Fear}} Fears all enemies in the room#Isaac deals 40 contact damage per second#{{HalfHeart}} Killing 2 enemies heals half a heart#{{Timer}} Effect lasts for 6.5 seconds"},
	...
	{"107", "The Pinking Shears", "{{Timer}} Grants flight for the current room#Isaac's body separates from his head and attacks enemies with 82.5 contact damage per second"},
	...
	{"207", "Ball of Bandages", "Lv1: Orbital#{{Charm}} Lv2: Orbital that shoots charmed tears#Lv3: Bandage Girl#Lv4: Super Bandage Girl"},
	...
	{"531", "Haemolacria", "↑ {{Damage}} x1.31 Damage multiplier#↓ {{Tears}} x2 Tear delay#↓ {{Tears}} +10 Tear delay#Isaac's tears fly in an arc and burst into smaller tears on impact"},
...
EID.descriptions[languageCode].cards={
	...
	{"4", "III - The Empress", "{{Timer}} For the current room, grants:#↑ {{Speed}} +0.3 Speed#↑ {{Damage}} +1.5 Damage"},
...
EID.descriptions[languageCode].pills={
	...
	{"36", "Power Pill!", "Grants invincibility#{{Fear}} Fears all enemies in the room#Isaac deals 40 contact damage per second#{{HalfHeart}} Killing 2 enemies heals half a heart#{{Timer}} Effect lasts for 6.5 seconds"},
