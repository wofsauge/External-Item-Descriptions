...
EID.descriptions[languageCode].collectibles={
	...
	{"13", "The Virus", "{{Poison}} Poison enemies on touch#↓ {{Speed}} -0.1 Speed down#{{BlackHeart}} Poisoned enemies can drop Black Hearts"},
	...
	{"295", "Magic Fingers", "Deals 2x Isaac's damage to all enemies#{{Coin}} Costs 1 coin to use"},
	...
	{"323", "Isaac's Tears", "Shoots 8 tears in all directions#Recharges by shooting tears"},
	...
	{"351", "Mega Bean", "Freeze all enemies in the current room#Deals 5 damage and poisons any enemies nearby#Sends a wave of spikes across the room#The spike wave can open secret rooms"},
	...
	{"380", "Pay To Play", "{{Coin}} +5 coins#Single-key doors are opened with coins instead of keys"},
