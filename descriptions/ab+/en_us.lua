...
EID.descriptions[languageCode].collectibles={
	...
	{"118", "Brimstone", "↓ {{Tears}} x3 Tear delay multiplier#{{Chargeable}} Isaac's tears are replaced by a chargeable blood laser"},
	...
	{"218", "Placenta", "↑ {{Heart}} +1 Health#{{HalfHeart}} Chance to heal half a heart every minute"},
	...
	{"275", "Lil Brimstone", "{{Collectible118}} Familiar that charges and shoots a Brimstone laser#Deals 3.5 damage per tick, for a total of 31.5 damage"},
