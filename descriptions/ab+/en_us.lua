...
EID.descriptions[languageCode].cards={
	...
	{"12", "XI - Strength", "{{Timer}} For the current room, grants: #↑ {{Heart}} +1 Health#↑ {{Speed}} +0.3 Speed#↑ {{Damage}} +0.3 Damage#↑ {{Damage}} x1.5 Damage multiplier#↑ {{Range}} +5.25 Range#↑ +0.5 Tear height"},
