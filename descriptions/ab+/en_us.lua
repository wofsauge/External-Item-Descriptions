...
EID.descriptions[languageCode].AdditionalInformations = {
	...
	[C_ID .. 107] = "{{Timer}} Receive for the room:#Flight#Isaac's body separates from his head and attacks enemies with {VAR:1} contact damage per second", -- The Pinking Shears
