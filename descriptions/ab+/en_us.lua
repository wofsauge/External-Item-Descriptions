...
EID.descriptions["en_us"].collectibles={
	...
	{"81", "Dead Cat", "↑ +9 lives#Respawn with 1 Heart#↓ Sets your Red Heart Container count to 1"},
	...
	{"182", "Sacred Heart", "Homing tears#↑ +1 Health up#↑ 230% + 1 Damage up#↓ -0.4 Tears down#↓ -0.25 Shot Speed down#↑ +4.125 Range up#Full Health"},
...
EID.descriptions["en_us"].trinkets={
	...
	{"7", "Rosary Bead", "Higher {{AngelRoom}}Angel Room chances#Higher chance to find {{Collectible33}} The Bible"},
