...
EID.descriptions[languageCode].collectibles={
	...
	{"13", "The Virus", "{{Poison}} #↓ {{Speed}} -0.1 Speed down#{{BlackHeart}} Poisoned enemies can drop Black Hearts"},
	...
	{"77", "My Little Unicorn", "Makes Isaac invincible and grants +0.28 Speed up#Isaac deals 40 contact damage per second while invincible#{{Blank}}#{{Timer}} Effects last 6 seconds"},
	...
	{"93", "The Gamekid", "Grants invincibility#{{Fear}} Fears all enemies in the room#Isaac deals 40 contact damage per second#{{HalfHeart}} Killing 2 enemies replenishes half a heart#{{Blank}}#{{Timer}} Effect lasts for 6.5 seconds"},
	...
	{"111", "The Bean", "{{Poison}} Farts a poison cloud#The poison deals 6 times Isaac's damage"},
	...
	{"128", "Forever Alone", "Fly orbital#Deals 30 contact damage per second"},
	{"129", "Bucket of Lard", "↑ +2 Empty heart container#↓ -0.2 Speed down#Heals half a heart"},
	{"130", "A Pony", "Grants flight while held#{{Speed}} ≥1.5 Speed#Using the item dashes in the direction of Isaac's movement"},
	...
	{"134", "Guppy's Tail", "{{Chest}} 33% chance to replace the room clear reward with a chest#33% chance to cancel the room clear reward"},
	...
	{"177", "Portable Slot", "Removes 1 coin and has a chance to spawn a pickup"},
	...
	{"181", "White Pony", "Grants flight while held#{{Speed}} ≥1.5 Speed#Holy Dash on use"},
	...
	{"202", "Midas' Touch", "Touching enemies turns them gold#Isaac deals contact damage based on his coin count#{{Coin}} Killing a golden enemy drop coins#Poop spawned by Isaac has a high chance to be Golden Poop"},
	...
	{"205", "Sharp Plug", "{{Battery}} Fully recharges the active item#{{Warning}} Deals 2 harts of damage to Isaac#Only works when item has no charges"},
	...
	{"220", "Sad Bombs", "Isaac's bomb fire 10 tears in a circle when they explode#{{Bomb}} +5 Bombs"},
	...
	{"223", "Pyromaniac", "Explosions heal 1 red heart#{{Bomb}} +5 Bombs"},
	...
	{"237", "Death's Touch", "↑ +1.5 Damage up#↑ Tear size up#↓ -0.3 Tears down#Piercing tears"},
	{"238", "Key Piece 1", "{{Warning}} Getting both parts of the key opens a big golden door#{{AngelChance}} 25% higher Angel Room chance"},
	{"239", "Key Piece 2", "{{Warning}} Getting both parts of the key opens a big golden door#{{AngelChance}} 25% higher Angel Room chance"},
	...
	{"256", "Hot Bombs", "{{Burning}} Isaac's bombs light a flame where they explode#{{Bomb}} +5 Bombs"},
	...
	{"260", "Black Candle", "{{CurseBlind}} Prevents curses in all future floors#Removes any curses on pickup#{{BlackHeart}} +1 Black Heart#{{AngelDevilChance}} +15% Devil/Angel Room chance"},
	...
	{"270", "Leech", "{{HalfHeart}} Chases enemies#Heals Isaac for half a heart when it kills an enemy#Deals 3.2 damage per second"},
	...
	{"278", "Dark Bum", "{{Heart}} Picks up Red Hearts from the floor#Spawns a Soul/Black Heart or spider for every 1.5 red heart picked up"},
	...
	{"290", "The Jar", "{{Heart}} Walking over red hearts stores up to 4 of them in the Jar#Using the item drops all stored hearts on the floor"},
	...
	{"295", "Magic Fingers", "Deals 2x Isaac's damage to all enemies#{{Coin}} Removes 1 coin"},
	...
	{"298", "Unicorn Stump", "Invincibility and +0.28 speed up for 6 seconds#Isaac doesn't deal contact damage"},
	...
	{"303", "Virgo", "Taking damage can make Isaac temporarily invincible#{{Pill}} Converts negative pills into positive ones#{{Luck}} 100% chance at 10 Luck"},
	...
	{"323", "Isaac's Tears", "Shoots 8 tears in all directions#Recharged by shooting tears"},
	...
	{"347", "Diplopia", "{{Warning}} SINGLE USE#Duplicates any pedestals and consumables in the current room"},
	...
	{"351", "Mega Bean", "Freeze all enemies in the current room#Deals 5 damage and poisons any enemies nearby#Sends a wave of spikes across the room#Can be used to open secret rooms"},
	{"352", "Glass Cannon", "↓ Reduces Isaac's health down to half a heart#Fires a large piercing spectral tear ((DMG+1) x 10)"},
	...
	{"364", "Friend Zone", "Orbital#Deals 45 contact damage per second"},
	...
	{"371", "Curse of the Tower", "Taking damge spawns 6 troll bombs#The troll bombs inherit Isaac's bomb effects"},
	...
	{"375", "Host Hat", "Isaac is immune to explosions and stomps from Mom and Satan's feet#20% chance to reflect enemy shots"},
	...
	{"387", "Censer", "Is surrounded by a huge aura of light that slows down enemies and projectiles in it"},
	...
	{"400", "Spear of Destiny", "Isaac holds a spear in front of him#The spears deals twice his damage and can fear enemies on contact"},
	...
	{"406", "D8", "Rerolls Isaac's damage, tears, range and speed stats"},
	...
	{"409", "Empty Vessel", "{{BlackHeart}} +2 Black Hearts#{{Blank}}#{{Blank}} When Isaac has no Red Hearts:#Grants flight#Every 40 seconds while in a hostile room, gain a shield for 10 seconds"},
	...
	{"412", "Cambion Conception", "Taking damage 15 times spawns a permanent demon familiar#Caps at 4 familiars"},
	...
	{"415", "Crown Of Light", "{{SoulHeart}} +2 Soul Hearts#{{Blank}}#{{Blank}} If Isaac has no damaged Red Heart containers:#↑ {{Damage}} +100% Damage up#↑ {{Range}} +5.25 Range up#↑ +0.5 Tear Height#↓ {{Shotspeed}} -0.3 Shot Speed down#{{Blank}}#Taking any damage removes the effect for the current room"},
	...
	{"437", "D7", "Respawns all enemies to get another room clear reward#If used in a Greed fight, can reroll the room into a Shop"},
	...
	{"444", "Lead Pencil", "Isaac fires a cluster of tears every 15 tears#Tears in the cluster deals double damage"},
	{"445", "Dog Tooth", "↑ {{Damage}} +0.3 Damage up#↑ {{Speed}} +0.1 Speed up#{{SecretRoom}} A wolf howls in rooms adjacent to a Secret/Super Secret Room#{{LadderRoom}} A barking sound plays in rooms with a crawlspace under a rock"},
	...
	{"450", "Eye of Greed", "Every 20 tears, Isaac shoots a coin tear that deals double damage#Enemies hit with the coin turn into gold#Killing a gold enemy drops 1-4 coins#Firing a coin tear removes 1 coin"},
	...
	{"468", "Shade", "Follows Isaac's movement on a  1 second delay#Deals 30 contact damage per second"},
	...
	{"473", "Big Chubby", "Very slowly charges forwards#Deals 40.5 contact damage per second"},
	{"474", "Tonsil", "Blocks enemy projectiles"},
	{"475", "Plan C", "{{Warning}} SINGLE USE#Deals 9,999,999 damage to all enemies#Kills Isaac 3 seconds later"},
	...
	{"481", "Dataminer", "When used, ↑/↓ small amount on random stat#Random tear effect for the room#Corrupts all sprites and music in the room"},
	{"482", "Clicker", "Rerolls the character#Removes the last item collected"},
	{"483", "Mama Mega!", "{{Warning}} SINGLE USE#Affects the whole floor#Explodes all objects#Deals 200 damage to all enemies#Opens the door to Boss Rush, Hush and all secret rooms#Having a Gold Bomb when using the item consumes it and allows for another use of Mama Mega"},
	{"484", "Wait What?", "Upon use, pushes enemies away and spawns a rock wave#Can open rooms and break rocks"},
	...
	{"487", "Potato Peeler", "Removes one Red Heart Container and grants: #↑ {{Damage}} +0.2 Damage up#{{Collectible73}} A Cube of Meat#↑ {{Range}} +5 Range and leaves a trail of blood creep for the current room"},
	{"488", "Metronome", "Grants a random item effect for the current room"},
	{"489", "D Infinity", "Triggers a random dice effect each use"},
	{"490", "Eden's Soul", "{{Warning}} SINGLE USE#Spawns 2 random items depending on the current room's item pool#Starts with no charges"},
	...
	{"501", "Greed's Gullet", "Gain 1 Heart Container for every 25 coins picked up after getting Greed's Gullet#{{Player14}} Keeper can gain additional Coin Hearts"},
	...
	{"520", "Jumper Cables", "Kiling 15 enemies adds 1 charge to the active item"},
	{"521", "Coupon", "Makes one random item in the {{Shop}} Shop or {{DevilRoom}} Devil Room free#{{Shop}} Holding the item guarantees one Shop item is on sale"},
	{"522", "Telekinesis", "Stops all enemy projectiles that come close to Isaac for 3 seconds and throws them away from him"},
	...
	{"532", "Lachryphagy", "Isaac's tears progressively slow down, stop, then explode into 8 smaller tears#Tears merge and become bigger"},
	{"533", "Trisagion", "Replaces Isaac's tears with piercing beams of light#{{Damage}} The beams deal 33% damage but can hit enemies multiple times"},
...
EID.descriptions[languageCode].trinkets={
	...
	{"14", "Callus", "Grants immunity to creep and spikes"},
	...
	{"40", "Red Patch", "{{Damage}} Taking damage has a 20% chance to grant +1.8 Damage up#{{Luck}} 100% chance at 8 Luck#{{Blank}}#{{Timer}} Effect lasts for the current room"},
	...
	{"58", "Samson's Lock", "{{Damage}} Killing an enemy has a 1/15 chance to grant +0.5 Damage up#{{Luck}} 100% chance at 10 Luck#{{Blank}}#{{Timer}} Effect lasts for the current room"},
	...
	{"96", "Ouroboros Worm", "Isaac's ears move quickly in a spiral pattern#Spectral tears#↑ {{Range}} +4 Range up#↑ +2 Tear Height"},
	...
	{"100", "Vibrant Bulb", "{{Warning}} Holding a fully charged active item grants:#↑ {{Damage}} +0.5 Damage#↑ {{Speed}} +0.25 Speed#↑ {{Range}} +0.75 Range#↑ {{Tears}} +0.2 Tears#↑ {{Shotspeed}} +0.1 Shot speed#↑ {{Luck}} +1 Luck"},
	...
	{"107", "Crow Heart", "Taking damage depletes red hearts before soul/black hearts#Red heart damage does not reduce devil deal chances"},
	...
	{"114", "Locust of Pestilence", "Entering a hostile room spawn a poison attack fly#The fly deals twice Isaac's damage"},
	{"115", "Locust of Famine", "Entering a hostile room spawn a slowing attack fly#The fly deals twice Isaac's damage"},
	{"116", "Locust of Death", "Entering a hostile room spawn an attack fly#The fly deals 4 times Isaac's damage"},
...
EID.descriptions[languageCode].cards={
	...
	{"37", "Perthro", "Rerolls all pedestal items"},
	...
	{"43", "Credit Card", "Makes all items and pickups in a {{Shop}} shop or {{DevilRoom}} Devil deal free"},
	...
	{"52", "Huge Growth", "↑ {{Damage}} +7 Damage up#↑ {{Range}} +30 Range up#Allows Isaac to destroy rocks by walking into them#Size up#{{Blank}}#{{Timer}} Effect lasts for one room"},
	{"53", "Ancient Recall", "{{Card}} Spawns 3 random cards"},
	{"54", "Era Walk", "{{Slow}} Slow down enemies#↑ {{Speed}} +0.5 Speed up#↓ {{Shotspeed}} -1 Shot Speed down#{{Blank}}#{{Timer}} Effect lasts for one room"},
}
...
EID.descriptions[languageCode].pills={
	...
	{"42", "I'm Excited{{Warning}}", "Speeds up all enemies in the room"},
...
EID.descriptions[languageCode].sacrifice={
	{"1", "", "{{Coin}} 1 coin {{ColorSilver}}(50% chance)#Nothing {{ColorSilver}}(50% chance)#{{Blank}}#{{Bomb}} 1 Bomb {{ColorSilver}}(100% chance on B1 if the boss has been killed under 1 minute)"},
	{"2", "", "{{Coin}} 1 coin {{ColorSilver}}(50% chance)#Nothing {{ColorSilver}}(50% chance)#{{Blank}}#{{Bomb}} 1 Bomb {{ColorSilver}}(100% chance on B1 if the boss has been killed under 1 minute)"},
	{"3", "", "{{AngelChance}} Increased Angel Room chance {{ColorSilver}}(67% chance)#Nothing {{ColorSilver}}(33% chance)"},
	{"4", "", "{{Chest}} 1 random chest {{ColorSilver}}(50% chance)#Nothing {{ColorSilver}}(50% chance)"},
	{"5", "", "{{Coin}} 3 coins {{ColorSilver}}(33% chance)#{{AngelChance}} Increased Angel Room chance {{ColorSilver}}(67% chance)"},
	{"6", "", "{{AngelRoom}} Teleportation to the Angel Room {{ColorSilver}}(33% chance)#{{DevilRoom}} (Teleports to the Devil Room instead if its door was spawned on the current floor)#{{Chest}} Random chest {{ColorSilver}}(67% chance)"},
	{"7", "", "{{AngelRoom}} 1 random Angel Room item {{ColorSilver}}(33% chance)#{{SoulHeart}} 1 Soul Heart {{ColorSilver}}(67% chance)"},
	{"8", "", "7 troll bombs {{ColorSilver}}(100% chance)"},
	{"9", "", "Spawns \"Uriel\" {{ColorSilver}}(100% chance)"},
	{"10", "", "{{SoulHeart}} 7 Soul Hearts {{ColorSilver}}(50% chance)#{{Coin}} 30 coins {{ColorSilver}}(50% chance)"},
	{"11", "", "Spawns \"Gabriel\" {{ColorSilver}}(100% chance)"},
	{"12", "", "Teleportation to the \"Dark Room\" {{ColorSilver}}(50% chance)#Nothing {{ColorSilver}}(50% chance)"},
}
