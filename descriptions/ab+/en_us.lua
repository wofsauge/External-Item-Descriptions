...
EID.descriptions[languageCode].collectibles={
	...
	{"52", "Dr. Fetus", "↓ {{Tears}} x2.5 Tear delay multiplier#{{Bomb}} Isaac shoots bombs instead of tears#Those bombs deal 5x Isaac's tear damage + 30"},
	...
	{"96", "Little C.H.A.D.", "{{HalfHeart}} Spawns half a heart every 3 rooms"},
	...
	{"152", "Technology 2", "↓ {{Tears}} x2 Tear delay multiplier#↓ {{Damage}} x0.65 Damage multiplier#Replaces Isaac's right eye tears with a continuous laser#The laser deals 20% of Isaac's damage per tick"},
	...
	{"225", "Gimpy", "{{SoulHeart}} Taking damage has a chance to spawn a Soul Heart#{{HalfHeart}} Enemies have a chance to drop half a Red Heart on death"},
	...
	{"331", "Godhead", "↑ {{Damage}} +0.5 Damage#↑ {{Range}} +1.2 Range#↑ +0.8 Tear height#↓ {{Tears}} -0.3 Tears#↓ {{Shotspeed}} -0.3 Shot speed#Homing tears#{{Damage}} Tears gain an aura that deals 450% of Isaac's damage per second"},
	...
	{"417", "Succubus", "Bounces around the room surrounded by a damaging aura that deals 129% of Isaac's damage per second#↑ {{Damage}} x1.5 Damage multiplier while standing in the aura"},
	...
	{"459", "Sinus Infection", "20% chance to shoot a sticky booger#Boogers deal Isaac's damage once a second and stick for 60 seconds#{{Luck}} Not affected by luck"},
	...
	{"508", "Mom's Razor", "{{BleedingOut}} Orbital that causes bleeding, which deals 10% damage of the enemy's max health every 5 seconds#Deals 300% of Isaac's damage per second#Does not block shots"},
...
EID.descriptions[languageCode].trinkets={
	...
	{"20", "Monkey Paw", "{{BlackHeart}} Spawns 1 Black Heart when Isaac's health gets down to half a heart#!!! Disappears after spawning 3 Black Hearts"},
	...
	{"49", "Bloody Penny", "{{HalfHeart}} Picking up a coin has a 50% chance to spawn half a heart"},
	...
	{"114", "Locust of Pestilence", "{{Poison}} Entering a hostile room spawns a poison attack fly#The fly deals twice Isaac's damage"},
	{"115", "Locust of Famine", "{{Slow}} Entering a hostile room spawns a slowing attack fly#The fly deals twice Isaac's damage"},
