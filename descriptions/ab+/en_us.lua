...
EID.descriptions["en_us"].collectibles={
	...
	{"46", "Lucky Foot", "↑ +1 Luck up#Better chance to win while gambling#Increases room clearing drop chance"},
	...
	{"415", "Crown of Light", "+2 Soul Hearts#↑ Damage x 2 if you don't have any damaged Red Heart containers#Deactivates for the current room when damaged at all"},
...
EID.descriptions["en_us"].trinkets={
	...
	{"5", "Purple Heart", "Doubles the chance for champion enemies"},
	{"6", "Broken Magnet", "Coin magnet"},
	{"7", "Rosary Bead", "Higher {{AngelRoom}}Angel Room chance#Higher chance to find {{Collectible33}}The Bible"},
	...
	{"34", "Child's Heart", "More Red Hearts appear"},
