...
EID.descriptions[languageCode].collectibles={
	...
	{"33", "The Bible", "{{Timer}} Grants flight for the current room#{{MomsHeart}} Kills Mom's Foot and Mom's Heart instantly#!!! Kills Isaac when used on Satan"},
	{"34", "The Book of Belial", "{{AngelDevilChance}} +12.5% Devil/Angel Room chance while held#{{Timer}} Receive for the current room:#↑ {{Damage}} +2 Damage#{{Collectible7}} x1.5 Damage multiplier if Isaac has Blood of the Martyr"},
	...
	{"39", "Mom's Bra", "Petrifies all enemies in the current room for 4 seconds"},
	...
	{"58", "Book of Shadows", "{{Timer}} Makes Isaac invincible for 10 seconds"},
	...
	{"77", "My Little Unicorn", "{{Timer}} Receive for 6 seconds:#↑ {{Speed}} +0.28 Speed#Invincibiliy#Isaac can't shoot but deals 40 contact damage per second"},
	...
	{"81", "Dead Cat", "↑ +9 Lives#Isaac respawns with 1 heart container on death#!!! Sets Isaac's heart containers to 1 when picked up#Characters that can't have Red Hearts get set to 1 Soul/Black Heart"},
	{"82", "Lord of the Pit", "↑ {{Speed}} +0.3 Speed#Flight"},
	{"83", "The Nail", "{{SoulHeart}} +1 Soul Heart#{{Timer}} Receive for the current room:#↑ {{Damage}} +0.7 Damage#↓ {{Speed}} -0.18 Speed#Isaac deals 40 contact damage per second#Allows Isaac to destroy rocks by walking into them"},
	...
	{"86", "Monstro's Tooth", "Monstro falls on an enemy and deals 120 damage#!!! Monstro falls on Isaac if the room has no enemies"},
	...
	{"107", "The Pinking Shears", "{{Timer}} Receive for the current room:#Flight#Isaac's body separates from his head and attacks enemies with 82.5 contact damage per second"},
	...
	{"114", "Mom's Knife", "Isaac's tears are replaced by a throwable knife#{{Damage}} The knife deals 2x Isaac's damage while held and 6x damage at the furthest possible distance"},
	{"115", "Ouija Board", "Spectral tears"},
	{"116", "9 Volt", "{{Battery}} Automatically charges the first bar of active items#{{Battery}} Fully recharges the current active item on pickup"},
	...
	{"123", "Monster Manual", "{{Timer}} Spawns a random familiar for the current room"},
	{"124", "Dead Sea Scrolls", "Triggers a random active item effect"},
	{"125", "Bobby-Bomb", "{{Bomb}} +5 Bombs#Homing bombs"},
	{"126", "Razor Blade", "↑ {{Damage}} +1.2 Damage for the current room#!!! Deals 1 heart of damage to Isaac#{{Heart}} Removes Red Hearts first"},
	{"127", "Forget Me Now", "!!! SINGLE USE !!!#Rerolls and restarts the entire floor"},
	...
	{"130", "A Pony", "{{Speed}} Sets your Speed to at least 1.5#Grants flight while held#Using the item dashes in the direction of Isaac's movement"},
	...
	{"158", "Crystal Ball", "Spawns a {{SoulHeart}} Soul Heart, {{Rune}} rune or {{Card}} card#{{Timer}} Full mapping effect for the current floor (except {{SuperSecretRoom}} Super Secret Room)"},
	...
	{"181", "White Pony", "{{Speed}} Sets your Speed to at least 1.5#Grants flight while held#Using the item dashes in the direction of Isaac's movement, leaving behind beams of light"},
	...
	{"186", "Blood Rights", "Deals 40 damage to every enemy#!!! Deals 1 heart of damage to Isaac#{{Heart}} Removes Red Hearts first"},
	...
	{"192", "Telepathy For Dummies", "{{Timer}} Grants homing tears for the current room"},
	...
	{"201", "Iron Bar", "↑ {{Damage}} +0.3 Damage#{{Confusion}} 10% chance to shoot concussive tears"},
	...
	{"217", "Mom's Wig", "{{Heart}} Heals 1 heart#Shooting tears has a random chance to spawn a blue spider"},
	...
	{"223", "Pyromaniac", "{{Bomb}} +5 Bombs#{{Heart}} Getting hit by explosions heals 1 heart instead of damaging Isaac#Grants immunity to rock wave attacks and Mom and Satan's stomp attacks"},
	...
	{"228", "Mom's Perfume", "↑ {{Tears}} -1 Tear delay#{{Fear}} 15% chance to shoot fear tears#{{Luck}} 100% chance at 85 luck"},
	{"229", "Monstro's Lung", "↓ {{Tears}} x4.3 Tear delay multiplier#{{Chargeable}} Tears are charged and released in a shotgun style attack"},
	{"230", "Abaddon", "↑ {{Speed}} +0.2 Speed#↑ {{Damage}} +1.5 Damage#↓ {{EmptyHeart}} Removes all heart containers#{{BlackHeart}} +6 Black Hearts#{{Fear}} 15% chance to shoot fear tears#{{Luck}} 100% chance at 85 luck"},
	...
	{"238", "Key Piece 1", "!!! Getting both parts of the key opens a big golden door#{{AngelChance}} +25% Angel Room chance#{{EternalHeart}} +2% chance for Eternal Hearts"},
	{"239", "Key Piece 2", "!!! Getting both parts of the key opens a big golden door#{{AngelChance}} +25% Angel Room chance#{{EternalHeart}} +2% chance for Eternal Hearts"},
	...
	{"257", "Fire Mind", "{{Burning}} Isaac's tears light enemies on fire#Chance for tears to explode on enemy impact#{{Luck}} 100% chance to explode at 13 luck#!!! The explosion can hurt Isaac"},
	...
	{"287", "Book of Secrets", "{{Timer}} Receive one of these effects for the current floor:#{{Collectible54}} Treasure Map#{{Collectible21}} Compass#{{Collectible246}} Blue Map"},
	...
	{"316", "Cursed Eye", "Charged wave of 4 tears#!!! Taking damage while partially charged teleports Isaac to a random room#{{Collectible260}} Black Candle removes the teleportation effect"},
	...
	{"325", "Scissors", "{{Timer}} Isaac's head turns into a stationary familiar for the current room#The body is controlled separately"},
	{"326", "Breath of Life", "Holding down the USE button empties the charge bar#Isaac is temporarily invincible when the charge bar is empty#!!! Holding it for too long deals damage to Isaac"},
	...
	{"347", "Diplopia", "!!! SINGLE USE !!!#Duplicates all item pedestals and consumables in the current room"},
	...
	{"351", "Mega Bean", "Petrifies all enemies in the current room#{{Poison}} Deals 5 damage and poisons any enemies nearby#Sends a rock wave in the direction Isaac is moving#The rock wave can open secret rooms and break rocks"},
	{"352", "Glass Cannon", "!!! Firing the cannon reduces Isaac's health down to half a heart#Shoots a large piercing + spectral tear that does 10x Isaac's damage"},
	...
	{"357", "Box of Friends", "{{Timer}} Receive for the current room:#A dublication of every familiar#{{Collectible113}} A Demon Baby if Isaac has no familiars"},
	...
	{"374", "Holy Light", "10% chance to shoot holy tears, which spawn a beam of light on hit#{{Damage}} The beam deals 4x Isaac's damage#{{Luck}} 50% chance at 9 luck"},
	...
	{"388", "Key Bum", "{{Key}} Picks up keys and spawns random chests"},
	...
	{"409", "Empty Vessel", "{{BlackHeart}} +2 Black Hearts#{{Blank}} When Isaac has no Red Hearts:#Flight#Every 40 seconds while in a hostile room, gain a shield for 10 seconds"},
	{"410", "Evil Eye", "3.33% chance to shoot an eye#The eye moves in a straight line and shoots tears in the same direction as Isaac"},
	...
	{"415", "Crown Of Light", "{{SoulHeart}} +2 Soul Hearts#{{Blank}} If Isaac has no damaged Red Heart containers:#↑ {{Damage}} x2 Damage multiplier#↑ {{Range}} +5.25 Range#↑ +0.5 Tear height#↓ {{Shotspeed}} -0.3 Shot speed#Taking any damage removes the effect for the current room"},
	...
	{"428", "PJs", "Full health#{{SoulHeart}} +4 Soul Hearts"},
	...
	{"448", "Shard of Glass", "Upon taking damage:#{{Heart}} 25% chance to spawn a Red Heart#{{Collectible214}} 10% chance to get ↑ {{Range}} +5 Range and leave a trail of blood creep for the current room"},
	{"449", "Metal Plate", "{{SoulHeart}} +1 Soul Heart#{{Confusion}} Enemy bullets have a 25% chance to be reflected as concussive tears"},
	{"450", "Eye of Greed", "Every 20 tears, Isaac shoots a coin tear that deals double damage#Enemies hit with the coin get petrified and turn into gold#{{Coin}} Killing a gold enemy drops 1-4 coins#!!! Firing a coin tear costs 1 coin"},
	...
	{"475", "Plan C", "!!! SINGLE USE !!!#Deals 9,999,999 damage to all enemies#!!! Kills Isaac 3 seconds later"},
	...
	{"481", "Dataminer", "↑ Random stat up#↓ Random stat down#{{Timer}} Random tear effect for the current room#{{Timer}} Corrupts all sprites and music in the room"},
	{"482", "Clicker", "Changes your character to a random character#Removes the most recent item collected"},
	{"483", "Mama Mega!", "!!! SINGLE USE !!!#Affects the whole floor#Explodes all objects#Deals 200 damage to all enemies#Opens the door to Boss Rush, Hush and all secret rooms#Having a Golden Bomb when using the item consumes it and allows for another use of Mama Mega"},
	...
	{"487", "Potato Peeler", "Removes 1 heart container for:#↑ {{Damage}} +0.2 Damage#{{Collectible73}} A Cube of Meat#{{Timer}} Receive for the current room:#↑ {{Range}} +5 Range#{{Collectible214}} Leave a trail of blood creep"},
	...
	{"493", "Adrenaline", "For every empty Red Heart container:#↑ {{Damage}} +0.2 Damage"},
	...
	{"510", "Delirious", "{{Timer}} Spawns a friendly delirium version of a boss for the current room"},
	...
	{"536", "Sacrificial Altar", "!!! SINGLE USE !!!#Sacrifices up to 2 familiars and spawns a devil item for each sacrifice#{{Coin}} Turns blue spiders/flies into coins"},
	...
	{"550", "Broken Shovel", "Mom's Foot constantly tries to stomp Isaac#Using the item stops the stomping for the room#!!! (Try to beat Boss Rush with it!)"},
	{"551", "Broken Shovel", "Completes Mom's Shovel#!!! Use the shovel on the mound of dirt in the \"Dark Room\""},
	{"552", "Mom's Shovel", "Spawns a trapdoor to the next floor#10% chance for {{LadderRoom}} crawlspace trapdoor#!!! Use the shovel on the hill of dirt in the \"Dark Room\""},
}
...
EID.descriptions[languageCode].trinkets={
	...
	{"5", "Purple Heart", "2x chance for champion enemies#Champion enemies have a chance to drop pickups"},
	...
	{"8", "Cartridge", "{{Timer}} 5% chance upon taking damage to receive for 6.5 seocnds:#Invincibility#Isaac can't shoot but deals 40 contact damage per second#{{HalfHeart}} Killing 2 enemies heals half a heart#{{Fear}} Fears all enemies in the room"},
	...
	{"20", "Monkey Paw", "{{BlackHeart}} Spawns 1 Black Heart when Isaac's health is reduced to half a heart#!!! Disappears after spawning 3 Black Hearts"},
	...
	{"33", "Umbilical Cord", "{{Timer}} Spawns {{Collectible100}} Little Steven for the current room when Isaac's health is reduced to half a heart"},
	...
	{"40", "Red Patch", "{{Timer}} Taking damage has a 20% chance to grant ↑ {{Damage}} +1.8 damage for the current room#{{Luck}} 100% chance at 8 luck"},
	...
	{"53", "Tick", "{{Heart}} Heals 1 heart when entering a {{BossRoom}} Boss Room#-15% boss health#!!! Once picked up, it can't be removed#Only removeable with {{Trinket41}} Match Stick or gulping"},
	...
	{"58", "Samson's Lock", "{{Timer}} Killing an enemy has a 1/15 chance to grant ↑ {{Damage}} +0.5 damage for the current room#{{Luck}} 100% chance at 10 luck"},
	...
	{"118", "Bat Wing", "{{Timer}} Killing an enemy has a 5% chance to grant flight for the current room"},
...
EID.descriptions[languageCode].cards={
	...
	{"2", "I - The Magician", "{{Timer}} Grants homing tears for the current room"},
	{"3", "II - The High Priestess", "Mom's Foot stomps on an enemy#Mom's Foot stomps Isaac if there are no enemies"},
	{"4", "III - The Empress", "{{Timer}} Receive for the current room:#↑ {{Speed}} +0.3 Speed#↑ {{Damage}} +1.5 Damage"},
	...
	{"12", "XI - Strength", "{{Timer}} Receive for the current room:#↑ {{Heart}} +1 Health#↑ {{Speed}} +0.3 Speed#↑ {{Damage}} +0.3 Damage#↑ {{Damage}} x1.5 Damage multiplier#↑ {{Range}} +5.25 Range#↑ +0.5 Tear height"},
	{"13", "XII - The Hanged Man", "{{Timer}} Grants flight for the current room"},
	...
	{"16", "XV - The Devil", "{{Timer}} Receive for the current room:#↑ {{Damage}} +2 Damage"},
	...
	{"35", "Dagaz", "{{SoulHeart}} +1 Soul Heart#{{CurseCursed}} Removes all curses for the current floor"},
	...
	{"49", "Dice Shard", "Rerolls all item pedestals and pickups in the current room"},
	{"50", "Emergency Contact", "Two of Mom's Hands come down and grab an enemy each"},
	{"51", "Holy Card", "{{HolyMantle}} Grants a Holy Mantle shield for the current room#(prevents damage once)#25% chance to spawn another Holy Card"},
	{"52", "Huge Growth", "{{Timer}} Receive for the current room:#↑ {{Damage}} +7 Damage#↑ {{Range}} +30 Range#Size up#Allows Isaac to destroy rocks by walking into them"},
	{"53", "Ancient Recall", "{{Card}} Spawns 3 random cards"},
	{"54", "Era Walk", "{{Timer}} Receive for the current room:#↑ {{Speed}} +0.5 Speed#↓ {{Shotspeed}} -1 Shot speed#{{Slow}} Slow down enemies"},
}
...
EID.descriptions[languageCode].pills={
	...
	{"21", "Hematemesis", "{{EmptyHeart}} Drains all but one heart container#{{Heart}} Spawns 1-4 Red Hearts"},
	...
	{"25", "Amnesia", "{{CurseLost}} Hides the map for the current floor"},
	...
	{"28", "Percs!", "{{Timer}} Reduces all damage taken to half a heart for the current room"},
	{"29", "Addicted!", "{{Timer}} Increases all damage taken to a full heart for the current room"},
