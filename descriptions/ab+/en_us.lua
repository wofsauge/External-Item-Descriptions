...
EID.descriptions[languageCode].collectibles={
	...
	{"437", "D7", "Respawns all enemies in the room#Can be used to get another room clear reward#If used after a Greed fight, rerolls the room into a Shop/Secret Room"},
	...
	{"483", "Mama Mega!", "{{Warning}} SINGLE USE#Affects the whole floor#Explodes all objects#Deals 200 damage to all enemies#Opens the door to Boss Rush, Hush and all secret rooms#Having a Golden Bomb when using the item consumes it and allows for another use of Mama Mega"},
	...
	{"515", "Mystery Gift", "{{Warning}} SINGLE USE#Spawns a random item from the current room's item pool#Chance to spawn Lump of Coal or The Poop instead"},
	...
	{"536", "Sacrificial Altar", "{{Warning}} SINGLE USE#Sacrifices up to 2 familiars and spawns a Devil item for each sacrifice#Turns blue spiders/flies into coins"},
