...
EID.descriptions[languageCode].collectibles={
	...
	{"34", "The Book of Belial", "↑ +2 Damage up#↑ {{AngelDevilChance}} +12.5% Devil/Angel Room chance"},
	...
	{"78", "Book of Revelations", "{{SoulHeart}} +1 Soul Heart#Higher horsemen chance if used#↑ {{AngelDevilChance}} +17.5% Devil/Angel Room chance"},
	...
	{"260", "Black Candle", "{{CurseCursed}} Immunity to Curses#{{BlackHeart}} +1 Black Heart#↑ {{AngelDevilChance}} +15% Devil/Angel Room chance"},
	...
	{"498", "Duality", "{{AngelDevilChance}} Spawns Devil AND Angel Room doors#When entering one, the other disappears"},
