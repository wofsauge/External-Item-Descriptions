...
EID.descriptions[languageCode].collectibles={
	...
	{"7", "Blood of the Martyr", "↑ {{Damage}} +1 Damage#{{Collectible34}} x1.5 Damage if Isaac has The Book of Belial or The Devil card effect active"},
	...
	{"33", "The Bible", "{{Timer}} Receive for the current room:#Flight#{{MomsHeart}} Kills Mom's Foot and Mom's Heart instantly#!!! Kills Isaac when used on Satan"},
	{"34", "The Book of Belial", "{{AngelDevilChance}} +12.5% Devil/Angel Room chance while held#{{Timer}} Receive for the current room:#↑ {{Damage}} +2 Damage#{{Collectible7}} x1.5 Damage if Isaac has Blood of the Martyr"},
	...
	{"52", "Dr. Fetus", "↓ {{Tears}} x2.5 Tear delay#{{Bomb}} Isaac shoots bombs instead of tears#Those bombs deal 5x Isaac's tear damage + 30"},
	...
	{"58", "Book of Shadows", "{{Timer}} Receive for 10 seconds:#Invincibility"},
	...
	{"106", "Mr. Mega", "↑ {{Bomb}} x2.25 Bomb damage#{{Bomb}} +5 Bombs"},
	...
	{"110", "Mom's Contacts", "↑ {{Range}} +0.25 Range#↑ +0.5 Tear height#20% chance to shoot petrifying tears"},
	...
	{"120", "Odd Mushroom (Thin)", "↑ {{Speed}} +0.3 Speed#↑ {{Tears}} +1.7 Tears#↓ {{Damage}} x0.9 Damage#↓ {{Damage}} -0.4 Damage"},
	...
	{"123", "Monster Manual", "{{Timer}} Receive for the current room:#A random familiar"},
	{"124", "Dead Sea Scrolls", "Triggers a random active item effect"},
	{"125", "Bobby-Bomb", "{{Bomb}} +5 Bombs#Homing bombs"},
	{"126", "Razor Blade", "{{Timer}} Receive for the current room:#↑ {{Damage}} +1.2 Damage#!!! Deals 1 heart of damage to Isaac#{{Heart}} Removes Red Hearts first"},
	...
	{"152", "Technology 2", "↓ {{Tears}} x2 Tear delay#↓ {{Damage}} x0.65 Damage multiplier#Replaces Isaac's right eye tears with a continuous laser#The laser deals 20% of Isaac's damage per tick"},
	...
	{"158", "Crystal Ball", "Spawns a {{SoulHeart}} Soul Heart or a {{Card}} card#{{Timer}} Receive for the current floor:#Full mapping effect (except {{SuperSecretRoom}} Super Secret Room)"},
	...
	{"169", "Polyphemus", "↑ {{Damage}} +4 Damage#↑ {{Damage}} x2 Damage multiplier#↓ {{Tears}} Tears down#Tears keep going after killing an enemy"},
	...
	{"186", "Blood Rights", "Deals 40 damage to every enemy#!!! Deals 1 heart of damage to Isaac#Removes Red Hearts first"},
	...
	{"192", "Telepathy For Dummies", "{{Timer}} Receive for the current room:#Homing tears"},
	...
	{"206", "Guillotine", "↑ {{Tears}} -1 Tear delay#↑ {{Damage}} +1 Damage#Isaac's head becomes an orbital that shoots, doesn't take damage and deals 105 contact damage"},
	...
	{"214", "Anemic", "↑ {{Range}} +5 Range#{{Timer}} When taking damage receive for the current room:#A trail of blood creep"},
	...
	{"224", "Cricket's Body", "↑ {{Tears}} +1 Tears#↓ {{Range}} -10 Range#Tears split up in 4 on hit#Split tears deal half damage"},
	...
	{"228", "Mom's Perfume", "↑ {{Tears}} +1 Tears#{{Fear}} 15% chance to shoot fear tears"},
	{"229", "Monstro's Lung", "↓ {{Tears}} x4.3 Tear delay#{{Chargeable}} Tears are charged and released in a shotgun style attack"},
	{"230", "Abaddon", "↑ {{Speed}} +0.2 Speed#↑ {{Damage}} +1.5 Damage#↓ {{EmptyHeart}} Removes all heart containers#{{BlackHeart}} +6 Black Hearts#{{Fear}} Fear tears"},
	...
	{"254", "Blood Clot", "↑ {{Damage}} +1 Damage for the left eye#↑ {{Range}} +5 Range for the left eye"},
	...
	{"295", "Magic Fingers", "Deals 2x Isaac's damage to all enemies#!!! Costs 1 coin to use"},
	...
	{"309", "Pisces", "↑ {{Tears}} -1 Tear delay#↑ {{Tearsize}} x1.25 Tear size#Increases knockback"},
	{"310", "Eve's Mascara", "↑ {{Damage}} x2 Damage multiplier#↓ {{Tears}} x0.5 Tears#↓ {{Shotspeed}} -0.5 Shot speed"},
	...
	{"325", "Scissors", "{{Timer}} Receive for the current room:#Isaac's head turns into a stationary familiar#The body is controlled separately"},
	...
	{"330", "Soy Milk", "↑ {{Tears}} Tears up: (delay/4)-2#↓ {{Damage}} x0.2 Damage#↓ {{Tearsize}} x0.5 Tear size"},
	{"331", "Godhead", "↑ {{Damage}} +0.5 Damage#↑ {{Range}} +1.2 Range#↑ +0.8 Tear height#↓ {{Tears}} -0.3 Tears#↓ {{Shotspeed}} -0.3 Shot speed#Homing tears#Tears gain a damaging aura"},
	...
	{"354", "Crack Jacks", "↑ {{Heart}} +1 Health#{{Trinket}} Spawns a random trinket"},
	...
	{"370", "Mr. Dolly", "↑ {{Tears}} +0.7 Tears#↑ {{Range}} +5.25 Range#↑ +0.5 Tear height#{{UnknownHeart}} Spawns 3 random hearts when picked up"},
	...
	{"417", "Succubus", "Bounces around the room surrounded by a damaging aura that deals 129% of Isaac's damage every second#↑ {{Damage}} x1.5 Damage multiplier while standing in the aura"},
	...
	{"441", "Mega Blast", "{{Timer}} Receive for 15 seconds:#A huge Mega Satan blood laser that automatically shoots"},
	...
	{"448", "Shard of Glass", "Upon taking damage:#{{Heart}} 25% chance to spawn a Red Heart#{{Timer}} 10% chance to receive for the current room:#↑ {{Range}} +5 Range#{{Collectible214}} A trail of blood creep"},
	...
	{"451", "Tarot Cloth", "{{Card}} Spawns a card#{{Card}} Card effects are doubled"},
	...
	{"481", "Dataminer", "↑ Random stat up#↓ Random stat down#{{Timer}} Receive for the current room:#A random tear effect#Corrupts all sprites and music"},
	...
	{"487", "Potato Peeler", "Removes 1 heart container for:#↑ {{Damage}} +0.2 Damage#{{Collectible73}} A Cube of Meat#{{Timer}} Receive for the current room:#↑ {{Range}} +5 Range#{{Collectible214}} A trail of blood creep"},
	...
	{"501", "Greed's Gullet", "{{Heart}} +1 Heart container for every 25 coins gained after getting Greed's Gullet#{{Player14}} Keeper can gain additional Coin Hearts"},
	...
	{"508", "Mom's Razor", "{{BleedingOut}} Orbital that causes bleeding, which deals 10% damage of the enemy's max health every 5 seconds#Deals 3x Isaac's damage on contact per second#Does not block shots"},
	...
	{"510", "Delirious", "{{Timer}} Receive for the current room:#A friendly Delirium version of a boss"},
	...
	{"543", "Hallowed Ground", "Taking damage spawns a white poop#While inside the poop's aura:#↑ {{Tears}} x0.5 Tear delay#Chance to block damage"},
	...
	{"549", "Brittle Bones", "{{EmptyBoneHeart}} Replaces all of Isaac's Red Heart containers with 6 empty Bone Hearts#{{Blank}} Upon losing a Bone Heart:#↑ {{Tears}} +0.5 Tears#Shoots 8 bone tears in all directions"},
...
EID.descriptions[languageCode].trinkets={
	...
	{"33", "Umbilical Cord", "{{Timer}} When reduced to half a heart receive for the current room:#{{Collectible100}} A Little Steven familiar"},
	...
	{"40", "Red Patch", "{{Timer}} 20% chance upon taking damage to receive for the current room:#↑ {{Damage}} +1.8 Damage#{{Luck}} 100% chance at 8 luck"},
	...
	{"58", "Samson's Lock", "{{Timer}} 1/15 chance when killing an enemy to receive for the current room:#↑ {{Damage}} +0.5 Damage#{{Luck}} 100% chance at 10 luck"},
	...
	{"96", "Ouroboros Worm", "↑ {{Range}} +4 Range#↑ +2 Tear height#Spectral tears#Isaac's tears move quickly in a spiral pattern"},
	...
	{"118", "Bat Wing", "{{Timer}} 5% chance when killing an enemy to receive for the current room:#Flight"},
...
EID.descriptions[languageCode].cards={
	...
	{"2", "I - The Magician", "{{Timer}} Receive for the current room:#Homing tears"},
	...
	{"13", "XII - The Hanged Man", "{{Timer}} Receive for the current room:#Flight"},
	...
	{"20", "XIX - The Sun", "{{Heart}} Full health#Deals 100 damage to all enemies#{{Timer}} Receive for the current floor:#Full mapping effect (except {{SuperSecretRoom}} Super Secret Room)"},
	{"21", "XX - Judgement", "Spawns a Beggar or Devil Beggar"},
	{"22", "XXI - The World", "{{Timer}} Receive for the current floor:#Full mapping effect (except {{SuperSecretRoom}} Super Secret Room)"},
	...
	{"36", "Ansuz", "{{Timer}} Receive for the current floor:#Full mapping effect"},
	{"37", "Perthro", "Rerolls all pedestal items in the room"},
	{"38", "Berkano", "Summons 3 blue spiders and 3 blue flies"},
	{"39", "Algiz", "{{Timer}} Receive for 30 seconds:#Invincibility"},
	...
	{"51", "Holy Card", "{{Timer}} Receive for the current room:#{{HolyMantle}} A Holy Mantle shield (prevents damage once)#25% chance to spawn another Holy Card"},
...
EID.descriptions[languageCode].pills={
	...
	{"5", "Full Health", "{{Heart}} Fully heals all red heart containers"},
	...
	{"23", "I can see forever!", "{{Timer}} Receive for the current floor:#{{SecretRoom}} Opens all secret room entrances"},
	{"24", "Pheromones", "{{Charm}} Charms all enemies in the room"},
	{"25", "Amnesia", "{{Timer}} Receive for the current floor:#{{CurseLost}} Hides the map"},
	{"26", "Lemon Party", "Spawns a large puddle on the ground which damages enemies"},
	{"27", "R U A Wizard?", "{{Timer}} Receive for 30 seconds:#Isaac shoots diagonally"},
	{"28", "Percs!", "{{Timer}} Receive for the current room:#Reduces all damage taken to half a heart"},
	{"29", "Addicted!", "{{Timer}} Receive for the current room:#Increases all damage taken to a full heart"},
	{"30", "Re-Lax", "Isaac spawns poop behind him for 2 seconds"},
	{"31", "???", "{{Timer}} Receive for the current floor:#{{CurseMaze}} Curse of the Maze effect"},
	...
	{"37", "Retro Vision", "{{Timer}} Receive for 30 seconds:#Pixelates the screen 3 times"},
