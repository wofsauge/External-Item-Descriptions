...
EID.descriptions[languageCode].collectibles={
	...
	{"274", "Найкращий друг", "Для поточної кімнати створює орбіталя середнього радіусу при отриманні персонажем шкоди#Орбіталь наносить 75 шкоди за секунду"},
	...
	{"326", "Подих життя", "Зажміть кнопку активації, щоб розрядити предмет#Персонаж стає невразливим, коли полоска заряду порожня#{{Warning}} Не утримуйте кнопку активації надто довго - персонаж почне отримувати шкоду"},
	...
	{"348", "Плацебо", "{{Pill}} Активує ефект пігулки з інвентаря персонажа без її використання"},
	...
	{"364", "Френдзона", "Муха-орбіталь середнього радіусу#Наносить 45 контактної шкоди за секунду"},
	...
	{"369", "Континуум", "↑ {{Range}} +2.25 Дальність збільшено#↑ +1.5 Висота Польоту Сльози#Спектральні сльози#TСльози можуть вилітати з одної сторони кімнати і з'являтися з іншої"},
	...
	{"377", "Розірваний кокон", "Ворожі павуки більше не наносять шкоди персонажу"},
	...
	{"385", "Жебрало", "Піднімає монетки поблизу#Росте після підбору 6, 12 та 24 монет#Рівень2: Шанс створити розхідник/предмет після зачистки кімнати#Рівень3: Випускає сльози, що можуть створити монетку при влучанні#Рівень4: Переслідує ворогів, раптово гублячи підпалені бомби; може створити монетку або предмет"},
	...
	{"388", "Жебрак-ключник", "Піднімає ключі і створює випадкові скрині"},
	...
	{"392", "Зодіак", "Ефект випадкового знаку зодіака на кожен поверх"},
	...
	{"404", "Малюк Пердун", "Блокує ворожі снаряди#При ударі, 10% шанс пукнути і причарувати, отруїти або відштовхнути ворогів"},
	...
	{"422", "Сяйливий годинник", "Повертає персонажа до попередньої кімнати і скасовує всі його дії, виконані в кімнаті, де було активовано Годинник"},
	...
	{"433", "Моя тінь", "При отриманні персонажем шкоди, на всіх ворогів накладається ефект страху та з'являється дружній чорний монстр#Монстр наносить 5 конатктної шкоди за секунду"},
	...
	{"445", "Собачий зуб", "↑ {{Damage}} +0.3 Шкоду збільшено#↑ {{Speed}} +0.1 Швидкість збльшено#{{SecretRoom}} Вовк виє у кімнатах, що межують із Секреткою/Суперсекреткою#{{LadderRoom}} Собака гавкає у кімнатах з проходом до криївки під каменями"},
	...
	{"472", "Дитя Король", "Інші компаньойни рухаються слідом за ним#Перестає рухатись, коли персонаж стріляє#Телепортується назад до персонажа, коли той перестає стріляти"},
	...
	{"477", "Порожнеча", "Поглинає усі п'єдестальні предмети в кімнаті#Активні предменти: їх ефекти активуються при поглинанні та при кожній наступній активації Порожнечі#↑ Пасивні предмети: покращує дві випадкові характеристики персонажа"},
	...
	{"483", "Мама Мега!", "{{Warning}} ОДНОРАЗОВИЙ {{Warning}}#Впливає на весь поверх#Підриває всі перешкоди#Наносить 200 шкоди всім ворогам#Відкриває двері до Бос Рашу, Хаша та всі секретні кімнати#Якщо у вас є золота бомба, при активації натомість буде поглинута вона, дозволяючи застосувати Маму Мега ще раз"}, -- TODO назви босів синхронізувати з перкладом гри
	...
	{"528", "Янгельська призма", "Орбітальна призма#Дружні сльози, що влучають у неї, розділяються на 4"},
	{"529", "Хлюп!", "Сльози персонажа штовхають одна одну та зникають, коли перестають рухатись"},
	{"530", "Список смерті", "Вбивайте ворогів згідно порядку, вказаного знаком {{DeathMark}} над ними, щоб отримати випадковий розхідник чи перманентне підвищення характеристики"},
	...
	{"538", "Камінці", "{{Trinket}} Створює 3 випадкові брелки#{{Collectible479}} При отриманні шкоди, активний брелок може бути поглинутий та перенесений до інвентаря предметів, перманентно даючи свій ефект"},
	...
	{"549", "Крихкі кістки", "{{EmptyBoneHeart}} Замінює усі Контейнери червоних сердець на 6 пустих Кісткових серця#При втраті Кісткового серця:#Випускає 8 кісткових сліз у всіх напрямках#↑ {{Tears}} +0.5 Темп Стрільби збільшено перманентно"},
