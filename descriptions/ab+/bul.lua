...
EID.descriptions[languageCode].collectibles={
	{"1", "Тъжният лук", "↑ {{Tears}} 0.7 скорост на стреляне"},
	{"2", "Вътрешно око", "Тройна стрелба#↓ {{Tears}} скорост на стреляне"},
	{"3", "Огъната лъжица", "Самонасочващи се сълзи"},
	{"4", "Главата на Крикет", "↑ {{Damage}} 0.5 Щети#↑ {{Damage}} +50% Повече щети"},
	{"5", "Моето отражение", "Дава бумеранг ефект на сълзите#↑ {{Range}} +1.5 Обхват на сълзите#↑ {{Shotspeed}} 0.6 скорост на стреляне#↑ 1 Големина на сълзите"},
	{"6", "Номер едно", "↑ {{Tears}} 1.5 скорост на стреляне#↓ {{Range}} -17.62 Обхват на сълзите#↑ +0.76 Височина на стреляне"},   -- Tear Height - Големина на сълзите->Височина на стреляне
	...
	{"32", "Закачалка", "↑ {{Tears}} 0.7 скорост на стреляне"},
	...
	{"80", "Пактът", "↑ {{Damage}} 0.5 Щети#↑ {{Tears}} 0.7 скорост на стреляне#+2 Духовни сърца"},
	...
	{"90", "Малкият Камък", "↑ {{Damage}} 1 Щети#↑ {{Tears}} 0.2 скорост на стреляне#↓ {{Speed}} -0.2 Скорост"},
	...
	{"101", "Ореолът", "↑ 1 Червено сърце#↑ {{Damage}} 0.3 Щети#↑ {{Tears}} 0.2 скорост на стреляне#↑ {{Range}} 0.25 Обхват на сълзите#↑ {{Speed}} +0.3 Скорост#↑ +0.5 Височина на сълзите"},
	...
	{"120", "Странна гъба (тънка)", "↑ {{Tears}} 1.7 скорост на стреляне#↑ {{Speed}} +0.3 Скорост#↓ -38% Щети#Намаляващият ефект става по-малък след увеличаване на щетите с други предмети"}, -- ~~surely there must be a more concise description of the Thin Odd Mushroom DMG penalty? (current literal translation is "Decreasing effect gets smaller after increasing Damage with other items")
