...
EID.descriptions[languageCode].collectibles={
	...
	{"14", "Злоба", "↑ {{Speed}} +0.6 Скорост#↑ {{Range}} +5.25 Обхват на сълзите#↑ +0.5 Височина на сълзите"},
	...
	{"79", "Марката", "↑ {{Damage}} 1.0 Щети#↑ {{Speed}} 0.2 Скорост#+1 Духовно сърце"},
	...
	{"143", "Спидбол", "↑ {{Speed}} 0.3 Скорост#↑ {{Shotspeed}} 0.2 Скорост на сълзите"},
	...
	{"213", "Изгубена връзка", "Сълзите ще имат щит, блокиращ другите сълзи#Когато такава сълза и вражеска сълза се сблъскат, и двете ще изчезнат#↓ {{Shotspeed}} -0.15 скорост на стрелбата"},
	...
	{"230", "Абаддон", "↑ {{Damage}} 1.5 Щети#↑ {{Speed}} 0.2 скорост#Шанс да изплаши чудовищата#Маха всички червени сърца#+6 Черни сърца"},
	...
	{"331", "Божественост", "Насочване на сълзите, имате аура, която нанася щети#↑ {{Damage}} +0.5 Щети#↑ {{Range}} 1.2 Обхват на сълзите#↓ {{Tears}} 0.3 Скорост на сълзите#↓ {{Shotspeed}} -0.3 Скорост на стрелба#↑ 0.8 Височина на сълзите"},   -- ~~Great example of Tears vs Shot speed <-> Скорост на сълзите и Скорост на стрелба
	...
	{"336", "Мъртъв лук", "Пиърсинг + спектрални сълзи#↑ {{Range}} +0.25 Обхват на сълзите#↓ {{Shotspeed}} -0.4 Скорост на стрелба#↓ -0.5 Височина на сълзите#↑ {{Tearsize}} +50% големина на сълзите"}, -- TODO: Piercing - Пиърсинг->Пронизващи (as token aka on every occurrence); TODO: Мъртъв лук(literal translation)->Изгнил лук?
	...
	{"345", "Синтол", "↑ {{Damage}} 1.0 Щети#↑ {{Range}} 5.25 Обхват на сълзите#↑ 0.5 Височина на сълзите"},
	...
	{"355", "Майчина перла", "↑ {{Range}} 1.25 Обхват на сълзите#↑ 0.5 Височина на сълзите#↑ 1 Късмет"},   -- TODO: fix item name (currently basically Mom's Pearl singular)
	...
	{"394", "Отбелязано", "Стреляте сълзи автоматично по посока на маркер, който контролирате#↑ {{Tears}} 0.7 Скорост на сълзите#↑ 0.3 Височина на сълзите#↑ {{Range}} 3.15 Обхват на сълзите"},
	...
	{"397", "Тягова греда", "Сълзите ви летят стриктно по лъча светлина, без да се отклоняват дори когато се движите#↑ {{Tears}} 0.5 Скорост на сълзите#↑ {{Range}} 5.25 Обхват на сълзите#↑ {{Shotspeed}} 0.16 Скорост на стреляне#↑ 0.5 Височина на сълзите"},
...
EID.descriptions[languageCode].trinkets={
	...
	{"67", "Треснувший Кубик", "Шанс срабатывания эффекта случайного кубика при получении урона"}, -- TODO: translate from Russian (lol, also not the only case)
	...
	{"100", "Вибрираща светлина", "Когато вашият активен артикул е зареден:#↑ {{Speed}} 0,25 скорост#↑ {{Range}} +0,75 обхват на стрелба#↑ {{Tears}} 0,2 бързина на сълзите#↑ {{Shotspeed}} +0,1 скорост на стреляне#↑ {{Damage}} +0,5 щети#↑ 1 късмет"},
	{"101", "Приглушена крушка", "Когато вашият активен артикул е напълно разреден:#↑ {{Speed}} 0,5 скорост#↑ {{Range}} 1,5 обхват на стрелба#↑ {{Tears}} 0,4 бързина на сълзите#↑ {{Shotspeed}} +0,3 скорост на стреляне#↑ {{Damage}} +1,5 щети#↑ 2 късмет"},
