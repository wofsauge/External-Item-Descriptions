...
EID.descriptions[languageCode].collectibles={
	...
	{"399", "Паст от бездната", "↑ {{Damage}} 1.0 Щети#↑ 0.5 Височина на сълзите#{{Chargeable}} След продължителна стрелба в продължение на 3 секунди на главата ще се появи червен кръст, след спиране на стрелбата ще се появи черен пръстен, причиняващ големи щети#Враговете, убити от пръстена, имат шанс да пуснат Черно сърце"},    -- roughly literal translation
