...
local collectibles = {
	...
	-- Change: Complete rewrite
	[510] = {"510", "Im Delirium", "Beschwört eine freundliche Delirium-Version eines Bosses#Persistiert zwischen Räumen#{{Warning}} Es kann immer nur ein Endgegner aktiv sein#Die Aktivierungskosten richten sich nach der Qualität des zuvor gespawnten Endgegners"}, -- Delirious
