...
local collectibles = {
	...
	[186] = { "186", "Право на кровь", "Наносит 40 урона каждому врагу#{{Tears}} +0.48 к скорострельности до конца комнаты#{{Warning}} Наносит Исааку урон в 1 сердце#После первого использования в комнате наносит урон в половину сердца#{{Heart}} Сначала забирает красные сердца" }, -- Blood Rights
	[244] = { "244", "Технология.5", "Иногда дополнительно к слезам Исаак стреляет лазерами#Небольшой шанс, что лазер получит случайный эффект" }, -- Tech.5
	...
	[420] = { "420", "Чёрный порошок", "Ходьба по кругу рисует на полу пентаграмму, которая наносит 130 урона за 4 секунды#Увеличивает размер взрывов#Костры взрываются при тушении" }, -- Black Powder
	[436] = {"436", "Молоко!", "Следует за персонажем и блокирует выстрелы#{{Tears}} После 10 попаданий разбивается и даёт повышение скорострельности до конца этажа"}, -- Milk!
...
[5] = { 2, 4, 6, 50, 66, 75 }, -- Purple Heart
	...
	[134] = { "Усиливает отталкивание газов", "Усиливает отталкивание газов#{{ColorGold}}Газы приводят врагов в замешательство на 3 сек." }, -- Gigante Bean
