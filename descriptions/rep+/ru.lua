...
local collectibles = {
	...
	[186] = { "186", "Право на кровь", "Наносит 40 урона каждому врагу#{{Tears}} +0.48 к скорострельности за первое использование на этаже, +0.15 за последующие#Бонус действует до выхода из комнаты и возвращается при повторном использовании#{{Warning}} Наносит Исааку урон в 1 сердце#После первого использования в комнате наносит урон в половину сердца#{{Heart}} Сначала забирает красные сердца" }, -- Blood Rights
	...
	[420] = { "420", "Чёрный порошок", "Ходьба по кругу рисует пентаграмму, наносящую 130 урона за 4 секунды#Увеличивает размер взрывов#Потушенные костры безопасно взрываются, нанося 20 урона" }, -- Black Powder
