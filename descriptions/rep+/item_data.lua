...
---------- Collectibles ----------
    ...
    [C_ID .. 651] = { EffectList = { FireRateMultiplier = 2.5, DamageMultiplier = 1.2, TearEffect = "Homing"} }, -- Star of Bethlehem (Changed DamageMultiplier and TearMultiplier to FireRateMultiplier)
